...
tdpError_t tdpThreadModelInfo(FILE *fp) { 
# 37
(fp) ? static_cast< void>(0) : __assert_fail("fp", "target_cuda.c", 37, __PRETTY_FUNCTION__); 
# 39
...
# 1 "target_cuda.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__19_target_cuda_cpp1_ii_d9edec20
# 1 "target_cuda.cudafe1.stub.c"
#include "target_cuda.cudafe1.stub.c"
# 1 "target_cuda.cudafe1.stub.c"
