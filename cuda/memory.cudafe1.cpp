...
# 57 "memory.c"
int forward_addr_rank0_assert(int lineno, const char *file, int 
# 58
nsites, int index) { 
# 60
do { if ((index < 0) || (index >= nsites)) { printf("%s (%s = %d, %s = %d), file %s, line %d\n", "Bad array index", "nsites", nsites, "index", index, file, lineno); ((index > 0) && (index < nsites)) ? static_cast< void>(0) : __assert_fail("index > 0 && index < nsites", "memory.c", 60, __PRETTY_FUNCTION__); }  } while (0); 
# 62
return index; 
# 63
} 
# 72
int forward_addr_rank1_assert(int lineno, const char *file, int 
# 73
nsites, int na, int index, int ia) { 
# 75
do { if ((index < 0) || (index >= nsites)) { printf("%s (%s = %d, %s = %d), file %s, line %d\n", "Bad array index", "nsites", nsites, "index", index, file, lineno); ((index > 0) && (index < nsites)) ? static_cast< void>(0) : __assert_fail("index > 0 && index < nsites", "memory.c", 75, __PRETTY_FUNCTION__); }  } while (0); 
# 76
do { if ((ia < 0) || (ia >= na)) { printf("%s (%s = %d, %s = %d), file %s, line %d\n", "Bad array index", "na", na, "ia", ia, file, lineno); ((ia > 0) && (ia < na)) ? static_cast< void>(0) : __assert_fail("ia > 0 && ia < na", "memory.c", 76, __PRETTY_FUNCTION__); }  } while (0); 
# 78
return (na * index) + ia; 
# 79
} 
# 88
int forward_addr_rank2_assert(int lineno, const char *file, int 
# 89
nsites, int na, int nb, int 
# 90
index, int ia, int ib) { 
# 92
do { if ((index < 0) || (index >= nsites)) { printf("%s (%s = %d, %s = %d), file %s, line %d\n", "Bad array index", "nsites", nsites, "index", index, file, lineno); ((index > 0) && (index < nsites)) ? static_cast< void>(0) : __assert_fail("index > 0 && index < nsites", "memory.c", 92, __PRETTY_FUNCTION__); }  } while (0); 
# 93
do { if ((ia < 0) || (ia >= na)) { printf("%s (%s = %d, %s = %d), file %s, line %d\n", "Bad array index", "na", na, "ia", ia, file, lineno); ((ia > 0) && (ia < na)) ? static_cast< void>(0) : __assert_fail("ia > 0 && ia < na", "memory.c", 93, __PRETTY_FUNCTION__); }  } while (0); 
# 94
do { if ((ib < 0) || (ib >= nb)) { printf("%s (%s = %d, %s = %d), file %s, line %d\n", "Bad array index", "nb", nb, "ib", ib, file, lineno); ((ib > 0) && (ib < nb)) ? static_cast< void>(0) : __assert_fail("ib > 0 && ib < nb", "memory.c", 94, __PRETTY_FUNCTION__); }  } while (0); 
# 96
return (((na * nb) * index) + (nb * ia)) + ib; 
# 97
} 
# 106
int forward_addr_rank3_assert(int lineno, const char *file, int 
# 107
nsites, int na, int nb, int nc, int 
# 108
index, int ia, int ib, int ic) { 
# 110
do { if ((index < 0) || (index >= nsites)) { printf("%s (%s = %d, %s = %d), file %s, line %d\n", "Bad array index", "nsites", nsites, "index", index, file, lineno); ((index > 0) && (index < nsites)) ? static_cast< void>(0) : __assert_fail("index > 0 && index < nsites", "memory.c", 110, __PRETTY_FUNCTION__); }  } while (0); 
# 111
do { if ((ia < 0) || (ia >= na)) { printf("%s (%s = %d, %s = %d), file %s, line %d\n", "Bad array index", "na", na, "ia", ia, file, lineno); ((ia > 0) && (ia < na)) ? static_cast< void>(0) : __assert_fail("ia > 0 && ia < na", "memory.c", 111, __PRETTY_FUNCTION__); }  } while (0); 
# 112
do { if ((ib < 0) || (ib >= nb)) { printf("%s (%s = %d, %s = %d), file %s, line %d\n", "Bad array index", "nb", nb, "ib", ib, file, lineno); ((ib > 0) && (ib < nb)) ? static_cast< void>(0) : __assert_fail("ib > 0 && ib < nb", "memory.c", 112, __PRETTY_FUNCTION__); }  } while (0); 
# 113
do { if ((ic < 0) || (ic >= nc)) { printf("%s (%s = %d, %s = %d), file %s, line %d\n", "Bad array index", "nc", nc, "ic", ic, file, lineno); ((ic > 0) && (ic < nc)) ? static_cast< void>(0) : __assert_fail("ic > 0 && ic < nc", "memory.c", 113, __PRETTY_FUNCTION__); }  } while (0); 
# 115
return (((((na * nb) * nc) * index) + ((nb * nc) * ia)) + (nc * ib)) + ic; 
# 116
} 
# 125
int forward_addr_rank4_assert(int lineno, const char *file, int 
# 126
nsites, int na, int nb, int nc, int nd, int 
# 127
index, int ia, int ib, int ic, int id) { 
# 129
do { if ((index < 0) || (index >= nsites)) { printf("%s (%s = %d, %s = %d), file %s, line %d\n", "Bad array index", "nsites", nsites, "index", index, file, lineno); ((index > 0) && (index < nsites)) ? static_cast< void>(0) : __assert_fail("index > 0 && index < nsites", "memory.c", 129, __PRETTY_FUNCTION__); }  } while (0); 
# 130
do { if ((ia < 0) || (ia >= na)) { printf("%s (%s = %d, %s = %d), file %s, line %d\n", "Bad array index", "na", na, "ia", ia, file, lineno); ((ia > 0) && (ia < na)) ? static_cast< void>(0) : __assert_fail("ia > 0 && ia < na", "memory.c", 130, __PRETTY_FUNCTION__); }  } while (0); 
# 131
do { if ((ib < 0) || (ib >= nb)) { printf("%s (%s = %d, %s = %d), file %s, line %d\n", "Bad array index", "nb", nb, "ib", ib, file, lineno); ((ib > 0) && (ib < nb)) ? static_cast< void>(0) : __assert_fail("ib > 0 && ib < nb", "memory.c", 131, __PRETTY_FUNCTION__); }  } while (0); 
# 132
do { if ((ic < 0) || (ic >= nc)) { printf("%s (%s = %d, %s = %d), file %s, line %d\n", "Bad array index", "nc", nc, "ic", ic, file, lineno); ((ic > 0) && (ic < nc)) ? static_cast< void>(0) : __assert_fail("ic > 0 && ic < nc", "memory.c", 132, __PRETTY_FUNCTION__); }  } while (0); 
# 133
do { if ((id < 0) || (id >= nd)) { printf("%s (%s = %d, %s = %d), file %s, line %d\n", "Bad array index", "nd", nd, "id", id, file, lineno); ((id > 0) && (id < nd)) ? static_cast< void>(0) : __assert_fail("id > 0 && id < nd", "memory.c", 133, __PRETTY_FUNCTION__); }  } while (0); 
# 135
return (((((((na * nb) * nc) * nd) * index) + (((nb * nc) * nd) * ia)) + ((nc * nd) * ib)) + (nd * ic)) + id; 
# 136
} 
# 145
int reverse_addr_rank0_assert(int lineno, const char *file, int 
# 146
nsites, int index) { 
# 148
do { if ((index < 0) || (index >= nsites)) { printf("%s (%s = %d, %s = %d), file %s, line %d\n", "Bad array index", "nsites", nsites, "index", index, file, lineno); ((index > 0) && (index < nsites)) ? static_cast< void>(0) : __assert_fail("index > 0 && index < nsites", "memory.c", 148, __PRETTY_FUNCTION__); }  } while (0); 
# 150
return index; 
# 151
} 
# 160
int reverse_addr_rank1_assert(int lineno, const char *file, int 
# 161
nsites, int na, int index, int ia) { 
# 163
do { if ((index < 0) || (index >= nsites)) { printf("%s (%s = %d, %s = %d), file %s, line %d\n", "Bad array index", "nsites", nsites, "index", index, file, lineno); ((index > 0) && (index < nsites)) ? static_cast< void>(0) : __assert_fail("index > 0 && index < nsites", "memory.c", 163, __PRETTY_FUNCTION__); }  } while (0); 
# 164
do { if ((ia < 0) || (ia >= na)) { printf("%s (%s = %d, %s = %d), file %s, line %d\n", "Bad array index", "na", na, "ia", ia, file, lineno); ((ia > 0) && (ia < na)) ? static_cast< void>(0) : __assert_fail("ia > 0 && ia < na", "memory.c", 164, __PRETTY_FUNCTION__); }  } while (0); 
# 166
return (nsites * ia) + index; 
# 167
} 
# 176
int reverse_addr_rank2_assert(int lineno, const char *file, int 
# 177
nsites, int na, int nb, int 
# 178
index, int ia, int ib) { 
# 180
do { if ((index < 0) || (index >= nsites)) { printf("%s (%s = %d, %s = %d), file %s, line %d\n", "Bad array index", "nsites", nsites, "index", index, file, lineno); ((index > 0) && (index < nsites)) ? static_cast< void>(0) : __assert_fail("index > 0 && index < nsites", "memory.c", 180, __PRETTY_FUNCTION__); }  } while (0); 
# 181
do { if ((ia < 0) || (ia >= na)) { printf("%s (%s = %d, %s = %d), file %s, line %d\n", "Bad array index", "na", na, "ia", ia, file, lineno); ((ia > 0) && (ia < na)) ? static_cast< void>(0) : __assert_fail("ia > 0 && ia < na", "memory.c", 181, __PRETTY_FUNCTION__); }  } while (0); 
# 182
do { if ((ib < 0) || (ib >= nb)) { printf("%s (%s = %d, %s = %d), file %s, line %d\n", "Bad array index", "nb", nb, "ib", ib, file, lineno); ((ib > 0) && (ib < nb)) ? static_cast< void>(0) : __assert_fail("ib > 0 && ib < nb", "memory.c", 182, __PRETTY_FUNCTION__); }  } while (0); 
# 184
return (((nb * nsites) * ia) + (nsites * ib)) + index; 
# 185
} 
# 194
int reverse_addr_rank3_assert(int lineno, const char *file, int 
# 195
nsites, int na, int nb, int nc, int 
# 196
index, int ia, int ib, int ic) { 
# 198
do { if ((index < 0) || (index >= nsites)) { printf("%s (%s = %d, %s = %d), file %s, line %d\n", "Bad array index", "nsites", nsites, "index", index, file, lineno); ((index > 0) && (index < nsites)) ? static_cast< void>(0) : __assert_fail("index > 0 && index < nsites", "memory.c", 198, __PRETTY_FUNCTION__); }  } while (0); 
# 199
do { if ((ia < 0) || (ia >= na)) { printf("%s (%s = %d, %s = %d), file %s, line %d\n", "Bad array index", "na", na, "ia", ia, file, lineno); ((ia > 0) && (ia < na)) ? static_cast< void>(0) : __assert_fail("ia > 0 && ia < na", "memory.c", 199, __PRETTY_FUNCTION__); }  } while (0); 
# 200
do { if ((ib < 0) || (ib >= nb)) { printf("%s (%s = %d, %s = %d), file %s, line %d\n", "Bad array index", "nb", nb, "ib", ib, file, lineno); ((ib > 0) && (ib < nb)) ? static_cast< void>(0) : __assert_fail("ib > 0 && ib < nb", "memory.c", 200, __PRETTY_FUNCTION__); }  } while (0); 
# 201
do { if ((ic < 0) || (ic >= nc)) { printf("%s (%s = %d, %s = %d), file %s, line %d\n", "Bad array index", "nc", nc, "ic", ic, file, lineno); ((ic > 0) && (ic < nc)) ? static_cast< void>(0) : __assert_fail("ic > 0 && ic < nc", "memory.c", 201, __PRETTY_FUNCTION__); }  } while (0); 
# 203
return (((((nb * nc) * nsites) * ia) + ((nc * nsites) * ib)) + (nsites * ic)) + index; 
# 204
} 
# 213
int reverse_addr_rank4_assert(int lineno, const char *file, int 
# 214
nsites, int na, int nb, int nc, int nd, int 
# 215
index, int ia, int ib, int ic, int id) { 
# 217
do { if ((index < 0) || (index >= nsites)) { printf("%s (%s = %d, %s = %d), file %s, line %d\n", "Bad array index", "nsites", nsites, "index", index, file, lineno); ((index > 0) && (index < nsites)) ? static_cast< void>(0) : __assert_fail("index > 0 && index < nsites", "memory.c", 217, __PRETTY_FUNCTION__); }  } while (0); 
# 218
do { if ((ia < 0) || (ia >= na)) { printf("%s (%s = %d, %s = %d), file %s, line %d\n", "Bad array index", "na", na, "ia", ia, file, lineno); ((ia > 0) && (ia < na)) ? static_cast< void>(0) : __assert_fail("ia > 0 && ia < na", "memory.c", 218, __PRETTY_FUNCTION__); }  } while (0); 
# 219
do { if ((ib < 0) || (ib >= nb)) { printf("%s (%s = %d, %s = %d), file %s, line %d\n", "Bad array index", "nb", nb, "ib", ib, file, lineno); ((ib > 0) && (ib < nb)) ? static_cast< void>(0) : __assert_fail("ib > 0 && ib < nb", "memory.c", 219, __PRETTY_FUNCTION__); }  } while (0); 
# 220
do { if ((ic < 0) || (ic >= nc)) { printf("%s (%s = %d, %s = %d), file %s, line %d\n", "Bad array index", "nc", nc, "ic", ic, file, lineno); ((ic > 0) && (ic < nc)) ? static_cast< void>(0) : __assert_fail("ic > 0 && ic < nc", "memory.c", 220, __PRETTY_FUNCTION__); }  } while (0); 
# 221
do { if ((id < 0) || (id >= nd)) { printf("%s (%s = %d, %s = %d), file %s, line %d\n", "Bad array index", "nd", nd, "id", id, file, lineno); ((id > 0) && (id < nd)) ? static_cast< void>(0) : __assert_fail("id > 0 && id < nd", "memory.c", 221, __PRETTY_FUNCTION__); }  } while (0); 
# 223
...
int mem_addr_rank0(int nsites, int index) { 
# 237
return reverse_addr_rank0_assert(237, "memory.c", nsites, index); 
# 238
} 
# 247
int mem_addr_rank1(int nsites, int na, int index, int ia) { 
# 249
return reverse_addr_rank1_assert(249, "memory.c", nsites, na, index, ia); 
# 250
} 
# 259
int mem_addr_rank2(int nsites, int na, int nb, int index, int ia, int ib) { 
# 261
return reverse_addr_rank2_assert(261, "memory.c", nsites, na, nb, index, ia, ib); 
# 262
} 
# 277 "memory.c"
void *mem_aligned_malloc(size_t alignment, size_t size) { 
...
void *p; 
# 284
((alignment % sizeof(void *)) == (0)) ? static_cast< void>(0) : __assert_fail("alignment % sizeof(void *) == 0", "memory.c", 284, __PRETTY_FUNCTION__); 
# 285
((alignment & (alignment - (1))) == (0)) ? static_cast< void>(0) : __assert_fail("(alignment & (alignment-1)) == 0", "memory.c", 285, __PRETTY_FUNCTION__); 
# 287
...
# 334 "memory.c"
void *mem_aligned_realloc(void *ptr, size_t alignment, size_t oldsize, size_t 
# 335
newsize) { 
# 337
void *p = (__null); 
...
# 1 "memory.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__14_memory_cpp1_ii_4e84af7b
# 1 "memory.cudafe1.stub.c"
#include "memory.cudafe1.stub.c"
# 1 "memory.cudafe1.stub.c"
