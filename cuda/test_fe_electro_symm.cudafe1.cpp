...
fe_es_t *fe = (__null); 
# 85
(pe) ? static_cast< void>(0) : __assert_fail("pe", "test_fe_electro_symm.c", 85, __PRETTY_FUNCTION__); 
# 87
cs_create(pe, &cs); 
# 88
cs_nhalo_set(cs, 2); 
...
# 92
(psi) ? static_cast< void>(0) : __assert_fail("psi", "test_fe_electro_symm.c", 92, __PRETTY_FUNCTION__); 
# 93
fe_electro_create(pe, psi, &fe_elec); 
# 95
field_create(pe, cs, 1, "phi", &phi); 
# 96
(phi) ? static_cast< void>(0) : __assert_fail("phi", "test_fe_electro_symm.c", 96, __PRETTY_FUNCTION__); 
# 97
field_init(phi, 1, __null); 
# 99
field_grad_create(pe, phi, 2, &dphi); 
# 100
(dphi) ? static_cast< void>(0) : __assert_fail("dphi", "test_fe_electro_symm.c", 100, __PRETTY_FUNCTION__); 
# 101
...
# 113
test_assert_info(fabs(((2.0) * dmu_test) - (dmu[0])) < ((double)(2.2204460492503130808e-16L)), 113, "test_fe_electro_symm.c"); 
# 114
fe_es_mu_ion_solv(fe, index, 1, &dmu_test); 
# 115
test_assert_info(fabs(((2.0) * dmu_test) - (dmu[1])) < ((double)(2.2204460492503130808e-16L)), 115, "test_fe_electro_symm.c"); 
# 117
phi0 = (1.0); 
# 118
field_scalar_set(phi, index, phi0); 
...
fe_es_mu_ion_solv(fe, index, 0, &dmu_test); 
# 120
test_assert_info(fabs(dmu_test - (dmu[0])) < ((double)(2.2204460492503130808e-16L)), 120, "test_fe_electro_symm.c"); 
# 121
fe_es_mu_ion_solv(fe, index, 1, &dmu_test); 
# 122
test_assert_info(fabs(dmu_test - (dmu[1])) < ((double)(2.2204460492503130808e-16L)), 122, "test_fe_electro_symm.c"); 
# 127
...
# 133
test_assert_info(fabs(eps_expect - eps_test) < ((double)(2.2204460492503130808e-16L)), 133, "test_fe_electro_symm.c"); 
# 135
phi0 = (1.0); 
# 136
field_scalar_set(phi, index, phi0); 
...
eps_expect = (ebar * ((1.0) - (gamma * phi0))); 
# 139
test_assert_info(fabs(eps_expect - eps_test) < ((double)(2.2204460492503130808e-16L)), 139, "test_fe_electro_symm.c"); 
# 143
fe_es_free(fe); 
# 144
...
# 1 "test_fe_electro_symm.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__28_test_fe_electro_symm_cpp1_ii_c4941d53
# 1 "test_fe_electro_symm.cudafe1.stub.c"
#include "test_fe_electro_symm.cudafe1.stub.c"
# 1 "test_fe_electro_symm.cudafe1.stub.c"
