...
# 67
static fe_surfactant1_param_t const_param; 
# 75
int fe_surfactant1_create(pe_t *pe, cs_t *cs, field_t *phi, field_grad_t *
# 76
grad, fe_surfactant1_t **
# 77
fe) { 
# 79
int ndevice; 
# 80
fe_surfactant1_t *obj = (__null); 
# 82
(pe) ? static_cast< void>(0) : __assert_fail("pe", "surfactant.c", 82, __PRETTY_FUNCTION__); 
# 83
(cs) ? static_cast< void>(0) : __assert_fail("cs", "surfactant.c", 83, __PRETTY_FUNCTION__); 
# 84
(fe) ? static_cast< void>(0) : __assert_fail("fe", "surfactant.c", 84, __PRETTY_FUNCTION__); 
# 85
(phi) ? static_cast< void>(0) : __assert_fail("phi", "surfactant.c", 85, __PRETTY_FUNCTION__); 
# 86
(grad) ? static_cast< void>(0) : __assert_fail("grad", "surfactant.c", 86, __PRETTY_FUNCTION__); 
# 88
obj = ((fe_surfactant1_t *)calloc(1, sizeof(fe_surfactant1_t))); 
# 89
(obj) ? static_cast< void>(0) : __assert_fail("obj", "surfactant.c", 89, __PRETTY_FUNCTION__); 
# 90
if (obj == (__null)) { pe_fatal(pe, "calloc(fe_surfactant1_t) failed\n"); }  
# 92
(obj->pe) = pe; 
# 93
(obj->cs) = cs; 
...
(obj->dphi) = grad; 
# 97
(0) ? static_cast< void>(0) : __assert_fail("0", "surfactant.c", 97, __PRETTY_FUNCTION__); 
# 101
...
# 109
{ tdpErrorHandler(cudaGetSymbolAddress((void **)(&tmp), const_param), "surfactant.c", 109, 1); } ; 
# 110
tdpMemcpy(&((obj->target)->param), tmp, sizeof(fe_surfactant1_param_t *), cudaMemcpyHostToDevice); 
# 113
(0) ? static_cast< void>(0) : __assert_fail("0", "surfactant.c", 113, __PRETTY_FUNCTION__); 
# 114
}  
# 116
(*fe) = obj; 
...
int ndevice; 
# 131
(fe) ? static_cast< void>(0) : __assert_fail("fe", "surfactant.c", 131, __PRETTY_FUNCTION__); 
# 133
tdpGetDeviceCount(&ndevice); 
# 134
...
int fe_surfactant1_target(fe_surfactant1_t *fe, fe_t **target) { 
# 150
(fe) ? static_cast< void>(0) : __assert_fail("fe", "surfactant.c", 150, __PRETTY_FUNCTION__); 
# 151
(target) ? static_cast< void>(0) : __assert_fail("target", "surfactant.c", 151, __PRETTY_FUNCTION__); 
# 153
...
# 164
int fe_surfactant1_param_set(fe_surfactant1_t *fe, fe_surfactant1_param_t 
# 165
vals) { 
# 167
(fe) ? static_cast< void>(0) : __assert_fail("fe", "surfactant.c", 167, __PRETTY_FUNCTION__); 
# 169
(*(fe->param)) = vals; 
# 171
return 0; 
...
# 180
int fe_surfactant1_param(fe_surfactant1_t *fe, fe_surfactant1_param_t *
# 181
values) { 
# 182
(fe) ? static_cast< void>(0) : __assert_fail("fe", "surfactant.c", 182, __PRETTY_FUNCTION__); 
# 184
(*values) = (*(fe->param)); 
# 186
return 0; 
...
# 197 "surfactant.c"
int fe_surfactant1_sigma(fe_surfactant1_t *fe, double *
# 198
sigma0) { 
# 199
double a, b, kappa; 
# 201
(fe) ? static_cast< void>(0) : __assert_fail("fe", "surfactant.c", 201, __PRETTY_FUNCTION__); 
# 202
(sigma0) ? static_cast< void>(0) : __assert_fail("sigma0", "surfactant.c", 202, __PRETTY_FUNCTION__); 
# 204
a = ((fe->param)->a); 
# 205
b = ((fe->param)->b); 
...
# 221 "surfactant.c"
int fe_surfactant1_xi0(fe_surfactant1_t *fe, double *
# 222
xi0) { 
# 223
(fe) ? static_cast< void>(0) : __assert_fail("fe", "surfactant.c", 223, __PRETTY_FUNCTION__); 
# 224
(xi0) ? static_cast< void>(0) : __assert_fail("xi0", "surfactant.c", 224, __PRETTY_FUNCTION__); 
# 226
...
# 244 "surfactant.c"
int fe_surfactant1_langmuir_isotherm(fe_surfactant1_t *fe, double *
# 245
psi_c) { 
# 246
double xi0; 
# 248
(fe) ? static_cast< void>(0) : __assert_fail("fe", "surfactant.c", 248, __PRETTY_FUNCTION__); 
# 250
...
# 268 "surfactant.c"
int fe_surfactant1_fed(fe_surfactant1_t *fe, int index, double *
# 269
fed) { 
# 271
double field[2]; 
...
double dphisq; 
# 277
(fe) ? static_cast< void>(0) : __assert_fail("fe", "surfactant.c", 277, __PRETTY_FUNCTION__); 
# 279
field_scalar_array(fe->phi, index, field); 
# 282
(0) ? static_cast< void>(0) : __assert_fail("0", "surfactant.c", 282, __PRETTY_FUNCTION__); 
# 283
phi = (field[0]); 
# 284
psi = (field[1]); 
...
# 290
(*fed) = ((((((0.5) * ((fe->param)->a)) * phi) * phi) + ((((((0.25) * ((fe->param)->b)) * phi) * phi) * phi) * phi)) + (((0.5) * ((fe->param)->kappa)) * dphisq)); 
# 293
(psi > (0.0)) ? static_cast< void>(0) : __assert_fail("psi > 0.0", "surfactant.c", 293, __PRETTY_FUNCTION__); 
# 294
(psi < (1.0)) ? static_cast< void>(0) : __assert_fail("psi < 1.0", "surfactant.c", 294, __PRETTY_FUNCTION__); 
# 296
(*fed) += ((((((fe->param)->kt) * ((psi * log(psi)) + (((1.0) - psi) * log((1.0) - psi)))) - ((((0.5) * ((fe->param)->epsilon)) * psi) * dphisq)) - (((((0.5) * ((fe->param)->beta)) * psi) * psi) * dphisq)) + (((((0.5) * ((fe->param)->w)) * psi) * phi) * phi)); 
# 301
return 0; 
# 302
} 
# 321 "surfactant.c"
int fe_surfactant_mu(fe_surfactant1_t *fe, int index, double *
# 322
mu) { 
# 323
double phi; 
...
double delsq[2]; 
# 329
(fe) ? static_cast< void>(0) : __assert_fail("fe", "surfactant.c", 329, __PRETTY_FUNCTION__); 
# 330
(mu) ? static_cast< void>(0) : __assert_fail("mu", "surfactant.c", 330, __PRETTY_FUNCTION__); 
# 332
field_scalar_array(fe->phi, index, field); 
# 335
(delsq[0]) = (0.0); (delsq[1]) = (0.0); 
# 336
(0) ? static_cast< void>(0) : __assert_fail("0", "surfactant.c", 336, __PRETTY_FUNCTION__); 
# 337
phi = (field[0]); 
# 338
psi = (field[1]); 
# 342
(mu[0]) = ((((((((fe->param)->a) * phi) + (((((fe->param)->b) * phi) * phi) * phi)) - (((fe->param)->kappa) * (delsq[0]))) + ((((fe->param)->w) * phi) * psi)) + (((fe->param)->epsilon) * ((psi * (delsq[0])) + dot_product(grad[0], grad[1])))) + ((((fe->param)->beta) * psi) * ((psi * (delsq[0])) + ((2.0) * dot_product(grad[0], grad[1]))))); 
# 350
(psi > (0.0)) ? static_cast< void>(0) : __assert_fail("psi > 0.0", "surfactant.c", 350, __PRETTY_FUNCTION__); 
# 351
(psi < (1.0)) ? static_cast< void>(0) : __assert_fail("psi < 1.0", "surfactant.c", 351, __PRETTY_FUNCTION__); 
# 353
(mu[1]) = ((((((fe->param)->kt) * (log(psi) - log((1.0) - psi))) + ((((0.5) * ((fe->param)->w)) * phi) * phi)) - (((0.5) * ((fe->param)->epsilon)) * dot_product(grad[0], grad[0]))) - ((((fe->param)->beta) * psi) * dot_product(grad[0], grad[0]))); 
# 358
return 0; 
# 359
} 
# 381 "surfactant.c"
int fe_surfactant1_str(fe_surfactant1_t *fe, int index, double 
# 382
s[3][3]) { 
# 383
int ia, ib; 
...
# 392
(fe) ? static_cast< void>(0) : __assert_fail("fe", "surfactant.c", 392, __PRETTY_FUNCTION__); 
# 394
field_scalar_array(fe->phi, index, field); 
# 397
(delsq[0]) = (0.0); (delsq[1]) = (0.0); 
# 398
(0) ? static_cast< void>(0) : __assert_fail("0", "surfactant.c", 398, __PRETTY_FUNCTION__); 
# 399
phi = (field[0]); 
# 400
psi = (field[1]); 
# 402
(psi < (1.0)) ? static_cast< void>(0) : __assert_fail("psi < 1.0", "surfactant.c", 402, __PRETTY_FUNCTION__); 
# 404
p0 = ((((((((((0.5) * ((fe->param)->a)) * phi) * phi) + ((((((0.75) * ((fe->param)->b)) * phi) * phi) * phi) * phi)) - (((fe->param)->kappa) * ((phi * (delsq[0])) - ((0.5) * dot_product(grad[0], grad[0]))))) - (((fe->param)->kt) * log((1.0) - psi))) + (((((fe->param)->w) * psi) * phi) * phi)) + ((((fe->param)->epsilon) * phi) * (dot_product(grad[0], grad[1]) + (psi * (delsq[0]))))) + ((((fe->param)->beta) * psi) * (((((2.0) * phi) * dot_product(grad[0], grad[1])) + ((phi * psi) * (delsq[0]))) - (((0.5) * psi) * dot_product(grad[0], grad[0]))))); 
# 413
for (ia = 0; ia < 3; ia++) { 
# 414
for (ib = 0; ib < 3; ib++) { 
# 415
((s[ia])[ib]) = ((p0 * ((d[ia])[ib])) + ((((((fe->param)->kappa) - (((fe->param)->epsilon) * psi)) - ((((fe->param)->beta) * psi) * psi)) * ((grad[0])[ia])) * ((grad[0])[ib]))); 
# 418
}  
# 419
}  
...
# 1 "surfactant.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__18_surfactant_cpp1_ii_d2049387
# 1 "surfactant.cudafe1.stub.c"
#include "surfactant.cudafe1.stub.c"
# 1 "surfactant.cudafe1.stub.c"
