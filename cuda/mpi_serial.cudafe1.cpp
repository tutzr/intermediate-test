...
# 52
static mpi_info_t *mpi_info = (__null); 
# 54
...
int MPI_Barrier(MPI_Comm comm) { 
# 66
(mpi_is_valid_comm(comm)) ? static_cast< void>(0) : __assert_fail("mpi_is_valid_comm(comm)", "mpi_serial.c", 66, __PRETTY_FUNCTION__); 
# 68
return MPI_SUCCESS; 
# 69
} 
...
comm) { 
# 82
(mpi_info->initialised) ? static_cast< void>(0) : __assert_fail("mpi_info->initialised", "mpi_serial.c", 82, __PRETTY_FUNCTION__); 
# 83
(buffer) ? static_cast< void>(0) : __assert_fail("buffer", "mpi_serial.c", 83, __PRETTY_FUNCTION__); 
# 84
(count > 0) ? static_cast< void>(0) : __assert_fail("count > 0", "mpi_serial.c", 84, __PRETTY_FUNCTION__); 
# 85
(mpi_is_valid_comm(comm)) ? static_cast< void>(0) : __assert_fail("mpi_is_valid_comm(comm)", "mpi_serial.c", 85, __PRETTY_FUNCTION__); 
# 87
return MPI_SUCCESS; 
# 88
} 
...
int MPI_Init(int *argc, char ***argv) { 
# 98
(argc) ? static_cast< void>(0) : __assert_fail("argc", "mpi_serial.c", 98, __PRETTY_FUNCTION__); 
# 99
(argv) ? static_cast< void>(0) : __assert_fail("argv", "mpi_serial.c", 99, __PRETTY_FUNCTION__); 
# 101
mpi_info = ((mpi_info_t *)calloc(1, sizeof(mpi_info_t))); 
# 102
(mpi_info) ? static_cast< void>(0) : __assert_fail("mpi_info", "mpi_serial.c", 102, __PRETTY_FUNCTION__); 
# 104
...
int MPI_Initialized(int *flag) { 
# 117
(flag) ? static_cast< void>(0) : __assert_fail("flag", "mpi_serial.c", 117, __PRETTY_FUNCTION__); 
# 119
(*flag) = (mpi_info != (__null)); 
# 121
return MPI_SUCCESS; 
# 122
} 
...
int MPI_Finalize() { 
# 132
(mpi_info) ? static_cast< void>(0) : __assert_fail("mpi_info", "mpi_serial.c", 132, __PRETTY_FUNCTION__); 
# 133
free(mpi_info); 
# 135
return MPI_SUCCESS; 
...
# 146
(mpi_is_valid_comm(comm)) ? static_cast< void>(0) : __assert_fail("mpi_is_valid_comm(comm)", "mpi_serial.c", 146, __PRETTY_FUNCTION__); 
# 147
(group) ? static_cast< void>(0) : __assert_fail("group", "mpi_serial.c", 147, __PRETTY_FUNCTION__); 
# 149
(*group) = 0; 
# 151
return MPI_SUCCESS; 
...
int MPI_Comm_rank(MPI_Comm comm, int *rank) { 
# 162
(mpi_is_valid_comm(comm)) ? static_cast< void>(0) : __assert_fail("mpi_is_valid_comm(comm)", "mpi_serial.c", 162, __PRETTY_FUNCTION__); 
# 163
(rank) ? static_cast< void>(0) : __assert_fail("rank", "mpi_serial.c", 163, __PRETTY_FUNCTION__); 
# 165
(*rank) = 0; 
# 167
return MPI_SUCCESS; 
...
int MPI_Comm_size(MPI_Comm comm, int *size) { 
# 178
(mpi_is_valid_comm(comm)) ? static_cast< void>(0) : __assert_fail("mpi_is_valid_comm(comm)", "mpi_serial.c", 178, __PRETTY_FUNCTION__); 
# 179
(size) ? static_cast< void>(0) : __assert_fail("size", "mpi_serial.c", 179, __PRETTY_FUNCTION__); 
# 181
(*size) = 1; 
# 183
return MPI_SUCCESS; 
...
double MPI_Wtime() { 
# 212
return ((double)clock()) * ((1.0) / (1000000L)); 
# 213
} 
# 221
double MPI_Wtick() { 
...
tag, MPI_Comm comm) { 
# 235
(buf) ? static_cast< void>(0) : __assert_fail("buf", "mpi_serial.c", 235, __PRETTY_FUNCTION__); 
# 237
...
# 252
(buf) ? static_cast< void>(0) : __assert_fail("buf", "mpi_serial.c", 252, __PRETTY_FUNCTION__); 
# 253
(status) ? static_cast< void>(0) : __assert_fail("status", "mpi_serial.c", 253, __PRETTY_FUNCTION__); 
# 255
...
# 270
(buf) ? static_cast< void>(0) : __assert_fail("buf", "mpi_serial.c", 270, __PRETTY_FUNCTION__); 
# 271
(request) ? static_cast< void>(0) : __assert_fail("request", "mpi_serial.c", 271, __PRETTY_FUNCTION__); 
# 273
...
tag, MPI_Comm comm) { 
# 289
(buf) ? static_cast< void>(0) : __assert_fail("buf", "mpi_serial.c", 289, __PRETTY_FUNCTION__); 
# 291
...
tag, MPI_Comm comm, MPI_Request *request) { 
# 306
(buf) ? static_cast< void>(0) : __assert_fail("buf", "mpi_serial.c", 306, __PRETTY_FUNCTION__); 
# 307
(request) ? static_cast< void>(0) : __assert_fail("request", "mpi_serial.c", 307, __PRETTY_FUNCTION__); 
# 309
...
tag, MPI_Comm comm, MPI_Request *request) { 
# 324
(buf) ? static_cast< void>(0) : __assert_fail("buf", "mpi_serial.c", 324, __PRETTY_FUNCTION__); 
# 325
(count >= 0) ? static_cast< void>(0) : __assert_fail("count >= 0", "mpi_serial.c", 325, __PRETTY_FUNCTION__); 
# 326
(dest == 0) ? static_cast< void>(0) : __assert_fail("dest == 0", "mpi_serial.c", 326, __PRETTY_FUNCTION__); 
# 327
(mpi_is_valid_comm(comm)) ? static_cast< void>(0) : __assert_fail("mpi_is_valid_comm(comm)", "mpi_serial.c", 327, __PRETTY_FUNCTION__); 
# 328
(request) ? static_cast< void>(0) : __assert_fail("request", "mpi_serial.c", 328, __PRETTY_FUNCTION__); 
# 330
...
# 344
(count >= 0) ? static_cast< void>(0) : __assert_fail("count >= 0", "mpi_serial.c", 344, __PRETTY_FUNCTION__); 
# 345
(requests) ? static_cast< void>(0) : __assert_fail("requests", "mpi_serial.c", 345, __PRETTY_FUNCTION__); 
# 346
(statuses) ? static_cast< void>(0) : __assert_fail("statuses", "mpi_serial.c", 346, __PRETTY_FUNCTION__); 
# 348
return MPI_SUCCESS; 
# 349
} 
...
statuses) { 
# 361
(count >= 0) ? static_cast< void>(0) : __assert_fail("count >= 0", "mpi_serial.c", 361, __PRETTY_FUNCTION__); 
# 362
(requests) ? static_cast< void>(0) : __assert_fail("requests", "mpi_serial.c", 362, __PRETTY_FUNCTION__); 
# 363
(index) ? static_cast< void>(0) : __assert_fail("index", "mpi_serial.c", 363, __PRETTY_FUNCTION__); 
# 364
(statuses) ? static_cast< void>(0) : __assert_fail("statuses", "mpi_serial.c", 364, __PRETTY_FUNCTION__); 
# 366
return MPI_SUCCESS; 
# 367
} 
...
int MPI_Probe(int source, int tag, MPI_Comm comm, MPI_Status *status) { 
# 378
(source == 0) ? static_cast< void>(0) : __assert_fail("source == 0", "mpi_serial.c", 378, __PRETTY_FUNCTION__); 
# 379
(mpi_is_valid_comm(comm)) ? static_cast< void>(0) : __assert_fail("mpi_is_valid_comm(comm)", "mpi_serial.c", 379, __PRETTY_FUNCTION__); 
# 380
(status) ? static_cast< void>(0) : __assert_fail("status", "mpi_serial.c", 380, __PRETTY_FUNCTION__); 
# 382
...
# 395
dest, int sendtag, void *recvbuf, int recvcount, MPI_Datatype 
# 396
recvtype, int source, int recvtag, MPI_Comm 
# 397
comm, MPI_Status *status) { 
# 399
(sendbuf) ? static_cast< void>(0) : __assert_fail("sendbuf", "mpi_serial.c", 399, __PRETTY_FUNCTION__); 
# 400
(dest == source) ? static_cast< void>(0) : __assert_fail("dest == source", "mpi_serial.c", 400, __PRETTY_FUNCTION__); 
# 401
(recvbuf) ? static_cast< void>(0) : __assert_fail("recvbuf", "mpi_serial.c", 401, __PRETTY_FUNCTION__); 
# 402
(recvcount == sendcount) ? static_cast< void>(0) : __assert_fail("recvcount == sendcount", "mpi_serial.c", 402, __PRETTY_FUNCTION__); 
# 403
(status) ? static_cast< void>(0) : __assert_fail("status", "mpi_serial.c", 403, __PRETTY_FUNCTION__); 
# 405
...
# 420
(sendbuf) ? static_cast< void>(0) : __assert_fail("sendbuf", "mpi_serial.c", 420, __PRETTY_FUNCTION__); 
# 421
(recvbuf) ? static_cast< void>(0) : __assert_fail("recvbuf", "mpi_serial.c", 421, __PRETTY_FUNCTION__); 
# 422
(count >= 0) ? static_cast< void>(0) : __assert_fail("count >= 0", "mpi_serial.c", 422, __PRETTY_FUNCTION__); 
# 423
(root == 0) ? static_cast< void>(0) : __assert_fail("root == 0", "mpi_serial.c", 423, __PRETTY_FUNCTION__); 
# 424
(mpi_is_valid_comm(comm)) ? static_cast< void>(0) : __assert_fail("mpi_is_valid_comm(comm)", "mpi_serial.c", 424, __PRETTY_FUNCTION__); 
# 427
...
comm) { 
# 442
(mpi_info) ? static_cast< void>(0) : __assert_fail("mpi_info", "mpi_serial.c", 442, __PRETTY_FUNCTION__); 
# 443
(sendbuf) ? static_cast< void>(0) : __assert_fail("sendbuf", "mpi_serial.c", 443, __PRETTY_FUNCTION__); 
# 444
(recvbuf) ? static_cast< void>(0) : __assert_fail("recvbuf", "mpi_serial.c", 444, __PRETTY_FUNCTION__); 
# 445
(sendcount == recvcount) ? static_cast< void>(0) : __assert_fail("sendcount == recvcount", "mpi_serial.c", 445, __PRETTY_FUNCTION__); 
# 446
(sendtype == recvtype) ? static_cast< void>(0) : __assert_fail("sendtype == recvtype", "mpi_serial.c", 446, __PRETTY_FUNCTION__); 
# 447
(mpi_is_valid_comm(comm)) ? static_cast< void>(0) : __assert_fail("mpi_is_valid_comm(comm)", "mpi_serial.c", 447, __PRETTY_FUNCTION__); 
# 449
...
root, MPI_Comm comm) { 
# 464
(mpi_info) ? static_cast< void>(0) : __assert_fail("mpi_info", "mpi_serial.c", 464, __PRETTY_FUNCTION__); 
# 465
(sendbuf) ? static_cast< void>(0) : __assert_fail("sendbuf", "mpi_serial.c", 465, __PRETTY_FUNCTION__); 
# 466
(recvbuf) ? static_cast< void>(0) : __assert_fail("recvbuf", "mpi_serial.c", 466, __PRETTY_FUNCTION__); 
# 467
(sendcount == recvcount) ? static_cast< void>(0) : __assert_fail("sendcount == recvcount", "mpi_serial.c", 467, __PRETTY_FUNCTION__); 
# 468
(sendtype == recvtype) ? static_cast< void>(0) : __assert_fail("sendtype == recvtype", "mpi_serial.c", 468, __PRETTY_FUNCTION__); 
# 469
(mpi_is_valid_comm(comm)) ? static_cast< void>(0) : __assert_fail("mpi_is_valid_comm(comm)", "mpi_serial.c", 469, __PRETTY_FUNCTION__); 
# 471
mpi_copy(sendbuf, recvbuf, sendcount, sendtype); 
# 473
return MPI_SUCCESS; 
...
# 484 "mpi_serial.c"
int MPI_Gatherv(const void *sendbuf, int sendcount, MPI_Datatype sendtype, void *
# 485
recvbuf, const int *recvcounts, const int *displ, MPI_Datatype 
# 486
recvtype, int root, MPI_Comm comm) { 
# 488
(sendbuf) ? static_cast< void>(0) : __assert_fail("sendbuf", "mpi_serial.c", 488, __PRETTY_FUNCTION__); 
# 489
(recvbuf) ? static_cast< void>(0) : __assert_fail("recvbuf", "mpi_serial.c", 489, __PRETTY_FUNCTION__); 
# 490
(root == 0) ? static_cast< void>(0) : __assert_fail("root == 0", "mpi_serial.c", 490, __PRETTY_FUNCTION__); 
# 491
(sendtype == recvtype) ? static_cast< void>(0) : __assert_fail("sendtype == recvtype", "mpi_serial.c", 491, __PRETTY_FUNCTION__); 
# 492
(sendcount == (recvcounts[0])) ? static_cast< void>(0) : __assert_fail("sendcount == recvcounts[0]", "mpi_serial.c", 492, __PRETTY_FUNCTION__); 
# 494
...
# 505
int MPI_Allreduce(void *sendbuf, void *recvbuf, int count, MPI_Datatype type, MPI_Op 
# 506
op, MPI_Comm comm) { 
# 508
(sendbuf) ? static_cast< void>(0) : __assert_fail("sendbuf", "mpi_serial.c", 508, __PRETTY_FUNCTION__); 
# 509
(recvbuf) ? static_cast< void>(0) : __assert_fail("recvbuf", "mpi_serial.c", 509, __PRETTY_FUNCTION__); 
# 510
(count >= 1) ? static_cast< void>(0) : __assert_fail("count >= 1", "mpi_serial.c", 510, __PRETTY_FUNCTION__); 
# 511
(mpi_is_valid_comm(comm)) ? static_cast< void>(0) : __assert_fail("mpi_is_valid_comm(comm)", "mpi_serial.c", 511, __PRETTY_FUNCTION__); 
# 513
if (sendbuf != ((void *)1)) { 
# 514
mpi_copy(sendbuf, recvbuf, count, type); 
...
int MPI_Comm_split(MPI_Comm comm, int colour, int key, MPI_Comm *newcomm) { 
# 530
(mpi_is_valid_comm(comm)) ? static_cast< void>(0) : __assert_fail("mpi_is_valid_comm(comm)", "mpi_serial.c", 530, __PRETTY_FUNCTION__); 
# 531
(newcomm) ? static_cast< void>(0) : __assert_fail("newcomm", "mpi_serial.c", 531, __PRETTY_FUNCTION__); 
# 533
(*newcomm) = comm; 
# 535
return MPI_SUCCESS; 
...
int MPI_Comm_dup(MPI_Comm oldcomm, MPI_Comm *newcomm) { 
# 565
(mpi_info) ? static_cast< void>(0) : __assert_fail("mpi_info", "mpi_serial.c", 565, __PRETTY_FUNCTION__); 
# 566
(mpi_is_valid_comm(oldcomm)) ? static_cast< void>(0) : __assert_fail("mpi_is_valid_comm(oldcomm)", "mpi_serial.c", 566, __PRETTY_FUNCTION__); 
# 567
(newcomm) ? static_cast< void>(0) : __assert_fail("newcomm", "mpi_serial.c", 567, __PRETTY_FUNCTION__); 
# 569
(*newcomm) = oldcomm; 
# 571
return MPI_SUCCESS; 
...
newtype) { 
# 584
(count > 0) ? static_cast< void>(0) : __assert_fail("count > 0", "mpi_serial.c", 584, __PRETTY_FUNCTION__); 
# 585
(array_of_blocklengths) ? static_cast< void>(0) : __assert_fail("array_of_blocklengths", "mpi_serial.c", 585, __PRETTY_FUNCTION__); 
# 586
(array_of_displacements) ? static_cast< void>(0) : __assert_fail("array_of_displacements", "mpi_serial.c", 586, __PRETTY_FUNCTION__); 
# 587
(newtype) ? static_cast< void>(0) : __assert_fail("newtype", "mpi_serial.c", 587, __PRETTY_FUNCTION__); 
# 589
(*newtype) = (-999); 
# 591
return MPI_SUCCESS; 
...
# 602
(count > 0) ? static_cast< void>(0) : __assert_fail("count > 0", "mpi_serial.c", 602, __PRETTY_FUNCTION__); 
# 603
(newtype) ? static_cast< void>(0) : __assert_fail("newtype", "mpi_serial.c", 603, __PRETTY_FUNCTION__); 
# 605
(*newtype) = (-999); 
# 607
return MPI_SUCCESS; 
...
# 618
(type) ? static_cast< void>(0) : __assert_fail("type", "mpi_serial.c", 618, __PRETTY_FUNCTION__); 
# 621
(*type) = (-999); 
# 623
return MPI_SUCCESS; 
...
# 634
(type) ? static_cast< void>(0) : __assert_fail("type", "mpi_serial.c", 634, __PRETTY_FUNCTION__); 
# 636
(*type) = (-3); 
# 638
return MPI_SUCCESS; 
...
# 650
(count > 0) ? static_cast< void>(0) : __assert_fail("count > 0", "mpi_serial.c", 650, __PRETTY_FUNCTION__); 
# 651
(blocklength >= 0) ? static_cast< void>(0) : __assert_fail("blocklength >= 0", "mpi_serial.c", 651, __PRETTY_FUNCTION__); 
# 652
(newtype) ? static_cast< void>(0) : __assert_fail("newtype", "mpi_serial.c", 652, __PRETTY_FUNCTION__); 
# 654
(*newtype) = (-999); 
# 656
return MPI_SUCCESS; 
...
# 669
(count > 0) ? static_cast< void>(0) : __assert_fail("count > 0", "mpi_serial.c", 669, __PRETTY_FUNCTION__); 
# 670
(array_of_blocklengths) ? static_cast< void>(0) : __assert_fail("array_of_blocklengths", "mpi_serial.c", 670, __PRETTY_FUNCTION__); 
# 671
(array_of_displacements) ? static_cast< void>(0) : __assert_fail("array_of_displacements", "mpi_serial.c", 671, __PRETTY_FUNCTION__); 
# 672
(array_of_types) ? static_cast< void>(0) : __assert_fail("array_of_types", "mpi_serial.c", 672, __PRETTY_FUNCTION__); 
# 673
(newtype) ? static_cast< void>(0) : __assert_fail("newtype", "mpi_serial.c", 673, __PRETTY_FUNCTION__); 
# 675
(*newtype) = (-999); 
# 677
return MPI_SUCCESS; 
...
int MPI_Address(void *location, MPI_Aint *address) { 
# 690
(location) ? static_cast< void>(0) : __assert_fail("location", "mpi_serial.c", 690, __PRETTY_FUNCTION__); 
# 691
(address) ? static_cast< void>(0) : __assert_fail("address", "mpi_serial.c", 691, __PRETTY_FUNCTION__); 
# 693
(*address) = 0; 
# 695
return MPI_SUCCESS; 
...
int MPI_Errhandler_set(MPI_Comm comm, MPI_Errhandler errhandler) { 
# 706
(mpi_info) ? static_cast< void>(0) : __assert_fail("mpi_info", "mpi_serial.c", 706, __PRETTY_FUNCTION__); 
# 707
(comm != (-2)) ? static_cast< void>(0) : __assert_fail("comm != -2", "mpi_serial.c", 707, __PRETTY_FUNCTION__); 
# 708
(errhandler == (MPI_ERRORS_ARE_FATAL)) ? static_cast< void>(0) : __assert_fail("errhandler == MPI_ERRORS_ARE_FATAL", "mpi_serial.c", 708, __PRETTY_FUNCTION__); 
# 710
return MPI_SUCCESS; 
# 711
} 
# 719
int MPI_Cart_create(MPI_Comm oldcomm, int ndims, int *dims, int *periods, int 
# 720
...
int icart; 
# 725
(mpi_info) ? static_cast< void>(0) : __assert_fail("mpi_info", "mpi_serial.c", 725, __PRETTY_FUNCTION__); 
# 726
(ndims <= 3) ? static_cast< void>(0) : __assert_fail("ndims <= 3", "mpi_serial.c", 726, __PRETTY_FUNCTION__); 
# 727
(newcomm) ? static_cast< void>(0) : __assert_fail("newcomm", "mpi_serial.c", 727, __PRETTY_FUNCTION__); 
# 729
(mpi_info->ncart) += 1; 
# 730
icart = ((MPI_COMM_SELF) + (mpi_info->ncart)); 
# 731
(icart < 16) ? static_cast< void>(0) : __assert_fail("icart < 16", "mpi_serial.c", 731, __PRETTY_FUNCTION__); 
# 733
(*newcomm) = icart; 
# 737
for (n = 0; n < ndims; n++) { 
...
int n; 
# 757
(mpi_info) ? static_cast< void>(0) : __assert_fail("mpi_info", "mpi_serial.c", 757, __PRETTY_FUNCTION__); 
# 758
(mpi_is_valid_comm(comm)) ? static_cast< void>(0) : __assert_fail("mpi_is_valid_comm(comm)", "mpi_serial.c", 758, __PRETTY_FUNCTION__); 
# 759
(dims) ? static_cast< void>(0) : __assert_fail("dims", "mpi_serial.c", 759, __PRETTY_FUNCTION__); 
# 760
(periods) ? static_cast< void>(0) : __assert_fail("periods", "mpi_serial.c", 760, __PRETTY_FUNCTION__); 
# 761
(coords) ? static_cast< void>(0) : __assert_fail("coords", "mpi_serial.c", 761, __PRETTY_FUNCTION__); 
# 763
for (n = 0; n < maxdims; n++) { 
# 764
(dims[n]) = 1; 
...
int d; 
# 782
(mpi_info) ? static_cast< void>(0) : __assert_fail("mpi_info", "mpi_serial.c", 782, __PRETTY_FUNCTION__); 
# 783
(comm != (-2)) ? static_cast< void>(0) : __assert_fail("comm != -2", "mpi_serial.c", 783, __PRETTY_FUNCTION__); 
# 784
(rank == 0) ? static_cast< void>(0) : __assert_fail("rank == 0", "mpi_serial.c", 784, __PRETTY_FUNCTION__); 
# 785
(coords) ? static_cast< void>(0) : __assert_fail("coords", "mpi_serial.c", 785, __PRETTY_FUNCTION__); 
# 787
for (d = 0; d < maxdims; d++) { 
# 788
(coords[d]) = 0; 
...
int MPI_Cart_rank(MPI_Comm comm, int *coords, int *rank) { 
# 804
(mpi_info) ? static_cast< void>(0) : __assert_fail("mpi_info", "mpi_serial.c", 804, __PRETTY_FUNCTION__); 
# 805
(mpi_is_valid_comm(comm)) ? static_cast< void>(0) : __assert_fail("mpi_is_valid_comm(comm)", "mpi_serial.c", 805, __PRETTY_FUNCTION__); 
# 806
(coords) ? static_cast< void>(0) : __assert_fail("coords", "mpi_serial.c", 806, __PRETTY_FUNCTION__); 
# 807
(rank) ? static_cast< void>(0) : __assert_fail("rank", "mpi_serial.c", 807, __PRETTY_FUNCTION__); 
# 809
(*rank) = 0; 
# 811
return MPI_SUCCESS; 
...
rank_dest) { 
# 823
(mpi_info) ? static_cast< void>(0) : __assert_fail("mpi_info", "mpi_serial.c", 823, __PRETTY_FUNCTION__); 
# 824
(comm != (-2)) ? static_cast< void>(0) : __assert_fail("comm != -2", "mpi_serial.c", 824, __PRETTY_FUNCTION__); 
# 825
(rank_source) ? static_cast< void>(0) : __assert_fail("rank_source", "mpi_serial.c", 825, __PRETTY_FUNCTION__); 
# 826
(rank_dest) ? static_cast< void>(0) : __assert_fail("rank_dest", "mpi_serial.c", 826, __PRETTY_FUNCTION__); 
# 828
(*rank_source) = 0; 
# 829
(*rank_dest) = 0; 
...
int MPI_Cart_sub(MPI_Comm comm, int *remain_dims, MPI_Comm *new_comm) { 
# 848
(mpi_info) ? static_cast< void>(0) : __assert_fail("mpi_info", "mpi_serial.c", 848, __PRETTY_FUNCTION__); 
# 849
(mpi_is_valid_comm(comm)) ? static_cast< void>(0) : __assert_fail("mpi_is_valid_comm(comm)", "mpi_serial.c", 849, __PRETTY_FUNCTION__); 
# 850
(remain_dims) ? static_cast< void>(0) : __assert_fail("remain_dims", "mpi_serial.c", 850, __PRETTY_FUNCTION__); 
# 851
(new_comm) ? static_cast< void>(0) : __assert_fail("new_comm", "mpi_serial.c", 851, __PRETTY_FUNCTION__); 
# 853
(*new_comm) = comm; 
# 855
return MPI_SUCCESS; 
...
int d; 
# 868
(mpi_info) ? static_cast< void>(0) : __assert_fail("mpi_info", "mpi_serial.c", 868, __PRETTY_FUNCTION__); 
# 869
(nnodes == 1) ? static_cast< void>(0) : __assert_fail("nnodes == 1", "mpi_serial.c", 869, __PRETTY_FUNCTION__); 
# 870
(ndims > 0) ? static_cast< void>(0) : __assert_fail("ndims > 0", "mpi_serial.c", 870, __PRETTY_FUNCTION__); 
# 871
(dims) ? static_cast< void>(0) : __assert_fail("dims", "mpi_serial.c", 871, __PRETTY_FUNCTION__); 
# 873
for (d = 0; d < ndims; d++) { 
# 874
(dims[d]) = 1; 
...
# 890
(send) ? static_cast< void>(0) : __assert_fail("send", "mpi_serial.c", 890, __PRETTY_FUNCTION__); 
# 891
(recv) ? static_cast< void>(0) : __assert_fail("recv", "mpi_serial.c", 891, __PRETTY_FUNCTION__); 
# 892
(count >= 0) ? static_cast< void>(0) : __assert_fail("count >= 0", "mpi_serial.c", 892, __PRETTY_FUNCTION__); 
# 894
...
# 965
(mpi_info) ? static_cast< void>(0) : __assert_fail("mpi_info", "mpi_serial.c", 965, __PRETTY_FUNCTION__); 
# 966
(mpi_is_valid_comm(comm)) ? static_cast< void>(0) : __assert_fail("mpi_is_valid_comm(comm)", "mpi_serial.c", 966, __PRETTY_FUNCTION__); 
# 967
(errhandler == (MPI_ERRORS_ARE_FATAL)) ? static_cast< void>(0) : __assert_fail("errhandler == MPI_ERRORS_ARE_FATAL", "mpi_serial.c", 967, __PRETTY_FUNCTION__); 
# 969
return MPI_SUCCESS; 
# 970
} 
...
int MPI_Get_address(const void *location, MPI_Aint *address) { 
# 1014
(location) ? static_cast< void>(0) : __assert_fail("location", "mpi_serial.c", 1014, __PRETTY_FUNCTION__); 
# 1015
(address) ? static_cast< void>(0) : __assert_fail("address", "mpi_serial.c", 1015, __PRETTY_FUNCTION__); 
# 1017
(*address) = 0; 
# 1019
return MPI_SUCCESS; 
...
# 1028
int MPI_Group_translate_ranks(MPI_Group grp1, int n, const int *ranks1, MPI_Group 
# 1029
grp2, int *ranks2) { 
# 1030
(ranks1) ? static_cast< void>(0) : __assert_fail("ranks1", "mpi_serial.c", 1030, __PRETTY_FUNCTION__); 
# 1031
(ranks2) ? static_cast< void>(0) : __assert_fail("ranks2", "mpi_serial.c", 1031, __PRETTY_FUNCTION__); 
# 1033
...
# 1044
int MPI_Type_create_resized(MPI_Datatype oldtype, MPI_Aint lb, MPI_Aint extent, MPI_Datatype *
# 1045
newtype) { 
# 1047
(newtype) ? static_cast< void>(0) : __assert_fail("newtype", "mpi_serial.c", 1047, __PRETTY_FUNCTION__); 
# 1049
(*newtype) = oldtype; 
# 1051
return MPI_SUCCESS; 
...
# 1062 "mpi_serial.c"
int MPI_Type_create_struct(int count, int array_of_blocklengths[], const MPI_Aint 
# 1063
...
newtype) { 
# 1067
(count > 0) ? static_cast< void>(0) : __assert_fail("count > 0", "mpi_serial.c", 1067, __PRETTY_FUNCTION__); 
# 1068
(array_of_blocklengths) ? static_cast< void>(0) : __assert_fail("array_of_blocklengths", "mpi_serial.c", 1068, __PRETTY_FUNCTION__); 
# 1069
(array_of_displacements) ? static_cast< void>(0) : __assert_fail("array_of_displacements", "mpi_serial.c", 1069, __PRETTY_FUNCTION__); 
# 1070
(array_of_types) ? static_cast< void>(0) : __assert_fail("array_of_types", "mpi_serial.c", 1070, __PRETTY_FUNCTION__); 
# 1071
(newtype) ? static_cast< void>(0) : __assert_fail("newtype", "mpi_serial.c", 1071, __PRETTY_FUNCTION__); 
# 1073
(*newtype) = (-999); 
# 1075
return MPI_SUCCESS; 
...
# 1084
int MPI_Type_get_extent(MPI_Datatype datatype, MPI_Aint *lb, MPI_Aint *
# 1085
extent) { 
# 1087
(lb) ? static_cast< void>(0) : __assert_fail("lb", "mpi_serial.c", 1087, __PRETTY_FUNCTION__); 
# 1088
(extent) ? static_cast< void>(0) : __assert_fail("extent", "mpi_serial.c", 1088, __PRETTY_FUNCTION__); 
# 1090
(*lb) = 0; 
# 1091
(*extent) = (-1); 
...
# 1106
if ((comm < (MPI_COMM_WORLD)) || (comm >= 16)) { return 0; }  
# 1108
return 1; 
# 1109
} 

# 1 "mpi_serial.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__18_mpi_serial_cpp1_ii_82e72b30
# 1 "mpi_serial.cudafe1.stub.c"
#include "mpi_serial.cudafe1.stub.c"
# 1 "mpi_serial.cudafe1.stub.c"
