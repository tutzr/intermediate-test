...
# 82 "nernst_planck.c"
int nernst_planck_fluxes_force_d3qx(psi_t * psi, fe_t * fe, hydro_t * hydro, map_t * map, colloids_info_t * cinfo, double ** flx); 
# 85
static int nernst_planck_fluxes(psi_t * psi, fe_t * fel, double * fe, double * fy, double * fz); 
# 88
static int nernst_planck_update(psi_t * psi, double * fe, double * fy, double * fz); 
# 90
static int nernst_planck_fluxes_d3qx(psi_t * psi, fe_t * fe, hydro_t * hydro, map_t * map, colloids_info_t * cinfo, double ** flx); 
# 92
...
double *fz = (__null); 
# 121
(0) ? static_cast< void>(0) : __assert_fail("0", "nernst_planck.c", 121, __PRETTY_FUNCTION__); 
# 123
psi_nk(psi, &nk); 
# 124
...
# 130
if (fe == (__null)) { pe_fatal(psi->pe, "calloc(fe) failed\n"); }  
# 131
if (fy == (__null)) { pe_fatal(psi->pe, "calloc(fy) failed\n"); }  
# 132
if (fz == (__null)) { pe_fatal(psi->pe, "calloc(fz) failed\n"); }  
# 139
if (hydro) { 
# 141
}  
...
# 182 "nernst_planck.c"
static int nernst_planck_fluxes(psi_t *psi, fe_t *fel, double *fe, double *
# 183
fy, double *
# 184
fz) { 
...
double mu_s0, mu_s1; 
# 198
(0) ? static_cast< void>(0) : __assert_fail("0", "nernst_planck.c", 198, __PRETTY_FUNCTION__); 
# 199
(psi) ? static_cast< void>(0) : __assert_fail("psi", "nernst_planck.c", 199, __PRETTY_FUNCTION__); 
# 200
(fe) ? static_cast< void>(0) : __assert_fail("fe", "nernst_planck.c", 200, __PRETTY_FUNCTION__); 
# 201
(fy) ? static_cast< void>(0) : __assert_fail("fy", "nernst_planck.c", 201, __PRETTY_FUNCTION__); 
# 202
(fz) ? static_cast< void>(0) : __assert_fail("fz", "nernst_planck.c", 202, __PRETTY_FUNCTION__); 
# 204
cs_nsites(psi->cs, &nsites); 
# 205
...
# 227
mu0 = (mu_s0 + ((((psi->valency)[n]) * eunit) * ((psi->psi)[reverse_addr_rank0_assert(228, "nernst_planck.c", nsites, index)]))); 
# 229
rho0 = ((psi->rho)[reverse_addr_rank1_assert(229, "nernst_planck.c", nsites, nk, index, n)]); 
# 233
((fel->func)->mu_solv)(fel, index + xs, n, &mu_s1); 
# 234
mu1 = (mu_s1 + ((((psi->valency)[n]) * eunit) * ((psi->psi)[reverse_addr_rank0_assert(235, "nernst_planck.c", nsites, index + xs)]))); 
# 237
b0 = exp((-beta) * (mu1 - mu0)); 
# 238
b1 = exp((+beta) * (mu1 - mu0)); 
# 239
rho1 = (((psi->rho)[reverse_addr_rank1_assert(239, "nernst_planck.c", nsites, nk, index + xs, n)]) * b1); 
# 241
(fe[reverse_addr_rank1_assert(241, "nernst_planck.c", nsites, nk, index, n)]) -= (((((psi->diffusivity)[n]) * (0.5)) * ((1.0) + b0)) * (rho1 - rho0)); 
# 246
((fel->func)->mu_solv)(fel, index + ys, n, &mu_s1); 
# 247
mu1 = (mu_s1 + ((((psi->valency)[n]) * eunit) * ((psi->psi)[reverse_addr_rank0_assert(248, "nernst_planck.c", nsites, index + ys)]))); 
# 250
b0 = exp((-beta) * (mu1 - mu0)); 
# 251
b1 = exp((+beta) * (mu1 - mu0)); 
# 252
rho1 = (((psi->rho)[reverse_addr_rank1_assert(252, "nernst_planck.c", nsites, nk, index + ys, n)]) * b1); 
# 254
(fy[(nk * index) + n]) -= (((((psi->diffusivity)[n]) * (0.5)) * ((1.0) + b0)) * (rho1 - rho0)); 
# 258
((fel->func)->mu_solv)(fel, index + zs, n, &mu_s1); 
# 259
mu1 = (mu_s1 + ((((psi->valency)[n]) * eunit) * ((psi->psi)[reverse_addr_rank0_assert(260, "nernst_planck.c", nsites, index + zs)]))); 
# 262
b0 = exp((-beta) * (mu1 - mu0)); 
# 263
b1 = exp((+beta) * (mu1 - mu0)); 
# 264
rho1 = (((psi->rho)[reverse_addr_rank1_assert(264, "nernst_planck.c", nsites, nk, index + zs, n)]) * b1); 
# 266
(fz[reverse_addr_rank1_assert(266, "nernst_planck.c", nsites, nk, index, n)]) -= (((((psi->diffusivity)[n]) * (0.5)) * ((1.0) + b0)) * (rho1 - rho0)); 
# 268
}  
# 271
}  
...
# 286 "nernst_planck.c"
static int nernst_planck_update(psi_t *psi, double *fe, double *fy, double *
# 287
fz) { 
# 288
int ic, jc, kc, index; 
...
double dt; 
# 295
(psi) ? static_cast< void>(0) : __assert_fail("psi", "nernst_planck.c", 295, __PRETTY_FUNCTION__); 
# 296
(fe) ? static_cast< void>(0) : __assert_fail("fe", "nernst_planck.c", 296, __PRETTY_FUNCTION__); 
# 297
(fy) ? static_cast< void>(0) : __assert_fail("fy", "nernst_planck.c", 297, __PRETTY_FUNCTION__); 
# 298
(fz) ? static_cast< void>(0) : __assert_fail("fz", "nernst_planck.c", 298, __PRETTY_FUNCTION__); 
# 300
cs_nlocal(psi->cs, nlocal); 
# 301
cs_strides(psi->cs, &xs, &ys, &zs); 
...
for (n = 0; n < nk; n++) { 
# 313
((psi->rho)[reverse_addr_rank1_assert(313, "nernst_planck.c", psi->nsites, nk, index, n)]) -= (((((((+(fe[reverse_addr_rank1_assert(314, "nernst_planck.c", psi->nsites, nk, index, n)])) - (fe[reverse_addr_rank1_assert(315, "nernst_planck.c", psi->nsites, nk, index - xs, n)])) + (fy[reverse_addr_rank1_assert(316, "nernst_planck.c", psi->nsites, nk, index, n)])) - (fy[reverse_addr_rank1_assert(317, "nernst_planck.c", psi->nsites, nk, index - ys, n)])) + (fz[reverse_addr_rank1_assert(318, "nernst_planck.c", psi->nsites, nk, index, n)])) - (fz[reverse_addr_rank1_assert(319, "nernst_planck.c", psi->nsites, nk, index - zs, n)])) * dt); 
# 320
}  
# 321
}  
...
# 340 "nernst_planck.c"
int nernst_planck_driver_d3qx(psi_t *psi, fe_t *fe, hydro_t *hydro, map_t *
# 341
...
# 352
(flx) ? static_cast< void>(0) : __assert_fail("flx", "nernst_planck.c", 352, __PRETTY_FUNCTION__); 
# 353
if (flx == (__null)) { pe_fatal(psi->pe, "calloc(flx) failed\n"); }  
# 355
for (ia = 0; ia < ((psi->nsites) * nk); ia++) { 
# 356
(flx[ia]) = ((double *)calloc(7 - 1, sizeof(double))); 
# 357
(flx[ia]) ? static_cast< void>(0) : __assert_fail("flx[ia]", "nernst_planck.c", 357, __PRETTY_FUNCTION__); 
# 358
if ((flx[ia]) == (__null)) { pe_fatal(psi->pe, "calloc(flx[]) failed\n"); }  
# 359
}  
# 362
...
# 395 "nernst_planck.c"
static int nernst_planck_fluxes_d3qx(psi_t *psi, fe_t *fe, hydro_t *hydro, map_t *
# 396
map, colloids_info_t *cinfo, double **
# 397
flx) { 
# 399
int ic, jc, kc; 
...
colloid_t *pc = (__null); 
# 417
(psi) ? static_cast< void>(0) : __assert_fail("psi", "nernst_planck.c", 417, __PRETTY_FUNCTION__); 
# 418
(fe) ? static_cast< void>(0) : __assert_fail("fe", "nernst_planck.c", 418, __PRETTY_FUNCTION__); 
# 419
((fe->func)->mu_solv) ? static_cast< void>(0) : __assert_fail("fe->func->mu_solv", "nernst_planck.c", 419, __PRETTY_FUNCTION__); 
# 420
(flx) ? static_cast< void>(0) : __assert_fail("flx", "nernst_planck.c", 420, __PRETTY_FUNCTION__); 
# 422
cs_nlocal(psi->cs, nlocal); 
# 424
psi_unit_charge(psi, &eunit); 
...
# 454
mu0 = ((reunit * mu_s0) + (((psi->valency)[n]) * ((psi->psi)[reverse_addr_rank0_assert(455, "nernst_planck.c", psi->nsites, index0)]))); 
# 456
rho0 = ((psi->rho)[reverse_addr_rank1_assert(456, "nernst_planck.c", psi->nsites, nk, index0, n)]); 
# 458
((fe->func)->mu_solv)(fe, index1, n, &mu_s1); 
# 459
mu1 = ((reunit * mu_s1) + (((psi->valency)[n]) * ((psi->psi)[reverse_addr_rank0_assert(460, "nernst_planck.c", psi->nsites, index1)]))); 
# 461
b0 = exp(mu0 - mu1); 
# 462
b1 = exp(mu1 - mu0); 
# 463
rho1 = (((psi->rho)[reverse_addr_rank1_assert(463, "nernst_planck.c", psi->nsites, nk, index1, n)]) * b1); 
# 465
((flx[reverse_addr_rank1_assert(465, "nernst_planck.c", psi->nsites, nk, index0, n)])[c - 1]) -= ((((((psi->diffusivity)[n]) * (0.5)) * ((1.0) + b0)) * (rho1 - rho0)) * (psi_gr_rnorm[c])); 
# 467
}  
# 468
}  
...
# 492 "nernst_planck.c"
int nernst_planck_fluxes_force_d3qx(psi_t *psi, fe_t *fe, hydro_t *hydro, map_t *
# 493
map, colloids_info_t *cinfo, double **
# 494
flx) { 
...
colloid_t *pc = (__null); 
# 521
(psi) ? static_cast< void>(0) : __assert_fail("psi", "nernst_planck.c", 521, __PRETTY_FUNCTION__); 
# 522
(flx) ? static_cast< void>(0) : __assert_fail("flx", "nernst_planck.c", 522, __PRETTY_FUNCTION__); 
# 524
cs_nsites(psi->cs, &nsites); 
# 525
cs_nlocal(psi->cs, nlocal); 
...
((fe->func)->mu_solv)(fe, index0, n, &mu_s0); 
# 574
mu0 = (mu_s0 + ((((psi->valency)[n]) * eunit) * ((psi->psi)[reverse_addr_rank0_assert(575, "nernst_planck.c", nsites, index0)]))); 
# 576
rho0 = ((psi->rho)[reverse_addr_rank1_assert(576, "nernst_planck.c", nsites, nk, index0, n)]); 
# 578
((fe->func)->mu_solv)(fe, index1, n, &mu_s1); 
# 579
mu1 = (mu_s1 + ((((psi->valency)[n]) * eunit) * ((psi->psi)[reverse_addr_rank0_assert(580, "nernst_planck.c", nsites, index1)]))); 
# 581
b0 = exp((-beta) * (mu1 - mu0)); 
# 582
b1 = exp((+beta) * (mu1 - mu0)); 
# 583
rho1 = (((psi->rho)[reverse_addr_rank1_assert(583, "nernst_planck.c", nsites, nk, index1, n)]) * b1); 
# 587
(flxtmp[0]) = ((((-(0.5)) * ((1.0) + b0)) * (rho1 - rho0)) * (psi_gr_rnorm[c])); 
# 588
(flxtmp[1]) = ((((psi->rho)[reverse_addr_rank1_assert(588, "nernst_planck.c", nsites, nk, index1, n)]) - ((psi->rho)[reverse_addr_rank1_assert(589, "nernst_planck.c", nsites, nk, index0, n)])) * (psi_gr_rnorm[c])); 
# 593
((flx[reverse_addr_rank1_assert(593, "nernst_planck.c", nsites, nk, index0, n)])[c - 1]) += (((psi->diffusivity)[n]) * (flxtmp[0])); 
# 596
...
double dt; 
# 684
(psi) ? static_cast< void>(0) : __assert_fail("psi", "nernst_planck.c", 684, __PRETTY_FUNCTION__); 
# 685
(flx) ? static_cast< void>(0) : __assert_fail("flx", "nernst_planck.c", 685, __PRETTY_FUNCTION__); 
# 687
cs_nsites(psi->cs, &nsites); 
# 688
cs_nlocal(psi->cs, nlocal); 
...
for (c = 1; c < 7; c++) { 
# 705
((psi->rho)[reverse_addr_rank1_assert(705, "nernst_planck.c", nsites, nk, index, n)]) -= (((flx[reverse_addr_rank1_assert(706, "nernst_planck.c", nsites, nk, index, n)])[c - 1]) * dt); 
# 707
acc += fabs(((flx[reverse_addr_rank1_assert(707, "nernst_planck.c", nsites, nk, index, n)])[c - 1]) * dt); 
# 708
}  
# 710
acc /= fabs((psi->rho)[reverse_addr_rank1_assert(710, "nernst_planck.c", nsites, nk, index, n)]); 
# 711
...
# 789
if (((*(maxacc)) < ((0.1000000000000000056) * diffacc)) && (diffacc > (0.0))) { 
# 791
psi_multisteps(psi, &multisteps); 
# 792
psi_nk(psi, &nk); 
...
# 800
if ((multisteps > 1) && ((diffmax / multisteps) < (0.05000000000000000278))) { 
# 801
multisteps *= (0.5); 
# 802
psi_multisteps_set(psi, multisteps); 
...
# 1 "nernst_planck.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__21_nernst_planck_cpp1_ii_08764160
# 1 "nernst_planck.cudafe1.stub.c"
#include "nernst_planck.cudafe1.stub.c"
# 1 "nernst_planck.cudafe1.stub.c"
