...
# 32 "io_info_args_rt.c"
int io_info_args_rt(pe_t *pe, rt_t *rt, const char *stub, io_info_rw_enum_t 
# 33
rw, io_info_args_t *args) { 
# 35
int iogrid[3] = {0}; 
# 36
int sz = ((3) * sizeof(int)); 
...
char stubo[8192] = {(0)}; 
# 40
(pe) ? static_cast< void>(0) : __assert_fail("pe", "io_info_args_rt.c", 40, __PRETTY_FUNCTION__); 
# 41
(rt) ? static_cast< void>(0) : __assert_fail("rt", "io_info_args_rt.c", 41, __PRETTY_FUNCTION__); 
# 42
(stub) ? static_cast< void>(0) : __assert_fail("stub", "io_info_args_rt.c", 42, __PRETTY_FUNCTION__); 
# 43
(args) ? static_cast< void>(0) : __assert_fail("args", "io_info_args_rt.c", 43, __PRETTY_FUNCTION__); 
# 45
(strlen(stub) < (8192 / 2)) ? static_cast< void>(0) : __assert_fail("strlen(stub) < 8192/2", "io_info_args_rt.c", 45, __PRETTY_FUNCTION__); 
# 46
(0) ? static_cast< void>(0) : __assert_fail("0", "io_info_args_rt.c", 46, __PRETTY_FUNCTION__); 
# 48
...
# 81 "io_info_args_rt.c"
int io_info_args_rt_iogrid(pe_t *pe, rt_t *rt, const char *key, int 
# 82
iogrid[3]) { 
# 84
int key_present = 0; 
...
int user_grid[3] = {0}; 
# 87
(pe) ? static_cast< void>(0) : __assert_fail("pe", "io_info_args_rt.c", 87, __PRETTY_FUNCTION__); 
# 88
(rt) ? static_cast< void>(0) : __assert_fail("rt", "io_info_args_rt.c", 88, __PRETTY_FUNCTION__); 
# 89
(key) ? static_cast< void>(0) : __assert_fail("key", "io_info_args_rt.c", 89, __PRETTY_FUNCTION__); 
# 91
...
# 1 "io_info_args_rt.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__23_io_info_args_rt_cpp1_ii_077e73f9
# 1 "io_info_args_rt.cudafe1.stub.c"
#include "io_info_args_rt.cudafe1.stub.c"
# 1 "io_info_args_rt.cudafe1.stub.c"
