...
int mpi_cartsz[3]; 
# 65
(lb) ? static_cast< void>(0) : __assert_fail("lb", "model_le.c", 65, __PRETTY_FUNCTION__); 
# 66
(le) ? static_cast< void>(0) : __assert_fail("le", "model_le.c", 66, __PRETTY_FUNCTION__); 
# 68
...
# 125
const double r2rcs4 = (4.5); 
# 127
(lb) ? static_cast< void>(0) : __assert_fail("lb", "model_le.c", 127, __PRETTY_FUNCTION__); 
# 128
(le) ? static_cast< void>(0) : __assert_fail("le", "model_le.c", 128, __PRETTY_FUNCTION__); 
# 129
((CVXBLOCK) == 1) ? static_cast< void>(0) : __assert_fail("CVXBLOCK == 1", "model_le.c", 129, __PRETTY_FUNCTION__); 
# 131
lb_ndist(lb, &ndist); 
# 132
...
physics_t *phys = (__null); 
# 238
(le) ? static_cast< void>(0) : __assert_fail("le", "model_le.c", 238, __PRETTY_FUNCTION__); 
# 239
(lb) ? static_cast< void>(0) : __assert_fail("lb", "model_le.c", 239, __PRETTY_FUNCTION__); 
# 240
((CVXBLOCK) == 1) ? static_cast< void>(0) : __assert_fail("CVXBLOCK == 1", "model_le.c", 240, __PRETTY_FUNCTION__); 
# 242
lb_ndist(lb, &ndist); 
# 243
nplane = lees_edw_nplane_local(le); 
...
physics_t *phys = (__null); 
# 345
(lb) ? static_cast< void>(0) : __assert_fail("lb", "model_le.c", 345, __PRETTY_FUNCTION__); 
# 346
(le) ? static_cast< void>(0) : __assert_fail("le", "model_le.c", 346, __PRETTY_FUNCTION__); 
# 348
...
# 365
(recv_buff) ? static_cast< void>(0) : __assert_fail("recv_buff", "model_le.c", 365, __PRETTY_FUNCTION__); 
# 366
if (recv_buff == (__null)) { pe_fatal(lb->pe, "malloc(recv_buff) failed\n"); }  
# 368
for (plane = 0; plane < nplane; plane++) { 
# 370
ic = lees_edw_plane_location(le, plane); 
...
# 393
(recv_buff[ndata++]) = ((((1.0) - fr) * ((lb->f)[reverse_addr_rank2_assert(394, "model_le.c", lb->nsite, ndist, NVEL, index0, n, pcv)])) + (fr * ((lb->f)[reverse_addr_rank2_assert(396, "model_le.c", lb->nsite, ndist, NVEL, index1, n, pcv)]))); 
# 397
}  
# 398
}  
...
int pcv = (xdisp_fwd_cv[0]) + p; 
# 414
((lb->f)[reverse_addr_rank2_assert(414, "model_le.c", lb->nsite, ndist, NVEL, index0, n, pcv)]) = (recv_buff[ndata++]); 
# 415
}  
# 416
}  
...
# 445
(recv_buff[ndata++]) = ((((1.0) - fr) * ((lb->f)[reverse_addr_rank2_assert(446, "model_le.c", lb->nsite, ndist, NVEL, index0, n, pcv)])) + (fr * ((lb->f)[reverse_addr_rank2_assert(447, "model_le.c", lb->nsite, ndist, NVEL, index1, n, pcv)]))); 
# 448
}  
# 449
}  
...
int pcv = (xdisp_bwd_cv[0]) + p; 
# 465
((lb->f)[reverse_addr_rank2_assert(465, "model_le.c", lb->nsite, ndist, NVEL, index0, n, pcv)]) = (recv_buff[ndata++]); 
# 466
}  
# 467
}  
...
MPI_Status status[4]; 
# 530
(lb) ? static_cast< void>(0) : __assert_fail("lb", "model_le.c", 530, __PRETTY_FUNCTION__); 
# 531
(le) ? static_cast< void>(0) : __assert_fail("le", "model_le.c", 531, __PRETTY_FUNCTION__); 
# 532
((CVXBLOCK) == 1) ? static_cast< void>(0) : __assert_fail("CVXBLOCK == 1", "model_le.c", 532, __PRETTY_FUNCTION__); 
# 534
lees_edw_ltot(le, ltot); 
# 535
...
# 551
(send_buff) ? static_cast< void>(0) : __assert_fail("send_buff", "model_le.c", 551, __PRETTY_FUNCTION__); 
# 552
if (send_buff == (__null)) { pe_fatal(lb->pe, "malloc(send_buff) failed\n"); }  
# 554
ndata = (((ndist * nprop) * ((nlocal[Y]) + 1)) * (nlocal[Z])); 
# 555
recv_buff = ((double *)malloc(ndata * sizeof(double))); 
# 556
(recv_buff) ? static_cast< void>(0) : __assert_fail("recv_buff", "model_le.c", 556, __PRETTY_FUNCTION__); 
# 557
if (recv_buff == (__null)) { pe_fatal(lb->pe, "malloc(recv_buff) failed\n"); }  
# 559
for (plane = 0; plane < nplane; plane++) { 
...
for (p = 0; p < nprop; p++) { 
# 599
(send_buff[ndata++]) = ((lb->f)[reverse_addr_rank2_assert(599, "model_le.c", lb->nsite, ndist, NVEL, index, n, (xdisp_fwd_cv[0]) + p)]); 
# 600
}  
# 601
}  
...
for (p = 0; p < nprop; p++) { 
# 628
((lb->f)[reverse_addr_rank2_assert(628, "model_le.c", lb->nsite, ndist, NVEL, index, n, (xdisp_fwd_cv[0]) + p)]) = ((((1.0) - fr) * (recv_buff[ind1 + p])) + (fr * (recv_buff[ind2 + p]))); 
# 629
}  
# 630
}  
...
for (p = 0; p < nprop; p++) { 
# 680
(send_buff[ndata++]) = ((lb->f)[reverse_addr_rank2_assert(680, "model_le.c", lb->nsite, ndist, NVEL, index, n, (xdisp_bwd_cv[0]) + p)]); 
# 681
}  
# 682
}  
...
for (p = 0; p < nprop; p++) { 
# 709
((lb->f)[reverse_addr_rank2_assert(709, "model_le.c", lb->nsite, ndist, NVEL, index, n, (xdisp_bwd_cv[0]) + p)]) = ((((1.0) - fr) * (recv_buff[ind1 + p])) + (fr * (recv_buff[ind2 + p]))); 
# 710
}  
# 711
}  
...
physics_t *phys = (__null); 
# 744
(lb) ? static_cast< void>(0) : __assert_fail("lb", "model_le.c", 744, __PRETTY_FUNCTION__); 
# 745
(le) ? static_cast< void>(0) : __assert_fail("le", "model_le.c", 745, __PRETTY_FUNCTION__); 
# 747
...
# 1 "model_le.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__16_model_le_cpp1_ii_ff93e90a
# 1 "model_le.cudafe1.stub.c"
#include "model_le.cudafe1.stub.c"
# 1 "model_le.cudafe1.stub.c"
