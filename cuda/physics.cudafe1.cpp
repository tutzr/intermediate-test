...
# 60
static physics_t *stat_phys = (__null); 
# 61
static physics_t const_phys; 
# 71 "physics.c"
int physics_ref(physics_t **ref) { 
# 73
(ref) ? static_cast< void>(0) : __assert_fail("ref", "physics.c", 73, __PRETTY_FUNCTION__); 
# 78
(stat_phys) ? static_cast< void>(0) : __assert_fail("stat_phys", "physics.c", 78, __PRETTY_FUNCTION__); 
# 79
(*ref) = stat_phys; 
# 82
return 0; 
...
int physics_create(pe_t *pe, physics_t **phys) { 
# 95
physics_t *obj = (__null); 
# 97
(pe) ? static_cast< void>(0) : __assert_fail("pe", "physics.c", 97, __PRETTY_FUNCTION__); 
# 98
(phys) ? static_cast< void>(0) : __assert_fail("phys", "physics.c", 98, __PRETTY_FUNCTION__); 
# 100
obj = ((physics_t *)calloc(1, sizeof(physics_t))); 
# 101
(obj) ? static_cast< void>(0) : __assert_fail("obj", "physics.c", 101, __PRETTY_FUNCTION__); 
# 102
if (obj == (__null)) { pe_fatal(pe, "calloc(physics_t) failed\n"); }  
# 104
(obj->eta_shear) = ((1.0) / (6.0)); 
# 105
(obj->eta_bulk) = ((1.0) / (6.0)); 
# 106
(obj->rho0) = (1.0); 
# 112
(obj->nsteps) = 0; 
...
(obj->t_current) = 0; 
# 116
if (stat_phys == (__null)) { stat_phys = obj; }  
# 117
(*phys) = obj; 
# 119
return 0; 
...
int physics_free(physics_t *phys) { 
# 130
(phys) ? static_cast< void>(0) : __assert_fail("phys", "physics.c", 130, __PRETTY_FUNCTION__); 
# 132
free(phys); 
# 133
stat_phys = (__null); 
...
# 146 "physics.c"
int physics_commit(physics_t *phys) { 
# 148
(phys) ? static_cast< void>(0) : __assert_fail("phys", "physics.c", 148, __PRETTY_FUNCTION__); 
# 150
{ tdpErrorHandler(cudaMemcpyToSymbol(const_phys, phys, sizeof(physics_t), 0, cudaMemcpyHostToDevice), "physics.c", 151, 1); 
# 150 "physics.c"
} 
# 151
; 
...
int physics_eta_shear(physics_t *phys, double *eta) { 
# 164
(phys) ? static_cast< void>(0) : __assert_fail("phys", "physics.c", 164, __PRETTY_FUNCTION__); 
# 165
(eta) ? static_cast< void>(0) : __assert_fail("eta", "physics.c", 165, __PRETTY_FUNCTION__); 
# 167
(*eta) = (phys->eta_shear); 
# 169
return 0; 
...
int physics_eta_shear_set(physics_t *phys, double eta) { 
# 180
(phys) ? static_cast< void>(0) : __assert_fail("phys", "physics.c", 180, __PRETTY_FUNCTION__); 
# 182
(phys->eta_shear) = eta; 
# 184
return 0; 
...
# 193
int physics_eta_bulk(physics_t *phys, double *eta) { 
# 195
(phys) ? static_cast< void>(0) : __assert_fail("phys", "physics.c", 195, __PRETTY_FUNCTION__); 
# 196
(eta) ? static_cast< void>(0) : __assert_fail("eta", "physics.c", 196, __PRETTY_FUNCTION__); 
# 198
(*eta) = (phys->eta_bulk); 
# 200
return 0; 
...
# 209
int physics_eta_bulk_set(physics_t *phys, double eta) { 
# 211
(phys) ? static_cast< void>(0) : __assert_fail("phys", "physics.c", 211, __PRETTY_FUNCTION__); 
# 213
(phys->eta_bulk) = eta; 
# 215
return 0; 
...
# 224
int physics_rho0(physics_t *phys, double *rho0) { 
# 226
(phys) ? static_cast< void>(0) : __assert_fail("phys", "physics.c", 226, __PRETTY_FUNCTION__); 
# 227
(rho0) ? static_cast< void>(0) : __assert_fail("rho0", "physics.c", 227, __PRETTY_FUNCTION__); 
# 229
(*rho0) = (phys->rho0); 
# 231
return 0; 
...
int physics_rho0_set(physics_t *phys, double rho0) { 
# 242
(phys) ? static_cast< void>(0) : __assert_fail("phys", "physics.c", 242, __PRETTY_FUNCTION__); 
# 244
(phys->rho0) = rho0; 
# 246
return 0; 
...
int physics_kt(physics_t *phys, double *kt) { 
# 257
(phys) ? static_cast< void>(0) : __assert_fail("phys", "physics.c", 257, __PRETTY_FUNCTION__); 
# 258
(kt) ? static_cast< void>(0) : __assert_fail("kt", "physics.c", 258, __PRETTY_FUNCTION__); 
# 260
(*kt) = (phys->kt); 
# 262
return 0; 
...
int physics_kt_set(physics_t *phys, double kt) { 
# 273
(phys) ? static_cast< void>(0) : __assert_fail("phys", "physics.c", 273, __PRETTY_FUNCTION__); 
# 275
(phys->kt) = kt; 
# 277
return 0; 
...
int physics_phi0(physics_t *phys, double *phi0) { 
# 288
(phys) ? static_cast< void>(0) : __assert_fail("phys", "physics.c", 288, __PRETTY_FUNCTION__); 
# 289
(phi0) ? static_cast< void>(0) : __assert_fail("phi0", "physics.c", 289, __PRETTY_FUNCTION__); 
# 291
(*phi0) = (phys->phi0); 
# 293
return 0; 
...
int physics_phi0_set(physics_t *phys, double phi0) { 
# 304
(phys) ? static_cast< void>(0) : __assert_fail("phys", "physics.c", 304, __PRETTY_FUNCTION__); 
# 306
(phys->phi0) = phi0; 
# 308
return 0; 
...
int physics_b0(physics_t *phys, double b0[3]) { 
# 319
(phys) ? static_cast< void>(0) : __assert_fail("phys", "physics.c", 319, __PRETTY_FUNCTION__); 
# 321
(b0[0]) = ((phys->b0)[0]); 
# 322
(b0[1]) = ((phys->b0)[1]); 
...
int physics_b0_set(physics_t *phys, double b0[3]) { 
# 336
(phys) ? static_cast< void>(0) : __assert_fail("phys", "physics.c", 336, __PRETTY_FUNCTION__); 
# 338
((phys->b0)[0]) = (b0[0]); 
# 339
((phys->b0)[1]) = (b0[1]); 
...
int physics_e0(physics_t *phys, double e0[3]) { 
# 353
(phys) ? static_cast< void>(0) : __assert_fail("phys", "physics.c", 353, __PRETTY_FUNCTION__); 
# 355
(e0[0]) = ((phys->e0)[0]); 
# 356
(e0[1]) = ((phys->e0)[1]); 
...
int physics_e0_set(physics_t *phys, double e0[3]) { 
# 370
(phys) ? static_cast< void>(0) : __assert_fail("phys", "physics.c", 370, __PRETTY_FUNCTION__); 
# 372
((phys->e0)[0]) = (e0[0]); 
# 373
((phys->e0)[1]) = (e0[1]); 
...
int physics_e0_flag(physics_t *phys) { 
# 393
(phys) ? static_cast< void>(0) : __assert_fail("phys", "physics.c", 393, __PRETTY_FUNCTION__); 
# 395
return phys->e0_flag; 
# 396
} 
# 404
int physics_e0_frequency(physics_t *phys, double *
# 405
e0_frequency) { 
# 407
(phys) ? static_cast< void>(0) : __assert_fail("phys", "physics.c", 407, __PRETTY_FUNCTION__); 
# 409
...
int physics_e0_frequency_set(physics_t *phys, double e0_frequency) { 
# 422
(phys) ? static_cast< void>(0) : __assert_fail("phys", "physics.c", 422, __PRETTY_FUNCTION__); 
# 424
...
int physics_fbody(physics_t *phys, double f[3]) { 
# 437
(phys) ? static_cast< void>(0) : __assert_fail("phys", "physics.c", 437, __PRETTY_FUNCTION__); 
# 439
(f[0]) = ((phys->fbody)[0]); 
# 440
(f[1]) = ((phys->fbody)[1]); 
...
int physics_fbody_set(physics_t *phys, double f[3]) { 
# 454
(phys) ? static_cast< void>(0) : __assert_fail("phys", "physics.c", 454, __PRETTY_FUNCTION__); 
# 456
((phys->fbody)[0]) = (f[0]); 
# 457
((phys->fbody)[1]) = (f[1]); 
...
int physics_fpulse(physics_t *phys, double fpulse[3]) { 
# 471
(phys) ? static_cast< void>(0) : __assert_fail("phys", "physics.c", 471, __PRETTY_FUNCTION__); 
# 473
...
int physics_fpulse_set(physics_t *phys, double fpulse[3]) { 
# 488
(phys) ? static_cast< void>(0) : __assert_fail("phys", "physics.c", 488, __PRETTY_FUNCTION__); 
# 490
...
# 503
int physics_fpulse_frequency(physics_t *phys, double *
# 504
fpulse_frequency) { 
# 506
(phys) ? static_cast< void>(0) : __assert_fail("phys", "physics.c", 506, __PRETTY_FUNCTION__); 
# 508
...
# 519
int physics_fpulse_frequency_set(physics_t *phys, double fpulse_frequency) { 
# 521
(phys) ? static_cast< void>(0) : __assert_fail("phys", "physics.c", 521, __PRETTY_FUNCTION__); 
# 523
...
int physics_mobility(physics_t *phys, double *mobility) { 
# 536
(phys) ? static_cast< void>(0) : __assert_fail("phys", "physics.c", 536, __PRETTY_FUNCTION__); 
# 537
(mobility) ? static_cast< void>(0) : __assert_fail("mobility", "physics.c", 537, __PRETTY_FUNCTION__); 
# 539
...
int physics_mobility_set(physics_t *phys, double mobility) { 
# 552
(mobility) ? static_cast< void>(0) : __assert_fail("mobility", "physics.c", 552, __PRETTY_FUNCTION__); 
# 554
...
int physics_fgrav(physics_t *phys, double g[3]) { 
# 567
(phys) ? static_cast< void>(0) : __assert_fail("phys", "physics.c", 567, __PRETTY_FUNCTION__); 
# 569
(g[0]) = ((phys->fgravity)[0]); 
# 570
(g[1]) = ((phys->fgravity)[1]); 
...
int physics_fgrav_set(physics_t *phys, double g[3]) { 
# 584
(phys) ? static_cast< void>(0) : __assert_fail("phys", "physics.c", 584, __PRETTY_FUNCTION__); 
# 586
((phys->fgravity)[0]) = (g[0]); 
# 587
((phys->fgravity)[1]) = (g[1]); 
...
int physics_grad_mu(physics_t *phys, double gm[3]) { 
# 601
(phys) ? static_cast< void>(0) : __assert_fail("phys", "physics.c", 601, __PRETTY_FUNCTION__); 
# 603
(gm[0]) = ((phys->grad_mu)[0]); 
# 604
(gm[1]) = ((phys->grad_mu)[1]); 
...
int physics_grad_mu_set(physics_t *phys, double gm[3]) { 
# 618
(phys) ? static_cast< void>(0) : __assert_fail("phys", "physics.c", 618, __PRETTY_FUNCTION__); 
# 620
((phys->grad_mu)[0]) = (gm[0]); 
# 621
((phys->grad_mu)[1]) = (gm[1]); 
...
int physics_control_timestep(physics_t *phys) { 
# 637
(phys) ? static_cast< void>(0) : __assert_fail("phys", "physics.c", 637, __PRETTY_FUNCTION__); 
# 638
...
int physics_control_time(physics_t *phys, double *t) { 
# 653
(phys) ? static_cast< void>(0) : __assert_fail("phys", "physics.c", 653, __PRETTY_FUNCTION__); 
# 654
(t) ? static_cast< void>(0) : __assert_fail("t", "physics.c", 654, __PRETTY_FUNCTION__); 
# 656
...
int physics_control_next_step(physics_t *phys) { 
# 672
(phys) ? static_cast< void>(0) : __assert_fail("phys", "physics.c", 672, __PRETTY_FUNCTION__); 
# 674
(phys->t_current) += 1; 
# 675
...
int physics_control_init_time(physics_t *phys, int nstart, int nstep) { 
# 689
(phys) ? static_cast< void>(0) : __assert_fail("phys", "physics.c", 689, __PRETTY_FUNCTION__); 
# 691
(phys->t_start) = nstart; 
# 692
(phys->nsteps) = nstep; 
...
# 1 "physics.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__15_physics_cpp1_ii_93368647
# 1 "physics.cudafe1.stub.c"
#include "physics.cudafe1.stub.c"
# 1 "physics.cudafe1.stub.c"
