...
# 25 "wall_rt.c"
int wall_rt_init(pe_t *pe, cs_t *cs, rt_t *rt, lb_t *lb, map_t *map, wall_t **
# 26
wall) { 
# 28
double ux_bot = (0.0); 
...
wall_param_t p = {0}; 
# 32
(rt) ? static_cast< void>(0) : __assert_fail("rt", "wall_rt.c", 32, __PRETTY_FUNCTION__); 
# 33
(cs) ? static_cast< void>(0) : __assert_fail("cs", "wall_rt.c", 33, __PRETTY_FUNCTION__); 
# 34
(lb) ? static_cast< void>(0) : __assert_fail("lb", "wall_rt.c", 34, __PRETTY_FUNCTION__); 
# 35
(map) ? static_cast< void>(0) : __assert_fail("map", "wall_rt.c", 35, __PRETTY_FUNCTION__); 
# 36
(wall) ? static_cast< void>(0) : __assert_fail("wall", "wall_rt.c", 36, __PRETTY_FUNCTION__); 
# 41
...
# 1 "wall_rt.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__15_wall_rt_cpp1_ii_435855ca
# 1 "wall_rt.cudafe1.stub.c"
#include "wall_rt.cudafe1.stub.c"
# 1 "wall_rt.cudafe1.stub.c"
