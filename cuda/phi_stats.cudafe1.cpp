...
double fbar, f2; 
# 49
(obj) ? static_cast< void>(0) : __assert_fail("obj", "phi_stats.c", 49, __PRETTY_FUNCTION__); 
# 50
(map) ? static_cast< void>(0) : __assert_fail("map", "phi_stats.c", 50, __PRETTY_FUNCTION__); 
# 52
field_nf(obj, &nf); 
# 53
(nf <= 5) ? static_cast< void>(0) : __assert_fail("nf <= 5", "phi_stats.c", 53, __PRETTY_FUNCTION__); 
# 55
...
double fbar, f2; 
# 95
(obj) ? static_cast< void>(0) : __assert_fail("obj", "phi_stats.c", 95, __PRETTY_FUNCTION__); 
# 96
(map) ? static_cast< void>(0) : __assert_fail("map", "phi_stats.c", 96, __PRETTY_FUNCTION__); 
# 97
(bbl) ? static_cast< void>(0) : __assert_fail("bbl", "phi_stats.c", 97, __PRETTY_FUNCTION__); 
# 99
field_nf(obj, &nf); 
# 100
(nf <= 5) ? static_cast< void>(0) : __assert_fail("nf <= 5", "phi_stats.c", 100, __PRETTY_FUNCTION__); 
# 102
pe_mpi_comm(obj->pe, &comm); 
# 103
stats_field_reduce(obj, map, fmin, fmax, fsum, fvar, &fvol, 0, comm); 
...
# 140 "phi_stats.c"
int stats_field_reduce(field_t *obj, map_t *map, double *fmin, double *
# 141
fmax, double *fsum, double *fvar, double *
# 142
fvol, int rank, MPI_Comm comm) { 
# 143
int nf; 
# 145
double fmin_local[5]; 
...
double fvol_local[1]; 
# 151
(obj) ? static_cast< void>(0) : __assert_fail("obj", "phi_stats.c", 151, __PRETTY_FUNCTION__); 
# 152
(map) ? static_cast< void>(0) : __assert_fail("map", "phi_stats.c", 152, __PRETTY_FUNCTION__); 
# 154
field_nf(obj, &nf); 
# 155
(nf <= 5) ? static_cast< void>(0) : __assert_fail("nf <= 5", "phi_stats.c", 155, __PRETTY_FUNCTION__); 
# 157
stats_field_local(obj, map, fmin_local, fmax_local, fsum_local, fvar_local, fvol_local); 
# 160
...
# 186 "phi_stats.c"
int stats_field_local(field_t *obj, map_t *map, double *fmin, double *fmax, double *
# 187
fsum, double *fvar, double *fvol) { 
# 189
int ic, jc, kc, index; 
# 190
int nlocal[3]; 
...
double f0[5]; 
# 196
(obj) ? static_cast< void>(0) : __assert_fail("obj", "phi_stats.c", 196, __PRETTY_FUNCTION__); 
# 197
(fmin) ? static_cast< void>(0) : __assert_fail("fmin", "phi_stats.c", 197, __PRETTY_FUNCTION__); 
# 198
(fmax) ? static_cast< void>(0) : __assert_fail("fmax", "phi_stats.c", 198, __PRETTY_FUNCTION__); 
# 199
(fsum) ? static_cast< void>(0) : __assert_fail("fsum", "phi_stats.c", 199, __PRETTY_FUNCTION__); 
# 200
(map) ? static_cast< void>(0) : __assert_fail("map", "phi_stats.c", 200, __PRETTY_FUNCTION__); 
# 202
cs_nlocal(obj->cs, nlocal); 
# 203
field_nf(obj, &nf); 
# 204
(nf <= 5) ? static_cast< void>(0) : __assert_fail("nf <= 5", "phi_stats.c", 204, __PRETTY_FUNCTION__); 
# 206
(*fvol) = (0.0); 
# 208
for (n = 0; n < nf; n++) { 
# 209
(fmin[n]) = (+((double)(1.7976931348623157081e+308L))); 
# 210
(fmax[n]) = (-((double)(1.7976931348623157081e+308L))); 
# 211
(fsum[n]) = (0.0); 
# 212
(fvar[n]) = (0.0); 
...
# 1 "phi_stats.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__17_phi_stats_cpp1_ii_12d72c8f
# 1 "phi_stats.cudafe1.stub.c"
#include "phi_stats.cudafe1.stub.c"
# 1 "phi_stats.cudafe1.stub.c"
