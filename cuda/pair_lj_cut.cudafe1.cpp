...
int pair_lj_cut_create(pe_t *pe, cs_t *cs, pair_lj_cut_t **pobj) { 
# 56
pair_lj_cut_t *obj = (__null); 
# 58
(pe) ? static_cast< void>(0) : __assert_fail("pe", "pair_lj_cut.c", 58, __PRETTY_FUNCTION__); 
# 59
(cs) ? static_cast< void>(0) : __assert_fail("cs", "pair_lj_cut.c", 59, __PRETTY_FUNCTION__); 
# 60
(pobj) ? static_cast< void>(0) : __assert_fail("pobj", "pair_lj_cut.c", 60, __PRETTY_FUNCTION__); 
# 62
obj = ((pair_lj_cut_t *)calloc(1, sizeof(pair_lj_cut_t))); 
# 63
(obj) ? static_cast< void>(0) : __assert_fail("obj", "pair_lj_cut.c", 63, __PRETTY_FUNCTION__); 
# 64
if (obj == (__null)) { pe_fatal(pe, "calloc(pair_lj_cut_t) failed\n"); }  
# 66
(obj->pe) = pe; 
# 67
(obj->cs) = cs; 
...
int pair_lj_cut_free(pair_lj_cut_t *obj) { 
# 82
(obj) ? static_cast< void>(0) : __assert_fail("obj", "pair_lj_cut.c", 82, __PRETTY_FUNCTION__); 
# 84
free(obj); 
# 86
return 0; 
...
# 95
int pair_lj_cut_param_set(pair_lj_cut_t *obj, double epsilon, double sigma, double 
# 96
rc) { 
# 97
(obj) ? static_cast< void>(0) : __assert_fail("obj", "pair_lj_cut.c", 97, __PRETTY_FUNCTION__); 
# 99
(obj->epsilon) = epsilon; 
# 100
(obj->sigma) = sigma; 
...
int pair_lj_cut_info(pair_lj_cut_t *obj) { 
# 114
(obj) ? static_cast< void>(0) : __assert_fail("obj", "pair_lj_cut.c", 114, __PRETTY_FUNCTION__); 
# 116
...
int pair_lj_cut_register(pair_lj_cut_t *obj, interact_t *parent) { 
# 132
(obj) ? static_cast< void>(0) : __assert_fail("obj", "pair_lj_cut.c", 132, __PRETTY_FUNCTION__); 
# 133
(parent) ? static_cast< void>(0) : __assert_fail("parent", "pair_lj_cut.c", 133, __PRETTY_FUNCTION__); 
# 135
...
colloid_t *pc2; 
# 169
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "pair_lj_cut.c", 169, __PRETTY_FUNCTION__); 
# 170
(self) ? static_cast< void>(0) : __assert_fail("self", "pair_lj_cut.c", 170, __PRETTY_FUNCTION__); 
# 172
cs_ltot(obj->cs, ltot); 
# 173
...
rs = pow((obj->sigma) * rr, 6); 
# 221
(obj->vlocal) += (((((4.0) * (obj->epsilon)) * ((rs * rs) - rs)) - vcut) - ((r - (obj->rc)) * dvcut)); 
# 223
...
# 254
(self) ? static_cast< void>(0) : __assert_fail("self", "pair_lj_cut.c", 254, __PRETTY_FUNCTION__); 
# 255
(stats) ? static_cast< void>(0) : __assert_fail("stats", "pair_lj_cut.c", 255, __PRETTY_FUNCTION__); 
# 257
...
double dvcut; 
# 277
(obj) ? static_cast< void>(0) : __assert_fail("obj", "pair_lj_cut.c", 277, __PRETTY_FUNCTION__); 
# 278
(r > (0.0)) ? static_cast< void>(0) : __assert_fail("r > 0.0", "pair_lj_cut.c", 278, __PRETTY_FUNCTION__); 
# 280
rr = ((1.0) / (obj->rc)); 
# 281
rs = pow((obj->sigma) * rr, 6); 
...
# 1 "pair_lj_cut.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__19_pair_lj_cut_cpp1_ii_a63ab5a7
# 1 "pair_lj_cut.cudafe1.stub.c"
#include "pair_lj_cut.cudafe1.stub.c"
# 1 "pair_lj_cut.cudafe1.stub.c"
