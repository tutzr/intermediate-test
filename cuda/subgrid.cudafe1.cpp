...
# 33
static double drange_ = (1.0); 
# 34
static int subgrid_on_ = 0; 
# 46 "subgrid.c"
int subgrid_force_from_particles(colloids_info_t *cinfo, hydro_t *hydro, wall_t *
# 47
wall) { 
# 49
int ic, jc, kc; 
...
colloid_t *p_colloid; 
# 59
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "subgrid.c", 59, __PRETTY_FUNCTION__); 
# 60
(hydro) ? static_cast< void>(0) : __assert_fail("hydro", "subgrid.c", 60, __PRETTY_FUNCTION__); 
# 61
(wall) ? static_cast< void>(0) : __assert_fail("wall", "subgrid.c", 61, __PRETTY_FUNCTION__); 
# 63
...
# 160
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "subgrid.c", 160, __PRETTY_FUNCTION__); 
# 161
(hydro) ? static_cast< void>(0) : __assert_fail("hydro", "subgrid.c", 161, __PRETTY_FUNCTION__); 
# 163
if (subgrid_on_ == 0) { return 0; }  
# 165
colloids_info_ncell(cinfo, ncell); 
...
colloid_t *p_colloid; 
# 222
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "subgrid.c", 222, __PRETTY_FUNCTION__); 
# 223
(hydro) ? static_cast< void>(0) : __assert_fail("hydro", "subgrid.c", 223, __PRETTY_FUNCTION__); 
# 225
cs_nlocal(cinfo->cs, nlocal); 
# 226
cs_nlocal_offset(cinfo->cs, offset); 
...
colloid_t *pc = (__null); 
# 327
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "subgrid.c", 327, __PRETTY_FUNCTION__); 
# 328
(wall) ? static_cast< void>(0) : __assert_fail("wall", "subgrid.c", 328, __PRETTY_FUNCTION__); 
# 330
...
int subgrid_on(int *flag) { 
# 390
(flag) ? static_cast< void>(0) : __assert_fail("flag", "subgrid.c", 390, __PRETTY_FUNCTION__); 
# 392
(*flag) = subgrid_on_; 
# 393
return 0; 
...
# 1 "subgrid.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__15_subgrid_cpp1_ii_ba5735e5
# 1 "subgrid.cudafe1.stub.c"
#include "subgrid.cudafe1.stub.c"
# 1 "subgrid.cudafe1.stub.c"
