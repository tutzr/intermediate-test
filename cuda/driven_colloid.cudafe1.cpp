...
MPI_Comm comm; 
# 85
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "driven_colloid.c", 85, __PRETTY_FUNCTION__); 
# 87
for (ia = 0; ia < 3; ia++) { 
# 88
(ftotal[ia]) = (0.0); 
...
# 1 "driven_colloid.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__22_driven_colloid_cpp1_ii_04091982
# 1 "driven_colloid.cudafe1.stub.c"
#include "driven_colloid.cudafe1.stub.c"
# 1 "driven_colloid.cudafe1.stub.c"
