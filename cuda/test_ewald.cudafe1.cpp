...
int ncell[3] = {2, 2, 2}; 
# 42
double mu = (0.2849999999999999756); 
# 43
double rc = (32.0); 
# 44
double r1[3]; 
...
colloid_t *p_c2; 
# 57
colloids_info_t *cinfo = (__null); 
# 59
pe_t *pe = (__null); 
# 60
cs_t *cs = (__null); 
# 61
ewald_t *ewald = (__null); 
# 63
...
cs_ltot(cs, ltot); 
# 75
test_assert_info(fabs((ltot[X]) - (64.0)) < (9.999999999999999988e-15), 75, "test_ewald.c"); 
# 76
test_assert_info(fabs((ltot[Y]) - (64.0)) < (9.999999999999999988e-15), 76, "test_ewald.c"); 
# 77
test_assert_info(fabs((ltot[Z]) - (64.0)) < (9.999999999999999988e-15), 77, "test_ewald.c"); 
# 79
colloids_info_create(pe, cs, ncell, &cinfo); 
# 80
test_assert_info(cinfo != (__null), 80, "test_ewald.c"); 
# 82
ewald_create(pe, cs, mu, rc, cinfo, &ewald); 
# 83
test_assert_info(ewald != (__null), 83, "test_ewald.c"); 
# 84
ewald_kappa(ewald, &kappa); 
# 88
test_assert_info(fabs(rc - (32.0)) < (9.999999999999999547e-08), 88, "test_ewald.c"); 
# 89
test_assert_info(fabs(mu - (0.2849999999999999756)) < (9.999999999999999547e-08), 89, "test_ewald.c"); 
# 90
test_assert_info(fabs(kappa - (0.078125)) < (9.999999999999999547e-08), 90, "test_ewald.c"); 
# 92
(r1[X]) = (3.0); 
# 93
(r1[Y]) = (3.0); 
...
# 102
(p_c1 != (__null)) ? static_cast< void>(0) : __assert_fail("p_c1 != __null", "test_ewald.c", 102, __PRETTY_FUNCTION__); 
# 103
(p_c2 != (__null)) ? static_cast< void>(0) : __assert_fail("p_c2 != __null", "test_ewald.c", 103, __PRETTY_FUNCTION__); 
# 104
colloids_info_ntotal_set(cinfo); 
# 108
((p_c1->s).a0) = (2.299999999999999822); 
# 109
((p_c1->s).ah) = (2.299999999999999822); 
# 111
(((p_c1->s).s)[X]) = (0.0); 
# 112
(((p_c1->s).s)[Y]) = (0.0); 
...
(((p_c1->s).s)[Z]) = (1.0); 
# 117
((p_c2->s).a0) = (2.299999999999999822); 
# 118
((p_c2->s).ah) = (2.299999999999999822); 
# 120
(((p_c2->s).s)[X]) = (0.0); 
# 121
(((p_c2->s).s)[Y]) = (0.0); 
...
# 138
test_assert_info(fabs(e - (0.0001689949999999999905)) < (9.999999999999999547e-08), 138, "test_ewald.c"); 
# 140
ewald_fourier_space_energy(ewald, &e); 
# 143
test_assert_info(fabs(e - (2.258310000000000067e-05)) < (9.999999999999999547e-08), 143, "test_ewald.c"); 
# 145
ewald_self_energy(ewald, &e); 
# 148
test_assert_info(fabs(e - (-(2.913559999999999935e-05))) < (9.999999999999999547e-08), 148, "test_ewald.c"); 
# 154
ewald_real_space_sum(ewald); 
# 155
ewald_total_energy(ewald, &ereal, &efourier, &eself); 
# 158
test_assert_info(fabs(ereal - (0.0001689949999999999905)) < (9.999999999999999547e-08), 158, "test_ewald.c"); 
# 164
test_assert_info(fabs(((p_c1->force)[X]) - (0.0)) < (9.999999999999999547e-08), 164, "test_ewald.c"); 
# 165
test_assert_info(fabs(((p_c1->force)[Y]) - (0.0)) < (9.999999999999999547e-08), 165, "test_ewald.c"); 
# 166
test_assert_info(fabs(((p_c1->force)[Z]) - (-(5.174640000000000316e-05))) < (9.999999999999999547e-08), 166, "test_ewald.c"); 
# 172
test_assert_info(fabs(((p_c2->force)[X]) - (0.0)) < (9.999999999999999547e-08), 172, "test_ewald.c"); 
# 173
test_assert_info(fabs(((p_c2->force)[Y]) - (0.0)) < (9.999999999999999547e-08), 173, "test_ewald.c"); 
# 174
test_assert_info(fabs(((p_c2->force)[Z]) - (5.174640000000000316e-05)) < (9.999999999999999547e-08), 174, "test_ewald.c"); 
# 176
test_assert_info(fabs(((p_c1->force)[Z]) + ((p_c2->force)[Z])) < (9.999999999999999547e-08), 176, "test_ewald.c"); 
# 182
test_assert_info(fabs(((p_c1->torque)[X]) - (0.0)) < (9.999999999999999547e-08), 182, "test_ewald.c"); 
# 183
test_assert_info(fabs(((p_c1->torque)[Y]) - (0.0)) < (9.999999999999999547e-08), 183, "test_ewald.c"); 
# 184
test_assert_info(fabs(((p_c1->torque)[Z]) - (0.0)) < (9.999999999999999547e-08), 184, "test_ewald.c"); 
# 189
test_assert_info(fabs(((p_c2->torque)[X]) - (0.0)) < (9.999999999999999547e-08), 189, "test_ewald.c"); 
# 190
test_assert_info(fabs(((p_c2->torque)[Y]) - (0.0)) < (9.999999999999999547e-08), 190, "test_ewald.c"); 
# 191
test_assert_info(fabs(((p_c2->torque)[Z]) - (0.0)) < (9.999999999999999547e-08), 191, "test_ewald.c"); 
# 195
...
ewald_total_energy(ewald, &ereal, &efourier, &eself); 
# 202
test_assert_info(fabs(efourier - (2.258310000000000067e-05)) < (9.999999999999999547e-08), 202, "test_ewald.c"); 
# 207
test_assert_info(fabs(((p_c1->force)[X]) - (0.0)) < (9.999999999999999547e-08), 207, "test_ewald.c"); 
# 208
test_assert_info(fabs(((p_c1->force)[Y]) - (0.0)) < (9.999999999999999547e-08), 208, "test_ewald.c"); 
# 209
test_assert_info(fabs(((p_c1->force)[Z]) - (3.086109999999999833e-06)) < (9.999999999999999547e-08), 209, "test_ewald.c"); 
# 214
test_assert_info(fabs(((p_c2->force)[X]) - (0.0)) < (9.999999999999999547e-08), 214, "test_ewald.c"); 
# 215
test_assert_info(fabs(((p_c2->force)[Y]) - (0.0)) < (9.999999999999999547e-08), 215, "test_ewald.c"); 
# 216
test_assert_info(fabs(((p_c2->force)[Z]) - (-(3.086109999999999833e-06))) < (9.999999999999999547e-08), 216, "test_ewald.c"); 
# 218
test_assert_info(fabs(((p_c1->force)[Z]) + ((p_c2->force)[Z])) < (9.999999999999999547e-08), 218, "test_ewald.c"); 
# 224
test_assert_info(fabs(((p_c1->torque)[X]) - (0.0)) < (9.999999999999999547e-08), 224, "test_ewald.c"); 
# 225
test_assert_info(fabs(((p_c1->torque)[Y]) - (0.0)) < (9.999999999999999547e-08), 225, "test_ewald.c"); 
# 226
test_assert_info(fabs(((p_c1->torque)[Z]) - (0.0)) < (9.999999999999999547e-08), 226, "test_ewald.c"); 
# 231
test_assert_info(fabs(((p_c2->torque)[X]) - (0.0)) < (9.999999999999999547e-08), 231, "test_ewald.c"); 
# 232
test_assert_info(fabs(((p_c2->torque)[Y]) - (0.0)) < (9.999999999999999547e-08), 232, "test_ewald.c"); 
# 233
test_assert_info(fabs(((p_c2->torque)[Z]) - (0.0)) < (9.999999999999999547e-08), 233, "test_ewald.c"); 
# 240
(((p_c2->s).s)[X]) = (1.0); 
# 241
(((p_c2->s).s)[Y]) = (0.0); 
...
ewald_real_space_energy(ewald, (p_c1->s).s, (p_c2->s).s, r12, &e); 
# 260
test_assert_info(fabs(e - (0.0)) < (9.999999999999999547e-08), 260, "test_ewald.c"); 
# 262
ewald_fourier_space_energy(ewald, &e); 
# 265
test_assert_info(fabs(e - (2.766329999999999991e-05)) < (9.999999999999999547e-08), 265, "test_ewald.c"); 
# 267
ewald_self_energy(ewald, &e); 
# 270
test_assert_info(fabs(e - (-(2.913559999999999935e-05))) < (9.999999999999999547e-08), 270, "test_ewald.c"); 
# 274
ewald_real_space_sum(ewald); 
# 275
ewald_total_energy(ewald, &ereal, &efourier, &eself); 
# 278
test_assert_info(fabs(ereal - (0.0)) < (9.999999999999999547e-08), 278, "test_ewald.c"); 
# 283
test_assert_info(fabs(((p_c1->force)[X]) - (-(2.297550000000000051e-05))) < (9.999999999999999547e-08), 283, "test_ewald.c"); 
# 284
test_assert_info(fabs(((p_c1->force)[Y]) - (0.0)) < (9.999999999999999547e-08), 284, "test_ewald.c"); 
# 285
test_assert_info(fabs(((p_c1->force)[Z]) - (0.0)) < (9.999999999999999547e-08), 285, "test_ewald.c"); 
# 291
test_assert_info(fabs(((p_c2->force)[X]) - (2.297550000000000051e-05)) < (9.999999999999999547e-08), 291, "test_ewald.c"); 
# 292
test_assert_info(fabs(((p_c2->force)[Y]) - (0.0)) < (9.999999999999999547e-08), 292, "test_ewald.c"); 
# 293
test_assert_info(fabs(((p_c2->force)[Z]) - (0.0)) < (9.999999999999999547e-08), 293, "test_ewald.c"); 
# 295
test_assert_info(fabs(((p_c1->force)[X]) + ((p_c2->force)[X])) < (9.999999999999999547e-08), 295, "test_ewald.c"); 
# 302
test_assert_info(fabs(((p_c1->torque)[X]) - (0.0)) < (9.999999999999999547e-08), 302, "test_ewald.c"); 
# 303
test_assert_info(fabs(((p_c1->torque)[Y]) - (-(6.075980000000000058e-05))) < (9.999999999999999547e-08), 303, "test_ewald.c"); 
# 304
test_assert_info(fabs(((p_c1->torque)[Z]) - (0.0)) < (9.999999999999999547e-08), 304, "test_ewald.c"); 
# 309
test_assert_info(fabs(((p_c2->torque)[X]) - (0.0)) < (9.999999999999999547e-08), 309, "test_ewald.c"); 
# 310
test_assert_info(fabs(((p_c2->torque)[Y]) - (-(0.0001689949999999999905))) < (9.999999999999999547e-08), 310, "test_ewald.c"); 
# 311
test_assert_info(fabs(((p_c2->torque)[Z]) - (0.0)) < (9.999999999999999547e-08), 311, "test_ewald.c"); 
# 315
((p_c1->force)[X]) = (0.0); ((p_c1->force)[Y]) = (0.0); ((p_c1->force)[Z]) = (0.0); 
# 316
((p_c2->force)[X]) = (0.0); ((p_c2->force)[Y]) = (0.0); ((p_c2->force)[Z]) = (0.0); 
...
ewald_total_energy(ewald, &ereal, &efourier, &eself); 
# 325
test_assert_info(fabs(efourier - (2.766329999999999991e-05)) < (9.999999999999999547e-08), 325, "test_ewald.c"); 
# 331
test_assert_info(fabs(((p_c1->force)[X]) - (-(1.35012999999999998e-06))) < (9.999999999999999547e-08), 331, "test_ewald.c"); 
# 332
test_assert_info(fabs(((p_c1->force)[Y]) - (0.0)) < (9.999999999999999547e-08), 332, "test_ewald.c"); 
# 333
test_assert_info(fabs(((p_c1->force)[Z]) - (0.0)) < (9.999999999999999547e-08), 333, "test_ewald.c"); 
# 338
test_assert_info(fabs(((p_c2->force)[X]) - (1.35012999999999998e-06)) < (9.999999999999999547e-08), 338, "test_ewald.c"); 
# 339
test_assert_info(fabs(((p_c2->force)[Y]) - (0.0)) < (9.999999999999999547e-08), 339, "test_ewald.c"); 
# 340
test_assert_info(fabs(((p_c2->force)[Z]) - (0.0)) < (9.999999999999999547e-08), 340, "test_ewald.c"); 
# 342
test_assert_info(fabs(((p_c1->force)[X]) + ((p_c2->force)[X])) < (9.999999999999999547e-08), 342, "test_ewald.c"); 
# 348
test_assert_info(fabs(((p_c1->torque)[X]) - (0.0)) < (9.999999999999999547e-08), 348, "test_ewald.c"); 
# 349
test_assert_info(fabs(((p_c1->torque)[Y]) - (-(1.929449999999999967e-05))) < (9.999999999999999547e-08), 349, "test_ewald.c"); 
# 350
test_assert_info(fabs(((p_c1->torque)[Z]) - (0.0)) < (9.999999999999999547e-08), 350, "test_ewald.c"); 
# 355
test_assert_info(fabs(((p_c2->torque)[X]) - (0.0)) < (9.999999999999999547e-08), 355, "test_ewald.c"); 
# 356
test_assert_info(fabs(((p_c2->torque)[Y]) - (5.080240000000000339e-06)) < (9.999999999999999547e-08), 356, "test_ewald.c"); 
# 357
test_assert_info(fabs(((p_c2->torque)[Z]) - (0.0)) < (9.999999999999999547e-08), 357, "test_ewald.c"); 
# 363
(((p_c1->s).r)[X]) = (3.0); 
# 364
(((p_c1->s).r)[Y]) = (3.0); 
...
ewald = (__null); 
# 435
ewald_create(pe, cs, (0.2849999999999999756), (8.0), cinfo, &ewald); 
# 436
test_assert_info(ewald != (__null), 436, "test_ewald.c"); 
# 438
ewald_real_space_energy(ewald, (p_c1->s).s, (p_c2->s).s, r12, &e); 
# 441
test_assert_info(fabs(e - (0.0)) < (9.999999999999999547e-08), 441, "test_ewald.c"); 
# 443
ewald_fourier_space_energy(ewald, &e); 
# 448
ewald_self_energy(ewald, &e); 
...
# 1 "test_ewald.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__18_test_ewald_cpp1_ii_5b26a90b
# 1 "test_ewald.cudafe1.stub.c"
#include "test_ewald.cudafe1.stub.c"
# 1 "test_ewald.cudafe1.stub.c"
