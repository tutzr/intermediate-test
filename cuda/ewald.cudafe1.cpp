...
static double *cosx_; 
# 47
static double *sinkr_; 
# 48
static double *coskr_; 
# 50
struct ewald_s { 
# 51
pe_t *pe; 
...
# 72 "ewald.c"
int ewald_create(pe_t *pe, cs_t *cs, double mu_input, double rc_input, colloids_info_t *
# 73
cinfo, ewald_t **pewald) { 
# 74
int nk; 
# 75
double ltot[3]; 
...
# 79
(pe) ? static_cast< void>(0) : __assert_fail("pe", "ewald.c", 79, __PRETTY_FUNCTION__); 
# 80
(cs) ? static_cast< void>(0) : __assert_fail("cs", "ewald.c", 80, __PRETTY_FUNCTION__); 
# 81
(pewald) ? static_cast< void>(0) : __assert_fail("pewald", "ewald.c", 81, __PRETTY_FUNCTION__); 
# 82
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "ewald.c", 82, __PRETTY_FUNCTION__); 
# 84
ewald = ((ewald_t *)calloc(1, sizeof(ewald_t))); 
# 85
(ewald) ? static_cast< void>(0) : __assert_fail("ewald", "ewald.c", 85, __PRETTY_FUNCTION__); 
# 86
if (ewald == (__null)) { pe_fatal(pe, "calloc(ewald) failed"); }  
# 88
(ewald->pe) = pe; 
# 89
(ewald->cs) = cs; 
...
# 110
(nktot_ > 0) ? static_cast< void>(0) : __assert_fail("nktot_ > 0", "ewald.c", 110, __PRETTY_FUNCTION__); 
# 112
sinx_ = ((double *)malloc(nktot_ * sizeof(double))); 
# 113
cosx_ = ((double *)malloc(nktot_ * sizeof(double))); 
# 115
if (sinx_ == (__null)) { pe_fatal(pe, "Ewald sum malloc(sinx_) failed\n"); }  
# 116
if (cosx_ == (__null)) { pe_fatal(pe, "Ewald sum malloc(cosx_) failed\n"); }  
# 118
sinkr_ = ((double *)malloc((3 * nkmax_) * sizeof(double))); 
# 119
coskr_ = ((double *)malloc((3 * nkmax_) * sizeof(double))); 
# 121
if (sinkr_ == (__null)) { pe_fatal(pe, "Ewald sum malloc(sinx_) failed\n"); }  
# 122
if (coskr_ == (__null)) { pe_fatal(pe, "Ewald sum malloc(cosx_) failed\n"); }  
# 124
(*pewald) = ewald; 
# 126
return 0; 
...
int ewald_free(ewald_t *ewald) { 
# 137
(ewald) ? static_cast< void>(0) : __assert_fail("ewald", "ewald.c", 137, __PRETTY_FUNCTION__); 
# 138
free(ewald); 
# 140
return 0; 
...
double eself; 
# 154
(ewald) ? static_cast< void>(0) : __assert_fail("ewald", "ewald.c", 154, __PRETTY_FUNCTION__); 
# 156
...
int ewald_kappa(ewald_t *ewald, double *kappa) { 
# 184
(ewald) ? static_cast< void>(0) : __assert_fail("ewald", "ewald.c", 184, __PRETTY_FUNCTION__); 
# 185
(kappa) ? static_cast< void>(0) : __assert_fail("kappa", "ewald.c", 185, __PRETTY_FUNCTION__); 
# 187
(*kappa) = kappa_; 
# 189
return 0; 
...
ewald_on_ = 0; 
# 208
(0) ? static_cast< void>(0) : __assert_fail("0", "ewald.c", 208, __PRETTY_FUNCTION__); 
# 210
} 
# 222 "ewald.c"
int ewald_sum(ewald_t *ewald) { 
# 224
if (ewald == (__null)) { return 0; }  
# 226
...
# 244 "ewald.c"
int ewald_real_space_energy(ewald_t *ewald, const double u1[3], const double 
# 245
u2[3], const double r12[3], double *
# 246
ereal) { 
# 247
double r; 
# 249
(ewald) ? static_cast< void>(0) : __assert_fail("ewald", "ewald.c", 249, __PRETTY_FUNCTION__); 
# 250
(ereal) ? static_cast< void>(0) : __assert_fail("ereal", "ewald.c", 250, __PRETTY_FUNCTION__); 
# 252
(*ereal) = (0.0); 
# 254
...
const double pi = (3.141592653589793116); 
# 291
(ewald) ? static_cast< void>(0) : __assert_fail("ewald", "ewald.c", 291, __PRETTY_FUNCTION__); 
# 293
...
MPI_Comm comm; 
# 356
(ewald) ? static_cast< void>(0) : __assert_fail("ewald", "ewald.c", 356, __PRETTY_FUNCTION__); 
# 358
cs_ltot(ewald->cs, ltot); 
# 359
...
# 412
kdotr = ((((((skr[X]) * (ckr[Y])) * (ckr[Z])) + (((ckr[X]) * (skr[Y])) * (ckr[Z]))) + (((ckr[X]) * (ckr[Y])) * (skr[Z]))) - (((skr[X]) * (skr[Y])) * (skr[Z]))); 
# 414
(sinx_[kn]) += (udotk * kdotr); 
# 416
kdotr = ((((((ckr[X]) * (ckr[Y])) * (ckr[Z])) - (((ckr[X]) * (skr[Y])) * (skr[Z]))) - (((skr[X]) * (ckr[Y])) * (skr[Z]))) - (((skr[X]) * (skr[Y])) * (ckr[Z]))); 
# 418
...
# 433
(subsin) ? static_cast< void>(0) : __assert_fail("subsin", "ewald.c", 433, __PRETTY_FUNCTION__); 
# 434
(subcos) ? static_cast< void>(0) : __assert_fail("subcos", "ewald.c", 434, __PRETTY_FUNCTION__); 
# 435
if (subsin == (__null)) { pe_fatal(ewald->pe, "calloc(subsin) failed\n"); }  
# 436
if (subcos == (__null)) { pe_fatal(ewald->pe, "calloc(subcos) failed\n"); }  
# 438
for (kn = 0; kn < nktot_; kn++) { 
# 439
(subsin[kn]) = (sinx_[kn]); 
...
const double pi = (3.141592653589793116); 
# 466
(ewald) ? static_cast< void>(0) : __assert_fail("ewald", "ewald.c", 466, __PRETTY_FUNCTION__); 
# 467
...
# 482 "ewald.c"
int ewald_total_energy(ewald_t *ewald, double *ereal, double *efour, double *
# 483
eself) { 
# 485
if (ewald) { 
...
# 520
(ewald) ? static_cast< void>(0) : __assert_fail("ewald", "ewald.c", 520, __PRETTY_FUNCTION__); 
# 521
colloids_info_ncell(ewald->cinfo, ncell); 
# 523
ereal_ = (0.0); 
...
c = (((((3.0) * b1) * rr) * rr) + (((((2.0) * kappa_) * kappa_) + (((3.0) * rr) * rr)) * b2)); 
# 571
d = ((((5.0) * c) / (r * r)) + ((((((4.0) * kappa_) * kappa_) * kappa_) * kappa_) * b2)); 
# 574
...
for (i = 0; i < 3; i++) { 
# 583
(f[i]) = ((((udotu * c) - ((u1dotr * u2dotr) * d)) * (r12[i])) + (c * ((u2dotr * (((p_c1->s).s)[i])) + (u1dotr * (((p_c2->s).s)[i]))))); 
# 585
}  
# 587
for (i = 0; i < 3; i++) { 
...
# 658
(ewald) ? static_cast< void>(0) : __assert_fail("ewald", "ewald.c", 658, __PRETTY_FUNCTION__); 
# 660
cs_ltot(ewald->cs, ltot); 
# 661
ewald_sum_sin_cos_terms(ewald); 
...
if (ky < 0) { (skr[Y]) = (-(skr[Y])); }  
# 728
sinkr = ((((((skr[X]) * (ckr[Y])) * (ckr[Z])) + (((ckr[X]) * (skr[Y])) * (ckr[Z]))) + (((ckr[X]) * (ckr[Y])) * (skr[Z]))) - (((skr[X]) * (skr[Y])) * (skr[Z]))); 
# 731
coskr = ((((((ckr[X]) * (ckr[Y])) * (ckr[Z])) - (((ckr[X]) * (skr[Y])) * (skr[Z]))) - (((skr[X]) * (ckr[Y])) * (skr[Z]))) - (((skr[X]) * (skr[Y])) * (ckr[Z]))); 
# 736
udotk = dot_product((p_colloid->s).s, k); 
# 738
for (i = 0; i < 3; i++) { 
...
const double pi = (3.141592653589793116); 
# 790
(ewald) ? static_cast< void>(0) : __assert_fail("ewald", "ewald.c", 790, __PRETTY_FUNCTION__); 
# 792
cs_ltot(ewald->cs, ltot); 
# 794
fkx = (((2.0) * pi) / (ltot[X])); 
...
const double pi = (3.141592653589793116); 
# 832
(ewald) ? static_cast< void>(0) : __assert_fail("ewald", "ewald.c", 832, __PRETTY_FUNCTION__); 
# 834
cs_ltot(ewald->cs, ltot); 
# 836
for (i = 0; i < 3; i++) { 
...
# 1 "ewald.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__13_ewald_cpp1_ii_a48138ce
# 1 "ewald.cudafe1.stub.c"
#include "ewald.cudafe1.stub.c"
# 1 "ewald.cudafe1.stub.c"
