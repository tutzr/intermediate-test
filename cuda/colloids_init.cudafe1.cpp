...
# 34
static int colloids_init_random_set(colloids_info_t * cinfo, int n, const colloid_state_t * s, double amax); 
# 36
static int colloids_init_check_wall(pe_t * pe, cs_t * cs, colloids_info_t * cinfo, wall_t * wall, double dh); 
# 49 "colloids_init.c"
int colloids_init_random(pe_t *pe, cs_t *cs, colloids_info_t *cinfo, int np, const colloid_state_t *
# 50
s0, wall_t *wall, double dh) { 
# 52
double amax; 
# 53
double hmax; 
# 55
(pe) ? static_cast< void>(0) : __assert_fail("pe", "colloids_init.c", 55, __PRETTY_FUNCTION__); 
# 56
(cs) ? static_cast< void>(0) : __assert_fail("cs", "colloids_init.c", 56, __PRETTY_FUNCTION__); 
# 57
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "colloids_init.c", 57, __PRETTY_FUNCTION__); 
# 60
amax = ((s0->ah) + dh); 
# 61
hmax = (((2.0) * (s0->ah)) + dh); 
...
# 82 "colloids_init.c"
static int colloids_init_random_set(colloids_info_t *cinfo, int npart, const colloid_state_t *
# 83
s, double amax) { 
# 84
int n; 
...
colloid_t *pc; 
# 92
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "colloids_init.c", 92, __PRETTY_FUNCTION__); 
# 94
...
MPI_Comm comm; 
# 147
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "colloids_init.c", 147, __PRETTY_FUNCTION__); 
# 149
...
if (noverlap > 0) { 
# 194
pe_info(cinfo->pe, "This appears to include at least one hard sphere overlap.\n"); 
# 196
...
# 214 "colloids_init.c"
static int colloids_init_check_wall(pe_t *pe, cs_t *cs, colloids_info_t *
# 215
cinfo, wall_t *wall, double 
# 216
dh) { 
# 217
int ia; 
...
colloid_t *pc = (__null); 
# 227
(pe) ? static_cast< void>(0) : __assert_fail("pe", "colloids_init.c", 227, __PRETTY_FUNCTION__); 
# 228
(cs) ? static_cast< void>(0) : __assert_fail("cs", "colloids_init.c", 228, __PRETTY_FUNCTION__); 
# 229
(wall) ? static_cast< void>(0) : __assert_fail("wall", "colloids_init.c", 229, __PRETTY_FUNCTION__); 
# 230
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "colloids_init.c", 230, __PRETTY_FUNCTION__); 
# 231
(dh >= (0.0)) ? static_cast< void>(0) : __assert_fail("dh >= 0.0", "colloids_init.c", 231, __PRETTY_FUNCTION__); 
# 233
cs_lmin(cs, lmin); 
# 234
cs_ltot(cs, ltot); 
...
# 1 "colloids_init.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__21_colloids_init_cpp1_ii_af00fb9a
# 1 "colloids_init.cudafe1.stub.c"
#include "colloids_init.cudafe1.stub.c"
# 1 "colloids_init.cudafe1.stub.c"
