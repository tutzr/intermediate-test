...
double hminlocal; 
# 33
double rch[LUBRICATION_SS_MAX]; 
# 34
double rrch[LUBRICATION_SS_MAX]; 
# 35
double rchmax; 
# 36
}; 
...
lubr_t *obj = (__null); 
# 48
(pe) ? static_cast< void>(0) : __assert_fail("pe", "lubrication.c", 48, __PRETTY_FUNCTION__); 
# 49
(pobj) ? static_cast< void>(0) : __assert_fail("pobj", "lubrication.c", 49, __PRETTY_FUNCTION__); 
# 51
obj = ((lubr_t *)calloc(1, sizeof(lubr_t))); 
# 52
(obj) ? static_cast< void>(0) : __assert_fail("obj", "lubrication.c", 52, __PRETTY_FUNCTION__); 
# 53
if (obj == (__null)) { pe_fatal(pe, "calloc(lubr_t) failed\n"); }  
# 55
(obj->pe) = pe; 
# 56
(obj->cs) = cs; 
...
int lubrication_free(lubr_t *obj) { 
# 71
(obj) ? static_cast< void>(0) : __assert_fail("obj", "lubrication.c", 71, __PRETTY_FUNCTION__); 
# 73
free(obj); 
# 75
return 0; 
...
colloid_t *pc2; 
# 102
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "lubrication.c", 102, __PRETTY_FUNCTION__); 
# 103
(obj) ? static_cast< void>(0) : __assert_fail("obj", "lubrication.c", 103, __PRETTY_FUNCTION__); 
# 105
cs_ltot(obj->cs, ltot); 
# 107
...
# 132
lubrication_single(obj, (pc1->s).ah, (pc2->s).ah, (pc1->s).v, (pc2->s).v, r12, ran, f); 
# 135
((pc1->force)[X]) += (f[X]); 
# 136
((pc1->force)[Y]) += (f[Y]); 
...
# 165
(self) ? static_cast< void>(0) : __assert_fail("self", "lubrication.c", 165, __PRETTY_FUNCTION__); 
# 167
...
# 180
(obj) ? static_cast< void>(0) : __assert_fail("obj", "lubrication.c", 180, __PRETTY_FUNCTION__); 
# 181
(type < (LUBRICATION_SS_MAX)) ? static_cast< void>(0) : __assert_fail("type < LUBRICATION_SS_MAX", "lubrication.c", 181, __PRETTY_FUNCTION__); 
# 182
(rc >= (0.0)) ? static_cast< void>(0) : __assert_fail("rc >= 0.0", "lubrication.c", 182, __PRETTY_FUNCTION__); 
# 184
if (rc < (0.0)) { rc = (0.0); }  
# 186
((obj->rch)[type]) = rc; 
...
int lubrication_register(lubr_t *obj, interact_t *parent) { 
# 201
(obj) ? static_cast< void>(0) : __assert_fail("obj", "lubrication.c", 201, __PRETTY_FUNCTION__); 
# 202
(parent) ? static_cast< void>(0) : __assert_fail("parent", "lubrication.c", 202, __PRETTY_FUNCTION__); 
# 204
...
int lubrication_rchmax(lubr_t *obj, double *rchmax) { 
# 219
(obj) ? static_cast< void>(0) : __assert_fail("obj", "lubrication.c", 219, __PRETTY_FUNCTION__); 
# 221
(*rchmax) = (obj->rchmax); 
# 223
return 0; 
...
# 241 "lubrication.c"
int lubrication_single(lubr_t *lubr, double a1, double a2, const double 
# 242
u1[3], const double u2[3], const double 
# 243
r12[3], const double ran[2], double f[3]) { 
# 244
int ia; 
# 245
double h; 
...
# 256
(lubr) ? static_cast< void>(0) : __assert_fail("lubr", "lubrication.c", 256, __PRETTY_FUNCTION__); 
# 257
physics_ref(&phys); 
# 259
for (ia = 0; ia < 3; ia++) { 
...
# 303
fmod = ((((((((-((24.0) / (15.0))) * pi) * eta) * a1) * a2) * (((((2.0) * a1) * a1) + (a1 * a2)) + (((2.0) * a2) * a2))) * (log(rh) - log(rrc))) / (((a1 + a2) * (a1 + a2)) * (a1 + a2))); 
# 306
...
# 1 "lubrication.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__19_lubrication_cpp1_ii_6a1c13e0
# 1 "lubrication.cudafe1.stub.c"
#include "lubrication.cudafe1.stub.c"
# 1 "lubrication.cudafe1.stub.c"
