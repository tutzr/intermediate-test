...
int pair_ss_cut_create(pe_t *pe, cs_t *cs, pair_ss_cut_t **pobj) { 
# 64
pair_ss_cut_t *obj = (__null); 
# 66
(pe) ? static_cast< void>(0) : __assert_fail("pe", "pair_ss_cut.c", 66, __PRETTY_FUNCTION__); 
# 67
(cs) ? static_cast< void>(0) : __assert_fail("cs", "pair_ss_cut.c", 67, __PRETTY_FUNCTION__); 
# 68
(pobj) ? static_cast< void>(0) : __assert_fail("pobj", "pair_ss_cut.c", 68, __PRETTY_FUNCTION__); 
# 70
obj = ((pair_ss_cut_t *)calloc(1, sizeof(pair_ss_cut_t))); 
# 71
(obj) ? static_cast< void>(0) : __assert_fail("obj", "pair_ss_cut.c", 71, __PRETTY_FUNCTION__); 
# 72
if (obj == (__null)) { pe_fatal(pe, "calloc(pair_ss_cut_t) failed\n"); }  
# 74
(obj->pe) = pe; 
# 75
(obj->cs) = cs; 
...
int pair_ss_cut_free(pair_ss_cut_t *obj) { 
# 89
(obj) ? static_cast< void>(0) : __assert_fail("obj", "pair_ss_cut.c", 89, __PRETTY_FUNCTION__); 
# 91
free(obj); 
# 93
return 0; 
...
# 102
int pair_ss_cut_param_set(pair_ss_cut_t *obj, double epsilon, double sigma, int 
# 103
nu, double hc) { 
# 104
(obj) ? static_cast< void>(0) : __assert_fail("obj", "pair_ss_cut.c", 104, __PRETTY_FUNCTION__); 
# 106
(obj->epsilon) = epsilon; 
# 107
(obj->sigma) = sigma; 
...
int pair_ss_cut_register(pair_ss_cut_t *obj, interact_t *parent) { 
# 149
(obj) ? static_cast< void>(0) : __assert_fail("obj", "pair_ss_cut.c", 149, __PRETTY_FUNCTION__); 
# 150
(parent) ? static_cast< void>(0) : __assert_fail("parent", "pair_ss_cut.c", 150, __PRETTY_FUNCTION__); 
# 152
...
colloid_t *pc2; 
# 186
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "pair_ss_cut.c", 186, __PRETTY_FUNCTION__); 
# 187
(self) ? static_cast< void>(0) : __assert_fail("self", "pair_ss_cut.c", 187, __PRETTY_FUNCTION__); 
# 189
...
# 228
(h > (0.0)) ? static_cast< void>(0) : __assert_fail("h > 0.0", "pair_ss_cut.c", 228, __PRETTY_FUNCTION__); 
# 230
rh = ((1.0) / h); 
# 232
...
pair_ss_cut_t *self = (pair_ss_cut_t *)obj; 
# 266
(self) ? static_cast< void>(0) : __assert_fail("self", "pair_ss_cut.c", 266, __PRETTY_FUNCTION__); 
# 268
...
double vcut, dvcut; 
# 289
(obj) ? static_cast< void>(0) : __assert_fail("obj", "pair_ss_cut.c", 289, __PRETTY_FUNCTION__); 
# 290
(h > (0.0)) ? static_cast< void>(0) : __assert_fail("h > 0.0", "pair_ss_cut.c", 290, __PRETTY_FUNCTION__); 
# 292
rh = ((1.0) / h); 
# 293
...
# 1 "pair_ss_cut.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__19_pair_ss_cut_cpp1_ii_0aa5210e
# 1 "pair_ss_cut.cudafe1.stub.c"
#include "pair_ss_cut.cudafe1.stub.c"
# 1 "pair_ss_cut.cudafe1.stub.c"
