...
# 112
{ tdpErrorHandler(tdpMemcpy(&((obj->target)->u), &tmp, sizeof(double *), cudaMemcpyHostToDevice), "hydro.c", 113, 1); 
# 112 "hydro.c"
} 
# 113
; 
...
# 117
{ tdpErrorHandler(tdpMemcpy(&((obj->target)->f), &tmp, sizeof(double *), cudaMemcpyHostToDevice), "hydro.c", 118, 1); 
# 117 "hydro.c"
} 
# 118
; 
...
# 122
{ tdpErrorHandler(tdpMemcpy(&((obj->target)->eta), &tmp, sizeof(double *), cudaMemcpyHostToDevice), "hydro.c", 123, 1); 
# 122 "hydro.c"
} 
# 123
; 
# 125
{ tdpErrorHandler(tdpMemcpy(&((obj->target)->nsite), &(obj->nsite), sizeof(int), cudaMemcpyHostToDevice), "hydro.c", 126, 1); 
# 125 "hydro.c"
} 
# 126
; 
...
if (ndevice > 0) { 
# 150
{ tdpErrorHandler(tdpMemcpy(&tmp, &((obj->target)->u), sizeof(double *), cudaMemcpyDeviceToHost), "hydro.c", 151, 1); 
# 150 "hydro.c"
} 
# 151
; 
...
# 153
{ tdpErrorHandler(tdpMemcpy(&tmp, &((obj->target)->f), sizeof(double *), cudaMemcpyDeviceToHost), "hydro.c", 154, 1); 
# 153 "hydro.c"
} 
# 154
; 
...
# 156
{ tdpErrorHandler(tdpMemcpy(&tmp, &((obj->target)->eta), sizeof(double *), cudaMemcpyDeviceToHost), "hydro.c", 157, 1); 
# 156 "hydro.c"
} 
# 157
; 
...
{ 
# 194
{ tdpErrorHandler(tdpMemcpy(&tmpf, &((obj->target)->f), sizeof(double *), cudaMemcpyDeviceToHost), "hydro.c", 195, 1); 
# 194 "hydro.c"
} 
# 195
; 
# 196
{ tdpErrorHandler(tdpMemcpy(&tmpu, &((obj->target)->u), sizeof(double *), cudaMemcpyDeviceToHost), "hydro.c", 197, 1); 
# 196 "hydro.c"
} 
# 197
; 
# 198
{ tdpErrorHandler(tdpMemcpy(&tmpeta, &((obj->target)->eta), sizeof(double *), cudaMemcpyDeviceToHost), "hydro.c", 199, 1); 
# 198 "hydro.c"
} 
# 199
; 
...
# 253
{ tdpErrorHandler(tdpMemcpy(&data, &((obj->target)->u), sizeof(double *), cudaMemcpyDeviceToHost), "hydro.c", 254, 1); 
# 253 "hydro.c"
} 
# 254
; 
...
# 436
{ tdpErrorHandler(tdpMemcpy(&u, &((obj->target)->u), sizeof(double *), cudaMemcpyDeviceToHost), "hydro.c", 437, 1); 
# 436 "hydro.c"
} 
# 437
; 
...
# 440
(__cudaPushCallConfiguration(nblk, ntpb, 0, 0)) ? (void)0 : hydro_field_set(obj->target, u, uzero[X], uzero[Y], uzero[Z]); 
# 441
; 
# 443
...
# 464
{ tdpErrorHandler(tdpMemcpy(&f, &((obj->target)->f), sizeof(double *), cudaMemcpyDeviceToHost), "hydro.c", 465, 1); 
# 464 "hydro.c"
} 
# 465
; 
...
kernel_launch_param(obj->nsite, &nblk, &ntpb); 
# 468
(__cudaPushCallConfiguration(nblk, ntpb, 0, 0)) ? (void)0 : hydro_field_set(obj->target, f, fzero[X], fzero[Y], fzero[Z]); 
# 469
; 
# 471
...
# 946
{ tdpErrorHandler(cudaGetSymbolAddress((void **)(&fnetd), fs), "hydro.c", 946, 1); } ; 
# 947
{ tdpErrorHandler(tdpMemcpy(fnetd, fnet, (3) * sizeof(double), cudaMemcpyHostToDevice), "hydro.c", 947, 1); } ; 
# 951
(__cudaPushCallConfiguration(nblk, ntpb, 0, 0)) ? (void)0 : hydro_accumulate_kernel_v(ctxt, hydro->target, fnetd); 
# 952
; 
# 954
...
# 960
{ tdpErrorHandler(tdpMemcpy(fnet, fnetd, (3) * sizeof(double), cudaMemcpyDeviceToHost), "hydro.c", 960, 1); } ; 
# 964
...
(fnet[Z]) = ((-(fnet[Z])) * rv); 
# 972
tdpMemcpy(fnetd, fnet, (3) * sizeof(double), cudaMemcpyHostToDevice); 
# 974
(__cudaPushCallConfiguration(nblk, ntpb, 0, 0)) ? (void)0 : hydro_correct_kernel_v(ctxt, hydro->target, fnetd); 
# 975
; 
# 977
