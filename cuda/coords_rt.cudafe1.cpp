...
int vector[3]; 
# 34
(pe) ? static_cast< void>(0) : __assert_fail("pe", "coords_rt.c", 34, __PRETTY_FUNCTION__); 
# 35
(rt) ? static_cast< void>(0) : __assert_fail("rt", "coords_rt.c", 35, __PRETTY_FUNCTION__); 
# 36
(cs) ? static_cast< void>(0) : __assert_fail("cs", "coords_rt.c", 36, __PRETTY_FUNCTION__); 
# 38
...
# 1 "coords_rt.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__17_coords_rt_cpp1_ii_2a5982e1
# 1 "coords_rt.cudafe1.stub.c"
#include "coords_rt.cudafe1.stub.c"
# 1 "coords_rt.cudafe1.stub.c"
