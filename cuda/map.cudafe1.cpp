...
map_t *obj = (__null); 
# 48
(pe) ? static_cast< void>(0) : __assert_fail("pe", "map.c", 48, __PRETTY_FUNCTION__); 
# 49
(cs) ? static_cast< void>(0) : __assert_fail("cs", "map.c", 49, __PRETTY_FUNCTION__); 
# 50
(ndata >= 0) ? static_cast< void>(0) : __assert_fail("ndata >= 0", "map.c", 50, __PRETTY_FUNCTION__); 
# 51
(pobj) ? static_cast< void>(0) : __assert_fail("pobj", "map.c", 51, __PRETTY_FUNCTION__); 
# 53
cs_nsites(cs, &nsites); 
# 54
cs_nhalo(cs, &nhalo); 
...
# 57
(obj) ? static_cast< void>(0) : __assert_fail("obj", "map.c", 57, __PRETTY_FUNCTION__); 
# 58
if (obj == (__null)) { pe_fatal(pe, "calloc(map_t) failed\n"); }  
# 60
(obj->status) = ((char *)calloc(nsites, sizeof(char))); 
# 61
(obj->status) ? static_cast< void>(0) : __assert_fail("obj->status", "map.c", 61, __PRETTY_FUNCTION__); 
# 62
if ((obj->status) == (__null)) { pe_fatal(pe, "calloc(map->status) failed\n"); }  
# 64
(obj->pe) = pe; 
# 65
(obj->cs) = cs; 
...
# 72
(obj->data) ? static_cast< void>(0) : __assert_fail("obj->data", "map.c", 72, __PRETTY_FUNCTION__); 
# 73
if ((ndata > 0) && ((obj->data) == (__null))) { pe_fatal(pe, "calloc(map->data) failed\n"); }  
# 75
coords_field_init_mpi_indexed(cs, nhalo, 1, MPI_CHAR, obj->halostatus); 
# 76
if (obj->ndata) { 
# 77
coords_field_init_mpi_indexed(cs, nhalo, obj->ndata, MPI_DOUBLE, obj->halodata); 
# 79
}  
# 84
...
# 98
tdpMemcpy(&((obj->target)->status), &tmp, sizeof(char *), cudaMemcpyHostToDevice); 
# 100
tdpMemcpy(&((obj->target)->is_porous_media), &(obj->is_porous_media), sizeof(int), cudaMemcpyHostToDevice); 
# 102
tdpMemcpy(&((obj->target)->nsite), &(obj->nsite), sizeof(int), cudaMemcpyHostToDevice); 
# 104
tdpMemcpy(&((obj->target)->ndata), &(obj->ndata), sizeof(int), cudaMemcpyHostToDevice); 
# 108
if ((obj->ndata) > 0) { 
# 109
size_t nsz = (((size_t)(obj->ndata)) * nsites) * sizeof(double); 
# 110
{ tdpErrorHandler(tdpMalloc((void **)(&dtmp), nsz), "map.c", 110, 1); } ; 
# 111
{ tdpErrorHandler(tdpMemset(dtmp, 0, nsz), "map.c", 111, 1); } ; 
# 112
{ tdpErrorHandler(tdpMemcpy(&((obj->target)->data), &dtmp, sizeof(double *), cudaMemcpyHostToDevice), "map.c", 113, 1); 
# 112 "map.c"
} 
# 113
; 
...
double *dtmp = (__null); 
# 134
(obj) ? static_cast< void>(0) : __assert_fail("obj", "map.c", 134, __PRETTY_FUNCTION__); 
# 136
tdpGetDeviceCount(&ndevice); 
# 138
if (ndevice > 0) { 
# 139
{ tdpErrorHandler(tdpMemcpy(&tmp, &((obj->target)->status), sizeof(char *), cudaMemcpyDeviceToHost), "map.c", 140, 1); 
# 139 "map.c"
} 
# 140
; 
# 141
{ tdpErrorHandler(tdpFree(tmp), "map.c", 141, 1); } ; 
# 143
if ((obj->ndata) > 0) { 
# 144
{ tdpErrorHandler(tdpMemcpy(&dtmp, &((obj->target)->data), sizeof(double *), cudaMemcpyDeviceToHost), "map.c", 145, 1); 
# 144 "map.c"
} 
# 145
; 
# 146
{ tdpErrorHandler(tdpFree(dtmp), "map.c", 146, 1); } ; 
# 147
}  
# 148
tdpFree(obj->target); 
...
char *tmp; 
# 181
(map) ? static_cast< void>(0) : __assert_fail("map", "map.c", 181, __PRETTY_FUNCTION__); 
# 183
tdpGetDeviceCount(&ndevice); 
# 185
if (ndevice == 0) { 
# 187
((map->target) == map) ? static_cast< void>(0) : __assert_fail("map->target == map", "map.c", 187, __PRETTY_FUNCTION__); 
# 188
} else 
# 189
{ 
# 190
tdpMemcpy(&tmp, &((map->target)->status), sizeof(char *), cudaMemcpyDeviceToHost); 
# 193
switch (flag) { 
# 194
...
size_t sz; 
# 220
(obj) ? static_cast< void>(0) : __assert_fail("obj", "map.c", 220, __PRETTY_FUNCTION__); 
# 221
((obj->info) == (__null)) ? static_cast< void>(0) : __assert_fail("obj->info == __null", "map.c", 221, __PRETTY_FUNCTION__); 
# 223
((args.grid)[X]) = (grid[X]); 
# 224
((args.grid)[Y]) = (grid[Y]); 
...
# 228
if ((obj->info) == (__null)) { pe_fatal(obj->pe, "io_info_create(map) failed\n"); }  
# 230
...
int map_io_info(map_t *obj, io_info_t **info) { 
# 254
(obj) ? static_cast< void>(0) : __assert_fail("obj", "map.c", 254, __PRETTY_FUNCTION__); 
# 255
(info) ? static_cast< void>(0) : __assert_fail("info", "map.c", 255, __PRETTY_FUNCTION__); 
# 257
(*info) = (obj->info); 
# 259
return 0; 
...
int nhalo; 
# 274
(obj) ? static_cast< void>(0) : __assert_fail("obj", "map.c", 274, __PRETTY_FUNCTION__); 
# 276
cs_nhalo(obj->cs, &nhalo); 
# 278
coords_field_halo_rank1(obj->cs, obj->nsite, nhalo, 1, obj->status, MPI_CHAR); 
# 280
if (obj->ndata) { 
# 281
coords_field_halo_rank1(obj->cs, obj->nsite, nhalo, obj->ndata, obj->data, MPI_DOUBLE); 
# 283
}  
# 285
return 0; 
...
int map_status(map_t *obj, int index, int *status) { 
# 299
(obj) ? static_cast< void>(0) : __assert_fail("obj", "map.c", 299, __PRETTY_FUNCTION__); 
# 300
(status) ? static_cast< void>(0) : __assert_fail("status", "map.c", 300, __PRETTY_FUNCTION__); 
# 302
(*status) = ((int)((obj->status)[reverse_addr_rank0_assert(302, "map.c", obj->nsite, index)])); 
# 304
return 0; 
# 305
} 
...
int map_status_set(map_t *obj, int index, int status) { 
# 316
(obj) ? static_cast< void>(0) : __assert_fail("obj", "map.c", 316, __PRETTY_FUNCTION__); 
# 317
(status >= 0) ? static_cast< void>(0) : __assert_fail("status >= 0", "map.c", 317, __PRETTY_FUNCTION__); 
# 318
(status < (MAP_STATUS_MAX)) ? static_cast< void>(0) : __assert_fail("status < MAP_STATUS_MAX", "map.c", 318, __PRETTY_FUNCTION__); 
# 320
((obj->status)[reverse_addr_rank0_assert(320, "map.c", obj->nsite, index)]) = status; 
# 322
return 0; 
# 323
} 
...
int map_ndata(map_t *obj, int *ndata) { 
# 334
(obj) ? static_cast< void>(0) : __assert_fail("obj", "map.c", 334, __PRETTY_FUNCTION__); 
# 335
(ndata) ? static_cast< void>(0) : __assert_fail("ndata", "map.c", 335, __PRETTY_FUNCTION__); 
# 337
(*ndata) = (obj->ndata); 
# 339
return 0; 
...
int n; 
# 353
(obj) ? static_cast< void>(0) : __assert_fail("obj", "map.c", 353, __PRETTY_FUNCTION__); 
# 354
(data) ? static_cast< void>(0) : __assert_fail("data", "map.c", 354, __PRETTY_FUNCTION__); 
# 356
for (n = 0; n < (obj->ndata); n++) { 
# 357
(data[n]) = ((obj->data)[reverse_addr_rank1_assert(357, "map.c", obj->nsite, obj->ndata, index, n)]); 
# 358
}  
# 360
return 0; 
...
int n; 
# 374
(obj) ? static_cast< void>(0) : __assert_fail("obj", "map.c", 374, __PRETTY_FUNCTION__); 
# 375
(data) ? static_cast< void>(0) : __assert_fail("data", "map.c", 375, __PRETTY_FUNCTION__); 
# 377
for (n = 0; n < (obj->ndata); n++) { 
# 378
((obj->data)[reverse_addr_rank1_assert(378, "map.c", obj->nsite, obj->ndata, index, n)]) = (data[n]); 
# 379
}  
# 381
return 0; 
...
# 392
(obj) ? static_cast< void>(0) : __assert_fail("obj", "map.c", 392, __PRETTY_FUNCTION__); 
# 393
(flag) ? static_cast< void>(0) : __assert_fail("flag", "map.c", 393, __PRETTY_FUNCTION__); 
# 395
...
# 408
(obj) ? static_cast< void>(0) : __assert_fail("obj", "map.c", 408, __PRETTY_FUNCTION__); 
# 410
...
MPI_Comm comm; 
# 426
(obj) ? static_cast< void>(0) : __assert_fail("obj", "map.c", 426, __PRETTY_FUNCTION__); 
# 427
(volume) ? static_cast< void>(0) : __assert_fail("volume", "map.c", 427, __PRETTY_FUNCTION__); 
# 429
...
int status; 
# 450
(obj) ? static_cast< void>(0) : __assert_fail("obj", "map.c", 450, __PRETTY_FUNCTION__); 
# 451
(volume) ? static_cast< void>(0) : __assert_fail("volume", "map.c", 451, __PRETTY_FUNCTION__); 
# 453
...
# 484
(fp) ? static_cast< void>(0) : __assert_fail("fp", "map.c", 484, __PRETTY_FUNCTION__); 
# 485
(obj) ? static_cast< void>(0) : __assert_fail("obj", "map.c", 485, __PRETTY_FUNCTION__); 
# 487
indexf = reverse_addr_rank0_assert(487, "map.c", obj->nsite, index); 
# 488
...
for (n = 0; n < (obj->ndata); n++) { 
# 492
indexf = reverse_addr_rank1_assert(492, "map.c", obj->nsite, obj->ndata, index, n); 
# 493
...
map_t *obj = (map_t *)self; 
# 512
(fp) ? static_cast< void>(0) : __assert_fail("fp", "map.c", 512, __PRETTY_FUNCTION__); 
# 513
(obj) ? static_cast< void>(0) : __assert_fail("obj", "map.c", 513, __PRETTY_FUNCTION__); 
# 515
indexf = reverse_addr_rank0_assert(515, "map.c", obj->nsite, index); 
# 516
...
for (n = 0; n < (obj->ndata); n++) { 
# 520
indexf = reverse_addr_rank1_assert(520, "map.c", obj->nsite, obj->ndata, index, n); 
# 521
...
map_t *obj = (map_t *)self; 
# 541
(fp) ? static_cast< void>(0) : __assert_fail("fp", "map.c", 541, __PRETTY_FUNCTION__); 
# 542
(obj) ? static_cast< void>(0) : __assert_fail("obj", "map.c", 542, __PRETTY_FUNCTION__); 
# 544
status = ((obj->status)[reverse_addr_rank0_assert(544, "map.c", obj->nsite, index)]); 
# 545
(status < 99) ? static_cast< void>(0) : __assert_fail("status < 99", "map.c", 545, __PRETTY_FUNCTION__); 
# 547
...
for (n = 0; n < (obj->ndata); n++) { 
# 551
indexf = reverse_addr_rank1_assert(551, "map.c", obj->nsite, obj->ndata, index, n); 
# 552
...
map_t *obj = (map_t *)self; 
# 574
(fp) ? static_cast< void>(0) : __assert_fail("fp", "map.c", 574, __PRETTY_FUNCTION__); 
# 575
(obj) ? static_cast< void>(0) : __assert_fail("obj", "map.c", 575, __PRETTY_FUNCTION__); 
# 577
nr = fscanf(fp, "%2d", &status); 
# 578
if (nr != 1) { pe_fatal(obj->pe, "fscanf(map->status) failed\n"); }  
# 579
((obj->status)[reverse_addr_rank0_assert(579, "map.c", obj->nsite, index)]) = status; 
# 581
for (n = 0; n < (obj->ndata); n++) { 
# 582
indexf = reverse_addr_rank1_assert(582, "map.c", obj->nsite, obj->ndata, index, n); 
# 583
...
# 1 "map.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__11_map_cpp1_ii_f2b804e2
# 1 "map.cudafe1.stub.c"
#include "map.cudafe1.stub.c"
# 1 "map.cudafe1.stub.c"
