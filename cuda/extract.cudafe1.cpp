...
# 118
int write_vtk_header(FILE * fp, int nrec, int  ndim[3], const char * descript, vtk_enum_t vtk); 
# 120
...
# 211
((io_size[0]) == 1) ? static_cast< void>(0) : __assert_fail("io_size[0] == 1", "extract.c", 211, __PRETTY_FUNCTION__); 
# 213
switch (version) { 
# 214
case 1:  
...
# 236
if (datasection == (__null)) { printf("calloc(datasection) failed\n"); }  
# 239
...
# 242
if (le_displacements_ == (__null)) { printf("malloc(le_displacements_)\n"); }  
# 243
if (le_duy_ == (__null)) { printf("malloc(le_duy_) failed\n"); }  
# 244
...
# 288
if ((nrec_ == 3) && (strncmp(stub_, "fed", 3) == 0)) { 
# 290
(0) ? static_cast< void>(0) : __assert_fail("0", "extract.c", 290, __PRETTY_FUNCTION__); 
# 291
} else 
# 292
{ 
...
fp_data = fopen(io_data, "w+b"); 
# 303
if (fp_data == (__null)) { printf("fopen(%s) failed\n", io_data); }  
# 304
printf("\nWriting result to %s\n", io_data); 
# 306
if ((nrec_ == 3) && (strncmp(stub_, "vel", 3) == 0)) { 
# 307
write_vtk_header(fp_data, nrec_, ntargets, "velocity_field", VTK_VECTORS); 
# 309
} else { 
# 310
if ((nrec_ == 1) && (strncmp(stub_, "phi", 3) == 0)) { 
# 311
write_vtk_header(fp_data, nrec_, ntargets, "composition", VTK_SCALARS); 
# 313
} else 
# 314
{ 
...
# 434
if (fp_metadata == (__null)) { printf("fopen(%s) failed\n", io_metadata); }  
# 436
for (p = 0; p < 12; p++) { 
# 437
pstr = fgets(line, 4096, fp_metadata); 
# 438
if (pstr == (__null)) { printf("Failed to read line\n"); }  
# 439
printf("%s", line); 
# 440
}  
...
# 455
ifail = fscanf(fp_metadata, "%d %d %d %d %d %d %d %d %d %d", &rank, &cx, &cy, &cz, &nlx, &nly, &nlz, &nox, &noy, &noz); 
# 457
(ifail == 10) ? static_cast< void>(0) : __assert_fail("ifail == 10", "extract.c", 457, __PRETTY_FUNCTION__); 
# 459
read_data(fp_data, nlocal, datalocal); 
# 460
copy_data(datalocal, datasection); 
...
# 495
p = fgets(tmp, 4096, fp_meta); 
# 496
(p) ? static_cast< void>(0) : __assert_fail("p", "extract.c", 496, __PRETTY_FUNCTION__); 
# 497
ifail = sscanf(tmp + ncharoffset, "%s\n", stub_); 
# 498
(ifail == 1) ? static_cast< void>(0) : __assert_fail("ifail == 1", "extract.c", 498, __PRETTY_FUNCTION__); 
# 499
printf("Read stub: %s\n", stub_); 
# 500
p = fgets(tmp, 4096, fp_meta); 
# 501
(p) ? static_cast< void>(0) : __assert_fail("p", "extract.c", 501, __PRETTY_FUNCTION__); 
# 503
p = fgets(tmp, 4096, fp_meta); 
# 504
(p) ? static_cast< void>(0) : __assert_fail("p", "extract.c", 504, __PRETTY_FUNCTION__); 
# 505
ifail = sscanf(tmp + ncharoffset, "%d\n", &nrbyte); 
# 506
(ifail == 1) ? static_cast< void>(0) : __assert_fail("ifail == 1", "extract.c", 506, __PRETTY_FUNCTION__); 
# 507
...
nrec_ = (nrbyte / 22); 
# 521
(nrec_ > 0) ? static_cast< void>(0) : __assert_fail("nrec_ > 0", "extract.c", 521, __PRETTY_FUNCTION__); 
# 522
}  
# 524
p = fgets(tmp, 4096, fp_meta); 
# 525
(p) ? static_cast< void>(0) : __assert_fail("p", "extract.c", 525, __PRETTY_FUNCTION__); 
# 526
ifail = sscanf(tmp + ncharoffset, "%d", &input_isbigendian_); 
# 527
(ifail == 1) ? static_cast< void>(0) : __assert_fail("ifail == 1", "extract.c", 527, __PRETTY_FUNCTION__); 
# 528
((input_isbigendian_ == 0) || (input_isbigendian_ == 1)) ? static_cast< void>(0) : __assert_fail("input_isbigendian_ == 0 || input_isbigendian_ == 1", "extract.c", 528, __PRETTY_FUNCTION__); 
# 530
p = fgets(tmp, 4096, fp_meta); 
# 531
(p) ? static_cast< void>(0) : __assert_fail("p", "extract.c", 531, __PRETTY_FUNCTION__); 
# 532
ifail = sscanf(tmp + ncharoffset, "%d\n", &npe); 
# 533
(ifail == 1) ? static_cast< void>(0) : __assert_fail("ifail == 1", "extract.c", 533, __PRETTY_FUNCTION__); 
# 534
printf("Total number of processors %d\n", npe); 
# 536
p = fgets(tmp, 4096, fp_meta); 
# 537
(p) ? static_cast< void>(0) : __assert_fail("p", "extract.c", 537, __PRETTY_FUNCTION__); 
# 538
ifail = sscanf(tmp + ncharoffset, "%d %d %d", pe_, pe_ + 1, pe_ + 2); 
# 539
(ifail == 3) ? static_cast< void>(0) : __assert_fail("ifail == 3", "extract.c", 539, __PRETTY_FUNCTION__); 
# 540
printf("Decomposition is %d %d %d\n", pe_[0], pe_[1], pe_[2]); 
# 541
(npe == (((pe_[0]) * (pe_[1])) * (pe_[2]))) ? static_cast< void>(0) : __assert_fail("npe == pe_[0]*pe_[1]*pe_[2]", "extract.c", 541, __PRETTY_FUNCTION__); 
# 543
p = fgets(tmp, 4096, fp_meta); 
# 544
(p) ? static_cast< void>(0) : __assert_fail("p", "extract.c", 544, __PRETTY_FUNCTION__); 
# 545
ifail = sscanf(tmp + ncharoffset, "%d %d %d", ntotal, ntotal + 1, ntotal + 2); 
# 546
(ifail == 3) ? static_cast< void>(0) : __assert_fail("ifail == 3", "extract.c", 546, __PRETTY_FUNCTION__); 
# 547
printf("System size is %d %d %d\n", ntotal[0], ntotal[1], ntotal[2]); 
# 549
p = fgets(tmp, 4096, fp_meta); 
# 550
(p) ? static_cast< void>(0) : __assert_fail("p", "extract.c", 550, __PRETTY_FUNCTION__); 
# 551
ifail = sscanf(tmp + ncharoffset, "%d", &nplanes_); 
# 552
(ifail == 1) ? static_cast< void>(0) : __assert_fail("ifail == 1", "extract.c", 552, __PRETTY_FUNCTION__); 
# 553
(nplanes_ >= 0) ? static_cast< void>(0) : __assert_fail("nplanes_ >= 0", "extract.c", 553, __PRETTY_FUNCTION__); 
# 554
printf("Number of Lees Edwards planes %d\n", nplanes_); 
# 555
p = fgets(tmp, 4096, fp_meta); 
# 556
(p) ? static_cast< void>(0) : __assert_fail("p", "extract.c", 556, __PRETTY_FUNCTION__); 
# 557
ifail = sscanf(tmp + ncharoffset, "%lf", &le_speed_); 
# 558
(ifail == 1) ? static_cast< void>(0) : __assert_fail("ifail == 1", "extract.c", 558, __PRETTY_FUNCTION__); 
# 559
printf("Lees Edwards speed: %f\n", le_speed_); 
# 562
p = fgets(tmp, 4096, fp_meta); 
# 563
(p) ? static_cast< void>(0) : __assert_fail("p", "extract.c", 563, __PRETTY_FUNCTION__); 
# 564
ifail = sscanf(tmp + ncharoffset, "%d", &nio_); 
# 565
(ifail == 1) ? static_cast< void>(0) : __assert_fail("ifail == 1", "extract.c", 565, __PRETTY_FUNCTION__); 
# 566
printf("Number of I/O groups: %d\n", nio_); 
# 568
p = fgets(tmp, 4096, fp_meta); 
# 569
if (p == (__null)) { printf("Not reached last line correctly\n"); }  
# 570
ifail = sscanf(tmp + ncharoffset, "%d %d %d\n", io_size + 0, io_size + 1, io_size + 2); 
# 572
(ifail == 3) ? static_cast< void>(0) : __assert_fail("ifail == 3", "extract.c", 572, __PRETTY_FUNCTION__); 
# 573
...
# 607
(ntime >= 0) ? static_cast< void>(0) : __assert_fail("ntime >= 0", "extract.c", 607, __PRETTY_FUNCTION__); 
# 608
return ntime; 
# 609
} 
...
# 669
(nread == 1) ? static_cast< void>(0) : __assert_fail("nread == 1", "extract.c", 669, __PRETTY_FUNCTION__); 
# 670
...
# 688
(nread == 1) ? static_cast< void>(0) : __assert_fail("nread == 1", "extract.c", 688, __PRETTY_FUNCTION__); 
# 689
}  
# 690
}  
...
for (n = 0; n < nrec_; n++) { 
# 871
(buffer[(nrec_ * site_index(1, jc, kc, ntargets)) + n]) = ((((((((-((1.0) / (6.0))) * fr) * (fr - (1.0))) * (fr - (2.0))) * (data[(nrec_ * site_index(ic, j0, kc, ntargets)) + n])) + ((((0.5) * ((fr * fr) - (1.0))) * (fr - (2.0))) * (data[(nrec_ * site_index(ic, j1, kc, ntargets)) + n]))) - (((((0.5) * fr) * (fr + (1.0))) * (fr - (2.0))) * (data[(nrec_ * site_index(ic, j2, kc, ntargets)) + n]))) + (((((1.0) / (6.0)) * fr) * ((fr * fr) - (1.0))) * (data[(nrec_ * site_index(ic, j3, kc, ntargets)) + n]))); 
# 880
}  
# 881
}  
...
for (n = 0; n < nrec_; n++) { 
# 888
(data[(nrec_ * site_index(ic, jc, kc, ntargets)) + n]) = (buffer[(nrec_ * site_index(1, jc, kc, ntargets)) + n]); 
# 890
if (n < 3) { 
# 891
...
# 912 "extract.c"
int write_vtk_header(FILE *fp, int nrec, int ndim[3], const char *descript, vtk_enum_t 
# 913
vtk) { 
# 915
(fp) ? static_cast< void>(0) : __assert_fail("fp", "extract.c", 915, __PRETTY_FUNCTION__); 
# 917
...
FILE *fp_data = (__null); 
# 952
(datasection) ? static_cast< void>(0) : __assert_fail("datasection", "extract.c", 952, __PRETTY_FUNCTION__); 
# 953
(nrec_ == 5) ? static_cast< void>(0) : __assert_fail("nrec_ == 5", "extract.c", 953, __PRETTY_FUNCTION__); 
# 956
if (output_lcs_) { 
# 957
...
int index, nr; 
# 1030
(fp) ? static_cast< void>(0) : __assert_fail("fp", "extract.c", 1030, __PRETTY_FUNCTION__); 
# 1031
((nrec0 + nrec) <= nrec_) ? static_cast< void>(0) : __assert_fail("(nrec0 + nrec) <= nrec_", "extract.c", 1031, __PRETTY_FUNCTION__); 
# 1033
for (ic = 1; ic <= (n[0]); ic++) { 
# 1034
for (jc = 1; jc <= (n[1]); jc++) { 
...
int index, nr; 
# 1063
(fp) ? static_cast< void>(0) : __assert_fail("fp", "extract.c", 1063, __PRETTY_FUNCTION__); 
# 1064
((nrec0 + nrec) <= nrec_) ? static_cast< void>(0) : __assert_fail("(nrec0 + nrec) <= nrec_", "extract.c", 1064, __PRETTY_FUNCTION__); 
# 1066
for (ic = 1; ic <= (n[0]); ic++) { 
# 1067
for (jc = 1; jc <= (n[1]); jc++) { 
...
int index, nr; 
# 1099
(fp) ? static_cast< void>(0) : __assert_fail("fp", "extract.c", 1099, __PRETTY_FUNCTION__); 
# 1100
((nrec0 + nrec) <= nrec_) ? static_cast< void>(0) : __assert_fail("(nrec0 + nrec) <= nrec_", "extract.c", 1100, __PRETTY_FUNCTION__); 
# 1102
for (kc = 1; kc <= (n[2]); kc++) { 
# 1103
for (jc = 1; jc <= (n[1]); jc++) { 
...
int index, nr; 
# 1129
(fp) ? static_cast< void>(0) : __assert_fail("fp", "extract.c", 1129, __PRETTY_FUNCTION__); 
# 1130
((nrec0 + nrec) <= nrec_) ? static_cast< void>(0) : __assert_fail("(nrec0 + nrec) <= nrec_", "extract.c", 1130, __PRETTY_FUNCTION__); 
# 1132
for (kc = 1; kc <= (n[2]); kc++) { 
# 1133
for (jc = 1; jc <= (n[1]); jc++) { 
...
double q[3][3], qs[5]; 
# 1172
(nrec_ == 5) ? static_cast< void>(0) : __assert_fail("nrec_ == 5", "extract.c", 1172, __PRETTY_FUNCTION__); 
# 1173
(datasection) ? static_cast< void>(0) : __assert_fail("datasection", "extract.c", 1173, __PRETTY_FUNCTION__); 
# 1175
for (ic = 1; ic <= (nlocal[0]); ic++) { 
# 1176
for (jc = 1; jc <= (nlocal[1]); jc++) { 
...
# 1 "extract.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__15_extract_cpp1_ii_nplanes_
# 1 "extract.cudafe1.stub.c"
#include "extract.cudafe1.stub.c"
# 1 "extract.cudafe1.stub.c"
