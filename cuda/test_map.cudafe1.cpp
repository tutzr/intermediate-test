...
map_t *map = (__null); 
# 85
(pe) ? static_cast< void>(0) : __assert_fail("pe", "test_map.c", 85, __PRETTY_FUNCTION__); 
# 87
cs_create(pe, &cs); 
# 88
cs_init(cs); 
...
# 93
(map) ? static_cast< void>(0) : __assert_fail("map", "test_map.c", 93, __PRETTY_FUNCTION__); 
# 95
map_ndata(map, &ndata); 
# 96
(ndata == ndataref) ? static_cast< void>(0) : __assert_fail("ndata == ndataref", "test_map.c", 96, __PRETTY_FUNCTION__); 
# 99
map_pm(map, &pm); 
# 100
(pm == 0) ? static_cast< void>(0) : __assert_fail("pm == 0", "test_map.c", 100, __PRETTY_FUNCTION__); 
# 101
map_pm_set(map, 1); 
# 102
map_pm(map, &pm); 
# 103
(pm == 1) ? static_cast< void>(0) : __assert_fail("pm == 1", "test_map.c", 103, __PRETTY_FUNCTION__); 
# 109
((MAP_FLUID) == 0) ? static_cast< void>(0) : __assert_fail("MAP_FLUID == 0", "test_map.c", 109, __PRETTY_FUNCTION__); 
# 111
...
# 117
(status == (MAP_FLUID)) ? static_cast< void>(0) : __assert_fail("status == MAP_FLUID", "test_map.c", 117, __PRETTY_FUNCTION__); 
# 118
}  
# 119
}  
...
# 126
(vol == (((nlocal[X]) * (nlocal[Y])) * (nlocal[Z]))) ? static_cast< void>(0) : __assert_fail("vol == nlocal[X]*nlocal[Y]*nlocal[Z]", "test_map.c", 126, __PRETTY_FUNCTION__); 
# 128
vol = 0; 
# 129
map_volume_allreduce(map, MAP_FLUID, &vol); 
# 130
(vol == (((ntotal[X]) * (ntotal[Y])) * (ntotal[Z]))) ? static_cast< void>(0) : __assert_fail("vol == ntotal[X]*ntotal[Y]*ntotal[Z]", "test_map.c", 130, __PRETTY_FUNCTION__); 
# 134
...
map_status(map, index, &status); 
# 137
(status == (MAP_BOUNDARY)) ? static_cast< void>(0) : __assert_fail("status == MAP_BOUNDARY", "test_map.c", 137, __PRETTY_FUNCTION__); 
# 139
map_free(map); 
# 140
cs_free(cs); 
...
map_t *map = (__null); 
# 166
(pe) ? static_cast< void>(0) : __assert_fail("pe", "test_map.c", 166, __PRETTY_FUNCTION__); 
# 168
cs_create(pe, &cs); 
# 169
cs_init(cs); 
...
map_create(pe, cs, ndataref, &map); 
# 173
(map) ? static_cast< void>(0) : __assert_fail("map", "test_map.c", 173, __PRETTY_FUNCTION__); 
# 175
map_ndata(map, &ndata); 
# 176
(ndata == ndataref) ? static_cast< void>(0) : __assert_fail("ndata == ndataref", "test_map.c", 176, __PRETTY_FUNCTION__); 
# 178
map_data_set(map, index, dataref); 
# 179
map_data(map, index, data); 
# 180
(fabs((data[0]) - (dataref[0])) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(data[0] - dataref[0]) < double(2.22044604925031308085e-16L)", "test_map.c", 180, __PRETTY_FUNCTION__); 
# 181
(fabs((data[1]) - (dataref[1])) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(data[1] - dataref[1]) < double(2.22044604925031308085e-16L)", "test_map.c", 181, __PRETTY_FUNCTION__); 
# 183
map_free(map); 
# 184
cs_free(cs); 
...
map_t *map = (__null); 
# 201
(pe) ? static_cast< void>(0) : __assert_fail("pe", "test_map.c", 201, __PRETTY_FUNCTION__); 
# 202
(ndata > 0) ? static_cast< void>(0) : __assert_fail("ndata > 0", "test_map.c", 202, __PRETTY_FUNCTION__); 
# 204
cs_create(pe, &cs); 
# 205
cs_init(cs); 
...
# 209
(map) ? static_cast< void>(0) : __assert_fail("map", "test_map.c", 209, __PRETTY_FUNCTION__); 
# 211
...
# 217
test_coords_field_check(cs, nhalo, map->ndata, map->data, MPI_DOUBLE, test_ref_double1); 
# 220
map_free(map); 
# 221
cs_free(cs); 
...
# 242
(pe) ? static_cast< void>(0) : __assert_fail("pe", "test_map.c", 242, __PRETTY_FUNCTION__); 
# 244
pe_mpi_comm(pe, &comm); 
# 246
(grid[X]) = 1; 
...
map_create(pe, cs, ndata, &map); 
# 259
(map) ? static_cast< void>(0) : __assert_fail("map", "test_map.c", 259, __PRETTY_FUNCTION__); 
# 261
map_init_io_info(map, grid, io_format, io_format); 
# 262
map_io_info(map, &iohandler); 
# 263
(iohandler) ? static_cast< void>(0) : __assert_fail("iohandler", "test_map.c", 263, __PRETTY_FUNCTION__); 
# 265
test_coords_field_set(cs, 1, map->status, MPI_CHAR, test_ref_char1); 
# 266
...
map_create(pe, cs, ndata, &map); 
# 277
(map) ? static_cast< void>(0) : __assert_fail("map", "test_map.c", 277, __PRETTY_FUNCTION__); 
# 279
map_init_io_info(map, grid, io_format, io_format); 
# 280
map_io_info(map, &iohandler); 
# 281
(iohandler) ? static_cast< void>(0) : __assert_fail("iohandler", "test_map.c", 281, __PRETTY_FUNCTION__); 
# 283
...
# 1 "test_map.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__16_test_map_cpp1_ii_8b13e4ab
# 1 "test_map.cudafe1.stub.c"
#include "test_map.cudafe1.stub.c"
# 1 "test_map.cudafe1.stub.c"
