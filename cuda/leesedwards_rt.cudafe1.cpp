...
int key; 
# 20
(rt) ? static_cast< void>(0) : __assert_fail("rt", "leesedwards_rt.c", 20, __PRETTY_FUNCTION__); 
# 21
(info) ? static_cast< void>(0) : __assert_fail("info", "leesedwards_rt.c", 21, __PRETTY_FUNCTION__); 
# 23
(info->nplanes) = 0; 
# 24
...
# 1 "leesedwards_rt.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__22_leesedwards_rt_cpp1_ii_0a41a186
# 1 "leesedwards_rt.cudafe1.stub.c"
#include "leesedwards_rt.cudafe1.stub.c"
# 1 "leesedwards_rt.cudafe1.stub.c"
