...
# 51 "gradient_2d_tomita_fluid.c"
static const double epsilon_ = (0.5); 
# 52
static const double epsilon1_ = (0.25); 
# 54
int grad_2d_tomita_fluid_operator(lees_edw_t * le, field_grad_t * fg, int nextra); 
# 56
int grad_2d_tomita_fluid_le(lees_edw_t * le, field_grad_t * fg, int nextra); 
# 68 "gradient_2d_tomita_fluid.c"
int grad_2d_tomita_fluid_d2(field_grad_t *fg) { 
# 70
int nextra; 
# 71
cs_t *cs = (__null); 
...
# 74
(fg) ? static_cast< void>(0) : __assert_fail("fg", "gradient_2d_tomita_fluid.c", 74, __PRETTY_FUNCTION__); 
# 75
(fg->field) ? static_cast< void>(0) : __assert_fail("fg->field", "gradient_2d_tomita_fluid.c", 75, __PRETTY_FUNCTION__); 
# 77
cs = ((fg->field)->cs); 
# 78
le = ((fg->field)->le); 
...
nextra -= 1; 
# 82
(nextra >= 0) ? static_cast< void>(0) : __assert_fail("nextra >= 0", "gradient_2d_tomita_fluid.c", 82, __PRETTY_FUNCTION__); 
# 84
grad_2d_tomita_fluid_operator(le, fg, nextra); 
# 85
grad_2d_tomita_fluid_le(le, fg, nextra); 
# 87
(0) ? static_cast< void>(0) : __assert_fail("0", "gradient_2d_tomita_fluid.c", 87, __PRETTY_FUNCTION__); 
# 89
return 0; 
# 90
} 
# 101 "gradient_2d_tomita_fluid.c"
int grad_2d_tomita_fluid_d4(field_grad_t *fg) { 
# 103
int nhalo; 
# 104
int nextra; 
...
nextra = (nhalo - 2); 
# 112
(nextra >= 0) ? static_cast< void>(0) : __assert_fail("nextra >= 0", "gradient_2d_tomita_fluid.c", 112, __PRETTY_FUNCTION__); 
# 114
(0) ? static_cast< void>(0) : __assert_fail("0", "gradient_2d_tomita_fluid.c", 114, __PRETTY_FUNCTION__); 
# 116
grad_2d_tomita_fluid_operator(le, fg, nextra); 
# 117
grad_2d_tomita_fluid_le(le, fg, nextra); 
...
# 128
int grad_2d_tomita_fluid_operator(lees_edw_t *le, field_grad_t *fg, int 
# 129
nextra) { 
# 131
int nop; 
...
# 147
(le) ? static_cast< void>(0) : __assert_fail("le", "gradient_2d_tomita_fluid.c", 147, __PRETTY_FUNCTION__); 
# 148
(fg) ? static_cast< void>(0) : __assert_fail("fg", "gradient_2d_tomita_fluid.c", 148, __PRETTY_FUNCTION__); 
# 150
...
for (n = 0; n < nop; n++) { 
# 170
(grad[(3 * ((nop * index) + n)) + (X)]) = (((0.5) * rfactor1) * (((field[(nop * indexp1) + n]) - (field[(nop * indexm1) + n])) + (epsilon1_ * ((((field[(nop * (indexp1 + ys)) + n]) - (field[(nop * (indexm1 + ys)) + n])) + (field[(nop * (indexp1 - ys)) + n])) - (field[(nop * (indexm1 - ys)) + n]))))); 
# 175
(grad[(3 * ((nop * index) + n)) + (Y)]) = (((0.5) * rfactor1) * (((field[(nop * (index + ys)) + n]) - (field[(nop * (index - ys)) + n])) + (epsilon1_ * ((((field[(nop * (indexp1 + ys)) + n]) - (field[(nop * (indexp1 - ys)) + n])) + (field[(nop * (indexm1 + ys)) + n])) - (field[(nop * (indexm1 - ys)) + n]))))); 
# 180
(grad[(3 * ((nop * index) + n)) + (Z)]) = (0.0); 
# 181
(del2[(nop * index) + n]) = (rfactor * ((((((field[(nop * indexp1) + n]) + (field[(nop * indexm1) + n])) + (field[(nop * (index + ys)) + n])) + (field[(nop * (index - ys)) + n])) + (epsilon_ * ((((field[(nop * (indexp1 + ys)) + n]) + (field[(nop * (indexp1 - ys)) + n])) + (field[(nop * (indexm1 + ys)) + n])) + (field[(nop * (indexm1 - ys)) + n])))) - (((4.0) * ((1.0) + epsilon_)) * (field[(nop * index) + n])))); 
# 191
}  
# 192
}  
...
# 207 "gradient_2d_tomita_fluid.c"
int grad_2d_tomita_fluid_le(lees_edw_t *le, field_grad_t *fg, int 
# 208
nextra) { 
# 209
int nop; 
...
double *__restrict__ del2; 
# 226
(le) ? static_cast< void>(0) : __assert_fail("le", "gradient_2d_tomita_fluid.c", 226, __PRETTY_FUNCTION__); 
# 227
(fg) ? static_cast< void>(0) : __assert_fail("fg", "gradient_2d_tomita_fluid.c", 227, __PRETTY_FUNCTION__); 
# 229
lees_edw_nlocal(le, nlocal); 
# 230
lees_edw_nhalo(le, &nhalo); 
# 232
((nlocal[Z]) == 1) ? static_cast< void>(0) : __assert_fail("nlocal[Z] == 1", "gradient_2d_tomita_fluid.c", 232, __PRETTY_FUNCTION__); 
# 234
ys = ((nlocal[Z]) + (2 * nhalo)); 
# 236
nop = ((fg->field)->nf); 
...
for (n = 0; n < nop; n++) { 
# 257
(grad[(3 * ((nop * index) + n)) + (X)]) = (((0.5) * rfactor) * (((field[(nop * indexp1) + n]) - (field[(nop * indexm1) + n])) + (epsilon_ * ((((field[(nop * (indexp1 + ys)) + n]) - (field[(nop * (indexm1 + ys)) + n])) + (field[(nop * (indexp1 - ys)) + n])) - (field[(nop * (indexm1 - ys)) + n]))))); 
# 262
(grad[(3 * ((nop * index) + n)) + (Y)]) = (((0.5) * rfactor) * (((field[(nop * (index + ys)) + n]) - (field[(nop * (index - ys)) + n])) + (epsilon_ * ((((field[(nop * (indexp1 + ys)) + n]) - (field[(nop * (indexp1 - ys)) + n])) + (field[(nop * (indexm1 + ys)) + n])) - (field[(nop * (indexm1 - ys)) + n]))))); 
# 267
(grad[(3 * ((nop * index) + n)) + (Z)]) = (0.0); 
# 269
(del2[(nop * index) + n]) = (rfactor * ((((((field[(nop * indexp1) + n]) + (field[(nop * indexm1) + n])) + (field[(nop * (index + ys)) + n])) + (field[(nop * (index - ys)) + n])) + (epsilon_ * ((((field[(nop * (indexp1 + ys)) + n]) + (field[(nop * (indexp1 - ys)) + n])) + (field[(nop * (indexm1 + ys)) + n])) + (field[(nop * (indexm1 - ys)) + n])))) - (((4.0) * ((1.0) + epsilon_)) * (field[(nop * index) + n])))); 
...
# 1 "gradient_2d_tomita_fluid.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__32_gradient_2d_tomita_fluid_cpp1_ii_7a15f398
# 1 "gradient_2d_tomita_fluid.cudafe1.stub.c"
#include "gradient_2d_tomita_fluid.cudafe1.stub.c"
# 1 "gradient_2d_tomita_fluid.cudafe1.stub.c"
