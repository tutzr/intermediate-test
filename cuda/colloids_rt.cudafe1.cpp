...
# 39
int lubrication_single(lubr_t * obj, double a1, double a2, const double  u1[3], const double  u2[3], const double  r12[3], const double  ran[2], double  f[3]); 
# 23 "pair_ss_cut.h"
...
# 32
int pair_ss_cut_param_set(pair_ss_cut_t * obj, double epsilon, double sigma, int nu, double hc); 
# 23 "pair_lj_cut.h"
...
# 27
int pair_lj_cut_param_set(pair_lj_cut_t * obj, double epsilon, double sigma, double rc); 
# 29
...
# 28
int pair_yukawa_param_set(pair_yukawa_t * obj, double epsilon, double kappa, double rc); 
# 30
...
# 21 "colloids_init.h"
int colloids_init_random(pe_t * pe, cs_t * cs, colloids_info_t * cinfo, int n, const colloid_state_t * state0, wall_t * wall, double dh); 
# 21 "colloid_io.h"
...
# 24 "colloid_io_rt.h"
int colloid_io_run_time(pe_t * pe, rt_t * rt, cs_t * cs, colloids_info_t * cinfo, colloid_io_t ** pcio); 
# 28 "colloids_rt.h"
...
# 51
int colloids_rt_dynamics(cs_t * cs, colloids_info_t * cinfo, wall_t * wall, map_t * map); 
# 53
...
# 55
int colloids_rt_init_from_file(pe_t * pe, rt_t * rt, colloids_info_t * cinfo, colloid_io_t * cio); 
# 57
int colloids_rt_init_random(pe_t * pe, cs_t * cs, rt_t * rt, wall_t * wall, colloids_info_t * cinfo); 
# 59
int colloids_rt_state_stub(pe_t * pe, rt_t * rt, colloids_info_t * cinfo, const char * stub, colloid_state_t * state); 
# 62
int colloids_rt_cell_list_checks(pe_t * pe, cs_t * cs, colloids_info_t ** pinfo, interact_t * interact); 
# 79 "colloids_rt.c"
int colloids_init_rt(pe_t *pe, rt_t *rt, cs_t *cs, colloids_info_t **pinfo, colloid_io_t **
# 80
pcio, interact_t **
# 81
interact, wall_t *wall, map_t *map) { 
# 82
int nc; 
# 83
int init_one = 0; 
...
char keyvalue[8192] = ""; 
# 91
(pe) ? static_cast< void>(0) : __assert_fail("pe", "colloids_rt.c", 91, __PRETTY_FUNCTION__); 
# 92
(cs) ? static_cast< void>(0) : __assert_fail("cs", "colloids_rt.c", 92, __PRETTY_FUNCTION__); 
# 93
(rt) ? static_cast< void>(0) : __assert_fail("rt", "colloids_rt.c", 93, __PRETTY_FUNCTION__); 
# 98
colloids_info_create(pe, cs, ncell, pinfo); 
# 100
rt_string_parameter(rt, "colloid_init", keyvalue, 8192); 
# 102
...
# 135
(*interact) ? static_cast< void>(0) : __assert_fail("*interact", "colloids_rt.c", 135, __PRETTY_FUNCTION__); 
# 137
...
# 187
int colloids_rt_dynamics(cs_t *cs, colloids_info_t *cinfo, wall_t *wall, map_t *
# 188
map) { 
# 190
...
MPI_Comm comm; 
# 194
(cs) ? static_cast< void>(0) : __assert_fail("cs", "colloids_rt.c", 194, __PRETTY_FUNCTION__); 
# 195
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "colloids_rt.c", 195, __PRETTY_FUNCTION__); 
# 199
...
# 223 "colloids_rt.c"
int colloids_rt_init_few(pe_t *pe, rt_t *rt, colloids_info_t *cinfo, int 
# 224
nc) { 
# 226
colloid_t *pc = (__null); 
# 227
colloid_state_t *state1 = (__null); 
# 228
colloid_state_t *state2 = (__null); 
# 229
colloid_state_t *state3 = (__null); 
# 231
(pe) ? static_cast< void>(0) : __assert_fail("pe", "colloids_rt.c", 231, __PRETTY_FUNCTION__); 
# 232
(rt) ? static_cast< void>(0) : __assert_fail("rt", "colloids_rt.c", 232, __PRETTY_FUNCTION__); 
# 233
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "colloids_rt.c", 233, __PRETTY_FUNCTION__); 
# 235
if (nc >= 1) { 
# 236
...
# 238
(state1 != (__null)) ? static_cast< void>(0) : __assert_fail("state1 != __null", "colloids_rt.c", 238, __PRETTY_FUNCTION__); 
# 240
...
# 250
(state2 != (__null)) ? static_cast< void>(0) : __assert_fail("state2 != __null", "colloids_rt.c", 250, __PRETTY_FUNCTION__); 
# 251
...
# 261
(state3 != (__null)) ? static_cast< void>(0) : __assert_fail("state3 != __null", "colloids_rt.c", 261, __PRETTY_FUNCTION__); 
# 262
...
# 282
int colloids_rt_init_from_file(pe_t *pe, rt_t *rt, colloids_info_t *cinfo, colloid_io_t *
# 283
cio) { 
# 285
int ntstep; 
# 286
char subdirectory[8192]; 
# 287
char filename[3 * 8192]; 
# 288
char stub[8192]; 
# 289
physics_t *phys = (__null); 
# 291
(pe) ? static_cast< void>(0) : __assert_fail("pe", "colloids_rt.c", 291, __PRETTY_FUNCTION__); 
# 292
(rt) ? static_cast< void>(0) : __assert_fail("rt", "colloids_rt.c", 292, __PRETTY_FUNCTION__); 
# 293
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "colloids_rt.c", 293, __PRETTY_FUNCTION__); 
# 294
(cio) ? static_cast< void>(0) : __assert_fail("cio", "colloids_rt.c", 294, __PRETTY_FUNCTION__); 
# 296
...
# 300
rt_string_parameter(rt, "colloid_file_stub", stub, 8192); 
# 302
...
# 324
int colloids_rt_init_random(pe_t *pe, cs_t *cs, rt_t *rt, wall_t *wall, colloids_info_t *
# 325
cinfo) { 
# 327
int nc; 
...
double dh = (0.0); 
# 329
colloid_state_t *state0 = (__null); 
# 331
(pe) ? static_cast< void>(0) : __assert_fail("pe", "colloids_rt.c", 331, __PRETTY_FUNCTION__); 
# 332
(rt) ? static_cast< void>(0) : __assert_fail("rt", "colloids_rt.c", 332, __PRETTY_FUNCTION__); 
# 333
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "colloids_rt.c", 333, __PRETTY_FUNCTION__); 
# 335
state0 = ((colloid_state_t *)calloc(1, sizeof(colloid_state_t))); 
# 336
(state0 != (__null)) ? static_cast< void>(0) : __assert_fail("state0 != __null", "colloids_rt.c", 336, __PRETTY_FUNCTION__); 
# 338
...
# 366 "colloids_rt.c"
int colloids_rt_state_stub(pe_t *pe, rt_t *rt, colloids_info_t *cinfo, const char *
# 367
stub, colloid_state_t *
# 368
state) { 
# 369
int nrt, nrt1; 
...
# 380
(pe) ? static_cast< void>(0) : __assert_fail("pe", "colloids_rt.c", 380, __PRETTY_FUNCTION__); 
# 381
(rt) ? static_cast< void>(0) : __assert_fail("rt", "colloids_rt.c", 381, __PRETTY_FUNCTION__); 
# 382
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "colloids_rt.c", 382, __PRETTY_FUNCTION__); 
# 383
(stub) ? static_cast< void>(0) : __assert_fail("stub", "colloids_rt.c", 383, __PRETTY_FUNCTION__); 
# 384
(state) ? static_cast< void>(0) : __assert_fail("state", "colloids_rt.c", 384, __PRETTY_FUNCTION__); 
# 386
(state->rebuild) = 1; 
# 388
...
# 421
if (nrt1) { pe_info(pe, format_i3, key1, (state->isfixedrxyz)[X], (state->isfixedrxyz)[Y], (state->isfixedrxyz)[Z]); }  
# 424
...
# 437
if (nrt1) { pe_info(pe, format_i3, key1, (state->isfixedvxyz)[X], (state->isfixedvxyz)[Y], (state->isfixedvxyz)[Z]); }  
# 440
...
# 449
nrt = rt_string_parameter(rt, key, value, 8192); 
# 451
...
physics_t *phys = (__null); 
# 535
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "colloids_rt.c", 535, __PRETTY_FUNCTION__); 
# 537
physics_ref(&phys); 
# 538
...
# 575 "colloids_rt.c"
int colloids_rt_cell_list_checks(pe_t *pe, cs_t *cs, colloids_info_t **
# 576
pinfo, interact_t *
# 577
interact) { 
...
double wcell[3]; 
# 588
(pe) ? static_cast< void>(0) : __assert_fail("pe", "colloids_rt.c", 588, __PRETTY_FUNCTION__); 
# 589
(cs) ? static_cast< void>(0) : __assert_fail("cs", "colloids_rt.c", 589, __PRETTY_FUNCTION__); 
# 590
(pinfo) ? static_cast< void>(0) : __assert_fail("pinfo", "colloids_rt.c", 590, __PRETTY_FUNCTION__); 
# 591
(*pinfo) ? static_cast< void>(0) : __assert_fail("*pinfo", "colloids_rt.c", 591, __PRETTY_FUNCTION__); 
# 593
colloids_info_ntotal(*pinfo, &nc); 
# 595
if (nc == 0) { return 0; }  
...
# 657
int colloids_init_ewald_rt(pe_t *pe, rt_t *rt, cs_t *cs, colloids_info_t *
# 658
cinfo, ewald_t **
# 659
pewald) { 
...
double rc; 
# 667
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "colloids_rt.c", 667, __PRETTY_FUNCTION__); 
# 669
...
# 682
(*pewald) ? static_cast< void>(0) : __assert_fail("*pewald", "colloids_rt.c", 682, __PRETTY_FUNCTION__); 
# 683
ewald_info(*pewald); 
# 684
}  
...
lubr_t *lubr = (__null); 
# 705
(pe) ? static_cast< void>(0) : __assert_fail("pe", "colloids_rt.c", 705, __PRETTY_FUNCTION__); 
# 706
(rt) ? static_cast< void>(0) : __assert_fail("rt", "colloids_rt.c", 706, __PRETTY_FUNCTION__); 
# 708
...
physics_t *phys = (__null); 
# 750
pair_ss_cut_t *pair = (__null); 
# 752
(pe) ? static_cast< void>(0) : __assert_fail("pe", "colloids_rt.c", 752, __PRETTY_FUNCTION__); 
# 753
(rt) ? static_cast< void>(0) : __assert_fail("rt", "colloids_rt.c", 753, __PRETTY_FUNCTION__); 
# 755
physics_ref(&phys); 
# 756
physics_kt(phys, &kt); 
...
double cutoff; 
# 798
pair_yukawa_t *yukawa = (__null); 
# 800
(pe) ? static_cast< void>(0) : __assert_fail("pe", "colloids_rt.c", 800, __PRETTY_FUNCTION__); 
# 801
(rt) ? static_cast< void>(0) : __assert_fail("rt", "colloids_rt.c", 801, __PRETTY_FUNCTION__); 
# 802
(interact) ? static_cast< void>(0) : __assert_fail("interact", "colloids_rt.c", 802, __PRETTY_FUNCTION__); 
# 804
...
double cutoff; 
# 837
pair_lj_cut_t *lj = (__null); 
# 839
(pe) ? static_cast< void>(0) : __assert_fail("pe", "colloids_rt.c", 839, __PRETTY_FUNCTION__); 
# 840
(rt) ? static_cast< void>(0) : __assert_fail("rt", "colloids_rt.c", 840, __PRETTY_FUNCTION__); 
# 841
(inter) ? static_cast< void>(0) : __assert_fail("inter", "colloids_rt.c", 841, __PRETTY_FUNCTION__); 
# 843
...
double r0; 
# 875
bond_fene_t *fene = (__null); 
# 877
(pe) ? static_cast< void>(0) : __assert_fail("pe", "colloids_rt.c", 877, __PRETTY_FUNCTION__); 
# 878
(rt) ? static_cast< void>(0) : __assert_fail("rt", "colloids_rt.c", 878, __PRETTY_FUNCTION__); 
# 879
(interact) ? static_cast< void>(0) : __assert_fail("interact", "colloids_rt.c", 879, __PRETTY_FUNCTION__); 
# 881
...
double kappa; 
# 910
angle_cosine_t *angle = (__null); 
# 912
(rt) ? static_cast< void>(0) : __assert_fail("rt", "colloids_rt.c", 912, __PRETTY_FUNCTION__); 
# 913
(interact) ? static_cast< void>(0) : __assert_fail("interact", "colloids_rt.c", 913, __PRETTY_FUNCTION__); 
# 915
...
# 950 "colloids_rt.c"
int colloids_init_halo_range_check(pe_t *pe, cs_t *cs, colloids_info_t *
# 951
cinfo) { 
# 953
int ifail = 0; 
...
double lcell[3]; 
# 962
(cs) ? static_cast< void>(0) : __assert_fail("cs", "colloids_rt.c", 962, __PRETTY_FUNCTION__); 
# 963
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "colloids_rt.c", 963, __PRETTY_FUNCTION__); 
# 965
colloids_info_ntotal(cinfo, &ncolloid); 
# 966
...
# 1 "colloids_rt.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__19_colloids_rt_cpp1_ii_7b4a2ec2
# 1 "colloids_rt.cudafe1.stub.c"
#include "colloids_rt.cudafe1.stub.c"
# 1 "colloids_rt.cudafe1.stub.c"
