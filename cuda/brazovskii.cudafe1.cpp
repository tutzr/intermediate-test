...
# 56
static fe_brazovskii_param_t const_param; 
# 59
static fe_vt_t fe_braz_hvt = {((fe_free_ft)fe_brazovskii_free), ((fe_target_ft)fe_brazovskii_target), ((fe_fed_ft)fe_brazovskii_fed), ((fe_mu_ft)fe_brazovskii_mu), ((fe_mu_solv_ft)__null), ((fe_str_ft)fe_brazovskii_str), ((fe_str_ft)fe_brazovskii_str), ((fe_str_ft)__null), ((fe_hvector_ft)__null), ((fe_htensor_ft)__null), ((fe_htensor_v_ft)__null), ((fe_stress_v_ft)fe_brazovskii_str_v), ((fe_stress_v_ft)fe_brazovskii_str_v), ((fe_stress_v_ft)__null)}; 
# 76
static fe_vt_t fe_braz_dvt; 
# 100 "brazovskii.c"
int fe_brazovskii_create(pe_t *pe, cs_t *cs, field_t *phi, field_grad_t *
# 101
dphi, fe_brazovskii_t **
# 102
p) { 
# 104
int ndevice; 
# 105
fe_brazovskii_t *obj = (__null); 
# 107
(pe) ? static_cast< void>(0) : __assert_fail("pe", "brazovskii.c", 107, __PRETTY_FUNCTION__); 
# 108
(cs) ? static_cast< void>(0) : __assert_fail("cs", "brazovskii.c", 108, __PRETTY_FUNCTION__); 
# 109
(phi) ? static_cast< void>(0) : __assert_fail("phi", "brazovskii.c", 109, __PRETTY_FUNCTION__); 
# 110
(dphi) ? static_cast< void>(0) : __assert_fail("dphi", "brazovskii.c", 110, __PRETTY_FUNCTION__); 
# 112
obj = ((fe_brazovskii_t *)calloc(1, sizeof(fe_brazovskii_t))); 
# 113
(obj) ? static_cast< void>(0) : __assert_fail("obj", "brazovskii.c", 113, __PRETTY_FUNCTION__); 
# 114
if (obj == (__null)) { pe_fatal(pe, "calloc(fe_brazovskii_t) failed\n"); }  
# 116
(obj->param) = ((fe_brazovskii_param_t *)calloc(1, sizeof(fe_brazovskii_param_t))); 
# 118
(obj->param) ? static_cast< void>(0) : __assert_fail("obj->param", "brazovskii.c", 118, __PRETTY_FUNCTION__); 
# 119
if ((obj->param) == (__null)) { pe_fatal(pe, "calloc(fe_brazovskii_param_t) failed\n"); }  
# 121
(obj->pe) = pe; 
# 122
(obj->cs) = cs; 
...
# 140
{ tdpErrorHandler(cudaGetSymbolAddress((void **)(&tmp), const_param), "brazovskii.c", 140, 1); } ; 
# 141
tdpMemcpy(&((obj->target)->param), &tmp, sizeof(fe_brazovskii_t *), cudaMemcpyHostToDevice); 
# 143
{ tdpErrorHandler(cudaGetSymbolAddress((void **)(&vt), fe_braz_dvt), "brazovskii.c", 143, 1); } ; 
# 144
tdpMemcpy(&(((obj->target)->super).func), &vt, sizeof(fe_vt_t *), cudaMemcpyHostToDevice); 
# 147
tdpMemcpy(&((obj->target)->phi), &(phi->target), sizeof(field_t *), cudaMemcpyHostToDevice); 
# 149
tdpMemcpy(&((obj->target)->dphi), &(dphi->target), sizeof(field_grad_t *), cudaMemcpyHostToDevice); 
# 151
}  
# 153
(*p) = obj; 
...
int ndevice; 
# 168
(fe) ? static_cast< void>(0) : __assert_fail("fe", "brazovskii.c", 168, __PRETTY_FUNCTION__); 
# 170
tdpGetDeviceCount(&ndevice); 
# 171
...
int fe_brazovskii_target(fe_brazovskii_t *fe, fe_t **target) { 
# 187
(fe) ? static_cast< void>(0) : __assert_fail("fe", "brazovskii.c", 187, __PRETTY_FUNCTION__); 
# 188
(target) ? static_cast< void>(0) : __assert_fail("target", "brazovskii.c", 188, __PRETTY_FUNCTION__); 
# 190
...
# 204 "brazovskii.c"
int fe_brazovskii_param_set(fe_brazovskii_t *fe, fe_brazovskii_param_t 
# 205
values) { 
# 206
(fe) ? static_cast< void>(0) : __assert_fail("fe", "brazovskii.c", 206, __PRETTY_FUNCTION__); 
# 208
(*(fe->param)) = values; 
# 210
return 0; 
...
# 219
int fe_brazovskii_param(fe_brazovskii_t *fe, fe_brazovskii_param_t *
# 220
values) { 
# 221
(fe) ? static_cast< void>(0) : __assert_fail("fe", "brazovskii.c", 221, __PRETTY_FUNCTION__); 
# 222
(values) ? static_cast< void>(0) : __assert_fail("values", "brazovskii.c", 222, __PRETTY_FUNCTION__); 
# 224
(*values) = (*(fe->param)); 
# 226
return 0; 
...
# 237 "brazovskii.c"
int fe_brazovskii_amplitude(fe_brazovskii_t *fe, double *
# 238
a0) { 
# 239
double b, c, kappa; 
# 241
(fe) ? static_cast< void>(0) : __assert_fail("fe", "brazovskii.c", 241, __PRETTY_FUNCTION__); 
# 243
b = ((fe->param)->b); 
# 244
c = ((fe->param)->c); 
...
# 260 "brazovskii.c"
int fe_brazovskii_wavelength(fe_brazovskii_t *fe, double *
# 261
lambda) { 
# 262
(fe) ? static_cast< void>(0) : __assert_fail("fe", "brazovskii.c", 262, __PRETTY_FUNCTION__); 
# 264
...
double delsq; 
# 284
(fe) ? static_cast< void>(0) : __assert_fail("fe", "brazovskii.c", 284, __PRETTY_FUNCTION__); 
# 286
...
# 290
(*fed) = (((((((0.5) * ((fe->param)->a)) * phi) * phi) + ((((((0.25) * ((fe->param)->b)) * phi) * phi) * phi) * phi)) + (((0.5) * ((fe->param)->kappa)) * dot_product(dphi, dphi))) + ((((0.5) * ((fe->param)->c)) * delsq) * delsq)); 
# 294
return 0; 
# 295
} 
...
double del4_phi; 
# 316
(fe) ? static_cast< void>(0) : __assert_fail("fe", "brazovskii.c", 316, __PRETTY_FUNCTION__); 
# 318
field_scalar(fe->phi, index, &phi); 
# 319
...
# 322
(*mu) = ((((((fe->param)->a) * phi) + (((((fe->param)->b) * phi) * phi) * phi)) - (((fe->param)->kappa) * del2_phi)) + (((fe->param)->c) * del4_phi)); 
# 325
return 0; 
# 326
} 
...
# 349
(fe) ? static_cast< void>(0) : __assert_fail("fe", "brazovskii.c", 349, __PRETTY_FUNCTION__); 
# 351
c = ((fe->param)->c); 
# 352
kappa = ((fe->param)->kappa); 
...
# 362
p0 = ((((((((((0.5) * ((fe->param)->a)) * phi) * phi) + ((((((0.75) * ((fe->param)->b)) * phi) * phi) * phi) * phi)) - ((kappa * phi) * del2_phi)) + (((0.5) * kappa) * dot_product(grad_phi, grad_phi))) + ((c * phi) * del4_phi)) + ((((0.5) * c) * del2_phi) * del2_phi)) + (c * dot_product(grad_phi, grad_del2_phi))); 
# 368
for (ia = 0; ia < 3; ia++) { 
# 369
for (ib = 0; ib < 3; ib++) { 
# 370
((s[ia])[ib]) = (((p0 * ((d[ia])[ib])) + ((kappa * (grad_phi[ia])) * (grad_phi[ib]))) - (c * (((grad_phi[ia]) * (grad_del2_phi[ib])) + ((grad_phi[ib]) * (grad_del2_phi[ia]))))); 
# 372
}  
# 373
}  
...
# 386 "brazovskii.c"
void fe_brazovskii_str_v(fe_brazovskii_t *fe, int index, double 
# 387
s[3][3][1]) { 
# 389
int ia, ib, iv; 
...
double s1[3][3]; 
# 392
(fe) ? static_cast< void>(0) : __assert_fail("fe", "brazovskii.c", 392, __PRETTY_FUNCTION__); 
# 394
for (iv = 0; iv < 1; iv++) { 
# 395
...
# 1 "brazovskii.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__18_brazovskii_cpp1_ii_48cd644b
# 1 "brazovskii.cudafe1.stub.c"
#include "brazovskii.cudafe1.stub.c"
# 1 "brazovskii.cudafe1.stub.c"
