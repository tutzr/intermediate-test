...
double tau[NVEL]; 
# 46
(pe) ? static_cast< void>(0) : __assert_fail("pe", "collision_rt.c", 46, __PRETTY_FUNCTION__); 
# 47
(rt) ? static_cast< void>(0) : __assert_fail("rt", "collision_rt.c", 47, __PRETTY_FUNCTION__); 
# 48
(lb) ? static_cast< void>(0) : __assert_fail("lb", "collision_rt.c", 48, __PRETTY_FUNCTION__); 
# 50
p = rt_string_parameter(rt, "isothermal_fluctuations", tmp, 8192); 
# 52
...
strcpy(relax, "M10"); 
# 60
p = rt_string_parameter(rt, "lb_relaxation_scheme", tmp, 8192); 
# 62
if (p == 1) { 
# 63
...
# 66
if ((strcmp(tmp, "trt") == 0) || (strcmp(tmp, "TRT") == 0)) { 
# 67
strcpy(relax, "TRT"); 
# 68
...
# 70
if ((strcmp(tmp, "bgk") == 0) || (strcmp(tmp, "BGK") == 0)) { 
# 71
strcpy(relax, "BGK"); 
# 72
...
# 81
p = rt_string_parameter(rt, "ghost_modes", tmp, 8192); 
# 82
nghost = 1; 
# 83
...
# 1 "collision_rt.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__20_collision_rt_cpp1_ii_0ca17334
# 1 "collision_rt.cudafe1.stub.c"
#include "collision_rt.cudafe1.stub.c"
# 1 "collision_rt.cudafe1.stub.c"
