...
# 32 "test_pair_ss_cut.c"
static int test_pair_ss_cut1(pe_t * pe, cs_t * cs); 
# 33
static int test_pair_ss_cut2(pe_t * pe, cs_t * cs); 
# 34
static int test_pair_config1(colloids_info_t * cinfo, interact_t * interact, pair_ss_cut_t * pair); 
# 43
int test_pair_ss_cut_suite() { 
# 45
pe_t *pe = (__null); 
...
double h, f, v; 
# 73
(pe) ? static_cast< void>(0) : __assert_fail("pe", "test_pair_ss_cut.c", 73, __PRETTY_FUNCTION__); 
# 74
(cs) ? static_cast< void>(0) : __assert_fail("cs", "test_pair_ss_cut.c", 74, __PRETTY_FUNCTION__); 
# 76
pair_ss_cut_create(pe, cs, &pair); 
# 77
(pair) ? static_cast< void>(0) : __assert_fail("pair", "test_pair_ss_cut.c", 77, __PRETTY_FUNCTION__); 
# 79
pair_ss_cut_param_set(pair, (0.001000000000000000021), (0.8000000000000000444), 2, (0.25)); 
# 81
h = (0.01250000000000000069); 
# 82
pair_ss_cut_single(pair, h, &f, &v); 
# 83
(fabs(f - (655.2780800000000454)) < ((1.192092896e-07F))) ? static_cast< void>(0) : __assert_fail("fabs(f - 655.27808) < 1.19209289550781250000e-7F", "test_pair_ss_cut.c", 83, __PRETTY_FUNCTION__); 
# 84
(fabs(v - (4.066303999999999697)) < ((1.192092896e-07F))) ? static_cast< void>(0) : __assert_fail("fabs(v - 4.0663040) < 1.19209289550781250000e-7F", "test_pair_ss_cut.c", 84, __PRETTY_FUNCTION__); 
# 86
h = (0.25); 
# 87
pair_ss_cut_single(pair, h, &f, &v); 
# 88
(fabs(f - (0.0)) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(f - 0.0) < double(2.22044604925031308085e-16L)", "test_pair_ss_cut.c", 88, __PRETTY_FUNCTION__); 
# 89
(fabs(v - (0.0)) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(v - 0.0) < double(2.22044604925031308085e-16L)", "test_pair_ss_cut.c", 89, __PRETTY_FUNCTION__); 
# 91
...
pair_ss_cut_t *pair = (__null); 
# 110
(pe) ? static_cast< void>(0) : __assert_fail("pe", "test_pair_ss_cut.c", 110, __PRETTY_FUNCTION__); 
# 111
(cs) ? static_cast< void>(0) : __assert_fail("cs", "test_pair_ss_cut.c", 111, __PRETTY_FUNCTION__); 
# 113
colloids_info_create(pe, cs, ncell, &cinfo); 
# 114
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "test_pair_ss_cut.c", 114, __PRETTY_FUNCTION__); 
# 115
interact_create(pe, cs, &interact); 
# 116
(interact) ? static_cast< void>(0) : __assert_fail("interact", "test_pair_ss_cut.c", 116, __PRETTY_FUNCTION__); 
# 118
pair_ss_cut_create(pe, cs, &pair); 
# 119
(pair) ? static_cast< void>(0) : __assert_fail("pair", "test_pair_ss_cut.c", 119, __PRETTY_FUNCTION__); 
# 121
pair_ss_cut_param_set(pair, (0.001000000000000000021), (0.8000000000000000444), 2, (0.25)); 
# 122
...
# 141
static int test_pair_config1(colloids_info_t *cinfo, interact_t *interact, pair_ss_cut_t *
# 142
pair) { 
# 144
int nc; 
# 145
double a0 = (2.299999999999999822); 
# 146
double ah = (2.299999999999999822); 
# 147
...
# 161
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "test_pair_ss_cut.c", 161, __PRETTY_FUNCTION__); 
# 162
(interact) ? static_cast< void>(0) : __assert_fail("interact", "test_pair_ss_cut.c", 162, __PRETTY_FUNCTION__); 
# 163
(pair) ? static_cast< void>(0) : __assert_fail("pair", "test_pair_ss_cut.c", 163, __PRETTY_FUNCTION__); 
# 165
...
# 193
(nc == 2) ? static_cast< void>(0) : __assert_fail("nc == 2", "test_pair_ss_cut.c", 193, __PRETTY_FUNCTION__); 
# 195
...
# 205
(fabs(((pc1->force)[X]) - f) < ((1.192092896e-07F))) ? static_cast< void>(0) : __assert_fail("fabs(pc1->force[X] - f) < 1.19209289550781250000e-7F", "test_pair_ss_cut.c", 205, __PRETTY_FUNCTION__); 
# 206
(fabs(((pc1->force)[Y]) - f) < ((1.192092896e-07F))) ? static_cast< void>(0) : __assert_fail("fabs(pc1->force[Y] - f) < 1.19209289550781250000e-7F", "test_pair_ss_cut.c", 206, __PRETTY_FUNCTION__); 
# 207
(fabs(((pc1->force)[Z]) - f) < ((1.192092896e-07F))) ? static_cast< void>(0) : __assert_fail("fabs(pc1->force[Z] - f) < 1.19209289550781250000e-7F", "test_pair_ss_cut.c", 207, __PRETTY_FUNCTION__); 
# 209
(fabs(((pc2->force)[X]) + f) < ((1.192092896e-07F))) ? static_cast< void>(0) : __assert_fail("fabs(pc2->force[X] + f) < 1.19209289550781250000e-7F", "test_pair_ss_cut.c", 209, __PRETTY_FUNCTION__); 
# 210
(fabs(((pc2->force)[Y]) + f) < ((1.192092896e-07F))) ? static_cast< void>(0) : __assert_fail("fabs(pc2->force[Y] + f) < 1.19209289550781250000e-7F", "test_pair_ss_cut.c", 210, __PRETTY_FUNCTION__); 
# 211
(fabs(((pc2->force)[Z]) + f) < ((1.192092896e-07F))) ? static_cast< void>(0) : __assert_fail("fabs(pc2->force[Z] + f) < 1.19209289550781250000e-7F", "test_pair_ss_cut.c", 211, __PRETTY_FUNCTION__); 
# 212
}  
# 214
...
# 218
(fabs((stats[INTERACT_STAT_VLOCAL]) - v) < ((1.192092896e-07F))) ? static_cast< void>(0) : __assert_fail("fabs(stats[INTERACT_STAT_VLOCAL] - v) < 1.19209289550781250000e-7F", "test_pair_ss_cut.c", 218, __PRETTY_FUNCTION__); 
# 220
return 0; 
# 221
} 

# 1 "test_pair_ss_cut.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__24_test_pair_ss_cut_cpp1_ii_f49d0e8d
# 1 "test_pair_ss_cut.cudafe1.stub.c"
#include "test_pair_ss_cut.cudafe1.stub.c"
# 1 "test_pair_ss_cut.cudafe1.stub.c"
