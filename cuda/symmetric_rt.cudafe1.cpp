...
fe_symm_param_t param; 
# 39
(pe) ? static_cast< void>(0) : __assert_fail("pe", "symmetric_rt.c", 39, __PRETTY_FUNCTION__); 
# 40
(rt) ? static_cast< void>(0) : __assert_fail("rt", "symmetric_rt.c", 40, __PRETTY_FUNCTION__); 
# 41
(fe) ? static_cast< void>(0) : __assert_fail("fe", "symmetric_rt.c", 41, __PRETTY_FUNCTION__); 
# 43
...
# 78
int fe_symmetric_phi_init_rt(pe_t *pe, rt_t *rt, fe_symm_t *fe, field_t *
# 79
phi) { 
# 81
...
# 84
(pe) ? static_cast< void>(0) : __assert_fail("pe", "symmetric_rt.c", 84, __PRETTY_FUNCTION__); 
# 85
(rt) ? static_cast< void>(0) : __assert_fail("rt", "symmetric_rt.c", 85, __PRETTY_FUNCTION__); 
# 86
(fe) ? static_cast< void>(0) : __assert_fail("fe", "symmetric_rt.c", 86, __PRETTY_FUNCTION__); 
# 87
(phi) ? static_cast< void>(0) : __assert_fail("phi", "symmetric_rt.c", 87, __PRETTY_FUNCTION__); 
# 89
physics_ref(&phys); 
# 90
...
# 1 "symmetric_rt.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__20_symmetric_rt_cpp1_ii_b796a95b
# 1 "symmetric_rt.cudafe1.stub.c"
#include "symmetric_rt.cudafe1.stub.c"
# 1 "symmetric_rt.cudafe1.stub.c"
