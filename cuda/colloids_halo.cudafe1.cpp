...
# 47
static int colloids_halo_load_list(colloid_halo_t * halo, int ic, int jc, int kc, const double  rperiod[3], int noff); 
# 61 "colloids_halo.c"
int colloids_halo_create(colloids_info_t *cinfo, colloid_halo_t **phalo) { 
# 63
colloid_halo_t *halo = (__null); 
# 65
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "colloids_halo.c", 65, __PRETTY_FUNCTION__); 
# 67
halo = ((colloid_halo_t *)calloc(1, sizeof(colloid_halo_t))); 
# 68
(halo) ? static_cast< void>(0) : __assert_fail("halo", "colloids_halo.c", 68, __PRETTY_FUNCTION__); 
# 69
if (halo == (__null)) { pe_fatal(cinfo->pe, "calloc(colloid_halo_t) failed\n"); }  
# 71
(halo->pe) = (cinfo->pe); 
# 72
(halo->cs) = (cinfo->cs); 
...
void colloids_halo_free(colloid_halo_t *halo) { 
# 88
(halo) ? static_cast< void>(0) : __assert_fail("halo", "colloids_halo.c", 88, __PRETTY_FUNCTION__); 
# 90
free(halo); 
# 93
} 
...
colloid_halo_t *halo = (__null); 
# 112
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "colloids_halo.c", 112, __PRETTY_FUNCTION__); 
# 114
halo = ((colloid_halo_t *)calloc(1, sizeof(colloid_halo_t))); 
# 115
(halo) ? static_cast< void>(0) : __assert_fail("halo", "colloids_halo.c", 115, __PRETTY_FUNCTION__); 
# 116
if (halo == (__null)) { pe_fatal(cinfo->pe, "calloc(colloid_halo_t) failed\n"); }  
# 118
(halo->pe) = (cinfo->pe); 
...
MPI_Status status[2]; 
# 147
(halo) ? static_cast< void>(0) : __assert_fail("halo", "colloids_halo.c", 147, __PRETTY_FUNCTION__); 
# 148
(halo->cinfo) ? static_cast< void>(0) : __assert_fail("halo->cinfo", "colloids_halo.c", 148, __PRETTY_FUNCTION__); 
# 153
colloids_halo_send_count(halo, dim, __null); 
# 154
...
# 160
(halo->send) ? static_cast< void>(0) : __assert_fail("halo->send", "colloids_halo.c", 160, __PRETTY_FUNCTION__); 
# 162
n = (((halo->nrecv)[FORWARD]) + ((halo->nrecv)[BACKWARD])); 
# 163
(halo->recv) = ((colloid_state_t *)malloc((imax(1, n)) * sizeof(colloid_state_t))); 
# 164
(halo->recv) ? static_cast< void>(0) : __assert_fail("halo->recv", "colloids_halo.c", 164, __PRETTY_FUNCTION__); 
# 166
if ((halo->send) == (__null)) { pe_fatal(halo->pe, "halo malloc(send_) failed\n"); }  
# 167
if ((halo->recv) == (__null)) { pe_fatal(halo->pe, "halo malloc(recv_) failed\n"); }  
# 169
...
int ncell[3]; 
# 203
(halo) ? static_cast< void>(0) : __assert_fail("halo", "colloids_halo.c", 203, __PRETTY_FUNCTION__); 
# 204
(halo->cinfo) ? static_cast< void>(0) : __assert_fail("halo->cinfo", "colloids_halo.c", 204, __PRETTY_FUNCTION__); 
# 206
...
double rback[3]; 
# 269
(halo) ? static_cast< void>(0) : __assert_fail("halo", "colloids_halo.c", 269, __PRETTY_FUNCTION__); 
# 271
colloids_info_ncell(halo->cinfo, ncell); 
# 273
nsent_forw = 0; 
...
if (p == 0) { 
# 286
(rback[dim]) = (((1.0) - ((double)(2.2204460492503130808e-16L))) * ((((halo->cs)->param)->ntotal)[dim])); 
# 287
}  
# 288
...
# 325
(nsent_forw == ((halo->nsend)[FORWARD])) ? static_cast< void>(0) : __assert_fail("nsent_forw == halo->nsend[FORWARD]", "colloids_halo.c", 325, __PRETTY_FUNCTION__); 
# 326
(nsent_back == ((halo->nsend)[BACKWARD])) ? static_cast< void>(0) : __assert_fail("nsent_back == halo->nsend[BACKWARD]", "colloids_halo.c", 326, __PRETTY_FUNCTION__); 
# 328
return 0; 
# 329
} 
# 343 "colloids_halo.c"
static int colloids_halo_load_list(colloid_halo_t *halo, int 
# 344
ic, int jc, int kc, const double *
# 345
rperiod, int noff) { 
# 346
int n; 
...
colloid_t *pc = (__null); 
# 349
(halo) ? static_cast< void>(0) : __assert_fail("halo", "colloids_halo.c", 349, __PRETTY_FUNCTION__); 
# 351
n = 0; 
# 352
...
colloid_t *pc = (__null); 
# 388
(halo) ? static_cast< void>(0) : __assert_fail("halo", "colloids_halo.c", 388, __PRETTY_FUNCTION__); 
# 390
for (n = 0; n < nrecv; n++) { 
# 392
exists = 0; 
...
# 413
(pc) ? static_cast< void>(0) : __assert_fail("pc", "colloids_halo.c", 413, __PRETTY_FUNCTION__); 
# 414
(pc->s) = ((halo->recv)[n]); 
# 415
((pc->s).rebuild) = 1; 
...
# 428
static int colloids_halo_irecv(colloid_halo_t *halo, int dim, MPI_Request 
# 429
req[2]) { 
# 430
int n; 
...
MPI_Comm comm; 
# 436
(halo) ? static_cast< void>(0) : __assert_fail("halo", "colloids_halo.c", 436, __PRETTY_FUNCTION__); 
# 438
(req[0]) = (-4); 
# 439
(req[1]) = (-4); 
...
# 450
MPI_Irecv((halo->recv) + ((halo->nrecv)[CS_FORW]), n, MPI_BYTE, pback, tagf_, comm, req + 1); 
# 452
}  
# 454
return 0; 
...
# 465 "colloids_halo.c"
static int colloids_halo_isend(colloid_halo_t *halo, int dim, MPI_Request 
# 466
req[2]) { 
# 467
int n; 
...
MPI_Comm comm; 
# 473
(halo) ? static_cast< void>(0) : __assert_fail("halo", "colloids_halo.c", 473, __PRETTY_FUNCTION__); 
# 475
if (((((halo->cs)->param)->mpi_cartsz)[dim]) == 1) { 
# 477
...
# 492
MPI_Issend((halo->send) + ((halo->nsend)[CS_BACK]), n, MPI_BYTE, pforw, tagf_, comm, req); 
# 495
...
MPI_Status status[4]; 
# 516
(halo) ? static_cast< void>(0) : __assert_fail("halo", "colloids_halo.c", 516, __PRETTY_FUNCTION__); 
# 518
if (((((halo->cs)->param)->mpi_cartsz)[dim]) == 1) { 
# 519
...
pback = ((((halo->cs)->mpi_cart_neighbours)[CS_BACK])[dim]); 
# 528
MPI_Irecv((halo->nrecv) + FORWARD, 1, MPI_INT, pforw, tagb_, comm, request); 
# 530
MPI_Irecv((halo->nrecv) + BACKWARD, 1, MPI_INT, pback, tagf_, comm, request + 1); 
# 532
MPI_Issend((halo->nsend) + FORWARD, 1, MPI_INT, pforw, tagf_, comm, request + 2); 
# 534
MPI_Issend((halo->nsend) + BACKWARD, 1, MPI_INT, pback, tagb_, comm, request + 3); 
# 537
...
# 544
if (((((halo->cs)->param)->mpi_cartcoords)[dim]) == (((((halo->cs)->param)->mpi_cartsz)[dim]) - 1)) { 
# 545
((halo->nrecv)[CS_FORW]) = 0; }  
# 546
}  
# 548
return 0; 
...
# 1 "colloids_halo.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__21_colloids_halo_cpp1_ii_5dd00a33
# 1 "colloids_halo.cudafe1.stub.c"
#include "colloids_halo.cudafe1.stub.c"
# 1 "colloids_halo.cudafe1.stub.c"
