...
# 36 "build.c"
int build_replace_fluid_local(colloids_info_t * info, colloid_t * pc, int index, lb_t * lb); 
# 39
int build_replace_q_local(fe_t * fe, colloids_info_t * info, colloid_t * pc, int index, field_t * q); 
# 42
static int build_remove_fluid(lb_t * lb, int index, colloid_t * pc); 
# 43
static int build_replace_fluid(lb_t * lb, colloids_info_t * info, int index, colloid_t * pc, map_t * map); 
# 45
static int build_remove_order_parameter(lb_t * lb, field_t * f, int index, colloid_t * pc); 
# 47
static int build_replace_order_parameter(fe_t * fe, lb_t * lb, colloids_info_t * cinfo, field_t * f, int index, colloid_t * pc, map_t * map); 
# 50
static int build_reset_links(cs_t * cs, colloid_t * pc, map_t * map); 
# 51
static int build_reconstruct_links(cs_t * cs, colloids_info_t * cinfo, colloid_t * pc, map_t * map); 
# 53
static void build_link_mean(colloid_t * pc, int p, const double  rb[3]); 
# 54
static int build_colloid_wall_links(cs_t * cs, colloids_info_t * cinfo, colloid_t * pc, map_t * map); 
# 58
...
double wet[2]; 
# 97
(cs) ? static_cast< void>(0) : __assert_fail("cs", "build.c", 97, __PRETTY_FUNCTION__); 
# 98
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "build.c", 98, __PRETTY_FUNCTION__); 
# 99
(map) ? static_cast< void>(0) : __assert_fail("map", "build.c", 99, __PRETTY_FUNCTION__); 
# 101
map_ndata(map, &ndata); 
# 102
(ndata <= 2) ? static_cast< void>(0) : __assert_fail("ndata <= 2", "build.c", 102, __PRETTY_FUNCTION__); 
# 104
cs_nlocal(cs, nlocal); 
# 105
...
# 235 "build.c"
int build_update_links(cs_t *cs, colloids_info_t *cinfo, wall_t *wall, map_t *
# 236
map) { 
# 238
int ia; 
...
colloid_t *pc; 
# 244
(cs) ? static_cast< void>(0) : __assert_fail("cs", "build.c", 244, __PRETTY_FUNCTION__); 
# 245
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "build.c", 245, __PRETTY_FUNCTION__); 
# 246
(map) ? static_cast< void>(0) : __assert_fail("map", "build.c", 246, __PRETTY_FUNCTION__); 
# 248
colloids_info_ncell(cinfo, ncell); 
# 249
...
# 308 "build.c"
int build_reconstruct_links(cs_t *cs, colloids_info_t *cinfo, colloid_t *
# 309
p_colloid, map_t *
# 310
map) { 
...
colloid_t *pc = (__null); 
# 329
(cs) ? static_cast< void>(0) : __assert_fail("cs", "build.c", 329, __PRETTY_FUNCTION__); 
# 331
cs_nlocal(cs, ntotal); 
# 332
...
{ 
# 448
(p_last) ? static_cast< void>(0) : __assert_fail("p_last", "build.c", 448, __PRETTY_FUNCTION__); 
# 449
(p_last->next) = p_link; 
# 450
}  
...
double lambda = (0.5); 
# 499
(p_colloid) ? static_cast< void>(0) : __assert_fail("p_colloid", "build.c", 499, __PRETTY_FUNCTION__); 
# 500
(map) ? static_cast< void>(0) : __assert_fail("map", "build.c", 500, __PRETTY_FUNCTION__); 
# 502
cs_nlocal_offset(cs, offset); 
# 504
p_link = (p_colloid->lnk); 
...
# 564 "build.c"
int build_remove_replace(fe_t *fe, colloids_info_t *cinfo, lb_t *lb, field_t *
# 565
phi, field_t *
# 566
p, field_t *q, psi_t *psi, map_t *map) { 
# 568
int ic, jc, kc, index; 
# 569
int is_halo; 
...
colloid_t *pcnew; 
# 575
(lb) ? static_cast< void>(0) : __assert_fail("lb", "build.c", 575, __PRETTY_FUNCTION__); 
# 576
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "build.c", 576, __PRETTY_FUNCTION__); 
# 578
...
# 590
is_halo = ((((((ic < 1) || (jc < 1)) || (kc < 1)) || (ic > (nlocal[X]))) || (jc > (nlocal[Y]))) || (kc > (nlocal[Z]))); 
# 593
if ((pcold == (__null)) && (pcnew != (__null))) { 
# 595
((pcnew->s).rebuild) = 1; 
# 597
if (!is_halo) { 
...
colloid_t *pcnew; 
# 642
(cs) ? static_cast< void>(0) : __assert_fail("cs", "build.c", 642, __PRETTY_FUNCTION__); 
# 643
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "build.c", 643, __PRETTY_FUNCTION__); 
# 645
cs_nhalo(cs, &nhalo); 
# 646
cs_nlocal(cs, nlocal); 
...
colloids_info_map(cinfo, index, &pcnew); 
# 657
if ((pcold == (__null)) && (pcnew != (__null))) { ((pcnew->s).rebuild) = 1; }  
# 658
if ((pcold != (__null)) && (pcnew == (__null))) { ((pcold->s).rebuild) = 1; }  
# 659
}  
# 660
}  
...
# 673 "build.c"
int build_remove_replace_policy_local(cs_t *cs, colloids_info_t *cinfo, lb_t *
# 674
lb) { 
# 675
int ic, jc, kc, index; 
...
colloid_t *pcnew; 
# 680
(cs) ? static_cast< void>(0) : __assert_fail("cs", "build.c", 680, __PRETTY_FUNCTION__); 
# 681
(lb) ? static_cast< void>(0) : __assert_fail("lb", "build.c", 681, __PRETTY_FUNCTION__); 
# 682
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "build.c", 682, __PRETTY_FUNCTION__); 
# 684
cs_nlocal(cs, nlocal); 
# 686
...
# 738
(lb) ? static_cast< void>(0) : __assert_fail("lb", "build.c", 738, __PRETTY_FUNCTION__); 
# 740
...
# 785 "build.c"
static int build_remove_order_parameter(lb_t *lb, field_t *f, int index, colloid_t *
# 786
pc) { 
# 787
int ndist; 
...
physics_t *phys = (__null); 
# 792
(f) ? static_cast< void>(0) : __assert_fail("f", "build.c", 792, __PRETTY_FUNCTION__); 
# 793
(lb) ? static_cast< void>(0) : __assert_fail("lb", "build.c", 793, __PRETTY_FUNCTION__); 
# 794
(pc) ? static_cast< void>(0) : __assert_fail("pc", "build.c", 794, __PRETTY_FUNCTION__); 
# 796
physics_ref(&phys); 
# 797
...
# 821 "build.c"
static int build_replace_fluid(lb_t *lb, colloids_info_t *cinfo, int index, colloid_t *
# 822
p_colloid, map_t *map) { 
# 824
int indexn, p, pdash; 
...
colloid_t *pc = (__null); 
# 843
(lb) ? static_cast< void>(0) : __assert_fail("lb", "build.c", 843, __PRETTY_FUNCTION__); 
# 844
(p_colloid) ? static_cast< void>(0) : __assert_fail("p_colloid", "build.c", 844, __PRETTY_FUNCTION__); 
# 845
(map) ? static_cast< void>(0) : __assert_fail("map", "build.c", 845, __PRETTY_FUNCTION__); 
# 847
cs_nlocal_offset(lb->cs, noffset); 
# 848
cs_index_to_ijk(lb->cs, index, ib); 
...
for (p = 1; p < (NVEL); p++) { 
# 870
indexn = cs_index(lb->cs, (ib[X]) + ((cv[p])[X]), (ib[Y]) + ((cv[p])[Y]), (ib[Z]) + ((cv[p])[Z])); 
# 875
...
# 948 "build.c"
int build_replace_fluid_local(colloids_info_t *cinfo, colloid_t *pc, int 
# 949
index, lb_t *lb) { 
# 951
int ia, ib, p; 
...
# 958
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "build.c", 958, __PRETTY_FUNCTION__); 
# 959
(pc) ? static_cast< void>(0) : __assert_fail("pc", "build.c", 959, __PRETTY_FUNCTION__); 
# 960
(lb) ? static_cast< void>(0) : __assert_fail("lb", "build.c", 960, __PRETTY_FUNCTION__); 
# 964
rho0 = ((lb->param)->rho0); 
# 965
...
# 1003 "build.c"
static int build_replace_order_parameter(fe_t *fe, lb_t *lb, colloids_info_t *
# 1004
cinfo, field_t *
# 1005
f, int index, colloid_t *
# 1006
pc, map_t *map) { 
# 1007
...
physics_t *phys = (__null); 
# 1022
colloid_t *pcmap = (__null); 
# 1024
(map) ? static_cast< void>(0) : __assert_fail("map", "build.c", 1024, __PRETTY_FUNCTION__); 
# 1025
(lb) ? static_cast< void>(0) : __assert_fail("lb", "build.c", 1025, __PRETTY_FUNCTION__); 
# 1026
lb_ndist(lb, &ndist); 
# 1028
field_nf(f, &nf); 
# 1029
(nf <= 5) ? static_cast< void>(0) : __assert_fail("nf <= 5", "build.c", 1029, __PRETTY_FUNCTION__); 
# 1031
...
for (p = 1; p < (NVEL); p++) { 
# 1048
indexn = cs_index(lb->cs, (ri[X]) + ((cv[p])[X]), (ri[Y]) + ((cv[p])[Y]), (ri[Z]) + ((cv[p])[Z])); 
# 1054
...
# 1148 "build.c"
int build_replace_q_local(fe_t *fe, colloids_info_t *info, colloid_t *pc, int 
# 1149
index, field_t *q) { 
# 1151
int ia, ib; 
...
# 1163
(fe) ? static_cast< void>(0) : __assert_fail("fe", "build.c", 1163, __PRETTY_FUNCTION__); 
# 1164
(info) ? static_cast< void>(0) : __assert_fail("info", "build.c", 1164, __PRETTY_FUNCTION__); 
# 1165
(pc) ? static_cast< void>(0) : __assert_fail("pc", "build.c", 1165, __PRETTY_FUNCTION__); 
# 1166
(q) ? static_cast< void>(0) : __assert_fail("q", "build.c", 1166, __PRETTY_FUNCTION__); 
# 1168
...
# 1257 "build.c"
int build_colloid_wall_links(cs_t *cs, colloids_info_t *cinfo, colloid_t *
# 1258
p_colloid, map_t *
# 1259
map) { 
...
colloid_link_t *p_last; 
# 1278
(p_colloid) ? static_cast< void>(0) : __assert_fail("p_colloid", "build.c", 1278, __PRETTY_FUNCTION__); 
# 1279
(map) ? static_cast< void>(0) : __assert_fail("map", "build.c", 1279, __PRETTY_FUNCTION__); 
# 1281
cs_nlocal(cs, ntotal); 
# 1282
cs_nlocal_offset(cs, offset); 
...
(p_link->status) = (LINK_BOUNDARY); 
# 1371
(p_link) ? static_cast< void>(0) : __assert_fail("p_link", "build.c", 1371, __PRETTY_FUNCTION__); 
# 1373
(p_last->next) = p_link; 
# 1374
(p_link->next) = (__null); 
...
int build_count_links_local(colloid_t *colloid, int *nlinks) { 
# 1400
colloid_link_t *pl = (__null); 
# 1401
int nlink = 0; 
# 1403
(colloid) ? static_cast< void>(0) : __assert_fail("colloid", "build.c", 1403, __PRETTY_FUNCTION__); 
# 1404
(nlinks) ? static_cast< void>(0) : __assert_fail("nlinks", "build.c", 1404, __PRETTY_FUNCTION__); 
# 1406
for (pl = (colloid->lnk); pl != (__null); pl = (pl->next)) { 
# 1407
nlink += 1; 
# 1408
}  
...
colloid_link_t *pl = (__null); 
# 1431
(colloid) ? static_cast< void>(0) : __assert_fail("colloid", "build.c", 1431, __PRETTY_FUNCTION__); 
# 1432
(sa) ? static_cast< void>(0) : __assert_fail("sa", "build.c", 1432, __PRETTY_FUNCTION__); 
# 1433
(saf) ? static_cast< void>(0) : __assert_fail("saf", "build.c", 1433, __PRETTY_FUNCTION__); 
# 1435
(*sa) = (0.0); 
# 1436
(*saf) = (0.0); 
...
# 1465
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "build.c", 1465, __PRETTY_FUNCTION__); 
# 1467
...
# 1493
colloid_t *colloid = (__null); 
# 1494
colloid_link_t *pl = (__null); 
# 1496
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "build.c", 1496, __PRETTY_FUNCTION__); 
# 1497
(psi) ? static_cast< void>(0) : __assert_fail("psi", "build.c", 1497, __PRETTY_FUNCTION__); 
# 1499
colloids_info_all_head(cinfo, &colloid); 
# 1501
for (; colloid != (__null); colloid = (colloid->nextall)) { 
# 1506
...
# 1518
(((colloid->s).saf) > (0.0)) ? static_cast< void>(0) : __assert_fail("colloid->s.saf > 0.0", "build.c", 1518, __PRETTY_FUNCTION__); 
# 1519
...
colloid_link_t *pl = (__null); 
# 1586
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "build.c", 1586, __PRETTY_FUNCTION__); 
# 1587
(phi) ? static_cast< void>(0) : __assert_fail("phi", "build.c", 1587, __PRETTY_FUNCTION__); 
# 1589
colloids_info_all_head(cinfo, &colloid); 
# 1591
for (; colloid != (__null); colloid = (colloid->nextall)) { 
...
# 1 "build.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__13_build_cpp1_ii_7c739e1f
# 1 "build.cudafe1.stub.c"
#include "build.cudafe1.stub.c"
# 1 "build.cudafe1.stub.c"
