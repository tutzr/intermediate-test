...
# 27 "../.././src/blue_phase_beris_edwards.h"
...
# 29 "test_be.c"
static int do_test_be_tmatrix(); 
# 30
static int do_test_be1(); 
# 40 "test_be.c"
int test_be_suite() { 
# 42
do_test_be1(); 
...
# 67
(be) ? static_cast< void>(0) : __assert_fail("be", "test_be.c", 67, __PRETTY_FUNCTION__); 
# 69
beris_edw_free(be); 
# 71
lees_edw_free(le); 
...
dij = (i == j); 
# 105
test_assert_info(fabs(sum - dij) <= ((double)(2.2204460492503130808e-16L)), 105, "test_be.c"); 
# 106
}  
# 107
}  
...
# 1 "test_be.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__15_test_be_cpp1_ii_7d493c69
# 1 "test_be.cudafe1.stub.c"
#include "test_be.cudafe1.stub.c"
# 1 "test_be.cudafe1.stub.c"
