...
# 75
static lees_edw_param_t static_param; 
# 77
int lees_edw_buffer_duy(lees_edw_t * le, int ib); 
# 80
int lees_edw_index_real_to_buffer(lees_edw_t * le, int ic, int idisplace); 
# 81
int lees_edw_index_buffer_to_real(lees_edw_t * le, int ibuf); 
# 89
int lees_edw_create(pe_t *pe, cs_t *cs, lees_edw_info_t *info, lees_edw_t **
# 90
ple) { 
# 92
int ndevice; 
...
# 95
(pe) ? static_cast< void>(0) : __assert_fail("pe", "leesedwards.c", 95, __PRETTY_FUNCTION__); 
# 96
(cs) ? static_cast< void>(0) : __assert_fail("cs", "leesedwards.c", 96, __PRETTY_FUNCTION__); 
# 98
le = ((lees_edw_t *)calloc(1, sizeof(lees_edw_t))); 
# 99
(le) ? static_cast< void>(0) : __assert_fail("le", "leesedwards.c", 99, __PRETTY_FUNCTION__); 
# 100
if (le == (__null)) { pe_fatal(pe, "calloc(lees_edw_t) failed\n"); }  
# 102
(le->param) = ((lees_edw_param_t *)calloc(1, sizeof(lees_edw_param_t))); 
# 103
(le->param) ? static_cast< void>(0) : __assert_fail("le->param", "leesedwards.c", 103, __PRETTY_FUNCTION__); 
# 104
if ((le->param) == (__null)) { pe_fatal(pe, "calloc(lees_edw_param_t) failed\n"); }  
# 106
(le->pe) = pe; 
# 107
pe_retain(pe); 
...
# 127
{ tdpErrorHandler(cudaGetSymbolAddress((void **)(&tmp), static_param), "leesedwards.c", 127, 1); } ; 
# 128
tdpMemcpy(&((le->target)->param), (const void *)(&tmp), sizeof(lees_edw_param_t *), cudaMemcpyHostToDevice); 
# 131
cs_target(cs, &cst); 
# 132
tdpMemcpy(&((le->target)->cs), &cst, sizeof(cs_t *), cudaMemcpyHostToDevice); 
# 134
lees_edw_commit(le); 
# 135
}  
...
int lees_edw_retain(lees_edw_t *le) { 
# 150
(le) ? static_cast< void>(0) : __assert_fail("le", "leesedwards.c", 150, __PRETTY_FUNCTION__); 
# 152
(le->nref) += 1; 
# 154
return 0; 
...
int lees_edw_free(lees_edw_t *le) { 
# 165
(le) ? static_cast< void>(0) : __assert_fail("le", "leesedwards.c", 165, __PRETTY_FUNCTION__); 
# 167
(le->nref) -= 1; 
# 169
if ((le->nref) <= 0) { 
...
int lees_edw_commit(lees_edw_t *le) { 
# 193
(le) ? static_cast< void>(0) : __assert_fail("le", "leesedwards.c", 193, __PRETTY_FUNCTION__); 
# 195
{ tdpErrorHandler(cudaMemcpyToSymbol(static_param, le->param, sizeof(lees_edw_param_t), 0, cudaMemcpyHostToDevice), "leesedwards.c", 196, 1); 
# 195 "leesedwards.c"
} 
# 196
; 
...
int lees_edw_target(lees_edw_t *le, lees_edw_t **target) { 
# 209
(le) ? static_cast< void>(0) : __assert_fail("le", "leesedwards.c", 209, __PRETTY_FUNCTION__); 
# 210
(target) ? static_cast< void>(0) : __assert_fail("target", "leesedwards.c", 210, __PRETTY_FUNCTION__); 
# 212
(*target) = (le->target); 
# 214
return 0; 
...
# 225
(le) ? static_cast< void>(0) : __assert_fail("le", "leesedwards.c", 225, __PRETTY_FUNCTION__); 
# 227
...
# 240
(le) ? static_cast< void>(0) : __assert_fail("le", "leesedwards.c", 240, __PRETTY_FUNCTION__); 
# 242
((le->param)->uy) = uy; 
# 244
return 0; 
...
# 255
(le) ? static_cast< void>(0) : __assert_fail("le", "leesedwards.c", 255, __PRETTY_FUNCTION__); 
# 257
...
# 272
(le) ? static_cast< void>(0) : __assert_fail("le", "leesedwards.c", 272, __PRETTY_FUNCTION__); 
# 274
((le->param)->nt0) = nt0; 
# 276
return 0; 
...
int ntotal[3]; 
# 296
(le) ? static_cast< void>(0) : __assert_fail("le", "leesedwards.c", 296, __PRETTY_FUNCTION__); 
# 297
(info) ? static_cast< void>(0) : __assert_fail("info", "leesedwards.c", 297, __PRETTY_FUNCTION__); 
# 299
...
int lees_edw_nplane_total(lees_edw_t *le) { 
# 335
(le) ? static_cast< void>(0) : __assert_fail("le", "leesedwards.c", 335, __PRETTY_FUNCTION__); 
# 337
...
int lees_edw_nplane_local(lees_edw_t *le) { 
# 349
(le) ? static_cast< void>(0) : __assert_fail("le", "leesedwards.c", 349, __PRETTY_FUNCTION__); 
# 351
...
int lees_edw_plane_uy(lees_edw_t *le, double *uy) { 
# 363
(le) ? static_cast< void>(0) : __assert_fail("le", "leesedwards.c", 363, __PRETTY_FUNCTION__); 
# 365
(*uy) = ((le->param)->uy); 
# 367
return 0; 
...
int lees_edw_nxbuffer(lees_edw_t *le, int *nxb) { 
# 379
(le) ? static_cast< void>(0) : __assert_fail("le", "leesedwards.c", 379, __PRETTY_FUNCTION__); 
# 381
...
double gammadot; 
# 399
(le) ? static_cast< void>(0) : __assert_fail("le", "leesedwards.c", 399, __PRETTY_FUNCTION__); 
# 401
if (((le->param)->nplanetotal) > 0) { 
# 403
...
# 408
pe_info(le->pe, "LE plane %d is at x = %d with speed %f\n", np + 1, (int)(((le->param)->dx_min) + (np * ((le->param)->dx_sep))), (le->param)->uy); 
# 410
}  
# 412
...
MPI_Comm cartcomm; 
# 443
(le) ? static_cast< void>(0) : __assert_fail("le", "leesedwards.c", 443, __PRETTY_FUNCTION__); 
# 445
...
# 466
if ((le->icbuff_to_real) == (__null)) { pe_fatal(le->pe, "calloc(le) failed\n"); }  
# 467
}  
# 469
ib = 0; 
...
# 473
(ib < ((2 * nhalo) * ((le->param)->nplanelocal))) ? static_cast< void>(0) : __assert_fail("ib < 2*nhalo*le->param->nplanelocal", "leesedwards.c", 473, __PRETTY_FUNCTION__); 
# 474
...
# 494
(le->icreal_to_buff) ? static_cast< void>(0) : __assert_fail("le->icreal_to_buff", "leesedwards.c", 494, __PRETTY_FUNCTION__); 
# 495
if ((le->icreal_to_buff) == (__null)) { pe_fatal(le->pe, "calloc(le) failed\n"); }  
# 501
...
# 504
((n >= 0) && (n < (((((le->param)->nlocal)[X]) + (2 * nhalo)) * ((2 * nhalo) + 1)))) ? static_cast< void>(0) : __assert_fail("n >= 0 && n < (le->param->nlocal[X] + 2*nhalo)*(2*nhalo + 1)", "leesedwards.c", 504, __PRETTY_FUNCTION__); 
# 505
...
n = ((((ic + nhalo) - 1) * ((2 * nhalo) + 1)) + (nh + nhalo)); 
# 529
((n >= 0) && (n < (((((le->param)->nlocal)[X]) + (2 * nhalo)) * ((2 * nhalo) + 1)))) ? static_cast< void>(0) : __assert_fail("n >= 0 && n < (le->param->nlocal[X] + 2*nhalo)*(2*nhalo + 1)", "leesedwards.c", 529, __PRETTY_FUNCTION__); 
# 530
...
n = ((((ic + nhalo) - 1) * ((2 * nhalo) + 1)) + (nh + nhalo)); 
# 542
((n >= 0) && (n < (((((le->param)->nlocal)[X]) + (2 * nhalo)) * ((2 * nhalo) + 1)))) ? static_cast< void>(0) : __assert_fail("n >= 0 && n < (le->param->nlocal[X] + 2*nhalo)*(2*nhalo + 1)", "leesedwards.c", 542, __PRETTY_FUNCTION__); 
# 543
((le->icreal_to_buff)[n]) = (nb + ib); 
# 544
}  
...
# 557
(le->buffer_duy) ? static_cast< void>(0) : __assert_fail("le->buffer_duy", "leesedwards.c", 557, __PRETTY_FUNCTION__); 
# 558
if ((le->buffer_duy) == (__null)) { pe_fatal(le->pe, "calloc(buffer_duy) failed\n"); }  
# 559
}  
# 561
ib = 0; 
...
# 564
(ib < ((le->param)->nxbuffer)) ? static_cast< void>(0) : __assert_fail("ib < le->param->nxbuffer", "leesedwards.c", 564, __PRETTY_FUNCTION__); 
# 565
((le->buffer_duy)[ib]) = (-1); 
# 566
ib++; 
...
for (nh = 0; nh < nhalo; nh++) { 
# 569
(ib < ((le->param)->nxbuffer)) ? static_cast< void>(0) : __assert_fail("ib < le->param->nxbuffer", "leesedwards.c", 569, __PRETTY_FUNCTION__); 
# 570
((le->buffer_duy)[ib]) = (+1); 
# 571
ib++; 
...
MPI_Comm cartcomm; 
# 612
(le) ? static_cast< void>(0) : __assert_fail("le", "leesedwards.c", 612, __PRETTY_FUNCTION__); 
# 614
cs_cartsz(le->cs, cartsz); 
# 615
cs_cart_comm(le->cs, &cartcomm); 
...
int lees_edw_nsites(lees_edw_t *le, int *nsites) { 
# 658
(le) ? static_cast< void>(0) : __assert_fail("le", "leesedwards.c", 658, __PRETTY_FUNCTION__); 
# 660
...
double xglobal; 
# 686
(le) ? static_cast< void>(0) : __assert_fail("le", "leesedwards.c", 686, __PRETTY_FUNCTION__); 
# 687
(((le->param)->type) == (LEES_EDW_LINEAR)) ? static_cast< void>(0) : __assert_fail("le->param->type == LEES_EDW_LINEAR", "leesedwards.c", 687, __PRETTY_FUNCTION__); 
# 689
...
double ltot[3]; 
# 727
(le) ? static_cast< void>(0) : __assert_fail("le", "leesedwards.c", 727, __PRETTY_FUNCTION__); 
# 728
(((le->param)->type) == (LEES_EDW_LINEAR)) ? static_cast< void>(0) : __assert_fail("le->param->type == LEES_EDW_LINEAR", "leesedwards.c", 728, __PRETTY_FUNCTION__); 
# 730
cs_lmin(le->cs, lmin); 
# 731
cs_ltot(le->cs, ltot); 
...
double tle; 
# 763
(le) ? static_cast< void>(0) : __assert_fail("le", "leesedwards.c", 763, __PRETTY_FUNCTION__); 
# 765
tle = (t - ((le->param)->time0)); 
# 766
(tle >= (0.0)) ? static_cast< void>(0) : __assert_fail("tle >= 0.0", "leesedwards.c", 766, __PRETTY_FUNCTION__); 
# 768
(*uy) = ((le->param)->uy); 
# 769
...
int ix; 
# 791
(le) ? static_cast< void>(0) : __assert_fail("le", "leesedwards.c", 791, __PRETTY_FUNCTION__); 
# 792
(le->cs) ? static_cast< void>(0) : __assert_fail("le->cs", "leesedwards.c", 792, __PRETTY_FUNCTION__); 
# 793
((np >= 0) && (np < ((le->param)->nplanelocal))) ? static_cast< void>(0) : __assert_fail("np >= 0 && np < le->param->nplanelocal", "leesedwards.c", 793, __PRETTY_FUNCTION__); 
# 795
...
int ib; 
# 818
(le) ? static_cast< void>(0) : __assert_fail("le", "leesedwards.c", 818, __PRETTY_FUNCTION__); 
# 819
(le->icreal_to_buff) ? static_cast< void>(0) : __assert_fail("le->icreal_to_buff", "leesedwards.c", 819, __PRETTY_FUNCTION__); 
# 821
((idisplace >= (-((le->param)->nhalo))) && (idisplace <= (+((le->param)->nhalo)))) ? static_cast< void>(0) : __assert_fail("idisplace >= -le->param->nhalo && idisplace <= +le->param->nhalo", "leesedwards.c", 821, __PRETTY_FUNCTION__); 
# 823
ib = (((((ic + ((le->param)->nhalo)) - 1) * ((2 * ((le->param)->nhalo)) + 1)) + idisplace) + ((le->param)->nhalo)); 
# 825
((ib >= 0) && (ib < ((le->param)->index_real_nbuffer))) ? static_cast< void>(0) : __assert_fail("ib >= 0 && ib < le->param->index_real_nbuffer", "leesedwards.c", 825, __PRETTY_FUNCTION__); 
# 827
(((le->icreal_to_buff)[ib]) == lees_edw_ic_to_buff(le, ic, idisplace)) ? static_cast< void>(0) : __assert_fail("le->icreal_to_buff[ib] == lees_edw_ic_to_buff(le, ic, idisplace)", "leesedwards.c", 827, __PRETTY_FUNCTION__); 
# 828
...
# 843
(le) ? static_cast< void>(0) : __assert_fail("le", "leesedwards.c", 843, __PRETTY_FUNCTION__); 
# 844
(le->icbuff_to_real) ? static_cast< void>(0) : __assert_fail("le->icbuff_to_real", "leesedwards.c", 844, __PRETTY_FUNCTION__); 
# 845
((ib >= 0) && (ib < ((le->param)->nxbuffer))) ? static_cast< void>(0) : __assert_fail("ib >=0 && ib < le->param->nxbuffer", "leesedwards.c", 845, __PRETTY_FUNCTION__); 
# 847
(((le->icbuff_to_real)[ib]) == lees_edw_ibuff_to_real(le, ib)) ? static_cast< void>(0) : __assert_fail("le->icbuff_to_real[ib] == lees_edw_ibuff_to_real(le, ib)", "leesedwards.c", 847, __PRETTY_FUNCTION__); 
# 848
...
double tle; 
# 869
(le) ? static_cast< void>(0) : __assert_fail("le", "leesedwards.c", 869, __PRETTY_FUNCTION__); 
# 870
((ib >= 0) && (ib < ((le->param)->nxbuffer))) ? static_cast< void>(0) : __assert_fail("ib >= 0 && ib < le->param->nxbuffer", "leesedwards.c", 870, __PRETTY_FUNCTION__); 
# 872
tle = (t - ((le->param)->time0)); 
# 873
(tle >= (0.0)) ? static_cast< void>(0) : __assert_fail("tle >= 0.0", "leesedwards.c", 873, __PRETTY_FUNCTION__); 
# 875
(*dy) = (0.0); 
# 877
if (((le->param)->type) == (LEES_EDW_LINEAR)) { 
...
# 879
(((le->buffer_duy)[ib]) == lees_edw_buffer_duy(le, ib)) ? static_cast< void>(0) : __assert_fail("le->buffer_duy[ib] == lees_edw_buffer_duy(le, ib)", "leesedwards.c", 879, __PRETTY_FUNCTION__); 
# 880
}  
# 882
...
int lees_edw_comm(lees_edw_t *le, MPI_Comm *comm) { 
# 899
(le) ? static_cast< void>(0) : __assert_fail("le", "leesedwards.c", 899, __PRETTY_FUNCTION__); 
# 901
(*comm) = (le->le_comm); 
# 903
return 0; 
...
int lees_edw_plane_comm(lees_edw_t *le, MPI_Comm *comm) { 
# 914
(le) ? static_cast< void>(0) : __assert_fail("le", "leesedwards.c", 914, __PRETTY_FUNCTION__); 
# 916
...
# 932 "leesedwards.c"
int lees_edw_jstart_to_mpi_ranks(lees_edw_t *le, const int j1, int send[3], int 
# 933
recv[3]) { 
# 935
int cartcoords[3]; 
...
# 938
(le) ? static_cast< void>(0) : __assert_fail("le", "leesedwards.c", 938, __PRETTY_FUNCTION__); 
# 939
(le->cs) ? static_cast< void>(0) : __assert_fail("le->cs", "leesedwards.c", 939, __PRETTY_FUNCTION__); 
# 941
cs_cart_coords(le->cs, cartcoords); 
# 945
...
double ltot[3]; 
# 979
(le) ? static_cast< void>(0) : __assert_fail("le", "leesedwards.c", 979, __PRETTY_FUNCTION__); 
# 980
cs_ltot(le->cs, ltot); 
# 982
...
int lees_edw_index(lees_edw_t *le, int ic, int jc, int kc) { 
# 1000
(le) ? static_cast< void>(0) : __assert_fail("le", "leesedwards.c", 1000, __PRETTY_FUNCTION__); 
# 1002
(ic >= (1 - ((le->param)->nhalo))) ? static_cast< void>(0) : __assert_fail("ic >= 1-le->param->nhalo", "leesedwards.c", 1002, __PRETTY_FUNCTION__); 
# 1003
(jc >= (1 - ((le->param)->nhalo))) ? static_cast< void>(0) : __assert_fail("jc >= 1-le->param->nhalo", "leesedwards.c", 1003, __PRETTY_FUNCTION__); 
# 1004
(kc >= (1 - ((le->param)->nhalo))) ? static_cast< void>(0) : __assert_fail("kc >= 1-le->param->nhalo", "leesedwards.c", 1004, __PRETTY_FUNCTION__); 
# 1005
(ic <= (((((le->param)->nlocal)[X]) + ((le->param)->nhalo)) + ((le->param)->nxbuffer))) ? static_cast< void>(0) : __assert_fail("ic <= le->param->nlocal[X] + le->param->nhalo + le->param->nxbuffer", "leesedwards.c", 1005, __PRETTY_FUNCTION__); 
# 1006
(jc <= ((((le->param)->nlocal)[Y]) + ((le->param)->nhalo))) ? static_cast< void>(0) : __assert_fail("jc <= le->param->nlocal[Y] + le->param->nhalo", "leesedwards.c", 1006, __PRETTY_FUNCTION__); 
# 1007
(kc <= ((((le->param)->nlocal)[Z]) + ((le->param)->nhalo))) ? static_cast< void>(0) : __assert_fail("kc <= le->param->nlocal[Z] + le->param->nhalo", "leesedwards.c", 1007, __PRETTY_FUNCTION__); 
# 1009
return (((((le->param)->str)[X]) * ((((le->param)->nhalo) + ic) - 1)) + ((((le->param)->str)[Y]) * ((((le->param)->nhalo) + jc) - 1))) + ((((le->param)->str)[Z]) * ((((le->param)->nhalo) + kc) - 1)); 
# 1012
} 
# 1020
void lees_edw_index_v(lees_edw_t *le, int ic[1], int 
# 1021
jc[1], int kc[1], int 
# 1022
index[1]) { 
...
int iv; 
# 1024
(le) ? static_cast< void>(0) : __assert_fail("le", "leesedwards.c", 1024, __PRETTY_FUNCTION__); 
# 1026
for (iv = 0; iv < 1; iv++) { 
# 1027
...
int lees_edw_nlocal(lees_edw_t *le, int nlocal[3]) { 
# 1042
(le) ? static_cast< void>(0) : __assert_fail("le", "leesedwards.c", 1042, __PRETTY_FUNCTION__); 
# 1044
...
int lees_edw_strides(lees_edw_t *le, int *xs, int *ys, int *zs) { 
# 1056
(le) ? static_cast< void>(0) : __assert_fail("le", "leesedwards.c", 1056, __PRETTY_FUNCTION__); 
# 1058
...
int lees_edw_nhalo(lees_edw_t *le, int *nhalo) { 
# 1070
(le) ? static_cast< void>(0) : __assert_fail("le", "leesedwards.c", 1070, __PRETTY_FUNCTION__); 
# 1072
...
int lees_edw_ltot(lees_edw_t *le, double ltot[3]) { 
# 1084
(le) ? static_cast< void>(0) : __assert_fail("le", "leesedwards.c", 1084, __PRETTY_FUNCTION__); 
# 1086
...
int lees_edw_cartsz(lees_edw_t *le, int cartsz[3]) { 
# 1098
(le) ? static_cast< void>(0) : __assert_fail("le", "leesedwards.c", 1098, __PRETTY_FUNCTION__); 
# 1099
(le->cs) ? static_cast< void>(0) : __assert_fail("le->cs", "leesedwards.c", 1099, __PRETTY_FUNCTION__); 
# 1101
...
int lees_edw_ntotal(lees_edw_t *le, int ntotal[3]) { 
# 1113
(le) ? static_cast< void>(0) : __assert_fail("le", "leesedwards.c", 1113, __PRETTY_FUNCTION__); 
# 1115
...
# 1127
(le) ? static_cast< void>(0) : __assert_fail("le", "leesedwards.c", 1127, __PRETTY_FUNCTION__); 
# 1129
...
# 1141
(le) ? static_cast< void>(0) : __assert_fail("le", "leesedwards.c", 1141, __PRETTY_FUNCTION__); 
# 1143
...
double t; 
# 1158
(le) ? static_cast< void>(0) : __assert_fail("le", "leesedwards.c", 1158, __PRETTY_FUNCTION__); 
# 1159
(le->phys) ? static_cast< void>(0) : __assert_fail("le->phys", "leesedwards.c", 1159, __PRETTY_FUNCTION__); 
# 1160
(dy) ? static_cast< void>(0) : __assert_fail("dy", "leesedwards.c", 1160, __PRETTY_FUNCTION__); 
# 1162
...
# 1177 "leesedwards.c"
int lees_edw_buffer_dy(lees_edw_t *le, int ib, double t0, double *
# 1178
dy) { 
# 1180
double t; 
# 1182
(le) ? static_cast< void>(0) : __assert_fail("le", "leesedwards.c", 1182, __PRETTY_FUNCTION__); 
# 1183
(le->phys) ? static_cast< void>(0) : __assert_fail("le->phys", "leesedwards.c", 1183, __PRETTY_FUNCTION__); 
# 1185
physics_control_time(le->phys, &t); 
# 1186
...
int lees_edw_buffer_du(lees_edw_t *le, int ib, double ule[3]) { 
# 1201
(le) ? static_cast< void>(0) : __assert_fail("le", "leesedwards.c", 1201, __PRETTY_FUNCTION__); 
# 1202
((ib >= 0) && (ib < ((le->param)->nxbuffer))) ? static_cast< void>(0) : __assert_fail("ib >= 0 && ib < le->param->nxbuffer", "leesedwards.c", 1202, __PRETTY_FUNCTION__); 
# 1204
if (((le->param)->type) == (LEES_EDW_LINEAR)) { 
# 1205
(ule[X]) = (0.0); 
...
# 1207
(((le->buffer_duy)[ib]) == lees_edw_buffer_duy(le, ib)) ? static_cast< void>(0) : __assert_fail("le->buffer_duy[ib] == lees_edw_buffer_duy(le, ib)", "leesedwards.c", 1207, __PRETTY_FUNCTION__); 
# 1208
(ule[Z]) = (0.0); 
# 1209
} else 
...
{ 
# 1211
(0) ? static_cast< void>(0) : __assert_fail("0", "leesedwards.c", 1211, __PRETTY_FUNCTION__); 
# 1212
}  
# 1214
return 0; 
...
int p; 
# 1228
(le) ? static_cast< void>(0) : __assert_fail("le", "leesedwards.c", 1228, __PRETTY_FUNCTION__); 
# 1229
((ib >= 0) && (ib < ((le->param)->nxbuffer))) ? static_cast< void>(0) : __assert_fail("ib >= 0 && ib < le->param->nxbuffer", "leesedwards.c", 1229, __PRETTY_FUNCTION__); 
# 1231
...
int nh; 
# 1252
(le) ? static_cast< void>(0) : __assert_fail("le", "leesedwards.c", 1252, __PRETTY_FUNCTION__); 
# 1253
(di <= ((le->param)->nhalo)) ? static_cast< void>(0) : __assert_fail("di <= le->param->nhalo", "leesedwards.c", 1253, __PRETTY_FUNCTION__); 
# 1254
(di >= (-((le->param)->nhalo))) ? static_cast< void>(0) : __assert_fail("di >= -le->param->nhalo", "leesedwards.c", 1254, __PRETTY_FUNCTION__); 
# 1256
ib = (ic + di); 
# 1258
...
int pm1; 
# 1292
(le) ? static_cast< void>(0) : __assert_fail("le", "leesedwards.c", 1292, __PRETTY_FUNCTION__); 
# 1293
((ib >= 0) && (ib < ((le->param)->nxbuffer))) ? static_cast< void>(0) : __assert_fail("ib >= 0 && ib < le->param->nxbuffer", "leesedwards.c", 1293, __PRETTY_FUNCTION__); 
# 1295
pm1 = (+1); 
# 1296
...
# 1 "leesedwards.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__19_leesedwards_cpp1_ii_a73b72cf
# 1 "leesedwards.cudafe1.stub.c"
#include "leesedwards.cudafe1.stub.c"
# 1 "leesedwards.cudafe1.stub.c"
