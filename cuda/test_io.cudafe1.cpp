...
# 39
int test_io_info_create_impl_a(pe_t * pe, cs_t * cs); 
# 47
int test_io_suite() { 
# 49
pe_t *pe = (__null); 
...
io_info_arg_t args; 
# 80
io_info_t *io_info = (__null); 
# 82
(pe) ? static_cast< void>(0) : __assert_fail("pe", "test_io.c", 82, __PRETTY_FUNCTION__); 
# 83
(cs) ? static_cast< void>(0) : __assert_fail("cs", "test_io.c", 83, __PRETTY_FUNCTION__); 
# 85
...
# 97
(io_info) ? static_cast< void>(0) : __assert_fail("io_info", "test_io.c", 97, __PRETTY_FUNCTION__); 
# 101
io_info_set_name(io_info, "Test double data"); 
# 102
io_info_set_bytesize(io_info, IO_FORMAT_BINARY, sizeof(double)); 
# 103
io_info_set_bytesize(io_info, IO_FORMAT_ASCII, 10); 
# 104
...
io_info_t *info = (0); 
# 159
(pe) ? static_cast< void>(0) : __assert_fail("pe", "test_io.c", 159, __PRETTY_FUNCTION__); 
# 160
(cs) ? static_cast< void>(0) : __assert_fail("cs", "test_io.c", 160, __PRETTY_FUNCTION__); 
# 162
...
# 173
(info) ? static_cast< void>(0) : __assert_fail("info", "test_io.c", 173, __PRETTY_FUNCTION__); 
# 175
{ 
# 177
((info->pe) == pe) ? static_cast< void>(0) : __assert_fail("info->pe == pe", "test_io.c", 177, __PRETTY_FUNCTION__); 
# 178
((info->cs) == cs) ? static_cast< void>(0) : __assert_fail("info->cs == cs", "test_io.c", 178, __PRETTY_FUNCTION__); 
# 179
(((info->impl).write_binary) == (impl.write_binary)) ? static_cast< void>(0) : __assert_fail("info->impl.write_binary == impl.write_binary", "test_io.c", 179, __PRETTY_FUNCTION__); 
# 180
(((info->impl).read_binary) == (impl.read_binary)) ? static_cast< void>(0) : __assert_fail("info->impl.read_binary == impl.read_binary", "test_io.c", 180, __PRETTY_FUNCTION__); 
# 181
(((info->impl).write_ascii) == (impl.write_ascii)) ? static_cast< void>(0) : __assert_fail("info->impl.write_ascii == impl.write_ascii", "test_io.c", 181, __PRETTY_FUNCTION__); 
# 182
(((info->impl).read_ascii) == (impl.read_ascii)) ? static_cast< void>(0) : __assert_fail("info->impl.read_ascii == impl.read_ascii", "test_io.c", 182, __PRETTY_FUNCTION__); 
# 183
(((info->impl).bytesize_ascii) == (impl.bytesize_ascii)) ? static_cast< void>(0) : __assert_fail("info->impl.bytesize_ascii == impl.bytesize_ascii", "test_io.c", 183, __PRETTY_FUNCTION__); 
# 184
(((info->impl).bytesize_binary) == (impl.bytesize_binary)) ? static_cast< void>(0) : __assert_fail("info->impl.bytesize_binary == impl.bytesize_binary", "test_io.c", 184, __PRETTY_FUNCTION__); 
# 185
} 
# 187
{ 
...
size_t bs; 
# 190
((((info->args).input).iorformat) == (IO_RECORD_BINARY)) ? static_cast< void>(0) : __assert_fail("info->args.input.iorformat == IO_RECORD_BINARY", "test_io.c", 190, __PRETTY_FUNCTION__); 
# 191
io_info_input_bytesize(info, &bs); 
# 192
(bs == (impl.bytesize_binary)) ? static_cast< void>(0) : __assert_fail("bs == impl.bytesize_binary", "test_io.c", 192, __PRETTY_FUNCTION__); 
# 193
} 
# 195
{ 
...
size_t bytesize; 
# 198
((((info->args).output).iorformat) == (IO_RECORD_BINARY)) ? static_cast< void>(0) : __assert_fail("info->args.output.iorformat == IO_RECORD_BINARY", "test_io.c", 198, __PRETTY_FUNCTION__); 
# 199
io_info_output_bytesize(info, &bytesize); 
# 200
(bytesize == (impl.bytesize_binary)) ? static_cast< void>(0) : __assert_fail("bytesize == impl.bytesize_binary", "test_io.c", 200, __PRETTY_FUNCTION__); 
# 201
} 
# 203
io_info_free(info); 
...
# 220
(fp) ? static_cast< void>(0) : __assert_fail("fp", "test_io.c", 220, __PRETTY_FUNCTION__); 
# 222
data = ((s->dref) * index); 
# 223
n = (fwrite(&data, sizeof(double), 1, fp)); 
# 224
test_assert_info(n == 1, 224, "test_io.c"); 
# 226
return n; 
# 227
} 
...
test_io_t *s = (test_io_t *)self; 
# 241
(fp) ? static_cast< void>(0) : __assert_fail("fp", "test_io.c", 241, __PRETTY_FUNCTION__); 
# 242
(s) ? static_cast< void>(0) : __assert_fail("s", "test_io.c", 242, __PRETTY_FUNCTION__); 
# 244
n = (fread(&data, sizeof(double), 1, fp)); 
# 245
test_assert_info(n == 1, 245, "test_io.c"); 
# 246
test_assert_info(fabs(data - ((s->dref) * index)) < ((double)(2.2204460492503130808e-16L)), 246, "test_io.c"); 
# 248
return n; 
# 249
} 
...
n = fscanf(fp, "%d\n", &indata); 
# 267
test_assert_info(n == 1, 267, "test_io.c"); 
# 268
test_assert_info(indata == ((data->iref) * index), 268, "test_io.c"); 
# 270
return n; 
# 271
} 
...
n = fprintf(fp, "%9d\n", index * (data->iref)); 
# 287
test_assert_info(n == 10, 287, "test_io.c"); 
# 289
return n; 
# 290
} 

# 1 "test_io.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__15_test_io_cpp1_ii_6edcbe7c
# 1 "test_io.cudafe1.stub.c"
#include "test_io.cudafe1.stub.c"
# 1 "test_io.cudafe1.stub.c"
