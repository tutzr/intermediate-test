...
# 213
(__cudaPushCallConfiguration(nblk, ntpb, 0, 0)) ? (void)0 : grad_3d_7pt_fluid_kernel_v(ctxt->target, (fg->field)->nf, ys, letarget, (fg->field)->target, fg->target); 
# 215
; 
# 216
...
kernel_ctxt_launch_param(ctxt, &nblk, &ntpb); 
# 476
(__cudaPushCallConfiguration(nblk, ntpb, 0, 0)) ? (void)0 : grad_3d_7pt_dab_kernel_v(ctxt->target, letarget, df->target, (df->field)->nsites, ys); 
# 477
; 
# 479
