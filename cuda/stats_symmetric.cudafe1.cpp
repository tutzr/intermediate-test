...
# 40 "stats_symmetric.c"
int stats_symmetric_length(fe_symm_t *fe, field_grad_t *phi_grad, map_t *
# 41
map, int 
# 42
timestep) { 
...
MPI_Comm comm; 
# 68
(phi_grad) ? static_cast< void>(0) : __assert_fail("phi_grad", "stats_symmetric.c", 68, __PRETTY_FUNCTION__); 
# 69
(map) ? static_cast< void>(0) : __assert_fail("map", "stats_symmetric.c", 69, __PRETTY_FUNCTION__); 
# 72
...
pe_info(pe, "\n"); 
# 141
pe_info(pe, "[length xyz] %8d %14.7e %14.7e %14.7e\n", timestep, lcoordinate[X], lcoordinate[Y], lcoordinate[Z]); 
# 143
pe_info(pe, "[length abc] %8d %14.7e %14.7e %14.7e\n", timestep, lnatural[0], lnatural[1], lnatural[2]); 
# 145
...
MPI_Comm comm; 
# 186
(phi) ? static_cast< void>(0) : __assert_fail("phi", "stats_symmetric.c", 186, __PRETTY_FUNCTION__); 
# 187
(map) ? static_cast< void>(0) : __assert_fail("map", "stats_symmetric.c", 187, __PRETTY_FUNCTION__); 
# 189
...
# 1 "stats_symmetric.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__23_stats_symmetric_cpp1_ii_edf6a134
# 1 "stats_symmetric.cudafe1.stub.c"
#include "stats_symmetric.cudafe1.stub.c"
# 1 "stats_symmetric.cudafe1.stub.c"
