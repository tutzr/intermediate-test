...
# 35
(p_link) ? static_cast< void>(0) : __assert_fail("p_link", "colloid_link.c", 35, __PRETTY_FUNCTION__); 
# 36
nlinks_++; 
# 38
return p_link; 
...
int count = 0; 
# 76
(p) ? static_cast< void>(0) : __assert_fail("p", "colloid_link.c", 76, __PRETTY_FUNCTION__); 
# 78
while (p) { 
# 79
count++; 
...
# 1 "colloid_link.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__20_colloid_link_cpp1_ii_c7ec05e0
# 1 "colloid_link.cudafe1.stub.c"
#include "colloid_link.cudafe1.stub.c"
# 1 "colloid_link.cudafe1.stub.c"
