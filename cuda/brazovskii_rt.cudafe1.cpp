...
# 22 "field_phi_init_rt.h"
int field_phi_init_rt(pe_t * pe, rt_t * rt, field_phi_info_t param, field_t * phi); 
# 24 "free_energy.h"
...
double lambda; 
# 36
(pe) ? static_cast< void>(0) : __assert_fail("pe", "brazovskii_rt.c", 36, __PRETTY_FUNCTION__); 
# 37
(rt) ? static_cast< void>(0) : __assert_fail("rt", "brazovskii_rt.c", 37, __PRETTY_FUNCTION__); 
# 38
(fe) ? static_cast< void>(0) : __assert_fail("fe", "brazovskii_rt.c", 38, __PRETTY_FUNCTION__); 
# 40
...
# 66
((param.b) > (0.0)) ? static_cast< void>(0) : __assert_fail("param.b > 0.0", "brazovskii_rt.c", 66, __PRETTY_FUNCTION__); 
# 67
((param.c) > (0.0)) ? static_cast< void>(0) : __assert_fail("param.c > 0.0", "brazovskii_rt.c", 67, __PRETTY_FUNCTION__); 
# 69
return 0; 
# 70
} 
# 79
int fe_brazovskii_phi_init_rt(pe_t *pe, rt_t *rt, fe_brazovskii_t *fe, field_t *
# 80
phi) { 
# 82
field_phi_info_t param = {(0)}; 
# 84
(pe) ? static_cast< void>(0) : __assert_fail("pe", "brazovskii_rt.c", 84, __PRETTY_FUNCTION__); 
# 85
(rt) ? static_cast< void>(0) : __assert_fail("rt", "brazovskii_rt.c", 85, __PRETTY_FUNCTION__); 
# 86
(fe) ? static_cast< void>(0) : __assert_fail("fe", "brazovskii_rt.c", 86, __PRETTY_FUNCTION__); 
# 87
(phi) ? static_cast< void>(0) : __assert_fail("phi", "brazovskii_rt.c", 87, __PRETTY_FUNCTION__); 
# 92
(param.phi0) = (0.0); 
# 94
...
# 1 "brazovskii_rt.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__21_brazovskii_rt_cpp1_ii_601bd9dc
# 1 "brazovskii_rt.cudafe1.stub.c"
#include "brazovskii_rt.cudafe1.stub.c"
# 1 "brazovskii_rt.cudafe1.stub.c"
