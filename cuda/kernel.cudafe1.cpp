...
kernel_param_t *tmp; 
# 87
{ tdpErrorHandler(cudaGetSymbolAddress((void **)(&(obj->target)), static_ctxt), "kernel.c", 87, 1); } ; 
# 88
{ tdpErrorHandler(cudaGetSymbolAddress((void **)(&tmp), static_param), "kernel.c", 88, 1); } ; 
# 89
{ tdpErrorHandler(tdpMemcpy(&((obj->target)->param), &tmp, sizeof(kernel_param_t *), cudaMemcpyHostToDevice), "kernel.c", 90, 1); 
# 89 "kernel.c"
} 
# 90
; 
...
if (ndevice > 0) { 
# 217
{ tdpErrorHandler(cudaMemcpyToSymbol(static_param, obj->param, sizeof(kernel_param_t), 0, cudaMemcpyHostToDevice), "kernel.c", 218, 1); 
# 217 "kernel.c"
} 
# 218
; 
