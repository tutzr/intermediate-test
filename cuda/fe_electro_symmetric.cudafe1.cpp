...
# 64
static fe_es_param_t const_param; 
# 66
static fe_vt_t fe_es_hvt = {((fe_free_ft)fe_es_free), ((fe_target_ft)fe_es_target), ((fe_fed_ft)fe_es_fed), ((fe_mu_ft)fe_es_mu_phi), ((fe_mu_solv_ft)fe_es_mu_ion_solv), ((fe_str_ft)fe_es_stress_ex), ((fe_str_ft)fe_es_stress_ex), ((fe_str_ft)__null), ((fe_hvector_ft)__null), ((fe_htensor_ft)__null), ((fe_htensor_v_ft)__null), ((fe_htensor_v_ft)__null), ((fe_htensor_v_ft)__null)}; 
# 82
static fe_vt_t fe_es_dvt; 
# 107 "fe_electro_symmetric.c"
int fe_es_create(pe_t *pe, cs_t *cs, fe_symm_t *symm, fe_electro_t *
# 108
elec, psi_t *
# 109
psi, fe_es_t **pobj) { 
...
fe_es_t *fe = (__null); 
# 114
(pe) ? static_cast< void>(0) : __assert_fail("pe", "fe_electro_symmetric.c", 114, __PRETTY_FUNCTION__); 
# 115
(cs) ? static_cast< void>(0) : __assert_fail("cs", "fe_electro_symmetric.c", 115, __PRETTY_FUNCTION__); 
# 116
(symm) ? static_cast< void>(0) : __assert_fail("symm", "fe_electro_symmetric.c", 116, __PRETTY_FUNCTION__); 
# 117
(elec) ? static_cast< void>(0) : __assert_fail("elec", "fe_electro_symmetric.c", 117, __PRETTY_FUNCTION__); 
# 118
(psi) ? static_cast< void>(0) : __assert_fail("psi", "fe_electro_symmetric.c", 118, __PRETTY_FUNCTION__); 
# 120
fe = ((fe_es_t *)calloc(1, sizeof(fe_es_t))); 
# 121
(fe) ? static_cast< void>(0) : __assert_fail("fe", "fe_electro_symmetric.c", 121, __PRETTY_FUNCTION__); 
# 122
if (fe == (__null)) { pe_fatal(pe, "calloc(fe_es_t) failed\n"); }  
# 123
(fe->param) = ((fe_es_param_t *)calloc(1, sizeof(fe_es_param_t))); 
# 124
(fe->param) ? static_cast< void>(0) : __assert_fail("fe->param", "fe_electro_symmetric.c", 124, __PRETTY_FUNCTION__); 
# 125
if ((fe->param) == (__null)) { pe_fatal(pe, "calloc(fe_es_param_t) failed\n"); }  
# 127
(fe->pe) = pe; 
# 128
(fe->cs) = cs; 
...
# 148
{ tdpErrorHandler(cudaGetSymbolAddress((void **)(&tmp), const_param), "fe_electro_symmetric.c", 148, 1); } ; 
# 149
tdpMemcpy(&((fe->target)->param), tmp, sizeof(fe_es_param_t *), cudaMemcpyHostToDevice); 
# 151
{ tdpErrorHandler(cudaGetSymbolAddress((void **)(&vt), fe_es_dvt), "fe_electro_symmetric.c", 151, 1); } ; 
# 152
}  
# 154
(*pobj) = fe; 
...
int fe_es_free(fe_es_t *fe) { 
# 167
(fe) ? static_cast< void>(0) : __assert_fail("fe", "fe_electro_symmetric.c", 167, __PRETTY_FUNCTION__); 
# 169
...
int fe_es_target(fe_es_t *fe, fe_t **target) { 
# 185
(fe) ? static_cast< void>(0) : __assert_fail("fe", "fe_electro_symmetric.c", 185, __PRETTY_FUNCTION__); 
# 186
(target) ? static_cast< void>(0) : __assert_fail("target", "fe_electro_symmetric.c", 186, __PRETTY_FUNCTION__); 
# 188
...
double e3; 
# 210
(fe) ? static_cast< void>(0) : __assert_fail("fe", "fe_electro_symmetric.c", 210, __PRETTY_FUNCTION__); 
# 212
...
reunit = ((1.0) / eunit); 
# 254
(fe) ? static_cast< void>(0) : __assert_fail("fe", "fe_electro_symmetric.c", 254, __PRETTY_FUNCTION__); 
# 258
...
# 295 "fe_electro_symmetric.c"
int fe_es_mu_ion_solv(fe_es_t *fe, int index, int n, double *mu) { 
# 297
double phi; 
# 299
(fe) ? static_cast< void>(0) : __assert_fail("fe", "fe_electro_symmetric.c", 299, __PRETTY_FUNCTION__); 
# 300
(mu) ? static_cast< void>(0) : __assert_fail("mu", "fe_electro_symmetric.c", 300, __PRETTY_FUNCTION__); 
# 301
(n < ((fe->param)->nk)) ? static_cast< void>(0) : __assert_fail("n < fe->param->nk", "fe_electro_symmetric.c", 301, __PRETTY_FUNCTION__); 
# 303
...
# 318 "fe_electro_symmetric.c"
int fe_es_epsilon_set(fe_es_t *fe, double e1, double e2) { 
# 320
(fe) ? static_cast< void>(0) : __assert_fail("fe", "fe_electro_symmetric.c", 320, __PRETTY_FUNCTION__); 
# 322
...
# 339 "fe_electro_symmetric.c"
int fe_es_deltamu_set(fe_es_t *fe, int nk, double *deltamu) { 
# 341
int n; 
# 343
(fe) ? static_cast< void>(0) : __assert_fail("fe", "fe_electro_symmetric.c", 343, __PRETTY_FUNCTION__); 
# 344
(nk == ((fe->param)->nk)) ? static_cast< void>(0) : __assert_fail("nk == fe->param->nk", "fe_electro_symmetric.c", 344, __PRETTY_FUNCTION__); 
# 345
(nk <= 4) ? static_cast< void>(0) : __assert_fail("nk <= 4", "fe_electro_symmetric.c", 345, __PRETTY_FUNCTION__); 
# 346
(deltamu) ? static_cast< void>(0) : __assert_fail("deltamu", "fe_electro_symmetric.c", 346, __PRETTY_FUNCTION__); 
# 348
for (n = 0; n < nk; n++) { 
# 349
...
# 368 "fe_electro_symmetric.c"
int fe_es_var_epsilon(fe_es_t *fe, int index, double *epsilon) { 
# 370
double phi; 
# 372
(fe) ? static_cast< void>(0) : __assert_fail("fe", "fe_electro_symmetric.c", 372, __PRETTY_FUNCTION__); 
# 373
(epsilon) ? static_cast< void>(0) : __assert_fail("epsilon", "fe_electro_symmetric.c", 373, __PRETTY_FUNCTION__); 
# 375
field_scalar((fe->fe_symm)->phi, index, &phi); 
# 376
...
# 426
(fe) ? static_cast< void>(0) : __assert_fail("fe", "fe_electro_symmetric.c", 426, __PRETTY_FUNCTION__); 
# 428
physics_ref(&phys); 
# 429
physics_kt(phys, &kt); 
...
# 1 "fe_electro_symmetric.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__28_fe_electro_symmetric_cpp1_ii_9cafb0b1
# 1 "fe_electro_symmetric.cudafe1.stub.c"
#include "fe_electro_symmetric.cudafe1.stub.c"
# 1 "fe_electro_symmetric.cudafe1.stub.c"
