...
# 44 "symmetric.c"
static fe_symm_param_t const_param; 
# 46
static fe_vt_t fe_symm_hvt = {((fe_free_ft)fe_symm_free), ((fe_target_ft)fe_symm_target), ((fe_fed_ft)fe_symm_fed), ((fe_mu_ft)fe_symm_mu), ((fe_mu_solv_ft)__null), ((fe_str_ft)fe_symm_str), ((fe_str_ft)fe_symm_str), ((fe_str_ft)__null), ((fe_hvector_ft)__null), ((fe_htensor_ft)__null), ((fe_htensor_v_ft)__null), ((fe_stress_v_ft)fe_symm_str_v), ((fe_stress_v_ft)fe_symm_str_v), ((fe_stress_v_ft)__null)}; 
# 63
static fe_vt_t fe_symm_dvt; 
# 88 "symmetric.c"
int fe_symm_create(pe_t *pe, cs_t *cs, field_t *phi, field_grad_t *
# 89
dphi, fe_symm_t **p) { 
# 91
int ndevice; 
# 92
fe_symm_t *obj = (__null); 
# 94
(pe) ? static_cast< void>(0) : __assert_fail("pe", "symmetric.c", 94, __PRETTY_FUNCTION__); 
# 95
(cs) ? static_cast< void>(0) : __assert_fail("cs", "symmetric.c", 95, __PRETTY_FUNCTION__); 
# 96
(phi) ? static_cast< void>(0) : __assert_fail("phi", "symmetric.c", 96, __PRETTY_FUNCTION__); 
# 97
(dphi) ? static_cast< void>(0) : __assert_fail("dphi", "symmetric.c", 97, __PRETTY_FUNCTION__); 
# 99
obj = ((fe_symm_t *)calloc(1, sizeof(fe_symm_t))); 
# 100
(obj) ? static_cast< void>(0) : __assert_fail("obj", "symmetric.c", 100, __PRETTY_FUNCTION__); 
# 101
if (obj == (__null)) { pe_fatal(pe, "calloc(fe_symm_t) failed\n"); }  
# 103
(obj->param) = ((fe_symm_param_t *)calloc(1, sizeof(fe_symm_param_t))); 
# 104
(obj->param) ? static_cast< void>(0) : __assert_fail("obj->param", "symmetric.c", 104, __PRETTY_FUNCTION__); 
# 105
if ((obj->param) == (__null)) { pe_fatal(pe, "calloc(fe_symm_param_t failed\n"); }  
# 107
(obj->pe) = pe; 
# 108
(obj->cs) = cs; 
...
# 126
{ tdpErrorHandler(cudaGetSymbolAddress((void **)(&p), const_param), "symmetric.c", 126, 1); } ; 
# 127
tdpMemcpy(&((obj->target)->param), &p, sizeof(fe_symm_param_t *), cudaMemcpyHostToDevice); 
# 129
{ tdpErrorHandler(cudaGetSymbolAddress((void **)(&vt), fe_symm_dvt), "symmetric.c", 129, 1); } ; 
# 130
...
int ndevice; 
# 154
(fe) ? static_cast< void>(0) : __assert_fail("fe", "symmetric.c", 154, __PRETTY_FUNCTION__); 
# 156
tdpGetDeviceCount(&ndevice); 
# 158
...
int fe_symm_target(fe_symm_t *fe, fe_t **target) { 
# 176
(fe) ? static_cast< void>(0) : __assert_fail("fe", "symmetric.c", 176, __PRETTY_FUNCTION__); 
# 177
(target) ? static_cast< void>(0) : __assert_fail("target", "symmetric.c", 177, __PRETTY_FUNCTION__); 
# 179
...
# 190
int fe_symm_kernel_commit(fe_symm_t *fe) { 
# 192
(fe) ? static_cast< void>(0) : __assert_fail("fe", "symmetric.c", 192, __PRETTY_FUNCTION__); 
# 194
{ tdpErrorHandler(cudaMemcpyToSymbol(const_param, fe->param, sizeof(fe_symm_param_t), 0, cudaMemcpyHostToDevice), "symmetric.c", 195, 1); 
# 194 "symmetric.c"
} 
# 195
; 
...
int fe_symm_param_set(fe_symm_t *fe, fe_symm_param_t values) { 
# 211
(fe) ? static_cast< void>(0) : __assert_fail("fe", "symmetric.c", 211, __PRETTY_FUNCTION__); 
# 213
(*(fe->param)) = values; 
# 215
...
int fe_symm_param(fe_symm_t *fe, fe_symm_param_t *values) { 
# 229
(fe) ? static_cast< void>(0) : __assert_fail("fe", "symmetric.c", 229, __PRETTY_FUNCTION__); 
# 231
(*values) = (*(fe->param)); 
# 233
return 0; 
...
double a, b, kappa; 
# 249
(fe) ? static_cast< void>(0) : __assert_fail("fe", "symmetric.c", 249, __PRETTY_FUNCTION__); 
# 251
a = ((fe->param)->a); 
# 252
b = ((fe->param)->b); 
...
int fe_symm_interfacial_width(fe_symm_t *fe, double *xi) { 
# 269
(fe) ? static_cast< void>(0) : __assert_fail("fe", "symmetric.c", 269, __PRETTY_FUNCTION__); 
# 271
...
double dphi[3]; 
# 290
(fe) ? static_cast< void>(0) : __assert_fail("fe", "symmetric.c", 290, __PRETTY_FUNCTION__); 
# 292
field_scalar(fe->phi, index, &phi); 
# 293
field_grad_scalar_grad(fe->dphi, index, dphi); 
# 295
(*fed) = ((((((0.5) * ((fe->param)->a)) + ((((0.25) * ((fe->param)->b)) * phi) * phi)) * phi) * phi) + (((0.5) * ((fe->param)->kappa)) * dot_product(dphi, dphi))); 
# 298
return 0; 
# 299
} 
...
double delsq; 
# 313
phi = (((fe->phi)->data)[reverse_addr_rank0_assert(313, "symmetric.c", (fe->phi)->nsites, index)]); 
# 314
delsq = (((fe->dphi)->delsq)[reverse_addr_rank0_assert(314, "symmetric.c", (fe->phi)->nsites, index)]); 
# 316
...
double d_ab; 
# 344
(fe) ? static_cast< void>(0) : __assert_fail("fe", "symmetric.c", 344, __PRETTY_FUNCTION__); 
# 346
kappa = ((fe->param)->kappa); 
# 348
field_scalar(fe->phi, index, &phi); 
...
# 352
p0 = (((((((0.5) * ((fe->param)->a)) * phi) * phi) + ((((((0.75) * ((fe->param)->b)) * phi) * phi) * phi) * phi)) - ((kappa * phi) * delsq_phi)) - (((0.5) * kappa) * dot_product(grad_phi, grad_phi))); 
# 355
for (ia = 0; ia < 3; ia++) { 
# 356
for (ib = 0; ib < 3; ib++) { 
...
# 385
(fe) ? static_cast< void>(0) : __assert_fail("fe", "symmetric.c", 385, __PRETTY_FUNCTION__); 
# 386
(fe->phi) ? static_cast< void>(0) : __assert_fail("fe->phi", "symmetric.c", 386, __PRETTY_FUNCTION__); 
# 387
(fe->dphi) ? static_cast< void>(0) : __assert_fail("fe->dphi", "symmetric.c", 387, __PRETTY_FUNCTION__); 
# 388
(fe->param) ? static_cast< void>(0) : __assert_fail("fe->param", "symmetric.c", 388, __PRETTY_FUNCTION__); 
# 390
a = ((fe->param)->a); 
# 391
b = ((fe->param)->b); 
...
for (iv = 0; iv < 1; iv++) { 
# 396
((grad[ia])[iv]) = (((fe->dphi)->grad)[reverse_addr_rank2_assert(396, "symmetric.c", (fe->dphi)->nsite, 1, 3, index + iv, 0, ia)]); 
# 397
}  
# 398
}  
...
for (iv = 0; iv < 1; iv++) { 
# 401
phi = (((fe->phi)->data)[reverse_addr_rank1_assert(401, "symmetric.c", (fe->phi)->nsites, 1, index + iv, 0)]); 
# 402
delsq = (((fe->dphi)->delsq)[reverse_addr_rank1_assert(402, "symmetric.c", (fe->dphi)->nsite, 1, index + iv, 0)]); 
# 404
p0 = (((((((0.5) * a) * phi) * phi) + ((((((0.75) * b) * phi) * phi) * phi) * phi)) - ((kappa * phi) * delsq)) - (((0.5) * kappa) * (((((grad[X])[iv]) * ((grad[X])[iv])) + (((grad[Y])[iv]) * ((grad[Y])[iv]))) + (((grad[Z])[iv]) * ((grad[Z])[iv]))))); 
# 408
for (ia = 0; ia < 3; ia++) { 
# 409
for (ib = 0; ib < 3; ib++) { 
...
# 1 "symmetric.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__17_symmetric_cpp1_ii_26b9708b
# 1 "symmetric.cudafe1.stub.c"
#include "symmetric.cudafe1.stub.c"
# 1 "symmetric.cudafe1.stub.c"
