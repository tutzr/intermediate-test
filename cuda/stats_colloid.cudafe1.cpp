...
MPI_Comm comm; 
# 54
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "stats_colloid.c", 54, __PRETTY_FUNCTION__); 
# 56
...
# 71
if (((pc->s).type) == (COLLOID_TYPE_SUBGRID)) { mass = (0.0); }  
# 73
...
for (ia = 0; ia < 6; ia++) { 
# 110
(vminlocal[ia]) = ((3.402823466e+38F)); 
# 111
}  
# 113
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "stats_colloid.c", 113, __PRETTY_FUNCTION__); 
# 114
colloids_info_ncell(cinfo, ncell); 
# 115
pe_mpi_comm(cinfo->pe, &comm); 
...
# 1 "stats_colloid.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__21_stats_colloid_cpp1_ii_ef6553fc
# 1 "stats_colloid.cudafe1.stub.c"
#include "stats_colloid.cudafe1.stub.c"
# 1 "stats_colloid.cudafe1.stub.c"
