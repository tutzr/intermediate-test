...
fe_lc_droplet_param_t param; 
# 34
(fe) ? static_cast< void>(0) : __assert_fail("fe", "lc_droplet_rt.c", 34, __PRETTY_FUNCTION__); 
# 36
pe_info(pe, "\n"); 
# 37
...
# 1 "lc_droplet_rt.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__21_lc_droplet_rt_cpp1_ii_a3430d6c
# 1 "lc_droplet_rt.cudafe1.stub.c"
#include "lc_droplet_rt.cudafe1.stub.c"
# 1 "lc_droplet_rt.cudafe1.stub.c"
