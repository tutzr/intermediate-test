...
# 35
int field_grad_create(pe_t *pe, field_t *f, int level, field_grad_t **
# 36
pobj) { 
# 38
field_grad_t *obj = ((field_grad_t *)__null); 
# 40
(pe) ? static_cast< void>(0) : __assert_fail("pe", "field_grad.c", 40, __PRETTY_FUNCTION__); 
# 41
(f) ? static_cast< void>(0) : __assert_fail("f", "field_grad.c", 41, __PRETTY_FUNCTION__); 
# 42
(pobj) ? static_cast< void>(0) : __assert_fail("pobj", "field_grad.c", 42, __PRETTY_FUNCTION__); 
# 44
obj = ((field_grad_t *)calloc(1, sizeof(field_grad_t))); 
# 45
(obj) ? static_cast< void>(0) : __assert_fail("obj", "field_grad.c", 45, __PRETTY_FUNCTION__); 
# 46
if (obj == (__null)) { pe_fatal(pe, "calloc(field_grad_t) failed\n"); }  
# 48
(obj->pe) = pe; 
# 49
(obj->field) = f; 
...
field_nf(f, &(obj->nf)); 
# 53
((obj->nf) > 0) ? static_cast< void>(0) : __assert_fail("obj->nf > 0", "field_grad.c", 53, __PRETTY_FUNCTION__); 
# 55
field_grad_init(obj); 
# 56
(*pobj) = obj; 
...
double *tmp; 
# 73
(obj) ? static_cast< void>(0) : __assert_fail("obj", "field_grad.c", 73, __PRETTY_FUNCTION__); 
# 75
...
# 89
tdpMemcpy(&((obj->target)->field), &((obj->field)->target), sizeof(field_t *), cudaMemcpyHostToDevice); 
# 91
}  
# 93
if ((obj->level) >= 2) { 
# 95
(obj->grad) = ((double *)calloc((3 * (obj->nf)) * nsites, sizeof(double))); 
# 96
(obj->delsq) = ((double *)calloc((obj->nf) * nsites, sizeof(double))); 
# 98
if ((obj->grad) == (__null)) { pe_fatal(obj->pe, "calloc(field_grad->grad) failed"); }  
# 99
if ((obj->delsq) == (__null)) { pe_fatal(obj->pe, "calloc(field_grad->delsq) failed"); }  
# 103
if (ndevice > 0) { 
# 104
tdpMalloc((void **)(&tmp), (((obj->nf) * 3) * nsites) * sizeof(double)); 
# 105
tdpMemcpy(&((obj->target)->grad), &tmp, sizeof(double *), cudaMemcpyHostToDevice); 
# 108
tdpMalloc((void **)(&tmp), ((obj->nf) * nsites) * sizeof(double)); 
# 109
tdpMemcpy(&((obj->target)->delsq), &tmp, sizeof(double *), cudaMemcpyHostToDevice); 
# 111
}  
# 112
}  
...
if ((obj->level) == 3) { 
# 115
(obj->d_ab) = ((double *)calloc((6 * (obj->nf)) * nsites, sizeof(double))); 
# 116
if ((obj->d_ab) == (__null)) { pe_fatal(obj->pe, "calloc(fieldgrad->d_ab) failed\n"); }  
# 118
if (ndevice > 0) { 
# 119
tdpMalloc((void **)(&tmp), ((6 * (obj->nf)) * nsites) * sizeof(double)); 
# 120
tdpMemcpy(&((obj->target)->d_ab), &tmp, sizeof(double *), cudaMemcpyHostToDevice); 
# 122
}  
# 123
}  
...
if ((obj->level) >= 4) { 
# 126
(obj->grad_delsq) = ((double *)calloc((3 * (obj->nf)) * nsites, sizeof(double))); 
# 127
(obj->delsq_delsq) = ((double *)calloc((obj->nf) * nsites, sizeof(double))); 
# 128
if ((obj->grad_delsq) == (__null)) { pe_fatal(obj->pe, "calloc(grad->grad_delsq) failed"); }  
# 129
if ((obj->delsq_delsq) == (__null)) { pe_fatal(obj->pe, "calloc(grad->delsq_delsq) failed"); }  
# 131
if (ndevice > 0) { 
# 132
tdpMalloc((void **)(&tmp), ((3 * (obj->nf)) * nsites) * sizeof(double)); 
# 133
tdpMemcpy(&((obj->target)->grad_delsq), &tmp, sizeof(double *), cudaMemcpyHostToDevice); 
# 136
tdpMalloc((void **)(&tmp), ((obj->nf) * nsites) * sizeof(double)); 
# 137
tdpMemcpy(&((obj->target)->delsq_delsq), &tmp, sizeof(double *), cudaMemcpyHostToDevice); 
# 139
}  
# 140
}  
...
double *tmp = (__null); 
# 159
(obj) ? static_cast< void>(0) : __assert_fail("obj", "field_grad.c", 159, __PRETTY_FUNCTION__); 
# 161
tdpGetDeviceCount(&ndevice); 
# 163
if (ndevice == 0) { 
# 165
((obj->target) == obj) ? static_cast< void>(0) : __assert_fail("obj->target == obj", "field_grad.c", 165, __PRETTY_FUNCTION__); 
# 166
} else 
# 167
{ 
...
tdpMemcpy(&((obj->target)->nsite), &(obj->nsite), sizeof(int), cudaMemcpyHostToDevice); 
# 178
tdpMemcpy(&tmp, &((obj->target)->grad), sizeof(double *), cudaMemcpyDeviceToHost); 
# 180
tdpMemcpy(tmp, obj->grad, (3) * nsz, cudaMemcpyHostToDevice); 
# 181
tdpMemcpy(&tmp, &((obj->target)->delsq), sizeof(double *), cudaMemcpyDeviceToHost); 
# 183
tdpMemcpy(tmp, obj->delsq, nsz, cudaMemcpyHostToDevice); 
# 184
break; 
# 185
...
tdpMemcpy(&tmp, &((obj->target)->grad), sizeof(double *), cudaMemcpyDeviceToHost); 
# 188
tdpMemcpy(obj->grad, tmp, (3) * nsz, cudaMemcpyDeviceToHost); 
# 189
tdpMemcpy(&tmp, &((obj->target)->delsq), sizeof(double *), cudaMemcpyDeviceToHost); 
# 191
tdpMemcpy(obj->delsq, tmp, nsz, cudaMemcpyDeviceToHost); 
# 192
break; 
# 193
default:  
...
# 210
(obj) ? static_cast< void>(0) : __assert_fail("obj", "field_grad.c", 210, __PRETTY_FUNCTION__); 
# 212
(obj->d2) = f2; 
# 213
(obj->d4) = f4; 
...
# 228
(obj) ? static_cast< void>(0) : __assert_fail("obj", "field_grad.c", 228, __PRETTY_FUNCTION__); 
# 230
(obj->dab) = fdab; 
# 232
return 0; 
...
double *tmp; 
# 249
(obj) ? static_cast< void>(0) : __assert_fail("obj", "field_grad.c", 249, __PRETTY_FUNCTION__); 
# 251
tdpGetDeviceCount(&ndevice); 
# 253
if (ndevice > 0) { 
...
tdpFree(tmp); 
# 260
tdpMemcpy(&tmp, &((obj->target)->d_ab), sizeof(double *), cudaMemcpyDeviceToHost); 
# 262
if (tmp) { tdpFree(tmp); }  
# 263
tdpMemcpy(&tmp, &((obj->target)->grad_delsq), sizeof(double *), cudaMemcpyDeviceToHost); 
# 265
if (tmp) { tdpFree(tmp); }  
# 266
tdpMemcpy(&tmp, &((obj->target)->delsq_delsq), sizeof(double *), cudaMemcpyDeviceToHost); 
# 268
if (tmp) { tdpFree(tmp); }  
# 270
tdpFree(obj->target); 
...
int field_grad_compute(field_grad_t *obj) { 
# 293
(obj) ? static_cast< void>(0) : __assert_fail("obj", "field_grad.c", 293, __PRETTY_FUNCTION__); 
# 294
(obj->d2) ? static_cast< void>(0) : __assert_fail("obj->d2", "field_grad.c", 294, __PRETTY_FUNCTION__); 
# 296
...
if ((obj->level) == 3) { 
# 301
(obj->dab) ? static_cast< void>(0) : __assert_fail("obj->dab", "field_grad.c", 301, __PRETTY_FUNCTION__); 
# 302
(obj->dab)(obj); 
# 303
}  
...
if ((obj->level) >= 4) { 
# 306
(obj->d4) ? static_cast< void>(0) : __assert_fail("obj->d4", "field_grad.c", 306, __PRETTY_FUNCTION__); 
# 307
(obj->d4)(obj); 
# 308
}  
...
int ia; 
# 323
(obj) ? static_cast< void>(0) : __assert_fail("obj", "field_grad.c", 323, __PRETTY_FUNCTION__); 
# 324
((obj->nf) == 1) ? static_cast< void>(0) : __assert_fail("obj->nf == 1", "field_grad.c", 324, __PRETTY_FUNCTION__); 
# 325
(grad) ? static_cast< void>(0) : __assert_fail("grad", "field_grad.c", 325, __PRETTY_FUNCTION__); 
# 327
for (ia = 0; ia < 3; ia++) { 
# 328
(grad[ia]) = ((obj->grad)[reverse_addr_rank2_assert(328, "field_grad.c", obj->nsite, 1, 3, index, 0, ia)]); 
# 329
}  
# 331
return 0; 
...
int field_grad_scalar_delsq(field_grad_t *obj, int index, double *delsq) { 
# 343
(obj) ? static_cast< void>(0) : __assert_fail("obj", "field_grad.c", 343, __PRETTY_FUNCTION__); 
# 344
((obj->nf) == 1) ? static_cast< void>(0) : __assert_fail("obj->nf == 1", "field_grad.c", 344, __PRETTY_FUNCTION__); 
# 345
(delsq) ? static_cast< void>(0) : __assert_fail("delsq", "field_grad.c", 345, __PRETTY_FUNCTION__); 
# 347
(*delsq) = ((obj->delsq)[reverse_addr_rank1_assert(347, "field_grad.c", obj->nsite, 1, index, 0)]); 
# 349
return 0; 
# 350
} 
# 359
int field_grad_scalar_grad_delsq(field_grad_t *obj, int index, double 
# 360
grad[3]) { 
# 361
int ia; 
# 363
(obj) ? static_cast< void>(0) : __assert_fail("obj", "field_grad.c", 363, __PRETTY_FUNCTION__); 
# 364
((obj->nf) == 1) ? static_cast< void>(0) : __assert_fail("obj->nf == 1", "field_grad.c", 364, __PRETTY_FUNCTION__); 
# 365
(grad) ? static_cast< void>(0) : __assert_fail("grad", "field_grad.c", 365, __PRETTY_FUNCTION__); 
# 367
for (ia = 0; ia < 3; ia++) { 
# 368
(grad[ia]) = ((obj->grad_delsq)[reverse_addr_rank1_assert(368, "field_grad.c", obj->nsite, 3, index, ia)]); 
# 369
}  
# 371
return 0; 
...
int field_grad_scalar_delsq_delsq(field_grad_t *obj, int index, double *dd) { 
# 383
(obj) ? static_cast< void>(0) : __assert_fail("obj", "field_grad.c", 383, __PRETTY_FUNCTION__); 
# 384
((obj->nf) == 1) ? static_cast< void>(0) : __assert_fail("obj->nf == 1", "field_grad.c", 384, __PRETTY_FUNCTION__); 
# 385
(dd) ? static_cast< void>(0) : __assert_fail("dd", "field_grad.c", 385, __PRETTY_FUNCTION__); 
# 387
(*dd) = ((obj->delsq_delsq)[reverse_addr_rank1_assert(387, "field_grad.c", obj->nsite, 1, index, 0)]); 
# 389
return 0; 
# 390
} 
...
# 403
(obj) ? static_cast< void>(0) : __assert_fail("obj", "field_grad.c", 403, __PRETTY_FUNCTION__); 
# 404
((obj->nf) == 1) ? static_cast< void>(0) : __assert_fail("obj->nf == 1", "field_grad.c", 404, __PRETTY_FUNCTION__); 
# 406
((dab[X])[X]) = ((obj->d_ab)[reverse_addr_rank1_assert(406, "field_grad.c", obj->nsite, 6, index, XX)]); 
# 407
((dab[X])[Y]) = ((obj->d_ab)[reverse_addr_rank1_assert(407, "field_grad.c", obj->nsite, 6, index, XY)]); 
# 408
((dab[X])[Z]) = ((obj->d_ab)[reverse_addr_rank1_assert(408, "field_grad.c", obj->nsite, 6, index, XZ)]); 
# 409
((dab[Y])[X]) = ((dab[X])[Y]); 
# 410
((dab[Y])[Y]) = ((obj->d_ab)[reverse_addr_rank1_assert(410, "field_grad.c", obj->nsite, 6, index, YY)]); 
# 411
((dab[Y])[Z]) = ((obj->d_ab)[reverse_addr_rank1_assert(411, "field_grad.c", obj->nsite, 6, index, YZ)]); 
# 412
((dab[Z])[X]) = ((dab[X])[Z]); 
# 413
((dab[Z])[Y]) = ((dab[Y])[Z]); 
# 414
((dab[Z])[Z]) = ((obj->d_ab)[reverse_addr_rank1_assert(414, "field_grad.c", obj->nsite, 6, index, ZZ)]); 
# 416
return 0; 
# 417
} 
...
int ia, ib; 
# 432
(obj) ? static_cast< void>(0) : __assert_fail("obj", "field_grad.c", 432, __PRETTY_FUNCTION__); 
# 433
((obj->nf) == 3) ? static_cast< void>(0) : __assert_fail("obj->nf == 3", "field_grad.c", 433, __PRETTY_FUNCTION__); 
# 434
(dp) ? static_cast< void>(0) : __assert_fail("dp", "field_grad.c", 434, __PRETTY_FUNCTION__); 
# 436
for (ia = 0; ia < 3; ia++) { 
# 437
for (ib = 0; ib < (obj->nf); ib++) { 
# 438
((dp[ia])[ib]) = ((obj->grad)[reverse_addr_rank2_assert(438, "field_grad.c", obj->nsite, obj->nf, 3, index, ib, ia)]); 
# 439
}  
# 440
}  
...
int ia; 
# 456
(obj) ? static_cast< void>(0) : __assert_fail("obj", "field_grad.c", 456, __PRETTY_FUNCTION__); 
# 457
((obj->nf) == 3) ? static_cast< void>(0) : __assert_fail("obj->nf == 3", "field_grad.c", 457, __PRETTY_FUNCTION__); 
# 458
(delsq) ? static_cast< void>(0) : __assert_fail("delsq", "field_grad.c", 458, __PRETTY_FUNCTION__); 
# 460
for (ia = 0; ia < 3; ia++) { 
# 461
(delsq[ia]) = ((obj->delsq)[reverse_addr_rank1_assert(461, "field_grad.c", obj->nsite, 3, index, ia)]); 
# 462
}  
# 464
return 0; 
...
int ia; 
# 480
(obj) ? static_cast< void>(0) : __assert_fail("obj", "field_grad.c", 480, __PRETTY_FUNCTION__); 
# 481
((obj->nf) == 5) ? static_cast< void>(0) : __assert_fail("obj->nf == 5", "field_grad.c", 481, __PRETTY_FUNCTION__); 
# 482
(dq) ? static_cast< void>(0) : __assert_fail("dq", "field_grad.c", 482, __PRETTY_FUNCTION__); 
# 484
for (ia = 0; ia < 3; ia++) { 
# 485
(((dq[ia])[X])[X]) = ((obj->grad)[reverse_addr_rank2_assert(485, "field_grad.c", obj->nsite, 5, 3, index, XX, ia)]); 
# 486
(((dq[ia])[X])[Y]) = ((obj->grad)[reverse_addr_rank2_assert(486, "field_grad.c", obj->nsite, 5, 3, index, XY, ia)]); 
# 487
(((dq[ia])[X])[Z]) = ((obj->grad)[reverse_addr_rank2_assert(487, "field_grad.c", obj->nsite, 5, 3, index, XZ, ia)]); 
# 488
(((dq[ia])[Y])[X]) = (((dq[ia])[X])[Y]); 
# 489
(((dq[ia])[Y])[Y]) = ((obj->grad)[reverse_addr_rank2_assert(489, "field_grad.c", obj->nsite, 5, 3, index, YY, ia)]); 
# 490
(((dq[ia])[Y])[Z]) = ((obj->grad)[reverse_addr_rank2_assert(490, "field_grad.c", obj->nsite, 5, 3, index, YZ, ia)]); 
# 491
(((dq[ia])[Z])[X]) = (((dq[ia])[X])[Z]); 
# 492
(((dq[ia])[Z])[Y]) = (((dq[ia])[Y])[Z]); 
...
int field_grad_tensor_delsq(field_grad_t *obj, int index, double dsq[3][3]) { 
# 510
(obj) ? static_cast< void>(0) : __assert_fail("obj", "field_grad.c", 510, __PRETTY_FUNCTION__); 
# 511
((obj->nf) == 5) ? static_cast< void>(0) : __assert_fail("obj->nf == 5", "field_grad.c", 511, __PRETTY_FUNCTION__); 
# 512
(dsq) ? static_cast< void>(0) : __assert_fail("dsq", "field_grad.c", 512, __PRETTY_FUNCTION__); 
# 514
((dsq[X])[X]) = ((obj->delsq)[reverse_addr_rank1_assert(514, "field_grad.c", obj->nsite, 5, index, XX)]); 
# 515
((dsq[X])[Y]) = ((obj->delsq)[reverse_addr_rank1_assert(515, "field_grad.c", obj->nsite, 5, index, XY)]); 
# 516
((dsq[X])[Z]) = ((obj->delsq)[reverse_addr_rank1_assert(516, "field_grad.c", obj->nsite, 5, index, XZ)]); 
# 517
((dsq[Y])[X]) = ((dsq[X])[Y]); 
# 518
((dsq[Y])[Y]) = ((obj->delsq)[reverse_addr_rank1_assert(518, "field_grad.c", obj->nsite, 5, index, YY)]); 
# 519
((dsq[Y])[Z]) = ((obj->delsq)[reverse_addr_rank1_assert(519, "field_grad.c", obj->nsite, 5, index, YZ)]); 
# 520
((dsq[Z])[X]) = ((dsq[X])[Z]); 
# 521
((dsq[Z])[Y]) = ((dsq[Y])[Z]); 
...
# 1 "field_grad.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__18_field_grad_cpp1_ii_7ef32e18
# 1 "field_grad.cudafe1.stub.c"
#include "field_grad.cudafe1.stub.c"
# 1 "field_grad.cudafe1.stub.c"
