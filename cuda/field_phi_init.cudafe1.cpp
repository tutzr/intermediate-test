...
# 35 "field_phi_init.c"
int field_phi_init_drop(field_t *phi, double xi, double radius, double 
# 36
phistar) { 
# 38
int nlocal[3]; 
...
# 47
(phi) ? static_cast< void>(0) : __assert_fail("phi", "field_phi_init.c", 47, __PRETTY_FUNCTION__); 
# 49
...
int ic, jc, kc, index; 
# 92
(phi) ? static_cast< void>(0) : __assert_fail("phi", "field_phi_init.c", 92, __PRETTY_FUNCTION__); 
# 94
cs_nlocal(phi->cs, nlocal); 
# 96
for (ic = 1; ic <= (nlocal[X]); ic++) { 
...
double ltot[3]; 
# 128
(phi) ? static_cast< void>(0) : __assert_fail("phi", "field_phi_init.c", 128, __PRETTY_FUNCTION__); 
# 130
cs_nlocal(phi->cs, nlocal); 
# 131
cs_nlocal_offset(phi->cs, noffset); 
...
double phi0; 
# 222
(phi) ? static_cast< void>(0) : __assert_fail("phi", "field_phi_init.c", 222, __PRETTY_FUNCTION__); 
# 224
cs_nlocal(phi->cs, nlocal); 
# 225
cs_nlocal_offset(phi->cs, noffset); 
...
double len[3]; 
# 270
(phi) ? static_cast< void>(0) : __assert_fail("phi", "field_phi_init.c", 270, __PRETTY_FUNCTION__); 
# 272
cs_nlocal(phi->cs, nlocal); 
# 273
cs_nlocal_offset(phi->cs, noffset); 
...
double len[3]; 
# 318
(phi) ? static_cast< void>(0) : __assert_fail("phi", "field_phi_init.c", 318, __PRETTY_FUNCTION__); 
# 320
cs_nlocal(phi->cs, nlocal); 
# 321
cs_nlocal_offset(phi->cs, noffset); 
...
double len[3]; 
# 359
(phi) ? static_cast< void>(0) : __assert_fail("phi", "field_phi_init.c", 359, __PRETTY_FUNCTION__); 
# 361
cs_nlocal(phi->cs, nlocal); 
# 362
cs_nlocal_offset(phi->cs, noffset); 
...
double len[3]; 
# 400
(phi) ? static_cast< void>(0) : __assert_fail("phi", "field_phi_init.c", 400, __PRETTY_FUNCTION__); 
# 402
cs_nlocal(phi->cs, nlocal); 
# 403
cs_nlocal_offset(phi->cs, noffset); 
...
double ltot[3]; 
# 443
(phi) ? static_cast< void>(0) : __assert_fail("phi", "field_phi_init.c", 443, __PRETTY_FUNCTION__); 
# 445
cs_nlocal(phi->cs, nlocal); 
# 446
cs_nlocal_offset(phi->cs, noffset); 
...
noise_t *rng = (__null); 
# 490
(phi) ? static_cast< void>(0) : __assert_fail("phi", "field_phi_init.c", 490, __PRETTY_FUNCTION__); 
# 492
cs = (phi->cs); 
# 493
cs_nlocal(cs, nlocal); 
...
# 533 "field_phi_init.c"
int field_phi_init_spinodal_patches(field_t *phi, int seed, int patch, double 
# 534
volminus1) { 
# 536
int ic, jc, kc, index; 
...
noise_t *rng = (__null); 
# 547
(phi) ? static_cast< void>(0) : __assert_fail("phi", "field_phi_init.c", 547, __PRETTY_FUNCTION__); 
# 549
cs_nlocal(phi->cs, nlocal); 
# 551
...
noise_free(rng); 
# 587
(count == (((nlocal[X]) * (nlocal[Y])) * (nlocal[Z]))) ? static_cast< void>(0) : __assert_fail("count == nlocal[X]*nlocal[Y]*nlocal[Z]", "field_phi_init.c", 587, __PRETTY_FUNCTION__); 
# 589
return 0; 
# 590
} 
# 601 "field_phi_init.c"
int field_phi_init_emulsion(field_t *phi, double xi, double radius, double 
# 602
phistar, int N_drops, double d_centre) { 
# 604
int ntotal[3]; 
# 605
int nlocal[3]; 
...
double phi1; 
# 624
(phi) ? static_cast< void>(0) : __assert_fail("phi", "field_phi_init.c", 624, __PRETTY_FUNCTION__); 
# 626
...
# 1 "field_phi_init.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__22_field_phi_init_cpp1_ii_8bd1b734
# 1 "field_phi_init.cudafe1.stub.c"
#include "field_phi_init.cudafe1.stub.c"
# 1 "field_phi_init.cudafe1.stub.c"
