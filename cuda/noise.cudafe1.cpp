...
# 89
tdpMemcpy((obj->target)->rtable, obj->rtable, (8) * sizeof(double), cudaMemcpyHostToDevice); 
# 91
}  
# 93
(*pobj) = obj; 
...
unsigned *tmp = (__null); 
# 110
tdpMemcpy(&tmp, &((obj->target)->state), sizeof(unsigned *), cudaMemcpyDeviceToHost); 
# 112
tdpFree(obj->target); 
# 113
}  
...
# 218
tdpMemcpy(&((obj->target)->state), &tmp, sizeof(unsigned *), cudaMemcpyHostToDevice); 
# 220
}  
# 222
