...
clock_t end = clock(); 
# 96
double time_spent = ((double)(end - begin)) / (1000000L); 
# 97
...
# 110 "tests.c"
void test_assert_info(const int lvalue, int line, const char *
# 111
file) { 
# 113
if (lvalue) { 
...
# 1 "tests.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__13_tests_cpp1_ii_main
# 1 "tests.cudafe1.stub.c"
#include "tests.cudafe1.stub.c"
# 1 "tests.cudafe1.stub.c"
