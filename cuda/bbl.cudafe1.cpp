...
# 272
{ tdpErrorHandler(cudaMemcpyToSymbol(lbp, lb->param, sizeof(lb_collide_param_t), 0, cudaMemcpyHostToDevice), "bbl.c", 273, 1); 
# 272 "bbl.c"
} 
# 273
; 
...
# 278
(__cudaPushCallConfiguration(nblk, ntpb, 0, 0)) ? (void)0 : bbl_pass0_kernel(ctxt->target, cstarget, lb->target, cinfo->target); 
# 279
; 
# 280
