...
# 83
field_t *field = (__null); 
# 84
field_grad_t *gradient = (__null); 
# 86
(pe) ? static_cast< void>(0) : __assert_fail("pe", "test_field_grad.c", 86, __PRETTY_FUNCTION__); 
# 88
cs_create(pe, &cs); 
# 89
cs_init(cs); 
...
# 93
(field) ? static_cast< void>(0) : __assert_fail("field", "test_field_grad.c", 93, __PRETTY_FUNCTION__); 
# 94
field_init(field, 0, le); 
# 96
field_grad_create(pe, field, 4, &gradient); 
# 97
(gradient) ? static_cast< void>(0) : __assert_fail("gradient", "test_field_grad.c", 97, __PRETTY_FUNCTION__); 
# 98
...
# 102
(fabs((grad[X]) - test_encode(ENCODE_GRAD, nfref, X, 0)) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(grad[X] - test_encode(ENCODE_GRAD, nfref, X, 0)) < double(2.22044604925031308085e-16L)", "test_field_grad.c", 102, __PRETTY_FUNCTION__); 
# 103
(fabs((grad[Y]) - test_encode(ENCODE_GRAD, nfref, Y, 0)) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(grad[Y] - test_encode(ENCODE_GRAD, nfref, Y, 0)) < double(2.22044604925031308085e-16L)", "test_field_grad.c", 103, __PRETTY_FUNCTION__); 
# 104
(fabs((grad[Z]) - test_encode(ENCODE_GRAD, nfref, Z, 0)) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(grad[Z] - test_encode(ENCODE_GRAD, nfref, Z, 0)) < double(2.22044604925031308085e-16L)", "test_field_grad.c", 104, __PRETTY_FUNCTION__); 
# 106
field_grad_scalar_delsq(gradient, 1, &delsq); 
# 107
(fabs(delsq - test_encode(ENCODE_DELSQ, nfref, X, 0)) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(delsq - test_encode(ENCODE_DELSQ, nfref, X, 0)) < double(2.22044604925031308085e-16L)", "test_field_grad.c", 107, __PRETTY_FUNCTION__); 
# 109
field_grad_scalar_grad_delsq(gradient, 1, grad); 
# 110
(fabs((grad[X]) - test_encode(ENCODE_GRAD4, nfref, X, 0)) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(grad[X] - test_encode(ENCODE_GRAD4, nfref, X, 0)) < double(2.22044604925031308085e-16L)", "test_field_grad.c", 110, __PRETTY_FUNCTION__); 
# 111
(fabs((grad[Y]) - test_encode(ENCODE_GRAD4, nfref, Y, 0)) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(grad[Y] - test_encode(ENCODE_GRAD4, nfref, Y, 0)) < double(2.22044604925031308085e-16L)", "test_field_grad.c", 111, __PRETTY_FUNCTION__); 
# 112
(fabs((grad[Z]) - test_encode(ENCODE_GRAD4, nfref, Z, 0)) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(grad[Z] - test_encode(ENCODE_GRAD4, nfref, Z, 0)) < double(2.22044604925031308085e-16L)", "test_field_grad.c", 112, __PRETTY_FUNCTION__); 
# 114
field_grad_scalar_delsq_delsq(gradient, 1, &delsq); 
# 115
(fabs(delsq - test_encode(ENCODE_DELSQ4, nfref, X, 0)) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(delsq - test_encode(ENCODE_DELSQ4, nfref, X, 0)) < double(2.22044604925031308085e-16L)", "test_field_grad.c", 115, __PRETTY_FUNCTION__); 
# 117
...
field_grad_t *gradient = (__null); 
# 143
(pe) ? static_cast< void>(0) : __assert_fail("pe", "test_field_grad.c", 143, __PRETTY_FUNCTION__); 
# 145
cs_create(pe, &cs); 
# 146
cs_init(cs); 
...
# 150
(field) ? static_cast< void>(0) : __assert_fail("field", "test_field_grad.c", 150, __PRETTY_FUNCTION__); 
# 151
field_init(field, 0, le); 
# 153
field_grad_create(pe, field, 4, &gradient); 
# 154
(gradient) ? static_cast< void>(0) : __assert_fail("gradient", "test_field_grad.c", 154, __PRETTY_FUNCTION__); 
# 155
field_grad_set(gradient, test_d2, test_d4); 
# 156
field_grad_compute(gradient); 
...
# 159
(fabs(((grad[X])[X]) - test_encode(ENCODE_GRAD, nf, X, X)) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(grad[X][X] - test_encode(ENCODE_GRAD, nf, X, X)) < double(2.22044604925031308085e-16L)", "test_field_grad.c", 159, __PRETTY_FUNCTION__); 
# 160
(fabs(((grad[X])[Y]) - test_encode(ENCODE_GRAD, nf, X, Y)) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(grad[X][Y] - test_encode(ENCODE_GRAD, nf, X, Y)) < double(2.22044604925031308085e-16L)", "test_field_grad.c", 160, __PRETTY_FUNCTION__); 
# 161
(fabs(((grad[X])[Z]) - test_encode(ENCODE_GRAD, nf, X, Z)) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(grad[X][Z] - test_encode(ENCODE_GRAD, nf, X, Z)) < double(2.22044604925031308085e-16L)", "test_field_grad.c", 161, __PRETTY_FUNCTION__); 
# 163
field_grad_vector_delsq(gradient, 1, delsq); 
# 164
(fabs((delsq[X]) - test_encode(ENCODE_DELSQ, nf, X, X)) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(delsq[X] - test_encode(ENCODE_DELSQ, nf, X, X)) < double(2.22044604925031308085e-16L)", "test_field_grad.c", 164, __PRETTY_FUNCTION__); 
# 165
(fabs((delsq[Y]) - test_encode(ENCODE_DELSQ, nf, X, Y)) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(delsq[Y] - test_encode(ENCODE_DELSQ, nf, X, Y)) < double(2.22044604925031308085e-16L)", "test_field_grad.c", 165, __PRETTY_FUNCTION__); 
# 166
(fabs((delsq[Z]) - test_encode(ENCODE_DELSQ, nf, X, Z)) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(delsq[Z] - test_encode(ENCODE_DELSQ, nf, X, Z)) < double(2.22044604925031308085e-16L)", "test_field_grad.c", 166, __PRETTY_FUNCTION__); 
# 168
field_grad_free(gradient); 
# 169
field_free(field); 
...
field_grad_t *gradient = (__null); 
# 197
(pe) ? static_cast< void>(0) : __assert_fail("pe", "test_field_grad.c", 197, __PRETTY_FUNCTION__); 
# 199
cs_create(pe, &cs); 
# 200
cs_init(cs); 
...
# 204
(field) ? static_cast< void>(0) : __assert_fail("field", "test_field_grad.c", 204, __PRETTY_FUNCTION__); 
# 205
field_init(field, 0, le); 
# 207
field_grad_create(pe, field, 4, &gradient); 
# 208
(gradient) ? static_cast< void>(0) : __assert_fail("gradient", "test_field_grad.c", 208, __PRETTY_FUNCTION__); 
# 209
field_grad_set(gradient, test_d2, test_d4); 
# 210
field_grad_compute(gradient); 
...
for (ia = 0; ia < 3; ia++) { 
# 214
(fabs((((grad[ia])[X])[X]) - test_encode(ENCODE_GRAD, nf, ia, XX)) <= ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(grad[ia][X][X] - test_encode(ENCODE_GRAD, nf, ia, XX)) <= double(2.22044604925031308085e-16L)", "test_field_grad.c", 214, __PRETTY_FUNCTION__); 
# 215
(fabs((((grad[ia])[X])[Y]) - test_encode(ENCODE_GRAD, nf, ia, XY)) <= ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(grad[ia][X][Y] - test_encode(ENCODE_GRAD, nf, ia, XY)) <= double(2.22044604925031308085e-16L)", "test_field_grad.c", 215, __PRETTY_FUNCTION__); 
# 216
(fabs((((grad[ia])[X])[Z]) - test_encode(ENCODE_GRAD, nf, ia, XZ)) <= ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(grad[ia][X][Z] - test_encode(ENCODE_GRAD, nf, ia, XZ)) <= double(2.22044604925031308085e-16L)", "test_field_grad.c", 216, __PRETTY_FUNCTION__); 
# 217
(fabs((((grad[ia])[Y])[X]) - test_encode(ENCODE_GRAD, nf, ia, XY)) <= ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(grad[ia][Y][X] - test_encode(ENCODE_GRAD, nf, ia, XY)) <= double(2.22044604925031308085e-16L)", "test_field_grad.c", 217, __PRETTY_FUNCTION__); 
# 218
(fabs((((grad[ia])[Y])[Y]) - test_encode(ENCODE_GRAD, nf, ia, YY)) <= ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(grad[ia][Y][Y] - test_encode(ENCODE_GRAD, nf, ia, YY)) <= double(2.22044604925031308085e-16L)", "test_field_grad.c", 218, __PRETTY_FUNCTION__); 
# 219
(fabs((((grad[ia])[Y])[Z]) - test_encode(ENCODE_GRAD, nf, ia, YZ)) <= ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(grad[ia][Y][Z] - test_encode(ENCODE_GRAD, nf, ia, YZ)) <= double(2.22044604925031308085e-16L)", "test_field_grad.c", 219, __PRETTY_FUNCTION__); 
# 220
(fabs((((grad[ia])[Z])[X]) - test_encode(ENCODE_GRAD, nf, ia, XZ)) <= ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(grad[ia][Z][X] - test_encode(ENCODE_GRAD, nf, ia, XZ)) <= double(2.22044604925031308085e-16L)", "test_field_grad.c", 220, __PRETTY_FUNCTION__); 
# 221
(fabs((((grad[ia])[Z])[Y]) - test_encode(ENCODE_GRAD, nf, ia, YZ)) <= ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(grad[ia][Z][Y] - test_encode(ENCODE_GRAD, nf, ia, YZ)) <= double(2.22044604925031308085e-16L)", "test_field_grad.c", 221, __PRETTY_FUNCTION__); 
# 222
(fabs(((((grad[ia])[Z])[Z]) + (((grad[ia])[X])[X])) + (((grad[ia])[Y])[Y])) <= ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(grad[ia][Z][Z] + grad[ia][X][X] + grad[ia][Y][Y]) <= double(2.22044604925031308085e-16L)", "test_field_grad.c", 222, __PRETTY_FUNCTION__); 
# 223
}  
# 225
field_grad_tensor_delsq(gradient, 1, delsq); 
# 226
(fabs(((delsq[X])[X]) - test_encode(ENCODE_DELSQ, nf, X, XX)) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(delsq[X][X] - test_encode(ENCODE_DELSQ, nf, X, XX)) < double(2.22044604925031308085e-16L)", "test_field_grad.c", 226, __PRETTY_FUNCTION__); 
# 227
(fabs(((delsq[X])[Y]) - test_encode(ENCODE_DELSQ, nf, X, XY)) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(delsq[X][Y] - test_encode(ENCODE_DELSQ, nf, X, XY)) < double(2.22044604925031308085e-16L)", "test_field_grad.c", 227, __PRETTY_FUNCTION__); 
# 228
(fabs(((delsq[X])[Z]) - test_encode(ENCODE_DELSQ, nf, X, XZ)) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(delsq[X][Z] - test_encode(ENCODE_DELSQ, nf, X, XZ)) < double(2.22044604925031308085e-16L)", "test_field_grad.c", 228, __PRETTY_FUNCTION__); 
# 229
(fabs(((delsq[Y])[X]) - test_encode(ENCODE_DELSQ, nf, X, XY)) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(delsq[Y][X] - test_encode(ENCODE_DELSQ, nf, X, XY)) < double(2.22044604925031308085e-16L)", "test_field_grad.c", 229, __PRETTY_FUNCTION__); 
# 230
(fabs(((delsq[Y])[Y]) - test_encode(ENCODE_DELSQ, nf, X, YY)) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(delsq[Y][Y] - test_encode(ENCODE_DELSQ, nf, X, YY)) < double(2.22044604925031308085e-16L)", "test_field_grad.c", 230, __PRETTY_FUNCTION__); 
# 231
(fabs(((delsq[Y])[Z]) - test_encode(ENCODE_DELSQ, nf, X, YZ)) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(delsq[Y][Z] - test_encode(ENCODE_DELSQ, nf, X, YZ)) < double(2.22044604925031308085e-16L)", "test_field_grad.c", 231, __PRETTY_FUNCTION__); 
# 232
(fabs(((delsq[Z])[X]) - test_encode(ENCODE_DELSQ, nf, X, XZ)) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(delsq[Z][X] - test_encode(ENCODE_DELSQ, nf, X, XZ)) < double(2.22044604925031308085e-16L)", "test_field_grad.c", 232, __PRETTY_FUNCTION__); 
# 233
(fabs(((delsq[Z])[Y]) - test_encode(ENCODE_DELSQ, nf, X, YZ)) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(delsq[Z][Y] - test_encode(ENCODE_DELSQ, nf, X, YZ)) < double(2.22044604925031308085e-16L)", "test_field_grad.c", 233, __PRETTY_FUNCTION__); 
# 234
(fabs((((delsq[Z])[Z]) + ((delsq[X])[X])) + ((delsq[Y])[Y])) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(delsq[Z][Z] + delsq[X][X] + delsq[Y][Y]) < double(2.22044604925031308085e-16L)", "test_field_grad.c", 234, __PRETTY_FUNCTION__); 
# 236
field_grad_free(gradient); 
# 237
field_free(field); 
...
field_grad_t *gradient = (__null); 
# 262
(pe) ? static_cast< void>(0) : __assert_fail("pe", "test_field_grad.c", 262, __PRETTY_FUNCTION__); 
# 264
cs_create(pe, &cs); 
# 265
cs_init(cs); 
...
# 269
(field) ? static_cast< void>(0) : __assert_fail("field", "test_field_grad.c", 269, __PRETTY_FUNCTION__); 
# 270
field_init(field, 0, le); 
# 272
field_grad_create(pe, field, 3, &gradient); 
# 273
(gradient) ? static_cast< void>(0) : __assert_fail("gradient", "test_field_grad.c", 273, __PRETTY_FUNCTION__); 
# 275
field_grad_set(gradient, test_d2, __null); 
# 276
...
# 281
(fabs(((dab[X])[X]) - test_encode(ENCODE_DAB, nf, XX, 0)) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(dab[X][X] - test_encode(ENCODE_DAB, nf, XX, 0)) < double(2.22044604925031308085e-16L)", "test_field_grad.c", 281, __PRETTY_FUNCTION__); 
# 282
(fabs(((dab[X])[Y]) - test_encode(ENCODE_DAB, nf, XY, 0)) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(dab[X][Y] - test_encode(ENCODE_DAB, nf, XY, 0)) < double(2.22044604925031308085e-16L)", "test_field_grad.c", 282, __PRETTY_FUNCTION__); 
# 283
(fabs(((dab[X])[Z]) - test_encode(ENCODE_DAB, nf, XZ, 0)) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(dab[X][Z] - test_encode(ENCODE_DAB, nf, XZ, 0)) < double(2.22044604925031308085e-16L)", "test_field_grad.c", 283, __PRETTY_FUNCTION__); 
# 284
(fabs(((dab[Y])[X]) - test_encode(ENCODE_DAB, nf, XY, 0)) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(dab[Y][X] - test_encode(ENCODE_DAB, nf, XY, 0)) < double(2.22044604925031308085e-16L)", "test_field_grad.c", 284, __PRETTY_FUNCTION__); 
# 285
(fabs(((dab[Y])[Y]) - test_encode(ENCODE_DAB, nf, YY, 0)) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(dab[Y][Y] - test_encode(ENCODE_DAB, nf, YY, 0)) < double(2.22044604925031308085e-16L)", "test_field_grad.c", 285, __PRETTY_FUNCTION__); 
# 286
(fabs(((dab[Y])[Z]) - test_encode(ENCODE_DAB, nf, YZ, 0)) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(dab[Y][Z] - test_encode(ENCODE_DAB, nf, YZ, 0)) < double(2.22044604925031308085e-16L)", "test_field_grad.c", 286, __PRETTY_FUNCTION__); 
# 287
(fabs(((dab[Z])[X]) - test_encode(ENCODE_DAB, nf, XZ, 0)) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(dab[Z][X] - test_encode(ENCODE_DAB, nf, XZ, 0)) < double(2.22044604925031308085e-16L)", "test_field_grad.c", 287, __PRETTY_FUNCTION__); 
# 288
(fabs(((dab[Z])[Y]) - test_encode(ENCODE_DAB, nf, YZ, 0)) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(dab[Z][Y] - test_encode(ENCODE_DAB, nf, YZ, 0)) < double(2.22044604925031308085e-16L)", "test_field_grad.c", 288, __PRETTY_FUNCTION__); 
# 289
(fabs(((dab[Z])[Z]) - test_encode(ENCODE_DAB, nf, ZZ, 0)) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(dab[Z][Z] - test_encode(ENCODE_DAB, nf, ZZ, 0)) < double(2.22044604925031308085e-16L)", "test_field_grad.c", 289, __PRETTY_FUNCTION__); 
# 293
field_grad_free(gradient); 
# 294
field_free(field); 
...
int index = 1; 
# 314
(fg) ? static_cast< void>(0) : __assert_fail("fg", "test_field_grad.c", 314, __PRETTY_FUNCTION__); 
# 316
...
for (n = 0; n < nf; n++) { 
# 320
((fg->grad)[mem_addr_rank2(nsites, nf, 3, index, n, X)]) = test_encode(ENCODE_GRAD, nf, X, n); 
# 321
((fg->grad)[mem_addr_rank2(nsites, nf, 3, index, n, Y)]) = test_encode(ENCODE_GRAD, nf, Y, n); 
# 322
((fg->grad)[mem_addr_rank2(nsites, nf, 3, index, n, Z)]) = test_encode(ENCODE_GRAD, nf, Z, n); 
# 323
...
int index0 = 1; 
# 341
(fg) ? static_cast< void>(0) : __assert_fail("fg", "test_field_grad.c", 341, __PRETTY_FUNCTION__); 
# 343
field_nf(fg->field, &nf); 
# 345
for (n = 0; n < nf; n++) { 
# 346
index = mem_addr_rank2(fg->nsite, nf, 3, index0, n, X); 
# 347
((fg->grad_delsq)[index]) = test_encode(ENCODE_GRAD4, nf, X, n); 
# 348
index = mem_addr_rank2(fg->nsite, nf, 3, index0, n, Y); 
# 349
((fg->grad_delsq)[index]) = test_encode(ENCODE_GRAD4, nf, Y, n); 
# 350
index = mem_addr_rank2(fg->nsite, nf, 3, index0, n, Z); 
# 351
...
double result; 
# 369
result = (((1.0) * code) + ((0.1000000000000000056) * ((n * nf) + iv))); 
# 371
return result; 
# 372
} 
...
int index = 1; 
# 385
(fg) ? static_cast< void>(0) : __assert_fail("fg", "test_field_grad.c", 385, __PRETTY_FUNCTION__); 
# 387
field_nf(fg->field, &nf); 
# 388
ns = ((fg->field)->nsites); 
# 390
(nf == 1) ? static_cast< void>(0) : __assert_fail("nf == 1", "test_field_grad.c", 390, __PRETTY_FUNCTION__); 
# 392
for (n = 0; n < nf; n++) { 
# 393
((fg->d_ab)[mem_addr_rank1(ns, 6, index, XX)]) = test_encode(ENCODE_DAB, nf, XX, n); 
# 394
((fg->d_ab)[mem_addr_rank1(ns, 6, index, XY)]) = test_encode(ENCODE_DAB, nf, XY, n); 
# 395
((fg->d_ab)[mem_addr_rank1(ns, 6, index, XZ)]) = test_encode(ENCODE_DAB, nf, XZ, n); 
# 396
((fg->d_ab)[mem_addr_rank1(ns, 6, index, YY)]) = test_encode(ENCODE_DAB, nf, YY, n); 
# 397
((fg->d_ab)[mem_addr_rank1(ns, 6, index, YZ)]) = test_encode(ENCODE_DAB, nf, YZ, n); 
# 398
((fg->d_ab)[mem_addr_rank1(ns, 6, index, ZZ)]) = test_encode(ENCODE_DAB, nf, ZZ, n); 
# 399
}  
# 401
return 0; 
...
# 1 "test_field_grad.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__23_test_field_grad_cpp1_ii_37bce1e7
# 1 "test_field_grad.cudafe1.stub.c"
#include "test_field_grad.cudafe1.stub.c"
# 1 "test_field_grad.cudafe1.stub.c"
