...
# 31 "psi_force.c"
int psi_force_gradmu_e(psi_t * psi, fe_t * fe, hydro_t * hydro, colloids_info_t * cinfo); 
# 33
int psi_force_gradmu_es(psi_t * psi, fe_t * fe, field_t * phi, hydro_t * hydro, colloids_info_t * cinfo); 
# 45 "psi_force.c"
int psi_force_gradmu(psi_t *psi, fe_t *fe, field_t *phi, hydro_t *
# 46
hydro, map_t *
# 47
map, colloids_info_t *cinfo) { 
# 49
(fe) ? static_cast< void>(0) : __assert_fail("fe", "psi_force.c", 49, __PRETTY_FUNCTION__); 
# 51
switch (fe->id) { 
# 52
case FE_ELECTRO:  
...
# 77 "psi_force.c"
int psi_force_gradmu_e(psi_t *psi, fe_t *fe, hydro_t *hydro, colloids_info_t *
# 78
cinfo) { 
# 80
int ic, jc, kc; 
...
colloid_t *pc = (__null); 
# 98
(fe) ? static_cast< void>(0) : __assert_fail("fe", "psi_force.c", 98, __PRETTY_FUNCTION__); 
# 99
(psi) ? static_cast< void>(0) : __assert_fail("psi", "psi_force.c", 99, __PRETTY_FUNCTION__); 
# 100
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "psi_force.c", 100, __PRETTY_FUNCTION__); 
# 102
...
# 196 "psi_force.c"
int psi_force_gradmu_es(psi_t *psi, fe_t *fe, field_t *phi, hydro_t *hydro, colloids_info_t *
# 197
cinfo) { 
# 199
int ic, jc, kc; 
...
colloid_t *pc = (__null); 
# 220
(fe) ? static_cast< void>(0) : __assert_fail("fe", "psi_force.c", 220, __PRETTY_FUNCTION__); 
# 221
(psi) ? static_cast< void>(0) : __assert_fail("psi", "psi_force.c", 221, __PRETTY_FUNCTION__); 
# 222
(phi) ? static_cast< void>(0) : __assert_fail("phi", "psi_force.c", 222, __PRETTY_FUNCTION__); 
# 223
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "psi_force.c", 223, __PRETTY_FUNCTION__); 
# 225
cs_nlocal(psi->cs, nlocal); 
# 226
cs_strides(psi->cs, &xs, &ys, &zs); 
...
psi_nk(psi, &nk); 
# 235
(nk == 2) ? static_cast< void>(0) : __assert_fail("nk == 2", "psi_force.c", 235, __PRETTY_FUNCTION__); 
# 237
for (ic = 1; ic <= (nlocal[X]); ic++) { 
# 238
for (jc = 1; jc <= (nlocal[Y]); jc++) { 
...
# 375 "psi_force.c"
int psi_force_divstress(psi_t *psi, fe_t *fe, hydro_t *hydro, colloids_info_t *
# 376
cinfo) { 
# 378
int ic, jc, kc; 
...
colloid_t *pc = (__null); 
# 388
(psi) ? static_cast< void>(0) : __assert_fail("psi", "psi_force.c", 388, __PRETTY_FUNCTION__); 
# 389
(fe) ? static_cast< void>(0) : __assert_fail("fe", "psi_force.c", 389, __PRETTY_FUNCTION__); 
# 390
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "psi_force.c", 390, __PRETTY_FUNCTION__); 
# 392
cs_nlocal(psi->cs, nlocal); 
# 394
(0) ? static_cast< void>(0) : __assert_fail("0", "psi_force.c", 394, __PRETTY_FUNCTION__); 
# 396
for (ic = 1; ic <= (nlocal[X]); ic++) { 
# 397
for (jc = 1; jc <= (nlocal[Y]); jc++) { 
...
# 472 "psi_force.c"
int psi_force_divstress_d3qx(psi_t *psi, fe_t *fe, hydro_t *hydro, map_t *
# 473
map, colloids_info_t *cinfo) { 
# 475
int ic, jc, kc; 
...
# 489
(psi) ? static_cast< void>(0) : __assert_fail("psi", "psi_force.c", 489, __PRETTY_FUNCTION__); 
# 490
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "psi_force.c", 490, __PRETTY_FUNCTION__); 
# 492
cs_nlocal(psi->cs, nlocal); 
# 494
for (ic = 1; ic <= (nlocal[X]); ic++) { 
...
colloid_t *pc = (__null); 
# 582
(psi) ? static_cast< void>(0) : __assert_fail("psi", "psi_force.c", 582, __PRETTY_FUNCTION__); 
# 583
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "psi_force.c", 583, __PRETTY_FUNCTION__); 
# 585
cs_nlocal(psi->cs, nlocal); 
# 587
(0) ? static_cast< void>(0) : __assert_fail("0", "psi_force.c", 587, __PRETTY_FUNCTION__); 
# 589
for (ic = 1; ic <= (nlocal[X]); ic++) { 
# 590
for (jc = 1; jc <= (nlocal[Y]); jc++) { 
...
for (ib = 0; ib < 3; ib++) { 
# 670
(force[ia]) -= (((((psi_gr_wv[p]) * psi_gr_rcs2) * ((((3.0) * ((pth[ia])[ib])) - ((4.0) * ((pth1[ia])[ib]))) + ((1.0) * ((pth2[ia])[ib])))) * (psi_gr_rnorm[p])) * ((psi_gr_cv[p])[ib])); 
# 673
}  
# 674
}  
...
# 1 "psi_force.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__17_psi_force_cpp1_ii_f1dc9685
# 1 "psi_force.cudafe1.stub.c"
#include "psi_force.cudafe1.stub.c"
# 1 "psi_force.cudafe1.stub.c"
