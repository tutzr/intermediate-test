...
# 84
colloid_halo_t *halo = (__null); 
# 86
(pe) ? static_cast< void>(0) : __assert_fail("pe", "test_colloids_halo.c", 86, __PRETTY_FUNCTION__); 
# 87
(cs) ? static_cast< void>(0) : __assert_fail("cs", "test_colloids_halo.c", 87, __PRETTY_FUNCTION__); 
# 89
cs_lmin(cs, lmin); 
# 90
cs_ntotal(cs, ntotal); 
...
# 94
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "test_colloids_halo.c", 94, __PRETTY_FUNCTION__); 
# 96
colloids_halo_create(cinfo, &halo); 
# 97
(halo) ? static_cast< void>(0) : __assert_fail("halo", "test_colloids_halo.c", 97, __PRETTY_FUNCTION__); 
# 99
...
# 107
(pc) ? static_cast< void>(0) : __assert_fail("pc", "test_colloids_halo.c", 107, __PRETTY_FUNCTION__); 
# 109
colloids_halo_send_count(halo, X, ncount); 
# 110
test_assert_info((ncount[FORWARD]) == 0, 110, "test_colloids_halo.c"); 
# 111
test_assert_info((ncount[BACKWARD]) == 1, 111, "test_colloids_halo.c"); 
# 113
colloids_halo_send_count(halo, Y, ncount); 
# 114
test_assert_info((ncount[FORWARD]) == 0, 114, "test_colloids_halo.c"); 
# 115
test_assert_info((ncount[BACKWARD]) == 1, 115, "test_colloids_halo.c"); 
# 117
colloids_halo_send_count(halo, Z, ncount); 
# 118
test_assert_info((ncount[FORWARD]) == 0, 118, "test_colloids_halo.c"); 
# 119
test_assert_info((ncount[BACKWARD]) == 1, 119, "test_colloids_halo.c"); 
# 121
colloids_halo_dim(halo, X); 
# 126
colloids_info_cell_count(cinfo, (ncell[X]) + 1, 1, 1, &ncolloid); 
# 127
test_assert_info(ncolloid == 1, 127, "test_colloids_halo.c"); 
# 129
colloids_info_nlocal(cinfo, &ncolloid); 
# 130
test_assert_info(ncolloid == 1, 130, "test_colloids_halo.c"); 
# 132
colloids_info_nallocated(cinfo, &ncolloid); 
# 133
test_assert_info(ncolloid == 2, 133, "test_colloids_halo.c"); 
# 135
colloids_info_cell_list_head(cinfo, (ncell[X]) + 1, 1, 1, &pc); 
# 136
test_assert_info(pc != (__null), 136, "test_colloids_halo.c"); 
# 139
...
colloids_halo_send_count(halo, Y, ncount); 
# 147
test_assert_info((ncount[FORWARD]) == 0, 147, "test_colloids_halo.c"); 
# 148
test_assert_info((ncount[BACKWARD]) == 2, 148, "test_colloids_halo.c"); 
# 150
colloids_halo_dim(halo, Y); 
# 155
colloids_info_cell_count(cinfo, 1, (ncell[Y]) + 1, 1, &ncolloid); 
# 156
test_assert_info(ncolloid == 1, 156, "test_colloids_halo.c"); 
# 158
colloids_info_cell_count(cinfo, (ncell[X]) + 1, (ncell[Y]) + 1, 1, &ncolloid); 
# 159
test_assert_info(ncolloid == 1, 159, "test_colloids_halo.c"); 
# 161
colloids_info_nlocal(cinfo, &ncolloid); 
# 162
test_assert_info(ncolloid == 1, 162, "test_colloids_halo.c"); 
# 164
colloids_info_nallocated(cinfo, &ncolloid); 
# 165
test_assert_info(ncolloid == 4, 165, "test_colloids_halo.c"); 
# 167
colloids_info_cell_list_head(cinfo, 1, (ncell[Y]) + 1, 1, &pc); 
# 168
test_assert_info(pc != (__null), 168, "test_colloids_halo.c"); 
# 171
(r1[X]) = (r0[X]); 
# 172
...
colloids_halo_send_count(halo, Z, ncount); 
# 178
test_assert_info((ncount[FORWARD]) == 0, 178, "test_colloids_halo.c"); 
# 179
test_assert_info((ncount[BACKWARD]) == 4, 179, "test_colloids_halo.c"); 
# 181
colloids_halo_dim(halo, Z); 
# 186
colloids_info_cell_count(cinfo, 1, 1, (ncell[Z]) + 1, &ncolloid); 
# 187
test_assert_info(ncolloid == 1, 187, "test_colloids_halo.c"); 
# 189
colloids_info_cell_count(cinfo, (ncell[X]) + 1, 1, (ncell[Z]) + 1, &ncolloid); 
# 190
test_assert_info(ncolloid == 1, 190, "test_colloids_halo.c"); 
# 192
colloids_info_cell_count(cinfo, 1, (ncell[Y]) + 1, (ncell[Z]) + 1, &ncolloid); 
# 193
test_assert_info(ncolloid == 1, 193, "test_colloids_halo.c"); 
# 195
colloids_info_cell_count(cinfo, (ncell[X]) + 1, (ncell[Y]) + 1, (ncell[Z]) + 1, &ncolloid); 
# 197
test_assert_info(ncolloid == 1, 197, "test_colloids_halo.c"); 
# 199
colloids_info_nlocal(cinfo, &ncolloid); 
# 200
test_assert_info(ncolloid == 1, 200, "test_colloids_halo.c"); 
# 202
colloids_info_nallocated(cinfo, &ncolloid); 
# 203
test_assert_info(ncolloid == 8, 203, "test_colloids_halo.c"); 
# 205
...
colloids_info_t *cinfo = (__null); 
# 237
(pe) ? static_cast< void>(0) : __assert_fail("pe", "test_colloids_halo.c", 237, __PRETTY_FUNCTION__); 
# 238
(cs) ? static_cast< void>(0) : __assert_fail("cs", "test_colloids_halo.c", 238, __PRETTY_FUNCTION__); 
# 240
cs_lmin(cs, lmin); 
# 241
cs_ntotal(cs, ntotal); 
...
colloids_info_create(pe, cs, ncell, &cinfo); 
# 245
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "test_colloids_halo.c", 245, __PRETTY_FUNCTION__); 
# 247
colloids_halo_create(cinfo, &halo); 
# 248
(halo) ? static_cast< void>(0) : __assert_fail("halo", "test_colloids_halo.c", 248, __PRETTY_FUNCTION__); 
# 250
cs_nlocal_offset(cs, noffset); 
# 251
...
colloids_info_add_local(cinfo, index, r0, &pc); 
# 259
(pc) ? static_cast< void>(0) : __assert_fail("pc", "test_colloids_halo.c", 259, __PRETTY_FUNCTION__); 
# 261
colloids_halo_send_count(halo, X, ncount); 
# 262
test_assert_info((ncount[FORWARD]) == 1, 262, "test_colloids_halo.c"); 
# 263
test_assert_info((ncount[BACKWARD]) == 0, 263, "test_colloids_halo.c"); 
# 265
colloids_halo_send_count(halo, Y, ncount); 
# 266
test_assert_info((ncount[FORWARD]) == 0, 266, "test_colloids_halo.c"); 
# 267
test_assert_info((ncount[BACKWARD]) == 1, 267, "test_colloids_halo.c"); 
# 269
colloids_halo_send_count(halo, Z, ncount); 
# 270
test_assert_info((ncount[FORWARD]) == 0, 270, "test_colloids_halo.c"); 
# 271
test_assert_info((ncount[BACKWARD]) == 1, 271, "test_colloids_halo.c"); 
# 273
colloids_halo_dim(halo, X); 
# 278
colloids_info_cell_count(cinfo, 0, 1, 1, &ncolloid); 
# 279
test_assert_info(ncolloid == 1, 279, "test_colloids_halo.c"); 
# 281
colloids_info_nlocal(cinfo, &ncolloid); 
# 282
test_assert_info(ncolloid == 1, 282, "test_colloids_halo.c"); 
# 284
colloids_info_nallocated(cinfo, &ncolloid); 
# 285
test_assert_info(ncolloid == 2, 285, "test_colloids_halo.c"); 
# 287
colloids_info_cell_list_head(cinfo, 0, 1, 1, &pc); 
# 288
test_assert_info(pc != (__null), 288, "test_colloids_halo.c"); 
# 290
(r1[X]) = ((r0[X]) - (((1.0) * (ntotal[X])) / (mpi_cartsz[X]))); 
# 291
(r1[Y]) = (r0[Y]); 
...
colloids_halo_send_count(halo, Y, ncount); 
# 296
test_assert_info((ncount[FORWARD]) == 0, 296, "test_colloids_halo.c"); 
# 297
test_assert_info((ncount[BACKWARD]) == 2, 297, "test_colloids_halo.c"); 
# 299
colloids_halo_dim(halo, Y); 
# 304
colloids_info_cell_count(cinfo, 2, (ncell[Y]) + 1, 1, &ncolloid); 
# 305
test_assert_info(ncolloid == 1, 305, "test_colloids_halo.c"); 
# 307
colloids_info_cell_count(cinfo, 0, (ncell[Y]) + 1, 1, &ncolloid); 
# 308
test_assert_info(ncolloid == 1, 308, "test_colloids_halo.c"); 
# 310
colloids_info_nlocal(cinfo, &ncolloid); 
# 311
test_assert_info(ncolloid == 1, 311, "test_colloids_halo.c"); 
# 313
colloids_info_nallocated(cinfo, &ncolloid); 
# 314
test_assert_info(ncolloid == 4, 314, "test_colloids_halo.c"); 
# 316
colloids_info_cell_list_head(cinfo, 2, (ncell[Y]) + 1, 1, &pc); 
# 317
test_assert_info(pc != (__null), 317, "test_colloids_halo.c"); 
# 319
(r1[X]) = (r0[X]); 
# 320
(r1[Y]) = ((r0[Y]) + (((1.0) * (ntotal[Y])) / (mpi_cartsz[Y]))); 
...
colloids_halo_send_count(halo, Z, ncount); 
# 325
test_assert_info((ncount[FORWARD]) == 0, 325, "test_colloids_halo.c"); 
# 326
test_assert_info((ncount[BACKWARD]) == 4, 326, "test_colloids_halo.c"); 
# 328
colloids_halo_dim(halo, Z); 
# 332
colloids_info_cell_count(cinfo, 2, 1, (ncell[Z]) + 1, &ncolloid); 
# 333
test_assert_info(ncolloid == 1, 333, "test_colloids_halo.c"); 
# 335
colloids_info_cell_count(cinfo, 0, 1, (ncell[Z]) + 1, &ncolloid); 
# 336
test_assert_info(ncolloid == 1, 336, "test_colloids_halo.c"); 
# 338
colloids_info_cell_count(cinfo, 2, (ncell[Y]) + 1, (ncell[Z]) + 1, &ncolloid); 
# 339
test_assert_info(ncolloid == 1, 339, "test_colloids_halo.c"); 
# 341
colloids_info_cell_count(cinfo, 0, (ncell[Y]) + 1, (ncell[Z]) + 1, &ncolloid); 
# 342
test_assert_info(ncolloid == 1, 342, "test_colloids_halo.c"); 
# 344
colloids_info_nlocal(cinfo, &ncolloid); 
# 345
test_assert_info(ncolloid == 1, 345, "test_colloids_halo.c"); 
# 347
colloids_info_nallocated(cinfo, &ncolloid); 
# 348
test_assert_info(ncolloid == 8, 348, "test_colloids_halo.c"); 
# 350
colloids_halo_free(halo); 
# 351
colloids_info_free(cinfo); 
...
colloids_info_t *cinfo = (__null); 
# 376
(pe) ? static_cast< void>(0) : __assert_fail("pe", "test_colloids_halo.c", 376, __PRETTY_FUNCTION__); 
# 377
(cs) ? static_cast< void>(0) : __assert_fail("cs", "test_colloids_halo.c", 377, __PRETTY_FUNCTION__); 
# 379
cs_lmin(cs, lmin); 
# 381
colloids_info_create(pe, cs, ncell, &cinfo); 
# 382
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "test_colloids_halo.c", 382, __PRETTY_FUNCTION__); 
# 384
cs_nlocal_offset(cs, noffset); 
# 386
(r0[X]) = ((lmin[X]) + ((1.0) * ((noffset[X]) + 1))); 
...
colloids_info_add_local(cinfo, index, r0, &pc); 
# 392
(pc) ? static_cast< void>(0) : __assert_fail("pc", "test_colloids_halo.c", 392, __PRETTY_FUNCTION__); 
# 394
...
colloids_info_nlocal(cinfo, &ncolloid); 
# 403
test_assert_info(ncolloid == 3, 403, "test_colloids_halo.c"); 
# 405
colloids_info_nallocated(cinfo, &ncolloid); 
# 406
test_assert_info(ncolloid == 24, 406, "test_colloids_halo.c"); 
# 408
colloids_info_free(cinfo); 
# 410
return 0; 
...
double ltot[3]; 
# 428
(cs) ? static_cast< void>(0) : __assert_fail("cs", "test_colloids_halo.c", 428, __PRETTY_FUNCTION__); 
# 429
cs_ltot(cs, ltot); 
# 431
tolerance = ((((1.0) + ((double)(2.2204460492503130808e-16L))) * ((double)(2.2204460492503130808e-16L))) * (ltot[X])); 
# 432
test_assert_info(fabs((r1[X]) - (r2[X])) < tolerance, 432, "test_colloids_halo.c"); 
# 433
tolerance = ((((1.0) + ((double)(2.2204460492503130808e-16L))) * ((double)(2.2204460492503130808e-16L))) * (ltot[Y])); 
# 434
test_assert_info(fabs((r1[Y]) - (r2[Y])) < tolerance, 434, "test_colloids_halo.c"); 
# 435
tolerance = ((((1.0) + ((double)(2.2204460492503130808e-16L))) * ((double)(2.2204460492503130808e-16L))) * (ltot[Z])); 
# 436
test_assert_info(fabs((r1[Z]) - (r2[Z])) < tolerance, 436, "test_colloids_halo.c"); 
# 439
} 

# 1 "test_colloids_halo.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__26_test_colloids_halo_cpp1_ii_13f1ed8b
# 1 "test_colloids_halo.cudafe1.stub.c"
#include "test_colloids_halo.cudafe1.stub.c"
# 1 "test_colloids_halo.cudafe1.stub.c"
