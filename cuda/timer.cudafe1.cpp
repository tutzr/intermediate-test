...
# 39
static pe_t *pe_stat = (__null); 
# 40
static timer_struct timer[TIMER_NTIMERS]; 
# 42
static const char *timer_name[] = {("Total"), ("Time step loop"), ("Propagation"), ("Propagtn (krnl) "), ("Collision"), ("Collision (krnl) "), ("Lattice halos"), ("phi gradients"), ("phi grad (krnl) "), ("phi halos"), ("Lees Edwards BC"), ("I/O"), ("Forces"), ("Rebuild"), ("BBL"), ("Particle updates"), ("Particle halos"), ("Fluctuations"), ("Ewald Sum total"), ("Ewald Real"), ("Ewald_Fourier"), ("Force calculation"), ("Chem stress (krnl) "), ("Phi force (krnl) "), ("phi update"), ("Velocity Halo "), ("BE mol field (krnl) "), ("BP BE update (krnl) "), ("Advectn (krnl) "), ("Advectn BCS (krnl) "), ("BP BE alloc/free "), ("Electrokinetics"), ("Poisson equation"), ("Nernst Planck"), ("Free1"), ("Free2"), ("Free3")}; 
# 90 "timer.c"
int TIMER_init(pe_t *pe) { 
# 92
int n; 
...
((timer[n]).t_sum) = (0.0); 
# 98
((timer[n]).t_max) = ((1.175494351e-38F)); 
# 99
((timer[n]).t_min) = ((3.402823466e+38F)); 
# 100
((timer[n]).active) = (0); 
# 101
((timer[n]).nsteps) = (0); 
...
MPI_Comm comm; 
# 167
(pe_stat) ? static_cast< void>(0) : __assert_fail("pe_stat", "timer.c", 167, __PRETTY_FUNCTION__); 
# 168
r = MPI_Wtick(); 
# 170
...
# 191
pe_info(pe_stat, "%20s: %10.3f %10.3f %10.3f %10.6f", timer_name[n], t_min, t_max, t_sum, t_sum / ((double)((timer[n]).nsteps))); 
# 193
...
# 1 "timer.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__13_timer_cpp1_ii_0a9b91ca
# 1 "timer.cudafe1.stub.c"
#include "timer.cudafe1.stub.c"
# 1 "timer.cudafe1.stub.c"
