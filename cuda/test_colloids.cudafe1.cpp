...
# 92
(pe) ? static_cast< void>(0) : __assert_fail("pe", "test_colloids.c", 92, __PRETTY_FUNCTION__); 
# 93
(cs) ? static_cast< void>(0) : __assert_fail("cs", "test_colloids.c", 93, __PRETTY_FUNCTION__); 
# 95
cs_ltot(cs, ltot); 
# 96
...
# 99
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "test_colloids.c", 99, __PRETTY_FUNCTION__); 
# 101
colloids_info_ncell(cinfo, ncell); 
# 103
test_assert_info((ncell[X]) == (ncellref[X]), 103, "test_colloids.c"); 
# 104
test_assert_info((ncell[Y]) == (ncellref[Y]), 104, "test_colloids.c"); 
# 105
test_assert_info((ncell[Z]) == (ncellref[Z]), 105, "test_colloids.c"); 
# 107
...
# 111
test_assert_info(fabs((lcell[ia]) - lcellref) < (9.999999999999999988e-15), 111, "test_colloids.c"); 
# 112
}  
# 116
...
double lmin[3]; 
# 140
colloid_t *pcref = (__null); 
# 141
colloid_t *pc = (__null); 
# 143
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "test_colloids.c", 143, __PRETTY_FUNCTION__); 
# 145
...
# 157
test_assert_info(pcref == (__null), 157, "test_colloids.c"); 
# 161
(r[X]) = ((lmin[X]) + ((1.0) * ((noffset[X]) + 1))); 
# 162
(r[Y]) = ((lmin[Y]) + ((1.0) * ((noffset[Y]) + 1))); 
...
colloids_info_add_local(cinfo, index, r, &pcref); 
# 166
test_assert_info(pcref != (__null), 166, "test_colloids.c"); 
# 167
colloids_info_nlocal(cinfo, &ncolloid); 
# 168
test_assert_info(ncolloid == 1, 168, "test_colloids.c"); 
# 170
...
# 178
test_assert_info(ncount == 1, 178, "test_colloids.c"); 
# 180
colloids_info_cell_list_head(cinfo, icell[X], icell[Y], icell[Z], &pc); 
# 181
test_assert_info(pc == pcref, 181, "test_colloids.c"); 
# 183
return 0; 
# 184
} 
...
double lmin[3]; 
# 201
double delta = ((1.192092896e-07F)); 
# 203
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "test_colloids.c", 203, __PRETTY_FUNCTION__); 
# 205
...
colloids_info_cell_coords(cinfo, r, icell); 
# 220
test_assert_info((icell[X]) == 1, 220, "test_colloids.c"); 
# 221
test_assert_info((icell[Y]) == 1, 221, "test_colloids.c"); 
# 222
test_assert_info((icell[Z]) == 1, 222, "test_colloids.c"); 
# 226
(r[X]) -= (lcell[X]); 
# 227
(r[Y]) -= (lcell[Y]); 
...
colloids_info_cell_coords(cinfo, r, icell); 
# 232
test_assert_info((icell[X]) == 0, 232, "test_colloids.c"); 
# 233
test_assert_info((icell[Y]) == 0, 233, "test_colloids.c"); 
# 234
test_assert_info((icell[Z]) == 0, 234, "test_colloids.c"); 
# 238
(r[X]) += ((2.0) * (lcell[X])); 
# 239
(r[Y]) += ((2.0) * (lcell[Y])); 
...
colloids_info_cell_coords(cinfo, r, icell); 
# 244
test_assert_info((icell[X]) == 2, 244, "test_colloids.c"); 
# 245
test_assert_info((icell[Y]) == 2, 245, "test_colloids.c"); 
# 246
test_assert_info((icell[Z]) == 2, 246, "test_colloids.c"); 
# 251
(r[X]) -= delta; 
# 252
(r[Y]) -= delta; 
...
colloids_info_cell_coords(cinfo, r, icell); 
# 257
test_assert_info((icell[X]) == 1, 257, "test_colloids.c"); 
# 258
test_assert_info((icell[Y]) == 1, 258, "test_colloids.c"); 
# 259
test_assert_info((icell[Z]) == 1, 259, "test_colloids.c"); 
# 264
(r[X]) += ((1.0) * (nlocal[X])); 
# 265
(r[Y]) += ((1.0) * (nlocal[Y])); 
...
colloids_info_cell_coords(cinfo, r, icell); 
# 271
test_assert_info((icell[X]) == ((ncell[X]) + 1), 271, "test_colloids.c"); 
# 272
test_assert_info((icell[Y]) == ((ncell[Y]) + 1), 272, "test_colloids.c"); 
# 273
test_assert_info((icell[Z]) == ((ncell[Z]) + 1), 273, "test_colloids.c"); 
# 275
return 0; 
# 276
} 

# 1 "test_colloids.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__21_test_colloids_cpp1_ii_b65ae358
# 1 "test_colloids.cudafe1.stub.c"
#include "test_colloids.cudafe1.stub.c"
# 1 "test_colloids.cudafe1.stub.c"
