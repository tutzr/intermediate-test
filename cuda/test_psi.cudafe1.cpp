...
psi_t *psi; 
# 85
(pe) ? static_cast< void>(0) : __assert_fail("pe", "test_psi.c", 85, __PRETTY_FUNCTION__); 
# 87
cs_create(pe, &cs); 
# 88
cs_init(cs); 
...
# 92
(psi) ? static_cast< void>(0) : __assert_fail("psi", "test_psi.c", 92, __PRETTY_FUNCTION__); 
# 93
psi_nk(psi, &n); 
# 94
test_assert_info(n == 3, 94, "test_psi.c"); 
# 96
for (n = 0; n < nk; n++) { 
# 97
...
# 99
test_assert_info(iv == (valency[n]), 99, "test_psi.c"); 
# 100
psi_diffusivity_set(psi, n, diffusivity[n]); 
# 101
psi_diffusivity(psi, n, &diff); 
# 102
test_assert_info(fabs(diff - (diffusivity[n])) < ((double)(2.2204460492503130808e-16L)), 102, "test_psi.c"); 
# 103
}  
# 105
psi_unit_charge(psi, &e); 
# 106
test_assert_info(fabs(e - (1.0)) < ((double)(2.2204460492503130808e-16L)), 106, "test_psi.c"); 
# 107
psi_unit_charge_set(psi, eunit); 
# 108
psi_unit_charge(psi, &e); 
# 109
test_assert_info(fabs(eunit - e) < ((double)(2.2204460492503130808e-16L)), 109, "test_psi.c"); 
# 111
psi_free(psi); 
# 112
cs_free(cs); 
...
psi_t *psi = (__null); 
# 138
(pe) ? static_cast< void>(0) : __assert_fail("pe", "test_psi.c", 138, __PRETTY_FUNCTION__); 
# 140
cs_create(pe, &cs); 
# 141
cs_init(cs); 
...
psi_create(pe, cs, nk, &psi); 
# 144
(psi) ? static_cast< void>(0) : __assert_fail("psi", "test_psi.c", 144, __PRETTY_FUNCTION__); 
# 145
psi_nk(psi, &n); 
# 146
test_assert_info(n == 2, 146, "test_psi.c"); 
# 148
for (n = 0; n < nk; n++) { 
# 149
psi_valency_set(psi, n, valency[n]); 
...
psi_valency(psi, n, &iv); 
# 151
test_assert_info(iv == (valency[n]), 151, "test_psi.c"); 
# 152
psi_diffusivity_set(psi, n, diffusivity[n]); 
# 153
psi_diffusivity(psi, n, &diff); 
# 154
test_assert_info(fabs(diff - (diffusivity[n])) < ((double)(2.2204460492503130808e-16L)), 154, "test_psi.c"); 
# 155
}  
# 157
index = 1; 
...
# 161
test_assert_info(fabs(value - ref) < ((double)(2.2204460492503130808e-16L)), 161, "test_psi.c"); 
# 163
for (n = 0; n < nk; n++) { 
# 164
ref = ((1.0) + n); 
...
# 167
test_assert_info(fabs(value - ref) < ((double)(2.2204460492503130808e-16L)), 167, "test_psi.c"); 
# 168
}  
# 170
ref = ((1.0) + (4.0)); 
...
# 172
test_assert_info(fabs(value - ref) < ((double)(2.2204460492503130808e-16L)), 172, "test_psi.c"); 
# 174
psi_free(psi); 
# 175
cs_free(cs); 
...
psi_t *psi = (__null); 
# 196
(pe) ? static_cast< void>(0) : __assert_fail("pe", "test_psi.c", 196, __PRETTY_FUNCTION__); 
# 198
cs_create(pe, &cs); 
# 199
...
psi_create(pe, cs, nk, &psi); 
# 204
(psi) ? static_cast< void>(0) : __assert_fail("psi", "test_psi.c", 204, __PRETTY_FUNCTION__); 
# 206
...
psi_t *psi; 
# 240
(pe) ? static_cast< void>(0) : __assert_fail("pe", "test_psi.c", 240, __PRETTY_FUNCTION__); 
# 245
(grid[0]) = 1; 
# 246
...
psi_create(pe, cs, nk, &psi); 
# 256
(psi) ? static_cast< void>(0) : __assert_fail("psi", "test_psi.c", 256, __PRETTY_FUNCTION__); 
# 258
test_coords_field_set(cs, 1, psi->psi, MPI_DOUBLE, test_ref_double1); 
# 259
psi_halo_psi(psi); 
...
MPI_Comm comm; 
# 293
(pe) ? static_cast< void>(0) : __assert_fail("pe", "test_psi.c", 293, __PRETTY_FUNCTION__); 
# 295
cs_create(pe, &cs); 
# 296
cs_init(cs); 
...
psi_create(pe, cs, nk, &psi); 
# 307
(psi) ? static_cast< void>(0) : __assert_fail("psi", "test_psi.c", 307, __PRETTY_FUNCTION__); 
# 308
...
# 314
(iohandler) ? static_cast< void>(0) : __assert_fail("iohandler", "test_psi.c", 314, __PRETTY_FUNCTION__); 
# 315
...
psi_io_info(psi, &iohandler); 
# 327
(iohandler) ? static_cast< void>(0) : __assert_fail("iohandler", "test_psi.c", 327, __PRETTY_FUNCTION__); 
# 328
...
double eref = (1.0); 
# 370
double epsilonref = ((41.39999999999999858) * (1000.0)); 
# 371
double ktref = (1.000000000000000082e-05); 
# 372
...
# 377
(pe) ? static_cast< void>(0) : __assert_fail("pe", "test_psi.c", 377, __PRETTY_FUNCTION__); 
# 379
cs_create(pe, &cs); 
# 380
cs_init(cs); 
...
psi_beta(psi, &tmp); 
# 385
test_assert_info(fabs(((1.0) / ktref) - tmp) < ((double)(2.2204460492503130808e-16L)), 385, "test_psi.c"); 
# 387
psi_epsilon_set(psi, epsilonref); 
# 388
psi_epsilon(psi, &tmp); 
# 389
test_assert_info(fabs(tmp - epsilonref) < ((double)(2.2204460492503130808e-16L)), 389, "test_psi.c"); 
# 391
psi_unit_charge_set(psi, eref); 
# 392
psi_unit_charge(psi, &tmp); 
# 393
test_assert_info(fabs(tmp - eref) < ((double)(2.2204460492503130808e-16L)), 393, "test_psi.c"); 
# 395
lbref = ((eref * eref) / ((((4.0) * pi_) * epsilonref) * ktref)); 
# 396
psi_bjerrum_length(psi, &tmp); 
# 397
test_assert_info(fabs(lbref - tmp) < ((double)(2.2204460492503130808e-16L)), 397, "test_psi.c"); 
# 400
ldebyeref = ((1.0) / sqrt(((8.0) * pi_) * lbref)); 
# 401
psi_debye_length(psi, (1.0), &tmp); 
# 402
test_assert_info(fabs(ldebyeref - tmp) < ((double)(2.2204460492503130808e-16L)), 402, "test_psi.c"); 
# 404
psi_free(psi); 
# 405
cs_free(cs); 
...
cs_t *cs = (__null); 
# 431
(pe) ? static_cast< void>(0) : __assert_fail("pe", "test_psi.c", 431, __PRETTY_FUNCTION__); 
# 433
cs_create(pe, &cs); 
# 434
cs_init(cs); 
...
# 445
test_assert_info(fabs(expect - rhoi) < ((double)(2.2204460492503130808e-16L)), 445, "test_psi.c"); 
# 447
psi_free(psi); 
# 448
cs_free(cs); 
...
# 467
(cs) ? static_cast< void>(0) : __assert_fail("cs", "test_psi.c", 467, __PRETTY_FUNCTION__); 
# 468
(ref) ? static_cast< void>(0) : __assert_fail("ref", "test_psi.c", 468, __PRETTY_FUNCTION__); 
# 470
cs_ntotal(cs, ntotal); 
# 472
(*ref) = (-(1.0)); 
...
# 1 "test_psi.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__16_test_psi_cpp1_ii_b881ae04
# 1 "test_psi.cudafe1.stub.c"
#include "test_psi.cudafe1.stub.c"
# 1 "test_psi.cudafe1.stub.c"
