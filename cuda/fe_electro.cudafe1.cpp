...
# 58
static fe_vt_t fe_electro_hvt = {((fe_free_ft)fe_electro_free), ((fe_target_ft)fe_electro_target), ((fe_fed_ft)fe_electro_fed), ((fe_mu_ft)fe_electro_mu), ((fe_mu_solv_ft)fe_electro_mu_solv), ((fe_str_ft)fe_electro_stress_ex), ((fe_str_ft)fe_electro_stress_ex), ((fe_str_ft)__null), ((fe_hvector_ft)__null), ((fe_htensor_ft)__null), ((fe_htensor_v_ft)__null), ((fe_htensor_v_ft)__null), ((fe_htensor_v_ft)__null)}; 
# 74
static fe_vt_t fe_electro_dvt; 
# 106 "fe_electro.c"
int fe_electro_create(pe_t *pe, psi_t *psi, fe_electro_t **pobj) { 
# 108
int ndevice; 
# 109
fe_electro_t *fe = (__null); 
# 111
(pe) ? static_cast< void>(0) : __assert_fail("pe", "fe_electro.c", 111, __PRETTY_FUNCTION__); 
# 112
(pobj) ? static_cast< void>(0) : __assert_fail("pobj", "fe_electro.c", 112, __PRETTY_FUNCTION__); 
# 113
(psi) ? static_cast< void>(0) : __assert_fail("psi", "fe_electro.c", 113, __PRETTY_FUNCTION__); 
# 115
fe = ((fe_electro_t *)calloc(1, sizeof(fe_electro_t))); 
# 116
(fe) ? static_cast< void>(0) : __assert_fail("fe", "fe_electro.c", 116, __PRETTY_FUNCTION__); 
# 117
if (fe == (__null)) { pe_fatal(pe, "calloc() failed\n"); }  
# 119
(fe->pe) = pe; 
# 120
(fe->psi) = psi; 
...
fe_vt_t *vt; 
# 132
{ tdpErrorHandler(cudaGetSymbolAddress((void **)(&vt), fe_electro_dvt), "fe_electro.c", 132, 1); } ; 
# 133
...
int fe_electro_free(fe_electro_t *fe) { 
# 149
(fe) ? static_cast< void>(0) : __assert_fail("fe", "fe_electro.c", 149, __PRETTY_FUNCTION__); 
# 151
...
int fe_electro_target(fe_electro_t *fe, fe_t **target) { 
# 165
(fe) ? static_cast< void>(0) : __assert_fail("fe", "fe_electro.c", 165, __PRETTY_FUNCTION__); 
# 166
(target) ? static_cast< void>(0) : __assert_fail("target", "fe_electro.c", 166, __PRETTY_FUNCTION__); 
# 168
...
double rho; 
# 195
(fe) ? static_cast< void>(0) : __assert_fail("fe", "fe_electro.c", 195, __PRETTY_FUNCTION__); 
# 196
(fe->psi) ? static_cast< void>(0) : __assert_fail("fe->psi", "fe_electro.c", 196, __PRETTY_FUNCTION__); 
# 198
e = (0.0); 
# 199
psi_nk(fe->psi, &nk); 
...
# 204
(rho >= (0.0)) ? static_cast< void>(0) : __assert_fail("rho >= 0.0", "fe_electro.c", 204, __PRETTY_FUNCTION__); 
# 205
e += (rho * ((log(rho + ((double)(2.2204460492503130808e-16L))) - (1.0)) + (((0.5) * (((fe->psi)->valency)[n])) * psi))); 
# 206
}  
# 208
(*fed) = e; 
...
# 232
(fe) ? static_cast< void>(0) : __assert_fail("fe", "fe_electro.c", 232, __PRETTY_FUNCTION__); 
# 233
(fe->psi) ? static_cast< void>(0) : __assert_fail("fe->psi", "fe_electro.c", 233, __PRETTY_FUNCTION__); 
# 235
psi_psi(fe->psi, index, &psi); 
# 236
physics_ref(&phys); 
...
psi_rho(fe->psi, index, n, &rho); 
# 241
(rho >= (0.0)) ? static_cast< void>(0) : __assert_fail("rho >= 0.0", "fe_electro.c", 241, __PRETTY_FUNCTION__); 
# 243
(mu[n]) = ((kt * log(rho + ((double)(2.2204460492503130808e-16L)))) + (((((fe->psi)->valency)[n]) * ((fe->psi)->e)) * psi)); 
# 244
}  
# 246
return 0; 
...
int fe_electro_mu_solv(fe_electro_t *fe, int index, int k, double *mu) { 
# 261
(mu) ? static_cast< void>(0) : __assert_fail("mu", "fe_electro.c", 261, __PRETTY_FUNCTION__); 
# 262
(*mu) = (0.0); 
# 264
return 0; 
...
# 293
(fe) ? static_cast< void>(0) : __assert_fail("fe", "fe_electro.c", 293, __PRETTY_FUNCTION__); 
# 295
physics_ref(&phys); 
# 296
physics_kt(phys, &kt); 
...
const int8_t d[3][3] = {{(1), (0), (0)}, {(0), (1), (0)}, {(0), (0), (1)}}; 
# 347
(fe) ? static_cast< void>(0) : __assert_fail("fe", "fe_electro.c", 347, __PRETTY_FUNCTION__); 
# 349
physics_ref(&phys); 
# 350
physics_kt(phys, &kt); 
...
# 1 "fe_electro.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__18_fe_electro_cpp1_ii_6038c4f8
# 1 "fe_electro.cudafe1.stub.c"
#include "fe_electro.cudafe1.stub.c"
# 1 "fe_electro.cudafe1.stub.c"
