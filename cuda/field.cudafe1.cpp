...
if (ndevice > 0) { 
# 109
tdpMemcpy(&tmp, &((obj->target)->data), sizeof(double *), cudaMemcpyDeviceToHost); 
# 111
tdpFree(tmp); 
# 112
tdpFree(obj->target); 
...
# 177
tdpMemcpy(&((obj->target)->data), &tmp, sizeof(double *), cudaMemcpyHostToDevice); 
# 180
...
# 355
tdpMemcpy(&data, &((obj->target)->data), sizeof(double *), cudaMemcpyDeviceToHost); 
# 357
