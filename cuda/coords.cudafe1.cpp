...
# 25
static int cs_rectilinear_decomposition(cs_t * cs); 
# 27
static cs_param_t const_param; 
# 35
int cs_create(pe_t *pe, cs_t **pcs) { 
# 37
cs_t *cs = (__null); 
# 39
(pe) ? static_cast< void>(0) : __assert_fail("pe", "coords.c", 39, __PRETTY_FUNCTION__); 
# 40
(pcs) ? static_cast< void>(0) : __assert_fail("pcs", "coords.c", 40, __PRETTY_FUNCTION__); 
# 42
cs = ((cs_t *)calloc(1, sizeof(cs_t))); 
# 43
(cs) ? static_cast< void>(0) : __assert_fail("cs", "coords.c", 43, __PRETTY_FUNCTION__); 
# 44
if (cs == (__null)) { pe_fatal(pe, "calloc(cs_t) failed\n"); }  
# 46
(cs->param) = ((cs_param_t *)calloc(1, sizeof(cs_param_t))); 
# 47
(cs->param) ? static_cast< void>(0) : __assert_fail("cs->param", "coords.c", 47, __PRETTY_FUNCTION__); 
# 48
if ((cs->param) == (__null)) { pe_fatal(pe, "calloc(cs_param_t) failed\n"); }  
# 50
(cs->pe) = pe; 
# 51
pe_retain(cs->pe); 
...
int cs_retain(cs_t *cs) { 
# 88
(cs) ? static_cast< void>(0) : __assert_fail("cs", "coords.c", 88, __PRETTY_FUNCTION__); 
# 90
(cs->nref) += 1; 
# 92
return 0; 
...
int cs_free(cs_t *cs) { 
# 103
(cs) ? static_cast< void>(0) : __assert_fail("cs", "coords.c", 103, __PRETTY_FUNCTION__); 
# 105
(cs->nref) -= 1; 
# 107
if ((cs->nref) <= 0) { 
# 109
if ((cs->target) != cs) { tdpErrorHandler(tdpFree(cs->target), "coords.c", 109, 1); }  ; 
# 111
...
int cs_target(cs_t *cs, cs_t **target) { 
# 137
(cs) ? static_cast< void>(0) : __assert_fail("cs", "coords.c", 137, __PRETTY_FUNCTION__); 
# 138
(target) ? static_cast< void>(0) : __assert_fail("target", "coords.c", 138, __PRETTY_FUNCTION__); 
# 140
(*target) = (cs->target); 
# 142
return 0; 
...
MPI_Comm comm; 
# 158
(cs) ? static_cast< void>(0) : __assert_fail("cs", "coords.c", 158, __PRETTY_FUNCTION__); 
# 159
...
# 180
MPI_Cart_create(comm, 3, (cs->param)->mpi_cartsz, iperiodic, cs->reorder, &(cs->commperiodic)); 
# 186
...
# 190
MPI_Cart_create(comm, 3, (cs->param)->mpi_cartsz, iperiodic, cs->reorder, &(cs->commcart)); 
# 192
...
for (n = 0; n < 3; n++) { 
# 196
MPI_Cart_shift(cs->commcart, n, 1, &(((cs->mpi_cart_neighbours)[CS_BACK])[n]), &(((cs->mpi_cart_neighbours)[CS_FORW])[n])); 
# 199
}  
# 203
...
# 228
{ tdpErrorHandler(cudaGetSymbolAddress((void **)(&tmp), const_param), "coords.c", 228, 1); } ; 
# 229
tdpMemcpy(&((cs->target)->param), (const void *)(&tmp), sizeof(cs_param_t *), cudaMemcpyHostToDevice); 
# 231
cs_commit(cs); 
# 232
}  
...
int cs_commit(cs_t *cs) { 
# 245
(cs) ? static_cast< void>(0) : __assert_fail("cs", "coords.c", 245, __PRETTY_FUNCTION__); 
# 247
{ tdpErrorHandler(cudaMemcpyToSymbol(const_param, cs->param, sizeof(cs_param_t), 0, cudaMemcpyHostToDevice), "coords.c", 248, 1); 
# 247 "coords.c"
} 
# 248
; 
...
int nmin[3], nmax[3]; 
# 265
(cs) ? static_cast< void>(0) : __assert_fail("cs", "coords.c", 265, __PRETTY_FUNCTION__); 
# 269
...
# 331
(cs) ? static_cast< void>(0) : __assert_fail("cs", "coords.c", 331, __PRETTY_FUNCTION__); 
# 333
...
int cs_cart_coords(cs_t *cs, int coords[3]) { 
# 349
(cs) ? static_cast< void>(0) : __assert_fail("cs", "coords.c", 349, __PRETTY_FUNCTION__); 
# 351
...
int p; 
# 368
(cs) ? static_cast< void>(0) : __assert_fail("cs", "coords.c", 368, __PRETTY_FUNCTION__); 
# 369
((forwback == (FORWARD)) || (forwback == (BACKWARD))) ? static_cast< void>(0) : __assert_fail("forwback == FORWARD || forwback == BACKWARD", "coords.c", 369, __PRETTY_FUNCTION__); 
# 370
(((dim == (X)) || (dim == (Y))) || (dim == (Z))) ? static_cast< void>(0) : __assert_fail("dim == X || dim == Y || dim == Z", "coords.c", 370, __PRETTY_FUNCTION__); 
# 372
...
int cs_cart_comm(cs_t *cs, MPI_Comm *comm) { 
# 385
(cs) ? static_cast< void>(0) : __assert_fail("cs", "coords.c", 385, __PRETTY_FUNCTION__); 
# 386
(comm) ? static_cast< void>(0) : __assert_fail("comm", "coords.c", 386, __PRETTY_FUNCTION__); 
# 388
(*comm) = (cs->commcart); 
# 390
return 0; 
...
# 403
(cs) ? static_cast< void>(0) : __assert_fail("cs", "coords.c", 403, __PRETTY_FUNCTION__); 
# 405
...
# 421
(cs) ? static_cast< void>(0) : __assert_fail("cs", "coords.c", 421, __PRETTY_FUNCTION__); 
# 423
...
int cs_lmin(cs_t *cs, double lmin[3]) { 
# 439
(cs) ? static_cast< void>(0) : __assert_fail("cs", "coords.c", 439, __PRETTY_FUNCTION__); 
# 441
...
int cs_nlocal(cs_t *cs, int n[3]) { 
# 461
(cs) ? static_cast< void>(0) : __assert_fail("cs", "coords.c", 461, __PRETTY_FUNCTION__); 
# 463
...
int cs_nsites(cs_t *cs, int *nsites) { 
# 482
(cs) ? static_cast< void>(0) : __assert_fail("cs", "coords.c", 482, __PRETTY_FUNCTION__); 
# 484
...
int cs_nlocal_offset(cs_t *cs, int n[3]) { 
# 501
(cs) ? static_cast< void>(0) : __assert_fail("cs", "coords.c", 501, __PRETTY_FUNCTION__); 
# 503
...
int nnodes; 
# 523
(cs) ? static_cast< void>(0) : __assert_fail("cs", "coords.c", 523, __PRETTY_FUNCTION__); 
# 527
...
int ntotal[3]; 
# 551
(cs) ? static_cast< void>(0) : __assert_fail("cs", "coords.c", 551, __PRETTY_FUNCTION__); 
# 553
cs_cartsz(cs, mpisz); 
# 554
cs_ntotal(cs, ntotal); 
...
# 565
((cs->listnlocal)[idim]) ? static_cast< void>(0) : __assert_fail("cs->listnlocal[idim]", "coords.c", 565, __PRETTY_FUNCTION__); 
# 566
((cs->listnoffset)[idim]) ? static_cast< void>(0) : __assert_fail("cs->listnoffset[idim]", "coords.c", 566, __PRETTY_FUNCTION__); 
# 568
if ((((cs->listnlocal)[idim]) == (__null)) || (((cs->listnoffset)[idim]) == (__null))) { 
# 569
...
# 583
(((cs->listnoffset)[idim])[n]) = ((((cs->listnoffset)[idim])[n - 1]) + (((cs->listnlocal)[idim])[n - 1])); 
# 585
}  
# 589
ntot = 0; 
...
int cs_index(cs_t *cs, int ic, int jc, int kc) { 
# 612
(cs) ? static_cast< void>(0) : __assert_fail("cs", "coords.c", 612, __PRETTY_FUNCTION__); 
# 614
(ic >= (1 - ((cs->param)->nhalo))) ? static_cast< void>(0) : __assert_fail("ic >= 1 - cs->param->nhalo", "coords.c", 614, __PRETTY_FUNCTION__); 
# 615
(jc >= (1 - ((cs->param)->nhalo))) ? static_cast< void>(0) : __assert_fail("jc >= 1 - cs->param->nhalo", "coords.c", 615, __PRETTY_FUNCTION__); 
# 616
(kc >= (1 - ((cs->param)->nhalo))) ? static_cast< void>(0) : __assert_fail("kc >= 1 - cs->param->nhalo", "coords.c", 616, __PRETTY_FUNCTION__); 
# 617
(ic <= ((((cs->param)->nlocal)[X]) + ((cs->param)->nhalo))) ? static_cast< void>(0) : __assert_fail("ic <= cs->param->nlocal[X] + cs->param->nhalo", "coords.c", 617, __PRETTY_FUNCTION__); 
# 618
(jc <= ((((cs->param)->nlocal)[Y]) + ((cs->param)->nhalo))) ? static_cast< void>(0) : __assert_fail("jc <= cs->param->nlocal[Y] + cs->param->nhalo", "coords.c", 618, __PRETTY_FUNCTION__); 
# 619
(kc <= ((((cs->param)->nlocal)[Z]) + ((cs->param)->nhalo))) ? static_cast< void>(0) : __assert_fail("kc <= cs->param->nlocal[Z] + cs->param->nhalo", "coords.c", 619, __PRETTY_FUNCTION__); 
# 621
...
int cs_nhalo_set(cs_t *cs, int nhalo) { 
# 634
(nhalo > 0) ? static_cast< void>(0) : __assert_fail("nhalo > 0", "coords.c", 634, __PRETTY_FUNCTION__); 
# 635
(cs) ? static_cast< void>(0) : __assert_fail("cs", "coords.c", 635, __PRETTY_FUNCTION__); 
# 637
...
int cs_nhalo(cs_t *cs, int *nhalo) { 
# 651
(cs) ? static_cast< void>(0) : __assert_fail("cs", "coords.c", 651, __PRETTY_FUNCTION__); 
# 652
(nhalo) ? static_cast< void>(0) : __assert_fail("nhalo", "coords.c", 652, __PRETTY_FUNCTION__); 
# 654
...
int cs_ntotal(cs_t *cs, int ntotal[3]) { 
# 668
(cs) ? static_cast< void>(0) : __assert_fail("cs", "coords.c", 668, __PRETTY_FUNCTION__); 
# 670
...
int cs_ntotal_set(cs_t *cs, const int ntotal[3]) { 
# 685
(cs) ? static_cast< void>(0) : __assert_fail("cs", "coords.c", 685, __PRETTY_FUNCTION__); 
# 687
...
# 702
(cs) ? static_cast< void>(0) : __assert_fail("cs", "coords.c", 702, __PRETTY_FUNCTION__); 
# 704
...
int cs_decomposition_set(cs_t *cs, const int irequest[3]) { 
# 719
(cs) ? static_cast< void>(0) : __assert_fail("cs", "coords.c", 719, __PRETTY_FUNCTION__); 
# 721
...
int cs_reorder_set(cs_t *cs, int reorder) { 
# 736
(cs) ? static_cast< void>(0) : __assert_fail("cs", "coords.c", 736, __PRETTY_FUNCTION__); 
# 738
(cs->reorder) = reorder; 
# 740
return 0; 
...
# 753 "coords.c"
int cs_minimum_distance(cs_t *cs, const double r1[3], const double 
# 754
r2[3], double 
# 755
r12[3]) { 
# 757
(cs) ? static_cast< void>(0) : __assert_fail("cs", "coords.c", 757, __PRETTY_FUNCTION__); 
# 759
(r12[X]) = ((r2[X]) - (r1[X])); 
# 760
(r12[Y]) = ((r2[Y]) - (r1[Y])); 
...
int cs_index_to_ijk(cs_t *cs, int index, int coords[3]) { 
# 785
(cs) ? static_cast< void>(0) : __assert_fail("cs", "coords.c", 785, __PRETTY_FUNCTION__); 
# 787
...
# 791
(cs_index(cs, coords[X], coords[Y], coords[Z]) == index) ? static_cast< void>(0) : __assert_fail("cs_index(cs, coords[X], coords[Y], coords[Z]) == index", "coords.c", 791, __PRETTY_FUNCTION__); 
# 793
return 0; 
# 794
} 
...
int cs_strides(cs_t *cs, int *xs, int *ys, int *zs) { 
# 805
(cs) ? static_cast< void>(0) : __assert_fail("cs", "coords.c", 805, __PRETTY_FUNCTION__); 
# 807
(*xs) = (((cs->param)->str)[X]); 
# 808
(*ys) = (((cs->param)->str)[Y]); 
...
int cs_periodic_comm(cs_t *cs, MPI_Comm *comm) { 
# 822
(cs) ? static_cast< void>(0) : __assert_fail("cs", "coords.c", 822, __PRETTY_FUNCTION__); 
# 824
...
int coords[3]; 
# 846
(((dim == (X)) || (dim == (Y))) || (dim == (Z))) ? static_cast< void>(0) : __assert_fail("dim == X || dim == Y || dim == Z", "coords.c", 846, __PRETTY_FUNCTION__); 
# 847
((direction == (FORWARD)) || (direction == (BACKWARD))) ? static_cast< void>(0) : __assert_fail("direction == FORWARD || direction == BACKWARD", "coords.c", 847, __PRETTY_FUNCTION__); 
# 848
(rank) ? static_cast< void>(0) : __assert_fail("rank", "coords.c", 848, __PRETTY_FUNCTION__); 
# 850
...
int cs_pe_rank(cs_t *cs) { 
# 872
(cs) ? static_cast< void>(0) : __assert_fail("cs", "coords.c", 872, __PRETTY_FUNCTION__); 
# 874
...
int cs_nall(cs_t *cs, int nall[3]) { 
# 885
(cs) ? static_cast< void>(0) : __assert_fail("cs", "coords.c", 885, __PRETTY_FUNCTION__); 
# 887
...
int cs_cart_rank(cs_t *cs) { 
# 901
(cs) ? static_cast< void>(0) : __assert_fail("cs", "coords.c", 901, __PRETTY_FUNCTION__); 
# 902
return cs->mpi_cartrank; 
# 903
} 

# 1 "coords.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__14_coords_cpp1_ii_7126c51d
# 1 "coords.cudafe1.stub.c"
#include "coords.cudafe1.stub.c"
# 1 "coords.cudafe1.stub.c"
