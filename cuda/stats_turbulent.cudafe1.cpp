...
int stats_turbulent_create(pe_t *pe, cs_t *cs, stats_turb_t **pobj) { 
# 44
stats_turb_t *obj = (__null); 
# 45
int nlocal[3]; 
# 47
(pe) ? static_cast< void>(0) : __assert_fail("pe", "stats_turbulent.c", 47, __PRETTY_FUNCTION__); 
# 48
(cs) ? static_cast< void>(0) : __assert_fail("cs", "stats_turbulent.c", 48, __PRETTY_FUNCTION__); 
# 49
(pobj) ? static_cast< void>(0) : __assert_fail("pobj", "stats_turbulent.c", 49, __PRETTY_FUNCTION__); 
# 51
obj = ((stats_turb_t *)calloc(1, sizeof(stats_turb_t))); 
# 52
(obj) ? static_cast< void>(0) : __assert_fail("obj", "stats_turbulent.c", 52, __PRETTY_FUNCTION__); 
# 53
if (obj == (__null)) { pe_fatal(pe, "calloc(stats_turb_t) failed\n"); }  
# 55
(obj->pe) = pe; 
# 56
(obj->cs) = cs; 
...
# 61
if ((obj->ubar) == (__null)) { pe_fatal(pe, "malloc(ubar_) failed\n"); }  
# 63
...
MPI_Comm comm; 
# 88
(stat) ? static_cast< void>(0) : __assert_fail("stat", "stats_turbulent.c", 88, __PRETTY_FUNCTION__); 
# 90
...
int stats_turbulent_free(stats_turb_t *stat) { 
# 134
(stat) ? static_cast< void>(0) : __assert_fail("stat", "stats_turbulent.c", 134, __PRETTY_FUNCTION__); 
# 136
...
double u[3]; 
# 160
(stat) ? static_cast< void>(0) : __assert_fail("stat", "stats_turbulent.c", 160, __PRETTY_FUNCTION__); 
# 161
(hydro) ? static_cast< void>(0) : __assert_fail("hydro", "stats_turbulent.c", 161, __PRETTY_FUNCTION__); 
# 163
...
int ia; 
# 198
(stat) ? static_cast< void>(0) : __assert_fail("stat", "stats_turbulent.c", 198, __PRETTY_FUNCTION__); 
# 200
cs_nlocal(stat->cs, nlocal); 
# 202
for (ic = 1; ic <= (nlocal[X]); ic++) { 
...
MPI_Status status; 
# 245
(stat) ? static_cast< void>(0) : __assert_fail("stat", "stats_turbulent.c", 245, __PRETTY_FUNCTION__); 
# 247
...
# 255
(f1) ? static_cast< void>(0) : __assert_fail("f1", "stats_turbulent.c", 255, __PRETTY_FUNCTION__); 
# 256
if (f1 == (__null)) { pe_fatal(stat->pe, "malloc(f1) failed\n"); }  
# 258
f1z = ((double *)malloc((3 * (ntotal[Z])) * sizeof(double))); 
# 259
(f1z) ? static_cast< void>(0) : __assert_fail("f1z", "stats_turbulent.c", 259, __PRETTY_FUNCTION__); 
# 260
if (f1z == (__null)) { pe_fatal(stat->pe, "malloc(f1z) failed\n"); }  
# 263
raverage = (0.0); 
# 264
if ((stat->time_counter) > 0) { raverage = ((1.0) / ((ltot[Y]) * (stat->time_counter))); }  
# 268
MPI_Reduce(stat->ubar, f1, (3 * (nlocal[X])) * (nlocal[Z]), MPI_DOUBLE, MPI_SUM, 0, stat->comm_y); 
# 273
...
# 309
MPI_Gather(f1 + ((3 * (ic - 1)) * (nlocal[Z])), 3 * (nlocal[Z]), MPI_DOUBLE, f1z, 3 * (nlocal[Z]), MPI_DOUBLE, 0, stat->comm_z); 
# 313
if (is_writing) { 
# 314
...
# 1 "stats_turbulent.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__23_stats_turbulent_cpp1_ii_2e6b2f69
# 1 "stats_turbulent.cudafe1.stub.c"
#include "stats_turbulent.cudafe1.stub.c"
# 1 "stats_turbulent.cudafe1.stub.c"
