...
# 29 "psi_colloid.c"
static int psi_colloid_charge_accum(psi_t * psi, colloids_info_t * cinfo, int index, double * rho, double * weight); 
# 50 "psi_colloid.c"
int psi_colloid_rho_set(psi_t *obj, colloids_info_t *cinfo) { 
# 52
int ic, jc, kc, index; 
...
colloid_t *pc = (__null); 
# 58
(obj) ? static_cast< void>(0) : __assert_fail("obj", "psi_colloid.c", 58, __PRETTY_FUNCTION__); 
# 59
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "psi_colloid.c", 59, __PRETTY_FUNCTION__); 
# 61
...
psi_nk(obj, &nk); 
# 132
(nk == 2) ? static_cast< void>(0) : __assert_fail("nk == 2", "psi_colloid.c", 132, __PRETTY_FUNCTION__); 
# 134
cs_ltot(obj->cs, ltot); 
# 135
cs_cart_comm(obj->cs, &comm); 
# 137
colloids_info_q_local(cinfo, qvlocal); 
# 138
colloids_info_v_local(cinfo, qvlocal + 2); 
# 140
...
# 163
((nc == 0) || (nc == 1)) ? static_cast< void>(0) : __assert_fail("nc == 0 || nc == 1", "psi_colloid.c", 163, __PRETTY_FUNCTION__); 
# 167
cs_nlocal(obj->cs, nlocal); 
# 169
for (ic = 1; ic <= (nlocal[X]); ic++) { 
...
double rho; 
# 203
(psi) ? static_cast< void>(0) : __assert_fail("psi", "psi_colloid.c", 203, __PRETTY_FUNCTION__); 
# 204
(colloid) ? static_cast< void>(0) : __assert_fail("colloid", "psi_colloid.c", 204, __PRETTY_FUNCTION__); 
# 206
...
# 223 "psi_colloid.c"
int psi_colloid_replace_charge(psi_t *psi, colloids_info_t *cinfo, colloid_t *
# 224
colloid, int index) { 
# 225
int n, nk; 
...
double weight; 
# 230
(psi) ? static_cast< void>(0) : __assert_fail("psi", "psi_colloid.c", 230, __PRETTY_FUNCTION__); 
# 231
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "psi_colloid.c", 231, __PRETTY_FUNCTION__); 
# 232
(colloid) ? static_cast< void>(0) : __assert_fail("colloid", "psi_colloid.c", 232, __PRETTY_FUNCTION__); 
# 234
psi_nk(psi, &nk); 
# 235
(nk == 2) ? static_cast< void>(0) : __assert_fail("nk == 2", "psi_colloid.c", 235, __PRETTY_FUNCTION__); 
# 237
...
psi_colloid_charge_accum(psi, cinfo, index + zs, rho, &weight); 
# 255
(weight > (0.0)) ? static_cast< void>(0) : __assert_fail("weight > 0.0", "psi_colloid.c", 255, __PRETTY_FUNCTION__); 
# 257
weight = ((1.0) / weight); 
# 258
for (n = 0; n < nk; n++) { 
...
# 286 "psi_colloid.c"
static int psi_colloid_charge_accum(psi_t *psi, colloids_info_t *cinfo, int 
# 287
index, double *rho, double *weight) { 
# 288
int n, nk = 2; 
# 289
double rho0; 
...
colloid_t *pc = (__null); 
# 292
(psi) ? static_cast< void>(0) : __assert_fail("psi", "psi_colloid.c", 292, __PRETTY_FUNCTION__); 
# 293
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "psi_colloid.c", 293, __PRETTY_FUNCTION__); 
# 294
(rho) ? static_cast< void>(0) : __assert_fail("rho", "psi_colloid.c", 294, __PRETTY_FUNCTION__); 
# 295
(weight) ? static_cast< void>(0) : __assert_fail("weight", "psi_colloid.c", 295, __PRETTY_FUNCTION__); 
# 297
...
# 319 "psi_colloid.c"
int psi_colloid_zetapotential(psi_t *obj, colloids_info_t *cinfo, double *
# 320
psi_zeta) { 
# 322
int ic, jc, kc; 
...
int nlocal[3]; 
# 327
int nsl_local, nsl_total; 
# 329
double psi0; 
# 330
double psi1; 
# 331
double psic_local, psic_total; 
# 333
colloid_t *p_c; 
# 334
...
MPI_Comm comm; 
# 338
(obj) ? static_cast< void>(0) : __assert_fail("obj", "psi_colloid.c", 338, __PRETTY_FUNCTION__); 
# 339
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "psi_colloid.c", 339, __PRETTY_FUNCTION__); 
# 341
cs_cart_comm(obj->cs, &comm); 
# 342
cs_nlocal(obj->cs, nlocal); 
...
# 1 "psi_colloid.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__19_psi_colloid_cpp1_ii_a30ada72
# 1 "psi_colloid.cudafe1.stub.c"
#include "psi_colloid.cudafe1.stub.c"
# 1 "psi_colloid.cudafe1.stub.c"
