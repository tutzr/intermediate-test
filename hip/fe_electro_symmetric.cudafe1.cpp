...
# 148
{ tdpErrorHandler(hipGetSymbolAddress((void **)(&tmp), &const_param), "fe_electro_symmetric.c", 148, 1); } ; 
# 149
tdpMemcpy(&((fe->target)->param), tmp, sizeof(fe_es_param_t *), hipMemcpyHostToDevice); 
# 151
{ tdpErrorHandler(hipGetSymbolAddress((void **)(&vt), &fe_es_dvt), "fe_electro_symmetric.c", 151, 1); } ; 
# 152
}  
# 154
(*pobj) = fe; 
