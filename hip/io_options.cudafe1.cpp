...
io_mode_enum_t io_mode_default() { 
# 38
return IO_MODE_SINGLE; 
# 39
} 
# 47
io_record_format_enum_t io_record_format_default() { 
# 49
return IO_RECORD_BINARY; 
# 50
} 
# 59 "io_options.c"
io_metadata_version_enum_t io_metadata_version_default() { 
# 61
return IO_METADATA_SINGLE_V1; 
# 62
} 
# 70
io_options_t io_options_default() { 
# 72
io_options_t opts = {IO_MODE_SINGLE, IO_RECORD_BINARY, IO_METADATA_SINGLE_V1, 0, 0}; 
# 74
return opts; 
# 75
} 
...
int valid = 0; 
# 91
(options) ? static_cast< void>(0) : __assert_fail("options", "io_options.c", 91, __PRETTY_FUNCTION__); 
# 93
...
# 125 "io_options.c"
int io_options_record_format_valid(io_record_format_enum_t ioformat) { 
# 127
int valid = 0; 
# 129
...
int valid = 0; 
# 147
(options) ? static_cast< void>(0) : __assert_fail("options", "io_options.c", 147, __PRETTY_FUNCTION__); 
# 151
...
# 1 "io_options.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__18_io_options_cpp1_ii_262bdb9f
# 1 "io_options.cudafe1.stub.c"
#include "io_options.cudafe1.stub.c"
# 1 "io_options.cudafe1.stub.c"
