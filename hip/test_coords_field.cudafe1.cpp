...
# 43 "test_coords_field.c"
int test_coords_field_set(cs_t *cs, int nf, void *buf, MPI_Datatype mpidata, halo_ft 
# 44
bufset) { 
# 45
int n; 
...
# 54
(cs) ? static_cast< void>(0) : __assert_fail("cs", "test_coords_field.c", 54, __PRETTY_FUNCTION__); 
# 55
(nf >= 0) ? static_cast< void>(0) : __assert_fail("nf >= 0", "test_coords_field.c", 55, __PRETTY_FUNCTION__); 
# 56
(fc) ? static_cast< void>(0) : __assert_fail("fc", "test_coords_field.c", 56, __PRETTY_FUNCTION__); 
# 57
((mpidata == (MPI_CHAR)) || (mpidata == (MPI_DOUBLE))) ? static_cast< void>(0) : __assert_fail("mpidata == MPI_CHAR || mpidata == MPI_DOUBLE", "test_coords_field.c", 57, __PRETTY_FUNCTION__); 
# 58
...
# 75
bufset(cs, (noffst[X]) + ic, (noffst[Y]) + jc, (noffst[Z]) + kc, n, fc + (sz * indexf)); 
# 77
}  
# 79
}  
...
# 102 "test_coords_field.c"
int test_coords_field_check(cs_t *cs, int nhcomm, int nf, void *buf, MPI_Datatype 
# 103
mpidata, halo_ft bufref) { 
# 104
int n; 
# 105
int nsites; 
...
# 115
(cs) ? static_cast< void>(0) : __assert_fail("cs", "test_coords_field.c", 115, __PRETTY_FUNCTION__); 
# 116
(nf >= 0) ? static_cast< void>(0) : __assert_fail("nf >= 0", "test_coords_field.c", 116, __PRETTY_FUNCTION__); 
# 117
(bufc) ? static_cast< void>(0) : __assert_fail("bufc", "test_coords_field.c", 117, __PRETTY_FUNCTION__); 
# 118
((mpidata == (MPI_CHAR)) || (mpidata == (MPI_DOUBLE))) ? static_cast< void>(0) : __assert_fail("mpidata == MPI_CHAR || mpidata == MPI_DOUBLE", "test_coords_field.c", 118, __PRETTY_FUNCTION__); 
# 119
if (mpidata == (MPI_CHAR)) { sz = sizeof(char); }  
# 120
if (mpidata == (MPI_DOUBLE)) { sz = sizeof(double); }  
...
cact = (bufc[sz * indexf]); 
# 137
test_assert_info(cref == cact, 137, "test_coords_field.c"); 
# 138
}  
# 139
}  
...
# 147
test_assert_info(fabs(dact - dref) < ((1.192092896e-07F)), 147, "test_coords_field.c"); 
# 148
}  
# 149
}  
...
char *c = (char *)ref; 
# 174
(cs) ? static_cast< void>(0) : __assert_fail("cs", "test_coords_field.c", 174, __PRETTY_FUNCTION__); 
# 175
(c) ? static_cast< void>(0) : __assert_fail("c", "test_coords_field.c", 175, __PRETTY_FUNCTION__); 
# 177
cs_ntotal(cs, ntotal); 
# 179
iref = ic; 
...
iref += n; 
# 184
test_assert_info(iref >= 0, 184, "test_coords_field.c"); 
# 185
(iref < 127) ? static_cast< void>(0) : __assert_fail("iref < 127", "test_coords_field.c", 185, __PRETTY_FUNCTION__); 
# 187
(*c) = iref; 
# 189
return 0; 
...
# 206
(d) ? static_cast< void>(0) : __assert_fail("d", "test_coords_field.c", 206, __PRETTY_FUNCTION__); 
# 208
cs_ltot(cs, ltot); 
# 210
...
# 1 "test_coords_field.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__25_test_coords_field_cpp1_ii_eacb3c01
# 1 "test_coords_field.cudafe1.stub.c"
#include "test_coords_field.cudafe1.stub.c"
# 1 "test_coords_field.cudafe1.stub.c"
