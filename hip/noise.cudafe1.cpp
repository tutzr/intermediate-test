...
noise_t *obj = (__null); 
# 59
(pe) ? static_cast< void>(0) : __assert_fail("pe", "noise.c", 59, __PRETTY_FUNCTION__); 
# 60
(cs) ? static_cast< void>(0) : __assert_fail("cs", "noise.c", 60, __PRETTY_FUNCTION__); 
# 61
(pobj) ? static_cast< void>(0) : __assert_fail("pobj", "noise.c", 61, __PRETTY_FUNCTION__); 
# 63
obj = ((noise_t *)calloc(1, sizeof(noise_t))); 
# 64
(obj) ? static_cast< void>(0) : __assert_fail("obj", "noise.c", 64, __PRETTY_FUNCTION__); 
# 65
if (obj == (__null)) { pe_fatal(pe, "calloc(noise_t) failed\n"); }  
# 67
(obj->pe) = pe; 
# 68
(obj->cs) = cs; 
...
# 89
tdpMemcpy((obj->target)->rtable, obj->rtable, (8) * sizeof(double), hipMemcpyHostToDevice); 
# 91
}  
# 93
(*pobj) = obj; 
...
int noise_free(noise_t *obj) { 
# 106
(obj) ? static_cast< void>(0) : __assert_fail("obj", "noise.c", 106, __PRETTY_FUNCTION__); 
# 108
if (((obj->target) != obj) && (obj->state)) { 
# 109
unsigned *tmp = (__null); 
# 110
tdpMemcpy(&tmp, &((obj->target)->state), sizeof(unsigned *), hipMemcpyDeviceToHost); 
# 112
tdpFree(obj->target); 
# 113
}  
...
int ntotal[3]; 
# 147
unsigned state0[4] = {(13), (12953), (712357), (22383979)}; 
# 148
unsigned state[4]; 
# 149
unsigned state_local[4]; 
# 151
(obj) ? static_cast< void>(0) : __assert_fail("obj", "noise.c", 151, __PRETTY_FUNCTION__); 
# 155
if (master_seed > 0) { 
# 156
...
nstat = (4 * (obj->nsites)); 
# 162
((obj->nsites) > 0) ? static_cast< void>(0) : __assert_fail("obj->nsites > 0", "noise.c", 162, __PRETTY_FUNCTION__); 
# 164
(obj->state) = ((unsigned *)calloc(nstat, sizeof(unsigned))); 
# 165
if ((obj->state) == (__null)) { pe_fatal(obj->pe, "calloc(obj->state) failed\n"); }  
# 167
nextra = 1; 
# 168
...
unsigned *tmp = (__null); 
# 217
tdpMalloc((void **)(&tmp), nstat * sizeof(unsigned)); 
# 218
tdpMemcpy(&((obj->target)->state), &tmp, sizeof(unsigned *), hipMemcpyHostToDevice); 
# 220
}  
# 222
noise_memcpy(obj, hipMemcpyHostToDevice); 
# 224
return 0; 
# 225
} 
# 233
int noise_target(noise_t *obj, noise_t **target) { 
# 235
(obj) ? static_cast< void>(0) : __assert_fail("obj", "noise.c", 235, __PRETTY_FUNCTION__); 
# 236
(target) ? static_cast< void>(0) : __assert_fail("target", "noise.c", 236, __PRETTY_FUNCTION__); 
# 238
(*target) = (obj->target); 
# 240
return 0; 
...
int ndevice; 
# 253
(obj) ? static_cast< void>(0) : __assert_fail("obj", "noise.c", 253, __PRETTY_FUNCTION__); 
# 255
tdpGetDeviceCount(&ndevice); 
# 257
if (ndevice == 0) { 
# 258
((obj->target) == obj) ? static_cast< void>(0) : __assert_fail("obj->target == obj", "noise.c", 258, __PRETTY_FUNCTION__); 
# 259
} else 
# 260
{ 
...
# 272
tdpMemcpy(tmp, obj->state, nstat * sizeof(unsigned), flag); 
# 273
break; 
# 274
case hipMemcpyDeviceToHost:  
# 275
tdpMemcpy(obj->state, tmp, nstat * sizeof(unsigned), flag); 
# 276
break; 
# 277
default:  
...
# 294 "noise.c"
int noise_init_io_info(noise_t *obj, int grid[3], int form_in, int 
# 295
form_out) { 
# 297
...
io_info_arg_t args; 
# 301
(obj) ? static_cast< void>(0) : __assert_fail("obj", "noise.c", 301, __PRETTY_FUNCTION__); 
# 303
((args.grid)[X]) = (grid[X]); 
# 304
((args.grid)[Y]) = (grid[Y]); 
...
# 308
if ((obj->info) == (__null)) { pe_fatal(obj->pe, "io_info_create(noise) failed\n"); }  
# 310
...
# 315
io_info_set_bytesize(obj->info, IO_FORMAT_BINARY, (4) * sizeof(unsigned)); 
# 318
...
# 330
int noise_state_set(noise_t *obj, int index, unsigned 
# 331
newstate[4]) { 
# 332
int ia; 
# 334
(obj) ? static_cast< void>(0) : __assert_fail("obj", "noise.c", 334, __PRETTY_FUNCTION__); 
# 335
(index >= 0) ? static_cast< void>(0) : __assert_fail("index >= 0", "noise.c", 335, __PRETTY_FUNCTION__); 
# 336
(index < (obj->nsites)) ? static_cast< void>(0) : __assert_fail("index < obj->nsites", "noise.c", 336, __PRETTY_FUNCTION__); 
# 338
for (ia = 0; ia < 4; ia++) { 
# 339
((obj->state)[reverse_addr_rank1_assert(339, "noise.c", obj->nsites, 4, index, ia)]) = (newstate[ia]); 
# 340
}  
# 342
return 0; 
...
# 353 "noise.c"
int noise_state(noise_t *obj, int index, unsigned 
# 354
state[4]) { 
# 355
int ia; 
# 357
(obj) ? static_cast< void>(0) : __assert_fail("obj", "noise.c", 357, __PRETTY_FUNCTION__); 
# 358
(index >= 0) ? static_cast< void>(0) : __assert_fail("index >= 0", "noise.c", 358, __PRETTY_FUNCTION__); 
# 359
(index < (obj->nsites)) ? static_cast< void>(0) : __assert_fail("index < obj->nsites", "noise.c", 359, __PRETTY_FUNCTION__); 
# 361
for (ia = 0; ia < 4; ia++) { 
# 362
(state[ia]) = ((obj->state)[reverse_addr_rank1_assert(362, "noise.c", obj->nsites, 4, index, ia)]); 
# 363
}  
# 365
return 0; 
...
int noise_reap(noise_t *obj, int index, double *reap) { 
# 379
(obj) ? static_cast< void>(0) : __assert_fail("obj", "noise.c", 379, __PRETTY_FUNCTION__); 
# 380
(index >= 0) ? static_cast< void>(0) : __assert_fail("index >= 0", "noise.c", 380, __PRETTY_FUNCTION__); 
# 381
(index < (obj->nsites)) ? static_cast< void>(0) : __assert_fail("index < obj->nsites", "noise.c", 381, __PRETTY_FUNCTION__); 
# 383
noise_reap_n(obj, index, 10, reap); 
# 385
return 0; 
# 386
} 
...
int ia; 
# 404
(obj) ? static_cast< void>(0) : __assert_fail("obj", "noise.c", 404, __PRETTY_FUNCTION__); 
# 405
(index >= 0) ? static_cast< void>(0) : __assert_fail("index >= 0", "noise.c", 405, __PRETTY_FUNCTION__); 
# 406
(index < (obj->nsites)) ? static_cast< void>(0) : __assert_fail("index < obj->nsites", "noise.c", 406, __PRETTY_FUNCTION__); 
# 407
(nmax <= 10) ? static_cast< void>(0) : __assert_fail("nmax <= 10", "noise.c", 407, __PRETTY_FUNCTION__); 
# 409
...
unsigned state[4]; 
# 440
(obj) ? static_cast< void>(0) : __assert_fail("obj", "noise.c", 440, __PRETTY_FUNCTION__); 
# 441
(index >= 0) ? static_cast< void>(0) : __assert_fail("index >= 0", "noise.c", 441, __PRETTY_FUNCTION__); 
# 442
(index < (obj->nsites)) ? static_cast< void>(0) : __assert_fail("index < obj->nsites", "noise.c", 442, __PRETTY_FUNCTION__); 
# 444
noise_state(obj, index, state); 
# 445
iuniform = noise_uniform(state); 
...
noise_state_set(obj, index, state); 
# 448
(*reap) = (((1.0) / (((2147483647) * 2U) + 1U)) * iuniform); 
# 450
return 0; 
# 451
} 
...
unsigned b; 
# 472
(4 == 4) ? static_cast< void>(0) : __assert_fail("4 == 4", "noise.c", 472, __PRETTY_FUNCTION__); 
# 474
...
(state[1]) = (b ^ (b << 5)); 
# 478
(state[2]) = (((36969) * ((state[2]) & (65535))) + ((state[2]) >> 16)); 
# 479
(state[3]) = (((18000) * ((state[3]) & (65535))) + ((state[3]) >> 16)); 
# 480
...
unsigned state[4]; 
# 499
(fp) ? static_cast< void>(0) : __assert_fail("fp", "noise.c", 499, __PRETTY_FUNCTION__); 
# 500
(obj) ? static_cast< void>(0) : __assert_fail("obj", "noise.c", 500, __PRETTY_FUNCTION__); 
# 502
noise_state(obj, index, state); 
# 503
n = (fwrite(state, sizeof(unsigned), 4, fp)); 
# 504
if (n != 4) { pe_fatal(obj->pe, "fwrite(noise) index %d\n", index); }  
# 506
return 0; 
# 507
} 
...
unsigned state[4]; 
# 523
(obj) ? static_cast< void>(0) : __assert_fail("obj", "noise.c", 523, __PRETTY_FUNCTION__); 
# 524
(fp) ? static_cast< void>(0) : __assert_fail("fp", "noise.c", 524, __PRETTY_FUNCTION__); 
# 526
n = (fread(state, sizeof(unsigned), 4, fp)); 
# 527
if (n != 4) { pe_fatal(obj->pe, "fread(noise) index %d\n", index); }  
# 528
noise_state_set(obj, index, state); 
# 530
return 0; 
...
# 544
(noise) ? static_cast< void>(0) : __assert_fail("noise", "noise.c", 544, __PRETTY_FUNCTION__); 
# 545
(type < (NOISE_END)) ? static_cast< void>(0) : __assert_fail("type < NOISE_END", "noise.c", 545, __PRETTY_FUNCTION__); 
# 546
(present) ? static_cast< void>(0) : __assert_fail("present", "noise.c", 546, __PRETTY_FUNCTION__); 
# 548
...
# 563
(noise) ? static_cast< void>(0) : __assert_fail("noise", "noise.c", 563, __PRETTY_FUNCTION__); 
# 564
(type < (NOISE_END)) ? static_cast< void>(0) : __assert_fail("type < NOISE_END", "noise.c", 564, __PRETTY_FUNCTION__); 
# 566
...
# 1 "noise.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__13_noise_cpp1_ii_1d7fac01
# 1 "noise.cudafe1.stub.c"
#include "noise.cudafe1.stub.c"
# 1 "noise.cudafe1.stub.c"
