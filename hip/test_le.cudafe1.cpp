...
MPI_Comm comm; 
# 97
(pe) ? static_cast< void>(0) : __assert_fail("pe", "test_le.c", 97, __PRETTY_FUNCTION__); 
# 98
(cs) ? static_cast< void>(0) : __assert_fail("cs", "test_le.c", 98, __PRETTY_FUNCTION__); 
# 100
(info->nplanes) = nplane; 
# 101
(info->uy) = uy_set; 
...
# 108
test_assert_info(lees_edw_nplane_total(le) == nplane, 108, "test_le.c"); 
# 112
nplane_local = (nplane / (cartsz[X])); 
# 113
test_assert_info(lees_edw_nplane_local(le) == nplane_local, 113, "test_le.c"); 
# 117
lees_edw_plane_uy(le, &uy); 
# 118
test_assert_info(fabs(uy - uy_set) < (9.999999999999999988e-15), 118, "test_le.c"); 
# 125
cs_ltot(cs, len); 
# 126
cs_ntotal(cs, ntotal); 
...
dy = fmod(dy, len[Y]); 
# 140
test_assert_info(dy > (-(len[Y])), 140, "test_le.c"); 
# 141
test_assert_info(dy < (+(len[Y])), 141, "test_le.c"); 
# 146
jdy = (floor(dy)); 
# 147
fr = (dy - jdy); 
# 149
test_assert_info(jdy < (ntotal[Y]), 149, "test_le.c"); 
# 150
test_assert_info(jdy >= (-(ntotal[Y])), 150, "test_le.c"); 
# 151
test_assert_info(fr >= (0.0), 151, "test_le.c"); 
# 152
test_assert_info(fr <= (1.0), 152, "test_le.c"); 
# 158
jlocal = ((noffset[Y]) + 1); 
# 159
j1 = (1 + ((((jlocal - jdy) - 2) + (2 * (ntotal[Y]))) % (ntotal[Y]))); 
# 161
test_assert_info(j1 >= 1, 161, "test_le.c"); 
# 162
test_assert_info(j1 <= (ntotal[Y]), 162, "test_le.c"); 
# 166
j1mod = (1 + (j1 % (nlocal[Y]))); 
# 168
test_assert_info(j1mod >= 1, 168, "test_le.c"); 
# 169
test_assert_info(j1mod <= (nlocal[Y]), 169, "test_le.c"); 
# 173
n1 = (((nlocal[Y]) - j1mod) + 1); 
# 175
test_assert_info(n1 >= 1, 175, "test_le.c"); 
# 176
test_assert_info(n1 <= (nlocal[Y]), 176, "test_le.c"); 
# 181
n2 = j1mod; 
# 183
test_assert_info(n2 >= 1, 183, "test_le.c"); 
# 184
test_assert_info(n2 <= (nlocal[Y]), 184, "test_le.c"); 
# 185
test_assert_info((n1 + n2) == ((nlocal[Y]) + 1), 185, "test_le.c"); 
# 187
py = ((j1 - 1) / (nlocal[Y])); 
# 188
test_assert_info(py >= 0, 188, "test_le.c"); 
# 189
test_assert_info(py < (cartsz[Y]), 189, "test_le.c"); 
# 190
MPI_Cart_rank(comm, &py, &precv_rank_left); 
# 191
py = (1 + ((j1 - 1) / (nlocal[Y]))); 
# 192
test_assert_info(py >= 1, 192, "test_le.c"); 
# 193
test_assert_info(py <= (cartsz[Y]), 193, "test_le.c"); 
# 194
...
double uy_set = (0.25); 
# 227
(pe) ? static_cast< void>(0) : __assert_fail("pe", "test_le.c", 227, __PRETTY_FUNCTION__); 
# 228
(cs) ? static_cast< void>(0) : __assert_fail("cs", "test_le.c", 228, __PRETTY_FUNCTION__); 
# 233
cs_ntotal(cs, ntotal); 
# 234
cs_nlocal(cs, nlocal); 
...
dy = fmod(dy, len[Y]); 
# 247
test_assert_info(dy > (-(len[Y])), 247, "test_le.c"); 
# 248
test_assert_info(dy < (+(len[Y])), 248, "test_le.c"); 
# 253
jdy = (floor(dy)); 
# 254
fr = (dy - jdy); 
# 256
test_assert_info(jdy < (ntotal[Y]), 256, "test_le.c"); 
# 257
test_assert_info(jdy >= (-(ntotal[Y])), 257, "test_le.c"); 
# 258
test_assert_info(fr >= (0.0), 258, "test_le.c"); 
# 259
test_assert_info(fr <= (1.0), 259, "test_le.c"); 
# 261
jc = ((noffset[Y]) + 1); 
# 262
...
j2 = (1 + ((j1 - 1) % (nlocal[Y]))); 
# 265
test_assert_info(j2 >= 1, 265, "test_le.c"); 
# 266
test_assert_info(j2 <= (nlocal[Y]), 266, "test_le.c"); 
# 268
n1 = (((nlocal[Y]) - j2) + 1); 
# 269
...
# 272
test_assert_info(((n1 + n2) + n3) == (((nlocal[Y]) + (2 * nhalo)) + 3), 272, "test_le.c"); 
# 273
}  
# 275
return 0; 
...
# 1 "test_le.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__15_test_le_cpp1_ii_b58be7fb
# 1 "test_le.cudafe1.stub.c"
#include "test_le.cudafe1.stub.c"
# 1 "test_le.cudafe1.stub.c"
