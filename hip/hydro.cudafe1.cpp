...
# 20 "coords_field.h"
int coords_field_init_mpi_indexed(cs_t * cs, int nhcomm, int nf, MPI_Datatype mpidata, MPI_Datatype  halo[3]); 
# 24
int coords_field_halo_rank1(cs_t * cs, int nall, int nhcomm, int na, void * buf, MPI_Datatype mpidata); 
# 37 "util.h"
int is_bigendian(); 
# 38
...
# 34
static void hydro_field_set(hydro_t * hydro, double * field, double, double, double); 
# 36
void hydro_accumulate_kernel(kernel_ctxt_t * ktx, hydro_t * hydro, double  fnet[3]); 
# 38
void hydro_correct_kernel(kernel_ctxt_t * ktx, hydro_t * hydro, double  fnet[3]); 
# 40
void hydro_accumulate_kernel_v(kernel_ctxt_t * ktx, hydro_t * hydro, double  fnet[3]); 
# 42
void hydro_correct_kernel_v(kernel_ctxt_t * ktx, hydro_t * hydro, double  fnet[3]); 
# 45
static double fs[3]; 
# 58 "hydro.c"
int hydro_create(pe_t *pe, cs_t *cs, lees_edw_t *le, int nhcomm, hydro_t **
# 59
pobj) { 
# 61
int ndevice; 
...
double *tmp; 
# 63
hydro_t *obj = ((hydro_t *)__null); 
# 65
(pe) ? static_cast< void>(0) : __assert_fail("pe", "hydro.c", 65, __PRETTY_FUNCTION__); 
# 66
(cs) ? static_cast< void>(0) : __assert_fail("cs", "hydro.c", 66, __PRETTY_FUNCTION__); 
# 67
(pobj) ? static_cast< void>(0) : __assert_fail("pobj", "hydro.c", 67, __PRETTY_FUNCTION__); 
# 69
obj = ((hydro_t *)calloc(1, sizeof(hydro_t))); 
# 70
(obj) ? static_cast< void>(0) : __assert_fail("obj", "hydro.c", 70, __PRETTY_FUNCTION__); 
# 71
if (obj == (__null)) { pe_fatal(pe, "calloc(hydro) failed\n"); }  
# 73
(obj->pe) = pe; 
# 74
(obj->cs) = cs; 
...
# 81
(obj->u) = ((double *)mem_aligned_calloc(4096, 3 * (obj->nsite), sizeof(double))); 
# 83
if ((obj->u) == (__null)) { pe_fatal(pe, "calloc(hydro->u) failed\n"); }  
# 85
(obj->f) = ((double *)mem_aligned_calloc(4096, 3 * (obj->nsite), sizeof(double))); 
# 87
if ((obj->f) == (__null)) { pe_fatal(pe, "calloc(hydro->f) failed\n"); }  
# 89
(obj->eta) = ((double *)mem_aligned_calloc(4096, obj->nsite, sizeof(double))); 
# 91
if ((obj->eta) == (__null)) { pe_fatal(pe, "calloc(hydro->eta) failed\n"); }  
# 93
halo_swap_create_r1(pe, cs, nhcomm, obj->nsite, 3, &(obj->halo)); 
# 94
(obj->halo) ? static_cast< void>(0) : __assert_fail("obj->halo", "hydro.c", 94, __PRETTY_FUNCTION__); 
# 96
...
{ 
# 107
{ tdpErrorHandler(tdpMalloc((void **)(&(obj->target)), sizeof(hydro_t)), "hydro.c", 107, 1); } ; 
# 108
{ tdpErrorHandler(tdpMemset(obj->target, 0, sizeof(hydro_t)), "hydro.c", 108, 1); } ; 
# 110
{ tdpErrorHandler(tdpMalloc((void **)(&tmp), (3 * (obj->nsite)) * sizeof(double)), "hydro.c", 110, 1); } ; 
# 111
{ tdpErrorHandler(tdpMemset(tmp, 0, (3 * (obj->nsite)) * sizeof(double)), "hydro.c", 111, 1); } ; 
# 112
{ tdpErrorHandler(tdpMemcpy(&((obj->target)->u), &tmp, sizeof(double *), hipMemcpyHostToDevice), "hydro.c", 113, 1); 
# 112 "hydro.c"
} 
# 113
; 
# 115
{ tdpErrorHandler(tdpMalloc((void **)(&tmp), (3 * (obj->nsite)) * sizeof(double)), "hydro.c", 115, 1); } ; 
# 116
{ tdpErrorHandler(tdpMemset(tmp, 0, (3 * (obj->nsite)) * sizeof(double)), "hydro.c", 116, 1); } ; 
# 117
{ tdpErrorHandler(tdpMemcpy(&((obj->target)->f), &tmp, sizeof(double *), hipMemcpyHostToDevice), "hydro.c", 118, 1); 
# 117 "hydro.c"
} 
# 118
; 
# 120
{ tdpErrorHandler(tdpMalloc((void **)(&tmp), (obj->nsite) * sizeof(double)), "hydro.c", 120, 1); } ; 
# 121
{ tdpErrorHandler(tdpMemset(tmp, 0, (obj->nsite) * sizeof(double)), "hydro.c", 121, 1); } ; 
# 122
{ tdpErrorHandler(tdpMemcpy(&((obj->target)->eta), &tmp, sizeof(double *), hipMemcpyHostToDevice), "hydro.c", 123, 1); 
# 122 "hydro.c"
} 
# 123
; 
# 125
{ tdpErrorHandler(tdpMemcpy(&((obj->target)->nsite), &(obj->nsite), sizeof(int), hipMemcpyHostToDevice), "hydro.c", 126, 1); 
# 125 "hydro.c"
} 
# 126
; 
...
double *tmp; 
# 145
(obj) ? static_cast< void>(0) : __assert_fail("obj", "hydro.c", 145, __PRETTY_FUNCTION__); 
# 147
tdpGetDeviceCount(&ndevice); 
# 149
if (ndevice > 0) { 
# 150
{ tdpErrorHandler(tdpMemcpy(&tmp, &((obj->target)->u), sizeof(double *), hipMemcpyDeviceToHost), "hydro.c", 151, 1); 
# 150 "hydro.c"
} 
# 151
; 
# 152
{ tdpErrorHandler(tdpFree(tmp), "hydro.c", 152, 1); } ; 
# 153
{ tdpErrorHandler(tdpMemcpy(&tmp, &((obj->target)->f), sizeof(double *), hipMemcpyDeviceToHost), "hydro.c", 154, 1); 
# 153 "hydro.c"
} 
# 154
; 
# 155
{ tdpErrorHandler(tdpFree(tmp), "hydro.c", 155, 1); } ; 
# 156
{ tdpErrorHandler(tdpMemcpy(&tmp, &((obj->target)->eta), sizeof(double *), hipMemcpyDeviceToHost), "hydro.c", 157, 1); 
# 156 "hydro.c"
} 
# 157
; 
# 158
{ tdpErrorHandler(tdpFree(tmp), "hydro.c", 158, 1); } ; 
# 159
{ tdpErrorHandler(tdpFree(obj->target), "hydro.c", 159, 1); } ; 
# 160
}  
# 162
...
# 178
int hydro_memcpy(hydro_t *obj, tdpMemcpyKind flag) { 
# 180
int ndevice; 
# 181
double *tmpu; 
...
double *tmpeta; 
# 185
(obj) ? static_cast< void>(0) : __assert_fail("obj", "hydro.c", 185, __PRETTY_FUNCTION__); 
# 187
tdpGetDeviceCount(&ndevice); 
# 189
if (ndevice == 0) { 
# 191
((obj->target) == obj) ? static_cast< void>(0) : __assert_fail("obj->target == obj", "hydro.c", 191, __PRETTY_FUNCTION__); 
# 192
} else 
# 193
{ 
# 194
{ tdpErrorHandler(tdpMemcpy(&tmpf, &((obj->target)->f), sizeof(double *), hipMemcpyDeviceToHost), "hydro.c", 195, 1); 
# 194 "hydro.c"
} 
# 195
; 
# 196
{ tdpErrorHandler(tdpMemcpy(&tmpu, &((obj->target)->u), sizeof(double *), hipMemcpyDeviceToHost), "hydro.c", 197, 1); 
# 196 "hydro.c"
} 
# 197
; 
# 198
{ tdpErrorHandler(tdpMemcpy(&tmpeta, &((obj->target)->eta), sizeof(double *), hipMemcpyDeviceToHost), "hydro.c", 199, 1); 
# 198 "hydro.c"
} 
# 199
; 
...
case hipMemcpyHostToDevice:  
# 203
{ tdpErrorHandler(tdpMemcpy(tmpu, obj->u, (3 * (obj->nsite)) * sizeof(double), flag), "hydro.c", 203, 1); } ; 
# 204
{ tdpErrorHandler(tdpMemcpy(tmpf, obj->f, (3 * (obj->nsite)) * sizeof(double), flag), "hydro.c", 204, 1); } ; 
# 205
{ tdpErrorHandler(tdpMemcpy(tmpeta, obj->eta, (obj->nsite) * sizeof(double), flag), "hydro.c", 205, 1); } ; 
# 206
{ tdpErrorHandler(tdpMemcpy(&((obj->target)->nsite), &(obj->nsite), sizeof(int), flag), "hydro.c", 206, 1); } ; 
# 207
break; 
# 208
case hipMemcpyDeviceToHost:  
# 209
{ tdpErrorHandler(tdpMemcpy(obj->f, tmpf, (3 * (obj->nsite)) * sizeof(double), flag), "hydro.c", 209, 1); } ; 
# 210
{ tdpErrorHandler(tdpMemcpy(obj->u, tmpu, (3 * (obj->nsite)) * sizeof(double), flag), "hydro.c", 210, 1); } ; 
# 211
{ tdpErrorHandler(tdpMemcpy(obj->eta, tmpeta, (obj->nsite) * sizeof(double), flag), "hydro.c", 211, 1); } ; 
# 212
break; 
# 213
default:  
...
int hydro_u_halo(hydro_t *obj) { 
# 229
(obj) ? static_cast< void>(0) : __assert_fail("obj", "hydro.c", 229, __PRETTY_FUNCTION__); 
# 231
...
double *data; 
# 246
(obj) ? static_cast< void>(0) : __assert_fail("obj", "hydro.c", 246, __PRETTY_FUNCTION__); 
# 248
switch (flag) { 
# 249
...
# 253
{ tdpErrorHandler(tdpMemcpy(&data, &((obj->target)->u), sizeof(double *), hipMemcpyDeviceToHost), "hydro.c", 254, 1); 
# 253 "hydro.c"
} 
# 254
; 
...
default:  
# 258
(0) ? static_cast< void>(0) : __assert_fail("0", "hydro.c", 258, __PRETTY_FUNCTION__); 
# 259
}  
# 261
return 0; 
...
# 273 "hydro.c"
int hydro_init_io_info(hydro_t *obj, int grid[3], int form_in, int 
# 274
form_out) { 
# 276
io_info_arg_t args; 
# 278
(obj) ? static_cast< void>(0) : __assert_fail("obj", "hydro.c", 278, __PRETTY_FUNCTION__); 
# 279
(grid) ? static_cast< void>(0) : __assert_fail("grid", "hydro.c", 279, __PRETTY_FUNCTION__); 
# 280
((obj->info) == (__null)) ? static_cast< void>(0) : __assert_fail("obj->info == __null", "hydro.c", 280, __PRETTY_FUNCTION__); 
# 282
((args.grid)[X]) = (grid[X]); 
# 283
((args.grid)[Y]) = (grid[Y]); 
...
# 287
if ((obj->info) == (__null)) { pe_fatal(obj->pe, "io_info_create(hydro) failed\n"); }  
# 289
...
# 296
io_info_set_bytesize(obj->info, IO_FORMAT_BINARY, (3) * sizeof(double)); 
# 297
...
int hydro_io_info(hydro_t *obj, io_info_t **info) { 
# 313
(obj) ? static_cast< void>(0) : __assert_fail("obj", "hydro.c", 313, __PRETTY_FUNCTION__); 
# 314
(obj->info) ? static_cast< void>(0) : __assert_fail("obj->info", "hydro.c", 314, __PRETTY_FUNCTION__); 
# 316
(*info) = (obj->info); 
# 318
return 0; 
...
int ia; 
# 332
(obj) ? static_cast< void>(0) : __assert_fail("obj", "hydro.c", 332, __PRETTY_FUNCTION__); 
# 334
for (ia = 0; ia < 3; ia++) { 
# 335
((obj->f)[reverse_addr_rank1_assert(335, "hydro.c", obj->nsite, 3, index, ia)]) = (force[ia]); 
# 336
}  
# 338
return 0; 
...
int ia; 
# 352
(obj) ? static_cast< void>(0) : __assert_fail("obj", "hydro.c", 352, __PRETTY_FUNCTION__); 
# 354
for (ia = 0; ia < 3; ia++) { 
# 355
(force[ia]) = ((obj->f)[reverse_addr_rank1_assert(355, "hydro.c", obj->nsite, 3, index, ia)]); 
# 356
}  
# 358
return 0; 
...
int ia; 
# 374
(obj) ? static_cast< void>(0) : __assert_fail("obj", "hydro.c", 374, __PRETTY_FUNCTION__); 
# 376
for (ia = 0; ia < 3; ia++) { 
# 377
((obj->f)[reverse_addr_rank1_assert(377, "hydro.c", obj->nsite, 3, index, ia)]) += (force[ia]); 
# 378
}  
# 380
return 0; 
...
int ia; 
# 394
(obj) ? static_cast< void>(0) : __assert_fail("obj", "hydro.c", 394, __PRETTY_FUNCTION__); 
# 396
for (ia = 0; ia < 3; ia++) { 
# 397
((obj->u)[reverse_addr_rank1_assert(397, "hydro.c", obj->nsite, 3, index, ia)]) = (u[ia]); 
# 398
}  
# 400
return 0; 
...
int ia; 
# 414
(obj) ? static_cast< void>(0) : __assert_fail("obj", "hydro.c", 414, __PRETTY_FUNCTION__); 
# 416
for (ia = 0; ia < 3; ia++) { 
# 417
(u[ia]) = ((obj->u)[reverse_addr_rank1_assert(417, "hydro.c", obj->nsite, 3, index, ia)]); 
# 418
}  
# 420
return 0; 
...
double *u = (__null); 
# 434
(obj) ? static_cast< void>(0) : __assert_fail("obj", "hydro.c", 434, __PRETTY_FUNCTION__); 
# 436
{ tdpErrorHandler(tdpMemcpy(&u, &((obj->target)->u), sizeof(double *), hipMemcpyDeviceToHost), "hydro.c", 437, 1); 
# 436 "hydro.c"
} 
# 437
; 
...
# 440
do { (__cudaPushCallConfiguration(nblk, ntpb, 0, 0)) ? (void)0 : hydro_field_set(obj->target, u, uzero[X], uzero[Y], uzero[Z]); } while (0); 
# 441
; 
# 443
{ tdpErrorHandler(tdpPeekAtLastError(), "hydro.c", 443, 1); } ; 
# 444
{ tdpErrorHandler(tdpDeviceSynchronize(), "hydro.c", 444, 1); } ; 
# 446
return 0; 
# 447
} 
...
double *f; 
# 461
(obj) ? static_cast< void>(0) : __assert_fail("obj", "hydro.c", 461, __PRETTY_FUNCTION__); 
# 462
(obj->target) ? static_cast< void>(0) : __assert_fail("obj->target", "hydro.c", 462, __PRETTY_FUNCTION__); 
# 464
{ tdpErrorHandler(tdpMemcpy(&f, &((obj->target)->f), sizeof(double *), hipMemcpyDeviceToHost), "hydro.c", 465, 1); 
# 464 "hydro.c"
} 
# 465
; 
...
kernel_launch_param(obj->nsite, &nblk, &ntpb); 
# 468
do { (__cudaPushCallConfiguration(nblk, ntpb, 0, 0)) ? (void)0 : hydro_field_set(obj->target, f, fzero[X], fzero[Y], fzero[Z]); } while (0); 
# 469
; 
# 471
{ tdpErrorHandler(tdpPeekAtLastError(), "hydro.c", 471, 1); } ; 
# 472
{ tdpErrorHandler(tdpDeviceSynchronize(), "hydro.c", 472, 1); } ; 
# 474
return 0; 
# 475
} 
# 484
static void hydro_field_set(hydro_t *hydro, double *field, double zx, double zy, double 
# 485
zz) ;
#if 0
# 485
...
int kindex; 
# 489
(hydro) ? static_cast< void>(0) : __assert_fail("hydro", "hydro.c", 489, __PRETTY_FUNCTION__); 
# 490
(field) ? static_cast< void>(0) : __assert_fail("field", "hydro.c", 490, __PRETTY_FUNCTION__); 
# 492
kindex = ((1) * (((__device_builtin_variable_blockIdx.x) * (__device_builtin_variable_blockDim.x)) + (__device_builtin_variable_threadIdx.x))); if (kindex < (hydro->nsite)) { 
# 493
(field[reverse_addr_rank1_assert(493, "hydro.c", hydro->nsite, 3, kindex, X)]) = zx; 
# 494
(field[reverse_addr_rank1_assert(494, "hydro.c", hydro->nsite, 3, kindex, Y)]) = zy; 
# 495
(field[reverse_addr_rank1_assert(495, "hydro.c", hydro->nsite, 3, kindex, Z)]) = zz; 
# 496
}  
# 499
} 
...
double ule[3]; 
# 534
(obj) ? static_cast< void>(0) : __assert_fail("obj", "hydro.c", 534, __PRETTY_FUNCTION__); 
# 536
if ((obj->le) == (__null)) { return 0; }  
# 538
cs_ltot(obj->cs, ltot); 
# 539
...
for (ia = 0; ia < 3; ia++) { 
# 580
((obj->u)[reverse_addr_rank1_assert(580, "hydro.c", obj->nsite, 3, index0, ia)]) = (((ule[ia]) + (((obj->u)[reverse_addr_rank1_assert(581, "hydro.c", obj->nsite, 3, index1, ia)]) * fr)) + (((obj->u)[reverse_addr_rank1_assert(582, "hydro.c", obj->nsite, 3, index2, ia)]) * ((1.0) - fr))); 
# 583
}  
# 584
}  
...
MPI_Status status[3]; 
# 638
(obj) ? static_cast< void>(0) : __assert_fail("obj", "hydro.c", 638, __PRETTY_FUNCTION__); 
# 640
cs_ltot(obj->cs, ltot); 
# 641
cs_nhalo(obj->cs, &nhalo); 
...
lees_edw_nxbuffer(obj->le, &nxbuffer); 
# 652
nsend = ((3 * (nlocal[Y])) * ((nlocal[Z]) + (2 * nhalo))); 
# 653
nrecv = ((3 * (((nlocal[Y]) + (2 * nhalo)) + 1)) * ((nlocal[Z]) + (2 * nhalo))); 
# 655
sbuf = ((double *)calloc(nsend, sizeof(double))); 
# 656
rbuf = ((double *)calloc(nrecv, sizeof(double))); 
# 658
if (sbuf == (__null)) { pe_fatal(obj->pe, "hydro: malloc(le sbuf) failed\n"); }  
# 659
if (rbuf == (__null)) { pe_fatal(obj->pe, "hydro: malloc(le rbuf) failed\n"); }  
# 664
for (ib = 0; ib < nxbuffer; ib++) { 
# 666
ic = lees_edw_ibuff_to_real(obj->le, ib); 
...
# 694
(((n1 + n2) + n3) == ((((nlocal[Y]) + (2 * nhalo)) + 1) * ((nlocal[Z]) + (2 * nhalo)))) ? static_cast< void>(0) : __assert_fail("(n1+n2+n3) == (nlocal[Y] + 2*nhalo + 1)*(nlocal[Z] + 2*nhalo)", "hydro.c", 694, __PRETTY_FUNCTION__); 
# 698
MPI_Irecv(rbuf, 3 * n1, MPI_DOUBLE, nrank_r[0], tag0, le_comm, request); 
# 699
MPI_Irecv(rbuf + (3 * n1), 3 * n2, MPI_DOUBLE, nrank_r[1], tag1, le_comm, request + 1); 
# 701
MPI_Irecv(rbuf + (3 * (n1 + n2)), 3 * n3, MPI_DOUBLE, nrank_r[2], tag2, le_comm, request + 2); 
# 706
...
for (ia = 0; ia < 3; ia++) { 
# 710
j1 = (((((jc - 1) * 3) * ((nlocal[Z]) + (2 * nhalo))) + (3 * ((kc + nhalo) - 1))) + ia); 
# 711
((j1 >= 0) && (j1 < nsend)) ? static_cast< void>(0) : __assert_fail("j1 >= 0 && j1 < nsend", "hydro.c", 711, __PRETTY_FUNCTION__); 
# 712
(sbuf[j1]) = ((obj->u)[reverse_addr_rank1_assert(712, "hydro.c", obj->nsite, 3, index, ia)]); 
# 713
}  
# 714
}  
...
# 717
j1 = (((j2 - 1) * 3) * ((nlocal[Z]) + (2 * nhalo))); 
# 718
MPI_Issend(sbuf + j1, 3 * n1, MPI_DOUBLE, nrank_s[0], tag0, le_comm, request + 3); 
# 720
MPI_Issend(sbuf, 3 * n2, MPI_DOUBLE, nrank_s[1], tag1, le_comm, request + 4); 
# 722
MPI_Issend(sbuf, 3 * n3, MPI_DOUBLE, nrank_s[2], tag2, le_comm, request + 5); 
# 725
...
for (ia = 0; ia < 3; ia++) { 
# 738
((obj->u)[reverse_addr_rank1_assert(738, "hydro.c", obj->nsite, 3, index, ia)]) = (((ule[ia]) + (fr * (rbuf[(3 * (((j1 + kc) + nhalo) - 1)) + ia]))) + (((1.0) - fr) * (rbuf[(3 * (((j2 + kc) + nhalo) - 1)) + ia]))); 
# 741
}  
# 742
}  
...
# 766
(fp) ? static_cast< void>(0) : __assert_fail("fp", "hydro.c", 766, __PRETTY_FUNCTION__); 
# 767
(obj) ? static_cast< void>(0) : __assert_fail("obj", "hydro.c", 767, __PRETTY_FUNCTION__); 
# 769
hydro_u(obj, index, u); 
# 770
n = (fwrite(u, sizeof(double), 3, fp)); 
# 771
if (n != 3) { pe_fatal(obj->pe, "fwrite(hydro->u) failed\n"); }  
# 773
return 0; 
# 774
} 
...
hydro_t *obj = (hydro_t *)arg; 
# 788
(fp) ? static_cast< void>(0) : __assert_fail("fp", "hydro.c", 788, __PRETTY_FUNCTION__); 
# 789
(obj) ? static_cast< void>(0) : __assert_fail("obj", "hydro.c", 789, __PRETTY_FUNCTION__); 
# 791
hydro_u(obj, index, u); 
# 793
...
# 813
(fp) ? static_cast< void>(0) : __assert_fail("fp", "hydro.c", 813, __PRETTY_FUNCTION__); 
# 814
(obj) ? static_cast< void>(0) : __assert_fail("obj", "hydro.c", 814, __PRETTY_FUNCTION__); 
# 816
n = (fread(u, sizeof(double), 3, fp)); 
# 817
if (n != 3) { pe_fatal(obj->pe, "fread(hydro->u) failed\n"); }  
# 819
...
hydro_t *obj = (hydro_t *)self; 
# 836
(fp) ? static_cast< void>(0) : __assert_fail("fp", "hydro.c", 836, __PRETTY_FUNCTION__); 
# 837
(obj) ? static_cast< void>(0) : __assert_fail("obj", "hydro.c", 837, __PRETTY_FUNCTION__); 
# 839
...
# 860 "hydro.c"
int hydro_u_gradient_tensor(hydro_t *obj, int ic, int jc, int kc, double 
# 861
w[3][3]) { 
# 863
int im1, ip1; 
...
double tr; 
# 866
(obj) ? static_cast< void>(0) : __assert_fail("obj", "hydro.c", 866, __PRETTY_FUNCTION__); 
# 868
...
# 873
((w[X])[X]) = ((0.5) * (((obj->u)[reverse_addr_rank1_assert(873, "hydro.c", obj->nsite, 3, ip1, X)]) - ((obj->u)[reverse_addr_rank1_assert(874, "hydro.c", obj->nsite, 3, im1, X)]))); 
# 875
((w[Y])[X]) = ((0.5) * (((obj->u)[reverse_addr_rank1_assert(875, "hydro.c", obj->nsite, 3, ip1, Y)]) - ((obj->u)[reverse_addr_rank1_assert(876, "hydro.c", obj->nsite, 3, im1, Y)]))); 
# 877
((w[Z])[X]) = ((0.5) * (((obj->u)[reverse_addr_rank1_assert(877, "hydro.c", obj->nsite, 3, ip1, Z)]) - ((obj->u)[reverse_addr_rank1_assert(878, "hydro.c", obj->nsite, 3, im1, Z)]))); 
# 880
im1 = lees_edw_index(obj->le, ic, jc - 1, kc); 
# 881
ip1 = lees_edw_index(obj->le, ic, jc + 1, kc); 
# 883
((w[X])[Y]) = ((0.5) * (((obj->u)[reverse_addr_rank1_assert(883, "hydro.c", obj->nsite, 3, ip1, X)]) - ((obj->u)[reverse_addr_rank1_assert(884, "hydro.c", obj->nsite, 3, im1, X)]))); 
# 885
((w[Y])[Y]) = ((0.5) * (((obj->u)[reverse_addr_rank1_assert(885, "hydro.c", obj->nsite, 3, ip1, Y)]) - ((obj->u)[reverse_addr_rank1_assert(886, "hydro.c", obj->nsite, 3, im1, Y)]))); 
# 887
((w[Z])[Y]) = ((0.5) * (((obj->u)[reverse_addr_rank1_assert(887, "hydro.c", obj->nsite, 3, ip1, Z)]) - ((obj->u)[reverse_addr_rank1_assert(888, "hydro.c", obj->nsite, 3, im1, Z)]))); 
# 890
im1 = lees_edw_index(obj->le, ic, jc, kc - 1); 
# 891
ip1 = lees_edw_index(obj->le, ic, jc, kc + 1); 
# 893
((w[X])[Z]) = ((0.5) * (((obj->u)[reverse_addr_rank1_assert(893, "hydro.c", obj->nsite, 3, ip1, X)]) - ((obj->u)[reverse_addr_rank1_assert(894, "hydro.c", obj->nsite, 3, im1, X)]))); 
# 895
((w[Y])[Z]) = ((0.5) * (((obj->u)[reverse_addr_rank1_assert(895, "hydro.c", obj->nsite, 3, ip1, Y)]) - ((obj->u)[reverse_addr_rank1_assert(896, "hydro.c", obj->nsite, 3, im1, Y)]))); 
# 897
((w[Z])[Z]) = ((0.5) * (((obj->u)[reverse_addr_rank1_assert(897, "hydro.c", obj->nsite, 3, ip1, Z)]) - ((obj->u)[reverse_addr_rank1_assert(898, "hydro.c", obj->nsite, 3, im1, Z)]))); 
# 902
...
# 934
(hydro) ? static_cast< void>(0) : __assert_fail("hydro", "hydro.c", 934, __PRETTY_FUNCTION__); 
# 936
...
# 946
{ tdpErrorHandler(hipGetSymbolAddress((void **)(&fnetd), &fs), "hydro.c", 946, 1); } ; 
# 947
{ tdpErrorHandler(tdpMemcpy(fnetd, fnet, (3) * sizeof(double), hipMemcpyHostToDevice), "hydro.c", 947, 1); } ; 
# 951
do { (__cudaPushCallConfiguration(nblk, ntpb, 0, 0)) ? (void)0 : hydro_accumulate_kernel_v(ctxt, hydro->target, fnetd); } while (0); 
# 952
; 
# 954
{ tdpErrorHandler(tdpPeekAtLastError(), "hydro.c", 954, 1); } ; 
# 956
cs_ltot(hydro->cs, ltot); 
# 957
rv = ((1.0) / (((ltot[X]) * (ltot[Y])) * (ltot[Z]))); 
# 959
{ tdpErrorHandler(tdpDeviceSynchronize(), "hydro.c", 959, 1); } ; 
# 960
{ tdpErrorHandler(tdpMemcpy(fnet, fnetd, (3) * sizeof(double), hipMemcpyDeviceToHost), "hydro.c", 960, 1); } ; 
# 964
MPI_Allreduce((void *)1, fnet, 3, MPI_DOUBLE, MPI_SUM, comm); 
# 966
(fnet[X]) = ((-(fnet[X])) * rv); 
# 967
(fnet[Y]) = ((-(fnet[Y])) * rv); 
...
(fnet[Z]) = ((-(fnet[Z])) * rv); 
# 972
tdpMemcpy(fnetd, fnet, (3) * sizeof(double), hipMemcpyHostToDevice); 
# 974
do { (__cudaPushCallConfiguration(nblk, ntpb, 0, 0)) ? (void)0 : hydro_correct_kernel_v(ctxt, hydro->target, fnetd); } while (0); 
# 975
; 
# 977
{ tdpErrorHandler(tdpPeekAtLastError(), "hydro.c", 977, 1); } ; 
# 978
{ tdpErrorHandler(tdpDeviceSynchronize(), "hydro.c", 978, 1); } ; 
# 980
...
# 993 "hydro.c"
void hydro_accumulate_kernel(kernel_ctxt_t *ktx, hydro_t *hydro, double 
# 994
fnet[3]) ;
#if 0
# 994
...
double fxb, fyb, fzb; 
# 1001
__attribute__((unused)) double fx[128]; 
# 1002
__attribute__((unused)) double fy[128]; 
# 1003
__attribute__((unused)) double fz[128]; 
# 1005
(ktx) ? static_cast< void>(0) : __assert_fail("ktx", "hydro.c", 1005, __PRETTY_FUNCTION__); 
# 1006
(hydro) ? static_cast< void>(0) : __assert_fail("hydro", "hydro.c", 1006, __PRETTY_FUNCTION__); 
# 1008
tid = (__device_builtin_variable_threadIdx.x); 
# 1009
(fx[tid]) = (0.0); 
# 1010
(fy[tid]) = (0.0); 
...
#endif
# 1053 "hydro.c"
void hydro_accumulate_kernel_v(kernel_ctxt_t *ktx, hydro_t *hydro, double 
# 1054
fnet[3]) ;
#if 0
# 1054
...
__attribute__((unused)) double fz[128]; 
# 1065
(ktx) ? static_cast< void>(0) : __assert_fail("ktx", "hydro.c", 1065, __PRETTY_FUNCTION__); 
# 1066
(hydro) ? static_cast< void>(0) : __assert_fail("hydro", "hydro.c", 1066, __PRETTY_FUNCTION__); 
# 1068
tid = (__device_builtin_variable_threadIdx.x); 
# 1069
(fx[tid]) = (0.0); 
...
for (iv = 0; iv < 1; iv++) { 
# 1086
ftmp += ((hydro->f)[reverse_addr_rank1_assert(1086, "hydro.c", hydro->nsite, 3, index + iv, ia)]); 
# 1087
}  
# 1088
(f[ia]) = ftmp; 
...
#endif
# 1118 "hydro.c"
void hydro_correct_kernel(kernel_ctxt_t *ktx, hydro_t *hydro, double 
# 1119
fnet[3]) ;
#if 0
# 1119
...
int ic, jc, kc, index; 
# 1125
(ktx) ? static_cast< void>(0) : __assert_fail("ktx", "hydro.c", 1125, __PRETTY_FUNCTION__); 
# 1126
(hydro) ? static_cast< void>(0) : __assert_fail("hydro", "hydro.c", 1126, __PRETTY_FUNCTION__); 
# 1128
kiterations = kernel_iterations(ktx); 
# 1130
kindex = ((1) * (((__device_builtin_variable_blockIdx.x) * (__device_builtin_variable_blockDim.x)) + (__device_builtin_variable_threadIdx.x))); if (kindex < kiterations) { 
...
#endif
# 1151 "hydro.c"
void hydro_correct_kernel_v(kernel_ctxt_t *ktx, hydro_t *hydro, double 
# 1152
fnet[3]) ;
#if 0
# 1152
...
int iv; 
# 1160
(ktx) ? static_cast< void>(0) : __assert_fail("ktx", "hydro.c", 1160, __PRETTY_FUNCTION__); 
# 1161
(hydro) ? static_cast< void>(0) : __assert_fail("hydro", "hydro.c", 1161, __PRETTY_FUNCTION__); 
# 1163
kiterations = kernel_vector_iterations(ktx); 
# 1165
kindex = ((1) * (((__device_builtin_variable_blockIdx.x) * (__device_builtin_variable_blockDim.x)) + (__device_builtin_variable_threadIdx.x))); if (kindex < kiterations) { 
...
for (iv = 0; iv < 1; iv++) { 
# 1171
((hydro->f)[reverse_addr_rank1_assert(1171, "hydro.c", hydro->nsite, 3, index + iv, ia)]) += (fnet[ia]); 
# 1172
}  
# 1173
}  
...
# 1 "hydro.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__13_hydro_cpp1_ii_34153041
# 1 "hydro.cudafe1.stub.c"
#include "hydro.cudafe1.stub.c"
# 1 "hydro.cudafe1.stub.c"
