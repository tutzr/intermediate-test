...
# 39
(ps) ? static_cast< void>(0) : __assert_fail("ps", "colloid.c", 39, __PRETTY_FUNCTION__); 
# 40
(fp) ? static_cast< void>(0) : __assert_fail("fp", "colloid.c", 40, __PRETTY_FUNCTION__); 
# 42
...
# 95
if (nread != (32 + 48)) { ifail = 1; }  
# 98
(ifail == 0) ? static_cast< void>(0) : __assert_fail("ifail == 0", "colloid.c", 98, __PRETTY_FUNCTION__); 
# 102
(ps->rebuild) = 1; 
# 104
return ifail; 
...
int nread; 
# 119
(ps) ? static_cast< void>(0) : __assert_fail("ps", "colloid.c", 119, __PRETTY_FUNCTION__); 
# 120
(fp) ? static_cast< void>(0) : __assert_fail("fp", "colloid.c", 120, __PRETTY_FUNCTION__); 
# 122
...
# 149
(s) ? static_cast< void>(0) : __assert_fail("s", "colloid.c", 149, __PRETTY_FUNCTION__); 
# 150
(fp) ? static_cast< void>(0) : __assert_fail("fp", "colloid.c", 150, __PRETTY_FUNCTION__); 
# 152
...
# 211
if (nwrite != ((32 + 48) * 25)) { ifail = 1; }  
# 214
(ifail == 0) ? static_cast< void>(0) : __assert_fail("ifail == 0", "colloid.c", 214, __PRETTY_FUNCTION__); 
# 216
return ifail; 
# 217
} 
...
int nwrite; 
# 231
(s) ? static_cast< void>(0) : __assert_fail("s", "colloid.c", 231, __PRETTY_FUNCTION__); 
# 232
(fp) ? static_cast< void>(0) : __assert_fail("fp", "colloid.c", 232, __PRETTY_FUNCTION__); 
# 234
...
# 1 "colloid.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__15_colloid_cpp1_ii_59bf6269
# 1 "colloid.cudafe1.stub.c"
#include "colloid.cudafe1.stub.c"
# 1 "colloid.cudafe1.stub.c"
