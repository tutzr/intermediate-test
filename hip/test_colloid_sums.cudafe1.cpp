...
# 34
static int test_colloid_sums_edge(pe_t * pe, cs_t * cs, int  ncell[3], const double  r0[3]); 
# 36
...
cs_t *cs = (__null); 
# 80
(pe) ? static_cast< void>(0) : __assert_fail("pe", "test_colloid_sums.c", 80, __PRETTY_FUNCTION__); 
# 82
cs_create(pe, &cs); 
# 83
...
# 136 "test_colloid_sums.c"
static int test_colloid_sums_edge(pe_t *pe, cs_t *cs, int ncell[3], const double 
# 137
r0[3]) { 
# 138
int index; 
...
# 151
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "test_colloid_sums.c", 151, __PRETTY_FUNCTION__); 
# 152
colloid_sums_create(cinfo, &halosum); 
# 153
(halosum) ? static_cast< void>(0) : __assert_fail("halosum", "test_colloid_sums.c", 153, __PRETTY_FUNCTION__); 
# 158
index = 1; 
# 159
...
int ivalue; 
# 225
(pc) ? static_cast< void>(0) : __assert_fail("pc", "test_colloid_sums.c", 225, __PRETTY_FUNCTION__); 
# 227
ivalue = seed; 
# 233
(pc->sumw) = ((1.0) * (ivalue++)); 
...
# 274 "test_colloid_sums.c"
static int test_colloid_sums_copy(colloid_t ref, colloid_t *pc) { 
# 276
int ia; 
# 278
(pc) ? static_cast< void>(0) : __assert_fail("pc", "test_colloid_sums.c", 278, __PRETTY_FUNCTION__); 
# 280
(pc->sumw) = (ref.sumw); 
# 281
(pc->sump) = (ref.sump); 
...
# 309 "test_colloid_sums.c"
static int test_colloid_sums_assert(colloid_t c1, colloid_t *c2) { 
# 311
int ia; 
# 313
(c2) ? static_cast< void>(0) : __assert_fail("c2", "test_colloid_sums.c", 313, __PRETTY_FUNCTION__); 
# 317
test_assert_info(fabs((c1.sumw) - (c2->sumw)) < (9.999999999999999988e-15), 317, "test_colloid_sums.c"); 
# 319
for (ia = 0; ia < 3; ia++) { 
# 320
test_assert_info(fabs(((c1.cbar)[ia]) - ((c2->cbar)[ia])) < (9.999999999999999988e-15), 320, "test_colloid_sums.c"); 
# 321
test_assert_info(fabs(((c1.rxcbar)[ia]) - ((c2->rxcbar)[ia])) < (9.999999999999999988e-15), 321, "test_colloid_sums.c"); 
# 322
}  
# 326
test_assert_info(fabs((c1.sump) - (c2->sump)) < (9.999999999999999988e-15), 326, "test_colloid_sums.c"); 
# 328
for (ia = 0; ia < 3; ia++) { 
# 329
test_assert_info(fabs(((c1.f0)[ia]) - ((c2->f0)[ia])) < (9.999999999999999988e-15), 329, "test_colloid_sums.c"); 
# 330
test_assert_info(fabs(((c1.t0)[ia]) - ((c2->t0)[ia])) < (9.999999999999999988e-15), 330, "test_colloid_sums.c"); 
# 331
test_assert_info(fabs(((c1.force)[ia]) - ((c2->force)[ia])) < (9.999999999999999988e-15), 331, "test_colloid_sums.c"); 
# 332
test_assert_info(fabs(((c1.torque)[ia]) - ((c2->torque)[ia])) < (9.999999999999999988e-15), 332, "test_colloid_sums.c"); 
# 333
}  
# 335
for (ia = 0; ia < 21; ia++) { 
# 336
test_assert_info(fabs(((c1.zeta)[ia]) - ((c2->zeta)[ia])) < (9.999999999999999988e-15), 336, "test_colloid_sums.c"); 
# 337
}  
# 341
for (ia = 0; ia < 3; ia++) { 
# 342
test_assert_info(fabs(((c1.fc0)[ia]) - ((c2->fc0)[ia])) < (9.999999999999999988e-15), 342, "test_colloid_sums.c"); 
# 343
test_assert_info(fabs(((c1.tc0)[ia]) - ((c2->tc0)[ia])) < (9.999999999999999988e-15), 343, "test_colloid_sums.c"); 
# 344
}  
# 346
return 0; 
...
int ncell[3] = {8, 8, 8}; 
# 365
double r0[3] = {(56.54999999999999716), (8.550000000000000711), (3.0)}; 
# 366
double dx; 
# 368
cs_t *cs = (__null); 
...
colloids_info_t *cinfo = (__null); 
# 372
(pe) ? static_cast< void>(0) : __assert_fail("pe", "test_colloid_sums.c", 372, __PRETTY_FUNCTION__); 
# 374
cs_create(pe, &cs); 
# 375
cs_ntotal_set(cs, ntotal); 
...
colloids_info_create(pe, cs, ncell, &cinfo); 
# 379
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "test_colloid_sums.c", 379, __PRETTY_FUNCTION__); 
# 381
...
colloids_info_t *cinfo = (__null); 
# 442
(pe) ? static_cast< void>(0) : __assert_fail("pe", "test_colloid_sums.c", 442, __PRETTY_FUNCTION__); 
# 444
cs_create(pe, &cs); 
# 445
cs_ntotal_set(cs, ntotal); 
...
colloids_info_create(pe, cs, ncell, &cinfo); 
# 449
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "test_colloid_sums.c", 449, __PRETTY_FUNCTION__); 
# 451
index = 1; 
# 452
colloids_info_add_local(cinfo, index, r0, &pc); 
...
while (pc) { 
# 476
(fabs(((pc->s).deltaphi) - (1.0)) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(pc->s.deltaphi - 1.0) < double(2.22044604925031308085e-16L)", "test_colloid_sums.c", 476, __PRETTY_FUNCTION__); 
# 477
(fabs(((pc->dq)[0]) - (10.0)) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(pc->dq[0] - 10.0) < double(2.22044604925031308085e-16L)", "test_colloid_sums.c", 477, __PRETTY_FUNCTION__); 
# 478
(fabs(((pc->dq)[1]) - (100.0)) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(pc->dq[1] - 100.0) < double(2.22044604925031308085e-16L)", "test_colloid_sums.c", 478, __PRETTY_FUNCTION__); 
# 479
pc = (pc->next); 
# 480
}  
...
# 1 "test_colloid_sums.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__25_test_colloid_sums_cpp1_ii_d2162f37
# 1 "test_colloid_sums.cudafe1.stub.c"
#include "test_colloid_sums.cudafe1.stub.c"
# 1 "test_colloid_sums.cudafe1.stub.c"
