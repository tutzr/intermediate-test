...
# 42
int grad_2d_5pt_fluid_operator(lees_edw_t * le, field_grad_t * fg, int nextra, int type); 
# 44
int grad_2d_5pt_fluid_le(lees_edw_t * le, field_grad_t * fg, int nextra, int type); 
# 46
int grad_2d_5pt_fluid_wall(lees_edw_t * le, field_grad_t * fg, int nextra, int type); 
# 55
int grad_2d_5pt_fluid_d2(field_grad_t *fg) { 
# 57
int nhalo, nextra; 
# 58
lees_edw_t *le = (__null); 
# 60
(fg) ? static_cast< void>(0) : __assert_fail("fg", "gradient_2d_5pt_fluid.c", 60, __PRETTY_FUNCTION__); 
# 61
(fg->field) ? static_cast< void>(0) : __assert_fail("fg->field", "gradient_2d_5pt_fluid.c", 61, __PRETTY_FUNCTION__); 
# 63
le = ((fg->field)->le); 
# 64
...
nextra = (nhalo - 1); 
# 66
(nextra >= 0) ? static_cast< void>(0) : __assert_fail("nextra >= 0", "gradient_2d_5pt_fluid.c", 66, __PRETTY_FUNCTION__); 
# 68
...
# 80
int grad_2d_5pt_fluid_d4(field_grad_t *fg) { 
# 82
int nhalo, nextra; 
# 83
lees_edw_t *le = (__null); 
# 85
(fg) ? static_cast< void>(0) : __assert_fail("fg", "gradient_2d_5pt_fluid.c", 85, __PRETTY_FUNCTION__); 
# 86
(fg->field) ? static_cast< void>(0) : __assert_fail("fg->field", "gradient_2d_5pt_fluid.c", 86, __PRETTY_FUNCTION__); 
# 88
le = ((fg->field)->le); 
# 89
lees_edw_nhalo(le, &nhalo); 
...
nextra = (nhalo - 2); 
# 91
(nextra >= 0) ? static_cast< void>(0) : __assert_fail("nextra >= 0", "gradient_2d_5pt_fluid.c", 91, __PRETTY_FUNCTION__); 
# 93
...
# 105
int grad_2d_5pt_fluid_operator(lees_edw_t *le, field_grad_t *fg, int 
# 106
nextra, int 
# 107
type) { 
...
# 119
double *__restrict__ field = (__null); 
# 120
double *__restrict__ grad = (__null); 
# 121
double *__restrict__ del2 = (__null); 
# 123
(le) ? static_cast< void>(0) : __assert_fail("le", "gradient_2d_5pt_fluid.c", 123, __PRETTY_FUNCTION__); 
# 124
(fg) ? static_cast< void>(0) : __assert_fail("fg", "gradient_2d_5pt_fluid.c", 124, __PRETTY_FUNCTION__); 
# 126
...
# 143
((type == (GRAD_DEL2)) || (type == (GRAD_DEL4))) ? static_cast< void>(0) : __assert_fail("type == GRAD_DEL2 || type == GRAD_DEL4", "gradient_2d_5pt_fluid.c", 143, __PRETTY_FUNCTION__); 
# 145
...
for (n = 0; n < nop; n++) { 
# 155
(grad[reverse_addr_rank2_assert(155, "gradient_2d_5pt_fluid.c", nsites, nop, 3, index, n, X)]) = ((0.5) * ((field[reverse_addr_rank1_assert(156, "gradient_2d_5pt_fluid.c", nsites, nop, indexp1, n)]) - (field[reverse_addr_rank1_assert(157, "gradient_2d_5pt_fluid.c", nsites, nop, indexm1, n)]))); 
# 158
(grad[reverse_addr_rank2_assert(158, "gradient_2d_5pt_fluid.c", nsites, nop, 3, index, n, Y)]) = ((0.5) * ((field[reverse_addr_rank1_assert(159, "gradient_2d_5pt_fluid.c", nsites, nop, index + ys, n)]) - (field[reverse_addr_rank1_assert(160, "gradient_2d_5pt_fluid.c", nsites, nop, index - ys, n)]))); 
# 161
(grad[reverse_addr_rank2_assert(161, "gradient_2d_5pt_fluid.c", nsites, nop, 3, index, n, Z)]) = (0.0); 
# 163
(del2[reverse_addr_rank1_assert(163, "gradient_2d_5pt_fluid.c", nsites, nop, index, n)]) = (((((field[reverse_addr_rank1_assert(164, "gradient_2d_5pt_fluid.c", nsites, nop, indexp1, n)]) + (field[reverse_addr_rank1_assert(165, "gradient_2d_5pt_fluid.c", nsites, nop, indexm1, n)])) + (field[reverse_addr_rank1_assert(166, "gradient_2d_5pt_fluid.c", nsites, nop, index + ys, n)])) + (field[reverse_addr_rank1_assert(167, "gradient_2d_5pt_fluid.c", nsites, nop, index - ys, n)])) - ((4.0) * (field[reverse_addr_rank1_assert(168, "gradient_2d_5pt_fluid.c", nsites, nop, index, n)]))); 
# 169
}  
# 170
}  
...
# 185 "gradient_2d_5pt_fluid.c"
int grad_2d_5pt_fluid_le(lees_edw_t *le, field_grad_t *fg, int 
# 186
nextra, int type) { 
# 188
int nop; 
...
double *__restrict__ del2 = (__null); 
# 204
(le) ? static_cast< void>(0) : __assert_fail("le", "gradient_2d_5pt_fluid.c", 204, __PRETTY_FUNCTION__); 
# 205
(fg) ? static_cast< void>(0) : __assert_fail("fg", "gradient_2d_5pt_fluid.c", 205, __PRETTY_FUNCTION__); 
# 207
lees_edw_nlocal(le, nlocal); 
# 208
lees_edw_nhalo(le, &nhalo); 
...
lees_edw_nsites(le, &nsites); 
# 211
((nlocal[Z]) == 1) ? static_cast< void>(0) : __assert_fail("nlocal[Z] == 1", "gradient_2d_5pt_fluid.c", 211, __PRETTY_FUNCTION__); 
# 213
ys = ((nlocal[Z]) + (2 * nhalo)); 
# 215
nop = ((fg->field)->nf); 
...
# 226
((type == (GRAD_DEL2)) || (type == (GRAD_DEL4))) ? static_cast< void>(0) : __assert_fail("type == GRAD_DEL2 || type == GRAD_DEL4", "gradient_2d_5pt_fluid.c", 226, __PRETTY_FUNCTION__); 
# 228
...
for (n = 0; n < nop; n++) { 
# 244
(grad[reverse_addr_rank2_assert(244, "gradient_2d_5pt_fluid.c", nsites, nop, 3, index, n, X)]) = ((0.5) * ((field[reverse_addr_rank1_assert(245, "gradient_2d_5pt_fluid.c", nsites, nop, indexp1, n)]) - (field[reverse_addr_rank1_assert(246, "gradient_2d_5pt_fluid.c", nsites, nop, indexm1, n)]))); 
# 247
(grad[reverse_addr_rank2_assert(247, "gradient_2d_5pt_fluid.c", nsites, nop, 3, index, n, Y)]) = ((0.5) * ((field[reverse_addr_rank1_assert(248, "gradient_2d_5pt_fluid.c", nsites, nop, index + ys, n)]) - (field[reverse_addr_rank1_assert(249, "gradient_2d_5pt_fluid.c", nsites, nop, index - ys, n)]))); 
# 250
(grad[reverse_addr_rank2_assert(250, "gradient_2d_5pt_fluid.c", nsites, nop, 3, index, n, Z)]) = (0.0); 
# 251
(del2[reverse_addr_rank1_assert(251, "gradient_2d_5pt_fluid.c", nsites, nop, index, n)]) = (((((field[reverse_addr_rank1_assert(252, "gradient_2d_5pt_fluid.c", nsites, nop, indexp1, n)]) + (field[reverse_addr_rank1_assert(253, "gradient_2d_5pt_fluid.c", nsites, nop, indexm1, n)])) + (field[reverse_addr_rank1_assert(254, "gradient_2d_5pt_fluid.c", nsites, nop, index + ys, n)])) + (field[reverse_addr_rank1_assert(255, "gradient_2d_5pt_fluid.c", nsites, nop, index - ys, n)])) - ((4.0) * (field[reverse_addr_rank1_assert(256, "gradient_2d_5pt_fluid.c", nsites, nop, index, n)]))); 
# 257
}  
# 258
}  
...
for (n = 0; n < nop; n++) { 
# 275
(grad[reverse_addr_rank2_assert(275, "gradient_2d_5pt_fluid.c", nsites, nop, 3, index, n, X)]) = ((0.5) * ((field[reverse_addr_rank1_assert(276, "gradient_2d_5pt_fluid.c", nsites, nop, indexp1, n)]) - (field[reverse_addr_rank1_assert(277, "gradient_2d_5pt_fluid.c", nsites, nop, indexm1, n)]))); 
# 278
(grad[reverse_addr_rank2_assert(278, "gradient_2d_5pt_fluid.c", nsites, nop, 3, index, n, Y)]) = ((0.5) * ((field[reverse_addr_rank1_assert(279, "gradient_2d_5pt_fluid.c", nsites, nop, index + ys, n)]) - (field[reverse_addr_rank1_assert(280, "gradient_2d_5pt_fluid.c", nsites, nop, index - ys, n)]))); 
# 281
(grad[reverse_addr_rank2_assert(281, "gradient_2d_5pt_fluid.c", nsites, nop, 3, index, n, Z)]) = (0.0); 
# 282
(del2[reverse_addr_rank1_assert(282, "gradient_2d_5pt_fluid.c", nsites, nop, index, n)]) = (((((field[reverse_addr_rank1_assert(283, "gradient_2d_5pt_fluid.c", nsites, nop, indexp1, n)]) + (field[reverse_addr_rank1_assert(284, "gradient_2d_5pt_fluid.c", nsites, nop, indexm1, n)])) + (field[reverse_addr_rank1_assert(285, "gradient_2d_5pt_fluid.c", nsites, nop, index + ys, n)])) + (field[reverse_addr_rank1_assert(286, "gradient_2d_5pt_fluid.c", nsites, nop, index - ys, n)])) - ((4.0) * (field[reverse_addr_rank1_assert(287, "gradient_2d_5pt_fluid.c", nsites, nop, index, n)]))); 
# 288
}  
# 289
}  
...
# 1 "gradient_2d_5pt_fluid.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__29_gradient_2d_5pt_fluid_cpp1_ii_2ad85857
# 1 "gradient_2d_5pt_fluid.cudafe1.stub.c"
#include "gradient_2d_5pt_fluid.cudafe1.stub.c"
# 1 "gradient_2d_5pt_fluid.cudafe1.stub.c"
