...
# 98
tdpMemcpy(&((obj->target)->status), &tmp, sizeof(char *), hipMemcpyHostToDevice); 
# 100
tdpMemcpy(&((obj->target)->is_porous_media), &(obj->is_porous_media), sizeof(int), hipMemcpyHostToDevice); 
# 102
tdpMemcpy(&((obj->target)->nsite), &(obj->nsite), sizeof(int), hipMemcpyHostToDevice); 
# 104
tdpMemcpy(&((obj->target)->ndata), &(obj->ndata), sizeof(int), hipMemcpyHostToDevice); 
# 108
if ((obj->ndata) > 0) { 
# 109
...
# 112
{ tdpErrorHandler(tdpMemcpy(&((obj->target)->data), &dtmp, sizeof(double *), hipMemcpyHostToDevice), "map.c", 113, 1); 
# 112 "map.c"
} 
# 113
; 
...
if (ndevice > 0) { 
# 139
{ tdpErrorHandler(tdpMemcpy(&tmp, &((obj->target)->status), sizeof(char *), hipMemcpyDeviceToHost), "map.c", 140, 1); 
# 139 "map.c"
} 
# 140
; 
...
if ((obj->ndata) > 0) { 
# 144
{ tdpErrorHandler(tdpMemcpy(&dtmp, &((obj->target)->data), sizeof(double *), hipMemcpyDeviceToHost), "map.c", 145, 1); 
# 144 "map.c"
} 
# 145
; 
...
{ 
# 190
tdpMemcpy(&tmp, &((map->target)->status), sizeof(char *), hipMemcpyDeviceToHost); 
# 193
switch (flag) { 
# 194
case hipMemcpyHostToDevice:  
