...
# 35 "model.c"
extern const double cs2 = ((1.0) / (3.0)); 
# 36
extern const double rcs2 = (3.0); 
# 38
...
# 50
static lb_collide_param_t static_param; 
# 60 "model.c"
int lb_create_ndist(pe_t *pe, cs_t *cs, int ndist, lb_t **plb) { 
# 62
lb_t *lb = (__null); 
# 64
(pe) ? static_cast< void>(0) : __assert_fail("pe", "model.c", 64, __PRETTY_FUNCTION__); 
# 65
(cs) ? static_cast< void>(0) : __assert_fail("cs", "model.c", 65, __PRETTY_FUNCTION__); 
# 66
(ndist > 0) ? static_cast< void>(0) : __assert_fail("ndist > 0", "model.c", 66, __PRETTY_FUNCTION__); 
# 67
(plb) ? static_cast< void>(0) : __assert_fail("plb", "model.c", 67, __PRETTY_FUNCTION__); 
# 69
lb = ((lb_t *)calloc(1, sizeof(lb_t))); 
# 70
(lb) ? static_cast< void>(0) : __assert_fail("lb", "model.c", 70, __PRETTY_FUNCTION__); 
# 71
if (lb == (__null)) { pe_fatal(pe, "calloc(1, lb_t) failed\n"); }  
# 73
(lb->param) = ((lb_collide_param_t *)calloc(1, sizeof(lb_collide_param_t))); 
# 74
if ((lb->param) == (__null)) { pe_fatal(pe, "calloc(1, lb_collide_param_t) failed\n"); }  
# 76
(lb->pe) = pe; 
# 77
(lb->cs) = cs; 
...
# 95 "model.c"
int lb_create(pe_t *pe, cs_t *cs, lb_t **plb) { 
# 97
(pe) ? static_cast< void>(0) : __assert_fail("pe", "model.c", 97, __PRETTY_FUNCTION__); 
# 98
(cs) ? static_cast< void>(0) : __assert_fail("cs", "model.c", 98, __PRETTY_FUNCTION__); 
# 99
(plb) ? static_cast< void>(0) : __assert_fail("plb", "model.c", 99, __PRETTY_FUNCTION__); 
# 101
...
double *tmp; 
# 117
(lb) ? static_cast< void>(0) : __assert_fail("lb", "model.c", 117, __PRETTY_FUNCTION__); 
# 119
tdpGetDeviceCount(&ndevice); 
# 121
if (ndevice > 0) { 
# 122
tdpMemcpy(&tmp, &((lb->target)->f), sizeof(double *), hipMemcpyDeviceToHost); 
# 123
tdpFree(tmp); 
# 125
tdpMemcpy(&tmp, &((lb->target)->fprime), sizeof(double *), hipMemcpyDeviceToHost); 
# 127
tdpFree(tmp); 
# 128
tdpFree(lb->target); 
...
double *tmpf = (__null); 
# 171
(lb) ? static_cast< void>(0) : __assert_fail("lb", "model.c", 171, __PRETTY_FUNCTION__); 
# 173
tdpGetDeviceCount(&ndevice); 
# 175
if (ndevice == 0) { 
# 177
((lb->target) == lb) ? static_cast< void>(0) : __assert_fail("lb->target == lb", "model.c", 177, __PRETTY_FUNCTION__); 
# 178
} else 
# 179
{ 
...
# 183
(lb->target) ? static_cast< void>(0) : __assert_fail("lb->target", "model.c", 183, __PRETTY_FUNCTION__); 
# 185
tdpMemcpy(&tmpf, &((lb->target)->f), sizeof(double *), hipMemcpyDeviceToHost); 
# 187
switch (flag) { 
# 188
case hipMemcpyHostToDevice:  
...
double *tmp; 
# 225
(lb) ? static_cast< void>(0) : __assert_fail("lb", "model.c", 225, __PRETTY_FUNCTION__); 
# 227
...
# 245
(lb->f) = ((double *)mem_aligned_malloc(4096, ndata * sizeof(double))); 
# 246
if ((lb->f) == (__null)) { pe_fatal(lb->pe, "malloc(distributions) failed\n"); }  
# 247
memset(lb->f, 0, ndata * sizeof(double)); 
# 249
(lb->fprime) = ((double *)mem_aligned_malloc(4096, ndata * sizeof(double))); 
# 250
if ((lb->fprime) == (__null)) { pe_fatal(lb->pe, "malloc(distributions) failed\n"); }  
# 251
...
{ 
# 262
lb_collide_param_t *ptmp = (__null); 
# 264
...
# 269
tdpMemcpy(&((lb->target)->f), &tmp, sizeof(double *), hipMemcpyHostToDevice); 
# 271
tdpMalloc((void **)(&tmp), ndata * sizeof(double)); 
# 272
tdpMemset(tmp, 0, ndata * sizeof(double)); 
# 273
tdpMemcpy(&((lb->target)->fprime), &tmp, sizeof(double *), hipMemcpyHostToDevice); 
# 276
{ tdpErrorHandler(hipGetSymbolAddress((void **)(&ptmp), &static_param), "model.c", 276, 1); } ; 
# 277
tdpMemcpy(&((lb->target)->param), &ptmp, sizeof(lb_collide_param_t *), hipMemcpyHostToDevice); 
# 279
}  
# 287
MPI_Type_vector(nx * ny, ((lb->ndist) * (NVEL)) * nhalolocal, ((lb->ndist) * (NVEL)) * nz, MPI_DOUBLE, &(lb->plane_xy_full)); 
# 289
MPI_Type_commit(&(lb->plane_xy_full)); 
# 291
MPI_Type_vector(nx, (((lb->ndist) * (NVEL)) * nz) * nhalolocal, (((lb->ndist) * (NVEL)) * ny) * nz, MPI_DOUBLE, &(lb->plane_xz_full)); 
# 293
MPI_Type_commit(&(lb->plane_xz_full)); 
# 295
MPI_Type_vector(1, ((((lb->ndist) * (NVEL)) * ny) * nz) * nhalolocal, 1, MPI_DOUBLE, &(lb->plane_yz_full)); 
# 297
...
# 302
lb_memcpy(lb, hipMemcpyHostToDevice); 
# 304
return 0; 
# 305
} 
...
int lb_collide_param_commit(lb_t *lb) { 
# 318
(lb) ? static_cast< void>(0) : __assert_fail("lb", "model.c", 318, __PRETTY_FUNCTION__); 
# 320
{ tdpErrorHandler(hipMemcpyToSymbol(&static_param, lb->param, sizeof(lb_collide_param_t), 0, hipMemcpyHostToDevice), "model.c", 321, 1); 
# 320 "model.c"
} 
# 321
; 
...
int ia, ib, p; 
# 336
(lb) ? static_cast< void>(0) : __assert_fail("lb", "model.c", 336, __PRETTY_FUNCTION__); 
# 337
(lb->param) ? static_cast< void>(0) : __assert_fail("lb->param", "model.c", 337, __PRETTY_FUNCTION__); 
# 339
...
int lb_nvel(lb_t *lb, int *nvel) { 
# 374
(nvel) ? static_cast< void>(0) : __assert_fail("nvel", "model.c", 374, __PRETTY_FUNCTION__); 
# 376
(*nvel) = (NVEL); 
# 378
return 0; 
...
int lb_ndim(lb_t *lb, int *ndim) { 
# 391
(ndim) ? static_cast< void>(0) : __assert_fail("ndim", "model.c", 391, __PRETTY_FUNCTION__); 
# 393
(*ndim) = (NDIM); 
# 395
return 0; 
...
int lb_nblock(lb_t *lb, int dim, int *nblock) { 
# 408
(((dim == (X)) || (dim == (Y))) || (dim == (Z))) ? static_cast< void>(0) : __assert_fail("dim == X || dim == Y || dim == Z", "model.c", 408, __PRETTY_FUNCTION__); 
# 409
(nblock) ? static_cast< void>(0) : __assert_fail("nblock", "model.c", 409, __PRETTY_FUNCTION__); 
# 411
...
int ic, jc, kc, index; 
# 431
(lb) ? static_cast< void>(0) : __assert_fail("lb", "model.c", 431, __PRETTY_FUNCTION__); 
# 433
cs_nlocal(lb->cs, nlocal); 
# 435
...
# 469
(lb) ? static_cast< void>(0) : __assert_fail("lb", "model.c", 469, __PRETTY_FUNCTION__); 
# 471
cs_nhalo(lb->cs, &nhalo); 
# 472
cs_nlocal(lb->cs, nlocal); 
...
# 543
MPI_Type_vector(nx, nz, ny * nz, (lb->site_y)[FORWARD], &((lb->plane_xz_reduced)[FORWARD])); 
# 545
MPI_Type_vector(nx, nz, ny * nz, (lb->site_y)[BACKWARD], &((lb->plane_xz_reduced)[BACKWARD])); 
# 547
...
# 582
MPI_Type_vector(nx * ny, 1, nz, (lb->site_z)[BACKWARD], &((lb->plane_xy_reduced)[BACKWARD])); 
# 584
...
int n; 
# 610
(type) ? static_cast< void>(0) : __assert_fail("type", "model.c", 610, __PRETTY_FUNCTION__); 
# 612
for (n = 0; n < ntype; n++) { 
# 613
(type[n]) = (MPI_DOUBLE); 
...
# 629 "model.c"
static int lb_set_blocks(lb_t *lb, int nblock, int *block, int nbasic, const int *
# 630
basic_block) { 
# 632
int n, p; 
# 634
(lb) ? static_cast< void>(0) : __assert_fail("lb", "model.c", 634, __PRETTY_FUNCTION__); 
# 636
...
# 653 "model.c"
static int lb_set_displacements(lb_t *lb, int ndisp, MPI_Aint *disp, int 
# 654
nbasic, const int *disp_basic) { 
# 655
int n, p; 
# 656
MPI_Aint disp0, disp1; 
# 658
(lb) ? static_cast< void>(0) : __assert_fail("lb", "model.c", 658, __PRETTY_FUNCTION__); 
# 661
...
# 683
(lb) ? static_cast< void>(0) : __assert_fail("lb", "model.c", 683, __PRETTY_FUNCTION__); 
# 684
((lb->io_info) == (__null)) ? static_cast< void>(0) : __assert_fail("lb->io_info == __null", "model.c", 684, __PRETTY_FUNCTION__); 
# 686
...
# 706
int lb_io_info_set(lb_t *lb, io_info_t *io_info, int form_in, int form_out) { 
# 708
char string[4096]; 
# 710
(lb) ? static_cast< void>(0) : __assert_fail("lb", "model.c", 710, __PRETTY_FUNCTION__); 
# 711
(io_info) ? static_cast< void>(0) : __assert_fail("io_info", "model.c", 711, __PRETTY_FUNCTION__); 
# 713
(lb->io_info) = io_info; 
# 715
...
# 736 "model.c"
int lb_io_rho_set(lb_t *lb, io_info_t *io_rho, int form_in, int 
# 737
form_out) { 
# 739
char string[4096]; 
# 741
(lb) ? static_cast< void>(0) : __assert_fail("lb", "model.c", 741, __PRETTY_FUNCTION__); 
# 742
(io_rho) ? static_cast< void>(0) : __assert_fail("io_rho", "model.c", 742, __PRETTY_FUNCTION__); 
# 744
(lb->io_rho) = io_rho; 
# 746
...
int lb_io_info(lb_t *lb, io_info_t **io_info) { 
# 765
(lb) ? static_cast< void>(0) : __assert_fail("lb", "model.c", 765, __PRETTY_FUNCTION__); 
# 766
(io_info) ? static_cast< void>(0) : __assert_fail("io_info", "model.c", 766, __PRETTY_FUNCTION__); 
# 768
(*io_info) = (lb->io_info); 
# 770
return 0; 
...
int lb_halo(lb_t *lb) { 
# 784
(lb) ? static_cast< void>(0) : __assert_fail("lb", "model.c", 784, __PRETTY_FUNCTION__); 
# 786
...
# 804
(lb) ? static_cast< void>(0) : __assert_fail("lb", "model.c", 804, __PRETTY_FUNCTION__); 
# 806
switch (flag) { 
# 807
case LB_HALO_HOST:  
...
case LB_HALO_TARGET:  
# 811
tdpMemcpy(&data, &((lb->target)->f), sizeof(double *), hipMemcpyDeviceToHost); 
# 812
...
case LB_HALO_FULL:  
# 815
if (1 > 1) { pe_fatal(lb->pe, "%s\n", msg); }  
# 816
if ((DATA_MODEL_SOA) != (DATA_MODEL_AOS)) { pe_fatal(lb->pe, "%s\n", msg); }  
# 817
lb_halo_set(lb, LB_HALO_FULL); 
# 818
...
default:  
# 828
(0) ? static_cast< void>(0) : __assert_fail("0", "model.c", 828, __PRETTY_FUNCTION__); 
# 829
}  
# 834
return 0; 
...
MPI_Comm comm; 
# 865
(lb) ? static_cast< void>(0) : __assert_fail("lb", "model.c", 865, __PRETTY_FUNCTION__); 
# 867
cs_nhalo(lb->cs, &nhalo); 
# 868
cs_nlocal(lb->cs, nlocal); 
...
# 895
MPI_Irecv((lb->f) + ihalo, 1, (lb->plane_yz)[BACKWARD], pforw, tagb, comm, &(request[0])); 
# 897
ihalo = (((lb->ndist) * (NVEL)) * cs_index(lb->cs, 0, 1 - nhalo, 1 - nhalo)); 
# 898
MPI_Irecv((lb->f) + ihalo, 1, (lb->plane_yz)[FORWARD], pback, tagf, comm, &(request[1])); 
# 900
ireal = (((lb->ndist) * (NVEL)) * cs_index(lb->cs, 1, 1 - nhalo, 1 - nhalo)); 
# 901
MPI_Issend((lb->f) + ireal, 1, (lb->plane_yz)[BACKWARD], pback, tagb, comm, &(request[2])); 
# 903
ireal = (((lb->ndist) * (NVEL)) * cs_index(lb->cs, nlocal[X], 1 - nhalo, 1 - nhalo)); 
# 904
MPI_Issend((lb->f) + ireal, 1, (lb->plane_yz)[FORWARD], pforw, tagf, comm, &(request[3])); 
# 906
...
# 931
MPI_Irecv((lb->f) + ihalo, 1, (lb->plane_xz)[BACKWARD], pforw, tagb, comm, &(request[0])); 
# 933
ihalo = (((lb->ndist) * (NVEL)) * cs_index(lb->cs, 1 - nhalo, 0, 1 - nhalo)); 
# 934
MPI_Irecv((lb->f) + ihalo, 1, (lb->plane_xz)[FORWARD], pback, tagf, comm, &(request[1])); 
# 936
ireal = (((lb->ndist) * (NVEL)) * cs_index(lb->cs, 1 - nhalo, 1, 1 - nhalo)); 
# 937
MPI_Issend((lb->f) + ireal, 1, (lb->plane_xz)[BACKWARD], pback, tagb, comm, &(request[2])); 
# 939
ireal = (((lb->ndist) * (NVEL)) * cs_index(lb->cs, 1 - nhalo, nlocal[Y], 1 - nhalo)); 
# 940
MPI_Issend((lb->f) + ireal, 1, (lb->plane_xz)[FORWARD], pforw, tagf, comm, &(request[3])); 
# 942
MPI_Waitall(4, request, status); 
# 943
}  
...
# 967
MPI_Irecv((lb->f) + ihalo, 1, (lb->plane_xy)[BACKWARD], pforw, tagb, comm, &(request[0])); 
# 969
ihalo = (((lb->ndist) * (NVEL)) * cs_index(lb->cs, 1 - nhalo, 1 - nhalo, 0)); 
# 970
MPI_Irecv((lb->f) + ihalo, 1, (lb->plane_xy)[FORWARD], pback, tagf, comm, &(request[1])); 
# 972
ireal = (((lb->ndist) * (NVEL)) * cs_index(lb->cs, 1 - nhalo, 1 - nhalo, 1)); 
# 973
MPI_Issend((lb->f) + ireal, 1, (lb->plane_xy)[BACKWARD], pback, tagb, comm, &(request[2])); 
# 975
ireal = (((lb->ndist) * (NVEL)) * cs_index(lb->cs, 1 - nhalo, 1 - nhalo, nlocal[Z])); 
# 976
MPI_Issend((lb->f) + ireal, 1, (lb->plane_xy)[FORWARD], pforw, tagf, comm, &(request[3])); 
# 978
MPI_Waitall(4, request, status); 
# 979
}  
...
lb_t *lb = (lb_t *)self; 
# 999
(fp) ? static_cast< void>(0) : __assert_fail("fp", "model.c", 999, __PRETTY_FUNCTION__); 
# 1000
(lb) ? static_cast< void>(0) : __assert_fail("lb", "model.c", 1000, __PRETTY_FUNCTION__); 
# 1002
for (n = 0; n < (lb->ndist); n++) { 
# 1003
for (p = 0; p < (NVEL); p++) { 
# 1004
iread = reverse_addr_rank2_assert(1004, "model.c", lb->nsite, lb->ndist, NVEL, index, n, p); 
# 1005
...
lb_t *lb = (lb_t *)self; 
# 1030
(fp) ? static_cast< void>(0) : __assert_fail("fp", "model.c", 1030, __PRETTY_FUNCTION__); 
# 1031
(lb) ? static_cast< void>(0) : __assert_fail("lb", "model.c", 1031, __PRETTY_FUNCTION__); 
# 1033
pe = (lb->pe); 
# 1036
nr = fscanf(fp, "%*d %*d %*d"); 
# 1037
(nr == 1) ? static_cast< void>(0) : __assert_fail("nr == 1", "model.c", 1037, __PRETTY_FUNCTION__); 
# 1039
nr = 0; 
# 1040
for (n = 0; n < (lb->ndist); n++) { 
...
for (p = 0; p < (NVEL); p++) { 
# 1042
nr += fscanf(fp, "%le", &((lb->f)[reverse_addr_rank2_assert(1043, "model.c", lb->nsite, lb->ndist, NVEL, index, n, p)])); 
# 1044
}  
# 1045
}  
...
lb_t *lb = (lb_t *)self; 
# 1067
(fp) ? static_cast< void>(0) : __assert_fail("fp", "model.c", 1067, __PRETTY_FUNCTION__); 
# 1068
(self) ? static_cast< void>(0) : __assert_fail("self", "model.c", 1068, __PRETTY_FUNCTION__); 
# 1070
for (n = 0; n < (lb->ndist); n++) { 
# 1071
for (p = 0; p < (NVEL); p++) { 
# 1072
iwrite = reverse_addr_rank2_assert(1072, "model.c", lb->nsite, lb->ndist, NVEL, index, n, p); 
# 1073
...
# 1101
(fp) ? static_cast< void>(0) : __assert_fail("fp", "model.c", 1101, __PRETTY_FUNCTION__); 
# 1102
(self) ? static_cast< void>(0) : __assert_fail("self", "model.c", 1102, __PRETTY_FUNCTION__); 
# 1104
pe = (lb->pe); 
# 1105
cs = (lb->cs); 
...
for (p = 0; p < (NVEL); p++) { 
# 1115
fprintf(fp, "%le ", (lb->f)[reverse_addr_rank2_assert(1115, "model.c", lb->nsite, lb->ndist, NVEL, index, n, p)]); 
# 1116
nw++; 
# 1117
}  
...
lb_t *lb = (lb_t *)self; 
# 1140
(fp) ? static_cast< void>(0) : __assert_fail("fp", "model.c", 1140, __PRETTY_FUNCTION__); 
# 1141
(lb) ? static_cast< void>(0) : __assert_fail("lb", "model.c", 1141, __PRETTY_FUNCTION__); 
# 1143
...
lb_t *lb = (lb_t *)self; 
# 1163
(fp) ? static_cast< void>(0) : __assert_fail("fp", "model.c", 1163, __PRETTY_FUNCTION__); 
# 1164
(lb) ? static_cast< void>(0) : __assert_fail("lb", "model.c", 1164, __PRETTY_FUNCTION__); 
# 1166
lb_0th_moment(lb, index, LB_RHO, &rho); 
# 1167
...
# 1183
(lb) ? static_cast< void>(0) : __assert_fail("lb", "model.c", 1183, __PRETTY_FUNCTION__); 
# 1185
...
int lb_ndist(lb_t *lb, int *ndist) { 
# 1216
(lb) ? static_cast< void>(0) : __assert_fail("lb", "model.c", 1216, __PRETTY_FUNCTION__); 
# 1217
(ndist) ? static_cast< void>(0) : __assert_fail("ndist", "model.c", 1217, __PRETTY_FUNCTION__); 
# 1219
(*ndist) = (lb->ndist); 
# 1221
return 0; 
...
# 1235
(lb) ? static_cast< void>(0) : __assert_fail("lb", "model.c", 1235, __PRETTY_FUNCTION__); 
# 1236
(n > 0) ? static_cast< void>(0) : __assert_fail("n > 0", "model.c", 1236, __PRETTY_FUNCTION__); 
# 1237
((lb->f) == (__null)) ? static_cast< void>(0) : __assert_fail("lb->f == __null", "model.c", 1237, __PRETTY_FUNCTION__); 
# 1239
(lb->ndist) = n; 
# 1241
return 0; 
...
int lb_f(lb_t *lb, int index, int p, int n, double *f) { 
# 1255
(lb) ? static_cast< void>(0) : __assert_fail("lb", "model.c", 1255, __PRETTY_FUNCTION__); 
# 1256
((index >= 0) && (index < (lb->nsite))) ? static_cast< void>(0) : __assert_fail("index >= 0 && index < lb->nsite", "model.c", 1256, __PRETTY_FUNCTION__); 
# 1257
((p >= 0) && (p < (NVEL))) ? static_cast< void>(0) : __assert_fail("p >= 0 && p < NVEL", "model.c", 1257, __PRETTY_FUNCTION__); 
# 1258
((n >= 0) && (n < (lb->ndist))) ? static_cast< void>(0) : __assert_fail("n >= 0 && n < lb->ndist", "model.c", 1258, __PRETTY_FUNCTION__); 
# 1260
(*f) = ((lb->f)[reverse_addr_rank2_assert(1260, "model.c", lb->nsite, lb->ndist, NVEL, index, n, p)]); 
# 1262
return 0; 
# 1263
} 
...
# 1276
(lb) ? static_cast< void>(0) : __assert_fail("lb", "model.c", 1276, __PRETTY_FUNCTION__); 
# 1277
((index >= 0) && (index < (lb->nsite))) ? static_cast< void>(0) : __assert_fail("index >= 0 && index < lb->nsite", "model.c", 1277, __PRETTY_FUNCTION__); 
# 1278
((p >= 0) && (p < (NVEL))) ? static_cast< void>(0) : __assert_fail("p >= 0 && p < NVEL", "model.c", 1278, __PRETTY_FUNCTION__); 
# 1279
((n >= 0) && (n < (lb->ndist))) ? static_cast< void>(0) : __assert_fail("n >= 0 && n < lb->ndist", "model.c", 1279, __PRETTY_FUNCTION__); 
# 1281
((lb->f)[reverse_addr_rank2_assert(1281, "model.c", lb->nsite, lb->ndist, NVEL, index, n, p)]) = fvalue; 
# 1283
return 0; 
# 1284
} 
...
int p; 
# 1299
(lb) ? static_cast< void>(0) : __assert_fail("lb", "model.c", 1299, __PRETTY_FUNCTION__); 
# 1300
(rho) ? static_cast< void>(0) : __assert_fail("rho", "model.c", 1300, __PRETTY_FUNCTION__); 
# 1301
((index >= 0) && (index < (lb->nsite))) ? static_cast< void>(0) : __assert_fail("index >= 0 && index < lb->nsite", "model.c", 1301, __PRETTY_FUNCTION__); 
# 1302
(nd < (lb->ndist)) ? static_cast< void>(0) : __assert_fail("nd < lb->ndist", "model.c", 1302, __PRETTY_FUNCTION__); 
# 1304
(*rho) = (0.0); 
# 1306
for (p = 0; p < (NVEL); p++) { 
# 1307
(*rho) += ((lb->f)[reverse_addr_rank2_assert(1307, "model.c", lb->nsite, lb->ndist, NVEL, index, nd, p)]); 
# 1308
}  
# 1310
return 0; 
...
int n; 
# 1327
(lb) ? static_cast< void>(0) : __assert_fail("lb", "model.c", 1327, __PRETTY_FUNCTION__); 
# 1328
((index >= 0) && (index < (lb->nsite))) ? static_cast< void>(0) : __assert_fail("index >= 0 && index < lb->nsite", "model.c", 1328, __PRETTY_FUNCTION__); 
# 1329
(nd < (lb->ndist)) ? static_cast< void>(0) : __assert_fail("nd < lb->ndist", "model.c", 1329, __PRETTY_FUNCTION__); 
# 1332
for (n = 0; n < 3; n++) { 
# 1333
(g[n]) = (0.0); 
...
for (n = 0; n < (NDIM); n++) { 
# 1338
(g[n]) += (((cv[p])[n]) * ((lb->f)[reverse_addr_rank2_assert(1338, "model.c", lb->nsite, lb->ndist, NVEL, index, nd, p)])); 
# 1339
}  
# 1340
}  
...
int p, ia, ib; 
# 1358
(lb) ? static_cast< void>(0) : __assert_fail("lb", "model.c", 1358, __PRETTY_FUNCTION__); 
# 1359
(nd == (LB_RHO)) ? static_cast< void>(0) : __assert_fail("nd == LB_RHO", "model.c", 1359, __PRETTY_FUNCTION__); 
# 1360
((index >= 0) && (index < (lb->nsite))) ? static_cast< void>(0) : __assert_fail("index >= 0 && index < lb->nsite", "model.c", 1360, __PRETTY_FUNCTION__); 
# 1362
for (ia = 0; ia < (NDIM); ia++) { 
# 1363
for (ib = 0; ib < (NDIM); ib++) { 
...
for (ib = 0; ib < (NDIM); ib++) { 
# 1371
((s[ia])[ib]) += (((lb->f)[reverse_addr_rank2_assert(1371, "model.c", lb->nsite, lb->ndist, NVEL, index, nd, p)]) * (((q_[p])[ia])[ib])); 
# 1373
}  
# 1374
}  
...
int p; 
# 1395
(lb) ? static_cast< void>(0) : __assert_fail("lb", "model.c", 1395, __PRETTY_FUNCTION__); 
# 1396
((n >= 0) && (n < (lb->ndist))) ? static_cast< void>(0) : __assert_fail("n >= 0 && n < lb->ndist", "model.c", 1396, __PRETTY_FUNCTION__); 
# 1397
((index >= 0) && (index < (lb->nsite))) ? static_cast< void>(0) : __assert_fail("index >= 0 && index < lb->nsite", "model.c", 1397, __PRETTY_FUNCTION__); 
# 1399
for (p = 0; p < (NVEL); p++) { 
# 1400
((lb->f)[reverse_addr_rank2_assert(1400, "model.c", lb->nsite, lb->ndist, NVEL, index, n, p)]) = ((wv[p]) * rho); 
# 1401
}  
# 1403
return 0; 
...
double sdotq; 
# 1421
(lb) ? static_cast< void>(0) : __assert_fail("lb", "model.c", 1421, __PRETTY_FUNCTION__); 
# 1422
((index >= 0) && (index < (lb->nsite))) ? static_cast< void>(0) : __assert_fail("index >= 0 && index < lb->nsite", "model.c", 1422, __PRETTY_FUNCTION__); 
# 1424
for (p = 0; p < (NVEL); p++) { 
# 1425
udotc = (0.0); 
...
# 1434
((lb->f)[reverse_addr_rank2_assert(1434, "model.c", lb->nsite, lb->ndist, NVEL, index, LB_RHO, p)]) = ((rho * (wv[p])) * (((1.0) + (rcs2 * udotc)) + ((((0.5) * rcs2) * rcs2) * sdotq))); 
# 1436
}  
# 1438
return 0; 
...
int p; 
# 1454
(lb) ? static_cast< void>(0) : __assert_fail("lb", "model.c", 1454, __PRETTY_FUNCTION__); 
# 1455
((n >= 0) && (n < (lb->ndist))) ? static_cast< void>(0) : __assert_fail("n >= 0 && n < lb->ndist", "model.c", 1455, __PRETTY_FUNCTION__); 
# 1456
((index >= 0) && (index < (lb->nsite))) ? static_cast< void>(0) : __assert_fail("index >= 0 && index < lb->nsite", "model.c", 1456, __PRETTY_FUNCTION__); 
# 1458
for (p = 0; p < (NVEL); p++) { 
# 1459
(f[p]) = ((lb->f)[reverse_addr_rank2_assert(1459, "model.c", lb->nsite, lb->ndist, NVEL, index, n, p)]); 
# 1460
}  
# 1462
return 0; 
...
# 1476 "model.c"
int lb_f_multi_index(lb_t *lb, int index, int n, double fv[NVEL][1]) { 
# 1478
int p, iv; 
# 1480
(lb) ? static_cast< void>(0) : __assert_fail("lb", "model.c", 1480, __PRETTY_FUNCTION__); 
# 1481
((n >= 0) && (n < (lb->ndist))) ? static_cast< void>(0) : __assert_fail("n >= 0 && n < lb->ndist", "model.c", 1481, __PRETTY_FUNCTION__); 
# 1482
((index >= 0) && (index < (lb->nsite))) ? static_cast< void>(0) : __assert_fail("index >= 0 && index < lb->nsite", "model.c", 1482, __PRETTY_FUNCTION__); 
# 1484
for (p = 0; p < (NVEL); p++) { 
# 1485
for (iv = 0; iv < 1; iv++) { 
# 1486
((fv[p])[iv]) = ((lb->f)[reverse_addr_rank2_assert(1486, "model.c", lb->nsite, lb->ndist, NVEL, index + iv, n, p)]); 
# 1487
}  
# 1488
}  
...
# 1503 "model.c"
int lb_f_multi_index_part(lb_t *lb, int index, int n, double fv[NVEL][1], int 
# 1504
nv) { 
# 1506
int p, iv; 
# 1508
(lb) ? static_cast< void>(0) : __assert_fail("lb", "model.c", 1508, __PRETTY_FUNCTION__); 
# 1509
((n >= 0) && (n < (lb->ndist))) ? static_cast< void>(0) : __assert_fail("n >= 0 && n < lb->ndist", "model.c", 1509, __PRETTY_FUNCTION__); 
# 1510
((index >= 0) && (index < (lb->nsite))) ? static_cast< void>(0) : __assert_fail("index >= 0 && index < lb->nsite", "model.c", 1510, __PRETTY_FUNCTION__); 
# 1511
(0) ? static_cast< void>(0) : __assert_fail("0", "model.c", 1511, __PRETTY_FUNCTION__); 
# 1513
for (p = 0; p < (NVEL); p++) { 
# 1514
for (iv = 0; iv < nv; iv++) { 
# 1515
((fv[p])[iv]) = ((lb->f)[reverse_addr_rank2_assert(1515, "model.c", lb->nsite, lb->ndist, NVEL, index + iv, n, p)]); 
# 1516
}  
# 1517
}  
...
int p; 
# 1536
(lb) ? static_cast< void>(0) : __assert_fail("lb", "model.c", 1536, __PRETTY_FUNCTION__); 
# 1537
((n >= 0) && (n < (lb->ndist))) ? static_cast< void>(0) : __assert_fail("n >= 0 && n < lb->ndist", "model.c", 1537, __PRETTY_FUNCTION__); 
# 1538
((index >= 0) && (index < (lb->nsite))) ? static_cast< void>(0) : __assert_fail("index >= 0 && index < lb->nsite", "model.c", 1538, __PRETTY_FUNCTION__); 
# 1540
for (p = 0; p < (NVEL); p++) { 
# 1541
((lb->f)[reverse_addr_rank2_assert(1541, "model.c", lb->nsite, lb->ndist, NVEL, index, n, p)]) = (f[p]); 
# 1542
}  
# 1544
return 0; 
...
# 1558 "model.c"
int lb_f_multi_index_set(lb_t *lb, int index, int n, double fv[NVEL][1]) { 
# 1560
int p, iv; 
# 1562
(lb) ? static_cast< void>(0) : __assert_fail("lb", "model.c", 1562, __PRETTY_FUNCTION__); 
# 1563
((n >= 0) && (n < (lb->ndist))) ? static_cast< void>(0) : __assert_fail("n >= 0 && n < lb->ndist", "model.c", 1563, __PRETTY_FUNCTION__); 
# 1564
((index >= 0) && (index < (lb->nsite))) ? static_cast< void>(0) : __assert_fail("index >= 0 && index < lb->nsite", "model.c", 1564, __PRETTY_FUNCTION__); 
# 1565
(0) ? static_cast< void>(0) : __assert_fail("0", "model.c", 1565, __PRETTY_FUNCTION__); 
# 1566
for (p = 0; p < (NVEL); p++) { 
# 1567
for (iv = 0; iv < 1; iv++) { 
# 1568
((lb->f)[reverse_addr_rank2_assert(1568, "model.c", lb->nsite, lb->ndist, NVEL, index + iv, n, p)]) = ((fv[p])[iv]); 
# 1569
}  
# 1570
}  
...
# 1585 "model.c"
int lb_f_multi_index_set_part(lb_t *lb, int index, int n, double 
# 1586
fv[NVEL][1], int nv) { 
# 1587
int p, iv; 
# 1589
(lb) ? static_cast< void>(0) : __assert_fail("lb", "model.c", 1589, __PRETTY_FUNCTION__); 
# 1590
((n >= 0) && (n < (lb->ndist))) ? static_cast< void>(0) : __assert_fail("n >= 0 && n < lb->ndist", "model.c", 1590, __PRETTY_FUNCTION__); 
# 1591
((index >= 0) && (index < (lb->nsite))) ? static_cast< void>(0) : __assert_fail("index >= 0 && index < lb->nsite", "model.c", 1591, __PRETTY_FUNCTION__); 
# 1592
(0) ? static_cast< void>(0) : __assert_fail("0", "model.c", 1592, __PRETTY_FUNCTION__); 
# 1593
for (p = 0; p < (NVEL); p++) { 
# 1594
for (iv = 0; iv < nv; iv++) { 
# 1595
((lb->f)[reverse_addr_rank2_assert(1595, "model.c", lb->nsite, lb->ndist, NVEL, index + iv, n, p)]) = ((fv[p])[iv]); 
# 1596
}  
# 1597
}  
...
int lb_order(lb_t *lb) { 
# 1612
(lb) ? static_cast< void>(0) : __assert_fail("lb", "model.c", 1612, __PRETTY_FUNCTION__); 
# 1614
return lb->model; 
# 1615
} 
...
MPI_Comm comm; 
# 1652
(lb) ? static_cast< void>(0) : __assert_fail("lb", "model.c", 1652, __PRETTY_FUNCTION__); 
# 1654
cs_nlocal(lb->cs, nlocal); 
# 1655
cs_cart_comm(lb->cs, &comm); 
...
# 1665
(sendback && sendforw) ? static_cast< void>(0) : __assert_fail("sendback && sendforw", "model.c", 1665, __PRETTY_FUNCTION__); 
# 1666
(recvforw && recvback) ? static_cast< void>(0) : __assert_fail("recvforw && recvback", "model.c", 1666, __PRETTY_FUNCTION__); 
# 1667
if (sendforw == (__null)) { pe_fatal(lb->pe, "malloc(sendforw) failed\n"); }  
# 1668
if (sendback == (__null)) { pe_fatal(lb->pe, "malloc(sendback) failed\n"); }  
# 1669
if (recvforw == (__null)) { pe_fatal(lb->pe, "malloc(recvforw) failed\n"); }  
# 1670
if (recvforw == (__null)) { pe_fatal(lb->pe, "malloc(recvback) failed\n"); }  
# 1672
count = 0; 
# 1673
for (p = 0; p < (NVEL); p++) { 
...
# 1679
indexreal = reverse_addr_rank2_assert(1679, "model.c", lb->nsite, lb->ndist, NVEL, index, n, p); 
# 1680
(sendforw[count]) = ((lb->f)[indexreal]); 
# 1682
index = cs_index(lb->cs, 1, jc, kc); 
# 1683
indexreal = reverse_addr_rank2_assert(1683, "model.c", lb->nsite, lb->ndist, NVEL, index, n, p); 
# 1684
...
# 1690
(count == nsend) ? static_cast< void>(0) : __assert_fail("count == nsend", "model.c", 1690, __PRETTY_FUNCTION__); 
# 1692
if ((mpi_cartsz[X]) == 1) { 
# 1693
...
# 1718
indexhalo = reverse_addr_rank2_assert(1718, "model.c", lb->nsite, lb->ndist, NVEL, index, n, p); 
# 1719
((lb->f)[indexhalo]) = (recvback[count]); 
# 1721
index = cs_index(lb->cs, (nlocal[X]) + 1, jc, kc); 
# 1722
indexhalo = reverse_addr_rank2_assert(1722, "model.c", lb->nsite, lb->ndist, NVEL, index, n, p); 
# 1723
...
# 1729
(count == nsend) ? static_cast< void>(0) : __assert_fail("count == nsend", "model.c", 1729, __PRETTY_FUNCTION__); 
# 1731
free(recvback); 
# 1732
free(recvforw); 
...
# 1762
indexreal = reverse_addr_rank2_assert(1762, "model.c", lb->nsite, lb->ndist, NVEL, index, n, p); 
# 1763
(sendforw[count]) = ((lb->f)[indexreal]); 
# 1765
index = cs_index(lb->cs, ic, 1, kc); 
# 1766
indexreal = reverse_addr_rank2_assert(1766, "model.c", lb->nsite, lb->ndist, NVEL, index, n, p); 
# 1767
(sendback[count]) = ((lb->f)[indexreal]); 
# 1768
++count; 
...
# 1773
(count == nsend) ? static_cast< void>(0) : __assert_fail("count == nsend", "model.c", 1773, __PRETTY_FUNCTION__); 
# 1776
if ((mpi_cartsz[Y]) == 1) { 
# 1777
memcpy(recvback, sendforw, nsend * sizeof(double)); 
...
# 1802
indexhalo = reverse_addr_rank2_assert(1802, "model.c", lb->nsite, lb->ndist, NVEL, index, n, p); 
# 1803
((lb->f)[indexhalo]) = (recvback[count]); 
# 1805
index = cs_index(lb->cs, ic, (nlocal[Y]) + 1, kc); 
# 1806
indexhalo = reverse_addr_rank2_assert(1806, "model.c", lb->nsite, lb->ndist, NVEL, index, n, p); 
# 1807
((lb->f)[indexhalo]) = (recvforw[count]); 
# 1808
++count; 
...
# 1813
(count == nsend) ? static_cast< void>(0) : __assert_fail("count == nsend", "model.c", 1813, __PRETTY_FUNCTION__); 
# 1814
free(recvback); 
# 1815
free(recvforw); 
...
# 1844
indexreal = reverse_addr_rank2_assert(1844, "model.c", lb->nsite, lb->ndist, NVEL, index, n, p); 
# 1845
(sendforw[count]) = ((lb->f)[indexreal]); 
# 1847
index = cs_index(lb->cs, ic, jc, 1); 
# 1848
indexreal = reverse_addr_rank2_assert(1848, "model.c", lb->nsite, lb->ndist, NVEL, index, n, p); 
# 1849
(sendback[count]) = ((lb->f)[indexreal]); 
# 1850
++count; 
...
# 1855
(count == nsend) ? static_cast< void>(0) : __assert_fail("count == nsend", "model.c", 1855, __PRETTY_FUNCTION__); 
# 1857
if ((mpi_cartsz[Z]) == 1) { 
# 1858
memcpy(recvback, sendforw, nsend * sizeof(double)); 
...
# 1883
indexhalo = reverse_addr_rank2_assert(1883, "model.c", lb->nsite, lb->ndist, NVEL, index, n, p); 
# 1884
((lb->f)[indexhalo]) = (recvback[count]); 
# 1886
index = cs_index(lb->cs, ic, jc, (nlocal[Z]) + 1); 
# 1887
indexhalo = reverse_addr_rank2_assert(1887, "model.c", lb->nsite, lb->ndist, NVEL, index, n, p); 
# 1888
((lb->f)[indexhalo]) = (recvforw[count]); 
# 1889
++count; 
...
# 1894
(count == nsend) ? static_cast< void>(0) : __assert_fail("count == nsend", "model.c", 1894, __PRETTY_FUNCTION__); 
# 1895
free(recvback); 
# 1896
free(recvforw); 
...
# 1 "model.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__13_model_cpp1_ii_cs2
# 1 "model.cudafe1.stub.c"
#include "model.cudafe1.stub.c"
# 1 "model.cudafe1.stub.c"
