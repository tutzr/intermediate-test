...
# 29 "polar_active_rt.c"
static int polar_active_init_code(field_t * p); 
# 39 "polar_active_rt.c"
int polar_active_run_time(pe_t *pe, rt_t *rt, fe_polar_t *fe) { 
# 41
fe_polar_param_t param; 
# 43
(pe) ? static_cast< void>(0) : __assert_fail("pe", "polar_active_rt.c", 43, __PRETTY_FUNCTION__); 
# 44
(rt) ? static_cast< void>(0) : __assert_fail("rt", "polar_active_rt.c", 44, __PRETTY_FUNCTION__); 
# 45
(fe) ? static_cast< void>(0) : __assert_fail("fe", "polar_active_rt.c", 45, __PRETTY_FUNCTION__); 
# 47
...
char key[8192]; 
# 86
(p) ? static_cast< void>(0) : __assert_fail("p", "polar_active_rt.c", 86, __PRETTY_FUNCTION__); 
# 88
rt_string_parameter(rt, "polar_active_initialisation", key, 8192); 
# 90
if (strcmp(key, "from_file") == 0) { 
# 91
(0) ? static_cast< void>(0) : __assert_fail("0", "polar_active_rt.c", 91, __PRETTY_FUNCTION__); 
# 93
}  
# 95
...
double p[3]; 
# 125
(fp) ? static_cast< void>(0) : __assert_fail("fp", "polar_active_rt.c", 125, __PRETTY_FUNCTION__); 
# 127
...
# 170
(fp) ? static_cast< void>(0) : __assert_fail("fp", "polar_active_rt.c", 170, __PRETTY_FUNCTION__); 
# 172
cs_nlocal(fp->cs, nlocal); 
# 173
cs_nlocal_offset(fp->cs, noffset); 
...
# 1 "polar_active_rt.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__23_polar_active_rt_cpp1_ii_bda303ce
# 1 "polar_active_rt.cudafe1.stub.c"
#include "polar_active_rt.cudafe1.stub.c"
# 1 "polar_active_rt.cudafe1.stub.c"
