...
# 41
static int fepsilon_constant(void * fe, int index, double * epsilon); 
# 42
static int fepsilon_sinz(void * fe, int index, double * epsilon); 
# 50
int test_psi_sor_suite() { 
# 52
pe_t *pe = (__null); 
...
psi_t *psi = (__null); 
# 84
(pe) ? static_cast< void>(0) : __assert_fail("pe", "test_psi_sor.c", 84, __PRETTY_FUNCTION__); 
# 86
cs_create(pe, &cs); 
# 87
cs_nhalo_set(cs, 1); 
...
# 93
(psi) ? static_cast< void>(0) : __assert_fail("psi", "test_psi_sor.c", 93, __PRETTY_FUNCTION__); 
# 94
...
psi_halo_rho(psi); 
# 112
psi_sor_vare_poisson(psi, __null, fepsilon_sinz); 
# 116
psi_free(psi); 
# 117
cs_free(cs); 
...
# 157
rho0 = ((1.0) / (((2.0) * (ltot[X])) * (ltot[Y]))); 
# 158
rho1 = ((1.0) / (((ltot[X]) * (ltot[Y])) * ((ltot[Z]) - (2.0)))); 
# 160
psi_nk(psi, &nk); 
# 161
test_assert_info(nk == 2, 161, "test_psi_sor.c"); 
# 165
...
# 210
test_assert_info(fabs((rho_min[0]) - (0.0)) < ((double)(2.2204460492503130808e-16L)), 210, "test_psi_sor.c"); 
# 211
test_assert_info(fabs((rho_max[0]) - (0.0)) < ((double)(2.2204460492503130808e-16L)), 211, "test_psi_sor.c"); 
# 212
test_assert_info(fabs((rho_tot[0]) - (0.0)) < ((double)(2.2204460492503130808e-16L)), 212, "test_psi_sor.c"); 
# 214
test_assert_info(fabs((rho_min[1]) - (0.0)) < ((double)(2.2204460492503130808e-16L)), 214, "test_psi_sor.c"); 
# 215
test_assert_info(fabs((rho_max[1]) - rho0) < ((double)(2.2204460492503130808e-16L)), 215, "test_psi_sor.c"); 
# 216
test_assert_info(fabs((rho_tot[1]) - (1.0)) < ((double)(2.2204460492503130808e-16L)), 216, "test_psi_sor.c"); 
# 218
test_assert_info(fabs((rho_min[2]) - (0.0)) < ((double)(2.2204460492503130808e-16L)), 218, "test_psi_sor.c"); 
# 219
test_assert_info(fabs((rho_max[2]) - rho1) < ((double)(2.2204460492503130808e-16L)), 219, "test_psi_sor.c"); 
# 220
test_assert_info(fabs((rho_tot[2]) - (1.0)) < ((1.192092896e-07F)), 220, "test_psi_sor.c"); 
# 222
test_assert_info(fabs((rho_min[3]) + rho1) < ((double)(2.2204460492503130808e-16L)), 222, "test_psi_sor.c"); 
# 223
test_assert_info(fabs((rho_max[3]) - rho0) < ((double)(2.2204460492503130808e-16L)), 223, "test_psi_sor.c"); 
# 224
test_assert_info(fabs((rho_tot[3]) - (0.0)) < ((1.192092896e-07F)), 224, "test_psi_sor.c"); 
# 225
}  
# 227
return 0; 
...
# 291
(epsilon) ? static_cast< void>(0) : __assert_fail("epsilon", "test_psi_sor.c", 291, __PRETTY_FUNCTION__); 
# 292
if (epsilon == (__null)) { pe_fatal(obj->pe, "calloc(epsilon) failed\n"); }  
# 294
for (k = 0; k < n; k++) { 
# 295
index = cs_index(obj->cs, 1, 1, 1 + k); 
# 296
fepsilon(__null, index, epsilon + k); 
# 297
}  
# 301
...
# 304
(a && b && c) ? static_cast< void>(0) : __assert_fail("a && b && c", "test_psi_sor.c", 304, __PRETTY_FUNCTION__); 
# 305
if (a == (__null)) { pe_fatal(obj->pe, "calloc(a) failed\n"); }  
# 306
if (b == (__null)) { pe_fatal(obj->pe, "calloc(b) failed\n"); }  
# 307
if (c == (__null)) { pe_fatal(obj->pe, "calloc(c) failed\n"); }  
# 315
for (k = 0; k < n; k++) { 
# 317
kp1 = (k + 1); 
...
# 341
test_assert_info(ifail == 0, 341, "test_psi_sor.c"); 
# 345
...
if (k == 0) { psi0 = psi; }  
# 354
test_assert_info(fabs(((b[k]) + psi0) - psi) < tolerance, 354, "test_psi_sor.c"); 
# 356
kp1 = (k + 1); 
# 357
km1 = (k - 1); 
...
emh = ((0.5) * ((epsilon[km1]) + (epsilon[k]))); 
# 363
rhodiff = (((emh * ((obj->psi)[index - 1])) - ((emh + eph) * ((obj->psi)[index]))) + (eph * ((obj->psi)[index + 1]))); 
# 366
test_assert_info(fabs((c[k]) - rhodiff) < tolerance, 366, "test_psi_sor.c"); 
# 367
rhotot += (c[k]); 
# 368
}  
# 371
test_assert_info(fabs(rhotot) < tolerance, 371, "test_psi_sor.c"); 
# 373
free(c); 
# 374
free(b); 
...
static int fepsilon_constant(void *fe, int index, double *epsilon) { 
# 391
(epsilon) ? static_cast< void>(0) : __assert_fail("epsilon", "test_psi_sor.c", 391, __PRETTY_FUNCTION__); 
# 393
(*epsilon) = (1.0); 
# 395
return 0; 
...
static int fepsilon_sinz(void *fe, int index, double *epsilon) { 
# 411
test_assert_info(0, 411, "test_psi_sor.c"); 
# 425 "test_psi_sor.c"
return 0; 
# 426
} 

# 1 "test_psi_sor.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__20_test_psi_sor_cpp1_ii_ba44b732
# 1 "test_psi_sor.cudafe1.stub.c"
#include "test_psi_sor.cudafe1.stub.c"
# 1 "test_psi_sor.cudafe1.stub.c"
