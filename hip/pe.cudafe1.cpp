...
pe_t *pe = (__null); 
# 57
(ppe) ? static_cast< void>(0) : __assert_fail("ppe", "pe.c", 57, __PRETTY_FUNCTION__); 
# 59
...
# 75
(pe) ? static_cast< void>(0) : __assert_fail("pe", "pe.c", 75, __PRETTY_FUNCTION__); 
# 76
(pe->unquiet) = 0; 
# 77
...
int pe_retain(pe_t *pe) { 
# 107
(pe) ? static_cast< void>(0) : __assert_fail("pe", "pe.c", 107, __PRETTY_FUNCTION__); 
# 109
(pe->nref) += 1; 
# 111
return 0; 
...
int pe_free(pe_t *pe) { 
# 124
(pe) ? static_cast< void>(0) : __assert_fail("pe", "pe.c", 124, __PRETTY_FUNCTION__); 
# 126
(pe->nref) -= 1; 
# 128
if ((pe->nref) <= 0) { 
...
int pe_message(pe_t *pe) { 
# 148
(pe) ? static_cast< void>(0) : __assert_fail("pe", "pe.c", 148, __PRETTY_FUNCTION__); 
# 150
pe_info(pe, "Welcome to Ludwig v%d.%d.%d (%s version running on %d process%s)\n\n", 0, 12, 0, ((pe->mpi_size) > 1) ? "MPI" : ("Serial"), pe->mpi_size, ((pe->mpi_size) == 1) ? "" : ("es")); 
# 156
if ((pe->mpi_rank) == 0) { 
# 157
(printf("Note assertions via standard C assert() are on.\n\n")) ? static_cast< void>(0) : __assert_fail("printf(\"Note assertions via standard C assert() are on.\\n\\n\")", "pe.c", 157, __PRETTY_FUNCTION__); 
# 158
...
va_list args; 
# 177
(pe) ? static_cast< void>(0) : __assert_fail("pe", "pe.c", 177, __PRETTY_FUNCTION__); 
# 179
if ((pe->mpi_rank) == 0) { 
# 180
...
va_list args; 
# 200
(pe) ? static_cast< void>(0) : __assert_fail("pe", "pe.c", 200, __PRETTY_FUNCTION__); 
# 202
...
va_list args; 
# 227
(pe) ? static_cast< void>(0) : __assert_fail("pe", "pe.c", 227, __PRETTY_FUNCTION__); 
# 229
printf("[%d] ", pe->mpi_rank); 
# 231
__builtin_va_start((args),fmt); 
...
int pe_subdirectory_set(pe_t *pe, const char *name) { 
# 246
(pe) ? static_cast< void>(0) : __assert_fail("pe", "pe.c", 246, __PRETTY_FUNCTION__); 
# 247
if (name != (__null)) { sprintf(pe->subdirectory, "%s/", name); }  
# 249
return 0; 
# 250
} 
...
int pe_subdirectory(pe_t *pe, char *name) { 
# 260
(pe) ? static_cast< void>(0) : __assert_fail("pe", "pe.c", 260, __PRETTY_FUNCTION__); 
# 261
(name) ? static_cast< void>(0) : __assert_fail("name", "pe.c", 261, __PRETTY_FUNCTION__); 
# 263
...
int pe_set(pe_t *pe, pe_enum_t option) { 
# 276
(pe) ? static_cast< void>(0) : __assert_fail("pe", "pe.c", 276, __PRETTY_FUNCTION__); 
# 278
switch (option) { 
# 279
case PE_QUIET:  
...
default:  
# 286
(0) ? static_cast< void>(0) : __assert_fail("0", "pe.c", 286, __PRETTY_FUNCTION__); 
# 287
}  
# 289
return 0; 
...
int pe_mpi_comm(pe_t *pe, MPI_Comm *comm) { 
# 300
(pe) ? static_cast< void>(0) : __assert_fail("pe", "pe.c", 300, __PRETTY_FUNCTION__); 
# 301
(comm) ? static_cast< void>(0) : __assert_fail("comm", "pe.c", 301, __PRETTY_FUNCTION__); 
# 303
(*comm) = (pe->comm); 
# 305
return 0; 
...
int pe_mpi_rank(pe_t *pe) { 
# 316
(pe) ? static_cast< void>(0) : __assert_fail("pe", "pe.c", 316, __PRETTY_FUNCTION__); 
# 318
return pe->mpi_rank; 
# 319
} 
...
int pe_mpi_size(pe_t *pe) { 
# 329
(pe) ? static_cast< void>(0) : __assert_fail("pe", "pe.c", 329, __PRETTY_FUNCTION__); 
# 331
return pe->mpi_size; 
# 332
} 
...
# 1 "pe.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__10_pe_cpp1_ii_1fb12ceb
# 1 "pe.cudafe1.stub.c"
#include "pe.cudafe1.stub.c"
# 1 "pe.cudafe1.stub.c"
