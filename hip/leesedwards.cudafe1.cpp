...
# 127
{ tdpErrorHandler(hipGetSymbolAddress((void **)(&tmp), &static_param), "leesedwards.c", 127, 1); } ; 
# 128
tdpMemcpy(&((le->target)->param), (const void *)(&tmp), sizeof(lees_edw_param_t *), hipMemcpyHostToDevice); 
# 131
cs_target(cs, &cst); 
# 132
tdpMemcpy(&((le->target)->cs), &cst, sizeof(cs_t *), hipMemcpyHostToDevice); 
# 134
lees_edw_commit(le); 
# 135
}  
...
# 195
{ tdpErrorHandler(hipMemcpyToSymbol(&static_param, le->param, sizeof(lees_edw_param_t), 0, hipMemcpyHostToDevice), "leesedwards.c", 196, 1); 
# 195 "leesedwards.c"
} 
# 196
; 
