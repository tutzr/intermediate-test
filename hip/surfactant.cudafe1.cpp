...
# 109
{ tdpErrorHandler(hipGetSymbolAddress((void **)(&tmp), &const_param), "surfactant.c", 109, 1); } ; 
# 110
tdpMemcpy(&((obj->target)->param), tmp, sizeof(fe_surfactant1_param_t *), hipMemcpyHostToDevice); 
# 113
