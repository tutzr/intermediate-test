...
# 24
int psi_init_gouy_chapman(psi_t * obj, map_t * map, double rho_el, double sigma); 
# 26
...
double diffacc; 
# 62
(pe) ? static_cast< void>(0) : __assert_fail("pe", "psi_rt.c", 62, __PRETTY_FUNCTION__); 
# 63
(rt) ? static_cast< void>(0) : __assert_fail("rt", "psi_rt.c", 63, __PRETTY_FUNCTION__); 
# 65
psi_nk(obj, &nk); 
# 66
(nk == 2) ? static_cast< void>(0) : __assert_fail("nk == 2", "psi_rt.c", 66, __PRETTY_FUNCTION__); 
# 68
...
# 149
rt_string_parameter(rt, "psi_format", value, 8192); 
# 151
...
io_info_t *iohandler; 
# 193
(pe) ? static_cast< void>(0) : __assert_fail("pe", "psi_rt.c", 193, __PRETTY_FUNCTION__); 
# 194
(rt) ? static_cast< void>(0) : __assert_fail("rt", "psi_rt.c", 194, __PRETTY_FUNCTION__); 
# 198
pe_info(pe, "\n"); 
# 199
...
pe_info(pe, "------------------------\n"); 
# 202
rt_string_parameter(rt, "electrokinetics_init", value, 8192); 
# 204
...
psi_init_uniform(obj, rho_el); 
# 289
n = rt_string_parameter(rt, "porous_media_file", filestub, 4096); 
# 290
...
# 1 "psi_rt.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__14_psi_rt_cpp1_ii_437b7dad
# 1 "psi_rt.cudafe1.stub.c"
#include "psi_rt.cudafe1.stub.c"
# 1 "psi_rt.cudafe1.stub.c"
