...
double ah = (3.5); 
# 71
double vf = (0.02000000000000000042); 
# 72
double dh = (0.5); 
# 73
double q0 = (0.0); 
...
ran_init(pe); 
# 86
(pe_mpi_size(pe) == 1) ? static_cast< void>(0) : __assert_fail("pe_mpi_size(pe) == 1", "colloid_init.c", 86, __PRETTY_FUNCTION__); 
# 88
cs_create(pe, &cs); 
# 89
...
# 100
(state != (__null)) ? static_cast< void>(0) : __assert_fail("state != __null", "colloid_init.c", 100, __PRETTY_FUNCTION__); 
# 102
...
# 147
(cs) ? static_cast< void>(0) : __assert_fail("cs", "colloid_init.c", 147, __PRETTY_FUNCTION__); 
# 149
cs_ntotal(cs, ntotal); 
# 151
...
# 183
(lmax >= lmin) ? static_cast< void>(0) : __assert_fail("lmax >= lmin", "colloid_init.c", 183, __PRETTY_FUNCTION__); 
# 184
...
# 202 "colloid_init.c"
int colloid_init_random(cs_t *cs, int nc, colloid_state_t *state, double 
# 203
dh) { 
# 205
int n; 
...
double rsep[3]; 
# 214
(cs) ? static_cast< void>(0) : __assert_fail("cs", "colloid_init.c", 214, __PRETTY_FUNCTION__); 
# 216
n = 0; 
# 217
nmaxattempt = (nc * 10000); 
# 219
...
double delta; 
# 276
(cs) ? static_cast< void>(0) : __assert_fail("cs", "colloid_init.c", 276, __PRETTY_FUNCTION__); 
# 277
cs_ntotal(cs, ntotal); 
# 280
ah_ref = ((state[0]).ah); 
...
# 434
delta = ((0.01000000000000000021) * ah_ref); 
# 436
for (im = 0; im < 10000000; im++) { 
# 438
if ((im % 1000) == 0) { 
# 439
...
# 525
void colloid_init_write_file(const int nc, const colloid_state_t *pc, const int 
# 526
form) { 
# 527
int n; 
...
# 574
double eps = (100.0), sig = (0.05000000000000000278); 
# 575
double v, v_rc; 
# 577
if (dr <= rc) { 
...
# 1 "colloid_init.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__20_colloid_init_cpp1_ii_main
# 1 "colloid_init.cudafe1.stub.c"
#include "colloid_init.cudafe1.stub.c"
# 1 "colloid_init.cudafe1.stub.c"
