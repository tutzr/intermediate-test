...
# 33
(pe) ? static_cast< void>(0) : __assert_fail("pe", "test_pe.c", 33, __PRETTY_FUNCTION__); 
# 35
test_assert_info(1, 35, "test_pe.c"); 
# 37
MPI_Comm_rank(MPI_COMM_WORLD, &my_rank); 
# 38
MPI_Comm_size(MPI_COMM_WORLD, &my_size); 
# 40
test_assert_info(pe_mpi_rank(pe) == my_rank, 40, "test_pe.c"); 
# 42
test_assert_info(pe_mpi_size(pe) == my_size, 42, "test_pe.c"); 
# 44
...
# 1 "test_pe.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__15_test_pe_cpp1_ii_ff7f569e
# 1 "test_pe.cudafe1.stub.c"
#include "test_pe.cudafe1.stub.c"
# 1 "test_pe.cudafe1.stub.c"
