...
int n, nk; 
# 43
(obj) ? static_cast< void>(0) : __assert_fail("obj", "psi_init.c", 43, __PRETTY_FUNCTION__); 
# 44
(rho_el >= (0.0)) ? static_cast< void>(0) : __assert_fail("rho_el >= 0.0", "psi_init.c", 44, __PRETTY_FUNCTION__); 
# 46
...
# 83 "psi_init.c"
int psi_init_gouy_chapman(psi_t *obj, map_t *map, double rho_el, double 
# 84
sigma) { 
# 86
int ic, jc, kc, index; 
...
double ltot[3]; 
# 93
(obj) ? static_cast< void>(0) : __assert_fail("obj", "psi_init.c", 93, __PRETTY_FUNCTION__); 
# 94
(map) ? static_cast< void>(0) : __assert_fail("map", "psi_init.c", 94, __PRETTY_FUNCTION__); 
# 96
cs_nlocal(obj->cs, nlocal); 
# 97
cs_ltot(obj->cs, ltot); 
...
int nlocal[3], noff[3]; 
# 179
(obj) ? static_cast< void>(0) : __assert_fail("obj", "psi_init.c", 179, __PRETTY_FUNCTION__); 
# 181
cs_nlocal(obj->cs, nlocal); 
# 182
...
double sigma; 
# 224
(psi) ? static_cast< void>(0) : __assert_fail("psi", "psi_init.c", 224, __PRETTY_FUNCTION__); 
# 225
(map) ? static_cast< void>(0) : __assert_fail("map", "psi_init.c", 225, __PRETTY_FUNCTION__); 
# 227
...
# 1 "psi_init.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__16_psi_init_cpp1_ii_2638e1e5
# 1 "psi_init.cudafe1.stub.c"
#include "psi_init.cudafe1.stub.c"
# 1 "psi_init.cudafe1.stub.c"
