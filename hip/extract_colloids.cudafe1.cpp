...
# 50 "extract_colloids.c"
static const int iread_ascii = 1; 
# 51
static const int include_ref = 0; 
# 52
static const int id = 1; 
# 53
static const int cds_with_m = 0; 
# 54
static const int cds_with_v = 1; 
# 56
...
if (argc == 5) { 
# 106
vel = ((double ****)calloc(32, sizeof(double ***))); 
# 107
for (ix = 0; ix < 32; ix++) { 
# 108
(vel[ix]) = ((double ***)calloc(32, sizeof(double **))); 
# 109
for (iy = 0; iy < 32; iy++) { 
# 110
((vel[ix])[iy]) = ((double **)calloc(32, sizeof(double *))); 
# 111
for (iz = 0; iz < 32; iz++) { 
# 112
...
# 155
(nread == 1) ? static_cast< void>(0) : __assert_fail("nread == 1", "extract_colloids.c", 155, __PRETTY_FUNCTION__); 
# 156
} else 
# 157
{ 
...
# 159
(nread == 1) ? static_cast< void>(0) : __assert_fail("nread == 1", "extract_colloids.c", 159, __PRETTY_FUNCTION__); 
# 160
}  
# 161
...
# 1 "extract_colloids.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__24_extract_colloids_cpp1_ii_main
# 1 "extract_colloids.cudafe1.stub.c"
#include "extract_colloids.cudafe1.stub.c"
# 1 "extract_colloids.cudafe1.stub.c"
