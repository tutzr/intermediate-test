...
double r[10]; 
# 71
unsigned state_ref[4] = {(123), (456), (78), (9)}; 
# 72
unsigned state[4] = {(0), (0), (0), (0)}; 
# 74
(pe) ? static_cast< void>(0) : __assert_fail("pe", "test_noise.c", 74, __PRETTY_FUNCTION__); 
# 75
test_assert_info(10 == 10, 75, "test_noise.c"); 
# 76
test_assert_info(4 == 4, 76, "test_noise.c"); 
# 78
...
# 85
(noise) ? static_cast< void>(0) : __assert_fail("noise", "test_noise.c", 85, __PRETTY_FUNCTION__); 
# 86
noise_init(noise, 0); 
# 91
noise_uniform(state); 
# 93
test_assert_info((state[0]) == (1234567), 93, "test_noise.c"); 
# 94
test_assert_info((state[1]) == (0), 94, "test_noise.c"); 
# 95
test_assert_info((state[2]) == (0), 95, "test_noise.c"); 
# 96
test_assert_info((state[3]) == (0), 96, "test_noise.c"); 
# 100
noise_state_set(noise, 0, state_ref); 
# 101
noise_state(noise, 0, state); 
# 103
test_assert_info((state[0]) == (state_ref[0]), 103, "test_noise.c"); 
# 104
test_assert_info((state[1]) == (state_ref[1]), 104, "test_noise.c"); 
# 105
test_assert_info((state[2]) == (state_ref[2]), 105, "test_noise.c"); 
# 106
test_assert_info((state[3]) == (state_ref[3]), 106, "test_noise.c"); 
# 108
noise_reap(noise, 0, r); 
# 110
test_assert_info(fabs((r[0]) - (+a1)) < ((double)(2.2204460492503130808e-16L)), 110, "test_noise.c"); 
# 111
test_assert_info(fabs((r[1]) - (-a1)) < ((double)(2.2204460492503130808e-16L)), 111, "test_noise.c"); 
# 112
test_assert_info(fabs((r[2]) - (0.0)) < ((double)(2.2204460492503130808e-16L)), 112, "test_noise.c"); 
# 113
test_assert_info(fabs((r[3]) - (+a2)) < ((double)(2.2204460492503130808e-16L)), 113, "test_noise.c"); 
# 114
test_assert_info(fabs((r[4]) - (+a2)) < ((double)(2.2204460492503130808e-16L)), 114, "test_noise.c"); 
# 115
test_assert_info(fabs((r[5]) - (0.0)) < ((double)(2.2204460492503130808e-16L)), 115, "test_noise.c"); 
# 116
test_assert_info(fabs((r[6]) - (0.0)) < ((double)(2.2204460492503130808e-16L)), 116, "test_noise.c"); 
# 117
test_assert_info(fabs((r[7]) - (0.0)) < ((double)(2.2204460492503130808e-16L)), 117, "test_noise.c"); 
# 118
test_assert_info(fabs((r[8]) - (0.0)) < ((double)(2.2204460492503130808e-16L)), 118, "test_noise.c"); 
# 119
test_assert_info(fabs((r[9]) - (0.0)) < ((double)(2.2204460492503130808e-16L)), 119, "test_noise.c"); 
# 121
noise_free(noise); 
# 122
cs_free(cs); 
...
MPI_Comm comm; 
# 151
(pe) ? static_cast< void>(0) : __assert_fail("pe", "test_noise.c", 151, __PRETTY_FUNCTION__); 
# 153
cs_create(pe, &cs); 
# 154
cs_init(cs); 
...
# 183
(rstat[1]) = (((rstat[1]) / ((((10) * (ltot[X])) * (ltot[Y])) * (ltot[Z]))) - ((rstat[0]) * (rstat[0]))); 
# 186
test_assert_info(fabs((rstat[0]) - (0.004101055729999999837)) < ((1.192092896e-07F)), 186, "test_noise.c"); 
# 187
test_assert_info(fabs((rstat[1]) - (1.001778400000000069)) < ((1.192092896e-07F)), 187, "test_noise.c"); 
# 189
noise_free(noise); 
# 190
cs_free(cs); 
...
noise_t *noise = (__null); 
# 230
(pe) ? static_cast< void>(0) : __assert_fail("pe", "test_noise.c", 230, __PRETTY_FUNCTION__); 
# 233
const int ntimes = 1000000; 
# 234
const double tolerance = (0.05000000000000000278); 
# 236
cs_create(pe, &cs); 
# 237
...
# 246
(moment6) ? static_cast< void>(0) : __assert_fail("moment6", "test_noise.c", 246, __PRETTY_FUNCTION__); 
# 250
...
# 293
test_assert_info(fabs(m1 - (0.0)) < tolerance, 293, "test_noise.c"); 
# 294
test_assert_info(fabs(m2 - (1.0)) < tolerance, 294, "test_noise.c"); 
# 295
test_assert_info(fabs(m3 - (0.0)) < tolerance, 295, "test_noise.c"); 
# 296
test_assert_info(fabs(m4 - (3.0)) < tolerance, 296, "test_noise.c"); 
# 297
test_assert_info(fabs(m5 - (0.0)) < tolerance, 297, "test_noise.c"); 
# 298
test_assert_info(fabs(m6 - (10.0)) < tolerance, 298, "test_noise.c"); 
# 300
}  
# 301
}  
...
# 1 "test_noise.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__18_test_noise_cpp1_ii_9285e541
# 1 "test_noise.cudafe1.stub.c"
#include "test_noise.cudafe1.stub.c"
# 1 "test_noise.cudafe1.stub.c"
