...
# 37 "gradient_rt.c"
int gradient_rt_init(pe_t *pe, rt_t *rt, const char *fieldname, field_grad_t *
# 38
grad, map_t *map, colloids_info_t *
# 39
cinfo) { 
# 41
int n; 
...
char keyvalue[8192]; 
# 44
int (*f2)(field_grad_t * fg) = (__null); 
# 45
int (*f4)(field_grad_t * fg) = (__null); 
# 47
(grad) ? static_cast< void>(0) : __assert_fail("grad", "gradient_rt.c", 47, __PRETTY_FUNCTION__); 
# 54
n = rt_string_parameter(rt, "fd_gradient_calculation", keyvalue, 8192); 
# 56
if (strcmp(fieldname, "phi") == 0) { 
# 57
n += rt_string_parameter(rt, "fd_gradient_calculation_phi", keyvalue, 8192); 
# 59
}  
# 60
if (strcmp(fieldname, "q") == 0) { 
# 61
n += rt_string_parameter(rt, "fd_gradient_calculation_q", keyvalue, 8192); 
# 63
}  
# 65
if (n == 0) { 
...
# 76
if (strcmp(keyvalue, "2d_tomita_fluid") == 0) { 
# 77
...
# 81
if (strcmp(keyvalue, "3d_7pt_fluid") == 0) { 
# 82
...
# 87
if (strcmp(keyvalue, "3d_7pt_solid") == 0) { 
# 88
...
# 92
(map) ? static_cast< void>(0) : __assert_fail("map", "gradient_rt.c", 92, __PRETTY_FUNCTION__); 
# 93
grad_3d_7pt_solid_set(map, cinfo); 
# 94
} else { 
# 95
if (strcmp(keyvalue, "3d_27pt_fluid") == 0) { 
# 96
...
# 101
if (strcmp(keyvalue, "3d_27pt_solid") == 0) { 
# 102
...
# 106
(map) ? static_cast< void>(0) : __assert_fail("map", "gradient_rt.c", 106, __PRETTY_FUNCTION__); 
# 107
...
# 1 "gradient_rt.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__19_gradient_rt_cpp1_ii_52344068
# 1 "gradient_rt.cudafe1.stub.c"
#include "gradient_rt.cudafe1.stub.c"
# 1 "gradient_rt.cudafe1.stub.c"
