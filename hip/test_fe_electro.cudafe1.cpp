...
# 95
(pe) ? static_cast< void>(0) : __assert_fail("pe", "test_fe_electro.c", 95, __PRETTY_FUNCTION__); 
# 96
(cs) ? static_cast< void>(0) : __assert_fail("cs", "test_fe_electro.c", 96, __PRETTY_FUNCTION__); 
# 97
(phys) ? static_cast< void>(0) : __assert_fail("phys", "test_fe_electro.c", 97, __PRETTY_FUNCTION__); 
# 99
...
# 105
(fe) ? static_cast< void>(0) : __assert_fail("fe", "test_fe_electro.c", 105, __PRETTY_FUNCTION__); 
# 109
rho0 = (1.0); 
# 110
rho1 = (1.0); 
# 111
fed0 = (rho0 * (log(rho0 + ((double)(2.2204460492503130808e-16L))) - (1.0))); 
# 112
fed1 = (rho0 * (log(rho1 + ((double)(2.2204460492503130808e-16L))) - (1.0))); 
# 114
...
# 119
test_assert_info(fabs(fed - (fed0 + fed1)) < ((double)(2.2204460492503130808e-16L)), 119, "test_fe_electro.c"); 
# 121
rho0 = exp((1.0)); 
# 122
...
fe_electro_fed(fe, index, &fed); 
# 126
test_assert_info(fabs(fed - (fed0 + fed1)) < ((double)(2.2204460492503130808e-16L)), 126, "test_fe_electro.c"); 
# 128
rho1 = exp((2.0)); 
# 129
...
fe_electro_fed(fe, index, &fed); 
# 133
test_assert_info(fabs(fed - (fed0 + fed1)) < ((double)(2.2204460492503130808e-16L)), 133, "test_fe_electro.c"); 
# 137
psi0 = (2.0); 
# 138
...
fe_electro_fed(fe, index, &fed); 
# 145
test_assert_info(fabs(fed - (fed0 + fed1)) < ((double)(2.2204460492503130808e-16L)), 145, "test_fe_electro.c"); 
# 147
fe_electro_free(fe); 
# 148
psi_free(psi); 
...
int nk = 3; 
# 165
double kt = (0.1000000000000000056); 
# 166
double eunit = (1.0); 
# 167
...
fe_electro_t *fe = (__null); 
# 178
(pe) ? static_cast< void>(0) : __assert_fail("pe", "test_fe_electro.c", 178, __PRETTY_FUNCTION__); 
# 179
(cs) ? static_cast< void>(0) : __assert_fail("cs", "test_fe_electro.c", 179, __PRETTY_FUNCTION__); 
# 180
(phys) ? static_cast< void>(0) : __assert_fail("phys", "test_fe_electro.c", 180, __PRETTY_FUNCTION__); 
# 182
psi_create(pe, cs, nk, &psi); 
# 183
psi_unit_charge_set(psi, eunit); 
...
fe_electro_create(pe, psi, &fe); 
# 187
(fe) ? static_cast< void>(0) : __assert_fail("fe", "test_fe_electro.c", 187, __PRETTY_FUNCTION__); 
# 189
for (n = 0; n < 3; n++) { 
# 190
rho0 = ((1.0) + ((1.0) * n)); 
...
# 199
test_assert_info(fabs((mu[n]) - mu0) < ((double)(2.2204460492503130808e-16L)), 199, "test_fe_electro.c"); 
# 202
psi0 = (1.0); 
# 203
psi_psi_set(psi, index, psi0); 
...
fe_electro_mu(fe, index, mu); 
# 206
test_assert_info(fabs((mu[n]) - mu0) < ((double)(2.2204460492503130808e-16L)), 206, "test_fe_electro.c"); 
# 207
}  
# 209
fe_electro_free(fe); 
...
fe_electro_t *fe = (__null); 
# 244
(pe) ? static_cast< void>(0) : __assert_fail("pe", "test_fe_electro.c", 244, __PRETTY_FUNCTION__); 
# 245
(cs) ? static_cast< void>(0) : __assert_fail("cs", "test_fe_electro.c", 245, __PRETTY_FUNCTION__); 
# 246
(phys) ? static_cast< void>(0) : __assert_fail("phys", "test_fe_electro.c", 246, __PRETTY_FUNCTION__); 
# 248
psi_create(pe, cs, nk, &psi); 
# 249
...
fe_electro_create(pe, psi, &fe); 
# 252
(fe) ? static_cast< void>(0) : __assert_fail("fe", "test_fe_electro.c", 252, __PRETTY_FUNCTION__); 
# 254
physics_kt_set(phys, kt); 
# 259
...
sexpect = (0.0); 
# 265
test_assert_info(fabs(((s[ia])[ib]) - sexpect) < ((double)(2.2204460492503130808e-16L)), 265, "test_fe_electro.c"); 
# 266
}  
# 267
}  
...
# 296
test_assert_info(fabs(((s[ia])[ib]) - sexpect) < ((double)(2.2204460492503130808e-16L)), 296, "test_fe_electro.c"); 
# 297
}  
# 298
}  
...
# 1 "test_fe_electro.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__23_test_fe_electro_cpp1_ii_449d7d87
# 1 "test_fe_electro.cudafe1.stub.c"
#include "test_fe_electro.cudafe1.stub.c"
# 1 "test_fe_electro.cudafe1.stub.c"
