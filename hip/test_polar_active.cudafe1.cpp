...
# 20 "../.././src/gradient_2d_5pt_fluid.h"
...
# 33 "test_polar_active.c"
static int test_polar_active_aster(fe_polar_t * fe, cs_t * cs, field_t * fp, field_grad_t * fpgrad); 
# 35
static int test_polar_active_terms(fe_polar_t * fe, cs_t * cs, field_t * fp, field_grad_t * fpgrad); 
# 37
static int test_polar_active_init_aster(cs_t * cs, field_t * fp); 
# 47 "test_polar_active.c"
int test_polar_active_suite() { 
# 49
int nf = 3; 
# 50
...
# 77
field_grad_set(fpgrad, grad_2d_5pt_fluid_d2, __null); 
# 79
...
# 105 "test_polar_active.c"
static int test_polar_active_aster(fe_polar_t *fe, cs_t *cs, field_t *fp, field_grad_t *
# 106
fpgrad) { 
# 108
int index; 
...
# 120
(param.a) = (-(0.1000000000000000056)); 
# 121
(param.b) = (+(0.1000000000000000056)); 
# 122
(param.kappa1) = (0.01000000000000000021); 
# 123
(param.kappa2) = (0.02000000000000000042); 
# 124
...
# 136
test_assert_info(fabs((p[X]) - (+(0.7071067800000000458))) < (9.999999999999999547e-08), 136, "test_polar_active.c"); 
# 137
test_assert_info(fabs((p[Y]) - (+(0.7071067800000000458))) < (9.999999999999999547e-08), 137, "test_polar_active.c"); 
# 138
test_assert_info(fabs(p[Z]) < (9.999999999999999988e-15), 138, "test_polar_active.c"); 
# 141
index = cs_index(cs, 2, 28, 1); 
# 142
field_vector(fp, index, p); 
# 145
test_assert_info(fabs((p[X]) - (+(0.9052369399999999899))) < (9.999999999999999547e-08), 145, "test_polar_active.c"); 
# 146
test_assert_info(fabs((p[Y]) - (+(0.4249071400000000165))) < (9.999999999999999547e-08), 146, "test_polar_active.c"); 
# 147
test_assert_info(fabs(p[Z]) < (9.999999999999999988e-15), 147, "test_polar_active.c"); 
# 152
...
fe_polar_fed(fe, index, &fed); 
# 168
test_assert_info(fabs(fed - (-(0.02244844799999999932))) < (9.999999999999999547e-08), 168, "test_polar_active.c"); 
# 175
index = cs_index(cs, 4, 78, 1); 
# 176
fe_polar_mol_field(fe, index, h); 
# 178
test_assert_info(fabs((h[X]) - (-(2.952626100000000136e-06))) < (9.999999999999999547e-08), 178, "test_polar_active.c"); 
# 179
test_assert_info(fabs((h[Y]) - (+(1.694736099999999928e-06))) < (9.999999999999999547e-08), 179, "test_polar_active.c"); 
# 180
test_assert_info(fabs(h[Z]) < (9.999999999999999988e-15), 180, "test_polar_active.c"); 
# 183
index = cs_index(cs, 49, 49, 1); 
# 184
fe_polar_mol_field(fe, index, h); 
# 186
test_assert_info(fabs((h[X]) - (-(0.001000358499999999973))) < (9.999999999999999547e-08), 186, "test_polar_active.c"); 
# 187
test_assert_info(fabs((h[Y]) - (-(0.001000358499999999973))) < (9.999999999999999547e-08), 187, "test_polar_active.c"); 
# 188
test_assert_info(fabs(h[Z]) < (9.999999999999999988e-15), 188, "test_polar_active.c"); 
# 195
index = cs_index(cs, 3, 90, 1); 
# 196
fe_polar_stress(fe, index, s); 
# 199
test_assert_info(fabs(((s[X])[X]) - (+(1.039819499999999989e-06))) < (9.999999999999999547e-08), 199, "test_polar_active.c"); 
# 200
test_assert_info(fabs(((s[X])[Y]) - (+(1.279846200000000101e-06))) < (9.999999999999999547e-08), 200, "test_polar_active.c"); 
# 201
test_assert_info(fabs((s[X])[Z]) < (9.999999999999999988e-15), 201, "test_polar_active.c"); 
# 202
test_assert_info(fabs(((s[Y])[X]) - (+(1.279503899999999949e-06))) < (9.999999999999999547e-08), 202, "test_polar_active.c"); 
# 203
test_assert_info(fabs(((s[Y])[Y]) - (+(1.574858300000000088e-06))) < (9.999999999999999547e-08), 203, "test_polar_active.c"); 
# 204
test_assert_info(fabs((s[Y])[Z]) < (9.999999999999999988e-15), 204, "test_polar_active.c"); 
# 205
test_assert_info(fabs((s[Z])[X]) < (9.999999999999999988e-15), 205, "test_polar_active.c"); 
# 206
test_assert_info(fabs((s[Z])[Y]) < (9.999999999999999988e-15), 206, "test_polar_active.c"); 
# 207
test_assert_info(fabs((s[Z])[Z]) < (9.999999999999999988e-15), 207, "test_polar_active.c"); 
# 210
index = cs_index(cs, 100, 1, 1); 
# 211
fe_polar_stress(fe, index, s); 
# 214
test_assert_info(fabs(((s[X])[X]) - (+(0.004897980399999999832))) < (9.999999999999999547e-08), 214, "test_polar_active.c"); 
# 215
test_assert_info(fabs(((s[X])[Y]) - (-(4.94693979999999989e-05))) < (9.999999999999999547e-08), 215, "test_polar_active.c"); 
# 216
test_assert_info(fabs((s[X])[Z]) < (9.999999999999999988e-15), 216, "test_polar_active.c"); 
# 217
test_assert_info(fabs(((s[Y])[X]) - (-(5.150926700000000137e-05))) < (9.999999999999999547e-08), 217, "test_polar_active.c"); 
# 218
test_assert_info(fabs(((s[Y])[Y]) - (+(0.005000000000000000104))) < (9.999999999999999547e-08), 218, "test_polar_active.c"); 
# 219
test_assert_info(fabs((s[Y])[Z]) < (9.999999999999999988e-15), 219, "test_polar_active.c"); 
# 220
test_assert_info(fabs((s[Z])[X]) < (9.999999999999999988e-15), 220, "test_polar_active.c"); 
# 221
test_assert_info(fabs((s[Z])[Y]) < (9.999999999999999988e-15), 221, "test_polar_active.c"); 
# 222
test_assert_info(fabs((s[Z])[Z]) < (9.999999999999999988e-15), 222, "test_polar_active.c"); 
# 227
return 0; 
# 228
} 
# 239 "test_polar_active.c"
int test_polar_active_terms(fe_polar_t *fe, cs_t *cs, field_t *fp, field_grad_t *
# 240
fpgrad) { 
# 242
int index; 
...
(param.kappa2) = (0.02000000000000000042); 
# 255
(param.lambda) = (2.100000000000000089); 
# 256
(param.zeta) = (0.001000000000000000021); 
# 257
fe_polar_param_set(fe, param); 
# 259
test_polar_active_init_aster(cs, fp); 
...
fe_polar_stress(fe, index, s); 
# 270
test_assert_info(fabs(((s[Y])[Z]) - (0.0)) < (9.999999999999999988e-15), 270, "test_polar_active.c"); 
# 271
test_assert_info(fabs(((s[Z])[Y]) - (0.0)) < (9.999999999999999988e-15), 271, "test_polar_active.c"); 
# 272
test_assert_info(fabs(((s[X])[Z]) - (0.0)) < (9.999999999999999988e-15), 272, "test_polar_active.c"); 
# 273
test_assert_info(fabs(((s[Z])[X]) - (0.0)) < (9.999999999999999988e-15), 273, "test_polar_active.c"); 
# 275
}  
# 276
}  
...
fe_polar_stress(fe, index, s); 
# 284
test_assert_info(fabs(((s[X])[X]) - (+(0.0002685817000000000174))) < (9.999999999999999547e-08), 284, "test_polar_active.c"); 
# 285
test_assert_info(fabs(((s[X])[Y]) - (-(0.0004854442900000000027))) < (9.999999999999999547e-08), 285, "test_polar_active.c"); 
# 286
test_assert_info(fabs((s[X])[Z]) < (9.999999999999999988e-15), 286, "test_polar_active.c"); 
# 287
test_assert_info(fabs(((s[Y])[X]) - (-(0.0004854446299999999994))) < (9.999999999999999547e-08), 287, "test_polar_active.c"); 
# 288
test_assert_info(fabs(((s[Y])[Y]) - (+(6.553574399999999702e-05))) < (9.999999999999999547e-08), 288, "test_polar_active.c"); 
# 289
test_assert_info(fabs((s[Y])[Z]) < (9.999999999999999988e-15), 289, "test_polar_active.c"); 
# 290
test_assert_info(fabs((s[Z])[X]) < (9.999999999999999988e-15), 290, "test_polar_active.c"); 
# 291
test_assert_info(fabs((s[Z])[Y]) < (9.999999999999999988e-15), 291, "test_polar_active.c"); 
# 292
test_assert_info(fabs(((s[Z])[Z]) - (-(0.0003315027700000000251))) < (9.999999999999999547e-08), 292, "test_polar_active.c"); 
# 295
index = cs_index(cs, 100, 1, 1); 
# 296
fe_polar_stress(fe, index, s); 
# 299
test_assert_info(fabs(((s[X])[X]) - (-(0.001523737500000000005))) < (9.999999999999999547e-08), 299, "test_polar_active.c"); 
# 300
test_assert_info(fabs(((s[X])[Y]) - (+(0.02044748399999999841))) < (9.999999999999999547e-08), 300, "test_polar_active.c"); 
# 301
test_assert_info(fabs((s[X])[Z]) < (9.999999999999999988e-15), 301, "test_polar_active.c"); 
# 302
test_assert_info(fabs(((s[Y])[X]) - (+(0.02044544400000000012))) < (9.999999999999999547e-08), 302, "test_polar_active.c"); 
# 303
test_assert_info(fabs(((s[Y])[Y]) - (-(0.002245677499999999913))) < (9.999999999999999547e-08), 303, "test_polar_active.c"); 
# 304
test_assert_info(fabs((s[Y])[Z]) < (9.999999999999999988e-15), 304, "test_polar_active.c"); 
# 305
test_assert_info(fabs((s[Z])[X]) < (9.999999999999999988e-15), 305, "test_polar_active.c"); 
# 306
test_assert_info(fabs((s[Z])[Y]) < (9.999999999999999988e-15), 306, "test_polar_active.c"); 
# 307
test_assert_info(fabs(((s[Z])[Z]) - (+(0.01366739500000000058))) < (9.999999999999999547e-08), 307, "test_polar_active.c"); 
# 312
return 0; 
# 313
} 
# 324 "test_polar_active.c"
...
# 1 "test_polar_active.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__25_test_polar_active_cpp1_ii_0cd46aff
# 1 "test_polar_active.cudafe1.stub.c"
#include "test_polar_active.cudafe1.stub.c"
# 1 "test_polar_active.cudafe1.stub.c"
