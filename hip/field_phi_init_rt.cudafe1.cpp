...
# 41 "field_phi_init_rt.c"
int field_phi_init_rt(pe_t *pe, rt_t *rt, field_phi_info_t param, field_t *
# 42
phi) { 
# 44
int p; 
...
# 51
(pe) ? static_cast< void>(0) : __assert_fail("pe", "field_phi_init_rt.c", 51, __PRETTY_FUNCTION__); 
# 52
(rt) ? static_cast< void>(0) : __assert_fail("rt", "field_phi_init_rt.c", 52, __PRETTY_FUNCTION__); 
# 53
(phi) ? static_cast< void>(0) : __assert_fail("phi", "field_phi_init_rt.c", 53, __PRETTY_FUNCTION__); 
# 55
p = rt_string_parameter(rt, "phi_initialisation", value, 8192); 
# 58
if ((p == 0) || (strcmp(value, "spinodal") == 0)) { 
# 59
int seed = 13; 
# 60
double noise0 = (0.1000000000000000056); 
# 61
...
# 120
double layer_size = (0.5); 
# 121
rt_double_parameter(rt, "phi_init_layer_size", &layer_size); 
# 122
if ((layer_size < (0.0)) || (layer_size > (1.0))) { layer_size = (0.5); }  
# 123
...
# 180
strcpy(filestub, "phi.init"); 
# 181
rt_string_parameter(rt, "phi_file_stub", filestub, 4096); 
# 182
...
# 1 "field_phi_init_rt.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__25_field_phi_init_rt_cpp1_ii_d84b5dfa
# 1 "field_phi_init_rt.cudafe1.stub.c"
#include "field_phi_init_rt.cudafe1.stub.c"
# 1 "field_phi_init_rt.cudafe1.stub.c"
