...
# 78
test_assert_info(((cv[(xdisp_fwd_cv[i]) + k])[X]) == (+1), 78, "test_halo.c"); 
# 79
test_assert_info(((cv[(xdisp_bwd_cv[i]) + k])[X]) == (-1), 79, "test_halo.c"); 
# 80
}  
# 81
}  
...
# 85
test_assert_info(((cv[(ydisp_fwd_cv[i]) + k])[Y]) == (+1), 85, "test_halo.c"); 
# 86
test_assert_info(((cv[(ydisp_bwd_cv[i]) + k])[Y]) == (-1), 86, "test_halo.c"); 
# 87
}  
# 88
}  
...
# 92
test_assert_info(((cv[(zdisp_fwd_cv[i]) + k])[Z]) == (+1), 92, "test_halo.c"); 
# 93
test_assert_info(((cv[(zdisp_bwd_cv[i]) + k])[Z]) == (-1), 93, "test_halo.c"); 
# 94
}  
# 95
}  
...
lb_t *lb = (__null); 
# 122
(pe) ? static_cast< void>(0) : __assert_fail("pe", "test_halo.c", 122, __PRETTY_FUNCTION__); 
# 123
(cs) ? static_cast< void>(0) : __assert_fail("cs", "test_halo.c", 123, __PRETTY_FUNCTION__); 
# 125
cs_nhalo(cs, &nhalo); 
# 126
nextra = (nhalo - 1); 
...
# 190
test_assert_info(fabs(f_actual - (0.0)) < ((double)(2.2204460492503130808e-16L)), 190, "test_halo.c"); 
# 191
}  
# 192
}  
...
lb_t *lb = (__null); 
# 230
(pe) ? static_cast< void>(0) : __assert_fail("pe", "test_halo.c", 230, __PRETTY_FUNCTION__); 
# 231
(cs) ? static_cast< void>(0) : __assert_fail("cs", "test_halo.c", 231, __PRETTY_FUNCTION__); 
# 232
(((dim == (X)) || (dim == (Y))) || (dim == (Z))) ? static_cast< void>(0) : __assert_fail("dim == X || dim == Y || dim == Z", "test_halo.c", 232, __PRETTY_FUNCTION__); 
# 235
lb_create(pe, cs, &lb); 
# 236
lb_ndist_set(lb, ndist); 
...
index = cs_index(cs, n[X], n[Y], n[Z]); 
# 276
if (((((((n[X]) <= nhalo) || ((n[X]) > ((nlocal[X]) - nhalo))) || ((n[Y]) <= nhalo)) || ((n[Y]) > ((nlocal[Y]) - nhalo))) || ((n[Z]) <= nhalo)) || ((n[Z]) > ((nlocal[Z]) - nhalo))) 
# 278
{ 
# 280
for (nd = 0; nd < ndist; nd++) { 
...
lb_f(lb, index, p, nd, &f_actual); 
# 319
test_assert_info(fabs(f_actual - f_expect) < ((double)(2.2204460492503130808e-16L)), 319, "test_halo.c"); 
# 320
}  
# 321
}  
...
lb_f(lb, index, p, nd, &f_actual); 
# 331
test_assert_info(fabs(f_actual - f_expect) < ((double)(2.2204460492503130808e-16L)), 331, "test_halo.c"); 
# 332
}  
# 333
}  
...
# 1 "test_halo.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__17_test_halo_cpp1_ii_b60f1af8
# 1 "test_halo.cudafe1.stub.c"
#include "test_halo.cudafe1.stub.c"
# 1 "test_halo.cudafe1.stub.c"
