...
# 31
int test_create_dimer(colloids_info_t * cinfo, double a, double  r1[3], double  r2[3], colloid_t * pc[2]); 
# 40
int test_bond_fene_suite() { 
# 42
pe_t *pe = (__null); 
...
int test_bond_fene1(pe_t *pe, cs_t *cs) { 
# 67
bond_fene_t *bond = (__null); 
# 69
double r = (1.0); 
# 70
double v, f; 
# 72
(pe) ? static_cast< void>(0) : __assert_fail("pe", "test_bond_fene.c", 72, __PRETTY_FUNCTION__); 
# 73
(cs) ? static_cast< void>(0) : __assert_fail("cs", "test_bond_fene.c", 73, __PRETTY_FUNCTION__); 
# 75
bond_fene_create(pe, cs, &bond); 
# 76
(bond) ? static_cast< void>(0) : __assert_fail("bond", "test_bond_fene.c", 76, __PRETTY_FUNCTION__); 
# 78
bond_fene_param_set(bond, (3.0), (7.0)); 
# 80
bond_fene_single(bond, r, &v, &f); 
# 82
(fabs(v - (1.515517599999999909)) < ((1.192092896e-07F))) ? static_cast< void>(0) : __assert_fail("fabs(v - 1.5155176) < 1.19209289550781250000e-7F", "test_bond_fene.c", 82, __PRETTY_FUNCTION__); 
# 83
(fabs(f - (-(3.0625))) < ((1.192092896e-07F))) ? static_cast< void>(0) : __assert_fail("fabs(f - -3.0625000) < 1.19209289550781250000e-7F", "test_bond_fene.c", 83, __PRETTY_FUNCTION__); 
# 85
bond_fene_free(bond); 
# 87
return 0; 
...
MPI_Comm comm; 
# 113
(pe) ? static_cast< void>(0) : __assert_fail("pe", "test_bond_fene.c", 113, __PRETTY_FUNCTION__); 
# 114
(cs) ? static_cast< void>(0) : __assert_fail("cs", "test_bond_fene.c", 114, __PRETTY_FUNCTION__); 
# 116
cs_ltot(cs, ltot); 
# 117
...
# 122
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "test_bond_fene.c", 122, __PRETTY_FUNCTION__); 
# 123
(interact) ? static_cast< void>(0) : __assert_fail("interact", "test_bond_fene.c", 123, __PRETTY_FUNCTION__); 
# 125
bond_fene_create(pe, cs, &bond); 
# 126
bond_fene_param_set(bond, (3.0), (7.0)); 
...
if (pc[0]) { 
# 149
(fabs((((pc[0])->force)[X]) - (((-f) * (r12[X])) / dr)) < ((1.192092896e-07F))) ? static_cast< void>(0) : __assert_fail("fabs(pc[0]->force[X] - -f*r12[X]/dr) < 1.19209289550781250000e-7F", "test_bond_fene.c", 149, __PRETTY_FUNCTION__); 
# 150
(fabs((((pc[0])->force)[Y]) - (((-f) * (r12[Y])) / dr)) < ((1.192092896e-07F))) ? static_cast< void>(0) : __assert_fail("fabs(pc[0]->force[Y] - -f*r12[Y]/dr) < 1.19209289550781250000e-7F", "test_bond_fene.c", 150, __PRETTY_FUNCTION__); 
# 151
(fabs((((pc[0])->force)[Z]) - (((-f) * (r12[Z])) / dr)) < ((1.192092896e-07F))) ? static_cast< void>(0) : __assert_fail("fabs(pc[0]->force[Z] - -f*r12[Z]/dr) < 1.19209289550781250000e-7F", "test_bond_fene.c", 151, __PRETTY_FUNCTION__); 
# 152
}  
# 154
if (pc[1]) { 
# 155
(fabs((((pc[1])->force)[X]) - ((f * (r12[X])) / dr)) < ((1.192092896e-07F))) ? static_cast< void>(0) : __assert_fail("fabs(pc[1]->force[X] - f*r12[X]/dr) < 1.19209289550781250000e-7F", "test_bond_fene.c", 155, __PRETTY_FUNCTION__); 
# 156
(fabs((((pc[1])->force)[Y]) - ((f * (r12[Y])) / dr)) < ((1.192092896e-07F))) ? static_cast< void>(0) : __assert_fail("fabs(pc[1]->force[Y] - f*r12[Y]/dr) < 1.19209289550781250000e-7F", "test_bond_fene.c", 156, __PRETTY_FUNCTION__); 
# 157
(fabs((((pc[1])->force)[Z]) - ((f * (r12[Z])) / dr)) < ((1.192092896e-07F))) ? static_cast< void>(0) : __assert_fail("fabs(pc[1]->force[Z] - f*r12[Z]/dr) < 1.19209289550781250000e-7F", "test_bond_fene.c", 157, __PRETTY_FUNCTION__); 
# 158
}  
# 162
...
# 166
(fabs((stats[INTERACT_STAT_VLOCAL]) - v) < ((1.192092896e-07F))) ? static_cast< void>(0) : __assert_fail("fabs(stats[INTERACT_STAT_VLOCAL] - v) < 1.19209289550781250000e-7F", "test_bond_fene.c", 166, __PRETTY_FUNCTION__); 
# 168
MPI_Allreduce(stats_local, stats, INTERACT_STAT_MAX, MPI_DOUBLE, MPI_MIN, comm); 
# 170
(fabs((stats[INTERACT_STAT_RMINLOCAL]) - dr) < ((1.192092896e-07F))) ? static_cast< void>(0) : __assert_fail("fabs(stats[INTERACT_STAT_RMINLOCAL] - dr) < 1.19209289550781250000e-7F", "test_bond_fene.c", 170, __PRETTY_FUNCTION__); 
# 172
MPI_Allreduce(stats_local, stats, INTERACT_STAT_MAX, MPI_DOUBLE, MPI_MAX, comm); 
# 174
(fabs((stats[INTERACT_STAT_RMAXLOCAL]) - dr) < ((1.192092896e-07F))) ? static_cast< void>(0) : __assert_fail("fabs(stats[INTERACT_STAT_RMAXLOCAL] - dr) < 1.19209289550781250000e-7F", "test_bond_fene.c", 174, __PRETTY_FUNCTION__); 
# 178
bond_fene_free(bond); 
# 179
...
# 191
int test_create_dimer(colloids_info_t *cinfo, double a, double r1[3], double 
# 192
r2[3], colloid_t *pc[2]) { 
# 194
int nc = 0; 
# 196
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "test_bond_fene.c", 196, __PRETTY_FUNCTION__); 
# 197
(pc) ? static_cast< void>(0) : __assert_fail("pc", "test_bond_fene.c", 197, __PRETTY_FUNCTION__); 
# 199
...
# 217
(nc == 2) ? static_cast< void>(0) : __assert_fail("nc == 2", "test_bond_fene.c", 217, __PRETTY_FUNCTION__); 
# 219
...
# 1 "test_bond_fene.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__22_test_bond_fene_cpp1_ii_efa38030
# 1 "test_bond_fene.cudafe1.stub.c"
#include "test_bond_fene.cudafe1.stub.c"
# 1 "test_bond_fene.cudafe1.stub.c"
