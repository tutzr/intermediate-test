...
# 59 "field.c"
int field_create(pe_t *pe, cs_t *cs, int nf, const char *name, field_t **
# 60
pobj) { 
# 62
field_t *obj = (__null); 
# 64
(pe) ? static_cast< void>(0) : __assert_fail("pe", "field.c", 64, __PRETTY_FUNCTION__); 
# 65
(cs) ? static_cast< void>(0) : __assert_fail("cs", "field.c", 65, __PRETTY_FUNCTION__); 
# 66
(nf > 0) ? static_cast< void>(0) : __assert_fail("nf > 0", "field.c", 66, __PRETTY_FUNCTION__); 
# 67
(pobj) ? static_cast< void>(0) : __assert_fail("pobj", "field.c", 67, __PRETTY_FUNCTION__); 
# 69
obj = ((field_t *)calloc(1, sizeof(field_t))); 
# 70
(obj) ? static_cast< void>(0) : __assert_fail("obj", "field.c", 70, __PRETTY_FUNCTION__); 
# 71
if (obj == (__null)) { pe_fatal(pe, "calloc(obj) failed\n"); }  
# 73
(obj->nf) = nf; 
# 75
(obj->name) = ((char *)calloc(strlen(name) + (1), sizeof(char))); 
# 76
(obj->name) ? static_cast< void>(0) : __assert_fail("obj->name", "field.c", 76, __PRETTY_FUNCTION__); 
# 77
if ((obj->name) == (__null)) { pe_fatal(pe, "calloc(name) failed\n"); }  
# 79
(strlen(name) < (8192)) ? static_cast< void>(0) : __assert_fail("strlen(name) < 8192", "field.c", 79, __PRETTY_FUNCTION__); 
# 80
strncpy(obj->name, name, strlen(name)); 
# 81
((obj->name)[strlen(name)]) = '\000'; 
# 83
(obj->pe) = pe; 
# 84
(obj->cs) = cs; 
...
double *tmp; 
# 104
(obj) ? static_cast< void>(0) : __assert_fail("obj", "field.c", 104, __PRETTY_FUNCTION__); 
# 106
tdpGetDeviceCount(&ndevice); 
# 108
if (ndevice > 0) { 
# 109
tdpMemcpy(&tmp, &((obj->target)->data), sizeof(double *), hipMemcpyDeviceToHost); 
# 111
tdpFree(tmp); 
# 112
tdpFree(obj->target); 
...
double *tmp; 
# 147
(obj) ? static_cast< void>(0) : __assert_fail("obj", "field.c", 147, __PRETTY_FUNCTION__); 
# 148
((obj->data) == (__null)) ? static_cast< void>(0) : __assert_fail("obj->data == __null", "field.c", 148, __PRETTY_FUNCTION__); 
# 150
...
# 158
if ((obj->data) == (__null)) { pe_fatal(obj->pe, "calloc(obj->data) failed\n"); }  
# 167 "field.c"
tdpGetDeviceCount(&ndevice); 
# 169
if (ndevice == 0) { 
...
# 177
tdpMemcpy(&((obj->target)->data), &tmp, sizeof(double *), hipMemcpyHostToDevice); 
# 180
...
# 186
field_memcpy(obj, hipMemcpyHostToDevice); 
# 187
}  
# 191
halo_swap_create_r1(obj->pe, obj->cs, nhcomm, nsites, obj->nf, &(obj->halo)); 
# 192
(obj->halo) ? static_cast< void>(0) : __assert_fail("obj->halo", "field.c", 192, __PRETTY_FUNCTION__); 
# 194
...
if (ndevice == 0) { 
# 214
((obj->target) == obj) ? static_cast< void>(0) : __assert_fail("obj->target == obj", "field.c", 214, __PRETTY_FUNCTION__); 
# 215
} else 
# 216
{ 
...
# 248
(obj) ? static_cast< void>(0) : __assert_fail("obj", "field.c", 248, __PRETTY_FUNCTION__); 
# 249
(nf) ? static_cast< void>(0) : __assert_fail("nf", "field.c", 249, __PRETTY_FUNCTION__); 
# 251
(*nf) = (obj->nf); 
# 253
return 0; 
...
# 262
int field_init_io_info(field_t *obj, int grid[3], int form_in, int 
# 263
form_out) { 
# 265
io_info_arg_t args; 
# 267
(obj) ? static_cast< void>(0) : __assert_fail("obj", "field.c", 267, __PRETTY_FUNCTION__); 
# 268
((obj->info) == (__null)) ? static_cast< void>(0) : __assert_fail("obj->info == __null", "field.c", 268, __PRETTY_FUNCTION__); 
# 270
((args.grid)[X]) = (grid[X]); 
# 271
((args.grid)[Y]) = (grid[Y]); 
...
# 275
if ((obj->info) == (__null)) { pe_fatal(obj->pe, "io_info_create(field) failed\n"); }  
# 277
...
int field_io_info(field_t *obj, io_info_t **info) { 
# 301
(obj) ? static_cast< void>(0) : __assert_fail("obj", "field.c", 301, __PRETTY_FUNCTION__); 
# 302
(obj->info) ? static_cast< void>(0) : __assert_fail("obj->info", "field.c", 302, __PRETTY_FUNCTION__); 
# 303
(info) ? static_cast< void>(0) : __assert_fail("info", "field.c", 303, __PRETTY_FUNCTION__); 
# 305
(*info) = (obj->info); 
# 307
return 0; 
...
int nlocal[3]; 
# 319
(obj) ? static_cast< void>(0) : __assert_fail("obj", "field.c", 319, __PRETTY_FUNCTION__); 
# 321
cs_nlocal(obj->cs, nlocal); 
# 323
if ((nlocal[Z]) < (obj->nhcomm)) { 
# 326
field_memcpy(obj, hipMemcpyDeviceToHost); 
# 327
...
double *data; 
# 348
(obj) ? static_cast< void>(0) : __assert_fail("obj", "field.c", 348, __PRETTY_FUNCTION__); 
# 350
switch (flag) { 
# 351
...
# 355
tdpMemcpy(&data, &((obj->target)->data), sizeof(double *), hipMemcpyDeviceToHost); 
# 357
...
default:  
# 360
(0) ? static_cast< void>(0) : __assert_fail("0", "field.c", 360, __PRETTY_FUNCTION__); 
# 361
}  
# 363
return 0; 
...
int j0, j1, j2, j3; 
# 399
(obj) ? static_cast< void>(0) : __assert_fail("obj", "field.c", 399, __PRETTY_FUNCTION__); 
# 400
(obj->data) ? static_cast< void>(0) : __assert_fail("obj->data", "field.c", 400, __PRETTY_FUNCTION__); 
# 402
...
for (n = 0; n < nf; n++) { 
# 447
((obj->data)[reverse_addr_rank1_assert(447, "field.c", obj->nsites, nf, index, n)]) = ((((((((-r6) * fr) * (fr - (1.0))) * (fr - (2.0))) * ((obj->data)[reverse_addr_rank1_assert(448, "field.c", obj->nsites, nf, index0, n)])) + ((((0.5) * ((fr * fr) - (1.0))) * (fr - (2.0))) * ((obj->data)[reverse_addr_rank1_assert(449, "field.c", obj->nsites, nf, index1, n)]))) - (((((0.5) * fr) * (fr + (1.0))) * (fr - (2.0))) * ((obj->data)[reverse_addr_rank1_assert(450, "field.c", obj->nsites, nf, index2, n)]))) + (((r6 * fr) * ((fr * fr) - (1.0))) * ((obj->data)[reverse_addr_rank1_assert(451, "field.c", obj->nsites, nf, index3, n)]))); 
# 452
}  
# 453
}  
...
int nrank_r[3]; 
# 504
double *sendbuf = (__null); 
# 505
double *recvbuf = (__null); 
# 507
const int tag0 = 1256; 
# 508
const int tag1 = 1257; 
...
MPI_Status status[3]; 
# 515
(obj) ? static_cast< void>(0) : __assert_fail("obj", "field.c", 515, __PRETTY_FUNCTION__); 
# 516
(obj->le) ? static_cast< void>(0) : __assert_fail("obj->le", "field.c", 516, __PRETTY_FUNCTION__); 
# 518
field_nf(obj, &nf); 
# 519
cs_ltot(obj->cs, ltot); 
...
# 537
if (sendbuf == (__null)) { pe_fatal(obj->pe, "malloc(sendbuf) failed\n"); }  
# 538
if (recvbuf == (__null)) { pe_fatal(obj->pe, "malloc(recvbuf) failed\n"); }  
# 542
for (ib = 0; ib < nxbuffer; ib++) { 
# 544
ic = lees_edw_ibuff_to_real(obj->le, ib); 
...
# 559
(j1 >= 1) ? static_cast< void>(0) : __assert_fail("j1 >= 1", "field.c", 559, __PRETTY_FUNCTION__); 
# 560
(j1 <= (ntotal[Y])) ? static_cast< void>(0) : __assert_fail("j1 <= ntotal[Y]", "field.c", 560, __PRETTY_FUNCTION__); 
# 562
lees_edw_jstart_to_mpi_ranks(obj->le, j1, nrank_s, nrank_r); 
# 569
j2 = (1 + ((j1 - 1) % (nlocal[Y]))); 
# 570
(j2 >= 1) ? static_cast< void>(0) : __assert_fail("j2 >= 1", "field.c", 570, __PRETTY_FUNCTION__); 
# 571
(j2 <= (nlocal[Y])) ? static_cast< void>(0) : __assert_fail("j2 <= nlocal[Y]", "field.c", 571, __PRETTY_FUNCTION__); 
# 573
jc = (((nlocal[Y]) - j2) + 1); 
# 574
...
# 579
MPI_Irecv(recvbuf + n1, n2, MPI_DOUBLE, nrank_r[1], tag1, le_comm, request + 1); 
# 582
jc = imax(0, ((j2 - (nlocal[Y])) + (2 * nhalo)) + 2); 
# 583
n3 = ((nf * jc) * ((nlocal[Z]) + (2 * nhalo))); 
# 584
MPI_Irecv((recvbuf + n1) + n2, n3, MPI_DOUBLE, nrank_r[2], tag2, le_comm, request + 2); 
# 589
...
j1 = (j0 + (nf * ((kc + nhalo) - 1))); 
# 595
(((j1 + n) >= 0) && ((j1 + n) < nsend)) ? static_cast< void>(0) : __assert_fail("(j1+n) >= 0 && (j1+n) < nsend", "field.c", 595, __PRETTY_FUNCTION__); 
# 596
(sendbuf[j1 + n]) = ((obj->data)[reverse_addr_rank1_assert(596, "field.c", obj->nsites, nf, index, n)]); 
# 597
}  
# 598
}  
...
# 604
MPI_Issend(sendbuf + index, n1, MPI_DOUBLE, nrank_s[0], tag0, le_comm, request + 3); 
# 606
MPI_Issend(sendbuf, n2, MPI_DOUBLE, nrank_s[1], tag1, le_comm, request + 4); 
# 608
MPI_Issend(sendbuf, n3, MPI_DOUBLE, nrank_s[2], tag2, le_comm, request + 5); 
# 611
...
for (n = 0; n < nf; n++) { 
# 630
((obj->data)[reverse_addr_rank1_assert(630, "field.c", obj->nsites, nf, index, n)]) = ((((((((-r6) * fr) * (fr - (1.0))) * (fr - (2.0))) * (recvbuf[(nf * (((j0 + kc) + nhalo) - 1)) + n])) + ((((0.5) * ((fr * fr) - (1.0))) * (fr - (2.0))) * (recvbuf[(nf * (((j1 + kc) + nhalo) - 1)) + n]))) - (((((0.5) * fr) * (fr + (1.0))) * (fr - (2.0))) * (recvbuf[(nf * (((j2 + kc) + nhalo) - 1)) + n]))) + (((r6 * fr) * ((fr * fr) - (1.0))) * (recvbuf[(nf * (((j3 + kc) + nhalo) - 1)) + n]))); 
# 635
}  
# 636
}  
...
int field_scalar(field_t *obj, int index, double *phi) { 
# 659
(obj) ? static_cast< void>(0) : __assert_fail("obj", "field.c", 659, __PRETTY_FUNCTION__); 
# 660
((obj->nf) == 1) ? static_cast< void>(0) : __assert_fail("obj->nf == 1", "field.c", 660, __PRETTY_FUNCTION__); 
# 661
(obj->data) ? static_cast< void>(0) : __assert_fail("obj->data", "field.c", 661, __PRETTY_FUNCTION__); 
# 662
(phi) ? static_cast< void>(0) : __assert_fail("phi", "field.c", 662, __PRETTY_FUNCTION__); 
# 664
(*phi) = ((obj->data)[reverse_addr_rank1_assert(664, "field.c", obj->nsites, 1, index, 0)]); 
# 666
return 0; 
# 667
} 
...
int field_scalar_set(field_t *obj, int index, double phi) { 
# 678
(obj) ? static_cast< void>(0) : __assert_fail("obj", "field.c", 678, __PRETTY_FUNCTION__); 
# 679
((obj->nf) == 1) ? static_cast< void>(0) : __assert_fail("obj->nf == 1", "field.c", 679, __PRETTY_FUNCTION__); 
# 680
(obj->data) ? static_cast< void>(0) : __assert_fail("obj->data", "field.c", 680, __PRETTY_FUNCTION__); 
# 682
((obj->data)[reverse_addr_rank1_assert(682, "field.c", obj->nsites, 1, index, 0)]) = phi; 
# 684
return 0; 
# 685
} 
...
int ia; 
# 698
(obj) ? static_cast< void>(0) : __assert_fail("obj", "field.c", 698, __PRETTY_FUNCTION__); 
# 699
((obj->nf) == 3) ? static_cast< void>(0) : __assert_fail("obj->nf == 3", "field.c", 699, __PRETTY_FUNCTION__); 
# 700
(obj->data) ? static_cast< void>(0) : __assert_fail("obj->data", "field.c", 700, __PRETTY_FUNCTION__); 
# 702
for (ia = 0; ia < 3; ia++) { 
# 703
(p[ia]) = ((obj->data)[reverse_addr_rank1_assert(703, "field.c", obj->nsites, 3, index, ia)]); 
# 704
}  
# 706
return 0; 
...
int ia; 
# 720
(obj) ? static_cast< void>(0) : __assert_fail("obj", "field.c", 720, __PRETTY_FUNCTION__); 
# 721
((obj->nf) == 3) ? static_cast< void>(0) : __assert_fail("obj->nf == 3", "field.c", 721, __PRETTY_FUNCTION__); 
# 722
(obj->data) ? static_cast< void>(0) : __assert_fail("obj->data", "field.c", 722, __PRETTY_FUNCTION__); 
# 723
(p) ? static_cast< void>(0) : __assert_fail("p", "field.c", 723, __PRETTY_FUNCTION__); 
# 725
for (ia = 0; ia < 3; ia++) { 
# 726
((obj->data)[reverse_addr_rank1_assert(726, "field.c", obj->nsites, 3, index, ia)]) = (p[ia]); 
# 727
}  
# 729
return 0; 
...
int field_tensor(field_t *obj, int index, double q[3][3]) { 
# 743
(obj) ? static_cast< void>(0) : __assert_fail("obj", "field.c", 743, __PRETTY_FUNCTION__); 
# 744
((obj->nf) == 5) ? static_cast< void>(0) : __assert_fail("obj->nf == 5", "field.c", 744, __PRETTY_FUNCTION__); 
# 745
(obj->data) ? static_cast< void>(0) : __assert_fail("obj->data", "field.c", 745, __PRETTY_FUNCTION__); 
# 746
(q) ? static_cast< void>(0) : __assert_fail("q", "field.c", 746, __PRETTY_FUNCTION__); 
# 748
((q[X])[X]) = ((obj->data)[reverse_addr_rank1_assert(748, "field.c", obj->nsites, 5, index, XX)]); 
# 749
((q[X])[Y]) = ((obj->data)[reverse_addr_rank1_assert(749, "field.c", obj->nsites, 5, index, XY)]); 
# 750
((q[X])[Z]) = ((obj->data)[reverse_addr_rank1_assert(750, "field.c", obj->nsites, 5, index, XZ)]); 
# 751
((q[Y])[X]) = ((q[X])[Y]); 
# 752
((q[Y])[Y]) = ((obj->data)[reverse_addr_rank1_assert(752, "field.c", obj->nsites, 5, index, YY)]); 
# 753
((q[Y])[Z]) = ((obj->data)[reverse_addr_rank1_assert(753, "field.c", obj->nsites, 5, index, YZ)]); 
# 754
((q[Z])[X]) = ((q[X])[Z]); 
# 755
((q[Z])[Y]) = ((q[Y])[Z]); 
...
int field_tensor_set(field_t *obj, int index, double q[3][3]) { 
# 773
(obj) ? static_cast< void>(0) : __assert_fail("obj", "field.c", 773, __PRETTY_FUNCTION__); 
# 774
((obj->nf) == 5) ? static_cast< void>(0) : __assert_fail("obj->nf == 5", "field.c", 774, __PRETTY_FUNCTION__); 
# 775
(obj->data) ? static_cast< void>(0) : __assert_fail("obj->data", "field.c", 775, __PRETTY_FUNCTION__); 
# 776
(q) ? static_cast< void>(0) : __assert_fail("q", "field.c", 776, __PRETTY_FUNCTION__); 
# 778
((obj->data)[reverse_addr_rank1_assert(778, "field.c", obj->nsites, 5, index, XX)]) = ((q[X])[X]); 
# 779
((obj->data)[reverse_addr_rank1_assert(779, "field.c", obj->nsites, 5, index, XY)]) = ((q[X])[Y]); 
# 780
((obj->data)[reverse_addr_rank1_assert(780, "field.c", obj->nsites, 5, index, XZ)]) = ((q[X])[Z]); 
# 781
((obj->data)[reverse_addr_rank1_assert(781, "field.c", obj->nsites, 5, index, YY)]) = ((q[Y])[Y]); 
# 782
((obj->data)[reverse_addr_rank1_assert(782, "field.c", obj->nsites, 5, index, YZ)]) = ((q[Y])[Z]); 
# 784
return 0; 
# 785
} 
...
int n; 
# 803
(obj) ? static_cast< void>(0) : __assert_fail("obj", "field.c", 803, __PRETTY_FUNCTION__); 
# 804
(obj->data) ? static_cast< void>(0) : __assert_fail("obj->data", "field.c", 804, __PRETTY_FUNCTION__); 
# 805
(array) ? static_cast< void>(0) : __assert_fail("array", "field.c", 805, __PRETTY_FUNCTION__); 
# 807
for (n = 0; n < (obj->nf); n++) { 
# 808
(array[n]) = ((obj->data)[reverse_addr_rank1_assert(808, "field.c", obj->nsites, obj->nf, index, n)]); 
# 809
}  
# 811
return 0; 
...
int n; 
# 825
(obj) ? static_cast< void>(0) : __assert_fail("obj", "field.c", 825, __PRETTY_FUNCTION__); 
# 826
(obj->data) ? static_cast< void>(0) : __assert_fail("obj->data", "field.c", 826, __PRETTY_FUNCTION__); 
# 827
(array) ? static_cast< void>(0) : __assert_fail("array", "field.c", 827, __PRETTY_FUNCTION__); 
# 829
for (n = 0; n < (obj->nf); n++) { 
# 830
((obj->data)[reverse_addr_rank1_assert(830, "field.c", obj->nsites, obj->nf, index, n)]) = (array[n]); 
# 831
}  
# 833
return 0; 
...
# 848
(fp) ? static_cast< void>(0) : __assert_fail("fp", "field.c", 848, __PRETTY_FUNCTION__); 
# 849
(obj) ? static_cast< void>(0) : __assert_fail("obj", "field.c", 849, __PRETTY_FUNCTION__); 
# 850
((obj->nf) <= 5) ? static_cast< void>(0) : __assert_fail("obj->nf <= 5", "field.c", 850, __PRETTY_FUNCTION__); 
# 852
...
field_t *obj = (field_t *)self; 
# 874
(fp) ? static_cast< void>(0) : __assert_fail("fp", "field.c", 874, __PRETTY_FUNCTION__); 
# 875
(obj) ? static_cast< void>(0) : __assert_fail("obj", "field.c", 875, __PRETTY_FUNCTION__); 
# 876
((obj->nf) <= 5) ? static_cast< void>(0) : __assert_fail("obj->nf <= 5", "field.c", 876, __PRETTY_FUNCTION__); 
# 878
for (n = 0; n < (obj->nf); n++) { 
# 879
...
field_t *obj = (field_t *)self; 
# 902
(fp) ? static_cast< void>(0) : __assert_fail("fp", "field.c", 902, __PRETTY_FUNCTION__); 
# 903
(obj) ? static_cast< void>(0) : __assert_fail("obj", "field.c", 903, __PRETTY_FUNCTION__); 
# 904
((obj->nf) <= 5) ? static_cast< void>(0) : __assert_fail("obj->nf <= 5", "field.c", 904, __PRETTY_FUNCTION__); 
# 906
...
field_t *obj = (field_t *)self; 
# 928
(fp) ? static_cast< void>(0) : __assert_fail("fp", "field.c", 928, __PRETTY_FUNCTION__); 
# 929
(obj) ? static_cast< void>(0) : __assert_fail("obj", "field.c", 929, __PRETTY_FUNCTION__); 
# 930
((obj->nf) <= 5) ? static_cast< void>(0) : __assert_fail("obj->nf <= 5", "field.c", 930, __PRETTY_FUNCTION__); 
# 932
field_scalar_array(obj, index, array); 
# 934
for (n = 0; n < (obj->nf); n++) { 
...
# 1 "field.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__13_field_cpp1_ii_36183496
# 1 "field.cudafe1.stub.c"
#include "field.cudafe1.stub.c"
# 1 "field.cudafe1.stub.c"
