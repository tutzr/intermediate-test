...
# 61
static int colloid_io_write_list_ascii(colloid_io_t * cio, int ic, int jc, int kc, FILE * fp); 
# 63
static int colloid_io_write_list_binary(colloid_io_t * cio, int ic, int jc, int kc, FILE * fp); 
# 66
static int colloid_io_filename(colloid_io_t * cio, char * filename, const char * stub); 
# 68
static int colloid_io_check_read(colloid_io_t * cio, int ngroup); 
# 83 "colloid_io.c"
int colloid_io_create(pe_t *pe, cs_t *cs, int io_grid[3], colloids_info_t *
# 84
info, colloid_io_t **
# 85
pcio) { 
...
int mpicoords[3]; 
# 90
colloid_io_t *obj = (__null); 
# 91
MPI_Comm cartcomm; 
# 93
(pe) ? static_cast< void>(0) : __assert_fail("pe", "colloid_io.c", 93, __PRETTY_FUNCTION__); 
# 94
(cs) ? static_cast< void>(0) : __assert_fail("cs", "colloid_io.c", 94, __PRETTY_FUNCTION__); 
# 95
(info) ? static_cast< void>(0) : __assert_fail("info", "colloid_io.c", 95, __PRETTY_FUNCTION__); 
# 96
(pcio) ? static_cast< void>(0) : __assert_fail("pcio", "colloid_io.c", 96, __PRETTY_FUNCTION__); 
# 98
obj = ((colloid_io_t *)calloc(1, sizeof(colloid_io_t))); 
# 99
(obj) ? static_cast< void>(0) : __assert_fail("obj", "colloid_io.c", 99, __PRETTY_FUNCTION__); 
# 100
if (obj == (__null)) { pe_fatal(pe, "calloc(colloid_io_t) failed\n"); }  
# 102
(obj->pe) = pe; 
# 103
(obj->cs) = cs; 
...
# 124
(obj->index) = ((((obj->coords)[X]) + (((obj->coords)[Y]) * (io_grid[X]))) + ((((obj->coords)[Z]) * (io_grid[X])) * (io_grid[Y]))); 
# 127
...
int colloid_io_free(colloid_io_t *cio) { 
# 149
(cio) ? static_cast< void>(0) : __assert_fail("cio", "colloid_io.c", 149, __PRETTY_FUNCTION__); 
# 151
...
int colloid_io_info_set(colloid_io_t *cio, colloids_info_t *info) { 
# 167
(cio) ? static_cast< void>(0) : __assert_fail("cio", "colloid_io.c", 167, __PRETTY_FUNCTION__); 
# 168
(info) ? static_cast< void>(0) : __assert_fail("info", "colloid_io.c", 168, __PRETTY_FUNCTION__); 
# 170
(cio->info) = info; 
# 172
return 0; 
...
char fout[8192]; 
# 188
(cio) ? static_cast< void>(0) : __assert_fail("cio", "colloid_io.c", 188, __PRETTY_FUNCTION__); 
# 190
strcpy(fin, "unset"); 
# 191
...
int nlocal; 
# 225
(cio) ? static_cast< void>(0) : __assert_fail("cio", "colloid_io.c", 225, __PRETTY_FUNCTION__); 
# 226
(ngroup) ? static_cast< void>(0) : __assert_fail("ngroup", "colloid_io.c", 226, __PRETTY_FUNCTION__); 
# 228
...
# 254
colloid_state_t *cbuf = (__null); 
# 255
colloid_state_t *rbuf = (__null); 
# 256
FILE *fp_state = (__null); 
# 258
(cio) ? static_cast< void>(0) : __assert_fail("cio", "colloid_io.c", 258, __PRETTY_FUNCTION__); 
# 260
colloids_info_ntotal(cio->info, &ntotal); 
# 261
if (ntotal == 0) { return 0; }  
# 263
(cio->f_header_write) ? static_cast< void>(0) : __assert_fail("cio->f_header_write", "colloid_io.c", 263, __PRETTY_FUNCTION__); 
# 264
(cio->f_buffer_write) ? static_cast< void>(0) : __assert_fail("cio->f_buffer_write", "colloid_io.c", 264, __PRETTY_FUNCTION__); 
# 268
...
# 277
(nclist) ? static_cast< void>(0) : __assert_fail("nclist", "colloid_io.c", 277, __PRETTY_FUNCTION__); 
# 278
if (nclist == (__null)) { pe_fatal(cio->pe, "malloc(nclist) failed\n"); }  
# 280
...
# 286
(cbuf) ? static_cast< void>(0) : __assert_fail("cbuf", "colloid_io.c", 286, __PRETTY_FUNCTION__); 
# 287
if (cbuf == (__null)) { pe_fatal(cio->pe, "malloc(cbuf) failed\n"); }  
# 289
...
# 297
(displ) ? static_cast< void>(0) : __assert_fail("displ", "colloid_io.c", 297, __PRETTY_FUNCTION__); 
# 298
if (displ == (__null)) { pe_fatal(cio->pe, "malloc(displ) failed\n"); }  
# 300
(displ[0]) = 0; 
# 301
...
ntotal += (nclist[n]); 
# 308
(displ[n]) *= sizeof(colloid_state_t); 
# 309
(nclist[n]) *= sizeof(colloid_state_t); 
# 310
}  
# 312
(ntotal > 0) ? static_cast< void>(0) : __assert_fail("ntotal > 0", "colloid_io.c", 312, __PRETTY_FUNCTION__); 
# 313
rbuf = ((colloid_state_t *)malloc(ntotal * sizeof(colloid_state_t))); 
# 314
(rbuf) ? static_cast< void>(0) : __assert_fail("rbuf", "colloid_io.c", 314, __PRETTY_FUNCTION__); 
# 315
if (rbuf == (__null)) { pe_fatal(cio->pe, "malloc(rbuf) failed\n"); }  
# 316
}  
# 318
MPI_Gatherv(cbuf, nc * sizeof(colloid_state_t), MPI_BYTE, rbuf, nclist, displ, MPI_BYTE, 0, cio->comm); 
# 321
if ((cio->rank) == 0) { 
# 323
...
colloid_t *pc = (__null); 
# 359
(cio) ? static_cast< void>(0) : __assert_fail("cio", "colloid_io.c", 359, __PRETTY_FUNCTION__); 
# 360
(buf) ? static_cast< void>(0) : __assert_fail("buf", "colloid_io.c", 360, __PRETTY_FUNCTION__); 
# 362
colloids_info_local_head(cio->info, &pc); 
# 364
while (pc) { 
# 365
(n < nc) ? static_cast< void>(0) : __assert_fail("n < nc", "colloid_io.c", 365, __PRETTY_FUNCTION__); 
# 366
...
int ifail = 0; 
# 390
(fp) ? static_cast< void>(0) : __assert_fail("fp", "colloid_io.c", 390, __PRETTY_FUNCTION__); 
# 391
(buf) ? static_cast< void>(0) : __assert_fail("buf", "colloid_io.c", 391, __PRETTY_FUNCTION__); 
# 393
for (n = 0; n < nc; n++) { 
# 394
...
int colloid_io_write_buffer_binary(FILE *fp, int nc, colloid_state_t *buf) { 
# 410
(fp) ? static_cast< void>(0) : __assert_fail("fp", "colloid_io.c", 410, __PRETTY_FUNCTION__); 
# 411
(buf) ? static_cast< void>(0) : __assert_fail("buf", "colloid_io.c", 411, __PRETTY_FUNCTION__); 
# 413
...
FILE *fp_state; 
# 435
(cio->f_header_read) ? static_cast< void>(0) : __assert_fail("cio->f_header_read", "colloid_io.c", 435, __PRETTY_FUNCTION__); 
# 436
(cio->f_list_read) ? static_cast< void>(0) : __assert_fail("cio->f_list_read", "colloid_io.c", 436, __PRETTY_FUNCTION__); 
# 440
colloid_io_filename(cio, filename_io, filename); 
# 442
...
# 454
if (fp_state == (__null)) { pe_fatal(cio->pe, "Failed to open %s\n", filename_io); }  
# 456
...
int nr; 
# 498
(nfile) ? static_cast< void>(0) : __assert_fail("nfile", "colloid_io.c", 498, __PRETTY_FUNCTION__); 
# 500
nr = fscanf(fp, "%22d\n", nfile); 
# 501
if (nr != 1) { return -1; }  
...
size_t nr; 
# 533
(fp) ? static_cast< void>(0) : __assert_fail("fp", "colloid_io.c", 533, __PRETTY_FUNCTION__); 
# 534
(nfile) ? static_cast< void>(0) : __assert_fail("nfile", "colloid_io.c", 534, __PRETTY_FUNCTION__); 
# 536
...
# 548
static int colloid_io_write_list_ascii(colloid_io_t *cio, int 
# 549
ic, int jc, int kc, FILE *fp) { 
# 550
int ifail = 0; 
# 551
colloid_t *pc = (__null); 
# 553
(cio) ? static_cast< void>(0) : __assert_fail("cio", "colloid_io.c", 553, __PRETTY_FUNCTION__); 
# 554
(fp) ? static_cast< void>(0) : __assert_fail("fp", "colloid_io.c", 554, __PRETTY_FUNCTION__); 
# 556
...
# 572
static int colloid_io_read_list_ascii(colloid_io_t *cio, int ndata, FILE *
# 573
fp) { 
# 574
int ifail = 0; 
...
colloid_t *p_colloid; 
# 581
(cio) ? static_cast< void>(0) : __assert_fail("cio", "colloid_io.c", 581, __PRETTY_FUNCTION__); 
# 582
(fp) ? static_cast< void>(0) : __assert_fail("fp", "colloid_io.c", 582, __PRETTY_FUNCTION__); 
# 584
...
# 607
static int colloid_io_write_list_binary(colloid_io_t *cio, int 
# 608
ic, int jc, int kc, FILE *fp) { 
# 609
colloid_t *pc = (__null); 
# 611
(cio) ? static_cast< void>(0) : __assert_fail("cio", "colloid_io.c", 611, __PRETTY_FUNCTION__); 
# 612
(fp) ? static_cast< void>(0) : __assert_fail("fp", "colloid_io.c", 612, __PRETTY_FUNCTION__); 
# 614
colloids_info_cell_list_head(cio->info, ic, jc, kc, &pc); 
# 616
while (pc) { 
...
# 630
static int colloid_io_read_list_binary(colloid_io_t *cio, int ndata, FILE *
# 631
fp) { 
# 633
int nread; 
...
colloid_t *pc = (__null); 
# 637
(cio) ? static_cast< void>(0) : __assert_fail("cio", "colloid_io.c", 637, __PRETTY_FUNCTION__); 
# 638
(fp) ? static_cast< void>(0) : __assert_fail("fp", "colloid_io.c", 638, __PRETTY_FUNCTION__); 
# 640
for (nread = 0; nread < ndata; nread++) { 
# 641
...
int colloid_io_format_input_ascii_set(colloid_io_t *cio) { 
# 657
(cio) ? static_cast< void>(0) : __assert_fail("cio", "colloid_io.c", 657, __PRETTY_FUNCTION__); 
# 659
...
int colloid_io_format_input_binary_set(colloid_io_t *cio) { 
# 673
(cio) ? static_cast< void>(0) : __assert_fail("cio", "colloid_io.c", 673, __PRETTY_FUNCTION__); 
# 675
...
int colloid_io_format_input_serial_set(colloid_io_t *cio) { 
# 689
(cio) ? static_cast< void>(0) : __assert_fail("cio", "colloid_io.c", 689, __PRETTY_FUNCTION__); 
# 691
...
int colloid_io_format_output_ascii_set(colloid_io_t *cio) { 
# 704
(cio) ? static_cast< void>(0) : __assert_fail("cio", "colloid_io.c", 704, __PRETTY_FUNCTION__); 
# 706
...
# 736 "colloid_io.c"
static int colloid_io_filename(colloid_io_t *cio, char *filename, const char *
# 737
stub) { 
# 738
(cio) ? static_cast< void>(0) : __assert_fail("cio", "colloid_io.c", 738, __PRETTY_FUNCTION__); 
# 739
(stub) ? static_cast< void>(0) : __assert_fail("stub", "colloid_io.c", 739, __PRETTY_FUNCTION__); 
# 740
(strlen(stub) < (4096 / 2)) ? static_cast< void>(0) : __assert_fail("strlen(stub) < 4096/2", "colloid_io.c", 740, __PRETTY_FUNCTION__); 
# 742
if ((cio->index) >= 1000) { 
# 743
...
int ntotal; 
# 768
(cio) ? static_cast< void>(0) : __assert_fail("cio", "colloid_io.c", 768, __PRETTY_FUNCTION__); 
# 770
colloids_info_nlocal(cio->info, &nlocal); 
# 772
...
# 1 "colloid_io.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__18_colloid_io_cpp1_ii_c01db1de
# 1 "colloid_io.cudafe1.stub.c"
#include "colloid_io.cudafe1.stub.c"
# 1 "colloid_io.cudafe1.stub.c"
