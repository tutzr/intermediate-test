...
char key1[4096]; 
# 38
(pe) ? static_cast< void>(0) : __assert_fail("pe", "advection_rt.c", 38, __PRETTY_FUNCTION__); 
# 39
(rt) ? static_cast< void>(0) : __assert_fail("rt", "advection_rt.c", 39, __PRETTY_FUNCTION__); 
# 41
rt_string_parameter(rt, "free_energy", key1, 4096); 
# 43
...
# 1 "advection_rt.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__20_advection_rt_cpp1_ii_3322db59
# 1 "advection_rt.cudafe1.stub.c"
#include "advection_rt.cudafe1.stub.c"
# 1 "advection_rt.cudafe1.stub.c"
