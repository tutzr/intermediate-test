...
tdpError_t tdpThreadModelInfo(FILE *fp) { 
# 35
(fp) ? static_cast< void>(0) : __assert_fail("fp", "target_hip.c", 35, __PRETTY_FUNCTION__); 
# 37
...
# 50
__attribute__((unused)) int tdpAtomicAddInt(int *sum, int val) {int volatile ___ = 1;(void)sum;(void)val;
# 53
::exit(___);}
#if 0
# 50
...
#endif
# 66 "target_hip.c"
__attribute__((unused)) double tdpAtomicAddDouble(double *sum, double val) {int volatile ___ = 1;(void)sum;(void)val;
# 87
::exit(___);}
#if 0
# 66
{ 
# 74
unsigned long long *address_as_ull = (unsigned long long *)sum; 
# 75
...
#endif
# 95 "target_hip.c"
__attribute__((unused)) double tdpAtomicMinDouble(double *minval, double val) {int volatile ___ = 1;(void)minval;(void)val;
# 108
::exit(___);}
#if 0
# 95
{ 
# 97
unsigned long long *address_as_ull = (unsigned long long *)minval; 
# 98
unsigned long long old = *address_as_ull; 
# 99
unsigned long long assumed; 
...
assumed = old; 
# 103
old = atomicCAS(address_as_ull, assumed, __double_as_longlong(fminf(val, __longlong_as_double(assumed)))); 
# 105
} while (assumed != old); 
# 107
return __longlong_as_double(old); 
...
#endif
# 119 "target_hip.c"
__attribute__((unused)) int tdpAtomicBlockAddInt(int *partsum) {int volatile ___ = 1;(void)partsum;
# 136
::exit(___);}
#if 0
# 119
...
#endif
# 146 "target_hip.c"
__attribute__((unused)) double tdpAtomicBlockAddDouble(double *partsum) {int volatile ___ = 1;(void)partsum;
# 163
::exit(___);}
#if 0
# 146
...
#endif
# 171 "target_hip.c"
void tdpErrorHandler(tdpError_t ifail, const char *file, int 
# 172
line, int fatal) { 
# 175
if (ifail != (hipSuccess)) { 
# 176
printf("Line %d (%s): %s %s\n", line, file, hipGetErrorName(ifail), hipGetErrorString(ifail)); 
# 178
if (fatal) { (0) ? static_cast< void>(0) : __assert_fail("0", "target_hip.c", 178, __PRETTY_FUNCTION__); }  
# 179
}  
# 189 "target_hip.c"
} 
# 197
tdpError_t tdpDeviceGetAttribute(int *value, tdpDeviceAttr 
# 198
attr, int 
# 199
device) { 
...
# 287
tdpError_t tdpMallocManaged(void **devptr, size_t size, unsigned 
# 288
flag) { 
# 290
...
# 293
tdpError_t tdpMemcpy(void *dst, const void *src, size_t count, tdpMemcpyKind 
# 294
kind) { 
# 296
...
# 299
tdpError_t tdpMemcpyAsync(void *dst, const void *src, size_t count, tdpMemcpyKind 
# 300
kind, tdpStream_t stream) { 
# 302
...
# 320
tdpError_t tdpHostAlloc(void **phost, size_t size, unsigned 
# 321
flags) { 
# 323
...
# 1 "target_hip.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__18_target_hip_cpp1_ii_d9edec20
# 1 "target_hip.cudafe1.stub.c"
#include "target_hip.cudafe1.stub.c"
# 1 "target_hip.cudafe1.stub.c"
