...
# 55
(pe) ? static_cast< void>(0) : __assert_fail("pe", "control.c", 55, __PRETTY_FUNCTION__); 
# 56
(rt) ? static_cast< void>(0) : __assert_fail("rt", "control.c", 56, __PRETTY_FUNCTION__); 
# 57
physics_ref(&phys); 
# 60
t_start = 0; 
...
# 1 "control.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__15_control_cpp1_ii_933053d7
# 1 "control.cudafe1.stub.c"
#include "control.cudafe1.stub.c"
# 1 "control.cudafe1.stub.c"
