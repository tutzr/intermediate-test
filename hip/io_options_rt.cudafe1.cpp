...
# 38 "io_options_rt.c"
int io_options_rt(pe_t *pe, rt_t *rt, const char *keystub, io_options_t *
# 39
options) { 
# 41
char key[8192] = {(0)}; 
...
# 46
(pe) ? static_cast< void>(0) : __assert_fail("pe", "io_options_rt.c", 46, __PRETTY_FUNCTION__); 
# 47
(rt) ? static_cast< void>(0) : __assert_fail("rt", "io_options_rt.c", 47, __PRETTY_FUNCTION__); 
# 48
(keystub) ? static_cast< void>(0) : __assert_fail("keystub", "io_options_rt.c", 48, __PRETTY_FUNCTION__); 
# 49
(options) ? static_cast< void>(0) : __assert_fail("options", "io_options_rt.c", 49, __PRETTY_FUNCTION__); 
# 52
...
# 86
int io_options_rt_mode(pe_t *pe, rt_t *rt, const char *key, io_mode_enum_t *
# 87
mode) { 
# 88
int key_present = 0; 
...
# 92
(pe) ? static_cast< void>(0) : __assert_fail("pe", "io_options_rt.c", 92, __PRETTY_FUNCTION__); 
# 93
(rt) ? static_cast< void>(0) : __assert_fail("rt", "io_options_rt.c", 93, __PRETTY_FUNCTION__); 
# 94
(key) ? static_cast< void>(0) : __assert_fail("key", "io_options_rt.c", 94, __PRETTY_FUNCTION__); 
# 95
(mode) ? static_cast< void>(0) : __assert_fail("mode", "io_options_rt.c", 95, __PRETTY_FUNCTION__); 
# 97
key_present = rt_string_parameter(rt, key, value, 8192); 
# 98
...
# 124 "io_options_rt.c"
int io_options_rt_record_format(pe_t *pe, rt_t *rt, const char *
# 125
key, io_record_format_enum_t *
# 126
iorformat) { 
# 127
int key_present = 0; 
...
# 131
(pe) ? static_cast< void>(0) : __assert_fail("pe", "io_options_rt.c", 131, __PRETTY_FUNCTION__); 
# 132
(rt) ? static_cast< void>(0) : __assert_fail("rt", "io_options_rt.c", 132, __PRETTY_FUNCTION__); 
# 133
(key) ? static_cast< void>(0) : __assert_fail("key", "io_options_rt.c", 133, __PRETTY_FUNCTION__); 
# 134
(iorformat) ? static_cast< void>(0) : __assert_fail("iorformat", "io_options_rt.c", 134, __PRETTY_FUNCTION__); 
# 136
key_present = rt_string_parameter(rt, key, value, 8192); 
# 137
util_str_tolower(value, strlen(value)); 
...
# 1 "io_options_rt.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__21_io_options_rt_cpp1_ii_f64c3a7c
# 1 "io_options_rt.cudafe1.stub.c"
#include "io_options_rt.cudafe1.stub.c"
# 1 "io_options_rt.cudafe1.stub.c"
