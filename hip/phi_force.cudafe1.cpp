...
# 43 "phi_force.c"
static int phi_force_compute_fluxes(lees_edw_t * le, fe_t * fe, int nall, double * fxe, double * fxw, double * fxy, double * fxz); 
# 48
static int phi_force_flux_divergence(cs_t * cs, hydro_t * hydro, double * fe, double * fw, double * fy, double * fz); 
# 50
static int phi_force_flux_fix_local(lees_edw_t * le, int nall, double * fluxe, double * fluxw); 
# 52
static int phi_force_flux_divergence_with_fix(cs_t * cs, hydro_t * hydro, double * fe, double * fw, double * fy, double * fz); 
# 56
static int phi_force_flux(cs_t * cs, lees_edw_t * le, fe_t * fe, wall_t * wall, hydro_t * hydro); 
# 58
static int phi_force_wallx(cs_t * cs, wall_t * wall, fe_t * fe, double * fxe, double * fxw); 
# 59
static int phi_force_fluid_phi_gradmu(lees_edw_t * le, pth_t * pth, fe_t * fe, field_t * phi, hydro_t * hydro); 
# 62
static int phi_force_fluid_phi_gradmu_ext(cs_t * cs, field_t * fphi, hydro_t * hydro); 
# 80 "phi_force.c"
int phi_force_calculation(cs_t *cs, lees_edw_t *le, wall_t *wall, pth_t *
# 81
pth, fe_t *fe, map_t *map, field_t *
# 82
phi, hydro_t *hydro) { 
# 84
int is_pm; 
# 86
if (pth == (__null)) { return 0; }  
# 87
...
default:  
# 113
(0) ? static_cast< void>(0) : __assert_fail("0", "phi_force.c", 113, __PRETTY_FUNCTION__); 
# 114
}  
# 115
}  
...
# 136 "phi_force.c"
static int phi_force_fluid_phi_gradmu(lees_edw_t *le, pth_t *pth, fe_t *
# 137
fe, field_t *fphi, hydro_t *
# 138
hydro) { 
# 140
...
double force[3]; 
# 148
(le) ? static_cast< void>(0) : __assert_fail("le", "phi_force.c", 148, __PRETTY_FUNCTION__); 
# 149
(fphi) ? static_cast< void>(0) : __assert_fail("fphi", "phi_force.c", 149, __PRETTY_FUNCTION__); 
# 150
(hydro) ? static_cast< void>(0) : __assert_fail("hydro", "phi_force.c", 150, __PRETTY_FUNCTION__); 
# 152
lees_edw_nhalo(le, &nhalo); 
# 153
lees_edw_nlocal(le, nlocal); 
# 154
(nhalo >= 2) ? static_cast< void>(0) : __assert_fail("nhalo >= 2", "phi_force.c", 154, __PRETTY_FUNCTION__); 
# 157
zs = 1; 
# 158
...
# 209 "phi_force.c"
static int phi_force_fluid_phi_gradmu_ext(cs_t *cs, field_t *fphi, hydro_t *
# 210
hydro) { 
# 211
int ic, jc, kc; 
...
# 220
(cs) ? static_cast< void>(0) : __assert_fail("cs", "phi_force.c", 220, __PRETTY_FUNCTION__); 
# 221
(fphi) ? static_cast< void>(0) : __assert_fail("fphi", "phi_force.c", 221, __PRETTY_FUNCTION__); 
# 222
(hydro) ? static_cast< void>(0) : __assert_fail("hydro", "phi_force.c", 222, __PRETTY_FUNCTION__); 
# 224
cs_nlocal(cs, nlocal); 
# 226
physics_ref(&phys); 
...
# 268 "phi_force.c"
static int phi_force_flux(cs_t *cs, lees_edw_t *le, fe_t *fe, wall_t *
# 269
wall, hydro_t *hydro) { 
# 270
int n; 
...
double *fluxz; 
# 279
(hydro) ? static_cast< void>(0) : __assert_fail("hydro", "phi_force.c", 279, __PRETTY_FUNCTION__); 
# 281
...
# 289
if (fluxe == (__null)) { pe_fatal(hydro->pe, "malloc(fluxe) force failed"); }  
# 290
if (fluxw == (__null)) { pe_fatal(hydro->pe, "malloc(fluxw) force failed"); }  
# 291
if (fluxy == (__null)) { pe_fatal(hydro->pe, "malloc(fluxy) force failed"); }  
# 292
if (fluxz == (__null)) { pe_fatal(hydro->pe, "malloc(fluxz) force failed"); }  
# 294
...
# 329 "phi_force.c"
static int phi_force_compute_fluxes(lees_edw_t *le, fe_t *fe, int nall, double *
# 330
fluxe, double *fluxw, double *
# 331
fluxy, double *fluxz) { 
# 333
...
double pth1[3][3]; 
# 340
(le) ? static_cast< void>(0) : __assert_fail("le", "phi_force.c", 340, __PRETTY_FUNCTION__); 
# 341
(fe) ? static_cast< void>(0) : __assert_fail("fe", "phi_force.c", 341, __PRETTY_FUNCTION__); 
# 342
((fe->func)->stress) ? static_cast< void>(0) : __assert_fail("fe->func->stress", "phi_force.c", 342, __PRETTY_FUNCTION__); 
# 344
lees_edw_nlocal(le, nlocal); 
# 346
for (ic = 1; ic <= (nlocal[X]); ic++) { 
...
for (ia = 0; ia < 3; ia++) { 
# 364
(fluxw[reverse_addr_rank1_assert(364, "phi_force.c", nall, 3, index, ia)]) = ((0.5) * (((pth1[ia])[X]) + ((pth0[ia])[X]))); 
# 365
}  
# 369
...
for (ia = 0; ia < 3; ia++) { 
# 373
(fluxe[reverse_addr_rank1_assert(373, "phi_force.c", nall, 3, index, ia)]) = ((0.5) * (((pth1[ia])[X]) + ((pth0[ia])[X]))); 
# 374
}  
# 378
...
for (ia = 0; ia < 3; ia++) { 
# 382
(fluxy[reverse_addr_rank1_assert(382, "phi_force.c", nall, 3, index, ia)]) = ((0.5) * (((pth1[ia])[Y]) + ((pth0[ia])[Y]))); 
# 383
}  
# 387
...
for (ia = 0; ia < 3; ia++) { 
# 391
(fluxz[reverse_addr_rank1_assert(391, "phi_force.c", nall, 3, index, ia)]) = ((0.5) * (((pth1[ia])[Z]) + ((pth0[ia])[Z]))); 
# 392
}  
# 394
}  
...
# 410 "phi_force.c"
static int phi_force_flux_divergence(cs_t *cs, hydro_t *hydro, double *
# 411
fluxe, double *fluxw, double *
# 412
fluxy, double *fluxz) { 
...
# 418
(cs) ? static_cast< void>(0) : __assert_fail("cs", "phi_force.c", 418, __PRETTY_FUNCTION__); 
# 419
(hydro) ? static_cast< void>(0) : __assert_fail("hydro", "phi_force.c", 419, __PRETTY_FUNCTION__); 
# 420
(fluxe) ? static_cast< void>(0) : __assert_fail("fluxe", "phi_force.c", 420, __PRETTY_FUNCTION__); 
# 421
(fluxw) ? static_cast< void>(0) : __assert_fail("fluxw", "phi_force.c", 421, __PRETTY_FUNCTION__); 
# 422
(fluxy) ? static_cast< void>(0) : __assert_fail("fluxy", "phi_force.c", 422, __PRETTY_FUNCTION__); 
# 423
(fluxz) ? static_cast< void>(0) : __assert_fail("fluxz", "phi_force.c", 423, __PRETTY_FUNCTION__); 
# 425
cs_nlocal(cs, nlocal); 
# 426
cs_nsites(cs, &nsf); 
...
for (ia = 0; ia < 3; ia++) { 
# 437
((hydro->f)[reverse_addr_rank1_assert(437, "phi_force.c", hydro->nsite, 3, index, ia)]) += (-((((((+(fluxe[reverse_addr_rank1_assert(438, "phi_force.c", nsf, 3, index, ia)])) - (fluxw[reverse_addr_rank1_assert(439, "phi_force.c", nsf, 3, index, ia)])) + (fluxy[reverse_addr_rank1_assert(440, "phi_force.c", nsf, 3, index, ia)])) - (fluxy[reverse_addr_rank1_assert(441, "phi_force.c", nsf, 3, indexj, ia)])) + (fluxz[reverse_addr_rank1_assert(442, "phi_force.c", nsf, 3, index, ia)])) - (fluxz[reverse_addr_rank1_assert(443, "phi_force.c", nsf, 3, indexk, ia)]))); 
# 444
}  
# 445
}  
...
# 469 "phi_force.c"
static int phi_force_flux_divergence_with_fix(cs_t *cs, hydro_t *
# 470
hydro, double *
# 471
fluxe, double *fluxw, double *
...
MPI_Comm comm; 
# 486
(cs) ? static_cast< void>(0) : __assert_fail("cs", "phi_force.c", 486, __PRETTY_FUNCTION__); 
# 487
(hydro) ? static_cast< void>(0) : __assert_fail("hydro", "phi_force.c", 487, __PRETTY_FUNCTION__); 
# 488
(fluxe) ? static_cast< void>(0) : __assert_fail("fluxe", "phi_force.c", 488, __PRETTY_FUNCTION__); 
# 489
(fluxw) ? static_cast< void>(0) : __assert_fail("fluxw", "phi_force.c", 489, __PRETTY_FUNCTION__); 
# 490
(fluxy) ? static_cast< void>(0) : __assert_fail("fluxy", "phi_force.c", 490, __PRETTY_FUNCTION__); 
# 491
(fluxz) ? static_cast< void>(0) : __assert_fail("fluxz", "phi_force.c", 491, __PRETTY_FUNCTION__); 
# 493
(0) ? static_cast< void>(0) : __assert_fail("0", "phi_force.c", 493, __PRETTY_FUNCTION__); 
# 495
cs_ltot(cs, ltot); 
# 496
cs_nlocal(cs, nlocal); 
...
for (ia = 0; ia < 3; ia++) { 
# 513
(f[ia]) = (-((((((+(fluxe[reverse_addr_rank1_assert(514, "phi_force.c", nsf, 3, index, ia)])) - (fluxw[reverse_addr_rank1_assert(515, "phi_force.c", nsf, 3, index, ia)])) + (fluxy[reverse_addr_rank1_assert(516, "phi_force.c", nsf, 3, index, ia)])) - (fluxy[reverse_addr_rank1_assert(517, "phi_force.c", nsf, 3, indexj, ia)])) + (fluxz[reverse_addr_rank1_assert(518, "phi_force.c", nsf, 3, index, ia)])) - (fluxz[reverse_addr_rank1_assert(519, "phi_force.c", nsf, 3, indexk, ia)]))); 
# 520
(fsum_local[ia]) += (f[ia]); 
# 521
}  
...
for (ia = 0; ia < 3; ia++) { 
# 543
(f[ia]) = (-((((((+(fluxe[reverse_addr_rank1_assert(544, "phi_force.c", nsf, 3, index, ia)])) - (fluxw[reverse_addr_rank1_assert(545, "phi_force.c", nsf, 3, index, ia)])) + (fluxy[reverse_addr_rank1_assert(546, "phi_force.c", nsf, 3, index, ia)])) - (fluxy[reverse_addr_rank1_assert(547, "phi_force.c", nsf, 3, indexj, ia)])) + (fluxz[reverse_addr_rank1_assert(548, "phi_force.c", nsf, 3, index, ia)])) - (fluxz[reverse_addr_rank1_assert(549, "phi_force.c", nsf, 3, indexk, ia)]))); 
# 550
(f[ia]) -= (fsum[ia]); 
# 551
}  
...
# 572 "phi_force.c"
static int phi_force_flux_fix_local(lees_edw_t *le, int nall, double *
# 573
fluxe, double *fluxw) { 
# 575
int nlocal[3]; 
...
MPI_Comm comm; 
# 587
(le) ? static_cast< void>(0) : __assert_fail("le", "phi_force.c", 587, __PRETTY_FUNCTION__); 
# 589
...
# 602
(fbar) ? static_cast< void>(0) : __assert_fail("fbar", "phi_force.c", 602, __PRETTY_FUNCTION__); 
# 603
(fcor) ? static_cast< void>(0) : __assert_fail("fcor", "phi_force.c", 603, __PRETTY_FUNCTION__); 
# 606
...
for (ia = 0; ia < 3; ia++) { 
# 617
(fbar[(3 * ip) + ia]) += ((-(fluxe[reverse_addr_rank1_assert(617, "phi_force.c", nall, 3, index, ia)])) + (fluxw[reverse_addr_rank1_assert(618, "phi_force.c", nall, 3, index1, ia)])); 
# 619
}  
# 620
}  
...
for (ia = 0; ia < 3; ia++) { 
# 639
(fluxe[reverse_addr_rank1_assert(639, "phi_force.c", nall, 3, index, ia)]) += (ra * (fcor[(3 * ip) + ia])); 
# 640
(fluxw[reverse_addr_rank1_assert(640, "phi_force.c", nall, 3, index1, ia)]) -= (ra * (fcor[(3 * ip) + ia])); 
# 641
}  
# 642
}  
...
# 664 "phi_force.c"
static int phi_force_wallx(cs_t *cs, wall_t *wall, fe_t *fe, double *fluxe, double *
# 665
fluxw) { 
# 667
int ic, jc, kc; 
...
double pth0[3][3]; 
# 677
(cs) ? static_cast< void>(0) : __assert_fail("cs", "phi_force.c", 677, __PRETTY_FUNCTION__); 
# 678
(wall) ? static_cast< void>(0) : __assert_fail("wall", "phi_force.c", 678, __PRETTY_FUNCTION__); 
# 679
(fe) ? static_cast< void>(0) : __assert_fail("fe", "phi_force.c", 679, __PRETTY_FUNCTION__); 
# 680
((fe->func)->stress) ? static_cast< void>(0) : __assert_fail("fe->func->stress", "phi_force.c", 680, __PRETTY_FUNCTION__); 
# 682
cs_nlocal(cs, nlocal); 
# 683
cs_nsites(cs, &nsf); 
...
for (ia = 0; ia < 3; ia++) { 
# 701
(fluxw[reverse_addr_rank1_assert(701, "phi_force.c", nsf, 3, index, ia)]) = ((pth0[ia])[X]); 
# 702
(fw[ia]) -= ((pth0[ia])[X]); 
# 703
}  
...
for (ia = 0; ia < 3; ia++) { 
# 718
(fluxe[reverse_addr_rank1_assert(718, "phi_force.c", nsf, 3, index, ia)]) = ((pth0[ia])[X]); 
# 719
(fw[ia]) += ((pth0[ia])[X]); 
# 720
}  
...
# 1 "phi_force.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__17_phi_force_cpp1_ii_48e8bebc
# 1 "phi_force.cudafe1.stub.c"
#include "phi_force.cudafe1.stub.c"
# 1 "phi_force.cudafe1.stub.c"
