...
# 41
int wall_info(wall_t * wall); 
# 42
int wall_commit(wall_t * wall, wall_param_t * values); 
# 43
int wall_target(wall_t * wall, wall_t ** target); 
# 44
int wall_param(wall_t * wall, wall_param_t * param); 
# 45
int wall_param_set(wall_t * wall, wall_param_t * values); 
# 46
int wall_shear_init(wall_t * wall); 
# 47
int wall_memcpy(wall_t * wall, tdpMemcpyKind flag); 
# 49
int wall_bbl(wall_t * wall); 
# 50
int wall_set_wall_distributions(wall_t * wall); 
# 51
int wall_lubr_sphere(wall_t * wall, double ah, const double  r[3], double  drag[3]); 
# 53
int wall_momentum(wall_t * wall, double  g[3]); 
# 54
int wall_momentum_add(wall_t * wall, const double  g[3]); 
# 56
int wall_is_pm(wall_t * wall, int * ispm); 
# 57
int wall_present(wall_t * wall); 
# 58
int wall_present_dim(wall_t * wall, int  iswall[3]); 
# 23 "halo_swap.h"
...
# 57
int grad_3d_27pt_fluid_operator(cs_t * cs, lees_edw_t * le, field_grad_t * fg, int nextra, grad_enum_t type); 
# 60
int grad_3d_27pt_fluid_le(lees_edw_t * le, field_grad_t * fg, int nextra, grad_enum_t type); 
# 63
int grad_3d_27pt_dab_le_correct(lees_edw_t * le, field_grad_t * df); 
# 64
int grad_3d_27pt_fluid_dab_compute(lees_edw_t * le, field_grad_t * df); 
# 66
void grad_3d_27pt_kernel(kernel_ctxt_t * ktx, int nf, int ys, lees_edw_t * le, grad_enum_t type, field_t * f, field_grad_t * fgrad); 
# 78
int grad_3d_27pt_fluid_d2(field_grad_t *fgrad) { 
# 80
int nhalo; 
# 81
int nextra; 
...
# 85
(fgrad) ? static_cast< void>(0) : __assert_fail("fgrad", "gradient_3d_27pt_fluid.c", 85, __PRETTY_FUNCTION__); 
# 86
(fgrad->field) ? static_cast< void>(0) : __assert_fail("fgrad->field", "gradient_3d_27pt_fluid.c", 86, __PRETTY_FUNCTION__); 
# 87
((fgrad->field)->cs) ? static_cast< void>(0) : __assert_fail("fgrad->field->cs", "gradient_3d_27pt_fluid.c", 87, __PRETTY_FUNCTION__); 
# 88
((fgrad->field)->le) ? static_cast< void>(0) : __assert_fail("fgrad->field->le", "gradient_3d_27pt_fluid.c", 88, __PRETTY_FUNCTION__); 
# 90
cs = ((fgrad->field)->cs); 
# 91
le = ((fgrad->field)->le); 
...
nextra = (nhalo - 1); 
# 95
(nextra >= 0) ? static_cast< void>(0) : __assert_fail("nextra >= 0", "gradient_3d_27pt_fluid.c", 95, __PRETTY_FUNCTION__); 
# 97
...
# 114 "gradient_3d_27pt_fluid.c"
int grad_3d_27pt_fluid_d4(field_grad_t *fgrad) { 
# 116
int nextra; 
# 117
cs_t *cs = (__null); 
...
lees_edw_t *le = (__null); 
# 120
(fgrad) ? static_cast< void>(0) : __assert_fail("fgrad", "gradient_3d_27pt_fluid.c", 120, __PRETTY_FUNCTION__); 
# 121
(fgrad->field) ? static_cast< void>(0) : __assert_fail("fgrad->field", "gradient_3d_27pt_fluid.c", 121, __PRETTY_FUNCTION__); 
# 122
((fgrad->field)->cs) ? static_cast< void>(0) : __assert_fail("fgrad->field->cs", "gradient_3d_27pt_fluid.c", 122, __PRETTY_FUNCTION__); 
# 123
((fgrad->field)->le) ? static_cast< void>(0) : __assert_fail("fgrad->field->le", "gradient_3d_27pt_fluid.c", 123, __PRETTY_FUNCTION__); 
# 125
cs = ((fgrad->field)->cs); 
# 126
le = ((fgrad->field)->le); 
...
nextra -= 2; 
# 130
(nextra >= 0) ? static_cast< void>(0) : __assert_fail("nextra >= 0", "gradient_3d_27pt_fluid.c", 130, __PRETTY_FUNCTION__); 
# 132
...
# 156 "gradient_3d_27pt_fluid.c"
int grad_3d_27pt_fluid_dab(field_grad_t *fgrad) { 
# 158
lees_edw_t *le = (__null); 
# 160
(fgrad) ? static_cast< void>(0) : __assert_fail("fgrad", "gradient_3d_27pt_fluid.c", 160, __PRETTY_FUNCTION__); 
# 161
(fgrad->field) ? static_cast< void>(0) : __assert_fail("fgrad->field", "gradient_3d_27pt_fluid.c", 161, __PRETTY_FUNCTION__); 
# 162
(((fgrad->field)->nf) == 1) ? static_cast< void>(0) : __assert_fail("fgrad->field->nf == 1", "gradient_3d_27pt_fluid.c", 162, __PRETTY_FUNCTION__); 
# 164
le = ((fgrad->field)->le); 
# 165
...
# 179 "gradient_3d_27pt_fluid.c"
int grad_3d_27pt_fluid_operator(cs_t *cs, lees_edw_t *le, field_grad_t *
# 180
fg, int 
# 181
nextra, grad_enum_t type) { 
# 182
int nlocal[3]; 
# 183
int xs, ys, zs; 
...
# 200
do { (__cudaPushCallConfiguration(nblk, ntpb, 0, 0)) ? (void)0 : grad_3d_27pt_kernel(ctxt->target, (fg->field)->nf, ys, letarget, type, (fg->field)->target, fg->target); } while (0); 
# 202
; 
# 203
...
void grad_3d_27pt_kernel(kernel_ctxt_t *ktx, int nf, int ys, lees_edw_t *
# 219
le, grad_enum_t 
# 220
type, field_t *
...
# 228
(ktx) ? static_cast< void>(0) : __assert_fail("ktx", "gradient_3d_27pt_fluid.c", 228, __PRETTY_FUNCTION__); 
# 229
(le) ? static_cast< void>(0) : __assert_fail("le", "gradient_3d_27pt_fluid.c", 229, __PRETTY_FUNCTION__); 
# 230
((type == (GRAD_DEL2)) || (type == (GRAD_DEL4))) ? static_cast< void>(0) : __assert_fail("type == GRAD_DEL2 || type == GRAD_DEL4", "gradient_3d_27pt_fluid.c", 230, __PRETTY_FUNCTION__); 
# 231
(f) ? static_cast< void>(0) : __assert_fail("f", "gradient_3d_27pt_fluid.c", 231, __PRETTY_FUNCTION__); 
# 232
(fgrad) ? static_cast< void>(0) : __assert_fail("fgrad", "gradient_3d_27pt_fluid.c", 232, __PRETTY_FUNCTION__); 
# 234
kiterations = kernel_iterations(ktx); 
# 236
kindex = ((1) * (((__device_builtin_variable_blockIdx.x) * (__device_builtin_variable_blockDim.x)) + (__device_builtin_variable_threadIdx.x))); if (kindex < kiterations) { 
# 238
int n; 
# 239
int ic, jc, kc; 
...
for (n = 0; n < nf; n++) { 
# 270
(grad[reverse_addr_rank2_assert(270, "gradient_3d_27pt_fluid.c", f->nsites, nf, 3, index, n, X)]) = (((0.5) * r9) * ((((((((((((((((((+(field[reverse_addr_rank1_assert(271, "gradient_3d_27pt_fluid.c", f->nsites, nf, (indexp1 - ys) - 1, n)])) - (field[reverse_addr_rank1_assert(272, "gradient_3d_27pt_fluid.c", f->nsites, nf, (indexm1 - ys) - 1, n)])) + (field[reverse_addr_rank1_assert(273, "gradient_3d_27pt_fluid.c", f->nsites, nf, indexp1 - ys, n)])) - (field[reverse_addr_rank1_assert(274, "gradient_3d_27pt_fluid.c", f->nsites, nf, indexm1 - ys, n)])) + (field[reverse_addr_rank1_assert(275, "gradient_3d_27pt_fluid.c", f->nsites, nf, (indexp1 - ys) + 1, n)])) - (field[reverse_addr_rank1_assert(276, "gradient_3d_27pt_fluid.c", f->nsites, nf, (indexm1 - ys) + 1, n)])) + (field[reverse_addr_rank1_assert(277, "gradient_3d_27pt_fluid.c", f->nsites, nf, indexp1 - 1, n)])) - (field[reverse_addr_rank1_assert(278, "gradient_3d_27pt_fluid.c", f->nsites, nf, indexm1 - 1, n)])) + (field[reverse_addr_rank1_assert(279, "gradient_3d_27pt_fluid.c", f->nsites, nf, indexp1, n)])) - (field[reverse_addr_rank1_assert(280, "gradient_3d_27pt_fluid.c", f->nsites, nf, indexm1, n)])) + (field[reverse_addr_rank1_assert(281, "gradient_3d_27pt_fluid.c", f->nsites, nf, indexp1 + 1, n)])) - (field[reverse_addr_rank1_assert(282, "gradient_3d_27pt_fluid.c", f->nsites, nf, indexm1 + 1, n)])) + (field[reverse_addr_rank1_assert(283, "gradient_3d_27pt_fluid.c", f->nsites, nf, (indexp1 + ys) - 1, n)])) - (field[reverse_addr_rank1_assert(284, "gradient_3d_27pt_fluid.c", f->nsites, nf, (indexm1 + ys) - 1, n)])) + (field[reverse_addr_rank1_assert(285, "gradient_3d_27pt_fluid.c", f->nsites, nf, indexp1 + ys, n)])) - (field[reverse_addr_rank1_assert(286, "gradient_3d_27pt_fluid.c", f->nsites, nf, indexm1 + ys, n)])) + (field[reverse_addr_rank1_assert(287, "gradient_3d_27pt_fluid.c", f->nsites, nf, (indexp1 + ys) + 1, n)])) - (field[reverse_addr_rank1_assert(288, "gradient_3d_27pt_fluid.c", f->nsites, nf, (indexm1 + ys) + 1, n)]))); 
# 290
(grad[reverse_addr_rank2_assert(290, "gradient_3d_27pt_fluid.c", f->nsites, nf, 3, index, n, Y)]) = (((0.5) * r9) * ((((((((((((((((((+(field[reverse_addr_rank1_assert(291, "gradient_3d_27pt_fluid.c", f->nsites, nf, (indexm1 + ys) - 1, n)])) - (field[reverse_addr_rank1_assert(292, "gradient_3d_27pt_fluid.c", f->nsites, nf, (indexm1 - ys) - 1, n)])) + (field[reverse_addr_rank1_assert(293, "gradient_3d_27pt_fluid.c", f->nsites, nf, indexm1 + ys, n)])) - (field[reverse_addr_rank1_assert(294, "gradient_3d_27pt_fluid.c", f->nsites, nf, indexm1 - ys, n)])) + (field[reverse_addr_rank1_assert(295, "gradient_3d_27pt_fluid.c", f->nsites, nf, (indexm1 + ys) + 1, n)])) - (field[reverse_addr_rank1_assert(296, "gradient_3d_27pt_fluid.c", f->nsites, nf, (indexm1 - ys) + 1, n)])) + (field[reverse_addr_rank1_assert(297, "gradient_3d_27pt_fluid.c", f->nsites, nf, (index + ys) - 1, n)])) - (field[reverse_addr_rank1_assert(298, "gradient_3d_27pt_fluid.c", f->nsites, nf, (index - ys) - 1, n)])) + (field[reverse_addr_rank1_assert(299, "gradient_3d_27pt_fluid.c", f->nsites, nf, index + ys, n)])) - (field[reverse_addr_rank1_assert(300, "gradient_3d_27pt_fluid.c", f->nsites, nf, index - ys, n)])) + (field[reverse_addr_rank1_assert(301, "gradient_3d_27pt_fluid.c", f->nsites, nf, (index + ys) + 1, n)])) - (field[reverse_addr_rank1_assert(302, "gradient_3d_27pt_fluid.c", f->nsites, nf, (index - ys) + 1, n)])) + (field[reverse_addr_rank1_assert(303, "gradient_3d_27pt_fluid.c", f->nsites, nf, (indexp1 + ys) - 1, n)])) - (field[reverse_addr_rank1_assert(304, "gradient_3d_27pt_fluid.c", f->nsites, nf, (indexp1 - ys) - 1, n)])) + (field[reverse_addr_rank1_assert(305, "gradient_3d_27pt_fluid.c", f->nsites, nf, indexp1 + ys, n)])) - (field[reverse_addr_rank1_assert(306, "gradient_3d_27pt_fluid.c", f->nsites, nf, indexp1 - ys, n)])) + (field[reverse_addr_rank1_assert(307, "gradient_3d_27pt_fluid.c", f->nsites, nf, (indexp1 + ys) + 1, n)])) - (field[reverse_addr_rank1_assert(308, "gradient_3d_27pt_fluid.c", f->nsites, nf, (indexp1 - ys) + 1, n)]))); 
# 310
(grad[reverse_addr_rank2_assert(310, "gradient_3d_27pt_fluid.c", f->nsites, nf, 3, index, n, Z)]) = (((0.5) * r9) * ((((((((((((((((((+(field[reverse_addr_rank1_assert(311, "gradient_3d_27pt_fluid.c", f->nsites, nf, (indexm1 - ys) + 1, n)])) - (field[reverse_addr_rank1_assert(312, "gradient_3d_27pt_fluid.c", f->nsites, nf, (indexm1 - ys) - 1, n)])) + (field[reverse_addr_rank1_assert(313, "gradient_3d_27pt_fluid.c", f->nsites, nf, indexm1 + 1, n)])) - (field[reverse_addr_rank1_assert(314, "gradient_3d_27pt_fluid.c", f->nsites, nf, indexm1 - 1, n)])) + (field[reverse_addr_rank1_assert(315, "gradient_3d_27pt_fluid.c", f->nsites, nf, (indexm1 + ys) + 1, n)])) - (field[reverse_addr_rank1_assert(316, "gradient_3d_27pt_fluid.c", f->nsites, nf, (indexm1 + ys) - 1, n)])) + (field[reverse_addr_rank1_assert(317, "gradient_3d_27pt_fluid.c", f->nsites, nf, (index - ys) + 1, n)])) - (field[reverse_addr_rank1_assert(318, "gradient_3d_27pt_fluid.c", f->nsites, nf, (index - ys) - 1, n)])) + (field[reverse_addr_rank1_assert(319, "gradient_3d_27pt_fluid.c", f->nsites, nf, index + 1, n)])) - (field[reverse_addr_rank1_assert(320, "gradient_3d_27pt_fluid.c", f->nsites, nf, index - 1, n)])) + (field[reverse_addr_rank1_assert(321, "gradient_3d_27pt_fluid.c", f->nsites, nf, (index + ys) + 1, n)])) - (field[reverse_addr_rank1_assert(322, "gradient_3d_27pt_fluid.c", f->nsites, nf, (index + ys) - 1, n)])) + (field[reverse_addr_rank1_assert(323, "gradient_3d_27pt_fluid.c", f->nsites, nf, (indexp1 - ys) + 1, n)])) - (field[reverse_addr_rank1_assert(324, "gradient_3d_27pt_fluid.c", f->nsites, nf, (indexp1 - ys) - 1, n)])) + (field[reverse_addr_rank1_assert(325, "gradient_3d_27pt_fluid.c", f->nsites, nf, indexp1 + 1, n)])) - (field[reverse_addr_rank1_assert(326, "gradient_3d_27pt_fluid.c", f->nsites, nf, indexp1 - 1, n)])) + (field[reverse_addr_rank1_assert(327, "gradient_3d_27pt_fluid.c", f->nsites, nf, (indexp1 + ys) + 1, n)])) - (field[reverse_addr_rank1_assert(328, "gradient_3d_27pt_fluid.c", f->nsites, nf, (indexp1 + ys) - 1, n)]))); 
# 330
(del2[reverse_addr_rank1_assert(330, "gradient_3d_27pt_fluid.c", f->nsites, nf, index, n)]) = (r9 * (((((((((((((((((((((((((((+(field[reverse_addr_rank1_assert(331, "gradient_3d_27pt_fluid.c", f->nsites, nf, (indexm1 - ys) - 1, n)])) + (field[reverse_addr_rank1_assert(332, "gradient_3d_27pt_fluid.c", f->nsites, nf, indexm1 - ys, n)])) + (field[reverse_addr_rank1_assert(333, "gradient_3d_27pt_fluid.c", f->nsites, nf, (indexm1 - ys) + 1, n)])) + (field[reverse_addr_rank1_assert(334, "gradient_3d_27pt_fluid.c", f->nsites, nf, indexm1 - 1, n)])) + (field[reverse_addr_rank1_assert(335, "gradient_3d_27pt_fluid.c", f->nsites, nf, indexm1, n)])) + (field[reverse_addr_rank1_assert(336, "gradient_3d_27pt_fluid.c", f->nsites, nf, indexm1 + 1, n)])) + (field[reverse_addr_rank1_assert(337, "gradient_3d_27pt_fluid.c", f->nsites, nf, (indexm1 + ys) - 1, n)])) + (field[reverse_addr_rank1_assert(338, "gradient_3d_27pt_fluid.c", f->nsites, nf, indexm1 + ys, n)])) + (field[reverse_addr_rank1_assert(339, "gradient_3d_27pt_fluid.c", f->nsites, nf, (indexm1 + ys) + 1, n)])) + (field[reverse_addr_rank1_assert(340, "gradient_3d_27pt_fluid.c", f->nsites, nf, (index - ys) - 1, n)])) + (field[reverse_addr_rank1_assert(341, "gradient_3d_27pt_fluid.c", f->nsites, nf, index - ys, n)])) + (field[reverse_addr_rank1_assert(342, "gradient_3d_27pt_fluid.c", f->nsites, nf, (index - ys) + 1, n)])) + (field[reverse_addr_rank1_assert(343, "gradient_3d_27pt_fluid.c", f->nsites, nf, index - 1, n)])) + (field[reverse_addr_rank1_assert(344, "gradient_3d_27pt_fluid.c", f->nsites, nf, index + 1, n)])) + (field[reverse_addr_rank1_assert(345, "gradient_3d_27pt_fluid.c", f->nsites, nf, (index + ys) - 1, n)])) + (field[reverse_addr_rank1_assert(346, "gradient_3d_27pt_fluid.c", f->nsites, nf, index + ys, n)])) + (field[reverse_addr_rank1_assert(347, "gradient_3d_27pt_fluid.c", f->nsites, nf, (index + ys) + 1, n)])) + (field[reverse_addr_rank1_assert(348, "gradient_3d_27pt_fluid.c", f->nsites, nf, (indexp1 - ys) - 1, n)])) + (field[reverse_addr_rank1_assert(349, "gradient_3d_27pt_fluid.c", f->nsites, nf, indexp1 - ys, n)])) + (field[reverse_addr_rank1_assert(350, "gradient_3d_27pt_fluid.c", f->nsites, nf, (indexp1 - ys) + 1, n)])) + (field[reverse_addr_rank1_assert(351, "gradient_3d_27pt_fluid.c", f->nsites, nf, indexp1 - 1, n)])) + (field[reverse_addr_rank1_assert(352, "gradient_3d_27pt_fluid.c", f->nsites, nf, indexp1, n)])) + (field[reverse_addr_rank1_assert(353, "gradient_3d_27pt_fluid.c", f->nsites, nf, indexp1 + 1, n)])) + (field[reverse_addr_rank1_assert(354, "gradient_3d_27pt_fluid.c", f->nsites, nf, (indexp1 + ys) - 1, n)])) + (field[reverse_addr_rank1_assert(355, "gradient_3d_27pt_fluid.c", f->nsites, nf, indexp1 + ys, n)])) + (field[reverse_addr_rank1_assert(356, "gradient_3d_27pt_fluid.c", f->nsites, nf, (indexp1 + ys) + 1, n)])) - ((26.0) * (field[reverse_addr_rank1_assert(357, "gradient_3d_27pt_fluid.c", f->nsites, nf, index, n)])))); 
# 358
}  
# 359
}  
...
#endif
# 375 "gradient_3d_27pt_fluid.c"
int grad_3d_27pt_fluid_le(lees_edw_t *le, field_grad_t *fg, int 
# 376
nextra, grad_enum_t type) { 
# 378
int nop; 
...
double *__restrict__ del2; 
# 396
(le) ? static_cast< void>(0) : __assert_fail("le", "gradient_3d_27pt_fluid.c", 396, __PRETTY_FUNCTION__); 
# 397
(fg) ? static_cast< void>(0) : __assert_fail("fg", "gradient_3d_27pt_fluid.c", 397, __PRETTY_FUNCTION__); 
# 398
((type == (GRAD_DEL2)) || (type == (GRAD_DEL4))) ? static_cast< void>(0) : __assert_fail("type == GRAD_DEL2 || type == GRAD_DEL4", "gradient_3d_27pt_fluid.c", 398, __PRETTY_FUNCTION__); 
# 400
...
for (n = 0; n < nop; n++) { 
# 436
(grad[reverse_addr_rank2_assert(436, "gradient_3d_27pt_fluid.c", nsites, nop, 3, index, n, X)]) = (((0.5) * r9) * ((((((((((((((((((+(field[reverse_addr_rank1_assert(437, "gradient_3d_27pt_fluid.c", nsites, nop, (indexp1 - ys) - 1, n)])) - (field[reverse_addr_rank1_assert(438, "gradient_3d_27pt_fluid.c", nsites, nop, (indexm1 - ys) - 1, n)])) + (field[reverse_addr_rank1_assert(439, "gradient_3d_27pt_fluid.c", nsites, nop, indexp1 - ys, n)])) - (field[reverse_addr_rank1_assert(440, "gradient_3d_27pt_fluid.c", nsites, nop, indexm1 - ys, n)])) + (field[reverse_addr_rank1_assert(441, "gradient_3d_27pt_fluid.c", nsites, nop, (indexp1 - ys) + 1, n)])) - (field[reverse_addr_rank1_assert(442, "gradient_3d_27pt_fluid.c", nsites, nop, (indexm1 - ys) + 1, n)])) + (field[reverse_addr_rank1_assert(443, "gradient_3d_27pt_fluid.c", nsites, nop, indexp1 - 1, n)])) - (field[reverse_addr_rank1_assert(444, "gradient_3d_27pt_fluid.c", nsites, nop, indexm1 - 1, n)])) + (field[reverse_addr_rank1_assert(445, "gradient_3d_27pt_fluid.c", nsites, nop, indexp1, n)])) - (field[reverse_addr_rank1_assert(446, "gradient_3d_27pt_fluid.c", nsites, nop, indexm1, n)])) + (field[reverse_addr_rank1_assert(447, "gradient_3d_27pt_fluid.c", nsites, nop, indexp1 + 1, n)])) - (field[reverse_addr_rank1_assert(448, "gradient_3d_27pt_fluid.c", nsites, nop, indexm1 + 1, n)])) + (field[reverse_addr_rank1_assert(449, "gradient_3d_27pt_fluid.c", nsites, nop, (indexp1 + ys) - 1, n)])) - (field[reverse_addr_rank1_assert(450, "gradient_3d_27pt_fluid.c", nsites, nop, (indexm1 + ys) - 1, n)])) + (field[reverse_addr_rank1_assert(451, "gradient_3d_27pt_fluid.c", nsites, nop, indexp1 + ys, n)])) - (field[reverse_addr_rank1_assert(452, "gradient_3d_27pt_fluid.c", nsites, nop, indexm1 + ys, n)])) + (field[reverse_addr_rank1_assert(453, "gradient_3d_27pt_fluid.c", nsites, nop, (indexp1 + ys) + 1, n)])) - (field[reverse_addr_rank1_assert(454, "gradient_3d_27pt_fluid.c", nsites, nop, (indexm1 + ys) + 1, n)]))); 
# 456
(grad[reverse_addr_rank2_assert(456, "gradient_3d_27pt_fluid.c", nsites, nop, 3, index, n, Y)]) = (((0.5) * r9) * ((((((((((((((((((+(field[reverse_addr_rank1_assert(457, "gradient_3d_27pt_fluid.c", nsites, nop, (indexm1 + ys) - 1, n)])) - (field[reverse_addr_rank1_assert(458, "gradient_3d_27pt_fluid.c", nsites, nop, (indexm1 - ys) - 1, n)])) + (field[reverse_addr_rank1_assert(459, "gradient_3d_27pt_fluid.c", nsites, nop, indexm1 + ys, n)])) - (field[reverse_addr_rank1_assert(460, "gradient_3d_27pt_fluid.c", nsites, nop, indexm1 - ys, n)])) + (field[reverse_addr_rank1_assert(461, "gradient_3d_27pt_fluid.c", nsites, nop, (indexm1 + ys) + 1, n)])) - (field[reverse_addr_rank1_assert(462, "gradient_3d_27pt_fluid.c", nsites, nop, (indexm1 - ys) + 1, n)])) + (field[reverse_addr_rank1_assert(463, "gradient_3d_27pt_fluid.c", nsites, nop, (index + ys) - 1, n)])) - (field[reverse_addr_rank1_assert(464, "gradient_3d_27pt_fluid.c", nsites, nop, (index - ys) - 1, n)])) + (field[reverse_addr_rank1_assert(465, "gradient_3d_27pt_fluid.c", nsites, nop, index + ys, n)])) - (field[reverse_addr_rank1_assert(466, "gradient_3d_27pt_fluid.c", nsites, nop, index - ys, n)])) + (field[reverse_addr_rank1_assert(467, "gradient_3d_27pt_fluid.c", nsites, nop, (index + ys) + 1, n)])) - (field[reverse_addr_rank1_assert(468, "gradient_3d_27pt_fluid.c", nsites, nop, (index - ys) + 1, n)])) + (field[reverse_addr_rank1_assert(469, "gradient_3d_27pt_fluid.c", nsites, nop, (indexp1 + ys) - 1, n)])) - (field[reverse_addr_rank1_assert(470, "gradient_3d_27pt_fluid.c", nsites, nop, (indexp1 - ys) - 1, n)])) + (field[reverse_addr_rank1_assert(471, "gradient_3d_27pt_fluid.c", nsites, nop, indexp1 + ys, n)])) - (field[reverse_addr_rank1_assert(472, "gradient_3d_27pt_fluid.c", nsites, nop, indexp1 - ys, n)])) + (field[reverse_addr_rank1_assert(473, "gradient_3d_27pt_fluid.c", nsites, nop, (indexp1 + ys) + 1, n)])) - (field[reverse_addr_rank1_assert(474, "gradient_3d_27pt_fluid.c", nsites, nop, (indexp1 - ys) + 1, n)]))); 
# 476
(grad[reverse_addr_rank2_assert(476, "gradient_3d_27pt_fluid.c", nsites, nop, 3, index, n, Z)]) = (((0.5) * r9) * ((((((((((((((((((+(field[reverse_addr_rank1_assert(477, "gradient_3d_27pt_fluid.c", nsites, nop, (indexm1 - ys) + 1, n)])) - (field[reverse_addr_rank1_assert(478, "gradient_3d_27pt_fluid.c", nsites, nop, (indexm1 - ys) - 1, n)])) + (field[reverse_addr_rank1_assert(479, "gradient_3d_27pt_fluid.c", nsites, nop, indexm1 + 1, n)])) - (field[reverse_addr_rank1_assert(480, "gradient_3d_27pt_fluid.c", nsites, nop, indexm1 - 1, n)])) + (field[reverse_addr_rank1_assert(481, "gradient_3d_27pt_fluid.c", nsites, nop, (indexm1 + ys) + 1, n)])) - (field[reverse_addr_rank1_assert(482, "gradient_3d_27pt_fluid.c", nsites, nop, (indexm1 + ys) - 1, n)])) + (field[reverse_addr_rank1_assert(483, "gradient_3d_27pt_fluid.c", nsites, nop, (index - ys) + 1, n)])) - (field[reverse_addr_rank1_assert(484, "gradient_3d_27pt_fluid.c", nsites, nop, (index - ys) - 1, n)])) + (field[reverse_addr_rank1_assert(485, "gradient_3d_27pt_fluid.c", nsites, nop, index + 1, n)])) - (field[reverse_addr_rank1_assert(486, "gradient_3d_27pt_fluid.c", nsites, nop, index - 1, n)])) + (field[reverse_addr_rank1_assert(487, "gradient_3d_27pt_fluid.c", nsites, nop, (index + ys) + 1, n)])) - (field[reverse_addr_rank1_assert(488, "gradient_3d_27pt_fluid.c", nsites, nop, (index + ys) - 1, n)])) + (field[reverse_addr_rank1_assert(489, "gradient_3d_27pt_fluid.c", nsites, nop, (indexp1 - ys) + 1, n)])) - (field[reverse_addr_rank1_assert(490, "gradient_3d_27pt_fluid.c", nsites, nop, (indexp1 - ys) - 1, n)])) + (field[reverse_addr_rank1_assert(491, "gradient_3d_27pt_fluid.c", nsites, nop, indexp1 + 1, n)])) - (field[reverse_addr_rank1_assert(492, "gradient_3d_27pt_fluid.c", nsites, nop, indexp1 - 1, n)])) + (field[reverse_addr_rank1_assert(493, "gradient_3d_27pt_fluid.c", nsites, nop, (indexp1 + ys) + 1, n)])) - (field[reverse_addr_rank1_assert(494, "gradient_3d_27pt_fluid.c", nsites, nop, (indexp1 + ys) - 1, n)]))); 
# 496
(del2[reverse_addr_rank1_assert(496, "gradient_3d_27pt_fluid.c", nsites, nop, index, n)]) = (r9 * (((((((((((((((((((((((((((+(field[reverse_addr_rank1_assert(497, "gradient_3d_27pt_fluid.c", nsites, nop, (indexm1 - ys) - 1, n)])) + (field[reverse_addr_rank1_assert(498, "gradient_3d_27pt_fluid.c", nsites, nop, indexm1 - ys, n)])) + (field[reverse_addr_rank1_assert(499, "gradient_3d_27pt_fluid.c", nsites, nop, (indexm1 - ys) + 1, n)])) + (field[reverse_addr_rank1_assert(500, "gradient_3d_27pt_fluid.c", nsites, nop, indexm1 - 1, n)])) + (field[reverse_addr_rank1_assert(501, "gradient_3d_27pt_fluid.c", nsites, nop, indexm1, n)])) + (field[reverse_addr_rank1_assert(502, "gradient_3d_27pt_fluid.c", nsites, nop, indexm1 + 1, n)])) + (field[reverse_addr_rank1_assert(503, "gradient_3d_27pt_fluid.c", nsites, nop, (indexm1 + ys) - 1, n)])) + (field[reverse_addr_rank1_assert(504, "gradient_3d_27pt_fluid.c", nsites, nop, indexm1 + ys, n)])) + (field[reverse_addr_rank1_assert(505, "gradient_3d_27pt_fluid.c", nsites, nop, (indexm1 + ys) + 1, n)])) + (field[reverse_addr_rank1_assert(506, "gradient_3d_27pt_fluid.c", nsites, nop, (index - ys) - 1, n)])) + (field[reverse_addr_rank1_assert(507, "gradient_3d_27pt_fluid.c", nsites, nop, index - ys, n)])) + (field[reverse_addr_rank1_assert(508, "gradient_3d_27pt_fluid.c", nsites, nop, (index - ys) + 1, n)])) + (field[reverse_addr_rank1_assert(509, "gradient_3d_27pt_fluid.c", nsites, nop, index - 1, n)])) + (field[reverse_addr_rank1_assert(510, "gradient_3d_27pt_fluid.c", nsites, nop, index + 1, n)])) + (field[reverse_addr_rank1_assert(511, "gradient_3d_27pt_fluid.c", nsites, nop, (index + ys) - 1, n)])) + (field[reverse_addr_rank1_assert(512, "gradient_3d_27pt_fluid.c", nsites, nop, index + ys, n)])) + (field[reverse_addr_rank1_assert(513, "gradient_3d_27pt_fluid.c", nsites, nop, (index + ys) + 1, n)])) + (field[reverse_addr_rank1_assert(514, "gradient_3d_27pt_fluid.c", nsites, nop, (indexp1 - ys) - 1, n)])) + (field[reverse_addr_rank1_assert(515, "gradient_3d_27pt_fluid.c", nsites, nop, indexp1 - ys, n)])) + (field[reverse_addr_rank1_assert(516, "gradient_3d_27pt_fluid.c", nsites, nop, (indexp1 - ys) + 1, n)])) + (field[reverse_addr_rank1_assert(517, "gradient_3d_27pt_fluid.c", nsites, nop, indexp1 - 1, n)])) + (field[reverse_addr_rank1_assert(518, "gradient_3d_27pt_fluid.c", nsites, nop, indexp1, n)])) + (field[reverse_addr_rank1_assert(519, "gradient_3d_27pt_fluid.c", nsites, nop, indexp1 + 1, n)])) + (field[reverse_addr_rank1_assert(520, "gradient_3d_27pt_fluid.c", nsites, nop, (indexp1 + ys) - 1, n)])) + (field[reverse_addr_rank1_assert(521, "gradient_3d_27pt_fluid.c", nsites, nop, indexp1 + ys, n)])) + (field[reverse_addr_rank1_assert(522, "gradient_3d_27pt_fluid.c", nsites, nop, (indexp1 + ys) + 1, n)])) - ((26.0) * (field[reverse_addr_rank1_assert(523, "gradient_3d_27pt_fluid.c", nsites, nop, index, n)])))); 
# 524
}  
# 525
}  
...
for (n = 0; n < nop; n++) { 
# 545
(grad[reverse_addr_rank2_assert(545, "gradient_3d_27pt_fluid.c", nsites, nop, 3, index, n, X)]) = (((0.5) * r9) * ((((((((((((((((((+(field[reverse_addr_rank1_assert(546, "gradient_3d_27pt_fluid.c", nsites, nop, (indexp1 - ys) - 1, n)])) - (field[reverse_addr_rank1_assert(547, "gradient_3d_27pt_fluid.c", nsites, nop, (indexm1 - ys) - 1, n)])) + (field[reverse_addr_rank1_assert(548, "gradient_3d_27pt_fluid.c", nsites, nop, indexp1 - ys, n)])) - (field[reverse_addr_rank1_assert(549, "gradient_3d_27pt_fluid.c", nsites, nop, indexm1 - ys, n)])) + (field[reverse_addr_rank1_assert(550, "gradient_3d_27pt_fluid.c", nsites, nop, (indexp1 - ys) + 1, n)])) - (field[reverse_addr_rank1_assert(551, "gradient_3d_27pt_fluid.c", nsites, nop, (indexm1 - ys) + 1, n)])) + (field[reverse_addr_rank1_assert(552, "gradient_3d_27pt_fluid.c", nsites, nop, indexp1 - 1, n)])) - (field[reverse_addr_rank1_assert(553, "gradient_3d_27pt_fluid.c", nsites, nop, indexm1 - 1, n)])) + (field[reverse_addr_rank1_assert(554, "gradient_3d_27pt_fluid.c", nsites, nop, indexp1, n)])) - (field[reverse_addr_rank1_assert(555, "gradient_3d_27pt_fluid.c", nsites, nop, indexm1, n)])) + (field[reverse_addr_rank1_assert(556, "gradient_3d_27pt_fluid.c", nsites, nop, indexp1 + 1, n)])) - (field[reverse_addr_rank1_assert(557, "gradient_3d_27pt_fluid.c", nsites, nop, indexm1 + 1, n)])) + (field[reverse_addr_rank1_assert(558, "gradient_3d_27pt_fluid.c", nsites, nop, (indexp1 + ys) - 1, n)])) - (field[reverse_addr_rank1_assert(559, "gradient_3d_27pt_fluid.c", nsites, nop, (indexm1 + ys) - 1, n)])) + (field[reverse_addr_rank1_assert(560, "gradient_3d_27pt_fluid.c", nsites, nop, indexp1 + ys, n)])) - (field[reverse_addr_rank1_assert(561, "gradient_3d_27pt_fluid.c", nsites, nop, indexm1 + ys, n)])) + (field[reverse_addr_rank1_assert(562, "gradient_3d_27pt_fluid.c", nsites, nop, (indexp1 + ys) + 1, n)])) - (field[reverse_addr_rank1_assert(563, "gradient_3d_27pt_fluid.c", nsites, nop, (indexm1 + ys) + 1, n)]))); 
# 565
(grad[reverse_addr_rank2_assert(565, "gradient_3d_27pt_fluid.c", nsites, nop, 3, index, n, Y)]) = (((0.5) * r9) * ((((((((((((((((((+(field[reverse_addr_rank1_assert(566, "gradient_3d_27pt_fluid.c", nsites, nop, (indexm1 + ys) - 1, n)])) - (field[reverse_addr_rank1_assert(567, "gradient_3d_27pt_fluid.c", nsites, nop, (indexm1 - ys) - 1, n)])) + (field[reverse_addr_rank1_assert(568, "gradient_3d_27pt_fluid.c", nsites, nop, indexm1 + ys, n)])) - (field[reverse_addr_rank1_assert(569, "gradient_3d_27pt_fluid.c", nsites, nop, indexm1 - ys, n)])) + (field[reverse_addr_rank1_assert(570, "gradient_3d_27pt_fluid.c", nsites, nop, (indexm1 + ys) + 1, n)])) - (field[reverse_addr_rank1_assert(571, "gradient_3d_27pt_fluid.c", nsites, nop, (indexm1 - ys) + 1, n)])) + (field[reverse_addr_rank1_assert(572, "gradient_3d_27pt_fluid.c", nsites, nop, (index + ys) - 1, n)])) - (field[reverse_addr_rank1_assert(573, "gradient_3d_27pt_fluid.c", nsites, nop, (index - ys) - 1, n)])) + (field[reverse_addr_rank1_assert(574, "gradient_3d_27pt_fluid.c", nsites, nop, index + ys, n)])) - (field[reverse_addr_rank1_assert(575, "gradient_3d_27pt_fluid.c", nsites, nop, index - ys, n)])) + (field[reverse_addr_rank1_assert(576, "gradient_3d_27pt_fluid.c", nsites, nop, (index + ys) + 1, n)])) - (field[reverse_addr_rank1_assert(577, "gradient_3d_27pt_fluid.c", nsites, nop, (index - ys) + 1, n)])) + (field[reverse_addr_rank1_assert(578, "gradient_3d_27pt_fluid.c", nsites, nop, (indexp1 + ys) - 1, n)])) - (field[reverse_addr_rank1_assert(579, "gradient_3d_27pt_fluid.c", nsites, nop, (indexp1 - ys) - 1, n)])) + (field[reverse_addr_rank1_assert(580, "gradient_3d_27pt_fluid.c", nsites, nop, indexp1 + ys, n)])) - (field[reverse_addr_rank1_assert(581, "gradient_3d_27pt_fluid.c", nsites, nop, indexp1 - ys, n)])) + (field[reverse_addr_rank1_assert(582, "gradient_3d_27pt_fluid.c", nsites, nop, (indexp1 + ys) + 1, n)])) - (field[reverse_addr_rank1_assert(583, "gradient_3d_27pt_fluid.c", nsites, nop, (indexp1 - ys) + 1, n)]))); 
# 585
(grad[reverse_addr_rank2_assert(585, "gradient_3d_27pt_fluid.c", nsites, nop, 3, index, n, Z)]) = (((0.5) * r9) * ((((((((((((((((((+(field[reverse_addr_rank1_assert(586, "gradient_3d_27pt_fluid.c", nsites, nop, (indexm1 - ys) + 1, n)])) - (field[reverse_addr_rank1_assert(587, "gradient_3d_27pt_fluid.c", nsites, nop, (indexm1 - ys) - 1, n)])) + (field[reverse_addr_rank1_assert(588, "gradient_3d_27pt_fluid.c", nsites, nop, indexm1 + 1, n)])) - (field[reverse_addr_rank1_assert(589, "gradient_3d_27pt_fluid.c", nsites, nop, indexm1 - 1, n)])) + (field[reverse_addr_rank1_assert(590, "gradient_3d_27pt_fluid.c", nsites, nop, (indexm1 + ys) + 1, n)])) - (field[reverse_addr_rank1_assert(591, "gradient_3d_27pt_fluid.c", nsites, nop, (indexm1 + ys) - 1, n)])) + (field[reverse_addr_rank1_assert(592, "gradient_3d_27pt_fluid.c", nsites, nop, (index - ys) + 1, n)])) - (field[reverse_addr_rank1_assert(593, "gradient_3d_27pt_fluid.c", nsites, nop, (index - ys) - 1, n)])) + (field[reverse_addr_rank1_assert(594, "gradient_3d_27pt_fluid.c", nsites, nop, index + 1, n)])) - (field[reverse_addr_rank1_assert(595, "gradient_3d_27pt_fluid.c", nsites, nop, index - 1, n)])) + (field[reverse_addr_rank1_assert(596, "gradient_3d_27pt_fluid.c", nsites, nop, (index + ys) + 1, n)])) - (field[reverse_addr_rank1_assert(597, "gradient_3d_27pt_fluid.c", nsites, nop, (index + ys) - 1, n)])) + (field[reverse_addr_rank1_assert(598, "gradient_3d_27pt_fluid.c", nsites, nop, (indexp1 - ys) + 1, n)])) - (field[reverse_addr_rank1_assert(599, "gradient_3d_27pt_fluid.c", nsites, nop, (indexp1 - ys) - 1, n)])) + (field[reverse_addr_rank1_assert(600, "gradient_3d_27pt_fluid.c", nsites, nop, indexp1 + 1, n)])) - (field[reverse_addr_rank1_assert(601, "gradient_3d_27pt_fluid.c", nsites, nop, indexp1 - 1, n)])) + (field[reverse_addr_rank1_assert(602, "gradient_3d_27pt_fluid.c", nsites, nop, (indexp1 + ys) + 1, n)])) - (field[reverse_addr_rank1_assert(603, "gradient_3d_27pt_fluid.c", nsites, nop, (indexp1 + ys) - 1, n)]))); 
# 605
(del2[reverse_addr_rank1_assert(605, "gradient_3d_27pt_fluid.c", nsites, nop, index, n)]) = (r9 * (((((((((((((((((((((((((((+(field[reverse_addr_rank1_assert(606, "gradient_3d_27pt_fluid.c", nsites, nop, (indexm1 - ys) - 1, n)])) + (field[reverse_addr_rank1_assert(607, "gradient_3d_27pt_fluid.c", nsites, nop, indexm1 - ys, n)])) + (field[reverse_addr_rank1_assert(608, "gradient_3d_27pt_fluid.c", nsites, nop, (indexm1 - ys) + 1, n)])) + (field[reverse_addr_rank1_assert(609, "gradient_3d_27pt_fluid.c", nsites, nop, indexm1 - 1, n)])) + (field[reverse_addr_rank1_assert(610, "gradient_3d_27pt_fluid.c", nsites, nop, indexm1, n)])) + (field[reverse_addr_rank1_assert(611, "gradient_3d_27pt_fluid.c", nsites, nop, indexm1 + 1, n)])) + (field[reverse_addr_rank1_assert(612, "gradient_3d_27pt_fluid.c", nsites, nop, (indexm1 + ys) - 1, n)])) + (field[reverse_addr_rank1_assert(613, "gradient_3d_27pt_fluid.c", nsites, nop, indexm1 + ys, n)])) + (field[reverse_addr_rank1_assert(614, "gradient_3d_27pt_fluid.c", nsites, nop, (indexm1 + ys) + 1, n)])) + (field[reverse_addr_rank1_assert(615, "gradient_3d_27pt_fluid.c", nsites, nop, (index - ys) - 1, n)])) + (field[reverse_addr_rank1_assert(616, "gradient_3d_27pt_fluid.c", nsites, nop, index - ys, n)])) + (field[reverse_addr_rank1_assert(617, "gradient_3d_27pt_fluid.c", nsites, nop, (index - ys) + 1, n)])) + (field[reverse_addr_rank1_assert(618, "gradient_3d_27pt_fluid.c", nsites, nop, index - 1, n)])) + (field[reverse_addr_rank1_assert(619, "gradient_3d_27pt_fluid.c", nsites, nop, index + 1, n)])) + (field[reverse_addr_rank1_assert(620, "gradient_3d_27pt_fluid.c", nsites, nop, (index + ys) - 1, n)])) + (field[reverse_addr_rank1_assert(621, "gradient_3d_27pt_fluid.c", nsites, nop, index + ys, n)])) + (field[reverse_addr_rank1_assert(622, "gradient_3d_27pt_fluid.c", nsites, nop, (index + ys) + 1, n)])) + (field[reverse_addr_rank1_assert(623, "gradient_3d_27pt_fluid.c", nsites, nop, (indexp1 - ys) - 1, n)])) + (field[reverse_addr_rank1_assert(624, "gradient_3d_27pt_fluid.c", nsites, nop, indexp1 - ys, n)])) + (field[reverse_addr_rank1_assert(625, "gradient_3d_27pt_fluid.c", nsites, nop, (indexp1 - ys) + 1, n)])) + (field[reverse_addr_rank1_assert(626, "gradient_3d_27pt_fluid.c", nsites, nop, indexp1 - 1, n)])) + (field[reverse_addr_rank1_assert(627, "gradient_3d_27pt_fluid.c", nsites, nop, indexp1, n)])) + (field[reverse_addr_rank1_assert(628, "gradient_3d_27pt_fluid.c", nsites, nop, indexp1 + 1, n)])) + (field[reverse_addr_rank1_assert(629, "gradient_3d_27pt_fluid.c", nsites, nop, (indexp1 + ys) - 1, n)])) + (field[reverse_addr_rank1_assert(630, "gradient_3d_27pt_fluid.c", nsites, nop, indexp1 + ys, n)])) + (field[reverse_addr_rank1_assert(631, "gradient_3d_27pt_fluid.c", nsites, nop, (indexp1 + ys) + 1, n)])) - ((26.0) * (field[reverse_addr_rank1_assert(632, "gradient_3d_27pt_fluid.c", nsites, nop, index, n)])))); 
# 633
}  
# 635
}  
...
# 666
(le) ? static_cast< void>(0) : __assert_fail("le", "gradient_3d_27pt_fluid.c", 666, __PRETTY_FUNCTION__); 
# 667
(df) ? static_cast< void>(0) : __assert_fail("df", "gradient_3d_27pt_fluid.c", 667, __PRETTY_FUNCTION__); 
# 669
lees_edw_nhalo(le, &nhalo); 
# 670
nextra = (nhalo - 1); 
# 671
(nextra >= 0) ? static_cast< void>(0) : __assert_fail("nextra >= 0", "gradient_3d_27pt_fluid.c", 671, __PRETTY_FUNCTION__); 
# 673
lees_edw_nlocal(le, nlocal); 
# 674
lees_edw_nsites(le, &nsites); 
...
indexp1 = lees_edw_index(le, icp1, jc, kc); 
# 691
(dab[reverse_addr_rank1_assert(691, "gradient_3d_27pt_fluid.c", nsites, 6, index, XX)]) = ((0.2000000000000000111) * ((((((((((((((((+(1.0)) * (field[reverse_addr_rank0_assert(692, "gradient_3d_27pt_fluid.c", nsites, indexp1)])) + ((1.0) * (field[reverse_addr_rank0_assert(693, "gradient_3d_27pt_fluid.c", nsites, indexm1)]))) - ((2.0) * (field[reverse_addr_rank0_assert(694, "gradient_3d_27pt_fluid.c", nsites, index)]))) + ((1.0) * (field[reverse_addr_rank0_assert(695, "gradient_3d_27pt_fluid.c", nsites, indexp1 + ys)]))) + ((1.0) * (field[reverse_addr_rank0_assert(696, "gradient_3d_27pt_fluid.c", nsites, indexm1 + ys)]))) - ((2.0) * (field[reverse_addr_rank0_assert(697, "gradient_3d_27pt_fluid.c", nsites, index + ys)]))) + ((1.0) * (field[reverse_addr_rank0_assert(698, "gradient_3d_27pt_fluid.c", nsites, indexp1 - ys)]))) + ((1.0) * (field[reverse_addr_rank0_assert(699, "gradient_3d_27pt_fluid.c", nsites, indexm1 - ys)]))) - ((2.0) * (field[reverse_addr_rank0_assert(700, "gradient_3d_27pt_fluid.c", nsites, index - ys)]))) + ((1.0) * (field[reverse_addr_rank0_assert(701, "gradient_3d_27pt_fluid.c", nsites, indexp1 + 1)]))) + ((1.0) * (field[reverse_addr_rank0_assert(702, "gradient_3d_27pt_fluid.c", nsites, indexm1 + 1)]))) - ((2.0) * (field[reverse_addr_rank0_assert(703, "gradient_3d_27pt_fluid.c", nsites, index + 1)]))) + ((1.0) * (field[reverse_addr_rank0_assert(704, "gradient_3d_27pt_fluid.c", nsites, indexp1 - 1)]))) + ((1.0) * (field[reverse_addr_rank0_assert(705, "gradient_3d_27pt_fluid.c", nsites, indexm1 - 1)]))) - ((2.0) * (field[reverse_addr_rank0_assert(706, "gradient_3d_27pt_fluid.c", nsites, index - 1)])))); 
# 708
(dab[reverse_addr_rank1_assert(708, "gradient_3d_27pt_fluid.c", nsites, 6, index, XY)]) = (r12 * ((((((((((((+(field[reverse_addr_rank0_assert(709, "gradient_3d_27pt_fluid.c", nsites, indexp1 + ys)])) - (field[reverse_addr_rank0_assert(710, "gradient_3d_27pt_fluid.c", nsites, indexp1 - ys)])) - (field[reverse_addr_rank0_assert(711, "gradient_3d_27pt_fluid.c", nsites, indexm1 + ys)])) + (field[reverse_addr_rank0_assert(712, "gradient_3d_27pt_fluid.c", nsites, indexm1 - ys)])) + (field[reverse_addr_rank0_assert(713, "gradient_3d_27pt_fluid.c", nsites, (indexp1 + ys) + 1)])) - (field[reverse_addr_rank0_assert(714, "gradient_3d_27pt_fluid.c", nsites, (indexp1 - ys) + 1)])) - (field[reverse_addr_rank0_assert(715, "gradient_3d_27pt_fluid.c", nsites, (indexm1 + ys) + 1)])) + (field[reverse_addr_rank0_assert(716, "gradient_3d_27pt_fluid.c", nsites, (indexm1 - ys) + 1)])) + (field[reverse_addr_rank0_assert(717, "gradient_3d_27pt_fluid.c", nsites, (indexp1 + ys) - 1)])) - (field[reverse_addr_rank0_assert(718, "gradient_3d_27pt_fluid.c", nsites, (indexp1 - ys) - 1)])) - (field[reverse_addr_rank0_assert(719, "gradient_3d_27pt_fluid.c", nsites, (indexm1 + ys) - 1)])) + (field[reverse_addr_rank0_assert(720, "gradient_3d_27pt_fluid.c", nsites, (indexm1 - ys) - 1)]))); 
# 722
(dab[reverse_addr_rank1_assert(722, "gradient_3d_27pt_fluid.c", nsites, 6, index, XZ)]) = (r12 * ((((((((((((+(field[reverse_addr_rank0_assert(723, "gradient_3d_27pt_fluid.c", nsites, indexp1 + 1)])) - (field[reverse_addr_rank0_assert(724, "gradient_3d_27pt_fluid.c", nsites, indexp1 - 1)])) - (field[reverse_addr_rank0_assert(725, "gradient_3d_27pt_fluid.c", nsites, indexm1 + 1)])) + (field[reverse_addr_rank0_assert(726, "gradient_3d_27pt_fluid.c", nsites, indexm1 - 1)])) + (field[reverse_addr_rank0_assert(727, "gradient_3d_27pt_fluid.c", nsites, (indexp1 + ys) + 1)])) - (field[reverse_addr_rank0_assert(728, "gradient_3d_27pt_fluid.c", nsites, (indexp1 + ys) - 1)])) - (field[reverse_addr_rank0_assert(729, "gradient_3d_27pt_fluid.c", nsites, (indexm1 + ys) + 1)])) + (field[reverse_addr_rank0_assert(730, "gradient_3d_27pt_fluid.c", nsites, (indexm1 + ys) - 1)])) + (field[reverse_addr_rank0_assert(731, "gradient_3d_27pt_fluid.c", nsites, (indexp1 - ys) + 1)])) - (field[reverse_addr_rank0_assert(732, "gradient_3d_27pt_fluid.c", nsites, (indexp1 - ys) - 1)])) - (field[reverse_addr_rank0_assert(733, "gradient_3d_27pt_fluid.c", nsites, (indexm1 - ys) + 1)])) + (field[reverse_addr_rank0_assert(734, "gradient_3d_27pt_fluid.c", nsites, (indexm1 - ys) - 1)]))); 
# 736
(dab[reverse_addr_rank1_assert(736, "gradient_3d_27pt_fluid.c", nsites, 6, index, YY)]) = ((0.2000000000000000111) * ((((((((((((((((+(1.0)) * (field[reverse_addr_rank0_assert(737, "gradient_3d_27pt_fluid.c", nsites, index + ys)])) + ((1.0) * (field[reverse_addr_rank0_assert(738, "gradient_3d_27pt_fluid.c", nsites, index - ys)]))) - ((2.0) * (field[reverse_addr_rank0_assert(739, "gradient_3d_27pt_fluid.c", nsites, index)]))) + ((1.0) * (field[reverse_addr_rank0_assert(740, "gradient_3d_27pt_fluid.c", nsites, indexp1 + ys)]))) + ((1.0) * (field[reverse_addr_rank0_assert(741, "gradient_3d_27pt_fluid.c", nsites, indexp1 - ys)]))) - ((2.0) * (field[reverse_addr_rank0_assert(742, "gradient_3d_27pt_fluid.c", nsites, indexp1)]))) + ((1.0) * (field[reverse_addr_rank0_assert(743, "gradient_3d_27pt_fluid.c", nsites, indexm1 + ys)]))) + ((1.0) * (field[reverse_addr_rank0_assert(744, "gradient_3d_27pt_fluid.c", nsites, indexm1 - ys)]))) - ((2.0) * (field[reverse_addr_rank0_assert(745, "gradient_3d_27pt_fluid.c", nsites, indexm1)]))) + ((1.0) * (field[reverse_addr_rank0_assert(746, "gradient_3d_27pt_fluid.c", nsites, (index + 1) + ys)]))) + ((1.0) * (field[reverse_addr_rank0_assert(747, "gradient_3d_27pt_fluid.c", nsites, (index + 1) - ys)]))) - ((2.0) * (field[reverse_addr_rank0_assert(748, "gradient_3d_27pt_fluid.c", nsites, index + 1)]))) + ((1.0) * (field[reverse_addr_rank0_assert(749, "gradient_3d_27pt_fluid.c", nsites, (index - 1) + ys)]))) + ((1.0) * (field[reverse_addr_rank0_assert(750, "gradient_3d_27pt_fluid.c", nsites, (index - 1) - ys)]))) - ((2.0) * (field[reverse_addr_rank0_assert(751, "gradient_3d_27pt_fluid.c", nsites, index - 1)])))); 
# 753
(dab[reverse_addr_rank1_assert(753, "gradient_3d_27pt_fluid.c", nsites, 6, index, YZ)]) = (r12 * ((((((((((((+(field[reverse_addr_rank0_assert(754, "gradient_3d_27pt_fluid.c", nsites, (index + ys) + 1)])) - (field[reverse_addr_rank0_assert(755, "gradient_3d_27pt_fluid.c", nsites, (index + ys) - 1)])) - (field[reverse_addr_rank0_assert(756, "gradient_3d_27pt_fluid.c", nsites, (index - ys) + 1)])) + (field[reverse_addr_rank0_assert(757, "gradient_3d_27pt_fluid.c", nsites, (index - ys) - 1)])) + (field[reverse_addr_rank0_assert(758, "gradient_3d_27pt_fluid.c", nsites, (indexp1 + ys) + 1)])) - (field[reverse_addr_rank0_assert(759, "gradient_3d_27pt_fluid.c", nsites, (indexp1 + ys) - 1)])) - (field[reverse_addr_rank0_assert(760, "gradient_3d_27pt_fluid.c", nsites, (indexp1 - ys) + 1)])) + (field[reverse_addr_rank0_assert(761, "gradient_3d_27pt_fluid.c", nsites, (indexp1 - ys) - 1)])) + (field[reverse_addr_rank0_assert(762, "gradient_3d_27pt_fluid.c", nsites, (indexm1 + ys) + 1)])) - (field[reverse_addr_rank0_assert(763, "gradient_3d_27pt_fluid.c", nsites, (indexm1 + ys) - 1)])) - (field[reverse_addr_rank0_assert(764, "gradient_3d_27pt_fluid.c", nsites, (indexm1 - ys) + 1)])) + (field[reverse_addr_rank0_assert(765, "gradient_3d_27pt_fluid.c", nsites, (indexm1 - ys) - 1)]))); 
# 767
(dab[reverse_addr_rank1_assert(767, "gradient_3d_27pt_fluid.c", nsites, 6, index, ZZ)]) = ((0.2000000000000000111) * ((((((((((((((((+(1.0)) * (field[reverse_addr_rank0_assert(768, "gradient_3d_27pt_fluid.c", nsites, index + 1)])) + ((1.0) * (field[reverse_addr_rank0_assert(769, "gradient_3d_27pt_fluid.c", nsites, index - 1)]))) - ((2.0) * (field[reverse_addr_rank0_assert(770, "gradient_3d_27pt_fluid.c", nsites, index)]))) + ((1.0) * (field[reverse_addr_rank0_assert(771, "gradient_3d_27pt_fluid.c", nsites, indexp1 + 1)]))) + ((1.0) * (field[reverse_addr_rank0_assert(772, "gradient_3d_27pt_fluid.c", nsites, indexp1 - 1)]))) - ((2.0) * (field[reverse_addr_rank0_assert(773, "gradient_3d_27pt_fluid.c", nsites, indexp1)]))) + ((1.0) * (field[reverse_addr_rank0_assert(774, "gradient_3d_27pt_fluid.c", nsites, indexm1 + 1)]))) + ((1.0) * (field[reverse_addr_rank0_assert(775, "gradient_3d_27pt_fluid.c", nsites, indexm1 - 1)]))) - ((2.0) * (field[reverse_addr_rank0_assert(776, "gradient_3d_27pt_fluid.c", nsites, indexm1)]))) + ((1.0) * (field[reverse_addr_rank0_assert(777, "gradient_3d_27pt_fluid.c", nsites, (index + ys) + 1)]))) + ((1.0) * (field[reverse_addr_rank0_assert(778, "gradient_3d_27pt_fluid.c", nsites, (index + ys) - 1)]))) - ((2.0) * (field[reverse_addr_rank0_assert(779, "gradient_3d_27pt_fluid.c", nsites, index + ys)]))) + ((1.0) * (field[reverse_addr_rank0_assert(780, "gradient_3d_27pt_fluid.c", nsites, (index - ys) + 1)]))) + ((1.0) * (field[reverse_addr_rank0_assert(781, "gradient_3d_27pt_fluid.c", nsites, (index - ys) - 1)]))) - ((2.0) * (field[reverse_addr_rank0_assert(782, "gradient_3d_27pt_fluid.c", nsites, index - ys)])))); 
# 784
}  
# 785
}  
...
const double r12 = ((1.0) / (12.0)); 
# 814
(le) ? static_cast< void>(0) : __assert_fail("le", "gradient_3d_27pt_fluid.c", 814, __PRETTY_FUNCTION__); 
# 815
(df) ? static_cast< void>(0) : __assert_fail("df", "gradient_3d_27pt_fluid.c", 815, __PRETTY_FUNCTION__); 
# 817
lees_edw_nhalo(le, &nhalo); 
# 818
lees_edw_nlocal(le, nlocal); 
...
nextra = (nhalo - 1); 
# 823
(nextra >= 0) ? static_cast< void>(0) : __assert_fail("nextra >= 0", "gradient_3d_27pt_fluid.c", 823, __PRETTY_FUNCTION__); 
# 825
dab = (df->d_ab); 
# 826
field = ((df->field)->data); 
...
indexp1 = lees_edw_index(le, ic2, jc, kc); 
# 845
(dab[reverse_addr_rank1_assert(845, "gradient_3d_27pt_fluid.c", nsites, 6, index, XX)]) = ((0.2000000000000000111) * ((((((((((((((((+(1.0)) * (field[reverse_addr_rank0_assert(846, "gradient_3d_27pt_fluid.c", nsites, indexp1)])) + ((1.0) * (field[reverse_addr_rank0_assert(847, "gradient_3d_27pt_fluid.c", nsites, indexm1)]))) - ((2.0) * (field[reverse_addr_rank0_assert(848, "gradient_3d_27pt_fluid.c", nsites, index)]))) + ((1.0) * (field[reverse_addr_rank0_assert(849, "gradient_3d_27pt_fluid.c", nsites, indexp1 + ys)]))) + ((1.0) * (field[reverse_addr_rank0_assert(850, "gradient_3d_27pt_fluid.c", nsites, indexm1 + ys)]))) - ((2.0) * (field[reverse_addr_rank0_assert(851, "gradient_3d_27pt_fluid.c", nsites, index + ys)]))) + ((1.0) * (field[reverse_addr_rank0_assert(852, "gradient_3d_27pt_fluid.c", nsites, indexp1 - ys)]))) + ((1.0) * (field[reverse_addr_rank0_assert(853, "gradient_3d_27pt_fluid.c", nsites, indexm1 - ys)]))) - ((2.0) * (field[reverse_addr_rank0_assert(854, "gradient_3d_27pt_fluid.c", nsites, index - ys)]))) + ((1.0) * (field[reverse_addr_rank0_assert(855, "gradient_3d_27pt_fluid.c", nsites, indexp1 + 1)]))) + ((1.0) * (field[reverse_addr_rank0_assert(856, "gradient_3d_27pt_fluid.c", nsites, indexm1 + 1)]))) - ((2.0) * (field[reverse_addr_rank0_assert(857, "gradient_3d_27pt_fluid.c", nsites, index + 1)]))) + ((1.0) * (field[reverse_addr_rank0_assert(858, "gradient_3d_27pt_fluid.c", nsites, indexp1 - 1)]))) + ((1.0) * (field[reverse_addr_rank0_assert(859, "gradient_3d_27pt_fluid.c", nsites, indexm1 - 1)]))) - ((2.0) * (field[reverse_addr_rank0_assert(860, "gradient_3d_27pt_fluid.c", nsites, index - 1)])))); 
# 862
(dab[reverse_addr_rank1_assert(862, "gradient_3d_27pt_fluid.c", nsites, 6, index, XY)]) = (r12 * ((((((((((((+(field[reverse_addr_rank0_assert(863, "gradient_3d_27pt_fluid.c", nsites, indexp1 + ys)])) - (field[reverse_addr_rank0_assert(864, "gradient_3d_27pt_fluid.c", nsites, indexp1 - ys)])) - (field[reverse_addr_rank0_assert(865, "gradient_3d_27pt_fluid.c", nsites, indexm1 + ys)])) + (field[reverse_addr_rank0_assert(866, "gradient_3d_27pt_fluid.c", nsites, indexm1 - ys)])) + (field[reverse_addr_rank0_assert(867, "gradient_3d_27pt_fluid.c", nsites, (indexp1 + ys) + 1)])) - (field[reverse_addr_rank0_assert(868, "gradient_3d_27pt_fluid.c", nsites, (indexp1 - ys) + 1)])) - (field[reverse_addr_rank0_assert(869, "gradient_3d_27pt_fluid.c", nsites, (indexm1 + ys) + 1)])) + (field[reverse_addr_rank0_assert(870, "gradient_3d_27pt_fluid.c", nsites, (indexm1 - ys) + 1)])) + (field[reverse_addr_rank0_assert(871, "gradient_3d_27pt_fluid.c", nsites, (indexp1 + ys) - 1)])) - (field[reverse_addr_rank0_assert(872, "gradient_3d_27pt_fluid.c", nsites, (indexp1 - ys) - 1)])) - (field[reverse_addr_rank0_assert(873, "gradient_3d_27pt_fluid.c", nsites, (indexm1 + ys) - 1)])) + (field[reverse_addr_rank0_assert(874, "gradient_3d_27pt_fluid.c", nsites, (indexm1 - ys) - 1)]))); 
# 876
(dab[reverse_addr_rank1_assert(876, "gradient_3d_27pt_fluid.c", nsites, 6, index, XZ)]) = (r12 * ((((((((((((+(field[reverse_addr_rank0_assert(877, "gradient_3d_27pt_fluid.c", nsites, indexp1 + 1)])) - (field[reverse_addr_rank0_assert(878, "gradient_3d_27pt_fluid.c", nsites, indexp1 - 1)])) - (field[reverse_addr_rank0_assert(879, "gradient_3d_27pt_fluid.c", nsites, indexm1 + 1)])) + (field[reverse_addr_rank0_assert(880, "gradient_3d_27pt_fluid.c", nsites, indexm1 - 1)])) + (field[reverse_addr_rank0_assert(881, "gradient_3d_27pt_fluid.c", nsites, (indexp1 + ys) + 1)])) - (field[reverse_addr_rank0_assert(882, "gradient_3d_27pt_fluid.c", nsites, (indexp1 + ys) - 1)])) - (field[reverse_addr_rank0_assert(883, "gradient_3d_27pt_fluid.c", nsites, (indexm1 + ys) + 1)])) + (field[reverse_addr_rank0_assert(884, "gradient_3d_27pt_fluid.c", nsites, (indexm1 + ys) - 1)])) + (field[reverse_addr_rank0_assert(885, "gradient_3d_27pt_fluid.c", nsites, (indexp1 - ys) + 1)])) - (field[reverse_addr_rank0_assert(886, "gradient_3d_27pt_fluid.c", nsites, (indexp1 - ys) - 1)])) - (field[reverse_addr_rank0_assert(887, "gradient_3d_27pt_fluid.c", nsites, (indexm1 - ys) + 1)])) + (field[reverse_addr_rank0_assert(888, "gradient_3d_27pt_fluid.c", nsites, (indexm1 - ys) - 1)]))); 
# 890
(dab[reverse_addr_rank1_assert(890, "gradient_3d_27pt_fluid.c", nsites, 6, index, YY)]) = ((0.2000000000000000111) * ((((((((((((((((+(1.0)) * (field[reverse_addr_rank0_assert(891, "gradient_3d_27pt_fluid.c", nsites, index + ys)])) + ((1.0) * (field[reverse_addr_rank0_assert(892, "gradient_3d_27pt_fluid.c", nsites, index - ys)]))) - ((2.0) * (field[reverse_addr_rank0_assert(893, "gradient_3d_27pt_fluid.c", nsites, index)]))) + ((1.0) * (field[reverse_addr_rank0_assert(894, "gradient_3d_27pt_fluid.c", nsites, indexp1 + ys)]))) + ((1.0) * (field[reverse_addr_rank0_assert(895, "gradient_3d_27pt_fluid.c", nsites, indexp1 - ys)]))) - ((2.0) * (field[reverse_addr_rank0_assert(896, "gradient_3d_27pt_fluid.c", nsites, indexp1)]))) + ((1.0) * (field[reverse_addr_rank0_assert(897, "gradient_3d_27pt_fluid.c", nsites, indexm1 + ys)]))) + ((1.0) * (field[reverse_addr_rank0_assert(898, "gradient_3d_27pt_fluid.c", nsites, indexm1 - ys)]))) - ((2.0) * (field[reverse_addr_rank0_assert(899, "gradient_3d_27pt_fluid.c", nsites, indexm1)]))) + ((1.0) * (field[reverse_addr_rank0_assert(900, "gradient_3d_27pt_fluid.c", nsites, (index + 1) + ys)]))) + ((1.0) * (field[reverse_addr_rank0_assert(901, "gradient_3d_27pt_fluid.c", nsites, (index + 1) - ys)]))) - ((2.0) * (field[reverse_addr_rank0_assert(902, "gradient_3d_27pt_fluid.c", nsites, index + 1)]))) + ((1.0) * (field[reverse_addr_rank0_assert(903, "gradient_3d_27pt_fluid.c", nsites, (index - 1) + ys)]))) + ((1.0) * (field[reverse_addr_rank0_assert(904, "gradient_3d_27pt_fluid.c", nsites, (index - 1) - ys)]))) - ((2.0) * (field[reverse_addr_rank0_assert(905, "gradient_3d_27pt_fluid.c", nsites, index - 1)])))); 
# 907
(dab[reverse_addr_rank1_assert(907, "gradient_3d_27pt_fluid.c", nsites, 6, index, YZ)]) = (r12 * ((((((((((((+(field[reverse_addr_rank0_assert(908, "gradient_3d_27pt_fluid.c", nsites, (index + ys) + 1)])) - (field[reverse_addr_rank0_assert(909, "gradient_3d_27pt_fluid.c", nsites, (index + ys) - 1)])) - (field[reverse_addr_rank0_assert(910, "gradient_3d_27pt_fluid.c", nsites, (index - ys) + 1)])) + (field[reverse_addr_rank0_assert(911, "gradient_3d_27pt_fluid.c", nsites, (index - ys) - 1)])) + (field[reverse_addr_rank0_assert(912, "gradient_3d_27pt_fluid.c", nsites, (indexp1 + ys) + 1)])) - (field[reverse_addr_rank0_assert(913, "gradient_3d_27pt_fluid.c", nsites, (indexp1 + ys) - 1)])) - (field[reverse_addr_rank0_assert(914, "gradient_3d_27pt_fluid.c", nsites, (indexp1 - ys) + 1)])) + (field[reverse_addr_rank0_assert(915, "gradient_3d_27pt_fluid.c", nsites, (indexp1 - ys) - 1)])) + (field[reverse_addr_rank0_assert(916, "gradient_3d_27pt_fluid.c", nsites, (indexm1 + ys) + 1)])) - (field[reverse_addr_rank0_assert(917, "gradient_3d_27pt_fluid.c", nsites, (indexm1 + ys) - 1)])) - (field[reverse_addr_rank0_assert(918, "gradient_3d_27pt_fluid.c", nsites, (indexm1 - ys) + 1)])) + (field[reverse_addr_rank0_assert(919, "gradient_3d_27pt_fluid.c", nsites, (indexm1 - ys) - 1)]))); 
# 921
(dab[reverse_addr_rank1_assert(921, "gradient_3d_27pt_fluid.c", nsites, 6, index, ZZ)]) = ((0.2000000000000000111) * ((((((((((((((((+(1.0)) * (field[reverse_addr_rank0_assert(922, "gradient_3d_27pt_fluid.c", nsites, index + 1)])) + ((1.0) * (field[reverse_addr_rank0_assert(923, "gradient_3d_27pt_fluid.c", nsites, index - 1)]))) - ((2.0) * (field[reverse_addr_rank0_assert(924, "gradient_3d_27pt_fluid.c", nsites, index)]))) + ((1.0) * (field[reverse_addr_rank0_assert(925, "gradient_3d_27pt_fluid.c", nsites, indexp1 + 1)]))) + ((1.0) * (field[reverse_addr_rank0_assert(926, "gradient_3d_27pt_fluid.c", nsites, indexp1 - 1)]))) - ((2.0) * (field[reverse_addr_rank0_assert(927, "gradient_3d_27pt_fluid.c", nsites, indexp1)]))) + ((1.0) * (field[reverse_addr_rank0_assert(928, "gradient_3d_27pt_fluid.c", nsites, indexm1 + 1)]))) + ((1.0) * (field[reverse_addr_rank0_assert(929, "gradient_3d_27pt_fluid.c", nsites, indexm1 - 1)]))) - ((2.0) * (field[reverse_addr_rank0_assert(930, "gradient_3d_27pt_fluid.c", nsites, indexm1)]))) + ((1.0) * (field[reverse_addr_rank0_assert(931, "gradient_3d_27pt_fluid.c", nsites, (index + ys) + 1)]))) + ((1.0) * (field[reverse_addr_rank0_assert(932, "gradient_3d_27pt_fluid.c", nsites, (index + ys) - 1)]))) - ((2.0) * (field[reverse_addr_rank0_assert(933, "gradient_3d_27pt_fluid.c", nsites, index + ys)]))) + ((1.0) * (field[reverse_addr_rank0_assert(934, "gradient_3d_27pt_fluid.c", nsites, (index - ys) + 1)]))) + ((1.0) * (field[reverse_addr_rank0_assert(935, "gradient_3d_27pt_fluid.c", nsites, (index - ys) - 1)]))) - ((2.0) * (field[reverse_addr_rank0_assert(936, "gradient_3d_27pt_fluid.c", nsites, index - ys)])))); 
# 938
}  
# 939
}  
...
indexp1 = lees_edw_index(le, ic2, jc, kc); 
# 957
(dab[reverse_addr_rank1_assert(957, "gradient_3d_27pt_fluid.c", nsites, 6, index, XX)]) = ((0.2000000000000000111) * ((((((((((((((((+(1.0)) * (field[reverse_addr_rank0_assert(958, "gradient_3d_27pt_fluid.c", nsites, indexp1)])) + ((1.0) * (field[reverse_addr_rank0_assert(959, "gradient_3d_27pt_fluid.c", nsites, indexm1)]))) - ((2.0) * (field[reverse_addr_rank0_assert(960, "gradient_3d_27pt_fluid.c", nsites, index)]))) + ((1.0) * (field[reverse_addr_rank0_assert(961, "gradient_3d_27pt_fluid.c", nsites, indexp1 + ys)]))) + ((1.0) * (field[reverse_addr_rank0_assert(962, "gradient_3d_27pt_fluid.c", nsites, indexm1 + ys)]))) - ((2.0) * (field[reverse_addr_rank0_assert(963, "gradient_3d_27pt_fluid.c", nsites, index + ys)]))) + ((1.0) * (field[reverse_addr_rank0_assert(964, "gradient_3d_27pt_fluid.c", nsites, indexp1 - ys)]))) + ((1.0) * (field[reverse_addr_rank0_assert(965, "gradient_3d_27pt_fluid.c", nsites, indexm1 - ys)]))) - ((2.0) * (field[reverse_addr_rank0_assert(966, "gradient_3d_27pt_fluid.c", nsites, index - ys)]))) + ((1.0) * (field[reverse_addr_rank0_assert(967, "gradient_3d_27pt_fluid.c", nsites, indexp1 + 1)]))) + ((1.0) * (field[reverse_addr_rank0_assert(968, "gradient_3d_27pt_fluid.c", nsites, indexm1 + 1)]))) - ((2.0) * (field[reverse_addr_rank0_assert(969, "gradient_3d_27pt_fluid.c", nsites, index + 1)]))) + ((1.0) * (field[reverse_addr_rank0_assert(970, "gradient_3d_27pt_fluid.c", nsites, indexp1 - 1)]))) + ((1.0) * (field[reverse_addr_rank0_assert(971, "gradient_3d_27pt_fluid.c", nsites, indexm1 - 1)]))) - ((2.0) * (field[reverse_addr_rank0_assert(972, "gradient_3d_27pt_fluid.c", nsites, index - 1)])))); 
# 974
(dab[reverse_addr_rank1_assert(974, "gradient_3d_27pt_fluid.c", nsites, 6, index, XY)]) = (r12 * ((((((((((((+(field[reverse_addr_rank0_assert(975, "gradient_3d_27pt_fluid.c", nsites, indexp1 + ys)])) - (field[reverse_addr_rank0_assert(976, "gradient_3d_27pt_fluid.c", nsites, indexp1 - ys)])) - (field[reverse_addr_rank0_assert(977, "gradient_3d_27pt_fluid.c", nsites, indexm1 + ys)])) + (field[reverse_addr_rank0_assert(978, "gradient_3d_27pt_fluid.c", nsites, indexm1 - ys)])) + (field[reverse_addr_rank0_assert(979, "gradient_3d_27pt_fluid.c", nsites, (indexp1 + ys) + 1)])) - (field[reverse_addr_rank0_assert(980, "gradient_3d_27pt_fluid.c", nsites, (indexp1 - ys) + 1)])) - (field[reverse_addr_rank0_assert(981, "gradient_3d_27pt_fluid.c", nsites, (indexm1 + ys) + 1)])) + (field[reverse_addr_rank0_assert(982, "gradient_3d_27pt_fluid.c", nsites, (indexm1 - ys) + 1)])) + (field[reverse_addr_rank0_assert(983, "gradient_3d_27pt_fluid.c", nsites, (indexp1 + ys) - 1)])) - (field[reverse_addr_rank0_assert(984, "gradient_3d_27pt_fluid.c", nsites, (indexp1 - ys) - 1)])) - (field[reverse_addr_rank0_assert(985, "gradient_3d_27pt_fluid.c", nsites, (indexm1 + ys) - 1)])) + (field[reverse_addr_rank0_assert(986, "gradient_3d_27pt_fluid.c", nsites, (indexm1 - ys) - 1)]))); 
# 988
(dab[reverse_addr_rank1_assert(988, "gradient_3d_27pt_fluid.c", nsites, 6, index, XZ)]) = (r12 * ((((((((((((+(field[reverse_addr_rank0_assert(989, "gradient_3d_27pt_fluid.c", nsites, indexp1 + 1)])) - (field[reverse_addr_rank0_assert(990, "gradient_3d_27pt_fluid.c", nsites, indexp1 - 1)])) - (field[reverse_addr_rank0_assert(991, "gradient_3d_27pt_fluid.c", nsites, indexm1 + 1)])) + (field[reverse_addr_rank0_assert(992, "gradient_3d_27pt_fluid.c", nsites, indexm1 - 1)])) + (field[reverse_addr_rank0_assert(993, "gradient_3d_27pt_fluid.c", nsites, (indexp1 + ys) + 1)])) - (field[reverse_addr_rank0_assert(994, "gradient_3d_27pt_fluid.c", nsites, (indexp1 + ys) - 1)])) - (field[reverse_addr_rank0_assert(995, "gradient_3d_27pt_fluid.c", nsites, (indexm1 + ys) + 1)])) + (field[reverse_addr_rank0_assert(996, "gradient_3d_27pt_fluid.c", nsites, (indexm1 + ys) - 1)])) + (field[reverse_addr_rank0_assert(997, "gradient_3d_27pt_fluid.c", nsites, (indexp1 - ys) + 1)])) - (field[reverse_addr_rank0_assert(998, "gradient_3d_27pt_fluid.c", nsites, (indexp1 - ys) - 1)])) - (field[reverse_addr_rank0_assert(999, "gradient_3d_27pt_fluid.c", nsites, (indexm1 - ys) + 1)])) + (field[reverse_addr_rank0_assert(1000, "gradient_3d_27pt_fluid.c", nsites, (indexm1 - ys) - 1)]))); 
# 1002
(dab[reverse_addr_rank1_assert(1002, "gradient_3d_27pt_fluid.c", nsites, 6, index, YY)]) = ((0.2000000000000000111) * ((((((((((((((((+(1.0)) * (field[reverse_addr_rank0_assert(1003, "gradient_3d_27pt_fluid.c", nsites, index + ys)])) + ((1.0) * (field[reverse_addr_rank0_assert(1004, "gradient_3d_27pt_fluid.c", nsites, index - ys)]))) - ((2.0) * (field[reverse_addr_rank0_assert(1005, "gradient_3d_27pt_fluid.c", nsites, index)]))) + ((1.0) * (field[reverse_addr_rank0_assert(1006, "gradient_3d_27pt_fluid.c", nsites, indexp1 + ys)]))) + ((1.0) * (field[reverse_addr_rank0_assert(1007, "gradient_3d_27pt_fluid.c", nsites, indexp1 - ys)]))) - ((2.0) * (field[reverse_addr_rank0_assert(1008, "gradient_3d_27pt_fluid.c", nsites, indexp1)]))) + ((1.0) * (field[reverse_addr_rank0_assert(1009, "gradient_3d_27pt_fluid.c", nsites, indexm1 + ys)]))) + ((1.0) * (field[reverse_addr_rank0_assert(1010, "gradient_3d_27pt_fluid.c", nsites, indexm1 - ys)]))) - ((2.0) * (field[reverse_addr_rank0_assert(1011, "gradient_3d_27pt_fluid.c", nsites, indexm1)]))) + ((1.0) * (field[reverse_addr_rank0_assert(1012, "gradient_3d_27pt_fluid.c", nsites, (index + 1) + ys)]))) + ((1.0) * (field[reverse_addr_rank0_assert(1013, "gradient_3d_27pt_fluid.c", nsites, (index + 1) - ys)]))) - ((2.0) * (field[reverse_addr_rank0_assert(1014, "gradient_3d_27pt_fluid.c", nsites, index + 1)]))) + ((1.0) * (field[reverse_addr_rank0_assert(1015, "gradient_3d_27pt_fluid.c", nsites, (index - 1) + ys)]))) + ((1.0) * (field[reverse_addr_rank0_assert(1016, "gradient_3d_27pt_fluid.c", nsites, (index - 1) - ys)]))) - ((2.0) * (field[reverse_addr_rank0_assert(1017, "gradient_3d_27pt_fluid.c", nsites, index - 1)])))); 
# 1019
(dab[reverse_addr_rank1_assert(1019, "gradient_3d_27pt_fluid.c", nsites, 6, index, YZ)]) = (r12 * ((((((((((((+(field[reverse_addr_rank0_assert(1020, "gradient_3d_27pt_fluid.c", nsites, (index + ys) + 1)])) - (field[reverse_addr_rank0_assert(1021, "gradient_3d_27pt_fluid.c", nsites, (index + ys) - 1)])) - (field[reverse_addr_rank0_assert(1022, "gradient_3d_27pt_fluid.c", nsites, (index - ys) + 1)])) + (field[reverse_addr_rank0_assert(1023, "gradient_3d_27pt_fluid.c", nsites, (index - ys) - 1)])) + (field[reverse_addr_rank0_assert(1024, "gradient_3d_27pt_fluid.c", nsites, (indexp1 + ys) + 1)])) - (field[reverse_addr_rank0_assert(1025, "gradient_3d_27pt_fluid.c", nsites, (indexp1 + ys) - 1)])) - (field[reverse_addr_rank0_assert(1026, "gradient_3d_27pt_fluid.c", nsites, (indexp1 - ys) + 1)])) + (field[reverse_addr_rank0_assert(1027, "gradient_3d_27pt_fluid.c", nsites, (indexp1 - ys) - 1)])) + (field[reverse_addr_rank0_assert(1028, "gradient_3d_27pt_fluid.c", nsites, (indexm1 + ys) + 1)])) - (field[reverse_addr_rank0_assert(1029, "gradient_3d_27pt_fluid.c", nsites, (indexm1 + ys) - 1)])) - (field[reverse_addr_rank0_assert(1030, "gradient_3d_27pt_fluid.c", nsites, (indexm1 - ys) + 1)])) + (field[reverse_addr_rank0_assert(1031, "gradient_3d_27pt_fluid.c", nsites, (indexm1 - ys) - 1)]))); 
# 1033
(dab[reverse_addr_rank1_assert(1033, "gradient_3d_27pt_fluid.c", nsites, 6, index, ZZ)]) = ((0.2000000000000000111) * ((((((((((((((((+(1.0)) * (field[reverse_addr_rank0_assert(1034, "gradient_3d_27pt_fluid.c", nsites, index + 1)])) + ((1.0) * (field[reverse_addr_rank0_assert(1035, "gradient_3d_27pt_fluid.c", nsites, index - 1)]))) - ((2.0) * (field[reverse_addr_rank0_assert(1036, "gradient_3d_27pt_fluid.c", nsites, index)]))) + ((1.0) * (field[reverse_addr_rank0_assert(1037, "gradient_3d_27pt_fluid.c", nsites, indexp1 + 1)]))) + ((1.0) * (field[reverse_addr_rank0_assert(1038, "gradient_3d_27pt_fluid.c", nsites, indexp1 - 1)]))) - ((2.0) * (field[reverse_addr_rank0_assert(1039, "gradient_3d_27pt_fluid.c", nsites, indexp1)]))) + ((1.0) * (field[reverse_addr_rank0_assert(1040, "gradient_3d_27pt_fluid.c", nsites, indexm1 + 1)]))) + ((1.0) * (field[reverse_addr_rank0_assert(1041, "gradient_3d_27pt_fluid.c", nsites, indexm1 - 1)]))) - ((2.0) * (field[reverse_addr_rank0_assert(1042, "gradient_3d_27pt_fluid.c", nsites, indexm1)]))) + ((1.0) * (field[reverse_addr_rank0_assert(1043, "gradient_3d_27pt_fluid.c", nsites, (index + ys) + 1)]))) + ((1.0) * (field[reverse_addr_rank0_assert(1044, "gradient_3d_27pt_fluid.c", nsites, (index + ys) - 1)]))) - ((2.0) * (field[reverse_addr_rank0_assert(1045, "gradient_3d_27pt_fluid.c", nsites, index + ys)]))) + ((1.0) * (field[reverse_addr_rank0_assert(1046, "gradient_3d_27pt_fluid.c", nsites, (index - ys) + 1)]))) + ((1.0) * (field[reverse_addr_rank0_assert(1047, "gradient_3d_27pt_fluid.c", nsites, (index - ys) - 1)]))) - ((2.0) * (field[reverse_addr_rank0_assert(1048, "gradient_3d_27pt_fluid.c", nsites, index - ys)])))); 
# 1050
}  
# 1051
}  
...
# 1 "gradient_3d_27pt_fluid.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__30_gradient_3d_27pt_fluid_cpp1_ii_47331d3b
# 1 "gradient_3d_27pt_fluid.cudafe1.stub.c"
#include "gradient_3d_27pt_fluid.cudafe1.stub.c"
# 1 "gradient_3d_27pt_fluid.cudafe1.stub.c"
