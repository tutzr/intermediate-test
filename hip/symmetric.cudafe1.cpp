...
# 126
{ tdpErrorHandler(hipGetSymbolAddress((void **)(&p), &const_param), "symmetric.c", 126, 1); } ; 
# 127
tdpMemcpy(&((obj->target)->param), &p, sizeof(fe_symm_param_t *), hipMemcpyHostToDevice); 
# 129
{ tdpErrorHandler(hipGetSymbolAddress((void **)(&vt), &fe_symm_dvt), "symmetric.c", 129, 1); } ; 
# 130
...
# 194
{ tdpErrorHandler(hipMemcpyToSymbol(&const_param, fe->param, sizeof(fe_symm_param_t), 0, hipMemcpyHostToDevice), "symmetric.c", 195, 1); 
# 194 "symmetric.c"
} 
# 195
; 
