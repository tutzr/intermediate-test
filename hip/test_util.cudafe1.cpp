...
# 35
int util_random_unit_vector_check(); 
# 36
int util_str_tolower_check(); 
# 44
int test_util_suite() { 
# 46
int ifail = 0; 
...
# 58
test_assert_info(ifail == 0, 58, "test_util.c"); 
# 60
((a[0])[0]) = (-(1.0)); 
# 61
((a[0])[1]) = (0.0); 
...
# 68
test_assert_info(ifail == 0, 68, "test_util.c"); 
# 70
ifail = util_svd_solve(m, n, a, b, x); 
# 71
test_assert_info(ifail == 0, 71, "test_util.c"); 
# 73
...
# 115
svd_epsilon = (sum * ((2.0) * ((double)(2.2204460492503130808e-16L)))); 
# 117
...
# 194
test_assert_info(fabs(rvar - (1.0)) < ((4.0) * ((double)(2.2204460492503130808e-16L))), 194, "test_util.c"); 
# 195
(rmean[0]) += (rhat[0]); 
# 196
(rmean[1]) += (rhat[1]); 
...
# 208
test_assert_info(rmin >= (-(1.0)), 208, "test_util.c"); 
# 211
test_assert_info(rmax <= (+(1.0)), 211, "test_util.c"); 
# 214
(rmean[0]) /= (10000000); 
# 215
(rmean[1]) /= (10000000); 
...
(rmean[2]) /= (10000000); 
# 218
test_assert_info(fabs(rmean[0]) < (0.001000000000000000021), 218, "test_util.c"); 
# 220
test_assert_info(fabs(rmean[1]) < (0.001000000000000000021), 220, "test_util.c"); 
# 222
test_assert_info(fabs(rmean[2]) < (0.001000000000000000021), 222, "test_util.c"); 
# 226
return 0; 
# 227
} 
...
# 244
(strncmp(s1, "test", 4) == 0) ? static_cast< void>(0) : __assert_fail("strncmp(s1, \"test\", 4) == 0", "test_util.c", 244, __PRETTY_FUNCTION__); 
# 247
strncpy(s1, "AbCD", 5); 
# 248
util_str_tolower(s1, 3); 
# 249
(strncmp(s1, "abcD", 4) == 0) ? static_cast< void>(0) : __assert_fail("strncmp(s1, \"abcD\", 4) == 0", "test_util.c", 249, __PRETTY_FUNCTION__); 
# 252
strncpy(s1, "__12345ABCDE__", 15); 
# 253
util_str_tolower(s1, strlen(s1)); 
# 254
(strncmp(s1, "__12345abcde__", 14) == 0) ? static_cast< void>(0) : __assert_fail("strncmp(s1, \"__12345abcde__\", 14) == 0", "test_util.c", 254, __PRETTY_FUNCTION__); 
# 256
return 0; 
# 257
} 

# 1 "test_util.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__17_test_util_cpp1_ii_d6f29b34
# 1 "test_util.cudafe1.stub.c"
#include "test_util.cudafe1.stub.c"
# 1 "test_util.cudafe1.stub.c"
