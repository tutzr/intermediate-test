...
# 28
int field_phi_init_drop(field_t * phi, double xi, double radius, double phistar); 
# 30
...
# 40
int field_phi_init_spinodal_patches(field_t * phi, int seed, int patch, double volm1); 
# 42
int field_phi_init_emulsion(field_t * phi, double xi, double radius, double phistar, int Ndrops, double d_centre); 
# 21 "../.././src/kernel.h"
...
# 88
(pe) ? static_cast< void>(0) : __assert_fail("pe", "test_visc_arrhenius.c", 88, __PRETTY_FUNCTION__); 
# 89
(cs) ? static_cast< void>(0) : __assert_fail("cs", "test_visc_arrhenius.c", 89, __PRETTY_FUNCTION__); 
# 90
(phi) ? static_cast< void>(0) : __assert_fail("phi", "test_visc_arrhenius.c", 90, __PRETTY_FUNCTION__); 
# 92
visc_arrhenius_create(pe, cs, phi, param, &visc); 
# 94
(visc) ? static_cast< void>(0) : __assert_fail("visc", "test_visc_arrhenius.c", 94, __PRETTY_FUNCTION__); 
# 95
((visc->pe) == pe) ? static_cast< void>(0) : __assert_fail("visc->pe == pe", "test_visc_arrhenius.c", 95, __PRETTY_FUNCTION__); 
# 96
((visc->cs) == cs) ? static_cast< void>(0) : __assert_fail("visc->cs == cs", "test_visc_arrhenius.c", 96, __PRETTY_FUNCTION__); 
# 97
((visc->phi) == phi) ? static_cast< void>(0) : __assert_fail("visc->phi == phi", "test_visc_arrhenius.c", 97, __PRETTY_FUNCTION__); 
# 98
(visc->param) ? static_cast< void>(0) : __assert_fail("visc->param", "test_visc_arrhenius.c", 98, __PRETTY_FUNCTION__); 
# 100
(fabs(((visc->param)->eta_plus) - (param.eta_plus)) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(visc->param->eta_plus - param.eta_plus) < double(2.22044604925031308085e-16L)", "test_visc_arrhenius.c", 100, __PRETTY_FUNCTION__); 
# 101
(fabs(((visc->param)->eta_minus) - (param.eta_minus)) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(visc->param->eta_minus - param.eta_minus) < double(2.22044604925031308085e-16L)", "test_visc_arrhenius.c", 101, __PRETTY_FUNCTION__); 
# 102
(fabs(((visc->param)->phistar) - (param.phistar)) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(visc->param->phistar - param.phistar) < double(2.22044604925031308085e-16L)", "test_visc_arrhenius.c", 102, __PRETTY_FUNCTION__); 
# 104
...
# 118 "test_visc_arrhenius.c"
int test_visc_arrhenius_update(pe_t *pe, cs_t *cs, field_t *phi) { 
# 120
const double eta_plus = (0.5); 
# 121
const double eta_minus = (0.1000000000000000056); 
# 122
...
double eta0; 
# 133
(pe) ? static_cast< void>(0) : __assert_fail("pe", "test_visc_arrhenius.c", 133, __PRETTY_FUNCTION__); 
# 134
(cs) ? static_cast< void>(0) : __assert_fail("cs", "test_visc_arrhenius.c", 134, __PRETTY_FUNCTION__); 
# 135
(phi) ? static_cast< void>(0) : __assert_fail("phi", "test_visc_arrhenius.c", 135, __PRETTY_FUNCTION__); 
# 137
visc_arrhenius_create(pe, cs, phi, param, &visc); 
# 141
phi0 = (+(1.0)); 
...
# 147
hydro_create(pe, cs, __null, 0, &hydro); 
# 148
visc_arrhenius_update(visc, hydro); 
# 149
hydro_memcpy(hydro, hipMemcpyDeviceToHost); 
# 153
eta0 = (pow(eta_minus, (0.5) * ((1.0) - phi0)) * pow(eta_plus, (0.5) * ((1.0) + phi0))); 
# 154
(fabs(eta0 - (param.eta_plus)) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(eta0 - param.eta_plus) < double(2.22044604925031308085e-16L)", "test_visc_arrhenius.c", 154, __PRETTY_FUNCTION__); 
# 156
ifail = test_visc_arrhenius_eta_uniform(cs, hydro, eta0); 
# 157
(ifail == 0) ? static_cast< void>(0) : __assert_fail("ifail == 0", "test_visc_arrhenius.c", 157, __PRETTY_FUNCTION__); 
# 161
phi0 = (-(1.0)); 
# 162
field_phi_init_uniform(phi, phi0); 
...
eta0 = (pow(eta_minus, (0.5) * ((1.0) - phi0)) * pow(eta_plus, (0.5) * ((1.0) + phi0))); 
# 171
(fabs(eta0 - (param.eta_minus)) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(eta0 - param.eta_minus) < double(2.22044604925031308085e-16L)", "test_visc_arrhenius.c", 171, __PRETTY_FUNCTION__); 
# 173
ifail = test_visc_arrhenius_eta_uniform(cs, hydro, eta0); 
# 174
(ifail == 0) ? static_cast< void>(0) : __assert_fail("ifail == 0", "test_visc_arrhenius.c", 174, __PRETTY_FUNCTION__); 
# 178
phi0 = (0.0); 
# 179
field_phi_init_uniform(phi, phi0); 
...
eta0 = (pow(eta_minus, (0.5) * ((1.0) - phi0)) * pow(eta_plus, (0.5) * ((1.0) + phi0))); 
# 186
(fabs(eta0 - (sqrt(eta_plus) * sqrt(eta_minus))) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(eta0 - sqrt(eta_plus)*sqrt(eta_minus)) < double(2.22044604925031308085e-16L)", "test_visc_arrhenius.c", 186, __PRETTY_FUNCTION__); 
# 188
ifail = test_visc_arrhenius_eta_uniform(cs, hydro, eta0); 
# 189
(ifail == 0) ? static_cast< void>(0) : __assert_fail("ifail == 0", "test_visc_arrhenius.c", 189, __PRETTY_FUNCTION__); 
# 193
hydro_free(hydro); 
# 194
visc_arrhenius_free(visc); 
...
double eta; 
# 213
(cs) ? static_cast< void>(0) : __assert_fail("cs", "test_visc_arrhenius.c", 213, __PRETTY_FUNCTION__); 
# 214
(hydro) ? static_cast< void>(0) : __assert_fail("hydro", "test_visc_arrhenius.c", 214, __PRETTY_FUNCTION__); 
# 216
cs_nlocal(cs, nlocal); 
# 218
...
# 223
eta = ((hydro->eta)[reverse_addr_rank0_assert(223, "test_visc_arrhenius.c", hydro->nsite, index)]); 
# 225
if (fabs(eta - eta0) > ((double)(2.2204460492503130808e-16L))) { ifail = 1; }  
# 226
}  
# 227
}  
...
# 1 "test_visc_arrhenius.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__27_test_visc_arrhenius_cpp1_ii_89ceb33f
# 1 "test_visc_arrhenius.cudafe1.stub.c"
#include "test_visc_arrhenius.cudafe1.stub.c"
# 1 "test_visc_arrhenius.cudafe1.stub.c"
