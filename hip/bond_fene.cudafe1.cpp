...
int bond_fene_create(pe_t *pe, cs_t *cs, bond_fene_t **pobj) { 
# 54
bond_fene_t *obj = (__null); 
# 56
(pe) ? static_cast< void>(0) : __assert_fail("pe", "bond_fene.c", 56, __PRETTY_FUNCTION__); 
# 57
(cs) ? static_cast< void>(0) : __assert_fail("cs", "bond_fene.c", 57, __PRETTY_FUNCTION__); 
# 58
(pobj) ? static_cast< void>(0) : __assert_fail("pobj", "bond_fene.c", 58, __PRETTY_FUNCTION__); 
# 60
obj = ((bond_fene_t *)calloc(1, sizeof(bond_fene_t))); 
# 61
(obj) ? static_cast< void>(0) : __assert_fail("obj", "bond_fene.c", 61, __PRETTY_FUNCTION__); 
# 62
if (obj == (__null)) { pe_fatal(pe, "calloc(bond_fene_t) failed\n"); }  
# 64
(obj->pe) = pe; 
# 65
(obj->cs) = cs; 
...
int bond_fene_free(bond_fene_t *obj) { 
# 80
(obj) ? static_cast< void>(0) : __assert_fail("obj", "bond_fene.c", 80, __PRETTY_FUNCTION__); 
# 82
free(obj); 
# 84
return 0; 
...
int bond_fene_param_set(bond_fene_t *obj, double k, double r0) { 
# 95
(obj) ? static_cast< void>(0) : __assert_fail("obj", "bond_fene.c", 95, __PRETTY_FUNCTION__); 
# 97
(obj->k) = k; 
# 98
(obj->r0) = r0; 
...
int bond_fene_info(bond_fene_t *obj) { 
# 111
(obj) ? static_cast< void>(0) : __assert_fail("obj", "bond_fene.c", 111, __PRETTY_FUNCTION__); 
# 113
...
int bond_fene_register(bond_fene_t *obj, interact_t *parent) { 
# 128
(obj) ? static_cast< void>(0) : __assert_fail("obj", "bond_fene.c", 128, __PRETTY_FUNCTION__); 
# 129
(parent) ? static_cast< void>(0) : __assert_fail("parent", "bond_fene.c", 129, __PRETTY_FUNCTION__); 
# 131
...
colloid_t *pc = (__null); 
# 155
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "bond_fene.c", 155, __PRETTY_FUNCTION__); 
# 156
(obj) ? static_cast< void>(0) : __assert_fail("obj", "bond_fene.c", 156, __PRETTY_FUNCTION__); 
# 158
...
# 172
((pc->bonded)[n]) ? static_cast< void>(0) : __assert_fail("pc->bonded[n]", "bond_fene.c", 172, __PRETTY_FUNCTION__); 
# 173
...
bond_fene_t *obj = (bond_fene_t *)self; 
# 214
(obj) ? static_cast< void>(0) : __assert_fail("obj", "bond_fene.c", 214, __PRETTY_FUNCTION__); 
# 215
(stats) ? static_cast< void>(0) : __assert_fail("stats", "bond_fene.c", 215, __PRETTY_FUNCTION__); 
# 217
...
double rr0; 
# 236
(obj) ? static_cast< void>(0) : __assert_fail("obj", "bond_fene.c", 236, __PRETTY_FUNCTION__); 
# 237
(r < (obj->r0)) ? static_cast< void>(0) : __assert_fail("r < obj->r0", "bond_fene.c", 237, __PRETTY_FUNCTION__); 
# 239
rr0 = (r / (obj->r0)); 
# 240
...
# 1 "bond_fene.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__17_bond_fene_cpp1_ii_91f23f18
# 1 "bond_fene.cudafe1.stub.c"
#include "bond_fene.cudafe1.stub.c"
# 1 "bond_fene.cudafe1.stub.c"
