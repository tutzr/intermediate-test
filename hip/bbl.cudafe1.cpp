...
# 48
static int bbl_wall_lubrication_account(bbl_t * bbl, wall_t * wall, colloids_info_t * cinfo); 
# 51
void bbl_pass0_kernel(kernel_ctxt_t * ktxt, cs_t * cs, lb_t * lb, colloids_info_t * cinfo); 
# 54
static lb_collide_param_t lbp; 
# 64 "bbl.c"
int bbl_create(pe_t *pe, cs_t *cs, lb_t *lb, bbl_t **pobj) { 
# 66
bbl_t *bbl = (__null); 
# 68
(pe) ? static_cast< void>(0) : __assert_fail("pe", "bbl.c", 68, __PRETTY_FUNCTION__); 
# 69
(cs) ? static_cast< void>(0) : __assert_fail("cs", "bbl.c", 69, __PRETTY_FUNCTION__); 
# 70
(lb) ? static_cast< void>(0) : __assert_fail("lb", "bbl.c", 70, __PRETTY_FUNCTION__); 
# 71
(pobj) ? static_cast< void>(0) : __assert_fail("pobj", "bbl.c", 71, __PRETTY_FUNCTION__); 
# 73
bbl = ((bbl_t *)calloc(1, sizeof(bbl_t))); 
# 74
(bbl) ? static_cast< void>(0) : __assert_fail("bbl", "bbl.c", 74, __PRETTY_FUNCTION__); 
# 75
if (bbl == (__null)) { pe_fatal(pe, "calloc(bbl_t) failed\n"); }  
# 77
(bbl->pe) = pe; 
# 78
(bbl->cs) = cs; 
...
# 94
(bbl) ? static_cast< void>(0) : __assert_fail("bbl", "bbl.c", 94, __PRETTY_FUNCTION__); 
# 96
free(bbl); 
# 98
return 0; 
...
MPI_Comm comm; 
# 113
(bbl) ? static_cast< void>(0) : __assert_fail("bbl", "bbl.c", 113, __PRETTY_FUNCTION__); 
# 114
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "bbl.c", 114, __PRETTY_FUNCTION__); 
# 116
...
# 149 "bbl.c"
int bounce_back_on_links(bbl_t *bbl, lb_t *lb, wall_t *wall, colloids_info_t *
# 150
cinfo) { 
# 152
int ntotal; 
...
int nlocal[3]; 
# 155
(bbl) ? static_cast< void>(0) : __assert_fail("bbl", "bbl.c", 155, __PRETTY_FUNCTION__); 
# 156
(lb) ? static_cast< void>(0) : __assert_fail("lb", "bbl.c", 156, __PRETTY_FUNCTION__); 
# 157
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "bbl.c", 157, __PRETTY_FUNCTION__); 
# 159
...
# 206
(bbl) ? static_cast< void>(0) : __assert_fail("bbl", "bbl.c", 206, __PRETTY_FUNCTION__); 
# 207
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "bbl.c", 207, __PRETTY_FUNCTION__); 
# 209
...
# 259
(bbl) ? static_cast< void>(0) : __assert_fail("bbl", "bbl.c", 259, __PRETTY_FUNCTION__); 
# 260
(lb) ? static_cast< void>(0) : __assert_fail("lb", "bbl.c", 260, __PRETTY_FUNCTION__); 
# 261
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "bbl.c", 261, __PRETTY_FUNCTION__); 
# 263
cs_nlocal(bbl->cs, nlocal); 
# 264
...
# 272
{ tdpErrorHandler(hipMemcpyToSymbol(&lbp, lb->param, sizeof(lb_collide_param_t), 0, hipMemcpyHostToDevice), "bbl.c", 273, 1); 
# 272 "bbl.c"
} 
# 273
; 
...
# 278
do { (__cudaPushCallConfiguration(nblk, ntpb, 0, 0)) ? (void)0 : bbl_pass0_kernel(ctxt->target, cstarget, lb->target, cinfo->target); } while (0); 
# 279
; 
# 280
{ tdpErrorHandler(tdpPeekAtLastError(), "bbl.c", 280, 1); } ; 
# 281
{ tdpErrorHandler(tdpDeviceSynchronize(), "bbl.c", 281, 1); } ; 
# 283
...
# 296 "bbl.c"
void bbl_pass0_kernel(kernel_ctxt_t *ktxt, cs_t *cs, lb_t *lb, colloids_info_t *
# 297
cinfo) ;
#if 0
# 297
...
# 303
(ktxt) ? static_cast< void>(0) : __assert_fail("ktxt", "bbl.c", 303, __PRETTY_FUNCTION__); 
# 304
(cs) ? static_cast< void>(0) : __assert_fail("cs", "bbl.c", 304, __PRETTY_FUNCTION__); 
# 305
(lb) ? static_cast< void>(0) : __assert_fail("lb", "bbl.c", 305, __PRETTY_FUNCTION__); 
# 306
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "bbl.c", 306, __PRETTY_FUNCTION__); 
# 308
...
# 356
((lb->f)[reverse_addr_rank2_assert(356, "bbl.c", lb->nsite, lb->ndist, NVEL, index, LB_RHO, p)]) = (((lbp.wv)[p]) * (((1.0) + (rcs2 * udotc)) + ((((0.5) * rcs2) * rcs2) * sdotq))); 
# 358
}  
# 359
}  
...
colloid_t *pc = (__null); 
# 390
colloid_link_t *p_link = (__null); 
# 392
(bbl) ? static_cast< void>(0) : __assert_fail("bbl", "bbl.c", 392, __PRETTY_FUNCTION__); 
# 393
(lb) ? static_cast< void>(0) : __assert_fail("lb", "bbl.c", 393, __PRETTY_FUNCTION__); 
# 394
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "bbl.c", 394, __PRETTY_FUNCTION__); 
# 396
physics_ref(&phys); 
# 397
...
ji = ((NVEL) - ij); 
# 436
((ij > 0) && (ij < (NVEL))) ? static_cast< void>(0) : __assert_fail("ij > 0 && ij < NVEL", "bbl.c", 436, __PRETTY_FUNCTION__); 
# 441
...
# 461
((cost * cost) <= (1.0)) ? static_cast< void>(0) : __assert_fail("cost*cost <= 1.0", "bbl.c", 461, __PRETTY_FUNCTION__); 
# 462
...
colloid_link_t *p_link; 
# 584
(bbl) ? static_cast< void>(0) : __assert_fail("bbl", "bbl.c", 584, __PRETTY_FUNCTION__); 
# 585
(lb) ? static_cast< void>(0) : __assert_fail("lb", "bbl.c", 585, __PRETTY_FUNCTION__); 
# 586
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "bbl.c", 586, __PRETTY_FUNCTION__); 
# 588
physics_ref(&phys); 
# 589
physics_rho0(phys, &rho0); 
...
# 759
(bbl) ? static_cast< void>(0) : __assert_fail("bbl", "bbl.c", 759, __PRETTY_FUNCTION__); 
# 760
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "bbl.c", 760, __PRETTY_FUNCTION__); 
# 762
...
# 915
((pc->force)[X]) = (((pc->f0)[X]) - ((((((((pc->zeta)[0]) * (((pc->s).v)[X])) + (((pc->zeta)[1]) * (((pc->s).v)[Y]))) + (((pc->zeta)[2]) * (((pc->s).v)[Z]))) + (((pc->zeta)[3]) * (((pc->s).w)[X]))) + (((pc->zeta)[4]) * (((pc->s).w)[Y]))) + (((pc->zeta)[5]) * (((pc->s).w)[Z])))); 
# 922
((pc->force)[Y]) = (((pc->f0)[Y]) - ((((((((pc->zeta)[1]) * (((pc->s).v)[X])) + (((pc->zeta)[6]) * (((pc->s).v)[Y]))) + (((pc->zeta)[7]) * (((pc->s).v)[Z]))) + (((pc->zeta)[8]) * (((pc->s).w)[X]))) + (((pc->zeta)[9]) * (((pc->s).w)[Y]))) + (((pc->zeta)[10]) * (((pc->s).w)[Z])))); 
# 929
((pc->force)[Z]) = (((pc->f0)[Z]) - ((((((((pc->zeta)[2]) * (((pc->s).v)[X])) + (((pc->zeta)[7]) * (((pc->s).v)[Y]))) + (((pc->zeta)[11]) * (((pc->s).v)[Z]))) + (((pc->zeta)[12]) * (((pc->s).w)[X]))) + (((pc->zeta)[13]) * (((pc->s).w)[Y]))) + (((pc->zeta)[14]) * (((pc->s).w)[Z])))); 
# 936
}  
# 941
...
# 959 "bbl.c"
static int bbl_wall_lubrication_account(bbl_t *bbl, wall_t *wall, colloids_info_t *
# 960
cinfo) { 
# 962
...
colloid_t *pc = (__null); 
# 966
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "bbl.c", 966, __PRETTY_FUNCTION__); 
# 970
...
int bbl_order_parameter_deficit(bbl_t *bbl, double *delta) { 
# 996
(bbl) ? static_cast< void>(0) : __assert_fail("bbl", "bbl.c", 996, __PRETTY_FUNCTION__); 
# 997
(delta) ? static_cast< void>(0) : __assert_fail("delta", "bbl.c", 997, __PRETTY_FUNCTION__); 
# 999
(delta[0]) = (0.0); 
# 1000
...
double ltot[3]; 
# 1020
(bbl) ? static_cast< void>(0) : __assert_fail("bbl", "bbl.c", 1020, __PRETTY_FUNCTION__); 
# 1022
cs_ltot(bbl->cs, ltot); 
# 1024
...
# 1 "bbl.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__11_bbl_cpp1_ii_e251c242
# 1 "bbl.cudafe1.stub.c"
#include "bbl.cudafe1.stub.c"
# 1 "bbl.cudafe1.stub.c"
