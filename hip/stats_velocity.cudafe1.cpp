...
MPI_Comm comm; 
# 52
(hydro) ? static_cast< void>(0) : __assert_fail("hydro", "stats_velocity.c", 52, __PRETTY_FUNCTION__); 
# 53
(map) ? static_cast< void>(0) : __assert_fail("map", "stats_velocity.c", 53, __PRETTY_FUNCTION__); 
# 55
...
for (ia = 0; ia < 3; ia++) { 
# 59
(umin[ia]) = ((3.402823466e+38F)); 
# 60
(umax[ia]) = ((1.175494351e-38F)); 
# 61
(usum_local[ia]) = (0.0); 
# 62
}  
...
# 1 "stats_velocity.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__22_stats_velocity_cpp1_ii_35453afa
# 1 "stats_velocity.cudafe1.stub.c"
#include "stats_velocity.cudafe1.stub.c"
# 1 "stats_velocity.cudafe1.stub.c"
