...
# 37 "blue_phase_rt.c"
int blue_phase_init_rt(pe_t *pe, rt_t *rt, fe_lc_t *
# 38
fe, beris_edw_t *
# 39
be) { 
...
int redshift_update; 
# 42
char method[8192] = "none"; 
# 43
char type[8192] = "none"; 
# 44
char type_wall[8192] = "none"; 
# 46
double epsilon; 
# 47
double redshift; 
...
# 66
(pe) ? static_cast< void>(0) : __assert_fail("pe", "blue_phase_rt.c", 66, __PRETTY_FUNCTION__); 
# 67
(rt) ? static_cast< void>(0) : __assert_fail("rt", "blue_phase_rt.c", 67, __PRETTY_FUNCTION__); 
# 68
(fe) ? static_cast< void>(0) : __assert_fail("fe", "blue_phase_rt.c", 68, __PRETTY_FUNCTION__); 
# 69
(be) ? static_cast< void>(0) : __assert_fail("be", "blue_phase_rt.c", 69, __PRETTY_FUNCTION__); 
# 71
...
# 116
((fe_param.kappa0) == (fe_param.kappa1)) ? static_cast< void>(0) : __assert_fail("fe_param.kappa0 == fe_param.kappa1", "blue_phase_rt.c", 116, __PRETTY_FUNCTION__); 
# 118
...
# 175
rt_string_parameter(rt, "lc_anchoring_method", method, 4096); 
# 177
...
{ 
# 190
n = rt_string_parameter(rt, "lc_anchoring", type, 4096); 
# 192
if (n == 1) { 
# 193
...
# 198
rt_string_parameter(rt, "lc_coll_anchoring", type, 4096); 
# 200
...
# 226
rt_string_parameter(rt, "lc_wall_anchoring", type_wall, 4096); 
# 228
...
# 336 "blue_phase_rt.c"
int blue_phase_rt_initial_conditions(pe_t *pe, rt_t *rt, cs_t *cs, fe_lc_t *
# 337
fe, field_t *q) { 
# 339
int n1, n2; 
...
# 349
(pe) ? static_cast< void>(0) : __assert_fail("pe", "blue_phase_rt.c", 349, __PRETTY_FUNCTION__); 
# 350
(cs) ? static_cast< void>(0) : __assert_fail("cs", "blue_phase_rt.c", 350, __PRETTY_FUNCTION__); 
# 351
(fe) ? static_cast< void>(0) : __assert_fail("fe", "blue_phase_rt.c", 351, __PRETTY_FUNCTION__); 
# 352
(q) ? static_cast< void>(0) : __assert_fail("q", "blue_phase_rt.c", 352, __PRETTY_FUNCTION__); 
# 354
fe_lc_param(fe, feparam); 
# 356
pe_info(pe, "\n"); 
# 358
n1 = rt_string_parameter(rt, "lc_q_initialisation", key1, 4096); 
# 359
...
# 1 "blue_phase_rt.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__21_blue_phase_rt_cpp1_ii_f0adc6c9
# 1 "blue_phase_rt.cudafe1.stub.c"
#include "blue_phase_rt.cudafe1.stub.c"
# 1 "blue_phase_rt.cudafe1.stub.c"
