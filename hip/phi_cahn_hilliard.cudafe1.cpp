...
# 77
void phi_ch_flux_mu1_kernel(kernel_ctxt_t * ktx, lees_edw_t * le, fe_t * fe, advflux_t * flux, double mobility); 
# 80
void phi_ch_flux_mu_ext_kernel(kernel_ctxt_t * ktx, lees_edw_t * le, advflux_t * flux, ch_kernel_t ch); 
# 83
void phi_ch_ufs_kernel(kernel_ctxt_t * ktx, lees_edw_t * le, field_t * field, advflux_t * flux, int ys, double wz); 
# 93
int phi_ch_create(pe_t *pe, cs_t *cs, lees_edw_t *le, phi_ch_info_t *
# 94
info, phi_ch_t **
# 95
pch) { 
...
phi_ch_t *obj = (__null); 
# 99
(pe) ? static_cast< void>(0) : __assert_fail("pe", "phi_cahn_hilliard.c", 99, __PRETTY_FUNCTION__); 
# 100
(cs) ? static_cast< void>(0) : __assert_fail("cs", "phi_cahn_hilliard.c", 100, __PRETTY_FUNCTION__); 
# 101
(le) ? static_cast< void>(0) : __assert_fail("le", "phi_cahn_hilliard.c", 101, __PRETTY_FUNCTION__); 
# 102
(pch) ? static_cast< void>(0) : __assert_fail("pch", "phi_cahn_hilliard.c", 102, __PRETTY_FUNCTION__); 
# 104
obj = ((phi_ch_t *)calloc(1, sizeof(phi_ch_t))); 
# 105
(obj) ? static_cast< void>(0) : __assert_fail("obj", "phi_cahn_hilliard.c", 105, __PRETTY_FUNCTION__); 
# 106
if (obj == (__null)) { pe_fatal(pe, "calloc(phi_ch_t) failed\n"); }  
# 108
(obj->pe) = pe; 
# 109
(obj->cs) = cs; 
...
int phi_ch_free(phi_ch_t *pch) { 
# 129
(pch) ? static_cast< void>(0) : __assert_fail("pch", "phi_cahn_hilliard.c", 129, __PRETTY_FUNCTION__); 
# 131
...
# 170 "phi_cahn_hilliard.c"
int phi_cahn_hilliard(phi_ch_t *pch, fe_t *fe, field_t *phi, hydro_t *
# 171
hydro, map_t *map, noise_t *
# 172
noise) { 
# 173
int nf; 
...
int noise_phi = 0; 
# 176
(pch) ? static_cast< void>(0) : __assert_fail("pch", "phi_cahn_hilliard.c", 176, __PRETTY_FUNCTION__); 
# 177
(fe) ? static_cast< void>(0) : __assert_fail("fe", "phi_cahn_hilliard.c", 177, __PRETTY_FUNCTION__); 
# 178
(phi) ? static_cast< void>(0) : __assert_fail("phi", "phi_cahn_hilliard.c", 178, __PRETTY_FUNCTION__); 
# 180
if (noise) { noise_present(noise, NOISE_PHI, &noise_phi); }  
# 182
field_nf(phi, &nf); 
# 183
(nf == 1) ? static_cast< void>(0) : __assert_fail("nf == 1", "phi_cahn_hilliard.c", 183, __PRETTY_FUNCTION__); 
# 188
if (hydro) { 
# 189
hydro_u_halo(hydro); 
...
# 236
(pch) ? static_cast< void>(0) : __assert_fail("pch", "phi_cahn_hilliard.c", 236, __PRETTY_FUNCTION__); 
# 237
(fe) ? static_cast< void>(0) : __assert_fail("fe", "phi_cahn_hilliard.c", 237, __PRETTY_FUNCTION__); 
# 239
...
# 253
do { (__cudaPushCallConfiguration(nblk, ntpb, 0, 0)) ? (void)0 : phi_ch_flux_mu1_kernel(ctxt->target, letarget, fetarget, (pch->flux)->target, mobility); } while (0); 
# 254
; 
# 255
{ tdpErrorHandler(tdpPeekAtLastError(), "phi_cahn_hilliard.c", 255, 1); } ; 
# 256
{ tdpErrorHandler(tdpDeviceSynchronize(), "phi_cahn_hilliard.c", 256, 1); } ; 
# 258
...
void phi_ch_flux_mu1_kernel(kernel_ctxt_t *ktx, lees_edw_t *
# 279
le, fe_t *fe, advflux_t *
# 280
flux, double mobility) ;
#if 0
# 280
{ 
# 281
...
# 284
(ktx) ? static_cast< void>(0) : __assert_fail("ktx", "phi_cahn_hilliard.c", 284, __PRETTY_FUNCTION__); 
# 285
(le) ? static_cast< void>(0) : __assert_fail("le", "phi_cahn_hilliard.c", 285, __PRETTY_FUNCTION__); 
# 286
(fe) ? static_cast< void>(0) : __assert_fail("fe", "phi_cahn_hilliard.c", 286, __PRETTY_FUNCTION__); 
# 287
((fe->func)->mu) ? static_cast< void>(0) : __assert_fail("fe->func->mu", "phi_cahn_hilliard.c", 287, __PRETTY_FUNCTION__); 
# 288
(flux) ? static_cast< void>(0) : __assert_fail("flux", "phi_cahn_hilliard.c", 288, __PRETTY_FUNCTION__); 
# 290
...
# 314
((flux->fw)[reverse_addr_rank0_assert(314, "phi_cahn_hilliard.c", flux->nsite, index0)]) -= (mobility * (mu0 - mu1)); 
# 318
index1 = lees_edw_index(le, icp1, jc, kc); 
# 319
((fe->func)->mu)(fe, index1, &mu1); 
# 320
((flux->fe)[reverse_addr_rank0_assert(320, "phi_cahn_hilliard.c", flux->nsite, index0)]) -= (mobility * (mu1 - mu0)); 
# 324
index1 = lees_edw_index(le, ic, jc + 1, kc); 
# 325
((fe->func)->mu)(fe, index1, &mu1); 
# 326
((flux->fy)[reverse_addr_rank0_assert(326, "phi_cahn_hilliard.c", flux->nsite, index0)]) -= (mobility * (mu1 - mu0)); 
# 330
index1 = lees_edw_index(le, ic, jc, kc + 1); 
# 331
((fe->func)->mu)(fe, index1, &mu1); 
# 332
((flux->fz)[reverse_addr_rank0_assert(332, "phi_cahn_hilliard.c", flux->nsite, index0)]) -= (mobility * (mu1 - mu0)); 
# 335
}  
# 338
} 
#endif
# 359 "phi_cahn_hilliard.c"
...
physics_t *phys = (__null); 
# 370
(pch) ? static_cast< void>(0) : __assert_fail("pch", "phi_cahn_hilliard.c", 370, __PRETTY_FUNCTION__); 
# 371
(fesymm) ? static_cast< void>(0) : __assert_fail("fesymm", "phi_cahn_hilliard.c", 371, __PRETTY_FUNCTION__); 
# 372
((fesymm->func)->mu) ? static_cast< void>(0) : __assert_fail("fesymm->func->mu", "phi_cahn_hilliard.c", 372, __PRETTY_FUNCTION__); 
# 374
lees_edw_nhalo(pch->le, &nhalo); 
# 375
lees_edw_nlocal(pch->le, nlocal); 
# 376
(nhalo >= 3) ? static_cast< void>(0) : __assert_fail("nhalo >= 3", "phi_cahn_hilliard.c", 376, __PRETTY_FUNCTION__); 
# 378
physics_ref(&phys); 
# 379
physics_mobility(phys, &mobility); 
...
# 396
(((pch->flux)->fw)[reverse_addr_rank0_assert(396, "phi_cahn_hilliard.c", (pch->flux)->nsite, index0)]) -= (((0.25) * mobility) * (((mup1 + mu00) - mum1) - mum2)); 
# 401
(((pch->flux)->fe)[reverse_addr_rank0_assert(401, "phi_cahn_hilliard.c", (pch->flux)->nsite, index0)]) -= (((0.25) * mobility) * (((mup2 + mup1) - mu00) - mum1)); 
# 406
...
# 410
(((pch->flux)->fy)[reverse_addr_rank0_assert(410, "phi_cahn_hilliard.c", (pch->flux)->nsite, index0)]) -= (((0.25) * mobility) * (((mup2 + mup1) - mu00) - mum1)); 
# 415
...
# 419
(((pch->flux)->fz)[reverse_addr_rank0_assert(419, "phi_cahn_hilliard.c", (pch->flux)->nsite, index0)]) -= (((0.25) * mobility) * (((mup2 + mup1) - mu00) - mum1)); 
# 423
}  
# 424
}  
...
physics_t *phys = (__null); 
# 451
(pch) ? static_cast< void>(0) : __assert_fail("pch", "phi_cahn_hilliard.c", 451, __PRETTY_FUNCTION__); 
# 452
(pch->le) ? static_cast< void>(0) : __assert_fail("pch->le", "phi_cahn_hilliard.c", 452, __PRETTY_FUNCTION__); 
# 453
(lees_edw_nplane_local(pch->le) == 0) ? static_cast< void>(0) : __assert_fail("lees_edw_nplane_local(pch->le) == 0", "phi_cahn_hilliard.c", 453, __PRETTY_FUNCTION__); 
# 457
physics_ref(&phys); 
# 458
physics_kt(phys, &kt); 
...
# 466
(rflux) ? static_cast< void>(0) : __assert_fail("rflux", "phi_cahn_hilliard.c", 466, __PRETTY_FUNCTION__); 
# 467
if (rflux == (__null)) { pe_fatal(pch->pe, "malloc(rflux) failed\n"); }  
# 472
nextra = 1; 
# 474
...
for (ia = 0; ia < 3; ia++) { 
# 482
(rflux[reverse_addr_rank1_assert(482, "phi_cahn_hilliard.c", nsites, 3, index0, ia)]) = (var * (reap[ia])); 
# 483
}  
# 485
}  
...
# 500
(((pch->flux)->fw)[reverse_addr_rank0_assert(500, "phi_cahn_hilliard.c", nsites, index0)]) += ((0.5) * ((rflux[reverse_addr_rank1_assert(501, "phi_cahn_hilliard.c", nsites, 3, index0, X)]) + (rflux[reverse_addr_rank1_assert(502, "phi_cahn_hilliard.c", nsites, 3, index1, X)]))); 
# 504
index1 = lees_edw_index(pch->le, ic + 1, jc, kc); 
# 505
(((pch->flux)->fe)[reverse_addr_rank0_assert(505, "phi_cahn_hilliard.c", nsites, index0)]) += ((0.5) * ((rflux[reverse_addr_rank1_assert(506, "phi_cahn_hilliard.c", nsites, 3, index0, X)]) + (rflux[reverse_addr_rank1_assert(507, "phi_cahn_hilliard.c", nsites, 3, index1, X)]))); 
# 511
index1 = lees_edw_index(pch->le, ic, jc + 1, kc); 
# 512
(((pch->flux)->fy)[reverse_addr_rank0_assert(512, "phi_cahn_hilliard.c", nsites, index0)]) += ((0.5) * ((rflux[reverse_addr_rank1_assert(513, "phi_cahn_hilliard.c", nsites, 3, index0, Y)]) + (rflux[reverse_addr_rank1_assert(514, "phi_cahn_hilliard.c", nsites, 3, index1, Y)]))); 
# 518
index1 = lees_edw_index(pch->le, ic, jc, kc + 1); 
# 519
(((pch->flux)->fz)[reverse_addr_rank0_assert(519, "phi_cahn_hilliard.c", nsites, index0)]) += ((0.5) * ((rflux[reverse_addr_rank1_assert(520, "phi_cahn_hilliard.c", nsites, 3, index0, Z)]) + (rflux[reverse_addr_rank1_assert(521, "phi_cahn_hilliard.c", nsites, 3, index1, Z)]))); 
# 522
}  
# 523
}  
...
double *buffere; 
# 566
(pch) ? static_cast< void>(0) : __assert_fail("pch", "phi_cahn_hilliard.c", 566, __PRETTY_FUNCTION__); 
# 567
(pch->le) ? static_cast< void>(0) : __assert_fail("pch->le", "phi_cahn_hilliard.c", 567, __PRETTY_FUNCTION__); 
# 569
...
# 584
(buffere && bufferw) ? static_cast< void>(0) : __assert_fail("buffere && bufferw", "phi_cahn_hilliard.c", 584, __PRETTY_FUNCTION__); 
# 585
if (buffere == (__null)) { pe_fatal(pch->pe, "malloc(buffere) failed\n"); }  
# 586
if (bufferw == (__null)) { pe_fatal(pch->pe, "malloc(bufferw) failed\n"); }  
# 588
...
# 611
(bufferw[index]) = (((((pch->flux)->fw)[reverse_addr_rank1_assert(612, "phi_cahn_hilliard.c", (pch->flux)->nsite, nf, index1, n)]) * fr) + ((((pch->flux)->fw)[reverse_addr_rank1_assert(613, "phi_cahn_hilliard.c", (pch->flux)->nsite, nf, index2, n)]) * ((1.0) - fr))); 
# 614
}  
# 615
}  
...
# 637
(buffere[index]) = (((((pch->flux)->fe)[reverse_addr_rank1_assert(638, "phi_cahn_hilliard.c", (pch->flux)->nsite, nf, index1, n)]) * fr) + ((((pch->flux)->fe)[reverse_addr_rank1_assert(639, "phi_cahn_hilliard.c", (pch->flux)->nsite, nf, index2, n)]) * ((1.0) - fr))); 
# 640
}  
# 641
}  
...
# 651
index = reverse_addr_rank1_assert(651, "phi_cahn_hilliard.c", (pch->flux)->nsite, nf, lees_edw_index(pch->le, ic, jc, kc), n); 
# 652
(((pch->flux)->fe)[index]) = ((0.5) * ((((pch->flux)->fe)[index]) + (bufferw[index1]))); 
# 653
index = reverse_addr_rank1_assert(653, "phi_cahn_hilliard.c", (pch->flux)->nsite, nf, lees_edw_index(pch->le, ic + 1, jc, kc), n); 
# 654
...
MPI_Status status[4]; 
# 713
(pch) ? static_cast< void>(0) : __assert_fail("pch", "phi_cahn_hilliard.c", 713, __PRETTY_FUNCTION__); 
# 714
(pch->le) ? static_cast< void>(0) : __assert_fail("pch->le", "phi_cahn_hilliard.c", 714, __PRETTY_FUNCTION__); 
# 716
lees_edw_nhalo(pch->le, &nhalo); 
# 717
lees_edw_nlocal(pch->le, nlocal); 
...
# 732
if (sbufe == (__null)) { pe_fatal(pch->pe, "malloc(sbufe) failed\n"); }  
# 733
if (sbufw == (__null)) { pe_fatal(pch->pe, "malloc(sbufw) failed\n"); }  
# 735
rbufe = ((double *)malloc(nrecv * sizeof(double))); 
# 736
rbufw = ((double *)malloc(nrecv * sizeof(double))); 
# 738
if (rbufe == (__null)) { pe_fatal(pch->pe, "malloc(rbufe) failed\n"); }  
# 739
if (rbufw == (__null)) { pe_fatal(pch->pe, "malloc(rbufw) failed\n"); }  
# 743
for (ip = 0; ip < lees_edw_nplane_local(pch->le); ip++) { 
# 745
ic = lees_edw_plane_location(pch->le, ip); 
...
# 759
(j1 > 0) ? static_cast< void>(0) : __assert_fail("j1 > 0", "phi_cahn_hilliard.c", 759, __PRETTY_FUNCTION__); 
# 760
(j1 <= (ntotal[Y])) ? static_cast< void>(0) : __assert_fail("j1 <= ntotal[Y]", "phi_cahn_hilliard.c", 760, __PRETTY_FUNCTION__); 
# 762
lees_edw_jstart_to_mpi_ranks(pch->le, j1, nrank_s, nrank_r); 
# 768
j2 = (1 + ((j1 - 1) % (nlocal[Y]))); 
# 769
(j2 > 0) ? static_cast< void>(0) : __assert_fail("j2 > 0", "phi_cahn_hilliard.c", 769, __PRETTY_FUNCTION__); 
# 770
(j2 <= (nlocal[Y])) ? static_cast< void>(0) : __assert_fail("j2 <= nlocal[Y]", "phi_cahn_hilliard.c", 770, __PRETTY_FUNCTION__); 
# 772
...
# 788
((j1 >= 0) && (j1 < nsend)) ? static_cast< void>(0) : __assert_fail("j1 >= 0 && j1 < nsend", "phi_cahn_hilliard.c", 788, __PRETTY_FUNCTION__); 
# 789
(sbufw[j1]) = (((pch->flux)->fw)[reverse_addr_rank1_assert(789, "phi_cahn_hilliard.c", (pch->flux)->nsite, nf, index, n)]); 
# 790
}  
# 791
}  
...
# 834
((j1 >= 0) && (jc < nsend)) ? static_cast< void>(0) : __assert_fail("j1 >= 0 && jc < nsend", "phi_cahn_hilliard.c", 834, __PRETTY_FUNCTION__); 
# 835
(sbufe[j1]) = (((pch->flux)->fe)[reverse_addr_rank1_assert(835, "phi_cahn_hilliard.c", (pch->flux)->nsite, nf, index, n)]); 
# 836
}  
# 837
}  
...
index = lees_edw_index(pch->le, ic, jc, kc); 
# 856
(((pch->flux)->fe)[reverse_addr_rank1_assert(856, "phi_cahn_hilliard.c", (pch->flux)->nsite, nf, index, n)]) = ((0.5) * (((((pch->flux)->fe)[reverse_addr_rank1_assert(857, "phi_cahn_hilliard.c", (pch->flux)->nsite, nf, index, n)]) + (frw * (rbufw[(nf * (((j1 + kc) + nhalo) - 1)) + n]))) + (((1.0) - frw) * (rbufw[(nf * (((j2 + kc) + nhalo) - 1)) + n])))); 
# 860
index = lees_edw_index(pch->le, ic + 1, jc, kc); 
# 861
(((pch->flux)->fw)[reverse_addr_rank1_assert(861, "phi_cahn_hilliard.c", (pch->flux)->nsite, nf, index, n)]) = ((0.5) * (((((pch->flux)->fw)[reverse_addr_rank1_assert(862, "phi_cahn_hilliard.c", (pch->flux)->nsite, nf, index, n)]) + (fre * (rbufe[(nf * (((j1 + kc) + nhalo) - 1)) + n]))) + (((1.0) - fre) * (rbufe[(nf * (((j2 + kc) + nhalo) - 1)) + n])))); 
# 865
}  
# 866
}  
...
kernel_ctxt_launch_param(ctxt, &nblk, &ntpb); 
# 921
do { (__cudaPushCallConfiguration(nblk, ntpb, 0, 0)) ? (void)0 : phi_ch_ufs_kernel(ctxt->target, le, phif->target, (pch->flux)->target, ys, wz); } while (0); 
# 922
; 
# 924
{ tdpErrorHandler(tdpPeekAtLastError(), "phi_cahn_hilliard.c", 924, 1); } ; 
# 925
{ tdpErrorHandler(tdpDeviceSynchronize(), "phi_cahn_hilliard.c", 925, 1); } ; 
# 927
kernel_ctxt_free(ctxt); 
# 929
return 0; 
...
void phi_ch_ufs_kernel(kernel_ctxt_t *ktx, lees_edw_t *le, field_t *
# 943
field, advflux_t *flux, int 
# 944
ys, double wz) ;
#if 0
# 944
...
double phi; 
# 950
(ktx) ? static_cast< void>(0) : __assert_fail("ktx", "phi_cahn_hilliard.c", 950, __PRETTY_FUNCTION__); 
# 951
(le) ? static_cast< void>(0) : __assert_fail("le", "phi_cahn_hilliard.c", 951, __PRETTY_FUNCTION__); 
# 952
(field) ? static_cast< void>(0) : __assert_fail("field", "phi_cahn_hilliard.c", 952, __PRETTY_FUNCTION__); 
# 953
(flux) ? static_cast< void>(0) : __assert_fail("flux", "phi_cahn_hilliard.c", 953, __PRETTY_FUNCTION__); 
# 955
kiterations = kernel_iterations(ktx); 
# 957
kindex = ((1) * (((__device_builtin_variable_blockIdx.x) * (__device_builtin_variable_blockDim.x)) + (__device_builtin_variable_threadIdx.x))); if (kindex < kiterations) { 
...
# 966
phi -= ((((((+((flux->fe)[reverse_addr_rank0_assert(966, "phi_cahn_hilliard.c", flux->nsite, index)])) - ((flux->fw)[reverse_addr_rank0_assert(967, "phi_cahn_hilliard.c", flux->nsite, index)])) + ((flux->fy)[reverse_addr_rank0_assert(968, "phi_cahn_hilliard.c", flux->nsite, index)])) - ((flux->fy)[reverse_addr_rank0_assert(969, "phi_cahn_hilliard.c", flux->nsite, index - ys)])) + (wz * ((flux->fz)[reverse_addr_rank0_assert(970, "phi_cahn_hilliard.c", flux->nsite, index)]))) - (wz * ((flux->fz)[reverse_addr_rank0_assert(971, "phi_cahn_hilliard.c", flux->nsite, index - 1)]))); 
# 973
...
kernel_ctxt_t *ctxt = (__null); 
# 998
(pch) ? static_cast< void>(0) : __assert_fail("pch", "phi_cahn_hilliard.c", 998, __PRETTY_FUNCTION__); 
# 1000
lees_edw_nlocal(pch->le, nlocal); 
# 1001
lees_edw_target(pch->le, &letarget); 
...
kernel_ctxt_launch_param(ctxt, &nblk, &ntpb); 
# 1014
do { (__cudaPushCallConfiguration(nblk, ntpb, 0, 0)) ? (void)0 : phi_ch_flux_mu_ext_kernel(ctxt->target, letarget, (pch->flux)->target, ch); } while (0); 
# 1015
; 
# 1016
{ tdpErrorHandler(tdpPeekAtLastError(), "phi_cahn_hilliard.c", 1016, 1); } ; 
# 1017
{ tdpErrorHandler(tdpDeviceSynchronize(), "phi_cahn_hilliard.c", 1017, 1); } ; 
# 1019
kernel_ctxt_free(ctxt); 
# 1021
return 0; 
...
void phi_ch_flux_mu_ext_kernel(kernel_ctxt_t *ktx, lees_edw_t *
# 1034
le, advflux_t *
# 1035
flux, ch_kernel_t 
...
__attribute__((unused)) int kiterations; 
# 1040
(ktx) ? static_cast< void>(0) : __assert_fail("ktx", "phi_cahn_hilliard.c", 1040, __PRETTY_FUNCTION__); 
# 1041
(le) ? static_cast< void>(0) : __assert_fail("le", "phi_cahn_hilliard.c", 1041, __PRETTY_FUNCTION__); 
# 1042
(flux) ? static_cast< void>(0) : __assert_fail("flux", "phi_cahn_hilliard.c", 1042, __PRETTY_FUNCTION__); 
# 1044
kiterations = kernel_iterations(ktx); 
# 1046
kindex = ((1) * (((__device_builtin_variable_blockIdx.x) * (__device_builtin_variable_blockDim.x)) + (__device_builtin_variable_threadIdx.x))); if (kindex < kiterations) { 
...
index0 = lees_edw_index(le, ic, jc, kc); 
# 1057
((flux->fw)[reverse_addr_rank0_assert(1057, "phi_cahn_hilliard.c", flux->nsite, index0)]) -= ((ch.mobility) * ((ch.gradmu_ex)[X])); 
# 1058
((flux->fe)[reverse_addr_rank0_assert(1058, "phi_cahn_hilliard.c", flux->nsite, index0)]) -= ((ch.mobility) * ((ch.gradmu_ex)[X])); 
# 1059
((flux->fy)[reverse_addr_rank0_assert(1059, "phi_cahn_hilliard.c", flux->nsite, index0)]) -= ((ch.mobility) * ((ch.gradmu_ex)[Y])); 
# 1060
((flux->fz)[reverse_addr_rank0_assert(1060, "phi_cahn_hilliard.c", flux->nsite, index0)]) -= ((ch.mobility) * ((ch.gradmu_ex)[Z])); 
# 1061
}  
# 1064
} 
...
# 1 "phi_cahn_hilliard.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__25_phi_cahn_hilliard_cpp1_ii_4b04a589
# 1 "phi_cahn_hilliard.cudafe1.stub.c"
#include "phi_cahn_hilliard.cudafe1.stub.c"
# 1 "phi_cahn_hilliard.cudafe1.stub.c"
