...
# 29
static void test_model_velocity_set(); 
# 31
...
# 62
if (((DATA_MODEL_SOA) == (DATA_MODEL_AOS)) && (1 == 1)) { 
# 63
...
p = ((xdisp_fwd_cv[i]) + k); 
# 90
test_assert_info((p >= 0) && (p < (NVEL)), 90, "test_model.c"); 
# 91
test_assert_info(((cv[p])[X]) == (+1), 91, "test_model.c"); 
# 92
p = ((xdisp_bwd_cv[i]) + k); 
# 93
test_assert_info((p >= 0) && (p < (NVEL)), 93, "test_model.c"); 
# 94
test_assert_info(((cv[p])[X]) == (-1), 94, "test_model.c"); 
# 95
}  
# 96
}  
...
p = ((ydisp_fwd_cv[i]) + k); 
# 101
test_assert_info((p >= 0) && (p < (NVEL)), 101, "test_model.c"); 
# 102
test_assert_info(((cv[p])[Y]) == (+1), 102, "test_model.c"); 
# 103
p = ((ydisp_bwd_cv[i]) + k); 
# 104
test_assert_info((p >= 0) && (p < (NVEL)), 104, "test_model.c"); 
# 105
test_assert_info(((cv[p])[Y]) == (-1), 105, "test_model.c"); 
# 106
}  
# 107
}  
...
p = ((zdisp_fwd_cv[i]) + k); 
# 112
test_assert_info((p >= 0) && (p < (NVEL)), 112, "test_model.c"); 
# 113
test_assert_info(((cv[p])[Z]) == (+1), 113, "test_model.c"); 
# 114
p = ((zdisp_bwd_cv[i]) + k); 
# 115
test_assert_info((p >= 0) && (p < (NVEL)), 115, "test_model.c"); 
# 116
test_assert_info(((cv[p])[Z]) == (-1), 116, "test_model.c"); 
# 117
}  
# 118
}  
...
# 149 "test_model.c"
test_assert_info((NHYDRO) == ((1 + (NDIM)) + (((NDIM) * ((NDIM) + 1)) / 2)), 149, "test_model.c"); 
# 154
test_assert_info(fabs(rcs2 - (3.0)) < (9.999999999999999988e-15), 154, "test_model.c"); 
# 160
for (i = 0; i < (NDIM); i++) { 
# 161
for (j = 0; j < (NDIM); j++) { 
...
if (i == j) { 
# 163
test_assert_info(fabs(((d_[i])[j]) - (1.0)) < (9.999999999999999988e-15), 163, "test_model.c"); 
# 164
} else 
# 165
{ 
# 166
test_assert_info(fabs(((d_[i])[j]) - (0.0)) < (9.999999999999999988e-15), 166, "test_model.c"); 
# 167
}  
# 168
}  
...
# 173
test_assert_info(((cv[0])[X]) == 0, 173, "test_model.c"); 
# 174
test_assert_info(((cv[0])[Y]) == 0, 174, "test_model.c"); 
# 175
test_assert_info(((cv[0])[Z]) == 0, 175, "test_model.c"); 
# 179
for (p = 1; p < (NVEL); p++) { 
# 180
test_assert_info(((cv[p])[X]) == (-((cv[(NVEL) - p])[X])), 180, "test_model.c"); 
# 181
test_assert_info(((cv[p])[Y]) == (-((cv[(NVEL) - p])[Y])), 181, "test_model.c"); 
# 182
test_assert_info(((cv[p])[Z]) == (-((cv[(NVEL) - p])[Z])), 182, "test_model.c"); 
# 183
}  
# 189
...
# 198
test_assert_info(fabs(sum - (1.0)) < (9.999999999999999988e-15), 198, "test_model.c"); 
# 200
test_assert_info(fabs(sumx) < (9.999999999999999988e-15), 200, "test_model.c"); 
# 202
test_assert_info(fabs(sumy) < (9.999999999999999988e-15), 202, "test_model.c"); 
# 204
test_assert_info(fabs(sumz) < (9.999999999999999988e-15), 204, "test_model.c"); 
# 210
for (i = 0; i < (NDIM); i++) { 
# 211
for (j = 0; j < (NDIM); j++) { 
...
# 216
test_assert_info(fabs(sum - (((d_[i])[j]) / rcs2)) < (9.999999999999999988e-15), 216, "test_model.c"); 
# 217
}  
# 218
}  
...
# 226
test_assert_info(fabs(sum - (((q_[p])[i])[j])) < (9.999999999999999988e-15), 226, "test_model.c"); 
# 227
}  
# 228
}  
...
# 239
test_assert_info(fabs(sum - (0.0)) < (9.999999999999999988e-15), 239, "test_model.c"); 
# 240
}  
# 241
}  
...
# 252
test_assert_info(fabs(sum - (0.0)) < (9.999999999999999988e-15), 252, "test_model.c"); 
# 253
}  
# 254
}  
...
for (p = 0; p < (NVEL); p++) { 
# 274
test_assert_info(fabs(((ma_[0])[p]) - (1.0)) < (9.999999999999999988e-15), 274, "test_model.c"); 
# 275
for (i = 0; i < (NDIM); i++) { 
# 276
test_assert_info(fabs(((ma_[1 + i])[p]) - ((cv[p])[i])) < (9.999999999999999988e-15), 276, "test_model.c"); 
# 277
}  
# 278
}  
...
for (j = i; j < (NDIM); j++) { 
# 286
test_assert_info(fabs(((ma_[(1 + (NDIM)) + (k++)])[p]) - (((q_[p])[i])[j])) < (9.999999999999999988e-15), 287, "test_model.c"); 
# 288 "test_model.c"
}  
# 289
}  
...
# 301
test_assert_info(fabs(sum - dij) < (9.999999999999999988e-15), 301, "test_model.c"); 
# 302
}  
# 303
}  
...
# 314
test_assert_info(fabs(sum - dij) < (9.999999999999999988e-15), 314, "test_model.c"); 
# 315
}  
# 316
}  
...
lb_t *lb; 
# 339
(pe) ? static_cast< void>(0) : __assert_fail("pe", "test_model.c", 339, __PRETTY_FUNCTION__); 
# 340
(cs) ? static_cast< void>(0) : __assert_fail("cs", "test_model.c", 340, __PRETTY_FUNCTION__); 
# 344
lb_create(pe, cs, &lb); 
# 345
(lb) ? static_cast< void>(0) : __assert_fail("lb", "test_model.c", 345, __PRETTY_FUNCTION__); 
# 346
lb_ndist(lb, &n); 
# 347
(n == 1) ? static_cast< void>(0) : __assert_fail("n == 1", "test_model.c", 347, __PRETTY_FUNCTION__); 
# 349
...
lb_ndist(lb, &n); 
# 355
(n == ndist) ? static_cast< void>(0) : __assert_fail("n == ndist", "test_model.c", 355, __PRETTY_FUNCTION__); 
# 357
for (n = 0; n < ndist; n++) { 
# 358
for (p = 0; p < (NVEL); p++) { 
# 359
fvalue_expected = (((0.01000000000000000021) * n) + (wv[p])); 
# 360
lb_f_set(lb, index, p, n, fvalue_expected); 
# 361
lb_f(lb, index, p, n, &fvalue); 
# 362
(fabs(fvalue - fvalue_expected) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(fvalue - fvalue_expected) < double(2.22044604925031308085e-16L)", "test_model.c", 362, __PRETTY_FUNCTION__); 
# 363
}  
# 367
fvalue_expected = ((((0.01000000000000000021) * n) * (NVEL)) + (1.0)); 
# 368
lb_0th_moment(lb, index, (lb_dist_enum_t)n, &fvalue); 
# 369
(fabs(fvalue - fvalue_expected) <= ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(fvalue - fvalue_expected) <= double(2.22044604925031308085e-16L)", "test_model.c", 369, __PRETTY_FUNCTION__); 
# 373
lb_1st_moment(lb, index, (n == 0) ? LB_RHO : LB_PHI, u); 
# 375
for (i = 0; i < (NDIM); i++) { 
# 376
(fabs((u[i]) - (0.0)) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(u[i] - 0.0) < double(2.22044604925031308085e-16L)", "test_model.c", 376, __PRETTY_FUNCTION__); 
# 377
}  
# 378
}  
...
lb_t *lb = (__null); 
# 404
(pe) ? static_cast< void>(0) : __assert_fail("pe", "test_model.c", 404, __PRETTY_FUNCTION__); 
# 405
(cs) ? static_cast< void>(0) : __assert_fail("cs", "test_model.c", 405, __PRETTY_FUNCTION__); 
# 407
lb_create(pe, cs, &lb); 
# 408
(lb) ? static_cast< void>(0) : __assert_fail("lb", "test_model.c", 408, __PRETTY_FUNCTION__); 
# 409
lb_ndist_set(lb, ndist); 
# 410
lb_init(lb); 
...
lb_halo(lb); 
# 442
lb_memcpy(lb, hipMemcpyDeviceToHost); 
# 446
...
# 459
test_assert_info(fabs(f_actual - f_expect) < ((double)(2.2204460492503130808e-16L)), 459, "test_model.c"); 
# 461
f_expect = ((1.0) * (abs(j - (nlocal[Y])))); 
# 462
lb_f(lb, index, Y, n, &f_actual); 
# 463
test_assert_info(fabs(f_actual - f_expect) < ((double)(2.2204460492503130808e-16L)), 463, "test_model.c"); 
# 465
f_expect = ((1.0) * (abs(k - (nlocal[Z])))); 
# 466
lb_f(lb, index, Z, n, &f_actual); 
# 467
test_assert_info(fabs(f_actual - f_expect) < ((double)(2.2204460492503130808e-16L)), 467, "test_model.c"); 
# 469
for (p = 3; p < (NVEL); p++) { 
# 470
...
f_expect = ((double)p); 
# 472
test_assert_info(fabs(f_actual - f_expect) < ((double)(2.2204460492503130808e-16L)), 472, "test_model.c"); 
# 473
}  
# 474
}  
...
lb_t *lb = (__null); 
# 503
(pe) ? static_cast< void>(0) : __assert_fail("pe", "test_model.c", 503, __PRETTY_FUNCTION__); 
# 504
(cs) ? static_cast< void>(0) : __assert_fail("cs", "test_model.c", 504, __PRETTY_FUNCTION__); 
# 506
lb_create(pe, cs, &lb); 
# 507
(lb) ? static_cast< void>(0) : __assert_fail("lb", "test_model.c", 507, __PRETTY_FUNCTION__); 
# 508
lb_ndist_set(lb, ndist); 
# 509
lb_init(lb); 
...
f_expect = ((1.0) * ((n * (NVEL)) + p)); 
# 542
test_assert_info(fabs(f_expect - f_actual) < ((double)(2.2204460492503130808e-16L)), 542, "test_model.c"); 
# 543
}  
# 544
}  
...
# 573
test_assert_info(fabs(f_actual - f_expect) < ((double)(2.2204460492503130808e-16L)), 573, "test_model.c"); 
# 574
}  
# 575
}  
...
int iam = 1; 
# 601
(cs) ? static_cast< void>(0) : __assert_fail("cs", "test_model.c", 601, __PRETTY_FUNCTION__); 
# 603
cs_nlocal(cs, nlocal); 
# 605
if (ic < 1) { iam = 0; }  
...
lb_t *lbwr = (__null); 
# 627
(pe) ? static_cast< void>(0) : __assert_fail("pe", "test_model.c", 627, __PRETTY_FUNCTION__); 
# 628
(cs) ? static_cast< void>(0) : __assert_fail("cs", "test_model.c", 628, __PRETTY_FUNCTION__); 
# 630
...
# 701
test_assert_info(fabs(((ma_[10])[p]) - chi1) < (9.999999999999999988e-15), 701, "test_model.c"); 
# 702
test_assert_info(fabs(((ma_[14])[p]) - chi2) < (9.999999999999999988e-15), 702, "test_model.c"); 
# 703
test_assert_info(fabs(((ma_[18])[p]) - chi3) < (9.999999999999999988e-15), 703, "test_model.c"); 
# 705
test_assert_info(fabs(((ma_[11])[p]) - (jchi1[X])) < (9.999999999999999988e-15), 705, "test_model.c"); 
# 706
test_assert_info(fabs(((ma_[12])[p]) - (jchi1[Y])) < (9.999999999999999988e-15), 706, "test_model.c"); 
# 707
test_assert_info(fabs(((ma_[13])[p]) - (jchi1[Z])) < (9.999999999999999988e-15), 707, "test_model.c"); 
# 709
test_assert_info(fabs(((ma_[15])[p]) - (jchi2[X])) < (9.999999999999999988e-15), 709, "test_model.c"); 
# 710
test_assert_info(fabs(((ma_[16])[p]) - (jchi2[Y])) < (9.999999999999999988e-15), 710, "test_model.c"); 
# 711
test_assert_info(fabs(((ma_[17])[p]) - (jchi2[Z])) < (9.999999999999999988e-15), 711, "test_model.c"); 
# 712
}  
# 714
return 0; 
...
# 1 "test_model.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__18_test_model_cpp1_ii_d0709cd1
# 1 "test_model.cudafe1.stub.c"
#include "test_model.cudafe1.stub.c"
# 1 "test_model.cudafe1.stub.c"
