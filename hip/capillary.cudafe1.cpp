...
# 69
int obstacle_length = 6; 
# 70
int obstacle_height = 10; 
# 71
int obstacle_depth = 6; 
# 77
const double sigma = (0.125); 
# 84
const double kappa = (0.0529999999999999985); 
# 85
...
# 346
printf("Obstacle %d x-position %d to %d, y-position %d to %d, z-position %d to %d\n", iobst, (obst_start[iobst])[0], (obst_stop[iobst])[0], (obst_start[iobst])[1], (obst_stop[iobst])[1], (obst_start[iobst])[2], (obst_stop[iobst])[2]); 
# 348
}  
# 351
...
# 397
if ((j >= ((obst_start[iobst])[1])) && (j <= ((obst_stop[iobst])[1])) && (k >= ((obst_start[iobst])[2])) && (k <= ((obst_stop[iobst])[2]))) 
# 398
{ 
# 399
(map_sig[n]) = (0.0); 
...
for (iobst = 0; iobst < obstacle_number; iobst++) { 
# 410
if ((i >= ((obst_start[iobst])[0])) && (i <= ((obst_stop[iobst])[0])) && (j >= ((obst_start[iobst])[1])) && (j <= ((obst_stop[iobst])[1])) && (k >= ((obst_start[iobst])[2])) && (k <= ((obst_stop[iobst])[2]))) 
# 412
{ 
# 414
(map_in[n]) = (MAP_BOUNDARY); 
...
# 576
printf("n = %d nsolid = %d nfluid = %d\n", (xmax * ymax) * zmax, nsolid, ((xmax * ymax) * zmax) - nsolid); 
# 581
...
# 669
(nread == 1) ? static_cast< void>(0) : __assert_fail("nread == 1", "capillary.c", 669, __PRETTY_FUNCTION__); 
# 670
}  
# 671
}  
...
int ns; 
# 755
(map_in) ? static_cast< void>(0) : __assert_fail("map_in", "capillary.c", 755, __PRETTY_FUNCTION__); 
# 756
(nsolid) ? static_cast< void>(0) : __assert_fail("nsolid", "capillary.c", 756, __PRETTY_FUNCTION__); 
# 763
...
# 768
(ymax % 2) ? static_cast< void>(0) : __assert_fail("ymax % 2", "capillary.c", 768, __PRETTY_FUNCTION__); 
# 769
(w % 2) ? static_cast< void>(0) : __assert_fail("w % 2", "capillary.c", 769, __PRETTY_FUNCTION__); 
# 773
for (ic = 1; ic <= xmax; ic++) { 
# 774
for (jc = 1; jc <= ymax; jc++) { 
...
# 1 "capillary.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__17_capillary_cpp1_ii_f7bd6991
# 1 "capillary.cudafe1.stub.c"
#include "capillary.cudafe1.stub.c"
# 1 "capillary.cudafe1.stub.c"
