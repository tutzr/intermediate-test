...
# 38 "stats_free_energy.c"
int stats_free_energy_density(pe_t *pe, cs_t *cs, wall_t *wall, fe_t *fe, map_t *
# 39
map, colloids_info_t *
# 40
cinfo) { 
...
MPI_Comm comm; 
# 58
(pe) ? static_cast< void>(0) : __assert_fail("pe", "stats_free_energy.c", 58, __PRETTY_FUNCTION__); 
# 59
(cs) ? static_cast< void>(0) : __assert_fail("cs", "stats_free_energy.c", 59, __PRETTY_FUNCTION__); 
# 60
(map) ? static_cast< void>(0) : __assert_fail("map", "stats_free_energy.c", 60, __PRETTY_FUNCTION__); 
# 62
if (fe == (__null)) { return 0; }  
# 64
pe_mpi_comm(pe, &comm); 
# 66
cs_ltot(cs, ltot); 
...
# 104
pe_info(pe, "[fe] %14d %17.10e %17.10e %17.10e %17.10e %17.10e\n", ntstep, fe_total[1], fe_total[2], (fe_total[1]) / (fe_total[2]), fe_total[3], fe_total[4]); 
# 107
} else { 
# 108
if (ncolloid > 0) { 
...
if ((fe_total[4]) > (0.0)) { 
# 116
pe_info(pe, "[fe] %14d %17.10e %17.10e %17.10e %17.10e %17.10e %17.10e\n", ntstep, fe_total[1], fe_total[2], (fe_total[1]) / (fe_total[2]), fe_total[3], fe_total[4], (fe_total[3]) / (fe_total[4])); 
# 119
} else 
# 120
{ 
# 121
pe_info(pe, "[fe] %14d %17.10e %17.10e %17.10e %17.10e\n", ntstep, fe_total[1], fe_total[2], (fe_total[1]) / (fe_total[2]), fe_total[3]); 
# 124
}  
# 125
} else 
...
# 131
pe_info(pe, "[fed] %14d %17.10e %17.10e\n", ntstep, rv * (fe_total[0]), (fe_total[1]) / (fe_total[2])); 
# 133
}  }  
# 137
return 0; 
...
# 1 "stats_free_energy.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__25_stats_free_energy_cpp1_ii_922142a4
# 1 "stats_free_energy.cudafe1.stub.c"
#include "stats_free_energy.cudafe1.stub.c"
# 1 "stats_free_energy.cudafe1.stub.c"
