...
# 29 "leslie_ericksen.c"
static double Gamma_; 
# 30
static double swim_ = (0.0); 
# 32
static int leslie_ericksen_update_fluid(fe_polar_t * fe, field_t * p, hydro_t * hydro, advflux_t * flux); 
# 35
static int leslie_ericksen_add_swimming_velocity(field_t * p, hydro_t * hydro); 
# 44
int leslie_ericksen_gamma_set(const double gamma) { 
# 46
Gamma_ = gamma; 
...
# 74 "leslie_ericksen.c"
int leslie_ericksen_update(cs_t *cs, fe_polar_t *fe, field_t *p, hydro_t *
# 75
hydro) { 
# 77
int nf; 
# 78
advflux_t *flux = (__null); 
# 80
(cs) ? static_cast< void>(0) : __assert_fail("cs", "leslie_ericksen.c", 80, __PRETTY_FUNCTION__); 
# 81
(p) ? static_cast< void>(0) : __assert_fail("p", "leslie_ericksen.c", 81, __PRETTY_FUNCTION__); 
# 83
field_nf(p, &nf); 
# 84
(nf == 3) ? static_cast< void>(0) : __assert_fail("nf == 3", "leslie_ericksen.c", 84, __PRETTY_FUNCTION__); 
# 85
...
# 109 "leslie_ericksen.c"
static int leslie_ericksen_update_fluid(fe_polar_t *fe, field_t *
# 110
fp, hydro_t *
# 111
hydro, advflux_t *
...
const double dt = (1.0); 
# 127
(fe) ? static_cast< void>(0) : __assert_fail("fe", "leslie_ericksen.c", 127, __PRETTY_FUNCTION__); 
# 128
(fp) ? static_cast< void>(0) : __assert_fail("fp", "leslie_ericksen.c", 128, __PRETTY_FUNCTION__); 
# 129
(flux) ? static_cast< void>(0) : __assert_fail("flux", "leslie_ericksen.c", 129, __PRETTY_FUNCTION__); 
# 131
...
# 173
(p[ia]) += (dt * ((((((((-((flux->fe)[reverse_addr_rank1_assert(173, "leslie_ericksen.c", flux->nsite, 3, index, ia)])) + ((flux->fw)[reverse_addr_rank1_assert(174, "leslie_ericksen.c", flux->nsite, 3, index, ia)])) - ((flux->fy)[reverse_addr_rank1_assert(175, "leslie_ericksen.c", flux->nsite, 3, index, ia)])) + ((flux->fy)[reverse_addr_rank1_assert(176, "leslie_ericksen.c", flux->nsite, 3, indexj, ia)])) - ((flux->fz)[reverse_addr_rank1_assert(177, "leslie_ericksen.c", flux->nsite, 3, index, ia)])) + ((flux->fz)[reverse_addr_rank1_assert(178, "leslie_ericksen.c", flux->nsite, 3, indexk, ia)])) + sum) + (Gamma_ * (h[ia])))); 
# 180
}  
# 182
...
# 198
static int leslie_ericksen_add_swimming_velocity(field_t *fp, hydro_t *
# 199
hydro) { 
# 200
int ic, jc, kc, index; 
...
double u[3]; 
# 207
(fp) ? static_cast< void>(0) : __assert_fail("fp", "leslie_ericksen.c", 207, __PRETTY_FUNCTION__); 
# 208
(hydro) ? static_cast< void>(0) : __assert_fail("hydro", "leslie_ericksen.c", 208, __PRETTY_FUNCTION__); 
# 210
...
# 1 "leslie_ericksen.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__23_leslie_ericksen_cpp1_ii_b22fa2ec
# 1 "leslie_ericksen.cudafe1.stub.c"
#include "leslie_ericksen.cudafe1.stub.c"
# 1 "leslie_ericksen.cudafe1.stub.c"
