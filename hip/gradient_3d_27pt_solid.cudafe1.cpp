...
# 52
static solid_s static_solid = {(0)}; 
# 57
static int bs_cv[27][3]; 
# 69
void grad_3d_27pt_solid_kernel(kernel_ctxt_t * ktx, field_grad_t * fg, map_t * map, double rkappa); 
# 80
int grad_3d_27pt_solid_map_set(map_t *map) { 
# 82
int ndata; 
# 83
(map) ? static_cast< void>(0) : __assert_fail("map", "gradient_3d_27pt_solid.c", 83, __PRETTY_FUNCTION__); 
# 85
...
int grad_3d_27pt_solid_fe_set(fe_symm_t *fe) { 
# 104
(fe) ? static_cast< void>(0) : __assert_fail("fe", "gradient_3d_27pt_solid.c", 104, __PRETTY_FUNCTION__); 
# 106
...
# 117
int grad_3d_27pt_solid_d2(field_grad_t *fgrad) { 
# 119
int nextra; 
# 120
int nlocal[3]; 
...
# 131
(nextra >= 0) ? static_cast< void>(0) : __assert_fail("nextra >= 0", "gradient_3d_27pt_solid.c", 131, __PRETTY_FUNCTION__); 
# 132
(static_solid.map) ? static_cast< void>(0) : __assert_fail("static_solid.map", "gradient_3d_27pt_solid.c", 132, __PRETTY_FUNCTION__); 
# 133
(static_solid.fe_symm) ? static_cast< void>(0) : __assert_fail("static_solid.fe_symm", "gradient_3d_27pt_solid.c", 133, __PRETTY_FUNCTION__); 
# 135
...
# 142
kernel_ctxt_create((fgrad->field)->cs, 1, limits, &ctxt); 
# 143
kernel_ctxt_launch_param(ctxt, &nblk, &ntpb); 
# 145
do { (__cudaPushCallConfiguration(nblk, ntpb, 0, 0)) ? (void)0 : grad_3d_27pt_solid_kernel(ctxt->target, fgrad->target, (static_solid.map)->target, rkappa); } while (0); 
# 147
; 
# 148
...
void grad_3d_27pt_solid_kernel(kernel_ctxt_t *ktx, field_grad_t *
# 165
fg, map_t *
# 166
map, double 
...
# 231
dphi = (((phi->data)[reverse_addr_rank1_assert(232, "gradient_3d_27pt_solid.c", phi->nsites, nop, isite[p], n)]) - ((phi->data)[reverse_addr_rank1_assert(233, "gradient_3d_27pt_solid.c", phi->nsites, nop, index, n)])); 
# 234
(gradt[p]) = dphi; 
# 236
for (ia = 0; ia < 3; ia++) { 
...
if ((isite[p]) == (-1)) { 
# 251
phi_b = (((phi->data)[reverse_addr_rank1_assert(251, "gradient_3d_27pt_solid.c", phi->nsites, nop, index, n)]) + ((0.5) * (((((bs_cv[p])[X]) * (gradn[X])) + (((bs_cv[p])[Y]) * (gradn[Y]))) + (((bs_cv[p])[Z]) * (gradn[Z]))))); 
# 257
ia = kernel_coords_index(ktx, ic + ((bs_cv[p])[X]), jc + ((bs_cv[p])[Y]), kc + ((bs_cv[p])[Z])); 
# 259
map_data(map, ia, wet); 
# 260
c = (wet[0]); 
...
# 286
((fg->delsq)[reverse_addr_rank1_assert(286, "gradient_3d_27pt_solid.c", phi->nsites, nop, index, n)]) = (r9 * dphi); 
# 287
for (ia = 0; ia < 3; ia++) { 
# 288
((fg->grad)[reverse_addr_rank2_assert(288, "gradient_3d_27pt_solid.c", phi->nsites, nop, 3, index, n, ia)]) = (r18 * (gradn[ia])); 
# 289
}  
# 290
}  
...
#endif
# 305 "gradient_3d_27pt_solid.c"
int grad_3d_27pt_solid_dab(field_grad_t *df) { 
# 307
int nlocal[3]; 
# 308
int nhalo; 
...
# 321
(df) ? static_cast< void>(0) : __assert_fail("df", "gradient_3d_27pt_solid.c", 321, __PRETTY_FUNCTION__); 
# 322
(cs) ? static_cast< void>(0) : __assert_fail("cs", "gradient_3d_27pt_solid.c", 322, __PRETTY_FUNCTION__); 
# 324
cs_nhalo(cs, &nhalo); 
# 325
cs_nlocal(cs, nlocal); 
...
nextra = (nhalo - 1); 
# 330
(nextra >= 0) ? static_cast< void>(0) : __assert_fail("nextra >= 0", "gradient_3d_27pt_solid.c", 330, __PRETTY_FUNCTION__); 
# 332
field = ((df->field)->data); 
# 333
dab = (df->d_ab); 
...
# 341
(dab[reverse_addr_rank1_assert(341, "gradient_3d_27pt_solid.c", nsites, 6, index, XX)]) = ((0.2000000000000000111) * ((((((((((((((((+(1.0)) * (field[reverse_addr_rank0_assert(342, "gradient_3d_27pt_solid.c", nsites, index + xs)])) + ((1.0) * (field[reverse_addr_rank0_assert(343, "gradient_3d_27pt_solid.c", nsites, index - xs)]))) - ((2.0) * (field[reverse_addr_rank0_assert(344, "gradient_3d_27pt_solid.c", nsites, index)]))) + ((1.0) * (field[reverse_addr_rank0_assert(345, "gradient_3d_27pt_solid.c", nsites, (index + xs) + ys)]))) + ((1.0) * (field[reverse_addr_rank0_assert(346, "gradient_3d_27pt_solid.c", nsites, (index - xs) + ys)]))) - ((2.0) * (field[reverse_addr_rank0_assert(347, "gradient_3d_27pt_solid.c", nsites, index + ys)]))) + ((1.0) * (field[reverse_addr_rank0_assert(348, "gradient_3d_27pt_solid.c", nsites, (index + xs) - ys)]))) + ((1.0) * (field[reverse_addr_rank0_assert(349, "gradient_3d_27pt_solid.c", nsites, (index - xs) - ys)]))) - ((2.0) * (field[reverse_addr_rank0_assert(350, "gradient_3d_27pt_solid.c", nsites, index - ys)]))) + ((1.0) * (field[reverse_addr_rank0_assert(351, "gradient_3d_27pt_solid.c", nsites, (index + xs) + 1)]))) + ((1.0) * (field[reverse_addr_rank0_assert(352, "gradient_3d_27pt_solid.c", nsites, (index - xs) + 1)]))) - ((2.0) * (field[reverse_addr_rank0_assert(353, "gradient_3d_27pt_solid.c", nsites, index + 1)]))) + ((1.0) * (field[reverse_addr_rank0_assert(354, "gradient_3d_27pt_solid.c", nsites, (index + xs) - 1)]))) + ((1.0) * (field[reverse_addr_rank0_assert(355, "gradient_3d_27pt_solid.c", nsites, (index - xs) - 1)]))) - ((2.0) * (field[reverse_addr_rank0_assert(356, "gradient_3d_27pt_solid.c", nsites, index - 1)])))); 
# 358
(dab[reverse_addr_rank1_assert(358, "gradient_3d_27pt_solid.c", nsites, 6, index, XY)]) = (r12 * ((((((((((((+(field[reverse_addr_rank0_assert(359, "gradient_3d_27pt_solid.c", nsites, (index + xs) + ys)])) - (field[reverse_addr_rank0_assert(360, "gradient_3d_27pt_solid.c", nsites, (index + xs) - ys)])) - (field[reverse_addr_rank0_assert(361, "gradient_3d_27pt_solid.c", nsites, (index - xs) + ys)])) + (field[reverse_addr_rank0_assert(362, "gradient_3d_27pt_solid.c", nsites, (index - xs) - ys)])) + (field[reverse_addr_rank0_assert(363, "gradient_3d_27pt_solid.c", nsites, ((index + xs) + ys) + 1)])) - (field[reverse_addr_rank0_assert(364, "gradient_3d_27pt_solid.c", nsites, ((index + xs) - ys) + 1)])) - (field[reverse_addr_rank0_assert(365, "gradient_3d_27pt_solid.c", nsites, ((index - xs) + ys) + 1)])) + (field[reverse_addr_rank0_assert(366, "gradient_3d_27pt_solid.c", nsites, ((index - xs) - ys) + 1)])) + (field[reverse_addr_rank0_assert(367, "gradient_3d_27pt_solid.c", nsites, ((index + xs) + ys) - 1)])) - (field[reverse_addr_rank0_assert(368, "gradient_3d_27pt_solid.c", nsites, ((index + xs) - ys) - 1)])) - (field[reverse_addr_rank0_assert(369, "gradient_3d_27pt_solid.c", nsites, ((index - xs) + ys) - 1)])) + (field[reverse_addr_rank0_assert(370, "gradient_3d_27pt_solid.c", nsites, ((index - xs) - ys) - 1)]))); 
# 372
(dab[reverse_addr_rank1_assert(372, "gradient_3d_27pt_solid.c", nsites, 6, index, XZ)]) = (r12 * ((((((((((((+(field[reverse_addr_rank0_assert(373, "gradient_3d_27pt_solid.c", nsites, (index + xs) + 1)])) - (field[reverse_addr_rank0_assert(374, "gradient_3d_27pt_solid.c", nsites, (index + xs) - 1)])) - (field[reverse_addr_rank0_assert(375, "gradient_3d_27pt_solid.c", nsites, (index - xs) + 1)])) + (field[reverse_addr_rank0_assert(376, "gradient_3d_27pt_solid.c", nsites, (index - xs) - 1)])) + (field[reverse_addr_rank0_assert(377, "gradient_3d_27pt_solid.c", nsites, ((index + xs) + ys) + 1)])) - (field[reverse_addr_rank0_assert(378, "gradient_3d_27pt_solid.c", nsites, ((index + xs) + ys) - 1)])) - (field[reverse_addr_rank0_assert(379, "gradient_3d_27pt_solid.c", nsites, ((index - xs) + ys) + 1)])) + (field[reverse_addr_rank0_assert(380, "gradient_3d_27pt_solid.c", nsites, ((index - xs) + ys) - 1)])) + (field[reverse_addr_rank0_assert(381, "gradient_3d_27pt_solid.c", nsites, ((index + xs) - ys) + 1)])) - (field[reverse_addr_rank0_assert(382, "gradient_3d_27pt_solid.c", nsites, ((index + xs) - ys) - 1)])) - (field[reverse_addr_rank0_assert(383, "gradient_3d_27pt_solid.c", nsites, ((index - xs) - ys) + 1)])) + (field[reverse_addr_rank0_assert(384, "gradient_3d_27pt_solid.c", nsites, ((index - xs) - ys) - 1)]))); 
# 386
(dab[reverse_addr_rank1_assert(386, "gradient_3d_27pt_solid.c", nsites, 6, index, YY)]) = ((0.2000000000000000111) * ((((((((((((((((+(1.0)) * (field[reverse_addr_rank0_assert(387, "gradient_3d_27pt_solid.c", nsites, index + ys)])) + ((1.0) * (field[reverse_addr_rank0_assert(388, "gradient_3d_27pt_solid.c", nsites, index - ys)]))) - ((2.0) * (field[reverse_addr_rank0_assert(389, "gradient_3d_27pt_solid.c", nsites, index)]))) + ((1.0) * (field[reverse_addr_rank0_assert(390, "gradient_3d_27pt_solid.c", nsites, (index + xs) + ys)]))) + ((1.0) * (field[reverse_addr_rank0_assert(391, "gradient_3d_27pt_solid.c", nsites, (index + xs) - ys)]))) - ((2.0) * (field[reverse_addr_rank0_assert(392, "gradient_3d_27pt_solid.c", nsites, index + xs)]))) + ((1.0) * (field[reverse_addr_rank0_assert(393, "gradient_3d_27pt_solid.c", nsites, (index - xs) + ys)]))) + ((1.0) * (field[reverse_addr_rank0_assert(394, "gradient_3d_27pt_solid.c", nsites, (index - xs) - ys)]))) - ((2.0) * (field[reverse_addr_rank0_assert(395, "gradient_3d_27pt_solid.c", nsites, index - xs)]))) + ((1.0) * (field[reverse_addr_rank0_assert(396, "gradient_3d_27pt_solid.c", nsites, (index + 1) + ys)]))) + ((1.0) * (field[reverse_addr_rank0_assert(397, "gradient_3d_27pt_solid.c", nsites, (index + 1) - ys)]))) - ((2.0) * (field[reverse_addr_rank0_assert(398, "gradient_3d_27pt_solid.c", nsites, index + 1)]))) + ((1.0) * (field[reverse_addr_rank0_assert(399, "gradient_3d_27pt_solid.c", nsites, (index - 1) + ys)]))) + ((1.0) * (field[reverse_addr_rank0_assert(400, "gradient_3d_27pt_solid.c", nsites, (index - 1) - ys)]))) - ((2.0) * (field[reverse_addr_rank0_assert(401, "gradient_3d_27pt_solid.c", nsites, index - 1)])))); 
# 404
(dab[reverse_addr_rank1_assert(404, "gradient_3d_27pt_solid.c", nsites, 6, index, YZ)]) = (r12 * ((((((((((((+(field[reverse_addr_rank0_assert(405, "gradient_3d_27pt_solid.c", nsites, (index + ys) + 1)])) - (field[reverse_addr_rank0_assert(406, "gradient_3d_27pt_solid.c", nsites, (index + ys) - 1)])) - (field[reverse_addr_rank0_assert(407, "gradient_3d_27pt_solid.c", nsites, (index - ys) + 1)])) + (field[reverse_addr_rank0_assert(408, "gradient_3d_27pt_solid.c", nsites, (index - ys) - 1)])) + (field[reverse_addr_rank0_assert(409, "gradient_3d_27pt_solid.c", nsites, ((index + xs) + ys) + 1)])) - (field[reverse_addr_rank0_assert(410, "gradient_3d_27pt_solid.c", nsites, ((index + xs) + ys) - 1)])) - (field[reverse_addr_rank0_assert(411, "gradient_3d_27pt_solid.c", nsites, ((index + xs) - ys) + 1)])) + (field[reverse_addr_rank0_assert(412, "gradient_3d_27pt_solid.c", nsites, ((index + xs) - ys) - 1)])) + (field[reverse_addr_rank0_assert(413, "gradient_3d_27pt_solid.c", nsites, ((index - xs) + ys) + 1)])) - (field[reverse_addr_rank0_assert(414, "gradient_3d_27pt_solid.c", nsites, ((index - xs) + ys) - 1)])) - (field[reverse_addr_rank0_assert(415, "gradient_3d_27pt_solid.c", nsites, ((index - xs) - ys) + 1)])) + (field[reverse_addr_rank0_assert(416, "gradient_3d_27pt_solid.c", nsites, ((index - xs) - ys) - 1)]))); 
# 418
(dab[reverse_addr_rank1_assert(418, "gradient_3d_27pt_solid.c", nsites, 6, index, ZZ)]) = ((0.2000000000000000111) * ((((((((((((((((+(1.0)) * (field[reverse_addr_rank0_assert(419, "gradient_3d_27pt_solid.c", nsites, index + 1)])) + ((1.0) * (field[reverse_addr_rank0_assert(420, "gradient_3d_27pt_solid.c", nsites, index - 1)]))) - ((2.0) * (field[reverse_addr_rank0_assert(421, "gradient_3d_27pt_solid.c", nsites, index)]))) + ((1.0) * (field[reverse_addr_rank0_assert(422, "gradient_3d_27pt_solid.c", nsites, (index + xs) + 1)]))) + ((1.0) * (field[reverse_addr_rank0_assert(423, "gradient_3d_27pt_solid.c", nsites, (index + xs) - 1)]))) - ((2.0) * (field[reverse_addr_rank0_assert(424, "gradient_3d_27pt_solid.c", nsites, index + xs)]))) + ((1.0) * (field[reverse_addr_rank0_assert(425, "gradient_3d_27pt_solid.c", nsites, (index - xs) + 1)]))) + ((1.0) * (field[reverse_addr_rank0_assert(426, "gradient_3d_27pt_solid.c", nsites, (index - xs) - 1)]))) - ((2.0) * (field[reverse_addr_rank0_assert(427, "gradient_3d_27pt_solid.c", nsites, index - xs)]))) + ((1.0) * (field[reverse_addr_rank0_assert(428, "gradient_3d_27pt_solid.c", nsites, (index + ys) + 1)]))) + ((1.0) * (field[reverse_addr_rank0_assert(429, "gradient_3d_27pt_solid.c", nsites, (index + ys) - 1)]))) - ((2.0) * (field[reverse_addr_rank0_assert(430, "gradient_3d_27pt_solid.c", nsites, index + ys)]))) + ((1.0) * (field[reverse_addr_rank0_assert(431, "gradient_3d_27pt_solid.c", nsites, (index - ys) + 1)]))) + ((1.0) * (field[reverse_addr_rank0_assert(432, "gradient_3d_27pt_solid.c", nsites, (index - ys) - 1)]))) - ((2.0) * (field[reverse_addr_rank0_assert(433, "gradient_3d_27pt_solid.c", nsites, index - ys)])))); 
# 435
}  
# 436
}  
...
# 1 "gradient_3d_27pt_solid.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__30_gradient_3d_27pt_solid_cpp1_ii_e02ba749
# 1 "gradient_3d_27pt_solid.cudafe1.stub.c"
#include "gradient_3d_27pt_solid.cudafe1.stub.c"
# 1 "gradient_3d_27pt_solid.cudafe1.stub.c"
