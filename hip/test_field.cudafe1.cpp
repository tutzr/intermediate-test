...
# 25
int test_coords_field_set(cs_t * cs, int nf, void * buf, MPI_Datatype mpidata, halo_ft bufset); 
# 27
int test_coords_field_check(cs_t * cs, int nhcomm, int nf, void * buf, MPI_Datatype mpidata, halo_ft bufref); 
# 30
...
field_t *phi = (__null); 
# 88
(pe) ? static_cast< void>(0) : __assert_fail("pe", "test_field.c", 88, __PRETTY_FUNCTION__); 
# 90
cs_create(pe, &cs); 
# 91
...
field_t *phi = (__null); 
# 127
(pe) ? static_cast< void>(0) : __assert_fail("pe", "test_field.c", 127, __PRETTY_FUNCTION__); 
# 129
cs_create(pe, &cs); 
# 130
cs_nhalo_set(cs, nhalo); 
...
field_create(pe, cs, nfref, "phi", &phi); 
# 134
(phi) ? static_cast< void>(0) : __assert_fail("phi", "test_field.c", 134, __PRETTY_FUNCTION__); 
# 136
field_nf(phi, &nf); 
# 137
(nf == nfref) ? static_cast< void>(0) : __assert_fail("nf == nfref", "test_field.c", 137, __PRETTY_FUNCTION__); 
# 139
field_init(phi, nhalo, __null); 
# 141
ref = (1.0); 
...
# 144
(fabs(value - ref) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(value - ref) < double(2.22044604925031308085e-16L)", "test_field.c", 144, __PRETTY_FUNCTION__); 
# 146
ref = (-(1.0)); 
# 147
...
# 149
(fabs(value - ref) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(value - ref) < double(2.22044604925031308085e-16L)", "test_field.c", 149, __PRETTY_FUNCTION__); 
# 151
ref = ((1.0) / (3.0)); 
# 152
field_scalar_set(phi, index, ref); 
...
field_scalar(phi, index, &value); 
# 154
(fabs(value - ref) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(value - ref) < double(2.22044604925031308085e-16L)", "test_field.c", 154, __PRETTY_FUNCTION__); 
# 157
test_field_halo(cs, phi); 
# 159
field_free(phi); 
...
field_t *phi = (__null); 
# 180
void do_test_field_kernel1(field_t * phi); 
# 182
(pe) ? static_cast< void>(0) : __assert_fail("pe", "test_field.c", 182, __PRETTY_FUNCTION__); 
# 184
cs_create(pe, &cs); 
# 185
cs_nhalo_set(cs, nhalo); 
...
field_create(pe, cs, nfref, "phi", &phi); 
# 189
(phi) ? static_cast< void>(0) : __assert_fail("phi", "test_field.c", 189, __PRETTY_FUNCTION__); 
# 191
field_nf(phi, &nf); 
# 192
(nf == nfref) ? static_cast< void>(0) : __assert_fail("nf == nfref", "test_field.c", 192, __PRETTY_FUNCTION__); 
# 194
field_init(phi, nhalo, __null); 
# 196
...
(ntpb.x) = (1); 
# 199
do { (__cudaPushCallConfiguration(nblk, ntpb, 0, 0)) ? (void)0 : do_test_field_kernel1(phi->target); } while (0); ; 
# 200
...
double q; 
# 220
double qref = (1.199999999999999956); 
# 222
(phi) ? static_cast< void>(0) : __assert_fail("phi", "test_field.c", 222, __PRETTY_FUNCTION__); 
# 224
field_nf(phi, &nf); 
# 225
(nf == 1) ? static_cast< void>(0) : __assert_fail("nf == 1", "test_field.c", 225, __PRETTY_FUNCTION__); 
# 227
cs_nsites(phi->cs, &nsites); 
# 228
((phi->nsites) == nsites) ? static_cast< void>(0) : __assert_fail("phi->nsites == nsites", "test_field.c", 228, __PRETTY_FUNCTION__); 
# 230
field_scalar_set(phi, index, qref); 
# 231
field_scalar(phi, index, &q); 
# 232
(fabs(q - qref) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(q - qref) < double(2.22044604925031308085e-16L)", "test_field.c", 232, __PRETTY_FUNCTION__); 
# 235
} 
#endif
# 245 "test_field.c"
...
field_t *phi = (__null); 
# 258
(pe) ? static_cast< void>(0) : __assert_fail("pe", "test_field.c", 258, __PRETTY_FUNCTION__); 
# 260
cs_create(pe, &cs); 
# 261
cs_nhalo_set(cs, nhalo); 
...
# 265
(phi) ? static_cast< void>(0) : __assert_fail("phi", "test_field.c", 265, __PRETTY_FUNCTION__); 
# 267
field_nf(phi, &nf); 
# 268
(nf == nfref) ? static_cast< void>(0) : __assert_fail("nf == nfref", "test_field.c", 268, __PRETTY_FUNCTION__); 
# 270
field_init(phi, nhalo, __null); 
# 272
...
# 274
(fabs((value[0]) - (ref[0])) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(value[0] - ref[0]) < double(2.22044604925031308085e-16L)", "test_field.c", 274, __PRETTY_FUNCTION__); 
# 275
(fabs((value[1]) - (ref[1])) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(value[1] - ref[1]) < double(2.22044604925031308085e-16L)", "test_field.c", 275, __PRETTY_FUNCTION__); 
# 276
(fabs((value[2]) - (ref[2])) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(value[2] - ref[2]) < double(2.22044604925031308085e-16L)", "test_field.c", 276, __PRETTY_FUNCTION__); 
# 278
field_scalar_array(phi, index, array); 
# 279
(fabs((array[0]) - (ref[0])) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(array[0] - ref[0]) < double(2.22044604925031308085e-16L)", "test_field.c", 279, __PRETTY_FUNCTION__); 
# 280
(fabs((array[1]) - (ref[1])) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(array[1] - ref[1]) < double(2.22044604925031308085e-16L)", "test_field.c", 280, __PRETTY_FUNCTION__); 
# 281
(fabs((array[2]) - (ref[2])) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(array[2] - ref[2]) < double(2.22044604925031308085e-16L)", "test_field.c", 281, __PRETTY_FUNCTION__); 
# 284
test_field_halo(cs, phi); 
# 286
field_free(phi); 
...
field_t *phi = (__null); 
# 313
(pe) ? static_cast< void>(0) : __assert_fail("pe", "test_field.c", 313, __PRETTY_FUNCTION__); 
# 315
cs_create(pe, &cs); 
# 316
cs_nhalo_set(cs, nhalo); 
...
# 320
(phi) ? static_cast< void>(0) : __assert_fail("phi", "test_field.c", 320, __PRETTY_FUNCTION__); 
# 322
field_nf(phi, &nf); 
# 323
(nf == nfref) ? static_cast< void>(0) : __assert_fail("nf == nfref", "test_field.c", 323, __PRETTY_FUNCTION__); 
# 325
field_init(phi, nhalo, __null); 
# 327
...
# 329
(fabs(((qvalue[X])[X]) - ((qref[X])[X])) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(qvalue[X][X] - qref[X][X]) < double(2.22044604925031308085e-16L)", "test_field.c", 329, __PRETTY_FUNCTION__); 
# 330
(fabs(((qvalue[X])[Y]) - ((qref[X])[Y])) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(qvalue[X][Y] - qref[X][Y]) < double(2.22044604925031308085e-16L)", "test_field.c", 330, __PRETTY_FUNCTION__); 
# 331
(fabs(((qvalue[X])[Z]) - ((qref[X])[Z])) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(qvalue[X][Z] - qref[X][Z]) < double(2.22044604925031308085e-16L)", "test_field.c", 331, __PRETTY_FUNCTION__); 
# 332
(fabs(((qvalue[Y])[X]) - ((qref[Y])[X])) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(qvalue[Y][X] - qref[Y][X]) < double(2.22044604925031308085e-16L)", "test_field.c", 332, __PRETTY_FUNCTION__); 
# 333
(fabs(((qvalue[Y])[Y]) - ((qref[Y])[Y])) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(qvalue[Y][Y] - qref[Y][Y]) < double(2.22044604925031308085e-16L)", "test_field.c", 333, __PRETTY_FUNCTION__); 
# 334
(fabs(((qvalue[Y])[Z]) - ((qref[Y])[Z])) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(qvalue[Y][Z] - qref[Y][Z]) < double(2.22044604925031308085e-16L)", "test_field.c", 334, __PRETTY_FUNCTION__); 
# 335
(fabs(((qvalue[Z])[X]) - ((qref[Z])[X])) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(qvalue[Z][X] - qref[Z][X]) < double(2.22044604925031308085e-16L)", "test_field.c", 335, __PRETTY_FUNCTION__); 
# 336
(fabs(((qvalue[Z])[Y]) - ((qref[Z])[Y])) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(qvalue[Z][Y] - qref[Z][Y]) < double(2.22044604925031308085e-16L)", "test_field.c", 336, __PRETTY_FUNCTION__); 
# 337
(fabs(((qvalue[Z])[Z]) - ((qref[Z])[Z])) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(qvalue[Z][Z] - qref[Z][Z]) < double(2.22044604925031308085e-16L)", "test_field.c", 337, __PRETTY_FUNCTION__); 
# 341
field_scalar_array(phi, index, array); 
# 342
(fabs((array[XX]) - ((qref[X])[X])) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(array[XX] - qref[X][X]) < double(2.22044604925031308085e-16L)", "test_field.c", 342, __PRETTY_FUNCTION__); 
# 343
(fabs((array[XY]) - ((qref[X])[Y])) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(array[XY] - qref[X][Y]) < double(2.22044604925031308085e-16L)", "test_field.c", 343, __PRETTY_FUNCTION__); 
# 344
(fabs((array[XZ]) - ((qref[X])[Z])) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(array[XZ] - qref[X][Z]) < double(2.22044604925031308085e-16L)", "test_field.c", 344, __PRETTY_FUNCTION__); 
# 345
(fabs((array[YY]) - ((qref[Y])[Y])) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(array[YY] - qref[Y][Y]) < double(2.22044604925031308085e-16L)", "test_field.c", 345, __PRETTY_FUNCTION__); 
# 346
(fabs((array[YZ]) - ((qref[Y])[Z])) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(array[YZ] - qref[Y][Z]) < double(2.22044604925031308085e-16L)", "test_field.c", 346, __PRETTY_FUNCTION__); 
# 349
test_field_halo(cs, phi); 
# 351
field_free(phi); 
...
static int test_field_halo(cs_t *cs, field_t *phi) { 
# 365
(phi) ? static_cast< void>(0) : __assert_fail("phi", "test_field.c", 365, __PRETTY_FUNCTION__); 
# 367
test_coords_field_set(cs, phi->nf, phi->data, MPI_DOUBLE, test_ref_double1); 
# 368
field_memcpy(phi, hipMemcpyHostToDevice); 
# 370
field_halo_swap(phi, FIELD_HALO_TARGET); 
# 372
field_memcpy(phi, hipMemcpyDeviceToHost); 
# 373
test_coords_field_check(cs, phi->nhcomm, phi->nf, phi->data, MPI_DOUBLE, test_ref_double1); 
# 376
return 0; 
# 377
} 
...
# 397
(pe) ? static_cast< void>(0) : __assert_fail("pe", "test_field.c", 397, __PRETTY_FUNCTION__); 
# 399
cs_create(pe, &cs); 
# 400
cs_init(cs); 
...
# 411
(phi) ? static_cast< void>(0) : __assert_fail("phi", "test_field.c", 411, __PRETTY_FUNCTION__); 
# 412
field_init(phi, nhalo, __null); 
# 413
...
# 417
(iohandler) ? static_cast< void>(0) : __assert_fail("iohandler", "test_field.c", 417, __PRETTY_FUNCTION__); 
# 419
...
field_io_info(phi, &iohandler); 
# 429
(iohandler) ? static_cast< void>(0) : __assert_fail("iohandler", "test_field.c", 429, __PRETTY_FUNCTION__); 
# 430
...
# 1 "test_field.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__18_test_field_cpp1_ii_d9d3344c
# 1 "test_field.cudafe1.stub.c"
#include "test_field.cudafe1.stub.c"
# 1 "test_field.cudafe1.stub.c"
