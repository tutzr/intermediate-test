...
# 41
static int test_set_drop(cs_t * cs, field_t * phi, const double  rc[3], double radius, double xi0); 
# 43
static int test_drop_difference(cs_t * cs, field_t * phi, const double  rc[3], double radius, double xi0, double  elnorm[3]); 
# 52
int test_phi_ch_suite() { 
# 54
int nf = 1; 
...
# 73
(phi) ? static_cast< void>(0) : __assert_fail("phi", "test_phi_ch.c", 73, __PRETTY_FUNCTION__); 
# 74
field_init(phi, nhalo, le); 
# 76
hydro_create(pe, cs, le, 1, &hydro); 
# 77
(hydro) ? static_cast< void>(0) : __assert_fail("hydro", "test_phi_ch.c", 77, __PRETTY_FUNCTION__); 
# 79
phi_ch_create(pe, cs, le, __null, &pch); 
# 80
(pch) ? static_cast< void>(0) : __assert_fail("pch", "test_phi_ch.c", 80, __PRETTY_FUNCTION__); 
# 82
...
double ltot[3]; 
# 116
(cs) ? static_cast< void>(0) : __assert_fail("cs", "test_phi_ch.c", 116, __PRETTY_FUNCTION__); 
# 117
(pch) ? static_cast< void>(0) : __assert_fail("pch", "test_phi_ch.c", 117, __PRETTY_FUNCTION__); 
# 118
(phi) ? static_cast< void>(0) : __assert_fail("phi", "test_phi_ch.c", 118, __PRETTY_FUNCTION__); 
# 119
(hydro) ? static_cast< void>(0) : __assert_fail("hydro", "test_phi_ch.c", 119, __PRETTY_FUNCTION__); 
# 121
cs_lmin(cs, lmin); 
# 122
cs_ltot(cs, ltot); 
...
field_halo(phi); 
# 147
phi_cahn_hilliard(pch, __null, phi, hydro, __null, __null); 
# 148
}  
# 151
(rc[X]) += ((u[X]) * ntmax); 
...
# 158
(fabs((ell[0]) - (0.01144819400000000008)) < ((1.192092896e-07F))) ? static_cast< void>(0) : __assert_fail("fabs(ell[0] - 1.1448194e-02) < 1.19209289550781250000e-7F", "test_phi_ch.c", 158, __PRETTY_FUNCTION__); 
# 159
(fabs((ell[1]) - (0.001524760499999999958)) < ((1.192092896e-07F))) ? static_cast< void>(0) : __assert_fail("fabs(ell[1] - 1.5247605e-03) < 1.19209289550781250000e-7F", "test_phi_ch.c", 159, __PRETTY_FUNCTION__); 
# 160
(fabs((ell[2]) - (0.2529610800000000048)) < ((1.192092896e-07F))) ? static_cast< void>(0) : __assert_fail("fabs(ell[2] - 2.5296108e-01) < 1.19209289550781250000e-7F", "test_phi_ch.c", 160, __PRETTY_FUNCTION__); 
# 162
return 0; 
# 163
} 
...
int nlocal[3]; 
# 179
(hydro) ? static_cast< void>(0) : __assert_fail("hydro", "test_phi_ch.c", 179, __PRETTY_FUNCTION__); 
# 181
cs_nlocal(cs, nlocal); 
# 183
...
# 205 "test_phi_ch.c"
static int test_set_drop(cs_t *cs, field_t *fphi, const double rc[3], double 
# 206
radius, double 
# 207
xi0) { 
...
# 221
(fphi) ? static_cast< void>(0) : __assert_fail("fphi", "test_phi_ch.c", 221, __PRETTY_FUNCTION__); 
# 222
rzeta = ((1.0) / xi0); 
# 224
for (ic = 1; ic <= (nlocal[X]); ic++) { 
...
# 253 "test_phi_ch.c"
static int test_drop_difference(cs_t *cs, field_t *fphi, const double rc[3], double 
# 254
radius, double xi0, double elnorm[3]) { 
# 256
int nlocal[3]; 
# 257
int noffset[3]; 
...
MPI_Comm comm; 
# 267
(cs) ? static_cast< void>(0) : __assert_fail("cs", "test_phi_ch.c", 267, __PRETTY_FUNCTION__); 
# 268
(fphi) ? static_cast< void>(0) : __assert_fail("fphi", "test_phi_ch.c", 268, __PRETTY_FUNCTION__); 
# 269
(xi0 > (0.0)) ? static_cast< void>(0) : __assert_fail("xi0 > 0.0", "test_phi_ch.c", 269, __PRETTY_FUNCTION__); 
# 270
rzeta = ((1.0) / xi0); 
# 272
cs_ltot(cs, ltot); 
...
# 1 "test_phi_ch.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__19_test_phi_ch_cpp1_ii_8be9018b
# 1 "test_phi_ch.cudafe1.stub.c"
#include "test_phi_ch.cudafe1.stub.c"
# 1 "test_phi_ch.cudafe1.stub.c"
