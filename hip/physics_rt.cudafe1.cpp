...
double gm0[3]; 
# 35
(pe) ? static_cast< void>(0) : __assert_fail("pe", "physics_rt.c", 35, __PRETTY_FUNCTION__); 
# 36
(phys) ? static_cast< void>(0) : __assert_fail("phys", "physics_rt.c", 36, __PRETTY_FUNCTION__); 
# 38
...
double frequency; 
# 95
(phys) ? static_cast< void>(0) : __assert_fail("phys", "physics_rt.c", 95, __PRETTY_FUNCTION__); 
# 99
...
# 1 "physics_rt.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__18_physics_rt_cpp1_ii_813d61bf
# 1 "physics_rt.cudafe1.stub.c"
#include "physics_rt.cudafe1.stub.c"
# 1 "physics_rt.cudafe1.stub.c"
