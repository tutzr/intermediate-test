...
# 27 "test_coords.c"
static int test_coords_constants(); 
# 28
...
# 36
int do_test_coords_device1(pe_t * pe); 
# 37
void do_test_coords_kernel1(cs_t * cs); 
# 46 "test_coords.c"
int test_coords_suite() { 
# 48
...
# 128 "test_coords.c"
int test_coords_constants() { 
# 131
test_assert_info((X) == 0, 131, "test_coords.c"); 
# 132
test_assert_info((Y) == 1, 132, "test_coords.c"); 
# 133
test_assert_info((Z) == 2, 133, "test_coords.c"); 
# 135
test_assert_info((XX) == 0, 135, "test_coords.c"); 
# 136
test_assert_info((XY) == 1, 136, "test_coords.c"); 
# 137
test_assert_info((XZ) == 2, 137, "test_coords.c"); 
# 138
test_assert_info((YY) == 3, 138, "test_coords.c"); 
# 139
test_assert_info((YZ) == 4, 139, "test_coords.c"); 
# 143
test_assert_info((FORWARD) == 0, 143, "test_coords.c"); 
# 144
test_assert_info((BACKWARD) == 1, 144, "test_coords.c"); 
# 155 "test_coords.c"
return 0; 
# 156
} 
...
double len[3]; 
# 172
(cs) ? static_cast< void>(0) : __assert_fail("cs", "test_coords.c", 172, __PRETTY_FUNCTION__); 
# 174
cs_ntotal(cs, ntotal); 
# 175
...
cs_ltot(cs, len); 
# 178
test_assert_info((ntotal[X]) == (ntotal_ref[X]), 178, "test_coords.c"); 
# 179
test_assert_info((ntotal[Y]) == (ntotal_ref[Y]), 179, "test_coords.c"); 
# 180
test_assert_info((ntotal[Z]) == (ntotal_ref[Z]), 180, "test_coords.c"); 
# 182
test_assert_info((periodic[X]) == (period_ref[X]), 182, "test_coords.c"); 
# 183
test_assert_info((periodic[Y]) == (period_ref[Y]), 183, "test_coords.c"); 
# 184
test_assert_info((periodic[Z]) == (period_ref[Z]), 184, "test_coords.c"); 
# 186
test_assert_info(fabs((len[X]) - ((1.0) * (ntotal_ref[X]))) < (9.999999999999999988e-15), 186, "test_coords.c"); 
# 187
test_assert_info(fabs((len[Y]) - ((1.0) * (ntotal_ref[Y]))) < (9.999999999999999988e-15), 187, "test_coords.c"); 
# 188
test_assert_info(fabs((len[Z]) - ((1.0) * (ntotal_ref[Z]))) < (9.999999999999999988e-15), 188, "test_coords.c"); 
# 190
return 0; 
# 191
} 
...
MPI_Comm comm; 
# 211
(cs) ? static_cast< void>(0) : __assert_fail("cs", "test_coords.c", 211, __PRETTY_FUNCTION__); 
# 213
...
if (ok) { 
# 227
test_assert_info((mpisz[X]) == (mpi_sz_req[X]), 227, "test_coords.c"); 
# 228
test_assert_info((mpisz[Y]) == (mpi_sz_req[Y]), 228, "test_coords.c"); 
# 229
test_assert_info((mpisz[Z]) == (mpi_sz_req[Z]), 229, "test_coords.c"); 
# 230
}  
# 232
return 0; 
...
MPI_Comm comm; 
# 261
(cs) ? static_cast< void>(0) : __assert_fail("cs", "test_coords.c", 261, __PRETTY_FUNCTION__); 
# 263
cs_ntotal(cs, ntotal); 
# 264
cs_nlocal(cs, nlocal); 
...
# 276
test_assert_info(cs_cart_rank(cs) == rank, 276, "test_coords.c"); 
# 280
cs_cartsz(cs, mpisz); 
# 281
test_assert_info((mpisz[X]) == (dims[X]), 281, "test_coords.c"); 
# 282
test_assert_info((mpisz[Y]) == (dims[Y]), 282, "test_coords.c"); 
# 283
test_assert_info((mpisz[Z]) == (dims[Z]), 283, "test_coords.c"); 
# 287
cs_cart_coords(cs, cart_coords); 
# 288
test_assert_info((cart_coords[X]) == (coords[X]), 288, "test_coords.c"); 
# 289
test_assert_info((cart_coords[Y]) == (coords[Y]), 289, "test_coords.c"); 
# 290
test_assert_info((cart_coords[Z]) == (coords[Z]), 290, "test_coords.c"); 
# 294
cs_periodic(cs, periodic); 
# 295
test_assert_info((periodic[X]) == (periods[X]), 295, "test_coords.c"); 
# 296
test_assert_info((periodic[Y]) == (periods[Y]), 296, "test_coords.c"); 
# 297
test_assert_info((periodic[Z]) == (periods[Z]), 297, "test_coords.c"); 
# 301
test_assert_info((nlocal[X]) == ((ntotal[X]) / (mpisz[X])), 301, "test_coords.c"); 
# 302
test_assert_info((nlocal[Y]) == ((ntotal[Y]) / (mpisz[Y])), 302, "test_coords.c"); 
# 303
test_assert_info((nlocal[Z]) == ((ntotal[Z]) / (mpisz[Z])), 303, "test_coords.c"); 
# 307
test_assert_info((noffset[X]) == ((cart_coords[X]) * (nlocal[X])), 307, "test_coords.c"); 
# 308
test_assert_info((noffset[Y]) == ((cart_coords[Y]) * (nlocal[Y])), 308, "test_coords.c"); 
# 309
test_assert_info((noffset[Z]) == ((cart_coords[Z]) * (nlocal[Z])), 309, "test_coords.c"); 
# 315
n = neighbour_rank(cs, (cart_coords[X]) + 1, cart_coords[Y], cart_coords[Z]); 
# 316
test_assert_info(n == cs_cart_neighb(cs, CS_FORW, X), 316, "test_coords.c"); 
# 320
n = neighbour_rank(cs, (cart_coords[X]) - 1, cart_coords[Y], cart_coords[Z]); 
# 321
test_assert_info(n == cs_cart_neighb(cs, CS_BACK, X), 321, "test_coords.c"); 
# 325
n = neighbour_rank(cs, cart_coords[X], (cart_coords[Y]) + 1, cart_coords[Z]); 
# 326
test_assert_info(n == cs_cart_neighb(cs, CS_FORW, Y), 326, "test_coords.c"); 
# 330
n = neighbour_rank(cs, cart_coords[X], (cart_coords[Y]) - 1, cart_coords[Z]); 
# 331
test_assert_info(n == cs_cart_neighb(cs, CS_BACK, Y), 331, "test_coords.c"); 
# 335
n = neighbour_rank(cs, cart_coords[X], cart_coords[Y], (cart_coords[Z]) + 1); 
# 336
test_assert_info(n == cs_cart_neighb(cs, CS_FORW, Z), 336, "test_coords.c"); 
# 340
n = neighbour_rank(cs, cart_coords[X], cart_coords[Y], (cart_coords[Z]) - 1); 
# 341
test_assert_info(n == cs_cart_neighb(cs, CS_BACK, Z), 341, "test_coords.c"); 
# 344
return 0; 
# 345
} 
...
MPI_Status status[1]; 
# 364
(cs) ? static_cast< void>(0) : __assert_fail("cs", "test_coords.c", 364, __PRETTY_FUNCTION__); 
# 381 "test_coords.c"
...
if (rank != 0) { 
# 385
MPI_Ssend(string, 4096, MPI_CHAR, 0, tag, MPI_COMM_WORLD); 
# 386
} else 
# 387
{ 
...
for (n = 1; n < sz; n++) { 
# 389
MPI_Recv(string, 4096, MPI_CHAR, n, tag, MPI_COMM_WORLD, status); 
# 391
}  
# 392
}  
...
MPI_Status status[1]; 
# 418
(cs) ? static_cast< void>(0) : __assert_fail("cs", "test_coords.c", 418, __PRETTY_FUNCTION__); 
# 422
(remainder[X]) = 0; 
# 423
(remainder[Y]) = 1; 
...
MPI_Comm comm; 
# 492
(cs) ? static_cast< void>(0) : __assert_fail("cs", "test_coords.c", 492, __PRETTY_FUNCTION__); 
# 494
...
MPI_Comm pcomm; 
# 525
(cs) ? static_cast< void>(0) : __assert_fail("cs", "test_coords.c", 525, __PRETTY_FUNCTION__); 
# 526
...
# 534
test_assert_info(pforw == ndest, 534, "test_coords.c"); 
# 535
test_assert_info(pback == nsource, 535, "test_coords.c"); 
# 537
...
# 541
test_assert_info(pforw == ndest, 541, "test_coords.c"); 
# 542
test_assert_info(pback == nsource, 542, "test_coords.c"); 
# 544
...
# 548
test_assert_info(pforw == ndest, 548, "test_coords.c"); 
# 549
test_assert_info(pback == nsource, 549, "test_coords.c"); 
# 551
return 0; 
# 552
} 
...
cs_t *cs = (__null); 
# 568
(pe) ? static_cast< void>(0) : __assert_fail("pe", "test_coords.c", 568, __PRETTY_FUNCTION__); 
# 570
cs_create(pe, &cs); 
# 571
cs_init(cs); 
...
(ntpb.x) = (1); 
# 577
do { (__cudaPushCallConfiguration(nblk, ntpb, 0, 0)) ? (void)0 : do_test_coords_kernel1(cstarget); } while (0); ; 
# 578
...
double ltot[3]; 
# 603
(cs) ? static_cast< void>(0) : __assert_fail("cs", "test_coords.c", 603, __PRETTY_FUNCTION__); 
# 605
cs_nhalo(cs, &nhalo); 
# 606
test_assert_info(nhalo == 1, 606, "test_coords.c"); 
# 608
cs_ntotal(cs, ntotal); 
# 609
test_assert_info((ntotal[X]) == 64, 609, "test_coords.c"); 
# 610
test_assert_info((ntotal[Y]) == 64, 610, "test_coords.c"); 
# 611
test_assert_info((ntotal[Z]) == 64, 611, "test_coords.c"); 
# 613
cs_nlocal(cs, nlocal); 
# 614
cs_cartsz(cs, mpisz); 
# 616
test_assert_info((nlocal[X]) == ((ntotal[X]) / (mpisz[X])), 616, "test_coords.c"); 
# 617
test_assert_info((nlocal[Y]) == ((ntotal[Y]) / (mpisz[Y])), 617, "test_coords.c"); 
# 618
test_assert_info((nlocal[Z]) == ((ntotal[Z]) / (mpisz[Z])), 618, "test_coords.c"); 
# 620
cs_nsites(cs, &nsites); 
# 622
test_assert_info(nsites == ((((nlocal[X]) + (2 * nhalo)) * ((nlocal[Y]) + (2 * nhalo))) * ((nlocal[Z]) + (2 * nhalo))), 622, "test_coords.c"); 
# 624
cs_cart_coords(cs, mpicoords); 
# 625
cs_nlocal_offset(cs, noffset); 
# 627
test_assert_info((noffset[X]) == ((mpicoords[X]) * (nlocal[X])), 627, "test_coords.c"); 
# 628
test_assert_info((noffset[Y]) == ((mpicoords[Y]) * (nlocal[Y])), 628, "test_coords.c"); 
# 629
test_assert_info((noffset[Z]) == ((mpicoords[Z]) * (nlocal[Z])), 629, "test_coords.c"); 
# 631
cs_lmin(cs, lmin); 
# 632
cs_ltot(cs, ltot); 
# 634
test_assert_info(fabs((lmin[X]) - (0.5)) < ((double)(2.2204460492503130808e-16L)), 634, "test_coords.c"); 
# 635
test_assert_info(fabs((lmin[Y]) - (0.5)) < ((double)(2.2204460492503130808e-16L)), 635, "test_coords.c"); 
# 636
test_assert_info(fabs((lmin[Z]) - (0.5)) < ((double)(2.2204460492503130808e-16L)), 636, "test_coords.c"); 
# 638
test_assert_info(fabs((ltot[X]) - (ntotal[X])) < ((double)(2.2204460492503130808e-16L)), 638, "test_coords.c"); 
# 639
test_assert_info(fabs((ltot[Y]) - (ntotal[Y])) < ((double)(2.2204460492503130808e-16L)), 639, "test_coords.c"); 
# 640
test_assert_info(fabs((ltot[Z]) - (ntotal[Z])) < ((double)(2.2204460492503130808e-16L)), 640, "test_coords.c"); 
# 643
} 
#endif

# 1 "test_coords.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__19_test_coords_cpp1_ii_e11a2087
# 1 "test_coords.cudafe1.stub.c"
#include "test_coords.cudafe1.stub.c"
# 1 "test_coords.cudafe1.stub.c"
