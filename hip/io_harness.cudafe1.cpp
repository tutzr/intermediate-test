...
# 42
static long io_file_offset(int, int, io_info_t *); 
# 43
static int io_decomposition_create(pe_t * pe, cs_t * cs, const int  grid[3], io_decomposition_t ** p); 
# 45
...
# 50
int io_unpack_local_buf(io_info_t * obj, int mpi_sender, const char * buf, char * io_buf); 
# 61 "io_harness.c"
int io_info_create(pe_t *pe, cs_t *cs, io_info_arg_t *arg, io_info_t **p) { 
# 63
io_info_t *info = (__null); 
# 65
(pe) ? static_cast< void>(0) : __assert_fail("pe", "io_harness.c", 65, __PRETTY_FUNCTION__); 
# 66
(cs) ? static_cast< void>(0) : __assert_fail("cs", "io_harness.c", 66, __PRETTY_FUNCTION__); 
# 67
(arg) ? static_cast< void>(0) : __assert_fail("arg", "io_harness.c", 67, __PRETTY_FUNCTION__); 
# 68
(p) ? static_cast< void>(0) : __assert_fail("p", "io_harness.c", 68, __PRETTY_FUNCTION__); 
# 70
info = ((io_info_t *)calloc(1, sizeof(io_info_t))); 
# 72
(info) ? static_cast< void>(0) : __assert_fail("info", "io_harness.c", 72, __PRETTY_FUNCTION__); 
# 73
if (info == (__null)) { pe_fatal(pe, "Failed to allocate io_info_t struct\n"); }  
# 75
(info->pe) = pe; 
# 76
(info->cs) = cs; 
...
# 84
(info->nsites) = (((((info->io_comm)->nsite)[X]) * (((info->io_comm)->nsite)[Y])) * (((info->io_comm)->nsite)[Z])); 
# 87
MPI_Reduce(&(info->nsites), &(info->maxlocal), 1, MPI_INT, MPI_MAX, 0, (info->io_comm)->comm); 
# 90
(*p) = info; 
# 92
return 0; 
...
# 103 "io_harness.c"
int io_info_create_impl(pe_t *pe, cs_t *cs, io_info_args_t args, io_implementation_t 
# 104
impl, io_info_t **info) { 
# 105
io_info_t *p = (__null); 
# 107
(pe) ? static_cast< void>(0) : __assert_fail("pe", "io_harness.c", 107, __PRETTY_FUNCTION__); 
# 108
(cs) ? static_cast< void>(0) : __assert_fail("cs", "io_harness.c", 108, __PRETTY_FUNCTION__); 
# 109
(info) ? static_cast< void>(0) : __assert_fail("info", "io_harness.c", 109, __PRETTY_FUNCTION__); 
# 111
p = ((io_info_t *)calloc(1, sizeof(io_info_t))); 
# 112
(p) ? static_cast< void>(0) : __assert_fail("p", "io_harness.c", 112, __PRETTY_FUNCTION__); 
# 114
if (p == (__null)) { pe_fatal(pe, "Failed to allocate io_info_t struct\n"); }  
# 120
(p->pe) = pe; 
# 121
(p->cs) = cs; 
...
# 147 "io_harness.c"
static int io_decomposition_create(pe_t *pe, cs_t *cs, const int grid[3], io_decomposition_t **
# 148
pobj) { 
# 150
int i, colour; 
...
int mpicoords[3]; 
# 156
io_decomposition_t *p = (__null); 
# 157
MPI_Comm comm; 
# 159
(pe) ? static_cast< void>(0) : __assert_fail("pe", "io_harness.c", 159, __PRETTY_FUNCTION__); 
# 160
(cs) ? static_cast< void>(0) : __assert_fail("cs", "io_harness.c", 160, __PRETTY_FUNCTION__); 
# 161
(pobj) ? static_cast< void>(0) : __assert_fail("pobj", "io_harness.c", 161, __PRETTY_FUNCTION__); 
# 163
p = ((io_decomposition_t *)calloc(1, sizeof(io_decomposition_t))); 
# 164
(p) ? static_cast< void>(0) : __assert_fail("p", "io_harness.c", 164, __PRETTY_FUNCTION__); 
# 165
if (p == (__null)) { pe_fatal(pe, "Failed to allocate io_decomposition_t\n"); }  
# 167
(p->n_io) = 1; 
# 169
...
# 193
colour = ((((p->coords)[X]) + (((p->coords)[Y]) * (grid[X]))) + ((((p->coords)[Z]) * (grid[X])) * (grid[Y]))); 
# 197
(p->index) = colour; 
# 199
...
# 220 "io_harness.c"
static void io_set_group_filename(char *filename_io, const char *stub, io_info_t *
# 221
info) { 
# 223
(stub) ? static_cast< void>(0) : __assert_fail("stub", "io_harness.c", 223, __PRETTY_FUNCTION__); 
# 224
(strlen(stub) < (4096 / 2)) ? static_cast< void>(0) : __assert_fail("strlen(stub) < 4096/2", "io_harness.c", 224, __PRETTY_FUNCTION__); 
# 225
(info) ? static_cast< void>(0) : __assert_fail("info", "io_harness.c", 225, __PRETTY_FUNCTION__); 
# 226
(info->io_comm) ? static_cast< void>(0) : __assert_fail("info->io_comm", "io_harness.c", 226, __PRETTY_FUNCTION__); 
# 227
(((info->io_comm)->n_io) < 1000) ? static_cast< void>(0) : __assert_fail("info->io_comm->n_io < 1000", "io_harness.c", 227, __PRETTY_FUNCTION__); 
# 230
sprintf(filename_io, "%s.%3.3d-%3.3d", stub, (info->io_comm)->n_io, ((info->io_comm)->index) + 1); 
# 233
(info->single_file_read) = 0; 
# 234
...
# 249
(p) ? static_cast< void>(0) : __assert_fail("p", "io_harness.c", 249, __PRETTY_FUNCTION__); 
# 250
...
# 266
(p) ? static_cast< void>(0) : __assert_fail("p", "io_harness.c", 266, __PRETTY_FUNCTION__); 
# 268
...
# 284
(p) ? static_cast< void>(0) : __assert_fail("p", "io_harness.c", 284, __PRETTY_FUNCTION__); 
# 285
(strlen(name) < (4096)) ? static_cast< void>(0) : __assert_fail("strlen(name) < 4096", "io_harness.c", 285, __PRETTY_FUNCTION__); 
# 286
strcpy(p->name, name); 
# 289
} 
...
# 299
(p) ? static_cast< void>(0) : __assert_fail("p", "io_harness.c", 299, __PRETTY_FUNCTION__); 
# 300
...
# 313
(p) ? static_cast< void>(0) : __assert_fail("p", "io_harness.c", 313, __PRETTY_FUNCTION__); 
# 314
...
# 327
(p) ? static_cast< void>(0) : __assert_fail("p", "io_harness.c", 327, __PRETTY_FUNCTION__); 
# 329
switch (t) { 
# 330
...
# 352 "io_harness.c"
static long io_file_offset(int ic, int jc, io_info_t *info) { 
# 354
long offset; 
# 355
int ifo, jfo, kfo; 
...
int noffset[3]; 
# 359
(info) ? static_cast< void>(0) : __assert_fail("info", "io_harness.c", 359, __PRETTY_FUNCTION__); 
# 362
...
# 366
offset = (((((ifo * (((info->io_comm)->nsite)[Y])) * (((info->io_comm)->nsite)[Z])) + (jfo * (((info->io_comm)->nsite)[Z]))) + kfo) * (info->bytesize)); 
# 372
if (info->single_file_read) { 
# 373
...
int io_write_metadata(io_info_t *info) { 
# 392
(info) ? static_cast< void>(0) : __assert_fail("info", "io_harness.c", 392, __PRETTY_FUNCTION__); 
# 394
...
MPI_Status status; 
# 432
(info) ? static_cast< void>(0) : __assert_fail("info", "io_harness.c", 432, __PRETTY_FUNCTION__); 
# 434
...
# 450
nr = sprintf(buf, "%3d %3d %3d %3d %d %d %d %d %d %d", (info->io_comm)->rank, mpicoords[X], mpicoords[Y], mpicoords[Z], nlocal[X], nlocal[Y], nlocal[Z], noff[X], noff[Y], noff[Z]); 
# 453
(nr < 128) ? static_cast< void>(0) : __assert_fail("nr < 128", "io_harness.c", 453, __PRETTY_FUNCTION__); 
# 455
if (((info->io_comm)->rank) > 0) { 
# 456
MPI_Send(buf, 128, MPI_CHAR, 0, tag, (info->io_comm)->comm); 
# 457
} else 
# 458
{ 
...
# 467
if (fp_meta == (__null)) { pe_fatal(info->pe, "fopen(%s) failed\n", filename_io); }  
# 469
...
# 492
MPI_Recv(rbuf, 128, MPI_CHAR, nr, tag, (info->io_comm)->comm, &status); 
# 494
fprintf(fp_meta, "%s\n", rbuf); 
# 495
}  
...
char filename_io[2 * 4096]; 
# 523
(obj) ? static_cast< void>(0) : __assert_fail("obj", "io_harness.c", 523, __PRETTY_FUNCTION__); 
# 524
(file_stub) ? static_cast< void>(0) : __assert_fail("file_stub", "io_harness.c", 524, __PRETTY_FUNCTION__); 
# 526
...
char filename[4096]; 
# 549
(filename_stub) ? static_cast< void>(0) : __assert_fail("filename_stub", "io_harness.c", 549, __PRETTY_FUNCTION__); 
# 550
(obj) ? static_cast< void>(0) : __assert_fail("obj", "io_harness.c", 550, __PRETTY_FUNCTION__); 
# 552
if (((obj->io_comm)->rank) == 0) { 
# 553
pe_subdirectory(obj->pe, subdirectory); 
...
int io_info_format_set(io_info_t *obj, int form_in, int form_out) { 
# 569
(obj) ? static_cast< void>(0) : __assert_fail("obj", "io_harness.c", 569, __PRETTY_FUNCTION__); 
# 570
(form_in >= 0) ? static_cast< void>(0) : __assert_fail("form_in >= 0", "io_harness.c", 570, __PRETTY_FUNCTION__); 
# 571
(form_in <= (IO_FORMAT_DEFAULT)) ? static_cast< void>(0) : __assert_fail("form_in <= IO_FORMAT_DEFAULT", "io_harness.c", 571, __PRETTY_FUNCTION__); 
# 572
(form_out >= 0) ? static_cast< void>(0) : __assert_fail("form_out >= 0", "io_harness.c", 572, __PRETTY_FUNCTION__); 
# 573
(form_out <= (IO_FORMAT_DEFAULT)) ? static_cast< void>(0) : __assert_fail("form_out <= IO_FORMAT_DEFAULT", "io_harness.c", 573, __PRETTY_FUNCTION__); 
# 575
...
int io_info_format_in_set(io_info_t *obj, int form_in) { 
# 591
(obj) ? static_cast< void>(0) : __assert_fail("obj", "io_harness.c", 591, __PRETTY_FUNCTION__); 
# 592
(form_in >= 0) ? static_cast< void>(0) : __assert_fail("form_in >= 0", "io_harness.c", 592, __PRETTY_FUNCTION__); 
# 593
(form_in <= (IO_FORMAT_DEFAULT)) ? static_cast< void>(0) : __assert_fail("form_in <= IO_FORMAT_DEFAULT", "io_harness.c", 593, __PRETTY_FUNCTION__); 
# 595
...
int io_info_format_out_set(io_info_t *obj, int form_out) { 
# 632
(obj) ? static_cast< void>(0) : __assert_fail("obj", "io_harness.c", 632, __PRETTY_FUNCTION__); 
# 633
(form_out >= 0) ? static_cast< void>(0) : __assert_fail("form_out >= 0", "io_harness.c", 633, __PRETTY_FUNCTION__); 
# 634
(form_out <= (IO_FORMAT_DEFAULT)) ? static_cast< void>(0) : __assert_fail("form_out <= IO_FORMAT_DEFAULT", "io_harness.c", 634, __PRETTY_FUNCTION__); 
# 636
...
# 665
(obj) ? static_cast< void>(0) : __assert_fail("obj", "io_harness.c", 665, __PRETTY_FUNCTION__); 
# 666
((format == (IO_FORMAT_ASCII)) || (format == (IO_FORMAT_BINARY))) ? static_cast< void>(0) : __assert_fail("format == IO_FORMAT_ASCII || format == IO_FORMAT_BINARY", "io_harness.c", 666, __PRETTY_FUNCTION__); 
# 667
(f) ? static_cast< void>(0) : __assert_fail("f", "io_harness.c", 667, __PRETTY_FUNCTION__); 
# 669
...
# 683
(obj) ? static_cast< void>(0) : __assert_fail("obj", "io_harness.c", 683, __PRETTY_FUNCTION__); 
# 684
((format == (IO_FORMAT_ASCII)) || (format == (IO_FORMAT_BINARY))) ? static_cast< void>(0) : __assert_fail("format == IO_FORMAT_ASCII || format == IO_FORMAT_BINARY", "io_harness.c", 684, __PRETTY_FUNCTION__); 
# 685
(f) ? static_cast< void>(0) : __assert_fail("f", "io_harness.c", 685, __PRETTY_FUNCTION__); 
# 687
...
# 699
static int io_info_bytesize(io_info_t *info, io_record_format_enum_t 
# 700
iorformat, size_t *
# 701
bs) { 
...
int err = 0; 
# 728
(info) ? static_cast< void>(0) : __assert_fail("info", "io_harness.c", 728, __PRETTY_FUNCTION__); 
# 729
(bs) ? static_cast< void>(0) : __assert_fail("bs", "io_harness.c", 729, __PRETTY_FUNCTION__); 
# 731
...
int err = 0; 
# 748
(info) ? static_cast< void>(0) : __assert_fail("info", "io_harness.c", 748, __PRETTY_FUNCTION__); 
# 749
(bs) ? static_cast< void>(0) : __assert_fail("bs", "io_harness.c", 749, __PRETTY_FUNCTION__); 
# 751
...
double t0, t1; 
# 775
(info) ? static_cast< void>(0) : __assert_fail("info", "io_harness.c", 775, __PRETTY_FUNCTION__); 
# 776
(data) ? static_cast< void>(0) : __assert_fail("data", "io_harness.c", 776, __PRETTY_FUNCTION__); 
# 778
...
# 790
pe_info(info->pe, "Write %lu bytes in %f secs %f GB/s\n", (info->nsites) * bytesize, t1 - t0, ((info->nsites) * bytesize) / ((1000000000.0) * (t1 - t0))); 
# 793
}  
# 794
}  
...
MPI_Status status; 
# 819
(obj) ? static_cast< void>(0) : __assert_fail("obj", "io_harness.c", 819, __PRETTY_FUNCTION__); 
# 820
(data) ? static_cast< void>(0) : __assert_fail("data", "io_harness.c", 820, __PRETTY_FUNCTION__); 
# 821
(obj->write_data) ? static_cast< void>(0) : __assert_fail("obj->write_data", "io_harness.c", 821, __PRETTY_FUNCTION__); 
# 823
...
{ 
# 838
MPI_Recv(&token, 1, MPI_INT, ((obj->io_comm)->rank) - 1, io_tag, (obj->io_comm)->comm, &status); 
# 840
fp_state = fopen(filename_io, "ab"); 
# 841
}  
# 843
if (fp_state == (__null)) { pe_fatal(obj->pe, "Failed to open %s\n", filename_io); }  
# 845
...
# 865
MPI_Ssend(&token, 1, MPI_INT, ((obj->io_comm)->rank) + 1, io_tag, (obj->io_comm)->comm); 
# 867
}  
# 869
return 0; 
...
MPI_Status status; 
# 914
(obj) ? static_cast< void>(0) : __assert_fail("obj", "io_harness.c", 914, __PRETTY_FUNCTION__); 
# 915
(data) ? static_cast< void>(0) : __assert_fail("data", "io_harness.c", 915, __PRETTY_FUNCTION__); 
# 916
(obj->write_data) ? static_cast< void>(0) : __assert_fail("obj->write_data", "io_harness.c", 916, __PRETTY_FUNCTION__); 
# 918
if ((obj->metadata_written) == 0) { io_write_metadata(obj); }  
# 920
cs_nlocal(obj->cs, nlocal); 
...
# 929
fp_buf = fopen("/dev/null", "w"); 
# 930
setvbuf(fp_buf, buf, 0, localsz); 
# 932
if ((buf == (__null)) || (fp_buf == (__null))) { 
# 933
...
# 958
if (io_buf == (__null)) { pe_fatal(obj->pe, "malloc(io_buf)\n"); }  
# 960
rbuf = ((char *)malloc((itemsz * (obj->maxlocal)) * sizeof(char))); 
# 961
if (rbuf == (__null)) { pe_fatal(obj->pe, "malloc(rbuf)\n"); }  
# 966
io_unpack_local_buf(obj, 0, buf, io_buf); 
# 968
for (nr = 0; nr < (((obj->io_comm)->size) - 1); nr++) { 
# 969
MPI_Recv(rbuf, itemsz * (obj->maxlocal), MPI_BYTE, -10, tag, (obj->io_comm)->comm, &status); 
# 971
...
# 987
offset = (((((obj->io_comm)->offset)[X]) * (((obj->io_comm)->nsite)[Y])) * (((obj->io_comm)->nsite)[Z])); 
# 989
fseek(fp_state, offset * itemsz, 0); 
# 990
}  
# 992
if (fp_state == (__null)) { 
...
# 1024 "io_harness.c"
int io_unpack_local_buf(io_info_t *obj, int mpi_sender, const char *buf, char *
# 1025
io_buf) { 
# 1026
int ib = 0; 
...
# 1038
(obj) ? static_cast< void>(0) : __assert_fail("obj", "io_harness.c", 1038, __PRETTY_FUNCTION__); 
# 1039
(buf) ? static_cast< void>(0) : __assert_fail("buf", "io_harness.c", 1039, __PRETTY_FUNCTION__); 
# 1040
(io_buf) ? static_cast< void>(0) : __assert_fail("io_buf", "io_harness.c", 1040, __PRETTY_FUNCTION__); 
# 1042
...
# 1068
offset = ((((ifo * (((obj->io_comm)->nsite)[Y])) * (((obj->io_comm)->nsite)[Z])) + (jfo * (((obj->io_comm)->nsite)[Z]))) + kfo); 
# 1071
...
MPI_Status status; 
# 1100
(obj) ? static_cast< void>(0) : __assert_fail("obj", "io_harness.c", 1100, __PRETTY_FUNCTION__); 
# 1101
(obj->read_data) ? static_cast< void>(0) : __assert_fail("obj->read_data", "io_harness.c", 1101, __PRETTY_FUNCTION__); 
# 1102
(filename_stub) ? static_cast< void>(0) : __assert_fail("filename_stub", "io_harness.c", 1102, __PRETTY_FUNCTION__); 
# 1103
(data) ? static_cast< void>(0) : __assert_fail("data", "io_harness.c", 1103, __PRETTY_FUNCTION__); 
# 1105
cs_nlocal(obj->cs, nlocal); 
# 1107
io_set_group_filename(filename_io, filename_stub, obj); 
...
{ 
# 1118
MPI_Recv(&token, 1, MPI_LONG, ((obj->io_comm)->rank) - 1, io_tag, (obj->io_comm)->comm, &status); 
# 1120
fp_state = fopen(filename_io, "r"); 
# 1121
}  
...
# 1131
if (obj->processor_independent) { fseek(fp_state, offset, 0); }  
# 1133
for (kc = 1; kc <= (nlocal[Z]); kc++) { 
# 1134
index = cs_index(obj->cs, ic, jc, kc); 
...
if (((obj->io_comm)->rank) < (((obj->io_comm)->size) - 1)) { 
# 1155
MPI_Ssend(&token, 1, MPI_LONG, ((obj->io_comm)->rank) + 1, io_tag, (obj->io_comm)->comm); 
# 1157
}  
# 1159
return 0; 
...
void io_info_single_file_set(io_info_t *info) { 
# 1170
(info) ? static_cast< void>(0) : __assert_fail("info", "io_harness.c", 1170, __PRETTY_FUNCTION__); 
# 1172
...
# 1185
(info) ? static_cast< void>(0) : __assert_fail("info", "io_harness.c", 1185, __PRETTY_FUNCTION__); 
# 1186
(stub) ? static_cast< void>(0) : __assert_fail("stub", "io_harness.c", 1186, __PRETTY_FUNCTION__); 
# 1187
(strlen(stub) < (4096)) ? static_cast< void>(0) : __assert_fail("strlen(stub) < 4096", "io_harness.c", 1187, __PRETTY_FUNCTION__); 
# 1189
strncpy(info->metadata_stub, stub, 4096); 
# 1191
return 0; 
# 1192
} 

# 1 "io_harness.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__18_io_harness_cpp1_ii_c46e89a0
# 1 "io_harness.cudafe1.stub.c"
#include "io_harness.cudafe1.stub.c"
# 1 "io_harness.cudafe1.stub.c"
