...
MPI_Comm comm; 
# 42
(obj) ? static_cast< void>(0) : __assert_fail("obj", "psi_stats.c", 42, __PRETTY_FUNCTION__); 
# 44
...
# 52
if (rho_min == (__null)) { pe_fatal(obj->pe, "calloc(rho_min) failed\n"); }  
# 53
if (rho_max == (__null)) { pe_fatal(obj->pe, "calloc(rho_max) failed\n"); }  
# 54
if (rho_tot == (__null)) { pe_fatal(obj->pe, "calloc(rho_tot) failed\n"); }  
# 58
...
# 90 "psi_stats.c"
int psi_stats_reduce(psi_t *obj, double *rho_min, double *rho_max, double *
# 91
rho_tot, int rank, MPI_Comm comm) { 
# 92
int nk, nrho; 
# 93
double *rho_min_local = (__null); 
# 94
double *rho_max_local = (__null); 
# 95
double *rho_tot_local = (__null); 
# 97
(obj) ? static_cast< void>(0) : __assert_fail("obj", "psi_stats.c", 97, __PRETTY_FUNCTION__); 
# 98
(rho_min) ? static_cast< void>(0) : __assert_fail("rho_min", "psi_stats.c", 98, __PRETTY_FUNCTION__); 
# 99
(rho_max) ? static_cast< void>(0) : __assert_fail("rho_max", "psi_stats.c", 99, __PRETTY_FUNCTION__); 
# 100
(rho_tot) ? static_cast< void>(0) : __assert_fail("rho_tot", "psi_stats.c", 100, __PRETTY_FUNCTION__); 
# 102
psi_nk(obj, &nk); 
# 103
nrho = (2 + nk); 
...
# 108
if (rho_min_local == (__null)) { pe_fatal(obj->pe, "calloc(rho_min_local) failed\n"); }  
# 109
if (rho_max_local == (__null)) { pe_fatal(obj->pe, "calloc(rho_max_local) failed\n"); }  
# 110
if (rho_tot_local == (__null)) { pe_fatal(obj->pe, "calloc(rho_tot_local) failed\n"); }  
# 112
...
# 143 "psi_stats.c"
int psi_stats_local(psi_t *obj, double *rho_min, double *rho_max, double *
# 144
rho_tot) { 
# 146
int ic, jc, kc, index; 
...
# 153
(obj) ? static_cast< void>(0) : __assert_fail("obj", "psi_stats.c", 153, __PRETTY_FUNCTION__); 
# 154
(rho_min) ? static_cast< void>(0) : __assert_fail("rho_min", "psi_stats.c", 154, __PRETTY_FUNCTION__); 
# 155
(rho_max) ? static_cast< void>(0) : __assert_fail("rho_max", "psi_stats.c", 155, __PRETTY_FUNCTION__); 
# 156
(rho_tot) ? static_cast< void>(0) : __assert_fail("rho_tot", "psi_stats.c", 156, __PRETTY_FUNCTION__); 
# 158
...
for (n = 0; n < nrho; n++) { 
# 163
(rho_min[n]) = ((double)(1.7976931348623157081e+308L)); 
# 164
(rho_max[n]) = (-((double)(1.7976931348623157081e+308L))); 
# 165
(rho_tot[n]) = (0.0); 
# 166
}  
...
# 1 "psi_stats.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__17_psi_stats_cpp1_ii_3b82aa90
# 1 "psi_stats.cudafe1.stub.c"
#include "psi_stats.cudafe1.stub.c"
# 1 "psi_stats.cudafe1.stub.c"
