...
# 81
(pe) ? static_cast< void>(0) : __assert_fail("pe", "test_hydro.c", 81, __PRETTY_FUNCTION__); 
# 82
(3 == 3) ? static_cast< void>(0) : __assert_fail("3 == 3", "test_hydro.c", 82, __PRETTY_FUNCTION__); 
# 84
cs_create(pe, &cs); 
# 85
cs_init(cs); 
...
# 89
(hydro) ? static_cast< void>(0) : __assert_fail("hydro", "test_hydro.c", 89, __PRETTY_FUNCTION__); 
# 91
...
# 94
(fabs((force[X]) - (check[X])) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(force[X] - check[X]) < double(2.22044604925031308085e-16L)", "test_hydro.c", 94, __PRETTY_FUNCTION__); 
# 95
(fabs((force[Y]) - (check[Y])) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(force[Y] - check[Y]) < double(2.22044604925031308085e-16L)", "test_hydro.c", 95, __PRETTY_FUNCTION__); 
# 96
(fabs((force[Z]) - (check[Z])) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(force[Z] - check[Z]) < double(2.22044604925031308085e-16L)", "test_hydro.c", 96, __PRETTY_FUNCTION__); 
# 98
hydro_u_set(hydro, index, u); 
# 99
hydro_u(hydro, index, check); 
# 100
(fabs((u[X]) - (check[X])) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(u[X] - check[X]) < double(2.22044604925031308085e-16L)", "test_hydro.c", 100, __PRETTY_FUNCTION__); 
# 101
(fabs((u[Y]) - (check[Y])) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(u[Y] - check[Y]) < double(2.22044604925031308085e-16L)", "test_hydro.c", 101, __PRETTY_FUNCTION__); 
# 102
(fabs((u[Z]) - (check[Z])) < ((double)(2.2204460492503130808e-16L))) ? static_cast< void>(0) : __assert_fail("fabs(u[Z] - check[Z]) < double(2.22044604925031308085e-16L)", "test_hydro.c", 102, __PRETTY_FUNCTION__); 
# 105
...
lees_edw_t *le = (__null); 
# 128
(pe) ? static_cast< void>(0) : __assert_fail("pe", "test_hydro.c", 128, __PRETTY_FUNCTION__); 
# 130
cs_create(pe, &cs); 
# 131
...
# 136
(hydro) ? static_cast< void>(0) : __assert_fail("hydro", "test_hydro.c", 136, __PRETTY_FUNCTION__); 
# 138
test_coords_field_set(cs, 3, hydro->u, MPI_DOUBLE, test_ref_double1); 
# 139
hydro_memcpy(hydro, hipMemcpyHostToDevice); 
# 141
hydro_u_halo(hydro); 
# 143
hydro_memcpy(hydro, hipMemcpyDeviceToHost); 
# 144
test_coords_field_check(cs, nhcomm, 3, hydro->u, MPI_DOUBLE, test_ref_double1); 
# 147
hydro_free(hydro); 
# 149
lees_edw_free(le); 
...
hydro_t *hydro = (__null); 
# 172
(pe) ? static_cast< void>(0) : __assert_fail("pe", "test_hydro.c", 172, __PRETTY_FUNCTION__); 
# 174
pe_mpi_comm(pe, &comm); 
# 176
cs_create(pe, &cs); 
...
# 185
hydro_create(pe, cs, __null, 1, &hydro); 
# 186
(hydro) ? static_cast< void>(0) : __assert_fail("hydro", "test_hydro.c", 186, __PRETTY_FUNCTION__); 
# 188
...
# 192
(iohandler) ? static_cast< void>(0) : __assert_fail("iohandler", "test_hydro.c", 192, __PRETTY_FUNCTION__); 
# 194
...
# 1 "test_hydro.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__18_test_hydro_cpp1_ii_48becd12
# 1 "test_hydro.cudafe1.stub.c"
#include "test_hydro.cudafe1.stub.c"
# 1 "test_hydro.cudafe1.stub.c"
