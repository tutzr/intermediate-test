...
rt_t *rt = (__null); 
# 81
(pe) ? static_cast< void>(0) : __assert_fail("pe", "runtime.c", 81, __PRETTY_FUNCTION__); 
# 83
rt = ((rt_t *)calloc(1, sizeof(rt_t))); 
# 84
(rt) ? static_cast< void>(0) : __assert_fail("rt", "runtime.c", 84, __PRETTY_FUNCTION__); 
# 85
if (rt == (__null)) { pe_fatal(pe, "calloc(rt) failed\n"); }  
# 87
(rt->pe) = pe; 
# 88
pe_retain(pe); 
...
int rt_free(rt_t *rt) { 
# 103
(rt) ? static_cast< void>(0) : __assert_fail("rt", "runtime.c", 103, __PRETTY_FUNCTION__); 
# 105
...
char line[128]; 
# 145
(rt) ? static_cast< void>(0) : __assert_fail("rt", "runtime.c", 145, __PRETTY_FUNCTION__); 
# 149
...
# 174
strncpy(rt->input_file, input_file_name, 4096); 
# 176
rt_key_broadcast(rt); 
# 178
return 0; 
...
int added = 0; 
# 194
(rt) ? static_cast< void>(0) : __assert_fail("rt", "runtime.c", 194, __PRETTY_FUNCTION__); 
# 195
(key) ? static_cast< void>(0) : __assert_fail("key", "runtime.c", 195, __PRETTY_FUNCTION__); 
# 196
(value) ? static_cast< void>(0) : __assert_fail("value", "runtime.c", 196, __PRETTY_FUNCTION__); 
# 200
nline = ((rt->nkeys) + 1); 
# 202
if ((strlen(key) + strlen(value)) >= (128 - 2)) { 
# 204
} else 
# 205
{ 
...
int rt_info(rt_t *rt) { 
# 227
(rt) ? static_cast< void>(0) : __assert_fail("rt", "runtime.c", 227, __PRETTY_FUNCTION__); 
# 229
...
static int rt_key_broadcast(rt_t *rt) { 
# 247
char *packed_keys = (__null); 
# 248
int nk = 0; 
# 249
MPI_Comm comm; 
# 251
(rt) ? static_cast< void>(0) : __assert_fail("rt", "runtime.c", 251, __PRETTY_FUNCTION__); 
# 252
...
if ((rt->nkeys) <= 1024) { 
# 259
packed_keys = ((char *)calloc((rt->nkeys) * 128, sizeof(char))); 
# 260
(packed_keys) ? static_cast< void>(0) : __assert_fail("packed_keys", "runtime.c", 260, __PRETTY_FUNCTION__); 
# 261
}  
# 263
if (packed_keys == (__null)) { pe_fatal(rt->pe, "malloc(packed_keys) failed\n"); }  
# 267
if (pe_mpi_rank(rt->pe) == 0) { 
# 268
...
# 271
strncpy(packed_keys + (nk * 128), key->key, 128); 
# 272
nk += 1; 
# 273
}  
...
# 276
MPI_Bcast(packed_keys, (rt->nkeys) * 128, MPI_CHAR, 0, comm); 
# 280
if (pe_mpi_rank(rt->pe) != 0) { 
# 281
for (nk = 0; nk < (rt->nkeys); nk++) { 
# 282
rt_add_key_pair(rt, packed_keys + (nk * 128), 0); 
# 283
}  
# 284
}  
...
char str_value[128]; 
# 304
(rt) ? static_cast< void>(0) : __assert_fail("rt", "runtime.c", 304, __PRETTY_FUNCTION__); 
# 306
...
char str_value[128]; 
# 325
(rt) ? static_cast< void>(0) : __assert_fail("rt", "runtime.c", 325, __PRETTY_FUNCTION__); 
# 327
key_present = rt_look_up_key(rt, key, str_value); 
# 328
...
char str_value[128]; 
# 346
(rt) ? static_cast< void>(0) : __assert_fail("rt", "runtime.c", 346, __PRETTY_FUNCTION__); 
# 348
key_present = rt_look_up_key(rt, key, str_value); 
# 350
if (key_present) { 
...
char str_value[128]; 
# 373
(rt) ? static_cast< void>(0) : __assert_fail("rt", "runtime.c", 373, __PRETTY_FUNCTION__); 
# 375
key_present = rt_look_up_key(rt, key, str_value); 
# 377
if (key_present) { 
...
# 396 "runtime.c"
int rt_string_parameter(rt_t *rt, const char *key, char *value, unsigned 
# 397
len) { 
# 399
int key_present = 0; 
...
char str_value[128]; 
# 402
(rt) ? static_cast< void>(0) : __assert_fail("rt", "runtime.c", 402, __PRETTY_FUNCTION__); 
# 404
key_present = rt_look_up_key(rt, key, str_value); 
# 406
if (key_present) { 
...
char str_value[128]; 
# 439
(rt) ? static_cast< void>(0) : __assert_fail("rt", "runtime.c", 439, __PRETTY_FUNCTION__); 
# 441
key_present = rt_look_up_key(rt, key, str_value); 
# 443
if (key_present) { 
...
int rt_active_keys(rt_t *rt, int *nactive) { 
# 464
key_pair_t *key = (__null); 
# 466
(rt) ? static_cast< void>(0) : __assert_fail("rt", "runtime.c", 466, __PRETTY_FUNCTION__); 
# 467
(*nactive) = 0; 
# 469
key = (rt->keylist); 
...
# 538
key_pair_t *pnew = (__null); 
# 540
(rt) ? static_cast< void>(0) : __assert_fail("rt", "runtime.c", 540, __PRETTY_FUNCTION__); 
# 542
pnew = ((key_pair_t *)calloc(1, sizeof(key_pair_t))); 
# 543
(pnew) ? static_cast< void>(0) : __assert_fail("pnew", "runtime.c", 543, __PRETTY_FUNCTION__); 
# 545
if (pnew == (__null)) { 
# 546
...
key_pair_t *pkey; 
# 578
(rt) ? static_cast< void>(0) : __assert_fail("rt", "runtime.c", 578, __PRETTY_FUNCTION__); 
# 580
pkey = (rt->keylist); 
# 582
...
# 1 "runtime.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__15_runtime_cpp1_ii_a1ad2f69
# 1 "runtime.cudafe1.stub.c"
#include "runtime.cudafe1.stub.c"
# 1 "runtime.cudafe1.stub.c"
