...
# 81 "coords_field.c"
int coords_field_init_mpi_indexed(cs_t *cs, int nhcomm, int nf, MPI_Datatype 
# 82
mpidata, MPI_Datatype 
# 83
halo[3]) { 
# 85
int ic, jc, n; 
...
int *displace; 
# 94
(cs) ? static_cast< void>(0) : __assert_fail("cs", "coords_field.c", 94, __PRETTY_FUNCTION__); 
# 96
cs_nhalo(cs, &nhalo); 
# 97
cs_nlocal(cs, nlocal); 
...
# 114
(blocklen) ? static_cast< void>(0) : __assert_fail("blocklen", "coords_field.c", 114, __PRETTY_FUNCTION__); 
# 115
(displace) ? static_cast< void>(0) : __assert_fail("displace", "coords_field.c", 115, __PRETTY_FUNCTION__); 
# 116
if (blocklen == (__null)) { pe_fatal(cs->pe, "calloc(blocklen) failed\n"); }  
# 117
if (displace == (__null)) { pe_fatal(cs->pe, "calloc(displace) failed\n"); }  
# 119
for (n = 0; n < ncount; n++) { 
# 120
...
displace = ((int *)calloc(ncount, sizeof(int))); 
# 145
(blocklen) ? static_cast< void>(0) : __assert_fail("blocklen", "coords_field.c", 145, __PRETTY_FUNCTION__); 
# 146
(displace) ? static_cast< void>(0) : __assert_fail("displace", "coords_field.c", 146, __PRETTY_FUNCTION__); 
# 147
if (blocklen == (__null)) { pe_fatal(cs->pe, "calloc(blocklen) failed\n"); }  
# 148
if (displace == (__null)) { pe_fatal(cs->pe, "calloc(displace) failed\n"); }  
...
displace = ((int *)calloc(ncount, sizeof(int))); 
# 177
(blocklen) ? static_cast< void>(0) : __assert_fail("blocklen", "coords_field.c", 177, __PRETTY_FUNCTION__); 
# 178
(displace) ? static_cast< void>(0) : __assert_fail("displace", "coords_field.c", 178, __PRETTY_FUNCTION__); 
# 179
if (blocklen == (__null)) { pe_fatal(cs->pe, "calloc(blocklen) failed\n"); }  
# 180
if (displace == (__null)) { pe_fatal(cs->pe, "calloc(displace) failed\n"); }  
...
# 207
int coords_field_halo_rank1(cs_t *cs, int nall, int nhcomm, int na, void *
# 208
mbuf, MPI_Datatype 
# 209
mpidata) { 
...
const int tagb = 2016; 
# 232
(cs) ? static_cast< void>(0) : __assert_fail("cs", "coords_field.c", 232, __PRETTY_FUNCTION__); 
# 233
(mbuf) ? static_cast< void>(0) : __assert_fail("mbuf", "coords_field.c", 233, __PRETTY_FUNCTION__); 
# 234
((mpidata == (MPI_CHAR)) || (mpidata == (MPI_DOUBLE))) ? static_cast< void>(0) : __assert_fail("mpidata == MPI_CHAR || mpidata == MPI_DOUBLE", "coords_field.c", 234, __PRETTY_FUNCTION__); 
# 236
...
# 251
(sendforw && sendback) ? static_cast< void>(0) : __assert_fail("sendforw && sendback", "coords_field.c", 251, __PRETTY_FUNCTION__); 
# 252
(recvforw && recvback) ? static_cast< void>(0) : __assert_fail("recvforw && recvback", "coords_field.c", 252, __PRETTY_FUNCTION__); 
# 253
if (sendforw == (__null)) { pe_fatal(cs->pe, "malloc(sendforw) failed\n"); }  
# 254
if (sendback == (__null)) { pe_fatal(cs->pe, "malloc(sendback) failed\n"); }  
# 255
if (recvforw == (__null)) { pe_fatal(cs->pe, "malloc(recvforw) failed\n"); }  
# 256
if (recvback == (__null)) { pe_fatal(cs->pe, "malloc(recvback) failed\n"); }  
# 260
icount = 0; 
# 262
...
# 268
ireal = reverse_addr_rank1_assert(268, "coords_field.c", nall, na, index, ia); 
# 269
memcpy(sendback + (icount * sz), buf + (ireal * sz), sz); 
# 271
index = cs_index(cs, (nlocal[X]) - nh, jc, kc); 
# 272
ireal = reverse_addr_rank1_assert(272, "coords_field.c", nall, na, index, ia); 
# 273
...
# 280
(icount == nsend) ? static_cast< void>(0) : __assert_fail("icount == nsend", "coords_field.c", 280, __PRETTY_FUNCTION__); 
# 282
...
# 308
ihalo = reverse_addr_rank1_assert(308, "coords_field.c", nall, na, index, ia); 
# 309
memcpy(buf + (ihalo * sz), recvforw + (icount * sz), sz); 
# 310
index = cs_index(cs, 0 - nh, jc, kc); 
# 311
ihalo = reverse_addr_rank1_assert(311, "coords_field.c", nall, na, index, ia); 
# 312
...
# 319
(icount == nsend) ? static_cast< void>(0) : __assert_fail("icount == nsend", "coords_field.c", 319, __PRETTY_FUNCTION__); 
# 321
free(recvback); 
# 322
free(recvforw); 
...
recvback = ((unsigned char *)malloc(nsend * sz)); 
# 336
(sendforw && sendback) ? static_cast< void>(0) : __assert_fail("sendforw && sendback", "coords_field.c", 336, __PRETTY_FUNCTION__); 
# 337
(recvforw && recvback) ? static_cast< void>(0) : __assert_fail("recvforw && recvback", "coords_field.c", 337, __PRETTY_FUNCTION__); 
# 338
if (sendforw == (__null)) { pe_fatal(cs->pe, "malloc(sendforw) failed\n"); }  
# 339
if (sendback == (__null)) { pe_fatal(cs->pe, "malloc(sendback) failed\n"); }  
...
# 352
ireal = reverse_addr_rank1_assert(352, "coords_field.c", nall, na, index, ia); 
# 353
memcpy(sendback + (icount * sz), buf + (ireal * sz), sz); 
# 354
index = cs_index(cs, ic, (nlocal[Y]) - nh, kc); 
# 355
ireal = reverse_addr_rank1_assert(355, "coords_field.c", nall, na, index, ia); 
# 356
memcpy(sendforw + (icount * sz), buf + (ireal * sz), sz); 
# 357
icount += 1; 
...
# 363
(icount == nsend) ? static_cast< void>(0) : __assert_fail("icount == nsend", "coords_field.c", 363, __PRETTY_FUNCTION__); 
# 365
...
# 391
ihalo = reverse_addr_rank1_assert(391, "coords_field.c", nall, na, index, ia); 
# 392
memcpy(buf + (ihalo * sz), recvback + (icount * sz), sz); 
# 393
index = cs_index(cs, ic, ((nlocal[Y]) + 1) + nh, kc); 
# 394
ihalo = reverse_addr_rank1_assert(394, "coords_field.c", nall, na, index, ia); 
# 395
memcpy(buf + (ihalo * sz), recvforw + (icount * sz), sz); 
# 396
icount += 1; 
...
# 402
(icount == nsend) ? static_cast< void>(0) : __assert_fail("icount == nsend", "coords_field.c", 402, __PRETTY_FUNCTION__); 
# 404
free(recvback); 
# 405
free(recvforw); 
...
recvback = ((unsigned char *)malloc(nsend * sz)); 
# 419
(sendforw && sendback) ? static_cast< void>(0) : __assert_fail("sendforw && sendback", "coords_field.c", 419, __PRETTY_FUNCTION__); 
# 420
(recvforw && recvback) ? static_cast< void>(0) : __assert_fail("recvforw && recvback", "coords_field.c", 420, __PRETTY_FUNCTION__); 
# 421
if (sendforw == (__null)) { pe_fatal(cs->pe, "malloc(sendforw) failed\n"); }  
# 422
if (sendback == (__null)) { pe_fatal(cs->pe, "malloc(sendback) failed\n"); }  
...
# 437
ireal = reverse_addr_rank1_assert(437, "coords_field.c", nall, na, index, ia); 
# 438
memcpy(sendback + (icount * sz), buf + (ireal * sz), sz); 
# 439
...
index = cs_index(cs, ic, jc, kc); 
# 441
ireal = reverse_addr_rank1_assert(441, "coords_field.c", nall, na, index, ia); 
# 442
memcpy(sendforw + (icount * sz), buf + (ireal * sz), sz); 
# 443
icount += 1; 
...
# 449
(icount == nsend) ? static_cast< void>(0) : __assert_fail("icount == nsend", "coords_field.c", 449, __PRETTY_FUNCTION__); 
# 451
...
# 477
ihalo = reverse_addr_rank1_assert(477, "coords_field.c", nall, na, index, ia); 
# 478
memcpy(buf + (ihalo * sz), recvback + (icount * sz), sz); 
# 479
index = cs_index(cs, ic, jc, ((nlocal[Z]) + 1) + nh); 
# 480
ihalo = reverse_addr_rank1_assert(480, "coords_field.c", nall, na, index, ia); 
# 481
memcpy(buf + (ihalo * sz), recvforw + (icount * sz), sz); 
# 482
icount += 1; 
...
# 488
(icount == nsend) ? static_cast< void>(0) : __assert_fail("icount == nsend", "coords_field.c", 488, __PRETTY_FUNCTION__); 
# 490
free(recvback); 
# 491
free(recvforw); 
...
# 1 "coords_field.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__20_coords_field_cpp1_ii_7e85f9a1
# 1 "coords_field.cudafe1.stub.c"
#include "coords_field.cudafe1.stub.c"
# 1 "coords_field.cudafe1.stub.c"
