...
# 30 "test_pair_lj_cut.c"
int test_pair_lj_cut1(pe_t * pe, cs_t * cs); 
# 31
int test_pair_lj_cut2(pe_t * pe, cs_t * cs); 
# 32
int test_pair_config1(colloids_info_t * cinfo, interact_t * interact, pair_lj_cut_t * lj); 
# 41
...
# 72
(lj) ? static_cast< void>(0) : __assert_fail("lj", "test_pair_lj_cut.c", 72, __PRETTY_FUNCTION__); 
# 74
pair_lj_cut_param_set(lj, (1.0), (1.0), (3.0)); 
# 76
h = (1.0); 
# 77
pair_lj_cut_single(lj, h, &f, &v); 
# 78
(fabs(f - (24.01094382999999866)) < ((1.192092896e-07F))) ? static_cast< void>(0) : __assert_fail("fabs(f - 24.01094383) < 1.19209289550781250000e-7F", "test_pair_lj_cut.c", 78, __PRETTY_FUNCTION__); 
# 79
(fabs(v - (0.02736710200000000079)) < ((1.192092896e-07F))) ? static_cast< void>(0) : __assert_fail("fabs(v - 0.027367102) < 1.19209289550781250000e-7F", "test_pair_lj_cut.c", 79, __PRETTY_FUNCTION__); 
# 81
h = (pow((2.0), (1.0) / (6.0)) * (1.0)); 
# 82
pair_lj_cut_single(lj, h, &f, &v); 
# 83
(fabs(f - (0.01094382999999999988)) < ((1.192092896e-07F))) ? static_cast< void>(0) : __assert_fail("fabs(f - 0.010943830) < 1.19209289550781250000e-7F", "test_pair_lj_cut.c", 83, __PRETTY_FUNCTION__); 
# 84
(fabs(v - (-(0.973973100000000036))) < ((1.192092896e-07F))) ? static_cast< void>(0) : __assert_fail("fabs(v - -0.97397310) < 1.19209289550781250000e-7F", "test_pair_lj_cut.c", 84, __PRETTY_FUNCTION__); 
# 86
h = (3.0); 
# 87
pair_lj_cut_single(lj, h, &f, &v); 
# 88
(fabs(f - (0.0)) < ((1.192092896e-07F))) ? static_cast< void>(0) : __assert_fail("fabs(f - 0.0) < 1.19209289550781250000e-7F", "test_pair_lj_cut.c", 88, __PRETTY_FUNCTION__); 
# 89
(fabs(v - (0.0)) < ((1.192092896e-07F))) ? static_cast< void>(0) : __assert_fail("fabs(v - 0.0) < 1.19209289550781250000e-7F", "test_pair_lj_cut.c", 89, __PRETTY_FUNCTION__); 
# 91
pair_lj_cut_free(lj); 
# 93
return 0; 
...
# 107
interact_t *interact = (__null); 
# 108
pair_lj_cut_t *lj = (__null); 
# 110
(pe) ? static_cast< void>(0) : __assert_fail("pe", "test_pair_lj_cut.c", 110, __PRETTY_FUNCTION__); 
# 111
(cs) ? static_cast< void>(0) : __assert_fail("cs", "test_pair_lj_cut.c", 111, __PRETTY_FUNCTION__); 
# 113
...
pair_lj_cut_create(pe, cs, &lj); 
# 117
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "test_pair_lj_cut.c", 117, __PRETTY_FUNCTION__); 
# 118
(interact) ? static_cast< void>(0) : __assert_fail("interact", "test_pair_lj_cut.c", 118, __PRETTY_FUNCTION__); 
# 119
(lj) ? static_cast< void>(0) : __assert_fail("lj", "test_pair_lj_cut.c", 119, __PRETTY_FUNCTION__); 
# 121
pair_lj_cut_param_set(lj, (1.0), (1.0), (3.0)); 
# 122
...
# 141
int test_pair_config1(colloids_info_t *cinfo, interact_t *
# 142
interact, pair_lj_cut_t *
# 143
lj) { 
# 145
int nc; 
...
double ah = (1.25); 
# 148
double dh = (0.1000000000000000056); 
# 149
double h, f, v; 
# 150
double r1[3]; 
...
MPI_Comm comm; 
# 158
colloid_t *pc1 = (__null); 
# 159
colloid_t *pc2 = (__null); 
# 161
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "test_pair_lj_cut.c", 161, __PRETTY_FUNCTION__); 
# 162
(interact) ? static_cast< void>(0) : __assert_fail("interact", "test_pair_lj_cut.c", 162, __PRETTY_FUNCTION__); 
# 163
(lj) ? static_cast< void>(0) : __assert_fail("lj", "test_pair_lj_cut.c", 163, __PRETTY_FUNCTION__); 
# 165
...
# 191
(nc == 2) ? static_cast< void>(0) : __assert_fail("nc == 2", "test_pair_lj_cut.c", 191, __PRETTY_FUNCTION__); 
# 193
...
# 201
(fabs(((pc1->force)[X]) - (0.01874389599999999947)) < ((1.192092896e-07F))) ? static_cast< void>(0) : __assert_fail("fabs(pc1->force[X] - 0.018743896) < 1.19209289550781250000e-7F", "test_pair_lj_cut.c", 201, __PRETTY_FUNCTION__); 
# 202
(fabs(((pc1->force)[Y]) - (0.0)) < ((1.192092896e-07F))) ? static_cast< void>(0) : __assert_fail("fabs(pc1->force[Y] - 0.0) < 1.19209289550781250000e-7F", "test_pair_lj_cut.c", 202, __PRETTY_FUNCTION__); 
# 203
(fabs(((pc1->force)[Z]) - (0.0)) < ((1.192092896e-07F))) ? static_cast< void>(0) : __assert_fail("fabs(pc1->force[Z] - 0.0) < 1.19209289550781250000e-7F", "test_pair_lj_cut.c", 203, __PRETTY_FUNCTION__); 
# 205
(fabs(((pc2->force)[X]) + (0.01874389599999999947)) < ((1.192092896e-07F))) ? static_cast< void>(0) : __assert_fail("fabs(pc2->force[X] + 0.018743896) < 1.19209289550781250000e-7F", "test_pair_lj_cut.c", 205, __PRETTY_FUNCTION__); 
# 206
(fabs(((pc2->force)[Y]) + (0.0)) < ((1.192092896e-07F))) ? static_cast< void>(0) : __assert_fail("fabs(pc2->force[Y] + 0.0) < 1.19209289550781250000e-7F", "test_pair_lj_cut.c", 206, __PRETTY_FUNCTION__); 
# 207
(fabs(((pc2->force)[Z]) + (0.0)) < ((1.192092896e-07F))) ? static_cast< void>(0) : __assert_fail("fabs(pc2->force[Z] + 0.0) < 1.19209289550781250000e-7F", "test_pair_lj_cut.c", 207, __PRETTY_FUNCTION__); 
# 208
}  
# 210
pair_lj_cut_stats(lj, stats_local); 
# 212
MPI_Allreduce(stats_local, stats, INTERACT_STAT_MAX, MPI_DOUBLE, MPI_SUM, comm); 
# 215
(fabs((stats[INTERACT_STAT_VLOCAL]) - v) < ((1.192092896e-07F))) ? static_cast< void>(0) : __assert_fail("fabs(stats[INTERACT_STAT_VLOCAL] - v) < 1.19209289550781250000e-7F", "test_pair_lj_cut.c", 215, __PRETTY_FUNCTION__); 
# 217
MPI_Allreduce(stats_local, stats, INTERACT_STAT_MAX, MPI_DOUBLE, MPI_MIN, comm); 
# 220
(fabs((stats[INTERACT_STAT_RMINLOCAL]) - h) < ((1.192092896e-07F))) ? static_cast< void>(0) : __assert_fail("fabs(stats[INTERACT_STAT_RMINLOCAL] - h) < 1.19209289550781250000e-7F", "test_pair_lj_cut.c", 220, __PRETTY_FUNCTION__); 
# 221
(fabs((stats[INTERACT_STAT_HMINLOCAL]) - dh) < ((1.192092896e-07F))) ? static_cast< void>(0) : __assert_fail("fabs(stats[INTERACT_STAT_HMINLOCAL] - dh) < 1.19209289550781250000e-7F", "test_pair_lj_cut.c", 221, __PRETTY_FUNCTION__); 
# 223
return 0; 
# 224
} 

# 1 "test_pair_lj_cut.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__24_test_pair_lj_cut_cpp1_ii_f65baa0f
# 1 "test_pair_lj_cut.cudafe1.stub.c"
#include "test_pair_lj_cut.cudafe1.stub.c"
# 1 "test_pair_lj_cut.cudafe1.stub.c"
