...
# 7 "driven_colloid_rt.h"
int driven_colloid_runtime(pe_t * pe, rt_t * rt); 
# 13 "driven_colloid_rt.c"
int driven_colloid_runtime(pe_t *pe, rt_t *rt) { 
# 15
int n; 
# 16
double f0 = (0.0); 
# 18
(pe) ? static_cast< void>(0) : __assert_fail("pe", "driven_colloid_rt.c", 18, __PRETTY_FUNCTION__); 
# 19
(rt) ? static_cast< void>(0) : __assert_fail("rt", "driven_colloid_rt.c", 19, __PRETTY_FUNCTION__); 
# 21
...
# 1 "driven_colloid_rt.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__25_driven_colloid_rt_cpp1_ii_28d6c845
# 1 "driven_colloid_rt.cudafe1.stub.c"
#include "driven_colloid_rt.cudafe1.stub.c"
# 1 "driven_colloid_rt.cudafe1.stub.c"
