...
MPI_Comm comm; 
# 53
(lb) ? static_cast< void>(0) : __assert_fail("lb", "stats_distribution.c", 53, __PRETTY_FUNCTION__); 
# 54
(map) ? static_cast< void>(0) : __assert_fail("map", "stats_distribution.c", 54, __PRETTY_FUNCTION__); 
# 56
...
(stat_local[2]) = (0.0); 
# 62
(stat_local[3]) = (+((double)(1.7976931348623157081e+308L))); 
# 63
(stat_local[4]) = (-((double)(1.7976931348623157081e+308L))); 
# 65
...
MPI_Comm comm; 
# 121
(lb) ? static_cast< void>(0) : __assert_fail("lb", "stats_distribution.c", 121, __PRETTY_FUNCTION__); 
# 122
(map) ? static_cast< void>(0) : __assert_fail("map", "stats_distribution.c", 122, __PRETTY_FUNCTION__); 
# 123
(g) ? static_cast< void>(0) : __assert_fail("g", "stats_distribution.c", 123, __PRETTY_FUNCTION__); 
# 125
pe_mpi_comm(lb->pe, &comm); 
# 126
cs_nlocal(lb->cs, nlocal); 
...
# 1 "stats_distribution.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__26_stats_distribution_cpp1_ii_587dcdca
# 1 "stats_distribution.cudafe1.stub.c"
#include "stats_distribution.cudafe1.stub.c"
# 1 "stats_distribution.cudafe1.stub.c"
