...
typedef 
# 31
enum wall_init_enum { WALL_INIT_COUNT_ONLY, 
# 32
WALL_INIT_ALLOCATE} wall_init_enum_t; 
# 37
typedef 
# 34
enum wall_uw_enum { WALL_UZERO, 
# 35
WALL_UWTOP, 
# 36
WALL_UWBOT, 
...
# 59
void wall_setu_kernel(wall_t * wall, lb_t * lb); 
# 60
void wall_bbl_kernel(wall_t * wall, lb_t * lb, map_t * map); 
# 62
static wall_param_t static_param; 
# 70
int wall_create(pe_t *pe, cs_t *cs, map_t *map, lb_t *lb, wall_t **
# 71
p) { 
# 73
int ndevice; 
...
wall_t *wall = (__null); 
# 76
(pe) ? static_cast< void>(0) : __assert_fail("pe", "wall.c", 76, __PRETTY_FUNCTION__); 
# 77
(cs) ? static_cast< void>(0) : __assert_fail("cs", "wall.c", 77, __PRETTY_FUNCTION__); 
# 78
(p) ? static_cast< void>(0) : __assert_fail("p", "wall.c", 78, __PRETTY_FUNCTION__); 
# 80
wall = ((wall_t *)calloc(1, sizeof(wall_t))); 
# 81
(wall) ? static_cast< void>(0) : __assert_fail("wall", "wall.c", 81, __PRETTY_FUNCTION__); 
# 82
if (wall == (__null)) { pe_fatal(pe, "calloc(wall_t) failed\n"); }  
# 84
(wall->param) = ((wall_param_t *)calloc(1, sizeof(wall_param_t))); 
# 85
if ((wall->param) == (__null)) { pe_fatal(pe, "calloc(wall_param_t) failed\n"); }  
# 87
(wall->pe) = pe; 
# 88
(wall->cs) = cs; 
...
{ 
# 102
wall_param_t *tmp = (__null); 
# 104
tdpMalloc((void **)(&(wall->target)), sizeof(wall_t)); 
# 105
tdpMemset(wall->target, 0, sizeof(wall_t)); 
# 106
{ tdpErrorHandler(hipGetSymbolAddress((void **)(&tmp), &static_param), "wall.c", 106, 1); } ; 
# 107
tdpMemcpy(&((wall->target)->param), &tmp, sizeof(wall_param_t *), hipMemcpyHostToDevice); 
# 109
}  
# 111
(*p) = wall; 
...
int wall_free(wall_t *wall) { 
# 124
(wall) ? static_cast< void>(0) : __assert_fail("wall", "wall.c", 124, __PRETTY_FUNCTION__); 
# 126
if ((wall->target) != wall) { 
# 127
int *tmp; 
# 128
tdpMemcpy(&tmp, &((wall->target)->linki), sizeof(int *), hipMemcpyDeviceToHost); 
# 130
tdpFree(tmp); 
# 131
tdpMemcpy(&tmp, &((wall->target)->linkj), sizeof(int *), hipMemcpyDeviceToHost); 
# 133
tdpFree(tmp); 
# 134
tdpMemcpy(&tmp, &((wall->target)->linkp), sizeof(int *), hipMemcpyDeviceToHost); 
# 136
tdpFree(tmp); 
# 137
tdpMemcpy(&tmp, &((wall->target)->linku), sizeof(int *), hipMemcpyDeviceToHost); 
# 139
tdpFree(tmp); 
# 140
tdpFree(wall->target); 
...
# 162
(wall) ? static_cast< void>(0) : __assert_fail("wall", "wall.c", 162, __PRETTY_FUNCTION__); 
# 163
(param) ? static_cast< void>(0) : __assert_fail("param", "wall.c", 163, __PRETTY_FUNCTION__); 
# 165
(*(wall->param)) = (*param); 
# 167
wall_init_map(wall); 
...
wall_init_uw(wall); 
# 173
map_memcpy(wall->map, hipMemcpyHostToDevice); 
# 175
return 0; 
# 176
} 
...
MPI_Comm comm; 
# 192
(wall) ? static_cast< void>(0) : __assert_fail("wall", "wall.c", 192, __PRETTY_FUNCTION__); 
# 194
pe = (wall->pe); 
# 196
pe_mpi_comm(pe, &comm); 
...
pe_info(pe, "--------------\n"); 
# 203
pe_info(pe, "Boundary walls:                  %1s %1s %1s\n", ((((wall->param)->isboundary)[X]) == 1) ? "X" : ("-"), ((((wall->param)->isboundary)[Y]) == 1) ? "Y" : ("-"), ((((wall->param)->isboundary)[Z]) == 1) ? "Z" : ("-")); 
# 207
...
int wall_target(wall_t *wall, wall_t **target) { 
# 239
(wall) ? static_cast< void>(0) : __assert_fail("wall", "wall.c", 239, __PRETTY_FUNCTION__); 
# 240
(target) ? static_cast< void>(0) : __assert_fail("target", "wall.c", 240, __PRETTY_FUNCTION__); 
# 242
(*target) = (wall->target); 
# 244
return 0; 
...
int wall_param_set(wall_t *wall, wall_param_t *values) { 
# 255
(wall) ? static_cast< void>(0) : __assert_fail("wall", "wall.c", 255, __PRETTY_FUNCTION__); 
# 256
(values) ? static_cast< void>(0) : __assert_fail("values", "wall.c", 256, __PRETTY_FUNCTION__); 
# 258
(*(wall->param)) = (*values); 
# 260
return 0; 
...
# 271
(wall) ? static_cast< void>(0) : __assert_fail("wall", "wall.c", 271, __PRETTY_FUNCTION__); 
# 272
(values) ? static_cast< void>(0) : __assert_fail("values", "wall.c", 272, __PRETTY_FUNCTION__); 
# 274
(*values) = (*(wall->param)); 
# 276
return 0; 
...
int ndevice; 
# 300
(wall) ? static_cast< void>(0) : __assert_fail("wall", "wall.c", 300, __PRETTY_FUNCTION__); 
# 302
tdpGetDeviceCount(&ndevice); 
# 304
if (init == (WALL_INIT_ALLOCATE)) { 
# 305
nlink = imax(1, wall->nlink); 
# 306
(nlink > 0) ? static_cast< void>(0) : __assert_fail("nlink > 0", "wall.c", 306, __PRETTY_FUNCTION__); 
# 307
...
# 311
(wall->linki) ? static_cast< void>(0) : __assert_fail("wall->linki", "wall.c", 311, __PRETTY_FUNCTION__); 
# 312
(wall->linkj) ? static_cast< void>(0) : __assert_fail("wall->linkj", "wall.c", 312, __PRETTY_FUNCTION__); 
# 313
(wall->linkp) ? static_cast< void>(0) : __assert_fail("wall->linkp", "wall.c", 313, __PRETTY_FUNCTION__); 
# 314
(wall->linku) ? static_cast< void>(0) : __assert_fail("wall->linku", "wall.c", 314, __PRETTY_FUNCTION__); 
# 315
if ((wall->linki) == (__null)) { pe_fatal(wall->pe, "calloc(wall->linki) failed\n"); }  
# 316
if ((wall->linkj) == (__null)) { pe_fatal(wall->pe, "calloc(wall->linkj) failed\n"); }  
# 317
if ((wall->linkp) == (__null)) { pe_fatal(wall->pe, "calloc(wall->linkp) failed\n"); }  
# 318
if ((wall->linku) == (__null)) { pe_fatal(wall->pe, "calloc(wall->linku) failed\n"); }  
# 319
if (ndevice > 0) { 
# 320
int tmp; 
...
# 322
tdpMemcpy(&((wall->target)->linki), &tmp, sizeof(int *), hipMemcpyHostToDevice); 
# 324
tdpMalloc((void **)(&tmp), (wall->nlink) * sizeof(int)); 
# 325
tdpMemcpy(&((wall->target)->linkj), &tmp, sizeof(int *), hipMemcpyHostToDevice); 
# 327
tdpMalloc((void **)(&tmp), (wall->nlink) * sizeof(int)); 
# 328
tdpMemcpy(&((wall->target)->linkp), &tmp, sizeof(int *), hipMemcpyHostToDevice); 
# 330
tdpMalloc((void **)(&tmp), (wall->nlink) * sizeof(int)); 
# 331
tdpMemcpy(&((wall->target)->linku), &tmp, sizeof(int *), hipMemcpyHostToDevice); 
# 333
}  
# 334
}  
...
if (init == (WALL_INIT_ALLOCATE)) { 
# 374
(nlink == (wall->nlink)) ? static_cast< void>(0) : __assert_fail("nlink == wall->nlink", "wall.c", 374, __PRETTY_FUNCTION__); 
# 375
wall_memcpy(wall, hipMemcpyHostToDevice); 
# 376
}  
# 377
(wall->nlink) = nlink; 
...
int ndevice; 
# 392
(wall) ? static_cast< void>(0) : __assert_fail("wall", "wall.c", 392, __PRETTY_FUNCTION__); 
# 394
tdpGetDeviceCount(&ndevice); 
# 396
if (ndevice == 0) { 
# 397
((wall->target) == wall) ? static_cast< void>(0) : __assert_fail("wall->target == wall", "wall.c", 397, __PRETTY_FUNCTION__); 
# 398
} else 
# 399
{ 
...
case hipMemcpyDeviceToHost:  
# 429
(0) ? static_cast< void>(0) : __assert_fail("0", "wall.c", 429, __PRETTY_FUNCTION__); 
# 430
break; 
# 431
default:  
...
int nwall; 
# 453
(wall) ? static_cast< void>(0) : __assert_fail("wall", "wall.c", 453, __PRETTY_FUNCTION__); 
# 455
nwall = (((((wall->param)->isboundary)[X]) + (((wall->param)->isboundary)[Y])) + (((wall->param)->isboundary)[Z])); 
# 458
if (nwall == 1) { 
# 460
iw = (-1); 
...
# 464
(((iw == (X)) || (iw == (Y))) || (iw == (Z))) ? static_cast< void>(0) : __assert_fail("iw == X || iw == Y || iw == Z", "wall.c", 464, __PRETTY_FUNCTION__); 
# 466
...
dim3 nblk, ntpb; 
# 487
(wall) ? static_cast< void>(0) : __assert_fail("wall", "wall.c", 487, __PRETTY_FUNCTION__); 
# 488
(wall->target) ? static_cast< void>(0) : __assert_fail("wall->target", "wall.c", 488, __PRETTY_FUNCTION__); 
# 490
if ((wall->nlink) == 0) { return 0; }  
# 492
kernel_launch_param(wall->nlink, &nblk, &ntpb); 
# 494
do { (__cudaPushCallConfiguration(nblk, ntpb, 0, 0)) ? (void)0 : wall_setu_kernel(wall->target, (wall->lb)->target); } while (0); 
# 495
; 
# 497
...
# 520
(wall) ? static_cast< void>(0) : __assert_fail("wall", "wall.c", 520, __PRETTY_FUNCTION__); 
# 521
(lb) ? static_cast< void>(0) : __assert_fail("lb", "wall.c", 521, __PRETTY_FUNCTION__); 
# 523
n = ((1) * (((__device_builtin_variable_blockIdx.x) * (__device_builtin_variable_blockDim.x)) + (__device_builtin_variable_threadIdx.x))); if (n < (wall->nlink)) { 
# 525
p = ((NVEL) - ((wall->linkp)[n])); 
# 526
...
dim3 nblk, ntpb; 
# 546
(wall) ? static_cast< void>(0) : __assert_fail("wall", "wall.c", 546, __PRETTY_FUNCTION__); 
# 547
(wall->target) ? static_cast< void>(0) : __assert_fail("wall->target", "wall.c", 547, __PRETTY_FUNCTION__); 
# 549
if ((wall->nlink) == 0) { return 0; }  
# 552
{ tdpErrorHandler(hipMemcpyToSymbol(&static_param, wall->param, sizeof(wall_param_t), 0, hipMemcpyHostToDevice), "wall.c", 553, 1); 
# 552 "wall.c"
} 
# 553
; 
...
kernel_launch_param(wall->nlink, &nblk, &ntpb); 
# 557
do { (__cudaPushCallConfiguration(nblk, ntpb, 0, 0)) ? (void)0 : wall_bbl_kernel(wall->target, (wall->lb)->target, (wall->map)->target); } while (0); 
# 558
; 
# 560
{ tdpErrorHandler(tdpPeekAtLastError(), "wall.c", 560, 1); } ; 
# 561
{ tdpErrorHandler(tdpDeviceSynchronize(), "wall.c", 561, 1); } ; 
# 563
return 0; 
# 564
} 
...
const double rcs2 = (3.0); 
# 589
(wall) ? static_cast< void>(0) : __assert_fail("wall", "wall.c", 589, __PRETTY_FUNCTION__); 
# 590
(lb) ? static_cast< void>(0) : __assert_fail("lb", "wall.c", 590, __PRETTY_FUNCTION__); 
# 591
(map) ? static_cast< void>(0) : __assert_fail("map", "wall.c", 591, __PRETTY_FUNCTION__); 
# 595
for (ib = 0; ib < 3; ib++) { 
# 596
...
ia = ((wall->linku)[n]); 
# 621
cdotu = (((((((lb->param)->cv)[ij])[X]) * ((uw[ia])[X])) + (((((lb->param)->cv)[ij])[Y]) * ((uw[ia])[Y]))) + (((((lb->param)->cv)[ij])[Z]) * ((uw[ia])[Z]))); 
# 625
...
int nextra; 
# 701
(wall) ? static_cast< void>(0) : __assert_fail("wall", "wall.c", 701, __PRETTY_FUNCTION__); 
# 703
...
# 754
(wall) ? static_cast< void>(0) : __assert_fail("wall", "wall.c", 754, __PRETTY_FUNCTION__); 
# 756
((wall->fnet)[X]) += (f[X]); 
# 757
((wall->fnet)[Y]) += (f[Y]); 
...
double ftmp[3]; 
# 777
(wall) ? static_cast< void>(0) : __assert_fail("wall", "wall.c", 777, __PRETTY_FUNCTION__); 
# 787 "wall.c"
tdpGetDeviceCount(&ndevice); 
# 789
if (ndevice > 0) { 
# 790
tdpMemcpy(ftmp, (wall->target)->fnet, (3) * sizeof(double), hipMemcpyDeviceToHost); 
# 792
((wall->fnet)[X]) += (ftmp[X]); 
# 793
((wall->fnet)[Y]) += (ftmp[Y]); 
...
# 796
tdpMemcpy((wall->target)->fnet, ftmp, (3) * sizeof(double), hipMemcpyHostToDevice); 
# 798
}  
# 802
(f[X]) = ((wall->fnet)[X]); 
...
int wall_is_pm(wall_t *wall, int *ispm) { 
# 817
(wall) ? static_cast< void>(0) : __assert_fail("wall", "wall.c", 817, __PRETTY_FUNCTION__); 
# 819
...
int wall_present(wall_t *wall) { 
# 832
wall_param_t *wp = (__null); 
# 834
(wall) ? static_cast< void>(0) : __assert_fail("wall", "wall.c", 834, __PRETTY_FUNCTION__); 
# 836
wp = (wall->param); 
# 837
...
int wall_present_dim(wall_t *wall, int iswall[3]) { 
# 848
(wall) ? static_cast< void>(0) : __assert_fail("wall", "wall.c", 848, __PRETTY_FUNCTION__); 
# 850
...
# 885
(wall) ? static_cast< void>(0) : __assert_fail("wall", "wall.c", 885, __PRETTY_FUNCTION__); 
# 888
...
# 974 "wall.c"
int wall_lubr_sphere(wall_t *wall, double ah, const double r[3], double *
# 975
drag) { 
# 977
double hlub; 
...
# 1 "wall.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__12_wall_cpp1_ii_6b8ce1bf
# 1 "wall.cudafe1.stub.c"
#include "wall.cudafe1.stub.c"
# 1 "wall.cudafe1.stub.c"
