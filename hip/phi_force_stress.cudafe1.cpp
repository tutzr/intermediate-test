...
# 29 "phi_force_stress.c"
void pth_kernel(kernel_ctxt_t * ktx, pth_t * pth, fe_t * fe); 
# 30
void pth_kernel_v(kernel_ctxt_t * ktx, pth_t * pth, fe_t * fe); 
# 31
void pth_kernel_a_v(kernel_ctxt_t * ktx, pth_t * pth, fe_t * fe); 
# 42 "phi_force_stress.c"
int pth_create(pe_t *pe, cs_t *cs, int method, pth_t **pobj) { 
# 44
int ndevice; 
# 45
double *tmp; 
...
pth_t *obj = (__null); 
# 48
(pobj) ? static_cast< void>(0) : __assert_fail("pobj", "phi_force_stress.c", 48, __PRETTY_FUNCTION__); 
# 50
obj = ((pth_t *)calloc(1, sizeof(pth_t))); 
# 51
(obj) ? static_cast< void>(0) : __assert_fail("obj", "phi_force_stress.c", 51, __PRETTY_FUNCTION__); 
# 52
if (obj == (__null)) { pe_fatal(pe, "calloc(pth_t) failed\n"); }  
# 54
(obj->pe) = pe; 
# 55
(obj->cs) = cs; 
...
# 63
if ((obj->str) == (__null)) { pe_fatal(pe, "calloc(pth->str) failed\n"); }  
# 64
}  
# 68
...
# 77
tdpMemcpy(&((obj->target)->nsites), &(obj->nsites), sizeof(int), hipMemcpyHostToDevice); 
# 80
if (method == (PTH_METHOD_DIVERGENCE)) { 
# 81
tdpMalloc((void **)(&tmp), ((3 * 3) * (obj->nsites)) * sizeof(double)); 
# 82
tdpMemcpy(&((obj->target)->str), &tmp, sizeof(double *), hipMemcpyHostToDevice); 
# 84
}  
# 85
}  
...
double *tmp = (__null); 
# 103
(pth) ? static_cast< void>(0) : __assert_fail("pth", "phi_force_stress.c", 103, __PRETTY_FUNCTION__); 
# 105
tdpGetDeviceCount(&ndevice); 
# 107
if (ndevice > 0) { 
# 108
tdpMemcpy(&tmp, &((pth->target)->str), sizeof(double *), hipMemcpyDeviceToHost); 
# 110
if (tmp) { tdpFree(tmp); }  
# 111
tdpFree(pth->target); 
...
size_t nsz; 
# 131
(pth) ? static_cast< void>(0) : __assert_fail("pth", "phi_force_stress.c", 131, __PRETTY_FUNCTION__); 
# 133
tdpGetDeviceCount(&ndevice); 
# 135
if (ndevice == 0) { 
# 137
((pth->target) == pth) ? static_cast< void>(0) : __assert_fail("pth->target == pth", "phi_force_stress.c", 137, __PRETTY_FUNCTION__); 
# 138
} else 
# 139
{ 
...
# 179
(pth) ? static_cast< void>(0) : __assert_fail("pth", "phi_force_stress.c", 179, __PRETTY_FUNCTION__); 
# 180
(fe) ? static_cast< void>(0) : __assert_fail("fe", "phi_force_stress.c", 180, __PRETTY_FUNCTION__); 
# 181
((fe->func)->target) ? static_cast< void>(0) : __assert_fail("fe->func->target", "phi_force_stress.c", 181, __PRETTY_FUNCTION__); 
# 183
...
# 198
if (((fe->func)->str_anti) != (__null)) { 
# 199
do { (__cudaPushCallConfiguration(nblk, ntpb, 0, 0)) ? (void)0 : pth_kernel_a_v(ctxt->target, pth->target, fe_target); } while (0); 
# 200
; 
# 201
}  
...
{ 
# 205
do { (__cudaPushCallConfiguration(nblk, ntpb, 0, 0)) ? (void)0 : pth_kernel_v(ctxt->target, pth->target, fe_target); } while (0); 
# 206
; 
# 207
}  
# 209
{ tdpErrorHandler(tdpPeekAtLastError(), "phi_force_stress.c", 209, 1); } ; 
# 210
{ tdpErrorHandler(tdpDeviceSynchronize(), "phi_force_stress.c", 210, 1); } ; 
# 212
...
double s[3][3]; 
# 232
(ktx) ? static_cast< void>(0) : __assert_fail("ktx", "phi_force_stress.c", 232, __PRETTY_FUNCTION__); 
# 233
(pth) ? static_cast< void>(0) : __assert_fail("pth", "phi_force_stress.c", 233, __PRETTY_FUNCTION__); 
# 234
(fe) ? static_cast< void>(0) : __assert_fail("fe", "phi_force_stress.c", 234, __PRETTY_FUNCTION__); 
# 235
((fe->func)->stress) ? static_cast< void>(0) : __assert_fail("fe->func->stress", "phi_force_stress.c", 235, __PRETTY_FUNCTION__); 
# 237
...
double s[3][3][1]; 
# 268
(ktx) ? static_cast< void>(0) : __assert_fail("ktx", "phi_force_stress.c", 268, __PRETTY_FUNCTION__); 
# 269
(pth) ? static_cast< void>(0) : __assert_fail("pth", "phi_force_stress.c", 269, __PRETTY_FUNCTION__); 
# 270
(fe) ? static_cast< void>(0) : __assert_fail("fe", "phi_force_stress.c", 270, __PRETTY_FUNCTION__); 
# 271
((fe->func)->stress_v) ? static_cast< void>(0) : __assert_fail("fe->func->stress_v", "phi_force_stress.c", 271, __PRETTY_FUNCTION__); 
# 273
...
for (iv = 0; iv < 1; iv++) { 
# 284
((pth->str)[reverse_addr_rank2_assert(284, "phi_force_stress.c", pth->nsites, 3, 3, index + iv, ia, ib)]) = (((s[ia])[ib])[iv]); 
# 285
}  
# 286
}  
...
double s[3][3][1]; 
# 310
(ktx) ? static_cast< void>(0) : __assert_fail("ktx", "phi_force_stress.c", 310, __PRETTY_FUNCTION__); 
# 311
(pth) ? static_cast< void>(0) : __assert_fail("pth", "phi_force_stress.c", 311, __PRETTY_FUNCTION__); 
# 312
(fe) ? static_cast< void>(0) : __assert_fail("fe", "phi_force_stress.c", 312, __PRETTY_FUNCTION__); 
# 313
((fe->func)->str_anti_v) ? static_cast< void>(0) : __assert_fail("fe->func->str_anti_v", "phi_force_stress.c", 313, __PRETTY_FUNCTION__); 
# 315
kiter = kernel_vector_iterations(ktx); 
# 317
kindex = ((1) * (((__device_builtin_variable_blockIdx.x) * (__device_builtin_variable_blockDim.x)) + (__device_builtin_variable_threadIdx.x))); if (kindex < kiter) { 
...
for (iv = 0; iv < 1; iv++) { 
# 326
((pth->str)[reverse_addr_rank2_assert(326, "phi_force_stress.c", pth->nsites, 3, 3, index + iv, ia, ib)]) = (((s[ia])[ib])[iv]); 
# 327
}  
# 328
}  
...
int ia, ib; 
# 349
(pth) ? static_cast< void>(0) : __assert_fail("pth", "phi_force_stress.c", 349, __PRETTY_FUNCTION__); 
# 351
for (ia = 0; ia < 3; ia++) { 
# 352
for (ib = 0; ib < 3; ib++) { 
# 353
((pth->str)[reverse_addr_rank2_assert(353, "phi_force_stress.c", pth->nsites, 3, 3, index, ia, ib)]) = ((p[ia])[ib]); 
# 354
}  
# 355
}  
...
int ia, ib; 
# 371
(pth) ? static_cast< void>(0) : __assert_fail("pth", "phi_force_stress.c", 371, __PRETTY_FUNCTION__); 
# 373
for (ia = 0; ia < 3; ia++) { 
# 374
for (ib = 0; ib < 3; ib++) { 
# 375
((p[ia])[ib]) = ((pth->str)[reverse_addr_rank2_assert(375, "phi_force_stress.c", pth->nsites, 3, 3, index, ia, ib)]); 
# 376
}  
# 377
}  
...
# 1 "phi_force_stress.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__24_phi_force_stress_cpp1_ii_fb922db6
# 1 "phi_force_stress.cudafe1.stub.c"
#include "phi_force_stress.cudafe1.stub.c"
# 1 "phi_force_stress.cudafe1.stub.c"
