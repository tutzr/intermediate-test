...
# 31
int test_bonds_dimer_instance(pe_t * pe, cs_t * cs, double a0, double  r1[3], double  r2[3]); 
# 33
int test_bonds_trimer_instance(pe_t * pe, cs_t * cs, double a0, double  r1[3], double  r2[3], double  r3[3]); 
# 35
int colloid_forces_bonds_count_local(colloids_info_t * cinfo, int * nbond, int * nangle); 
# 37
int colloid_forces_bonds_check(cs_t * cs, colloids_info_t * cinfo, int * nbondfound, int * nbondpair); 
# 47
int test_bonds_suite() { 
# 49
pe_t *pe = (__null); 
...
test_bonds_trimer_instance(pe, cs, a0, r0, r2, r1); 
# 161
(r1[X]) = ((0.4000000000000000222) * (ltot[X])); 
# 162
(r1[Y]) = ((0.4000000000000000222) * (ltot[Y])); 
# 163
(r1[Z]) = ((0.4000000000000000222) * (ltot[Z])); 
# 165
(r0[X]) = ((r1[X]) - ((1.5) * a0)); 
# 166
(r0[Y]) = ((r1[Y]) - (0.1000000000000000056)); 
# 167
(r0[Z]) = (r1[Z]); 
# 169
(r2[X]) = ((r0[X]) + ((1.5) * a0)); 
# 170
(r2[Y]) = ((r0[Y]) - (0.1000000000000000056)); 
# 171
(r2[Z]) = (r0[Z]); 
# 173
test_bonds_trimer_instance(pe, cs, a0, r0, r1, r2); 
...
# 188 "test_bonds.c"
int test_bonds_dimer_instance(pe_t *pe, cs_t *cs, double a0, double r1[3], double 
# 189
r2[3]) { 
# 191
int nc; 
...
MPI_Comm comm; 
# 205
(pe) ? static_cast< void>(0) : __assert_fail("pe", "test_bonds.c", 205, __PRETTY_FUNCTION__); 
# 206
(cs) ? static_cast< void>(0) : __assert_fail("cs", "test_bonds.c", 206, __PRETTY_FUNCTION__); 
# 208
colloids_info_create(pe, cs, ncell, &cinfo); 
# 209
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "test_bonds.c", 209, __PRETTY_FUNCTION__); 
# 211
cs_cart_comm(cs, &comm); 
# 213
state0 = ((colloid_state_t *)calloc(1, sizeof(colloid_state_t))); 
# 214
(state0) ? static_cast< void>(0) : __assert_fail("state0", "test_bonds.c", 214, __PRETTY_FUNCTION__); 
# 216
state1 = (*state0); 
# 218
(state1.index) = 1; 
...
# 250
(nc == 2) ? static_cast< void>(0) : __assert_fail("nc == 2", "test_bonds.c", 250, __PRETTY_FUNCTION__); 
# 252
...
# 260
(nbond == 1) ? static_cast< void>(0) : __assert_fail("nbond == 1", "test_bonds.c", 260, __PRETTY_FUNCTION__); 
# 261
(nangle == 0) ? static_cast< void>(0) : __assert_fail("nangle == 0", "test_bonds.c", 261, __PRETTY_FUNCTION__); 
# 263
...
# 268
(nbond == 1) ? static_cast< void>(0) : __assert_fail("nbond == 1", "test_bonds.c", 268, __PRETTY_FUNCTION__); 
# 269
(npair == 1) ? static_cast< void>(0) : __assert_fail("npair == 1", "test_bonds.c", 269, __PRETTY_FUNCTION__); 
# 271
...
# 286 "test_bonds.c"
int test_bonds_trimer_instance(pe_t *pe, cs_t *cs, double a0, double r0[3], double 
# 287
r1[3], double r2[3]) { 
# 289
int nc; 
...
MPI_Comm comm; 
# 305
(pe) ? static_cast< void>(0) : __assert_fail("pe", "test_bonds.c", 305, __PRETTY_FUNCTION__); 
# 306
(cs) ? static_cast< void>(0) : __assert_fail("cs", "test_bonds.c", 306, __PRETTY_FUNCTION__); 
# 308
colloids_info_create(pe, cs, ncell, &cinfo); 
# 309
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "test_bonds.c", 309, __PRETTY_FUNCTION__); 
# 311
cs_cart_comm(cs, &comm); 
# 313
state_null = ((colloid_state_t *)calloc(1, sizeof(colloid_state_t))); 
# 314
(state_null) ? static_cast< void>(0) : __assert_fail("state_null", "test_bonds.c", 314, __PRETTY_FUNCTION__); 
# 318
state0 = (*state_null); 
# 320
(state0.index) = 1; 
...
colloids_info_ntotal(cinfo, &nc); 
# 373
(nc == 3) ? static_cast< void>(0) : __assert_fail("nc == 3", "test_bonds.c", 373, __PRETTY_FUNCTION__); 
# 375
colloids_halo_state(cinfo); 
# 376
colloids_info_list_local_build(cinfo); 
...
MPI_Allreduce(&nangle_local, &nangle, 1, MPI_INT, MPI_SUM, comm); 
# 383
(nbond == 2) ? static_cast< void>(0) : __assert_fail("nbond == 2", "test_bonds.c", 383, __PRETTY_FUNCTION__); 
# 384
(nangle == 1) ? static_cast< void>(0) : __assert_fail("nangle == 1", "test_bonds.c", 384, __PRETTY_FUNCTION__); 
# 386
colloid_forces_bonds_check(cs, cinfo, &nbond_local, &npair_local); 
# 388
MPI_Allreduce(&nbond_local, &nbond, 1, MPI_INT, MPI_SUM, comm); 
...
MPI_Allreduce(&npair_local, &npair, 1, MPI_INT, MPI_SUM, comm); 
# 391
(nbond == 2) ? static_cast< void>(0) : __assert_fail("nbond == 2", "test_bonds.c", 391, __PRETTY_FUNCTION__); 
# 392
(npair == 2) ? static_cast< void>(0) : __assert_fail("npair == 2", "test_bonds.c", 392, __PRETTY_FUNCTION__); 
# 394
colloids_info_free(cinfo); 
# 395
free(state_null); 
...
# 408 "test_bonds.c"
int colloid_forces_bonds_count_local(colloids_info_t *cinfo, int *nbond, int *
# 409
nangle) { 
# 410
int n; 
...
colloid_t *pc = (__null); 
# 413
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "test_bonds.c", 413, __PRETTY_FUNCTION__); 
# 414
(nbond) ? static_cast< void>(0) : __assert_fail("nbond", "test_bonds.c", 414, __PRETTY_FUNCTION__); 
# 415
(nangle) ? static_cast< void>(0) : __assert_fail("nangle", "test_bonds.c", 415, __PRETTY_FUNCTION__); 
# 417
(*nbond) = 0; 
# 418
(*nangle) = 0; 
...
# 442 "test_bonds.c"
int colloid_forces_bonds_check(cs_t *cs, colloids_info_t *cinfo, int *
# 443
nbondfound, int *
# 444
nbondpair) { 
...
colloid_t *pc2; 
# 459
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "test_bonds.c", 459, __PRETTY_FUNCTION__); 
# 460
...
# 1 "test_bonds.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__18_test_bonds_cpp1_ii_0726a4ad
# 1 "test_bonds.cudafe1.stub.c"
#include "test_bonds.cudafe1.stub.c"
# 1 "test_bonds.cudafe1.stub.c"
