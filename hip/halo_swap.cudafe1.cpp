...
# 65
static halo_swap_param_t const_param; 
# 67
int halo_swap_create(pe_t * pe, cs_t * cs, int nhcomm, int naddr, int na, int nb, halo_swap_t ** phalo); 
# 69
void halo_swap_coords(halo_swap_t * halo, int id, int index, int * ic, int * jc, int * kc); 
# 70
...
# 81 "halo_swap.c"
int halo_swap_create_r1(pe_t *pe, cs_t *cs, int nhcomm, int naddr, int 
# 82
na, halo_swap_t **
# 83
p) { 
...
# 96 "halo_swap.c"
int halo_swap_create_r2(pe_t *pe, cs_t *cs, int nhcomm, int naddr, int 
# 97
na, int nb, halo_swap_t **
# 98
p) { 
# 100
...
# 109
int halo_swap_create(pe_t *pe, cs_t *cs, int nhcomm, int naddr, int 
# 110
na, int nb, halo_swap_t **
# 111
phalo) { 
...
unsigned mflag = (0); 
# 118
halo_swap_t *halo = (__null); 
# 120
(pe) ? static_cast< void>(0) : __assert_fail("pe", "halo_swap.c", 120, __PRETTY_FUNCTION__); 
# 121
(cs) ? static_cast< void>(0) : __assert_fail("cs", "halo_swap.c", 121, __PRETTY_FUNCTION__); 
# 122
(phalo) ? static_cast< void>(0) : __assert_fail("phalo", "halo_swap.c", 122, __PRETTY_FUNCTION__); 
# 124
halo = ((halo_swap_t *)calloc(1, sizeof(halo_swap_t))); 
# 125
(halo) ? static_cast< void>(0) : __assert_fail("halo", "halo_swap.c", 125, __PRETTY_FUNCTION__); 
# 127
(halo->param) = ((halo_swap_param_t *)calloc(1, sizeof(halo_swap_param_t))); 
# 128
(halo->param) ? static_cast< void>(0) : __assert_fail("halo->param", "halo_swap.c", 128, __PRETTY_FUNCTION__); 
# 133
(halo->pe) = pe; 
# 134
(halo->cs) = cs; 
...
# 210
tdpMemcpy(&((halo->target)->fxlo), &tmp, sizeof(double *), hipMemcpyHostToDevice); 
# 212
tdpMalloc((void **)(&tmp), sz); 
# 213
tdpMemcpy(&((halo->target)->fxhi), &tmp, sizeof(double *), hipMemcpyHostToDevice); 
# 216
tdpMalloc((void **)(&tmp), sz); 
# 217
tdpMemcpy(&((halo->target)->hxlo), &tmp, sizeof(double *), hipMemcpyHostToDevice); 
# 219
tdpMalloc((void **)(&tmp), sz); 
# 220
tdpMemcpy(&((halo->target)->hxhi), &tmp, sizeof(double *), hipMemcpyHostToDevice); 
# 223
sz = ((((((halo->param)->hsz)[Y]) * na) * nb) * sizeof(double)); 
# 225
tdpMalloc((void **)(&tmp), sz); 
# 226
tdpMemcpy(&((halo->target)->fylo), &tmp, sizeof(double *), hipMemcpyHostToDevice); 
# 228
tdpMalloc((void **)(&tmp), sz); 
# 229
tdpMemcpy(&((halo->target)->fyhi), &tmp, sizeof(double *), hipMemcpyHostToDevice); 
# 232
tdpMalloc((void **)(&tmp), sz); 
# 233
tdpMemcpy(&((halo->target)->hylo), &tmp, sizeof(double *), hipMemcpyHostToDevice); 
# 235
tdpMalloc((void **)(&tmp), sz); 
# 236
tdpMemcpy(&((halo->target)->hyhi), &tmp, sizeof(double *), hipMemcpyHostToDevice); 
# 239
sz = ((((((halo->param)->hsz)[Z]) * na) * nb) * sizeof(double)); 
# 241
tdpMalloc((void **)(&tmp), sz); 
# 242
tdpMemcpy(&((halo->target)->fzlo), &tmp, sizeof(double *), hipMemcpyHostToDevice); 
# 244
tdpMalloc((void **)(&tmp), sz); 
# 245
tdpMemcpy(&((halo->target)->fzhi), &tmp, sizeof(double *), hipMemcpyHostToDevice); 
# 248
tdpMalloc((void **)(&tmp), sz); 
# 249
tdpMemcpy(&((halo->target)->hzlo), &tmp, sizeof(double *), hipMemcpyHostToDevice); 
# 251
tdpMalloc((void **)(&tmp), sz); 
# 252
tdpMemcpy(&((halo->target)->hzhi), &tmp, sizeof(double *), hipMemcpyHostToDevice); 
# 255
{ tdpErrorHandler(hipGetSymbolAddress((void **)(&tmpp), &const_param), "halo_swap.c", 255, 1); } ; 
# 256
tdpMemcpy(&((halo->target)->param), &tmpp, sizeof(halo_swap_param_t *), hipMemcpyHostToDevice); 
# 260
...
int ndevice; 
# 278
(halo) ? static_cast< void>(0) : __assert_fail("halo", "halo_swap.c", 278, __PRETTY_FUNCTION__); 
# 280
tdpGetDeviceCount(&ndevice); 
# 282
if (ndevice > 0) { 
...
double *tmp; 
# 285
tdpMemcpy(&tmp, &((halo->target)->fxlo), sizeof(double *), hipMemcpyDeviceToHost); 
# 287
tdpFree(tmp); 
# 288
tdpMemcpy(&tmp, &((halo->target)->fxhi), sizeof(double *), hipMemcpyDeviceToHost); 
# 290
tdpFree(tmp); 
# 291
tdpMemcpy(&tmp, &((halo->target)->fylo), sizeof(double *), hipMemcpyDeviceToHost); 
# 293
tdpFree(tmp); 
# 294
tdpMemcpy(&tmp, &((halo->target)->fyhi), sizeof(double *), hipMemcpyDeviceToHost); 
# 296
tdpFree(tmp); 
# 297
tdpMemcpy(&tmp, &((halo->target)->fzlo), sizeof(double *), hipMemcpyDeviceToHost); 
# 299
tdpFree(tmp); 
# 300
tdpMemcpy(&tmp, &((halo->target)->fzhi), sizeof(double *), hipMemcpyDeviceToHost); 
# 302
tdpFree(tmp); 
# 304
tdpMemcpy(&tmp, &((halo->target)->hxlo), sizeof(double *), hipMemcpyDeviceToHost); 
# 306
tdpFree(tmp); 
# 307
tdpMemcpy(&tmp, &((halo->target)->hxhi), sizeof(double *), hipMemcpyDeviceToHost); 
# 309
tdpFree(tmp); 
# 310
tdpMemcpy(&tmp, &((halo->target)->hylo), sizeof(double *), hipMemcpyDeviceToHost); 
# 312
tdpFree(tmp); 
# 313
tdpMemcpy(&tmp, &((halo->target)->hyhi), sizeof(double *), hipMemcpyDeviceToHost); 
# 315
tdpFree(tmp); 
# 316
tdpMemcpy(&tmp, &((halo->target)->hzlo), sizeof(double *), hipMemcpyDeviceToHost); 
# 318
tdpFree(tmp); 
# 319
tdpMemcpy(&tmp, &((halo->target)->hzhi), sizeof(double *), hipMemcpyDeviceToHost); 
# 321
tdpFree(tmp); 
# 323
tdpFree(halo->target); 
...
# 356
int halo_swap_handlers_set(halo_swap_t *halo, f_pack_t pack, f_unpack_t 
# 357
unpack) { 
# 359
(halo) ? static_cast< void>(0) : __assert_fail("halo", "halo_swap.c", 359, __PRETTY_FUNCTION__); 
# 361
(halo->data_pack) = pack; 
# 362
...
int halo_swap_commit(halo_swap_t *halo) { 
# 375
(halo) ? static_cast< void>(0) : __assert_fail("halo", "halo_swap.c", 375, __PRETTY_FUNCTION__); 
# 377
{ tdpErrorHandler(hipMemcpyToSymbol(&const_param, halo->param, sizeof(halo_swap_param_t), 0, hipMemcpyHostToDevice), "halo_swap.c", 378, 1); 
# 377 "halo_swap.c"
} 
# 378
; 
...
# 389
int halo_swap_host_rank1(halo_swap_t *halo, void *mbuf, MPI_Datatype 
# 390
mpidata) { 
# 392
int sz; 
...
# 417
(halo) ? static_cast< void>(0) : __assert_fail("halo", "halo_swap.c", 417, __PRETTY_FUNCTION__); 
# 418
(mbuf) ? static_cast< void>(0) : __assert_fail("mbuf", "halo_swap.c", 418, __PRETTY_FUNCTION__); 
# 419
((mpidata == (MPI_CHAR)) || (mpidata == (MPI_DOUBLE))) ? static_cast< void>(0) : __assert_fail("mpidata == MPI_CHAR || mpidata == MPI_DOUBLE", "halo_swap.c", 419, __PRETTY_FUNCTION__); 
# 421
...
# 439
(sendforw && sendback) ? static_cast< void>(0) : __assert_fail("sendforw && sendback", "halo_swap.c", 439, __PRETTY_FUNCTION__); 
# 440
(recvforw && recvback) ? static_cast< void>(0) : __assert_fail("recvforw && recvback", "halo_swap.c", 440, __PRETTY_FUNCTION__); 
# 441
if (sendforw == (__null)) { pe_fatal(halo->pe, "malloc(sendforw) failed\n"); }  
# 442
if (sendback == (__null)) { pe_fatal(halo->pe, "malloc(sendback) failed\n"); }  
# 443
if (recvforw == (__null)) { pe_fatal(halo->pe, "malloc(recvforw) failed\n"); }  
# 444
if (recvback == (__null)) { pe_fatal(halo->pe, "malloc(recvback) failed\n"); }  
# 448
icount = 0; 
# 450
...
# 456
ireal = reverse_addr_rank1_assert(456, "halo_swap.c", hp->naddr, hp->na, index, ia); 
# 457
memcpy(sendback + (icount * sz), buf + (ireal * sz), sz); 
# 459
index = cs_index(halo->cs, (nlocal[X]) - nh, jc, kc); 
# 460
ireal = reverse_addr_rank1_assert(460, "halo_swap.c", hp->naddr, hp->na, index, ia); 
# 461
...
# 468
(icount == nsend) ? static_cast< void>(0) : __assert_fail("icount == nsend", "halo_swap.c", 468, __PRETTY_FUNCTION__); 
# 470
if ((mpicartsz[X]) == 1) { 
# 471
...
# 496
ihalo = reverse_addr_rank1_assert(496, "halo_swap.c", hp->naddr, hp->na, index, ia); 
# 497
memcpy(buf + (ihalo * sz), recvforw + (icount * sz), sz); 
# 498
index = cs_index(halo->cs, 0 - nh, jc, kc); 
# 499
ihalo = reverse_addr_rank1_assert(499, "halo_swap.c", hp->naddr, hp->na, index, ia); 
# 500
...
# 507
(icount == nsend) ? static_cast< void>(0) : __assert_fail("icount == nsend", "halo_swap.c", 507, __PRETTY_FUNCTION__); 
# 509
free(recvback); 
# 510
free(recvforw); 
...
recvback = ((unsigned char *)malloc(nsend * sz)); 
# 524
(sendforw && sendback) ? static_cast< void>(0) : __assert_fail("sendforw && sendback", "halo_swap.c", 524, __PRETTY_FUNCTION__); 
# 525
(recvforw && recvback) ? static_cast< void>(0) : __assert_fail("recvforw && recvback", "halo_swap.c", 525, __PRETTY_FUNCTION__); 
# 526
if (sendforw == (__null)) { pe_fatal(halo->pe, "malloc(sendforw) failed\n"); }  
# 527
if (sendback == (__null)) { pe_fatal(halo->pe, "malloc(sendback) failed\n"); }  
...
# 540
ireal = reverse_addr_rank1_assert(540, "halo_swap.c", hp->naddr, hp->na, index, ia); 
# 541
memcpy(sendback + (icount * sz), buf + (ireal * sz), sz); 
# 542
index = cs_index(halo->cs, ic, (nlocal[Y]) - nh, kc); 
# 543
ireal = reverse_addr_rank1_assert(543, "halo_swap.c", hp->naddr, hp->na, index, ia); 
# 544
memcpy(sendforw + (icount * sz), buf + (ireal * sz), sz); 
# 545
icount += 1; 
...
# 551
(icount == nsend) ? static_cast< void>(0) : __assert_fail("icount == nsend", "halo_swap.c", 551, __PRETTY_FUNCTION__); 
# 553
if ((mpicartsz[Y]) == 1) { 
# 554
memcpy(recvback, sendforw, nsend * sz); 
...
# 579
ihalo = reverse_addr_rank1_assert(579, "halo_swap.c", hp->naddr, hp->na, index, ia); 
# 580
memcpy(buf + (ihalo * sz), recvback + (icount * sz), sz); 
# 581
index = cs_index(halo->cs, ic, ((nlocal[Y]) + 1) + nh, kc); 
# 582
ihalo = reverse_addr_rank1_assert(582, "halo_swap.c", hp->naddr, hp->na, index, ia); 
# 583
memcpy(buf + (ihalo * sz), recvforw + (icount * sz), sz); 
# 584
icount += 1; 
...
# 590
(icount == nsend) ? static_cast< void>(0) : __assert_fail("icount == nsend", "halo_swap.c", 590, __PRETTY_FUNCTION__); 
# 592
free(recvback); 
# 593
free(recvforw); 
...
recvback = ((unsigned char *)malloc(nsend * sz)); 
# 607
(sendforw && sendback) ? static_cast< void>(0) : __assert_fail("sendforw && sendback", "halo_swap.c", 607, __PRETTY_FUNCTION__); 
# 608
(recvforw && recvback) ? static_cast< void>(0) : __assert_fail("recvforw && recvback", "halo_swap.c", 608, __PRETTY_FUNCTION__); 
# 609
if (sendforw == (__null)) { pe_fatal(halo->pe, "malloc(sendforw) failed\n"); }  
# 610
if (sendback == (__null)) { pe_fatal(halo->pe, "malloc(sendback) failed\n"); }  
...
# 625
ireal = reverse_addr_rank1_assert(625, "halo_swap.c", hp->naddr, hp->na, index, ia); 
# 626
memcpy(sendback + (icount * sz), buf + (ireal * sz), sz); 
# 627
...
index = cs_index(halo->cs, ic, jc, kc); 
# 629
ireal = reverse_addr_rank1_assert(629, "halo_swap.c", hp->naddr, hp->na, index, ia); 
# 630
memcpy(sendforw + (icount * sz), buf + (ireal * sz), sz); 
# 631
icount += 1; 
...
# 637
(icount == nsend) ? static_cast< void>(0) : __assert_fail("icount == nsend", "halo_swap.c", 637, __PRETTY_FUNCTION__); 
# 639
if ((mpicartsz[Z]) == 1) { 
# 640
memcpy(recvback, sendforw, nsend * sz); 
...
# 665
ihalo = reverse_addr_rank1_assert(665, "halo_swap.c", hp->naddr, hp->na, index, ia); 
# 666
memcpy(buf + (ihalo * sz), recvback + (icount * sz), sz); 
# 667
index = cs_index(halo->cs, ic, jc, ((nlocal[Z]) + 1) + nh); 
# 668
ihalo = reverse_addr_rank1_assert(668, "halo_swap.c", hp->naddr, hp->na, index, ia); 
# 669
memcpy(buf + (ihalo * sz), recvforw + (icount * sz), sz); 
# 670
icount += 1; 
...
# 676
(icount == nsend) ? static_cast< void>(0) : __assert_fail("icount == nsend", "halo_swap.c", 676, __PRETTY_FUNCTION__); 
# 678
free(recvback); 
# 679
free(recvforw); 
...
# 726
(halo) ? static_cast< void>(0) : __assert_fail("halo", "halo_swap.c", 726, __PRETTY_FUNCTION__); 
# 729
((((halo->param)->nlocal)[Z]) >= ((halo->param)->nswap)) ? static_cast< void>(0) : __assert_fail("halo->param->nlocal[Z] >= halo->param->nswap", "halo_swap.c", 729, __PRETTY_FUNCTION__); 
# 731
tdpGetDeviceCount(&ndevice); 
# 732
halo_swap_commit(halo); 
...
# 756
MPI_Irecv(halo->hxlo, ncount, MPI_DOUBLE, cs_cart_neighb(halo->cs, BACKWARD, X), ftagx, comm, req_x); 
# 758
MPI_Irecv(halo->hxhi, ncount, MPI_DOUBLE, cs_cart_neighb(halo->cs, FORWARD, X), btagx, comm, req_x + 1); 
# 760
}  
# 762
if ((mpicartsz[Y]) > 1) { 
...
# 764
MPI_Irecv(halo->hylo, ncount, MPI_DOUBLE, cs_cart_neighb(halo->cs, BACKWARD, Y), ftagy, comm, req_y); 
# 766
MPI_Irecv(halo->hyhi, ncount, MPI_DOUBLE, cs_cart_neighb(halo->cs, FORWARD, Y), btagy, comm, req_y + 1); 
# 768
}  
# 770
if ((mpicartsz[Z]) > 1) { 
...
# 772
MPI_Irecv(halo->hzlo, ncount, MPI_DOUBLE, cs_cart_neighb(halo->cs, BACKWARD, Z), ftagz, comm, req_z); 
# 774
MPI_Irecv(halo->hzhi, ncount, MPI_DOUBLE, cs_cart_neighb(halo->cs, FORWARD, Z), btagz, comm, req_z + 1); 
# 776
}  
# 780
kernel_launch_param(hsz[X], &nblk, &ntpb); 
# 781
do { (__cudaPushCallConfiguration(nblk, ntpb, 0, (halo->stream)[X])) ? (void)0 : (halo->data_pack)(halo->target, X, data); } while (0); 
# 782
; 
# 784
if (ndevice > 0) { 
...
tdpMemcpy(&tmp, &((halo->target)->fxlo), sizeof(double *), hipMemcpyDeviceToHost); 
# 788
tdpMemcpyAsync(halo->fxlo, tmp, ncount * sizeof(double), hipMemcpyDeviceToHost, (halo->stream)[X]); 
# 790
tdpMemcpy(&tmp, &((halo->target)->fxhi), sizeof(double *), hipMemcpyDeviceToHost); 
# 792
tdpMemcpyAsync(halo->fxhi, tmp, ncount * sizeof(double), hipMemcpyDeviceToHost, (halo->stream)[X]); 
# 794
}  
# 798
kernel_launch_param(hsz[Y], &nblk, &ntpb); 
# 799
do { (__cudaPushCallConfiguration(nblk, ntpb, 0, (halo->stream)[Y])) ? (void)0 : (halo->data_pack)(halo->target, Y, data); } while (0); 
# 800
; 
# 802
if (ndevice > 0) { 
...
tdpMemcpy(&tmp, &((halo->target)->fylo), sizeof(double *), hipMemcpyDeviceToHost); 
# 806
tdpMemcpyAsync(halo->fylo, tmp, ncount * sizeof(double), hipMemcpyDeviceToHost, (halo->stream)[Y]); 
# 808
tdpMemcpy(&tmp, &((halo->target)->fyhi), sizeof(double *), hipMemcpyDeviceToHost); 
# 810
tdpMemcpyAsync(halo->fyhi, tmp, ncount * sizeof(double), hipMemcpyDeviceToHost, (halo->stream)[Y]); 
# 812
}  
# 816
kernel_launch_param(hsz[Z], &nblk, &ntpb); 
# 817
do { (__cudaPushCallConfiguration(nblk, ntpb, 0, (halo->stream)[Z])) ? (void)0 : (halo->data_pack)(halo->target, Z, data); } while (0); 
# 818
; 
# 820
if (ndevice > 0) { 
...
tdpMemcpy(&tmp, &((halo->target)->fzlo), sizeof(double *), hipMemcpyDeviceToHost); 
# 824
tdpMemcpyAsync(halo->fzlo, tmp, ncount * sizeof(double), hipMemcpyDeviceToHost, (halo->stream)[Z]); 
# 826
tdpMemcpy(&tmp, &((halo->target)->fzhi), sizeof(double *), hipMemcpyDeviceToHost); 
# 828
tdpMemcpyAsync(halo->fzhi, tmp, ncount * sizeof(double), hipMemcpyDeviceToHost, (halo->stream)[Z]); 
# 830
}  
# 835
...
tdpMemcpy(&tmp, &((halo->target)->hxlo), sizeof(double *), hipMemcpyDeviceToHost); 
# 844
tdpMemcpyAsync(tmp, halo->fxhi, ncount * sizeof(double), hipMemcpyHostToDevice, (halo->stream)[X]); 
# 847
memcpy(halo->hxhi, halo->fxlo, ncount * sizeof(double)); 
# 848
tdpMemcpy(&tmp, &((halo->target)->hxhi), sizeof(double *), hipMemcpyDeviceToHost); 
# 850
tdpMemcpyAsync(tmp, halo->fxlo, ncount * sizeof(double), hipMemcpyHostToDevice, (halo->stream)[X]); 
# 852
} else 
# 853
{ 
# 854
MPI_Isend(halo->fxhi, ncount, MPI_DOUBLE, cs_cart_neighb(halo->cs, FORWARD, X), ftagx, comm, req_x + 2); 
# 856
MPI_Isend(halo->fxlo, ncount, MPI_DOUBLE, cs_cart_neighb(halo->cs, BACKWARD, X), btagx, comm, req_x + 3); 
# 859
for (m = 0; m < 4; m++) { 
# 860
...
tdpMemcpy(&tmp, &((halo->target)->hxlo), sizeof(double *), hipMemcpyDeviceToHost); 
# 864
tdpMemcpyAsync(tmp, halo->hxlo, ncount * sizeof(double), hipMemcpyHostToDevice, (halo->stream)[X]); 
# 866
}  
# 867
if ((mc == 1) && (ndevice > 0)) { 
...
tdpMemcpy(&tmp, &((halo->target)->hxhi), sizeof(double *), hipMemcpyDeviceToHost); 
# 870
tdpMemcpyAsync(tmp, halo->hxhi, ncount * sizeof(double), hipMemcpyHostToDevice, (halo->stream)[X]); 
# 872
}  
# 873
}  
...
kernel_launch_param(hsz[X], &nblk, &ntpb); 
# 877
do { (__cudaPushCallConfiguration(nblk, ntpb, 0, (halo->stream)[X])) ? (void)0 : (halo->data_unpack)(halo->target, X, data); } while (0); 
# 878
; 
# 883
...
tdpMemcpy(&tmp, &((halo->target)->hylo), sizeof(double *), hipMemcpyDeviceToHost); 
# 918
tdpMemcpyAsync(tmp, halo->fyhi, ncount * sizeof(double), hipMemcpyHostToDevice, (halo->stream)[Y]); 
# 921
memcpy(halo->hyhi, halo->fylo, ncount * sizeof(double)); 
# 922
tdpMemcpy(&tmp, &((halo->target)->hyhi), sizeof(double *), hipMemcpyDeviceToHost); 
# 924
tdpMemcpyAsync(tmp, halo->fylo, ncount * sizeof(double), hipMemcpyHostToDevice, (halo->stream)[Y]); 
# 926
} else 
# 927
{ 
# 928
MPI_Isend(halo->fyhi, ncount, MPI_DOUBLE, cs_cart_neighb(halo->cs, FORWARD, Y), ftagy, comm, req_y + 2); 
# 930
MPI_Isend(halo->fylo, ncount, MPI_DOUBLE, cs_cart_neighb(halo->cs, BACKWARD, Y), btagy, comm, req_y + 3); 
# 933
for (m = 0; m < 4; m++) { 
# 934
...
tdpMemcpy(&tmp, &((halo->target)->hylo), sizeof(double *), hipMemcpyDeviceToHost); 
# 938
tdpMemcpyAsync(tmp, halo->hylo, ncount * sizeof(double), hipMemcpyHostToDevice, (halo->stream)[Y]); 
# 940
}  
# 941
if ((mc == 1) && (ndevice > 0)) { 
...
tdpMemcpy(&tmp, &((halo->target)->hyhi), sizeof(double *), hipMemcpyDeviceToHost); 
# 944
tdpMemcpyAsync(tmp, halo->hyhi, ncount * sizeof(double), hipMemcpyHostToDevice, (halo->stream)[Y]); 
# 946
}  
# 947
}  
...
kernel_launch_param(hsz[Y], &nblk, &ntpb); 
# 952
do { (__cudaPushCallConfiguration(nblk, ntpb, 0, (halo->stream)[Y])) ? (void)0 : (halo->data_unpack)(halo->target, Y, data); } while (0); 
# 953
; 
# 958
...
tdpMemcpy(&tmp, &((halo->target)->hzlo), sizeof(double *), hipMemcpyDeviceToHost); 
# 1015
tdpMemcpyAsync(tmp, halo->fzhi, ncount * sizeof(double), hipMemcpyHostToDevice, (halo->stream)[Z]); 
# 1018
tdpMemcpy(&tmp, &((halo->target)->hzhi), sizeof(double *), hipMemcpyDeviceToHost); 
# 1020
tdpMemcpyAsync(tmp, halo->fzlo, ncount * sizeof(double), hipMemcpyHostToDevice, (halo->stream)[Z]); 
# 1022
} else 
# 1023
{ 
# 1024
MPI_Isend(halo->fzhi, ncount, MPI_DOUBLE, cs_cart_neighb(halo->cs, FORWARD, Z), ftagz, comm, req_z + 2); 
# 1026
MPI_Isend(halo->fzlo, ncount, MPI_DOUBLE, cs_cart_neighb(halo->cs, BACKWARD, Z), btagz, comm, req_z + 3); 
# 1029
for (m = 0; m < 4; m++) { 
# 1030
...
tdpMemcpy(&tmp, &((halo->target)->hzlo), sizeof(double *), hipMemcpyDeviceToHost); 
# 1034
tdpMemcpyAsync(tmp, halo->hzlo, ncount * sizeof(double), hipMemcpyHostToDevice, (halo->stream)[Z]); 
# 1036
}  
# 1037
if ((mc == 1) && (ndevice > 0)) { 
...
tdpMemcpy(&tmp, &((halo->target)->hzhi), sizeof(double *), hipMemcpyDeviceToHost); 
# 1040
tdpMemcpyAsync(tmp, halo->hzhi, ncount * sizeof(double), hipMemcpyHostToDevice, (halo->stream)[Z]); 
# 1042
}  
# 1043
}  
...
kernel_launch_param(hsz[Z], &nblk, &ntpb); 
# 1047
do { (__cudaPushCallConfiguration(nblk, ntpb, 0, (halo->stream)[Z])) ? (void)0 : (halo->data_unpack)(halo->target, Z, data); } while (0); 
# 1048
; 
# 1050
tdpStreamSynchronize((halo->stream)[X]); 
...
int kindex; 
# 1071
(halo) ? static_cast< void>(0) : __assert_fail("halo", "halo_swap.c", 1071, __PRETTY_FUNCTION__); 
# 1072
(((id == (X)) || (id == (Y))) || (id == (Z))) ? static_cast< void>(0) : __assert_fail("id == X || id == Y || id == Z", "halo_swap.c", 1072, __PRETTY_FUNCTION__); 
# 1073
(data) ? static_cast< void>(0) : __assert_fail("data", "halo_swap.c", 1073, __PRETTY_FUNCTION__); 
# 1075
kindex = ((1) * (((__device_builtin_variable_blockIdx.x) * (__device_builtin_variable_blockDim.x)) + (__device_builtin_variable_threadIdx.x))); if (kindex < (((halo->param)->hsz)[id])) { 
# 1077
int nh; 
# 1078
int hsz; 
...
int hi; 
# 1081
double *__restrict__ buflo = (__null); 
# 1082
double *__restrict__ bufhi = (__null); 
# 1083
halo_swap_param_t *hp; 
# 1085
hp = (halo->param); 
...
for (ia = 0; ia < (hp->na); ia++) { 
# 1126
(buflo[(hsz * ia) + kindex]) = (data[reverse_addr_rank1_assert(1126, "halo_swap.c", hp->naddr, hp->na, indexl, ia)]); 
# 1127
}  
# 1129
for (ia = 0; ia < (hp->na); ia++) { 
# 1130
(bufhi[(hsz * ia) + kindex]) = (data[reverse_addr_rank1_assert(1130, "halo_swap.c", hp->naddr, hp->na, indexh, ia)]); 
# 1131
}  
# 1132
} else 
...
# 1139
(buflo[(hsz * nel) + kindex]) = (data[reverse_addr_rank2_assert(1140, "halo_swap.c", hp->naddr, hp->na, hp->nb, indexl, ia, ib)]); 
# 1141
nel += 1; 
# 1142
}  
...
for (ib = 0; ib < (hp->nb); ib++) { 
# 1148
(bufhi[(hsz * nel) + kindex]) = (data[reverse_addr_rank2_assert(1149, "halo_swap.c", hp->naddr, hp->na, hp->nb, indexh, ia, ib)]); 
# 1150
nel += 1; 
# 1151
}  
...
int kindex; 
# 1173
(halo) ? static_cast< void>(0) : __assert_fail("halo", "halo_swap.c", 1173, __PRETTY_FUNCTION__); 
# 1174
(((id == (X)) || (id == (Y))) || (id == (Z))) ? static_cast< void>(0) : __assert_fail("id == X || id == Y || id == Z", "halo_swap.c", 1174, __PRETTY_FUNCTION__); 
# 1175
(data) ? static_cast< void>(0) : __assert_fail("data", "halo_swap.c", 1175, __PRETTY_FUNCTION__); 
# 1179
kindex = ((1) * (((__device_builtin_variable_blockIdx.x) * (__device_builtin_variable_blockDim.x)) + (__device_builtin_variable_threadIdx.x))); if (kindex < (((halo->param)->hsz)[id])) { 
# 1181
int hsz; 
...
for (ia = 0; ia < (hp->na); ia++) { 
# 1233
(data[reverse_addr_rank1_assert(1233, "halo_swap.c", hp->naddr, hp->na, indexl, ia)]) = (buflo[(hsz * ia) + kindex]); 
# 1234
}  
# 1236
for (ia = 0; ia < (hp->na); ia++) { 
# 1237
(data[reverse_addr_rank1_assert(1237, "halo_swap.c", hp->naddr, hp->na, indexh, ia)]) = (bufhi[(hsz * ia) + kindex]); 
# 1238
}  
# 1240
} else 
...
for (ib = 0; ib < (hp->nb); ib++) { 
# 1247
(data[reverse_addr_rank2_assert(1247, "halo_swap.c", hp->naddr, hp->na, hp->nb, indexl, ia, ib)]) = (buflo[(hsz * nel) + kindex]); 
# 1249
nel += 1; 
# 1250
}  
...
for (ib = 0; ib < (hp->nb); ib++) { 
# 1256
(data[reverse_addr_rank2_assert(1256, "halo_swap.c", hp->naddr, hp->na, hp->nb, indexh, ia, ib)]) = (bufhi[(hsz * nel) + kindex]); 
# 1258
nel += 1; 
# 1259
}  
...
#endif
# 1278 "halo_swap.c"
void halo_swap_coords(halo_swap_t *halo, int id, int index, int *
# 1279
ic, int *jc, int *kc) { 
# 1280
int xstr; 
...
int ystr; 
# 1283
(halo) ? static_cast< void>(0) : __assert_fail("halo", "halo_swap.c", 1283, __PRETTY_FUNCTION__); 
# 1285
...
int ystr; 
# 1309
(halo) ? static_cast< void>(0) : __assert_fail("halo", "halo_swap.c", 1309, __PRETTY_FUNCTION__); 
# 1311
...
int ystr; 
# 1331
(halo) ? static_cast< void>(0) : __assert_fail("halo", "halo_swap.c", 1331, __PRETTY_FUNCTION__); 
# 1333
ystr = ((((halo->param)->hext)[id])[Z]); 
# 1334
xstr = (ystr * ((((halo->param)->hext)[id])[Y])); 
...
# 1 "halo_swap.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__17_halo_swap_cpp1_ii_0e562ad4
# 1 "halo_swap.cudafe1.stub.c"
#include "halo_swap.cudafe1.stub.c"
# 1 "halo_swap.cudafe1.stub.c"
