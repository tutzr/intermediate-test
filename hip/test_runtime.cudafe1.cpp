...
# 49
test_assert_info(1, 49, "test_runtime.c"); 
# 52
n = 0; 
# 54
rt_active_keys(rt, &n); 
# 55
test_assert_info(n == 15, 55, "test_runtime.c"); 
# 58
n = 0; 
# 60
n = rt_int_parameter(rt, "int_scalar", &ivalue); 
# 61
test_assert_info(n == 1, 61, "test_runtime.c"); 
# 65
test_assert_info(ivalue == 999, 65, "test_runtime.c"); 
# 68
n = 0; 
# 70
n = rt_double_parameter(rt, "double_scalar", &dvalue); 
# 71
test_assert_info(n == 1, 71, "test_runtime.c"); 
# 75
test_assert_info(fabs(dvalue - (3.330000000000000071)) < (9.999999999999999988e-15), 75, "test_runtime.c"); 
# 78
n = 0; 
# 80
n = rt_int_parameter(rt, "temperature", &ivalue); 
# 81
test_assert_info(n == 1, 81, "test_runtime.c"); 
# 85
test_assert_info(ivalue == (-1), 85, "test_runtime.c"); 
# 88
n = 0; 
# 90
n = rt_int_parameter(rt, "temp", &ivalue); 
# 91
test_assert_info(n == 1, 91, "test_runtime.c"); 
# 95
test_assert_info(ivalue == 1, 95, "test_runtime.c"); 
# 99
n = rt_int_parameter(rt, "temper", &ivalue); 
# 100
test_assert_info(ivalue == 0, 100, "test_runtime.c"); 
# 103
n = 0; 
# 105
n = rt_int_parameter_vector(rt, "int_vector", ivector); 
# 106
test_assert_info(n == 1, 106, "test_runtime.c"); 
# 110
test_assert_info((ivector[0]) == (-1), 110, "test_runtime.c"); 
# 114
test_assert_info((ivector[1]) == (-2), 114, "test_runtime.c"); 
# 118
test_assert_info((ivector[2]) == 3, 118, "test_runtime.c"); 
# 121
n = 0; 
# 123
n = rt_double_parameter_vector(rt, "double_vector", dvector); 
# 124
test_assert_info(n == 1, 124, "test_runtime.c"); 
# 128
test_assert_info(fabs((dvector[0]) - (-(1.0))) < (9.999999999999999988e-15), 128, "test_runtime.c"); 
# 132
test_assert_info(fabs((dvector[1]) - (-(2.0))) < (9.999999999999999988e-15), 132, "test_runtime.c"); 
# 136
test_assert_info(fabs((dvector[2]) - (3.0)) < (9.999999999999999988e-15), 136, "test_runtime.c"); 
# 139
n = 1; 
# 141
n = rt_int_parameter(rt, "int_dummy", &ivalue); 
# 142
test_assert_info(n == 0, 142, "test_runtime.c"); 
# 146
n = rt_double_parameter(rt, "double_dummy", &dvalue); 
# 147
test_assert_info(n == 0, 147, "test_runtime.c"); 
# 152
n = 0; 
# 154
n = rt_int_parameter(rt, "int_multiple_space", &ivalue); 
# 155
test_assert_info(n == 1, 155, "test_runtime.c"); 
# 159
test_assert_info(ivalue == (-2), 159, "test_runtime.c"); 
# 162
n = 0; 
# 164
n = rt_double_parameter(rt, "double_tab", &dvalue); 
# 165
test_assert_info(n == 1, 165, "test_runtime.c"); 
# 169
test_assert_info(fabs(dvalue - (-(2.0))) < (9.999999999999999988e-15), 169, "test_runtime.c"); 
# 174
n = 0; 
# 176
n = rt_string_parameter(rt, "string_parameter", string, 256); 
# 177
test_assert_info(n == 1, 177, "test_runtime.c"); 
# 181
test_assert_info(strcmp(string, "ASCII") == 0, 181, "test_runtime.c"); 
# 184
n = 0; 
# 186
n = rt_string_parameter(rt, "input_config", string, 256); 
# 187
test_assert_info(n == 1, 187, "test_runtime.c"); 
# 191
test_assert_info(strcmp(string, "config.0") == 0, 191, "test_runtime.c"); 
# 196
n = rt_int_parameter(rt, "key_trail1", &ivalue); 
# 197
(n == 1) ? static_cast< void>(0) : __assert_fail("n == 1", "test_runtime.c", 197, __PRETTY_FUNCTION__); 
# 198
(ivalue == 909) ? static_cast< void>(0) : __assert_fail("ivalue == 909", "test_runtime.c", 198, __PRETTY_FUNCTION__); 
# 200
n = rt_int_parameter(rt, "key_trail2", &ivalue); 
# 201
(n == 1) ? static_cast< void>(0) : __assert_fail("n == 1", "test_runtime.c", 201, __PRETTY_FUNCTION__); 
# 202
(ivalue == 910) ? static_cast< void>(0) : __assert_fail("ivalue == 910", "test_runtime.c", 202, __PRETTY_FUNCTION__); 
# 206
n = rt_string_parameter(rt, "key_trail3", string, 256); 
# 207
(n == 1) ? static_cast< void>(0) : __assert_fail("n == 1", "test_runtime.c", 207, __PRETTY_FUNCTION__); 
# 208
(strcmp(string, "string_3") == 0) ? static_cast< void>(0) : __assert_fail("strcmp(string, \"string_3\") == 0", "test_runtime.c", 208, __PRETTY_FUNCTION__); 
# 210
n = rt_string_parameter(rt, "key_trail4", string, 256); 
# 211
(n == 1) ? static_cast< void>(0) : __assert_fail("n == 1", "test_runtime.c", 211, __PRETTY_FUNCTION__); 
# 212
(strcmp(string, "string_4") == 0) ? static_cast< void>(0) : __assert_fail("strcmp(string, \"string_4\") == 0", "test_runtime.c", 212, __PRETTY_FUNCTION__); 
# 216
n = 1; 
# 218
rt_active_keys(rt, &n); 
# 219
test_assert_info(n == 0, 219, "test_runtime.c"); 
# 222
rt_free(rt); 
# 223
...
# 1 "test_runtime.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__20_test_runtime_cpp1_ii_61984fad
# 1 "test_runtime.cudafe1.stub.c"
#include "test_runtime.cudafe1.stub.c"
# 1 "test_runtime.cudafe1.stub.c"
