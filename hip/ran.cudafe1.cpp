...
# 28
static lecuyer p_rng; 
# 29
static lecuyer s_rng; 
# 31
static double ran_gaussian(lecuyer *); 
# 32
static double ran_lecuyer(lecuyer *); 
# 51 "ran.c"
int ran_init(pe_t *pe) { 
# 53
...
int scalar_seed = 7361237; 
# 65
(pe) ? static_cast< void>(0) : __assert_fail("pe", "ran.c", 65, __PRETTY_FUNCTION__); 
# 66
(rt) ? static_cast< void>(0) : __assert_fail("rt", "ran.c", 66, __PRETTY_FUNCTION__); 
# 70
...
int ran_init_seed(pe_t *pe, int scalar_seed) { 
# 86
(pe) ? static_cast< void>(0) : __assert_fail("pe", "ran.c", 86, __PRETTY_FUNCTION__); 
# 90
(s_rng.ispare) = 0; 
# 92
...
# 150 "ran.c"
static double ran_gaussian(lecuyer *rng) { 
# 152
double result; 
# 153
double ran1, ran2; 
...
# 193 "ran.c"
static double ran_lecuyer(lecuyer *rng) { 
# 195
int h, p1, p5; 
# 197
h = (((rng->rstate)[4]) / 20554); 
# 198
p5 = ((104480 * (((rng->rstate)[4]) - (h * 20554))) - (h * 1727)); 
# 200
...
h = (((rng->rstate)[0]) / 20); 
# 206
p1 = ((107374182 * (((rng->rstate)[0]) - (h * 20))) - (h * ((rng->rstate)[0]))); 
# 208
if (p1 < 0) { p1 += 2147483647; }  
# 209
if (p5 > 0) { p5 -= 2147483647; }  
# 211
((rng->rstate)[0]) = (p1 + p5); 
# 212
if (((rng->rstate)[0]) < 0) { ((rng->rstate)[0]) += 2147483647; }  
# 214
return (4.656612873077392578e-10) * ((rng->rstate)[0]); 
# 215
} 

# 1 "ran.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__11_ran_cpp1_ii_6f0c27e7
# 1 "ran.cudafe1.stub.c"
#include "ran.cudafe1.stub.c"
# 1 "ran.cudafe1.stub.c"
