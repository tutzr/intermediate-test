...
# 38 "psi.c"
static const double e_unit_default = (1.0); 
# 39
static const double reltol_default = ((1.192092896e-07F)); 
# 40
static const double abstol_default = ((0.01000000000000000021) * ((1.192092896e-07F))); 
# 41
static const int maxits_default = 10000; 
# 42
static const int multisteps_default = 1; 
# 43
static const int skipsteps_default = 1; 
# 44
static const double diffacc_default = (0); 
# 46
...
psi_t *psi = (__null); 
# 65
(pe) ? static_cast< void>(0) : __assert_fail("pe", "psi.c", 65, __PRETTY_FUNCTION__); 
# 66
(cs) ? static_cast< void>(0) : __assert_fail("cs", "psi.c", 66, __PRETTY_FUNCTION__); 
# 67
(pobj) ? static_cast< void>(0) : __assert_fail("pobj", "psi.c", 67, __PRETTY_FUNCTION__); 
# 68
(nk > 1) ? static_cast< void>(0) : __assert_fail("nk > 1", "psi.c", 68, __PRETTY_FUNCTION__); 
# 69
(nk <= 4) ? static_cast< void>(0) : __assert_fail("nk <= 4", "psi.c", 69, __PRETTY_FUNCTION__); 
# 71
cs_nsites(cs, &nsites); 
# 72
cs_nhalo(cs, &nhalo); 
...
# 75
(psi) ? static_cast< void>(0) : __assert_fail("psi", "psi.c", 75, __PRETTY_FUNCTION__); 
# 76
if (psi == (__null)) { pe_fatal(pe, "Allocation of psi failed\n"); }  
# 78
(psi->pe) = pe; 
# 79
(psi->cs) = cs; 
...
# 88
if ((psi->psi) == (__null)) { pe_fatal(pe, "Allocation of psi->psi failed\n"); }  
# 89
if ((psi->rho) == (__null)) { pe_fatal(pe, "Allocation of psi->rho failed\n"); }  
# 90
if ((psi->diffusivity) == (__null)) { pe_fatal(pe, "psi->diffusivity failed\n"); }  
# 91
if ((psi->valency) == (__null)) { pe_fatal(pe, "calloc(psi->valency) failed\n"); }  
# 93
...
# 101
(psi->nfreq_io) = 2147483647; 
# 102
(psi->nfreq) = 2147483647; 
# 104
...
int psi_io_info(psi_t *obj, io_info_t **info) { 
# 120
(obj) ? static_cast< void>(0) : __assert_fail("obj", "psi.c", 120, __PRETTY_FUNCTION__); 
# 121
(info) ? static_cast< void>(0) : __assert_fail("info", "psi.c", 121, __PRETTY_FUNCTION__); 
# 123
(*info) = (obj->info); 
# 125
return 0; 
...
int nh; 
# 138
(psi) ? static_cast< void>(0) : __assert_fail("psi", "psi.c", 138, __PRETTY_FUNCTION__); 
# 140
cs_nhalo(psi->cs, &nh); 
# 141
...
int nh; 
# 156
(psi) ? static_cast< void>(0) : __assert_fail("psi", "psi.c", 156, __PRETTY_FUNCTION__); 
# 158
cs_nhalo(psi->cs, &nh); 
# 159
coords_field_halo_rank1(psi->cs, psi->nsites, nh, psi->nk, psi->rho, MPI_DOUBLE); 
# 161
return 0; 
# 162
} 
...
int psi_nk(psi_t *obj, int *nk) { 
# 172
(obj) ? static_cast< void>(0) : __assert_fail("obj", "psi.c", 172, __PRETTY_FUNCTION__); 
# 174
(*nk) = (obj->nk); 
# 176
return 0; 
...
int psi_valency_set(psi_t *obj, int n, int iv) { 
# 187
(obj) ? static_cast< void>(0) : __assert_fail("obj", "psi.c", 187, __PRETTY_FUNCTION__); 
# 188
(n < (obj->nk)) ? static_cast< void>(0) : __assert_fail("n < obj->nk", "psi.c", 188, __PRETTY_FUNCTION__); 
# 190
((obj->valency)[n]) = iv; 
# 192
return 0; 
...
int psi_valency(psi_t *obj, int n, int *iv) { 
# 203
(obj) ? static_cast< void>(0) : __assert_fail("obj", "psi.c", 203, __PRETTY_FUNCTION__); 
# 204
(n < (obj->nk)) ? static_cast< void>(0) : __assert_fail("n < obj->nk", "psi.c", 204, __PRETTY_FUNCTION__); 
# 205
(iv) ? static_cast< void>(0) : __assert_fail("iv", "psi.c", 205, __PRETTY_FUNCTION__); 
# 207
(*iv) = ((obj->valency)[n]); 
# 209
return 0; 
...
int psi_diffusivity_set(psi_t *obj, int n, double diff) { 
# 220
(obj) ? static_cast< void>(0) : __assert_fail("obj", "psi.c", 220, __PRETTY_FUNCTION__); 
# 221
(n < (obj->nk)) ? static_cast< void>(0) : __assert_fail("n < obj->nk", "psi.c", 221, __PRETTY_FUNCTION__); 
# 223
...
int psi_diffusivity(psi_t *obj, int n, double *diff) { 
# 236
(obj) ? static_cast< void>(0) : __assert_fail("obj", "psi.c", 236, __PRETTY_FUNCTION__); 
# 237
(n < (obj->nk)) ? static_cast< void>(0) : __assert_fail("n < obj->nk", "psi.c", 237, __PRETTY_FUNCTION__); 
# 238
(diff) ? static_cast< void>(0) : __assert_fail("diff", "psi.c", 238, __PRETTY_FUNCTION__); 
# 240
...
io_info_arg_t args; 
# 260
(obj) ? static_cast< void>(0) : __assert_fail("obj", "psi.c", 260, __PRETTY_FUNCTION__); 
# 261
(grid) ? static_cast< void>(0) : __assert_fail("grid", "psi.c", 261, __PRETTY_FUNCTION__); 
# 262
((obj->info) == (__null)) ? static_cast< void>(0) : __assert_fail("obj->info == __null", "psi.c", 262, __PRETTY_FUNCTION__); 
# 264
((args.grid)[X]) = (grid[X]); 
# 265
((args.grid)[Y]) = (grid[Y]); 
...
# 269
if ((obj->info) == (__null)) { pe_fatal(obj->pe, "io_info_create(psi) failed\n"); }  
# 271
...
int n; 
# 297
(obj) ? static_cast< void>(0) : __assert_fail("obj", "psi.c", 297, __PRETTY_FUNCTION__); 
# 299
for (n = 0; n < 3; n++) { 
# 300
...
# 331
(obj) ? static_cast< void>(0) : __assert_fail("obj", "psi.c", 331, __PRETTY_FUNCTION__); 
# 332
(fp) ? static_cast< void>(0) : __assert_fail("fp", "psi.c", 332, __PRETTY_FUNCTION__); 
# 334
cs_nsites(obj->cs, &nsites); 
# 336
nwrite = fprintf(fp, "%22.15e ", (obj->psi)[reverse_addr_rank0_assert(336, "psi.c", nsites, index)]); 
# 337
if (nwrite != 23) { 
# 338
...
for (n = 0; n < (obj->nk); n++) { 
# 342
nwrite = fprintf(fp, "%22.15e ", (obj->rho)[reverse_addr_rank1_assert(342, "psi.c", nsites, obj->nk, index, n)]); 
# 343
...
psi_t *obj = (psi_t *)self; 
# 374
(fp) ? static_cast< void>(0) : __assert_fail("fp", "psi.c", 374, __PRETTY_FUNCTION__); 
# 375
(self) ? static_cast< void>(0) : __assert_fail("self", "psi.c", 375, __PRETTY_FUNCTION__); 
# 377
cs_nsites(obj->cs, &nsites); 
# 379
indexf = reverse_addr_rank0_assert(379, "psi.c", nsites, index); 
# 380
...
for (n = 0; n < (obj->nk); n++) { 
# 384
indexf = reverse_addr_rank1_assert(384, "psi.c", nsites, obj->nk, index, n); 
# 385
...
psi_t *obj = (psi_t *)self; 
# 412
(fp) ? static_cast< void>(0) : __assert_fail("fp", "psi.c", 412, __PRETTY_FUNCTION__); 
# 413
(obj) ? static_cast< void>(0) : __assert_fail("obj", "psi.c", 413, __PRETTY_FUNCTION__); 
# 415
cs_nsites(obj->cs, &nsites); 
# 417
indexf = reverse_addr_rank0_assert(417, "psi.c", nsites, index); 
# 418
...
# 422
indexf = reverse_addr_rank1_assert(422, "psi.c", nsites, obj->nk, index, na); 
# 423
...
psi_t *obj = (psi_t *)self; 
# 451
(fp) ? static_cast< void>(0) : __assert_fail("fp", "psi.c", 451, __PRETTY_FUNCTION__); 
# 452
(obj) ? static_cast< void>(0) : __assert_fail("obj", "psi.c", 452, __PRETTY_FUNCTION__); 
# 454
cs_nsites(obj->cs, &nsites); 
# 456
indexf = reverse_addr_rank0_assert(456, "psi.c", nsites, index); 
# 457
...
for (na = 0; na < (obj->nk); na++) { 
# 461
indexf = reverse_addr_rank1_assert(461, "psi.c", nsites, obj->nk, index, na); 
# 462
...
double rho_elec = (0.0); 
# 485
(obj) ? static_cast< void>(0) : __assert_fail("obj", "psi.c", 485, __PRETTY_FUNCTION__); 
# 486
(rho) ? static_cast< void>(0) : __assert_fail("rho", "psi.c", 486, __PRETTY_FUNCTION__); 
# 488
for (n = 0; n < (obj->nk); n++) { 
# 489
rho_elec += (((obj->e) * ((obj->valency)[n])) * ((obj->rho)[reverse_addr_rank1_assert(489, "psi.c", obj->nsites, obj->nk, index, n)])); 
# 490
}  
# 491
(*rho) = rho_elec; 
...
int psi_rho(psi_t *obj, int index, int n, double *rho) { 
# 504
(obj) ? static_cast< void>(0) : __assert_fail("obj", "psi.c", 504, __PRETTY_FUNCTION__); 
# 505
(rho) ? static_cast< void>(0) : __assert_fail("rho", "psi.c", 505, __PRETTY_FUNCTION__); 
# 506
(n < (obj->nk)) ? static_cast< void>(0) : __assert_fail("n < obj->nk", "psi.c", 506, __PRETTY_FUNCTION__); 
# 508
(*rho) = ((obj->rho)[reverse_addr_rank1_assert(508, "psi.c", obj->nsites, obj->nk, index, n)]); 
# 510
return 0; 
# 511
} 
...
int psi_rho_set(psi_t *obj, int index, int n, double rho) { 
# 521
(obj) ? static_cast< void>(0) : __assert_fail("obj", "psi.c", 521, __PRETTY_FUNCTION__); 
# 522
(n < (obj->nk)) ? static_cast< void>(0) : __assert_fail("n < obj->nk", "psi.c", 522, __PRETTY_FUNCTION__); 
# 524
((obj->rho)[reverse_addr_rank1_assert(524, "psi.c", obj->nsites, obj->nk, index, n)]) = rho; 
# 526
return 0; 
# 527
} 
...
int psi_psi(psi_t *obj, int index, double *psi) { 
# 537
(obj) ? static_cast< void>(0) : __assert_fail("obj", "psi.c", 537, __PRETTY_FUNCTION__); 
# 538
(psi) ? static_cast< void>(0) : __assert_fail("psi", "psi.c", 538, __PRETTY_FUNCTION__); 
# 540
(*psi) = ((obj->psi)[reverse_addr_rank0_assert(540, "psi.c", obj->nsites, index)]); 
# 542
return 0; 
# 543
} 
...
int psi_psi_set(psi_t *obj, int index, double psi) { 
# 553
(obj) ? static_cast< void>(0) : __assert_fail("obj", "psi.c", 553, __PRETTY_FUNCTION__); 
# 555
((obj->psi)[reverse_addr_rank0_assert(555, "psi.c", obj->nsites, index)]) = psi; 
# 557
return 0; 
# 558
} 
...
int psi_unit_charge(psi_t *obj, double *eunit) { 
# 568
(obj) ? static_cast< void>(0) : __assert_fail("obj", "psi.c", 568, __PRETTY_FUNCTION__); 
# 569
(eunit) ? static_cast< void>(0) : __assert_fail("eunit", "psi.c", 569, __PRETTY_FUNCTION__); 
# 571
(*eunit) = (obj->e); 
# 573
return 0; 
...
int psi_unit_charge_set(psi_t *obj, double eunit) { 
# 584
(obj) ? static_cast< void>(0) : __assert_fail("obj", "psi.c", 584, __PRETTY_FUNCTION__); 
# 586
(obj->e) = eunit; 
# 588
return 0; 
...
int psi_beta(psi_t *obj, double *beta) { 
# 599
(obj) ? static_cast< void>(0) : __assert_fail("obj", "psi.c", 599, __PRETTY_FUNCTION__); 
# 600
(beta) ? static_cast< void>(0) : __assert_fail("beta", "psi.c", 600, __PRETTY_FUNCTION__); 
# 602
(*beta) = (obj->beta); 
# 604
return 0; 
...
int psi_beta_set(psi_t *obj, double beta) { 
# 615
(obj) ? static_cast< void>(0) : __assert_fail("obj", "psi.c", 615, __PRETTY_FUNCTION__); 
# 617
(obj->beta) = beta; 
# 619
return 0; 
...
int psi_epsilon(psi_t *obj, double *epsilon) { 
# 630
(obj) ? static_cast< void>(0) : __assert_fail("obj", "psi.c", 630, __PRETTY_FUNCTION__); 
# 631
(epsilon) ? static_cast< void>(0) : __assert_fail("epsilon", "psi.c", 631, __PRETTY_FUNCTION__); 
# 633
(*epsilon) = (obj->epsilon); 
# 635
return 0; 
...
int psi_epsilon_set(psi_t *obj, double epsilon) { 
# 646
(obj) ? static_cast< void>(0) : __assert_fail("obj", "psi.c", 646, __PRETTY_FUNCTION__); 
# 648
(obj->epsilon) = epsilon; 
# 650
return 0; 
...
int psi_epsilon2(psi_t *obj, double *epsilon2) { 
# 661
(obj) ? static_cast< void>(0) : __assert_fail("obj", "psi.c", 661, __PRETTY_FUNCTION__); 
# 662
(epsilon2) ? static_cast< void>(0) : __assert_fail("epsilon2", "psi.c", 662, __PRETTY_FUNCTION__); 
# 664
...
int psi_epsilon2_set(psi_t *obj, double epsilon2) { 
# 678
(obj) ? static_cast< void>(0) : __assert_fail("obj", "psi.c", 678, __PRETTY_FUNCTION__); 
# 680
...
int n; 
# 697
(psi) ? static_cast< void>(0) : __assert_fail("psi", "psi.c", 697, __PRETTY_FUNCTION__); 
# 698
(sion) ? static_cast< void>(0) : __assert_fail("sion", "psi.c", 698, __PRETTY_FUNCTION__); 
# 700
(*sion) = (0.0); 
# 701
for (n = 0; n < (psi->nk); n++) { 
# 702
(*sion) += ((((0.5) * ((psi->valency)[n])) * ((psi->valency)[n])) * ((psi->rho)[reverse_addr_rank1_assert(703, "psi.c", psi->nsites, psi->nk, index, n)])); 
# 704
}  
# 706
return 0; 
...
# 721
(obj) ? static_cast< void>(0) : __assert_fail("obj", "psi.c", 721, __PRETTY_FUNCTION__); 
# 722
(lb) ? static_cast< void>(0) : __assert_fail("lb", "psi.c", 722, __PRETTY_FUNCTION__); 
# 724
...
const double pi = (3.141592653589793116); 
# 743
(obj) ? static_cast< void>(0) : __assert_fail("obj", "psi.c", 743, __PRETTY_FUNCTION__); 
# 744
(lb) ? static_cast< void>(0) : __assert_fail("lb", "psi.c", 744, __PRETTY_FUNCTION__); 
# 746
...
const double pi = (3.141592653589793116); 
# 766
(obj) ? static_cast< void>(0) : __assert_fail("obj", "psi.c", 766, __PRETTY_FUNCTION__); 
# 767
(ld) ? static_cast< void>(0) : __assert_fail("ld", "psi.c", 767, __PRETTY_FUNCTION__); 
# 769
...
const double pi = (3.141592653589793116); 
# 791
(obj) ? static_cast< void>(0) : __assert_fail("obj", "psi.c", 791, __PRETTY_FUNCTION__); 
# 792
(ld) ? static_cast< void>(0) : __assert_fail("ld", "psi.c", 792, __PRETTY_FUNCTION__); 
# 794
...
# 813 "psi.c"
int psi_surface_potential(psi_t *obj, double sigma, double rho_b, double *
# 814
sp) { 
# 815
double p; 
# 817
(obj) ? static_cast< void>(0) : __assert_fail("obj", "psi.c", 817, __PRETTY_FUNCTION__); 
# 818
(sp) ? static_cast< void>(0) : __assert_fail("sp", "psi.c", 818, __PRETTY_FUNCTION__); 
# 819
((obj->nk) == 2) ? static_cast< void>(0) : __assert_fail("obj->nk == 2", "psi.c", 819, __PRETTY_FUNCTION__); 
# 820
(((obj->valency)[0]) == (-((obj->valency)[1]))) ? static_cast< void>(0) : __assert_fail("obj->valency[0] == -obj->valency[1]", "psi.c", 820, __PRETTY_FUNCTION__); 
# 822
p = ((1.0) / sqrt((((8.0) * (obj->epsilon)) * rho_b) / (obj->beta))); 
# 824
(*sp) = fabs(((2.0) / ((((obj->valency)[0]) * (obj->e)) * (obj->beta))) * log(((-p) * sigma) + sqrt((((p * p) * sigma) * sigma) + (1.0)))); 
# 827
return 0; 
# 828
} 
...
int psi_reltol(psi_t *obj, double *reltol) { 
# 840
(obj) ? static_cast< void>(0) : __assert_fail("obj", "psi.c", 840, __PRETTY_FUNCTION__); 
# 841
(reltol) ? static_cast< void>(0) : __assert_fail("reltol", "psi.c", 841, __PRETTY_FUNCTION__); 
# 843
(*reltol) = (obj->reltol); 
# 845
return 0; 
...
int psi_abstol(psi_t *obj, double *abstol) { 
# 858
(obj) ? static_cast< void>(0) : __assert_fail("obj", "psi.c", 858, __PRETTY_FUNCTION__); 
# 859
(abstol) ? static_cast< void>(0) : __assert_fail("abstol", "psi.c", 859, __PRETTY_FUNCTION__); 
# 861
(*abstol) = (obj->abstol); 
# 863
return 0; 
...
int psi_reltol_set(psi_t *obj, double reltol) { 
# 874
(obj) ? static_cast< void>(0) : __assert_fail("obj", "psi.c", 874, __PRETTY_FUNCTION__); 
# 876
(obj->reltol) = reltol; 
# 878
return 0; 
...
int psi_abstol_set(psi_t *obj, double abstol) { 
# 889
(obj) ? static_cast< void>(0) : __assert_fail("obj", "psi.c", 889, __PRETTY_FUNCTION__); 
# 891
(obj->abstol) = abstol; 
# 893
return 0; 
...
int psi_multisteps_set(psi_t *obj, int multisteps) { 
# 904
(obj) ? static_cast< void>(0) : __assert_fail("obj", "psi.c", 904, __PRETTY_FUNCTION__); 
# 905
(multisteps) ? static_cast< void>(0) : __assert_fail("multisteps", "psi.c", 905, __PRETTY_FUNCTION__); 
# 907
...
int psi_multisteps(psi_t *obj, int *multisteps) { 
# 920
(obj) ? static_cast< void>(0) : __assert_fail("obj", "psi.c", 920, __PRETTY_FUNCTION__); 
# 921
(multisteps) ? static_cast< void>(0) : __assert_fail("multisteps", "psi.c", 921, __PRETTY_FUNCTION__); 
# 923
...
int psi_multistep_timestep(psi_t *obj, double *dt) { 
# 936
(obj) ? static_cast< void>(0) : __assert_fail("obj", "psi.c", 936, __PRETTY_FUNCTION__); 
# 938
...
int psi_maxits_set(psi_t *obj, int maxits) { 
# 951
(obj) ? static_cast< void>(0) : __assert_fail("obj", "psi.c", 951, __PRETTY_FUNCTION__); 
# 952
(maxits) ? static_cast< void>(0) : __assert_fail("maxits", "psi.c", 952, __PRETTY_FUNCTION__); 
# 954
(obj->maxits) = maxits; 
# 956
return 0; 
...
int psi_maxits(psi_t *obj, int *maxits) { 
# 967
(obj) ? static_cast< void>(0) : __assert_fail("obj", "psi.c", 967, __PRETTY_FUNCTION__); 
# 968
(maxits) ? static_cast< void>(0) : __assert_fail("maxits", "psi.c", 968, __PRETTY_FUNCTION__); 
# 970
(*maxits) = (obj->maxits); 
# 972
return 0; 
...
int psi_diffacc_set(psi_t *obj, double diffacc) { 
# 983
(obj) ? static_cast< void>(0) : __assert_fail("obj", "psi.c", 983, __PRETTY_FUNCTION__); 
# 984
(diffacc >= (0)) ? static_cast< void>(0) : __assert_fail("diffacc>=0", "psi.c", 984, __PRETTY_FUNCTION__); 
# 986
(obj->diffacc) = diffacc; 
# 988
return 0; 
...
int psi_diffacc(psi_t *obj, double *diffacc) { 
# 999
(obj) ? static_cast< void>(0) : __assert_fail("obj", "psi.c", 999, __PRETTY_FUNCTION__); 
# 1000
(diffacc) ? static_cast< void>(0) : __assert_fail("diffacc", "psi.c", 1000, __PRETTY_FUNCTION__); 
# 1002
(*diffacc) = (obj->diffacc); 
# 1004
return 0; 
...
int psi_skipsteps_set(psi_t *obj, double skipsteps) { 
# 1015
(obj) ? static_cast< void>(0) : __assert_fail("obj", "psi.c", 1015, __PRETTY_FUNCTION__); 
# 1016
(skipsteps >= (1)) ? static_cast< void>(0) : __assert_fail("skipsteps>=1", "psi.c", 1016, __PRETTY_FUNCTION__); 
# 1018
...
int psi_skipsteps(psi_t *obj) { 
# 1031
(obj) ? static_cast< void>(0) : __assert_fail("obj", "psi.c", 1031, __PRETTY_FUNCTION__); 
# 1033
...
MPI_Comm comm; 
# 1057
(psi) ? static_cast< void>(0) : __assert_fail("psi", "psi.c", 1057, __PRETTY_FUNCTION__); 
# 1059
cs_ltot(psi->cs, ltot); 
# 1060
...
# 1125
(psi) ? static_cast< void>(0) : __assert_fail("psi", "psi.c", 1125, __PRETTY_FUNCTION__); 
# 1127
cs_nhalo(psi->cs, &nhalo); 
# 1128
cs_nlocal(psi->cs, nlocal); 
...
if (periodic[X]) { 
# 1149
((psi->psi)[reverse_addr_rank0_assert(1149, "psi.c", psi->nsites, index)]) += ((e0[X]) * (ntotal[X])); 
# 1150
} else 
# 1151
{ 
...
# 1153
((psi->psi)[reverse_addr_rank0_assert(1153, "psi.c", psi->nsites, index)]) = ((psi->psi)[reverse_addr_rank0_assert(1154, "psi.c", psi->nsites, index1)]); 
# 1155
}  
# 1156
}  
...
if (periodic[X]) { 
# 1171
((psi->psi)[reverse_addr_rank0_assert(1171, "psi.c", psi->nsites, index)]) -= ((e0[X]) * (ntotal[X])); 
# 1172
} else 
# 1173
{ 
...
# 1175
((psi->psi)[reverse_addr_rank0_assert(1175, "psi.c", psi->nsites, index)]) = ((psi->psi)[reverse_addr_rank0_assert(1176, "psi.c", psi->nsites, index1)]); 
# 1177
}  
# 1178
}  
...
if (periodic[Y]) { 
# 1192
((psi->psi)[reverse_addr_rank0_assert(1192, "psi.c", psi->nsites, index)]) += ((e0[Y]) * (ntotal[Y])); 
# 1193
} else 
# 1194
{ 
...
# 1196
((psi->psi)[reverse_addr_rank0_assert(1196, "psi.c", psi->nsites, index)]) = ((psi->psi)[reverse_addr_rank0_assert(1197, "psi.c", psi->nsites, index1)]); 
# 1198
}  
# 1199
}  
...
if (periodic[Y]) { 
# 1214
((psi->psi)[reverse_addr_rank0_assert(1214, "psi.c", psi->nsites, index)]) -= ((e0[Y]) * (ntotal[Y])); 
# 1215
} else 
# 1216
{ 
...
# 1218
((psi->psi)[reverse_addr_rank0_assert(1218, "psi.c", psi->nsites, index)]) = ((psi->psi)[reverse_addr_rank0_assert(1219, "psi.c", psi->nsites, index1)]); 
# 1220
}  
# 1221
}  
...
if (periodic[Z]) { 
# 1236
((psi->psi)[reverse_addr_rank0_assert(1236, "psi.c", psi->nsites, index)]) += ((e0[Z]) * (ntotal[Z])); 
# 1237
} else 
# 1238
{ 
...
# 1240
((psi->psi)[reverse_addr_rank0_assert(1240, "psi.c", psi->nsites, index)]) = ((psi->psi)[reverse_addr_rank0_assert(1241, "psi.c", psi->nsites, index1)]); 
# 1242
}  
# 1243
}  
...
if (periodic[Z]) { 
# 1258
((psi->psi)[reverse_addr_rank0_assert(1258, "psi.c", psi->nsites, index)]) -= ((e0[Z]) * (ntotal[Z])); 
# 1259
} else 
# 1260
{ 
...
# 1262
((psi->psi)[reverse_addr_rank0_assert(1262, "psi.c", psi->nsites, index)]) = ((psi->psi)[reverse_addr_rank0_assert(1263, "psi.c", psi->nsites, index1)]); 
# 1264
}  
# 1265
}  
...
# 1282
(psi) ? static_cast< void>(0) : __assert_fail("psi", "psi.c", 1282, __PRETTY_FUNCTION__); 
# 1284
(*flag) = (psi->method); 
# 1286
return 0; 
...
# 1297
(psi) ? static_cast< void>(0) : __assert_fail("psi", "psi.c", 1297, __PRETTY_FUNCTION__); 
# 1298
((flag >= 0) && (flag < (PSI_FORCE_NTYPES))) ? static_cast< void>(0) : __assert_fail("flag >= 0 && flag < PSI_FORCE_NTYPES", "psi.c", 1298, __PRETTY_FUNCTION__); 
# 1300
(psi->method) = flag; 
# 1302
return 0; 
...
int psi_nfreq_set(psi_t *psi, int nfreq) { 
# 1313
(psi) ? static_cast< void>(0) : __assert_fail("psi", "psi.c", 1313, __PRETTY_FUNCTION__); 
# 1315
(psi->nfreq) = nfreq; 
# 1317
return 0; 
...
physics_t *phys = (__null); 
# 1330
(psi) ? static_cast< void>(0) : __assert_fail("psi", "psi.c", 1330, __PRETTY_FUNCTION__); 
# 1332
physics_ref(&phys); 
# 1333
...
psi_nk(psi, &nk); 
# 1382
(nk == 2) ? static_cast< void>(0) : __assert_fail("nk == 2", "psi.c", 1382, __PRETTY_FUNCTION__); 
# 1384
cs_cart_comm(psi->cs, &comm); 
# 1385
cs_nlocal(psi->cs, nlocal); 
...
# 1423
((nc == 0) || (nc == 1)) ? static_cast< void>(0) : __assert_fail("nc == 0 || nc == 1", "psi.c", 1423, __PRETTY_FUNCTION__); 
# 1425
for (ic = 1; ic <= (nlocal[X]); ic++) { 
# 1426
for (jc = 1; jc <= (nlocal[Y]); jc++) { 
...
# 1 "psi.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__11_psi_cpp1_ii_aefa5849
# 1 "psi.cudafe1.stub.c"
#include "psi.cudafe1.stub.c"
# 1 "psi.cudafe1.stub.c"
