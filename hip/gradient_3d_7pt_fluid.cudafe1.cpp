...
# 48 "gradient_3d_7pt_fluid.c"
int grad_3d_7pt_fluid_operator(cs_t * cs, lees_edw_t * le, field_grad_t * fg, int nextra); 
# 51
int grad_3d_7pt_fluid_le(lees_edw_t * le, field_grad_t * fg, int nextra); 
# 54
int grad_3d_7pt_dab_le_correct(lees_edw_t * le, field_grad_t * df, int nextra); 
# 56
int grad_3d_7pt_dab_compute(cs_t * cs, lees_edw_t * le, field_grad_t * df, int nextra); 
# 62
void grad_3d_7pt_fluid_kernel_v(kernel_ctxt_t * ktx, int nop, int ys, lees_edw_t * le, field_t * field, field_grad_t * fgrad); 
# 67
void grad_3d_7pt_dab_kernel_v(kernel_ctxt_t * ktx, lees_edw_t * le, field_grad_t * df, int nsites, int ys); 
# 77
int grad_3d_7pt_fluid_d2(field_grad_t *fgrad) { 
# 79
int nhalo, nextra; 
# 80
cs_t *cs = (__null); 
...
# 83
(fgrad) ? static_cast< void>(0) : __assert_fail("fgrad", "gradient_3d_7pt_fluid.c", 83, __PRETTY_FUNCTION__); 
# 84
(fgrad->field) ? static_cast< void>(0) : __assert_fail("fgrad->field", "gradient_3d_7pt_fluid.c", 84, __PRETTY_FUNCTION__); 
# 85
((fgrad->field)->cs) ? static_cast< void>(0) : __assert_fail("fgrad->field->cs", "gradient_3d_7pt_fluid.c", 85, __PRETTY_FUNCTION__); 
# 86
((fgrad->field)->le) ? static_cast< void>(0) : __assert_fail("fgrad->field->le", "gradient_3d_7pt_fluid.c", 86, __PRETTY_FUNCTION__); 
# 88
cs = ((fgrad->field)->cs); 
# 89
le = ((fgrad->field)->le); 
...
nextra = (nhalo - 1); 
# 93
(nextra >= 0) ? static_cast< void>(0) : __assert_fail("nextra >= 0", "gradient_3d_7pt_fluid.c", 93, __PRETTY_FUNCTION__); 
# 95
...
# 111 "gradient_3d_7pt_fluid.c"
int grad_3d_7pt_fluid_d4(field_grad_t *fgrad) { 
# 113
int nhalo, nextra; 
# 114
cs_t *cs = (__null); 
...
lees_edw_t *le = (__null); 
# 117
(fgrad) ? static_cast< void>(0) : __assert_fail("fgrad", "gradient_3d_7pt_fluid.c", 117, __PRETTY_FUNCTION__); 
# 118
(fgrad->field) ? static_cast< void>(0) : __assert_fail("fgrad->field", "gradient_3d_7pt_fluid.c", 118, __PRETTY_FUNCTION__); 
# 119
((fgrad->field)->cs) ? static_cast< void>(0) : __assert_fail("fgrad->field->cs", "gradient_3d_7pt_fluid.c", 119, __PRETTY_FUNCTION__); 
# 120
((fgrad->field)->le) ? static_cast< void>(0) : __assert_fail("fgrad->field->le", "gradient_3d_7pt_fluid.c", 120, __PRETTY_FUNCTION__); 
# 122
cs = ((fgrad->field)->cs); 
# 123
le = ((fgrad->field)->le); 
...
nextra = (nhalo - (2 * 1)); 
# 127
(nextra >= 0) ? static_cast< void>(0) : __assert_fail("nextra >= 0", "gradient_3d_7pt_fluid.c", 127, __PRETTY_FUNCTION__); 
# 129
grad_3d_7pt_fluid_operator(cs, le, fgrad, nextra); 
# 130
grad_3d_7pt_fluid_le(le, fgrad, nextra); 
# 132
(0) ? static_cast< void>(0) : __assert_fail("0", "gradient_3d_7pt_fluid.c", 132, __PRETTY_FUNCTION__); 
# 134
return 0; 
# 135
} 
# 156 "gradient_3d_7pt_fluid.c"
int grad_3d_7pt_fluid_dab(field_grad_t *fgrad) { 
# 158
int nhalo; 
# 159
int nextra; 
...
lees_edw_t *le = (__null); 
# 163
(fgrad) ? static_cast< void>(0) : __assert_fail("fgrad", "gradient_3d_7pt_fluid.c", 163, __PRETTY_FUNCTION__); 
# 164
(fgrad->field) ? static_cast< void>(0) : __assert_fail("fgrad->field", "gradient_3d_7pt_fluid.c", 164, __PRETTY_FUNCTION__); 
# 165
((fgrad->field)->le) ? static_cast< void>(0) : __assert_fail("fgrad->field->le", "gradient_3d_7pt_fluid.c", 165, __PRETTY_FUNCTION__); 
# 166
(((fgrad->field)->nf) == 1) ? static_cast< void>(0) : __assert_fail("fgrad->field->nf == 1", "gradient_3d_7pt_fluid.c", 166, __PRETTY_FUNCTION__); 
# 168
cs = ((fgrad->field)->cs); 
# 169
le = ((fgrad->field)->le); 
...
nextra = (nhalo - 1); 
# 173
(nextra >= 0) ? static_cast< void>(0) : __assert_fail("nextra >= 0", "gradient_3d_7pt_fluid.c", 173, __PRETTY_FUNCTION__); 
# 175
...
# 187
int grad_3d_7pt_fluid_operator(cs_t *cs, lees_edw_t *le, field_grad_t *
# 188
fg, int 
# 189
nextra) { 
...
# 198
(le) ? static_cast< void>(0) : __assert_fail("le", "gradient_3d_7pt_fluid.c", 198, __PRETTY_FUNCTION__); 
# 200
...
# 213
do { (__cudaPushCallConfiguration(nblk, ntpb, 0, 0)) ? (void)0 : grad_3d_7pt_fluid_kernel_v(ctxt->target, (fg->field)->nf, ys, letarget, (fg->field)->target, fg->target); } while (0); 
# 215
; 
# 216
{ tdpErrorHandler(tdpPeekAtLastError(), "gradient_3d_7pt_fluid.c", 216, 1); } ; 
# 217
{ tdpErrorHandler(tdpDeviceSynchronize(), "gradient_3d_7pt_fluid.c", 217, 1); } ; 
# 219
...
void grad_3d_7pt_fluid_kernel_v(kernel_ctxt_t *ktx, int nf, int ys, lees_edw_t *
# 236
le, field_t *
# 237
field, field_grad_t *
...
int kiterations; 
# 243
(ktx) ? static_cast< void>(0) : __assert_fail("ktx", "gradient_3d_7pt_fluid.c", 243, __PRETTY_FUNCTION__); 
# 244
(le) ? static_cast< void>(0) : __assert_fail("le", "gradient_3d_7pt_fluid.c", 244, __PRETTY_FUNCTION__); 
# 245
(field) ? static_cast< void>(0) : __assert_fail("field", "gradient_3d_7pt_fluid.c", 245, __PRETTY_FUNCTION__); 
# 246
(fgrad) ? static_cast< void>(0) : __assert_fail("fgrad", "gradient_3d_7pt_fluid.c", 246, __PRETTY_FUNCTION__); 
# 248
...
# 267
for (iv = 0; iv < 1; iv++) { (im1[iv]) = lees_edw_ic_to_buff(le, ic[iv], -1); }  
# 268
for (iv = 0; iv < 1; iv++) { (ip1[iv]) = lees_edw_ic_to_buff(le, ic[iv], +1); }  
# 270
...
if (maskv[iv]) { 
# 276
((fgrad->grad)[reverse_addr_rank2_assert(276, "gradient_3d_7pt_fluid.c", fgrad->nsite, nf, 3, index + iv, n, X)]) = ((0.5) * (((field->data)[reverse_addr_rank1_assert(277, "gradient_3d_7pt_fluid.c", field->nsites, nf, indexp1[iv], n)]) - ((field->data)[reverse_addr_rank1_assert(278, "gradient_3d_7pt_fluid.c", field->nsites, nf, indexm1[iv], n)]))); 
# 279
}  
# 280
}  
...
if (maskv[iv]) { 
# 284
((fgrad->grad)[reverse_addr_rank2_assert(284, "gradient_3d_7pt_fluid.c", fgrad->nsite, nf, 3, index + iv, n, Y)]) = ((0.5) * (((field->data)[reverse_addr_rank1_assert(285, "gradient_3d_7pt_fluid.c", field->nsites, nf, (index + iv) + ys, n)]) - ((field->data)[reverse_addr_rank1_assert(286, "gradient_3d_7pt_fluid.c", field->nsites, nf, (index + iv) - ys, n)]))); 
# 287
}  
# 288
}  
...
if (maskv[iv]) { 
# 292
((fgrad->grad)[reverse_addr_rank2_assert(292, "gradient_3d_7pt_fluid.c", fgrad->nsite, nf, 3, index + iv, n, Z)]) = ((0.5) * (((field->data)[reverse_addr_rank1_assert(293, "gradient_3d_7pt_fluid.c", field->nsites, nf, (index + iv) + 1, n)]) - ((field->data)[reverse_addr_rank1_assert(294, "gradient_3d_7pt_fluid.c", field->nsites, nf, (index + iv) - 1, n)]))); 
# 295
}  
# 296
}  
...
if (maskv[iv]) { 
# 300
((fgrad->delsq)[reverse_addr_rank1_assert(300, "gradient_3d_7pt_fluid.c", fgrad->nsite, nf, index + iv, n)]) = ((((((((field->data)[reverse_addr_rank1_assert(301, "gradient_3d_7pt_fluid.c", field->nsites, nf, indexp1[iv], n)]) + ((field->data)[reverse_addr_rank1_assert(302, "gradient_3d_7pt_fluid.c", field->nsites, nf, indexm1[iv], n)])) + ((field->data)[reverse_addr_rank1_assert(303, "gradient_3d_7pt_fluid.c", field->nsites, nf, (index + iv) + ys, n)])) + ((field->data)[reverse_addr_rank1_assert(304, "gradient_3d_7pt_fluid.c", field->nsites, nf, (index + iv) - ys, n)])) + ((field->data)[reverse_addr_rank1_assert(305, "gradient_3d_7pt_fluid.c", field->nsites, nf, (index + iv) + 1, n)])) + ((field->data)[reverse_addr_rank1_assert(306, "gradient_3d_7pt_fluid.c", field->nsites, nf, (index + iv) - 1, n)])) - ((6.0) * ((field->data)[reverse_addr_rank1_assert(307, "gradient_3d_7pt_fluid.c", field->nsites, nf, index + iv, n)]))); 
# 308
}  
# 309
}  
...
#endif
# 327 "gradient_3d_7pt_fluid.c"
int grad_3d_7pt_fluid_le(lees_edw_t *le, field_grad_t *fg, int 
# 328
nextra) { 
# 330
int nop; 
...
# 346
(le) ? static_cast< void>(0) : __assert_fail("le", "gradient_3d_7pt_fluid.c", 346, __PRETTY_FUNCTION__); 
# 347
(fg) ? static_cast< void>(0) : __assert_fail("fg", "gradient_3d_7pt_fluid.c", 347, __PRETTY_FUNCTION__); 
# 349
lees_edw_nlocal(le, nlocal); 
# 350
lees_edw_nhalo(le, &nhalo); 
...
for (n = 0; n < nop; n++) { 
# 378
(grad[reverse_addr_rank2_assert(378, "gradient_3d_7pt_fluid.c", nsites, nop, 3, index, n, X)]) = ((0.5) * ((field[reverse_addr_rank1_assert(379, "gradient_3d_7pt_fluid.c", nsites, nop, indexp1, n)]) - (field[reverse_addr_rank1_assert(380, "gradient_3d_7pt_fluid.c", nsites, nop, indexm1, n)]))); 
# 381
(grad[reverse_addr_rank2_assert(381, "gradient_3d_7pt_fluid.c", nsites, nop, 3, index, n, Y)]) = ((0.5) * ((field[reverse_addr_rank1_assert(382, "gradient_3d_7pt_fluid.c", nsites, nop, index + ys, n)]) - (field[reverse_addr_rank1_assert(383, "gradient_3d_7pt_fluid.c", nsites, nop, index - ys, n)]))); 
# 384
(grad[reverse_addr_rank2_assert(384, "gradient_3d_7pt_fluid.c", nsites, nop, 3, index, n, Z)]) = ((0.5) * ((field[reverse_addr_rank1_assert(385, "gradient_3d_7pt_fluid.c", nsites, nop, index + 1, n)]) - (field[reverse_addr_rank1_assert(386, "gradient_3d_7pt_fluid.c", nsites, nop, index - 1, n)]))); 
# 387
(del2[reverse_addr_rank1_assert(387, "gradient_3d_7pt_fluid.c", nsites, nop, index, n)]) = (((((((field[reverse_addr_rank1_assert(388, "gradient_3d_7pt_fluid.c", nsites, nop, indexp1, n)]) + (field[reverse_addr_rank1_assert(389, "gradient_3d_7pt_fluid.c", nsites, nop, indexm1, n)])) + (field[reverse_addr_rank1_assert(390, "gradient_3d_7pt_fluid.c", nsites, nop, index + ys, n)])) + (field[reverse_addr_rank1_assert(391, "gradient_3d_7pt_fluid.c", nsites, nop, index - ys, n)])) + (field[reverse_addr_rank1_assert(392, "gradient_3d_7pt_fluid.c", nsites, nop, index + 1, n)])) + (field[reverse_addr_rank1_assert(393, "gradient_3d_7pt_fluid.c", nsites, nop, index - 1, n)])) - ((6.0) * (field[reverse_addr_rank1_assert(394, "gradient_3d_7pt_fluid.c", nsites, nop, index, n)]))); 
# 395
}  
# 396
}  
...
for (n = 0; n < nop; n++) { 
# 416
(grad[reverse_addr_rank2_assert(416, "gradient_3d_7pt_fluid.c", nsites, nop, 3, index, n, X)]) = ((0.5) * ((field[reverse_addr_rank1_assert(417, "gradient_3d_7pt_fluid.c", nsites, nop, indexp1, n)]) - (field[reverse_addr_rank1_assert(418, "gradient_3d_7pt_fluid.c", nsites, nop, indexm1, n)]))); 
# 419
(grad[reverse_addr_rank2_assert(419, "gradient_3d_7pt_fluid.c", nsites, nop, 3, index, n, Y)]) = ((0.5) * ((field[reverse_addr_rank1_assert(420, "gradient_3d_7pt_fluid.c", nsites, nop, index + ys, n)]) - (field[reverse_addr_rank1_assert(421, "gradient_3d_7pt_fluid.c", nsites, nop, index - ys, n)]))); 
# 422
(grad[reverse_addr_rank2_assert(422, "gradient_3d_7pt_fluid.c", nsites, nop, 3, index, n, Z)]) = ((0.5) * ((field[reverse_addr_rank1_assert(423, "gradient_3d_7pt_fluid.c", nsites, nop, index + 1, n)]) - (field[reverse_addr_rank1_assert(424, "gradient_3d_7pt_fluid.c", nsites, nop, index - 1, n)]))); 
# 425
(del2[reverse_addr_rank1_assert(425, "gradient_3d_7pt_fluid.c", nsites, nop, index, n)]) = (((((((field[reverse_addr_rank1_assert(426, "gradient_3d_7pt_fluid.c", nsites, nop, indexp1, n)]) + (field[reverse_addr_rank1_assert(427, "gradient_3d_7pt_fluid.c", nsites, nop, indexm1, n)])) + (field[reverse_addr_rank1_assert(428, "gradient_3d_7pt_fluid.c", nsites, nop, index + ys, n)])) + (field[reverse_addr_rank1_assert(429, "gradient_3d_7pt_fluid.c", nsites, nop, index - ys, n)])) + (field[reverse_addr_rank1_assert(430, "gradient_3d_7pt_fluid.c", nsites, nop, index + 1, n)])) + (field[reverse_addr_rank1_assert(431, "gradient_3d_7pt_fluid.c", nsites, nop, index - 1, n)])) - ((6.0) * (field[reverse_addr_rank1_assert(432, "gradient_3d_7pt_fluid.c", nsites, nop, index, n)]))); 
# 433
}  
# 434
}  
...
# 451 "gradient_3d_7pt_fluid.c"
int grad_3d_7pt_dab_compute(cs_t *cs, lees_edw_t *le, field_grad_t *
# 452
df, int 
# 453
nextra) { 
...
kernel_ctxt_t *ctxt = (__null); 
# 461
(cs) ? static_cast< void>(0) : __assert_fail("cs", "gradient_3d_7pt_fluid.c", 461, __PRETTY_FUNCTION__); 
# 462
(le) ? static_cast< void>(0) : __assert_fail("le", "gradient_3d_7pt_fluid.c", 462, __PRETTY_FUNCTION__); 
# 463
(df) ? static_cast< void>(0) : __assert_fail("df", "gradient_3d_7pt_fluid.c", 463, __PRETTY_FUNCTION__); 
# 465
lees_edw_nlocal(le, nlocal); 
# 466
lees_edw_strides(le, &xs, &ys, &zs); 
...
kernel_ctxt_launch_param(ctxt, &nblk, &ntpb); 
# 476
do { (__cudaPushCallConfiguration(nblk, ntpb, 0, 0)) ? (void)0 : grad_3d_7pt_dab_kernel_v(ctxt->target, letarget, df->target, (df->field)->nsites, ys); } while (0); 
# 477
; 
# 479
{ tdpErrorHandler(tdpPeekAtLastError(), "gradient_3d_7pt_fluid.c", 479, 1); } ; 
# 480
{ tdpErrorHandler(tdpDeviceSynchronize(), "gradient_3d_7pt_fluid.c", 480, 1); } ; 
# 482
kernel_ctxt_free(ctxt); 
# 484
return 0; 
...
void grad_3d_7pt_dab_kernel_v(kernel_ctxt_t *ktx, lees_edw_t *le, field_grad_t *
# 496
df, int nsites, int 
# 497
ys) ;
...
double *__restrict__ field; 
# 504
(ktx) ? static_cast< void>(0) : __assert_fail("ktx", "gradient_3d_7pt_fluid.c", 504, __PRETTY_FUNCTION__); 
# 505
(le) ? static_cast< void>(0) : __assert_fail("le", "gradient_3d_7pt_fluid.c", 505, __PRETTY_FUNCTION__); 
# 506
(df) ? static_cast< void>(0) : __assert_fail("df", "gradient_3d_7pt_fluid.c", 506, __PRETTY_FUNCTION__); 
# 508
field = ((df->field)->data); 
# 509
dab = (df->d_ab); 
...
if (maskv[iv]) { 
# 539
(dab[reverse_addr_rank1_assert(539, "gradient_3d_7pt_fluid.c", nsites, 6, index + iv, XX)]) = ((((+(1.0)) * (field[reverse_addr_rank0_assert(540, "gradient_3d_7pt_fluid.c", nsites, indexp1[iv])])) + ((1.0) * (field[reverse_addr_rank0_assert(541, "gradient_3d_7pt_fluid.c", nsites, indexm1[iv])]))) - ((2.0) * (field[reverse_addr_rank0_assert(542, "gradient_3d_7pt_fluid.c", nsites, index + iv)]))); 
# 544
(dab[reverse_addr_rank1_assert(544, "gradient_3d_7pt_fluid.c", nsites, 6, index + iv, XY)]) = ((0.25) * ((((+(field[reverse_addr_rank0_assert(545, "gradient_3d_7pt_fluid.c", nsites, (indexp1[iv]) + ys)])) - (field[reverse_addr_rank0_assert(546, "gradient_3d_7pt_fluid.c", nsites, (indexp1[iv]) - ys)])) - (field[reverse_addr_rank0_assert(547, "gradient_3d_7pt_fluid.c", nsites, (indexm1[iv]) + ys)])) + (field[reverse_addr_rank0_assert(548, "gradient_3d_7pt_fluid.c", nsites, (indexm1[iv]) - ys)]))); 
# 550
(dab[reverse_addr_rank1_assert(550, "gradient_3d_7pt_fluid.c", nsites, 6, index + iv, XZ)]) = ((0.25) * ((((+(field[reverse_addr_rank0_assert(551, "gradient_3d_7pt_fluid.c", nsites, (indexp1[iv]) + 1)])) - (field[reverse_addr_rank0_assert(552, "gradient_3d_7pt_fluid.c", nsites, (indexp1[iv]) - 1)])) - (field[reverse_addr_rank0_assert(553, "gradient_3d_7pt_fluid.c", nsites, (indexm1[iv]) + 1)])) + (field[reverse_addr_rank0_assert(554, "gradient_3d_7pt_fluid.c", nsites, (indexm1[iv]) - 1)]))); 
# 556
(dab[reverse_addr_rank1_assert(556, "gradient_3d_7pt_fluid.c", nsites, 6, index + iv, YY)]) = ((((+(1.0)) * (field[reverse_addr_rank0_assert(557, "gradient_3d_7pt_fluid.c", nsites, (index + iv) + ys)])) + ((1.0) * (field[reverse_addr_rank0_assert(558, "gradient_3d_7pt_fluid.c", nsites, (index + iv) - ys)]))) - ((2.0) * (field[reverse_addr_rank0_assert(559, "gradient_3d_7pt_fluid.c", nsites, index + iv)]))); 
# 561
(dab[reverse_addr_rank1_assert(561, "gradient_3d_7pt_fluid.c", nsites, 6, index + iv, YZ)]) = ((0.25) * ((((+(field[reverse_addr_rank0_assert(562, "gradient_3d_7pt_fluid.c", nsites, ((index + iv) + ys) + 1)])) - (field[reverse_addr_rank0_assert(563, "gradient_3d_7pt_fluid.c", nsites, ((index + iv) + ys) - 1)])) - (field[reverse_addr_rank0_assert(564, "gradient_3d_7pt_fluid.c", nsites, ((index + iv) - ys) + 1)])) + (field[reverse_addr_rank0_assert(565, "gradient_3d_7pt_fluid.c", nsites, ((index + iv) - ys) - 1)]))); 
# 567
(dab[reverse_addr_rank1_assert(567, "gradient_3d_7pt_fluid.c", nsites, 6, index + iv, ZZ)]) = ((((+(1.0)) * (field[reverse_addr_rank0_assert(568, "gradient_3d_7pt_fluid.c", nsites, (index + iv) + 1)])) + ((1.0) * (field[reverse_addr_rank0_assert(569, "gradient_3d_7pt_fluid.c", nsites, (index + iv) - 1)]))) - ((2.0) * (field[reverse_addr_rank0_assert(570, "gradient_3d_7pt_fluid.c", nsites, index + iv)]))); 
# 571
}  
# 572
}  
...
#endif
# 585 "gradient_3d_7pt_fluid.c"
int grad_3d_7pt_dab_le_correct(lees_edw_t *le, field_grad_t *df, int 
# 586
nextra) { 
# 588
int nlocal[3]; 
...
double *__restrict__ field; 
# 600
(le) ? static_cast< void>(0) : __assert_fail("le", "gradient_3d_7pt_fluid.c", 600, __PRETTY_FUNCTION__); 
# 601
(df) ? static_cast< void>(0) : __assert_fail("df", "gradient_3d_7pt_fluid.c", 601, __PRETTY_FUNCTION__); 
# 602
(nextra >= 0) ? static_cast< void>(0) : __assert_fail("nextra >= 0", "gradient_3d_7pt_fluid.c", 602, __PRETTY_FUNCTION__); 
# 604
lees_edw_nhalo(le, &nhalo); 
# 605
lees_edw_nlocal(le, nlocal); 
...
indexp1 = lees_edw_index(le, ic2, jc, kc); 
# 630
(dab[reverse_addr_rank1_assert(630, "gradient_3d_7pt_fluid.c", nsites, 6, index, XX)]) = ((((+(1.0)) * (field[reverse_addr_rank0_assert(631, "gradient_3d_7pt_fluid.c", nsites, indexp1)])) + ((1.0) * (field[reverse_addr_rank0_assert(632, "gradient_3d_7pt_fluid.c", nsites, indexm1)]))) - ((2.0) * (field[reverse_addr_rank0_assert(633, "gradient_3d_7pt_fluid.c", nsites, index)]))); 
# 634
(dab[reverse_addr_rank1_assert(634, "gradient_3d_7pt_fluid.c", nsites, 6, index, XY)]) = ((0.25) * ((((+(field[reverse_addr_rank0_assert(635, "gradient_3d_7pt_fluid.c", nsites, indexp1 + ys)])) - (field[reverse_addr_rank0_assert(636, "gradient_3d_7pt_fluid.c", nsites, indexp1 - ys)])) - (field[reverse_addr_rank0_assert(637, "gradient_3d_7pt_fluid.c", nsites, indexm1 + ys)])) + (field[reverse_addr_rank0_assert(638, "gradient_3d_7pt_fluid.c", nsites, indexm1 - ys)]))); 
# 639
(dab[reverse_addr_rank1_assert(639, "gradient_3d_7pt_fluid.c", nsites, 6, index, XZ)]) = ((0.25) * ((((+(field[reverse_addr_rank0_assert(640, "gradient_3d_7pt_fluid.c", nsites, indexp1 + 1)])) - (field[reverse_addr_rank0_assert(641, "gradient_3d_7pt_fluid.c", nsites, indexp1 - 1)])) - (field[reverse_addr_rank0_assert(642, "gradient_3d_7pt_fluid.c", nsites, indexm1 + 1)])) + (field[reverse_addr_rank0_assert(643, "gradient_3d_7pt_fluid.c", nsites, indexm1 - 1)]))); 
# 644
(dab[reverse_addr_rank1_assert(644, "gradient_3d_7pt_fluid.c", nsites, 6, index, YY)]) = ((((+(1.0)) * (field[reverse_addr_rank0_assert(645, "gradient_3d_7pt_fluid.c", nsites, index + ys)])) + ((1.0) * (field[reverse_addr_rank0_assert(646, "gradient_3d_7pt_fluid.c", nsites, index - ys)]))) - ((2.0) * (field[reverse_addr_rank0_assert(647, "gradient_3d_7pt_fluid.c", nsites, index)]))); 
# 648
(dab[reverse_addr_rank1_assert(648, "gradient_3d_7pt_fluid.c", nsites, 6, index, YZ)]) = ((0.25) * ((((+(field[reverse_addr_rank0_assert(649, "gradient_3d_7pt_fluid.c", nsites, (index + ys) + 1)])) - (field[reverse_addr_rank0_assert(650, "gradient_3d_7pt_fluid.c", nsites, (index + ys) - 1)])) - (field[reverse_addr_rank0_assert(651, "gradient_3d_7pt_fluid.c", nsites, (index - ys) + 1)])) + (field[reverse_addr_rank0_assert(652, "gradient_3d_7pt_fluid.c", nsites, (index - ys) - 1)]))); 
# 653
(dab[reverse_addr_rank1_assert(653, "gradient_3d_7pt_fluid.c", nsites, 6, index, ZZ)]) = ((((+(1.0)) * (field[reverse_addr_rank0_assert(654, "gradient_3d_7pt_fluid.c", nsites, index + 1)])) + ((1.0) * (field[reverse_addr_rank0_assert(655, "gradient_3d_7pt_fluid.c", nsites, index - 1)]))) - ((2.0) * (field[reverse_addr_rank0_assert(656, "gradient_3d_7pt_fluid.c", nsites, index)]))); 
# 657
}  
# 658
}  
...
indexp1 = lees_edw_index(le, ic2, jc, kc); 
# 676
(dab[reverse_addr_rank1_assert(676, "gradient_3d_7pt_fluid.c", nsites, 6, index, XX)]) = ((((+(1.0)) * (field[reverse_addr_rank0_assert(677, "gradient_3d_7pt_fluid.c", nsites, indexp1)])) + ((1.0) * (field[reverse_addr_rank0_assert(678, "gradient_3d_7pt_fluid.c", nsites, indexm1)]))) - ((2.0) * (field[reverse_addr_rank0_assert(679, "gradient_3d_7pt_fluid.c", nsites, index)]))); 
# 680
(dab[reverse_addr_rank1_assert(680, "gradient_3d_7pt_fluid.c", nsites, 6, index, XY)]) = ((0.25) * ((((+(field[reverse_addr_rank0_assert(681, "gradient_3d_7pt_fluid.c", nsites, indexp1 + ys)])) - (field[reverse_addr_rank0_assert(682, "gradient_3d_7pt_fluid.c", nsites, indexp1 - ys)])) - (field[reverse_addr_rank0_assert(683, "gradient_3d_7pt_fluid.c", nsites, indexm1 + ys)])) + (field[reverse_addr_rank0_assert(684, "gradient_3d_7pt_fluid.c", nsites, indexm1 - ys)]))); 
# 685
(dab[reverse_addr_rank1_assert(685, "gradient_3d_7pt_fluid.c", nsites, 6, index, XZ)]) = ((0.25) * ((((+(field[reverse_addr_rank0_assert(686, "gradient_3d_7pt_fluid.c", nsites, indexp1 + 1)])) - (field[reverse_addr_rank0_assert(687, "gradient_3d_7pt_fluid.c", nsites, indexp1 - 1)])) - (field[reverse_addr_rank0_assert(688, "gradient_3d_7pt_fluid.c", nsites, indexm1 + 1)])) + (field[reverse_addr_rank0_assert(689, "gradient_3d_7pt_fluid.c", nsites, indexm1 - 1)]))); 
# 690
(dab[reverse_addr_rank1_assert(690, "gradient_3d_7pt_fluid.c", nsites, 6, index, YY)]) = ((((+(1.0)) * (field[reverse_addr_rank0_assert(691, "gradient_3d_7pt_fluid.c", nsites, index + ys)])) + ((1.0) * (field[reverse_addr_rank0_assert(692, "gradient_3d_7pt_fluid.c", nsites, index - ys)]))) - ((2.0) * (field[reverse_addr_rank0_assert(693, "gradient_3d_7pt_fluid.c", nsites, index)]))); 
# 694
(dab[reverse_addr_rank1_assert(694, "gradient_3d_7pt_fluid.c", nsites, 6, index, YZ)]) = ((0.25) * ((((+(field[reverse_addr_rank0_assert(695, "gradient_3d_7pt_fluid.c", nsites, (index + ys) + 1)])) - (field[reverse_addr_rank0_assert(696, "gradient_3d_7pt_fluid.c", nsites, (index + ys) - 1)])) - (field[reverse_addr_rank0_assert(697, "gradient_3d_7pt_fluid.c", nsites, (index - ys) + 1)])) + (field[reverse_addr_rank0_assert(698, "gradient_3d_7pt_fluid.c", nsites, (index - ys) - 1)]))); 
# 699
(dab[reverse_addr_rank1_assert(699, "gradient_3d_7pt_fluid.c", nsites, 6, index, ZZ)]) = ((((+(1.0)) * (field[reverse_addr_rank0_assert(700, "gradient_3d_7pt_fluid.c", nsites, index + 1)])) + ((1.0) * (field[reverse_addr_rank0_assert(701, "gradient_3d_7pt_fluid.c", nsites, index - 1)]))) - ((2.0) * (field[reverse_addr_rank0_assert(702, "gradient_3d_7pt_fluid.c", nsites, index)]))); 
# 703
}  
# 704
}  
...
# 1 "gradient_3d_7pt_fluid.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__29_gradient_3d_7pt_fluid_cpp1_ii_cba08ddd
# 1 "gradient_3d_7pt_fluid.cudafe1.stub.c"
#include "gradient_3d_7pt_fluid.cudafe1.stub.c"
# 1 "gradient_3d_7pt_fluid.cudafe1.stub.c"
