...
rtot = (rtot / (10000000)); 
# 84
test_assert_info(fabs(rtot - (0.5)) < (0.001000000000000000021), 84, "test_random.c"); 
# 88
test_assert_info(fabs(rmin - (0.0)) < (0.001000000000000000021), 88, "test_random.c"); 
# 92
test_assert_info(fabs(rmax - (1.0)) < (0.001000000000000000021), 92, "test_random.c"); 
# 100
rtot = (0.0); 
# 101
rvar = (0.0); 
...
rtot = (rtot / (10000000)); 
# 116
test_assert_info(fabs(rtot - (0.0)) < (0.001000000000000000021), 116, "test_random.c"); 
# 120
test_assert_info(rmin < (-(4.0)), 120, "test_random.c"); 
# 124
test_assert_info(rmax > (4.0), 124, "test_random.c"); 
# 127
rvar = (rvar / (10000000)); 
# 129
test_assert_info(fabs(rvar - (1.0)) < (0.001000000000000000021), 129, "test_random.c"); 
# 136
rtot = (0.0); 
# 137
rmin = (1.0); 
...
rtot = (rtot / (10000000)); 
# 149
test_assert_info(fabs(rtot - (0.5)) < (0.001000000000000000021), 149, "test_random.c"); 
# 153
test_assert_info(fabs(rmin - (0.0)) < (0.001000000000000000021), 153, "test_random.c"); 
# 157
test_assert_info(fabs(rmax - (1.0)) < (0.001000000000000000021), 157, "test_random.c"); 
# 164
rtot = (0.0); 
# 165
rvar = (0.0); 
...
rtot = (rtot / (10000000)); 
# 180
test_assert_info(fabs(rtot - (0.0)) < (0.001000000000000000021), 180, "test_random.c"); 
# 184
test_assert_info(rmin < (-(4.0)), 184, "test_random.c"); 
# 188
test_assert_info(rmax > (4.0), 188, "test_random.c"); 
# 191
rvar = (rvar / (10000000)); 
# 193
test_assert_info(fabs(rvar - (1.0)) < (0.001000000000000000021), 193, "test_random.c"); 
# 196
...
# 1 "test_random.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__19_test_random_cpp1_ii_61e01f6d
# 1 "test_random.cudafe1.stub.c"
#include "test_random.cudafe1.stub.c"
# 1 "test_random.cudafe1.stub.c"
