...
# 29 "phi_lb_coupler.c"
void phi_lb_to_field_kernel(kernel_ctxt_t * ktxt, field_t * phi, lb_t * lb); 
# 41 "phi_lb_coupler.c"
int phi_lb_to_field(field_t *phi, lb_t *lb) { 
# 43
int nlocal[3]; 
...
# 48
(phi) ? static_cast< void>(0) : __assert_fail("phi", "phi_lb_coupler.c", 48, __PRETTY_FUNCTION__); 
# 49
(lb) ? static_cast< void>(0) : __assert_fail("lb", "phi_lb_coupler.c", 49, __PRETTY_FUNCTION__); 
# 51
...
# 60
do { (__cudaPushCallConfiguration(nblk, ntpb, 0, 0)) ? (void)0 : phi_lb_to_field_kernel(ctxt->target, phi->target, lb->target); } while (0); 
# 61
; 
# 63
...
# 74
void phi_lb_to_field_kernel(kernel_ctxt_t *ktx, field_t *phi, lb_t *
# 75
lb) ;
#if 0
# 75
...
double phi0; 
# 82
(ktx) ? static_cast< void>(0) : __assert_fail("ktx", "phi_lb_coupler.c", 82, __PRETTY_FUNCTION__); 
# 83
(phi) ? static_cast< void>(0) : __assert_fail("phi", "phi_lb_coupler.c", 83, __PRETTY_FUNCTION__); 
# 84
(lb) ? static_cast< void>(0) : __assert_fail("lb", "phi_lb_coupler.c", 84, __PRETTY_FUNCTION__); 
# 86
...
for (p = 0; p < (NVEL); p++) { 
# 97
phi0 += ((lb->f)[reverse_addr_rank2_assert(97, "phi_lb_coupler.c", lb->nsite, 2, NVEL, index, LB_PHI, p)]); 
# 98
}  
# 100
((phi->data)[reverse_addr_rank0_assert(100, "phi_lb_coupler.c", phi->nsites, index)]) = phi0; 
# 101
}  
# 104
} 
#endif
# 116 "phi_lb_coupler.c"
int phi_lb_from_field(field_t *phi, lb_t *lb) { 
# 118
int p; 
# 119
...
double phi0; 
# 124
(phi) ? static_cast< void>(0) : __assert_fail("phi", "phi_lb_coupler.c", 124, __PRETTY_FUNCTION__); 
# 125
(lb) ? static_cast< void>(0) : __assert_fail("lb", "phi_lb_coupler.c", 125, __PRETTY_FUNCTION__); 
# 127
cs_nlocal(phi->cs, nlocal); 
# 129
...
# 1 "phi_lb_coupler.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__22_phi_lb_coupler_cpp1_ii_7b27d0a0
# 1 "phi_lb_coupler.cudafe1.stub.c"
#include "phi_lb_coupler.cudafe1.stub.c"
# 1 "phi_lb_coupler.cudafe1.stub.c"
