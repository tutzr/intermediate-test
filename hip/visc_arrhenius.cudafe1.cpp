...
# 36 "visc_arrhenius.c"
static void visc_update_kernel(kernel_ctxt_t * ktx, visc_arrhenius_param_t visc_param, field_t * phi, hydro_t * hydro); 
# 41
static const visc_vt_t vt_ = {((visc_free_ft)visc_arrhenius_free), ((visc_update_ft)visc_arrhenius_update), ((visc_stats_ft)visc_arrhenius_stats)}; 
# 53
int visc_arrhenius_create(pe_t *pe, cs_t *cs, field_t *phi, visc_arrhenius_param_t 
# 54
param, visc_arrhenius_t **
# 55
pvisc) { 
# 57
visc_arrhenius_t *visc = (__null); 
# 59
(pe) ? static_cast< void>(0) : __assert_fail("pe", "visc_arrhenius.c", 59, __PRETTY_FUNCTION__); 
# 60
(cs) ? static_cast< void>(0) : __assert_fail("cs", "visc_arrhenius.c", 60, __PRETTY_FUNCTION__); 
# 61
(phi) ? static_cast< void>(0) : __assert_fail("phi", "visc_arrhenius.c", 61, __PRETTY_FUNCTION__); 
# 63
visc = ((visc_arrhenius_t *)calloc(1, sizeof(visc_arrhenius_t))); 
# 64
(visc) ? static_cast< void>(0) : __assert_fail("visc", "visc_arrhenius.c", 64, __PRETTY_FUNCTION__); 
# 65
if (visc == (__null)) { pe_fatal(pe, "calloc(visc_arrhenius_t) failed\n"); }  
# 67
(visc->param) = ((visc_arrhenius_param_t *)calloc(1, sizeof(visc_arrhenius_param_t))); 
# 69
(visc->param) ? static_cast< void>(0) : __assert_fail("visc->param", "visc_arrhenius.c", 69, __PRETTY_FUNCTION__); 
# 70
if ((visc->param) == (__null)) { pe_fatal(pe, "calloc(visc_arrhenius_param_t)\n"); }  
# 71
(*(visc->param)) = param; 
# 73
(visc->pe) = pe; 
...
int visc_arrhenius_free(visc_arrhenius_t *visc) { 
# 95
(visc) ? static_cast< void>(0) : __assert_fail("visc", "visc_arrhenius.c", 95, __PRETTY_FUNCTION__); 
# 97
free(visc->param); 
# 98
free(visc); 
...
pe_t *pe = (__null); 
# 113
(visc) ? static_cast< void>(0) : __assert_fail("visc", "visc_arrhenius.c", 113, __PRETTY_FUNCTION__); 
# 114
(visc->pe) ? static_cast< void>(0) : __assert_fail("visc->pe", "visc_arrhenius.c", 114, __PRETTY_FUNCTION__); 
# 116
pe = (visc->pe); 
# 118
pe_info(pe, "\n"); 
...
# 137 "visc_arrhenius.c"
int visc_arrhenius_stats(visc_arrhenius_t *visc, hydro_t *hydro) { 
# 139
(0) ? static_cast< void>(0) : __assert_fail("0", "visc_arrhenius.c", 139, __PRETTY_FUNCTION__); 
# 141
return 0; 
# 142
} 
...
# 157
(visc) ? static_cast< void>(0) : __assert_fail("visc", "visc_arrhenius.c", 157, __PRETTY_FUNCTION__); 
# 158
(hydro) ? static_cast< void>(0) : __assert_fail("hydro", "visc_arrhenius.c", 158, __PRETTY_FUNCTION__); 
# 160
...
# 166
kernel_ctxt_create(visc->cs, 1, limits, &ctxt); 
# 167
kernel_ctxt_launch_param(ctxt, &nblk, &ntpb); 
# 169
do { (__cudaPushCallConfiguration(nblk, ntpb, 0, 0)) ? (void)0 : visc_update_kernel(ctxt->target, *(visc->param), (visc->phi)->target, hydro->target); } while (0); 
# 170
; 
# 172
{ tdpErrorHandler(tdpPeekAtLastError(), "visc_arrhenius.c", 172, 1); } ; 
# 173
{ tdpErrorHandler(tdpDeviceSynchronize(), "visc_arrhenius.c", 173, 1); } ; 
# 175
...
# 186
static void visc_update_kernel(kernel_ctxt_t *ktx, visc_arrhenius_param_t 
# 187
visc_param, field_t *
# 188
phi, hydro_t *hydro) ;
...
int kiter; 
# 192
(ktx) ? static_cast< void>(0) : __assert_fail("ktx", "visc_arrhenius.c", 192, __PRETTY_FUNCTION__); 
# 193
(phi) ? static_cast< void>(0) : __assert_fail("phi", "visc_arrhenius.c", 193, __PRETTY_FUNCTION__); 
# 194
(hydro) ? static_cast< void>(0) : __assert_fail("hydro", "visc_arrhenius.c", 194, __PRETTY_FUNCTION__); 
# 196
...
# 211
phi0 = ((phi->data)[reverse_addr_rank0_assert(211, "visc_arrhenius.c", phi->nsites, index)]); 
# 212
...
# 217
((hydro->eta)[reverse_addr_rank0_assert(217, "visc_arrhenius.c", hydro->nsite, index)]) = (etaminus * etaplus); 
# 218
}  
# 221
} 
...
# 1 "visc_arrhenius.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__22_visc_arrhenius_cpp1_ii_77229234
# 1 "visc_arrhenius.cudafe1.stub.c"
#include "visc_arrhenius.cudafe1.stub.c"
# 1 "visc_arrhenius.cudafe1.stub.c"
