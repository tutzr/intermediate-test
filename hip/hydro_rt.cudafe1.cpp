...
# 22 "hydro_rt.c"
static int hydro_do_init(pe_t * pe, rt_t * rt, cs_t * cs, lees_edw_t * le, hydro_t ** phydro); 
# 31
int hydro_rt(pe_t *pe, rt_t *rt, cs_t *cs, lees_edw_t *le, hydro_t **
# 32
phydro) { 
# 34
int hswitch = 1; 
...
char value[8192] = ""; 
# 37
(pe) ? static_cast< void>(0) : __assert_fail("pe", "hydro_rt.c", 37, __PRETTY_FUNCTION__); 
# 38
(rt) ? static_cast< void>(0) : __assert_fail("rt", "hydro_rt.c", 38, __PRETTY_FUNCTION__); 
# 39
(phydro) ? static_cast< void>(0) : __assert_fail("phydro", "hydro_rt.c", 39, __PRETTY_FUNCTION__); 
# 41
if (rt_string_parameter(rt, "hydrodynamics", value, 8192)) { 
# 42
...
# 66 "hydro_rt.c"
static int hydro_do_init(pe_t *pe, rt_t *rt, cs_t *cs, lees_edw_t *le, hydro_t **
# 67
phydro) { 
# 69
hydro_t *obj = (__null); 
...
# 77
(rt) ? static_cast< void>(0) : __assert_fail("rt", "hydro_rt.c", 77, __PRETTY_FUNCTION__); 
# 78
(phydro) ? static_cast< void>(0) : __assert_fail("phydro", "hydro_rt.c", 78, __PRETTY_FUNCTION__); 
# 80
hydro_create(pe, cs, le, nhcomm, &obj); 
# 81
(obj) ? static_cast< void>(0) : __assert_fail("obj", "hydro_rt.c", 81, __PRETTY_FUNCTION__); 
# 83
rt_int_parameter_vector(rt, "default_io_grid", io_grid); 
# 84
rt_string_parameter(rt, "vel_format", value, 8192); 
# 86
...
# 1 "hydro_rt.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__16_hydro_rt_cpp1_ii_ddf4734b
# 1 "hydro_rt.cudafe1.stub.c"
#include "hydro_rt.cudafe1.stub.c"
# 1 "hydro_rt.cudafe1.stub.c"
