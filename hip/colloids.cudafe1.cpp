...
colloid_t *tmp; 
# 179
{ tdpErrorHandler(tdpMemcpy(&tmp, &((info->target)->map_new), sizeof(colloid_t **), hipMemcpyDeviceToHost), "colloids.c", 180, 1); 
# 179 "colloids.c"
} 
# 180
; 
# 181
{ tdpErrorHandler(tdpMemcpy(tmp, info->map_new, (info->nsites) * sizeof(colloid_t *), hipMemcpyHostToDevice), "colloids.c", 182, 1); 
# 181 "colloids.c"
} 
# 182
; 
...
# 277
{ tdpErrorHandler(tdpMemcpy(&((info->target)->map_new), &tmp, sizeof(colloid_t **), hipMemcpyHostToDevice), "colloids.c", 278, 1); 
# 277 "colloids.c"
} 
# 278
; 
