...
# 59
(fe) ? static_cast< void>(0) : __assert_fail("fe", "stats_surfactant.c", 59, __PRETTY_FUNCTION__); 
# 60
(0) ? static_cast< void>(0) : __assert_fail("0", "stats_surfactant.c", 60, __PRETTY_FUNCTION__); 
# 63
physics_ref(&phys); 
# 64
cs_nlocal(cs, nlocal); 
...
# 74
(0) ? static_cast< void>(0) : __assert_fail("0", "stats_surfactant.c", 74, __PRETTY_FUNCTION__); 
# 75
(phi[0]) = (0.0); 
# 76
(phi[1]) = (0.0); 
...
sigma += ((0.5) * (e - e0)); 
# 95
(0) ? static_cast< void>(0) : __assert_fail("0", "stats_surfactant.c", 95, __PRETTY_FUNCTION__); 
# 96
...
# 111
pe_info(__null, "Surfactant: %d %12.5e %12.5e %12.5e %12.5e\n", nt, sqrt((1.0) * nt), psi_b, psi_0, sigma); 
# 114
return 0; 
# 115
} 

# 1 "stats_surfactant.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__24_stats_surfactant_cpp1_ii_ce9f21e2
# 1 "stats_surfactant.cudafe1.stub.c"
#include "stats_surfactant.cudafe1.stub.c"
# 1 "stats_surfactant.cudafe1.stub.c"
