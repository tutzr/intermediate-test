...
double a1 = (1.25); 
# 74
double a2 = (2.299999999999999822); 
# 75
...
# 83
(lubr) ? static_cast< void>(0) : __assert_fail("lubr", "test_lubrication.c", 83, __PRETTY_FUNCTION__); 
# 85
lubrication_rch_set(lubr, LUBRICATION_SS_FNORM, rc); 
# 86
lubrication_rchmax(lubr, &rchmax); 
# 87
test_assert_info(fabs(rc - rchmax) < ((double)(2.2204460492503130808e-16L)), 87, "test_lubrication.c"); 
# 91
(fexpect[X]) = (0.0); (fexpect[Y]) = (0.0); (fexpect[Z]) = (0.0); 
# 93
lubrication_single(lubr, a1, a2, u1, u2, r12, ran, factual); 
# 94
test_assert_info(fabs((factual[X]) - (fexpect[X])) < ((1.192092896e-07F)), 94, "test_lubrication.c"); 
# 95
test_assert_info(fabs((factual[Y]) - (fexpect[Y])) < ((1.192092896e-07F)), 95, "test_lubrication.c"); 
# 96
test_assert_info(fabs((factual[Z]) - (fexpect[Z])) < ((1.192092896e-07F)), 96, "test_lubrication.c"); 
# 100
(u1[Z]) = (0.5); 
# 101
(fexpect[Z]) = (-(1.003564300000000076)); 
# 103
lubrication_single(lubr, a1, a2, u1, u2, r12, ran, factual); 
# 104
test_assert_info(fabs((factual[Z]) - (fexpect[Z])) < ((1.192092896e-07F)), 104, "test_lubrication.c"); 
# 106
...
double u2[3] = {(0.0), (0.0), (0.0)}; 
# 131
double r12[3] = {(0.0), (0.0), (3.649999999999999911)}; 
# 132
double ran[2] = {(0.0), (0.0)}; 
# 133
...
double factual[3]; 
# 136
(pe) ? static_cast< void>(0) : __assert_fail("pe", "test_lubrication.c", 136, __PRETTY_FUNCTION__); 
# 137
(cs) ? static_cast< void>(0) : __assert_fail("cs", "test_lubrication.c", 137, __PRETTY_FUNCTION__); 
# 139
lubrication_create(pe, cs, &lubr); 
# 140
(lubr) ? static_cast< void>(0) : __assert_fail("lubr", "test_lubrication.c", 140, __PRETTY_FUNCTION__); 
# 142
lubrication_rch_set(lubr, LUBRICATION_SS_FTANG, rc); 
# 143
lubrication_rchmax(lubr, &rchmax); 
# 144
test_assert_info(fabs(rc - rchmax) < ((double)(2.2204460492503130808e-16L)), 144, "test_lubrication.c"); 
# 148
lubrication_single(lubr, a1, a2, u1, u2, r12, ran, factual); 
# 149
test_assert_info(fabs((fexpect[X]) - (factual[X])) < ((1.192092896e-07F)), 149, "test_lubrication.c"); 
# 150
test_assert_info(fabs((fexpect[Y]) - (factual[Y])) < ((1.192092896e-07F)), 150, "test_lubrication.c"); 
# 151
test_assert_info(fabs((fexpect[Z]) - (factual[Z])) < ((1.192092896e-07F)), 151, "test_lubrication.c"); 
# 155
(u1[X]) = (0.5); 
# 156
(fexpect[X]) = (-(0.4089396499999999879)); 
# 158
lubrication_single(lubr, a1, a2, u1, u2, r12, ran, factual); 
# 159
test_assert_info(fabs((fexpect[X]) - (factual[X])) < ((1.192092896e-07F)), 159, "test_lubrication.c"); 
# 161
lubrication_free(lubr); 
# 163
return 0; 
...
# 1 "test_lubrication.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__24_test_lubrication_cpp1_ii_997f197d
# 1 "test_lubrication.cudafe1.stub.c"
#include "test_lubrication.cudafe1.stub.c"
# 1 "test_lubrication.cudafe1.stub.c"
