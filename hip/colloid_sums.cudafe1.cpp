...
# 85
static int tagf_ = 1070; 
# 86
static int tagb_ = 1071; 
# 94
int colloid_sums_create(colloids_info_t *cinfo, colloid_sum_t **psum) { 
# 96
colloid_sum_t *sum = (__null); 
# 98
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "colloid_sums.c", 98, __PRETTY_FUNCTION__); 
# 100
sum = ((colloid_sum_t *)calloc(1, sizeof(colloid_sum_t))); 
# 101
(sum) ? static_cast< void>(0) : __assert_fail("sum", "colloid_sums.c", 101, __PRETTY_FUNCTION__); 
# 102
if (sum == (__null)) { pe_fatal(cinfo->pe, "calloc(colloid_sum_t) failed\n"); }  
# 104
(sum->pe) = (cinfo->pe); 
# 105
(sum->cs) = (cinfo->cs); 
...
void colloid_sums_free(colloid_sum_t *sum) { 
# 120
(sum) ? static_cast< void>(0) : __assert_fail("sum", "colloid_sums.c", 120, __PRETTY_FUNCTION__); 
# 122
free(sum); 
# 125
} 
...
colloid_sum_t *sum = (__null); 
# 141
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "colloid_sums.c", 141, __PRETTY_FUNCTION__); 
# 143
sum = ((colloid_sum_t *)calloc(1, sizeof(colloid_sum_t))); 
# 144
(sum) ? static_cast< void>(0) : __assert_fail("sum", "colloid_sums.c", 144, __PRETTY_FUNCTION__); 
# 145
if (sum == (__null)) { pe_fatal(cinfo->pe, "calloc(colloid_sum_t) failed\n"); }  
# 147
(sum->pe) = (cinfo->pe); 
...
MPI_Status status[2]; 
# 176
(sum) ? static_cast< void>(0) : __assert_fail("sum", "colloid_sums.c", 176, __PRETTY_FUNCTION__); 
# 177
(sum->cinfo) ? static_cast< void>(0) : __assert_fail("sum->cinfo", "colloid_sums.c", 177, __PRETTY_FUNCTION__); 
# 178
(mtype < (COLLOID_SUM_MAX)) ? static_cast< void>(0) : __assert_fail("mtype < COLLOID_SUM_MAX", "colloid_sums.c", 178, __PRETTY_FUNCTION__); 
# 182
(sum->mtype) = mtype; 
# 183
(sum->msize) = (msize_[mtype]); 
...
# 193
if ((sum->send) == (__null)) { pe_fatal(sum->pe, "malloc(sum->send) failed\n"); }  
# 194
if ((sum->recv) == (__null)) { pe_fatal(sum->pe, "malloc(sum->recv) failed\n"); }  
# 198
...
# 282
if (((((sum->cs)->param)->mpi_cartcoords)[dim]) == (((((sum->cs)->param)->mpi_cartsz)[dim]) - 1)) { 
# 283
((sum->ncount)[CS_FORW]) = 0; }  
# 284
}  
# 286
return 0; 
...
# 295
static int colloid_sums_irecv(colloid_sum_t *sum, int dim, MPI_Request 
# 296
req[2]) { 
# 297
int nf, pforw; 
...
# 310
if (nb > 0) { MPI_Irecv((sum->recv) + nf, nb, MPI_DOUBLE, pback, tagf_, (sum->cs)->commcart, req); }  
# 312
if (nf > 0) { MPI_Irecv(sum->recv, nf, MPI_DOUBLE, pforw, tagb_, (sum->cs)->commcart, req + 1); }  
# 314
}  
# 316
return 0; 
...
# 325
static int colloid_sums_isend(colloid_sum_t *sum, int dim, MPI_Request 
# 326
req[2]) { 
# 327
int nf, pforw; 
...
pback = ((((sum->cs)->mpi_cart_neighbours)[CS_BACK])[dim]); 
# 344
if (nb > 0) { MPI_Issend(sum->send, nb, MPI_DOUBLE, pback, tagb_, (sum->cs)->commcart, req); }  
# 346
if (nf > 0) { MPI_Issend((sum->send) + nb, nf, MPI_DOUBLE, pforw, tagf_, (sum->cs)->commcart, req + 1); }  
# 348
}  
# 350
return 0; 
...
int ncell[3]; 
# 373
int (*mloader_forw)(colloid_sum_t *, int, int, int, int) = (__null); 
# 374
int (*mloader_back)(colloid_sum_t *, int, int, int, int) = (__null); 
# 376
colloids_info_ncell(sum->cinfo, ncell); 
# 378
...
# 385
(mloader_forw) ? static_cast< void>(0) : __assert_fail("mloader_forw", "colloid_sums.c", 385, __PRETTY_FUNCTION__); 
# 386
...
if ((sum->mload) == (MESSAGE_LOAD)) { 
# 442
(nb == ((sum->ncount)[BACKWARD])) ? static_cast< void>(0) : __assert_fail("nb == sum->ncount[BACKWARD]", "colloid_sums.c", 442, __PRETTY_FUNCTION__); 
# 443
(nf == (((sum->ncount)[BACKWARD]) + ((sum->ncount)[FORWARD]))) ? static_cast< void>(0) : __assert_fail("nf == sum->ncount[BACKWARD] + sum->ncount[FORWARD]", "colloid_sums.c", 443, __PRETTY_FUNCTION__); 
# 444
} else 
# 445
{ 
# 446
(nb == (((sum->ncount)[FORWARD]) + ((sum->ncount)[BACKWARD]))) ? static_cast< void>(0) : __assert_fail("nb == sum->ncount[FORWARD] + sum->ncount[BACKWARD]", "colloid_sums.c", 446, __PRETTY_FUNCTION__); 
# 447
(nf == ((sum->ncount)[FORWARD])) ? static_cast< void>(0) : __assert_fail("nf == sum->ncount[FORWARD]", "colloid_sums.c", 447, __PRETTY_FUNCTION__); 
# 448
}  
# 450
return 0; 
...
# 461 "colloid_sums.c"
static int colloid_sums_m0(colloid_sum_t *sum, int ic, int jc, int kc, int 
# 462
noff) { 
# 464
return 0; 
...
# 478 "colloid_sums.c"
static int colloid_sums_m1(colloid_sum_t *sum, int ic, int jc, int kc, int 
# 479
noff) { 
# 481
int n, npart; 
...
# 502
(n == (((noff + npart) + 1) * (sum->msize))) ? static_cast< void>(0) : __assert_fail("n == (noff + npart + 1)*sum->msize", "colloid_sums.c", 502, __PRETTY_FUNCTION__); 
# 503
} else 
# 504
{ 
...
# 519
(n == (((noff + npart) + 1) * (sum->msize))) ? static_cast< void>(0) : __assert_fail("n == (noff + npart + 1)*sum->msize", "colloid_sums.c", 519, __PRETTY_FUNCTION__); 
# 520
}  
# 522
npart++; 
...
# 537 "colloid_sums.c"
static int colloid_sums_m2(colloid_sum_t *sum, int ic, int jc, int kc, int 
# 538
noff) { 
# 540
int n, npart; 
...
# 563
(n == (((noff + npart) + 1) * (sum->msize))) ? static_cast< void>(0) : __assert_fail("n == (noff + npart + 1)*sum->msize", "colloid_sums.c", 563, __PRETTY_FUNCTION__); 
# 564
} else 
# 565
{ 
...
# 582
(n == (((noff + npart) + 1) * (sum->msize))) ? static_cast< void>(0) : __assert_fail("n == (noff + npart + 1)*sum->msize", "colloid_sums.c", 582, __PRETTY_FUNCTION__); 
# 583
}  
# 585
npart++; 
...
# 600 "colloid_sums.c"
static int colloid_sums_m3(colloid_sum_t *sum, int ic, int jc, int kc, int 
# 601
noff) { 
# 603
int n, npart; 
...
# 620
(n == (((noff + npart) + 1) * (sum->msize))) ? static_cast< void>(0) : __assert_fail("n == (noff + npart + 1)*sum->msize", "colloid_sums.c", 620, __PRETTY_FUNCTION__); 
# 621
} else 
# 622
{ 
...
# 633
(n == (((noff + npart) + 1) * (sum->msize))) ? static_cast< void>(0) : __assert_fail("n == (noff + npart + 1)*sum->msize", "colloid_sums.c", 633, __PRETTY_FUNCTION__); 
# 634
}  
# 636
npart++; 
...
# 651 "colloid_sums.c"
static int colloid_sums_m4(colloid_sum_t *sum, int ic, int jc, int kc, int 
# 652
noff) { 
# 654
int n, npart; 
...
# 670
(n == (((noff + npart) + 1) * (sum->msize))) ? static_cast< void>(0) : __assert_fail("n == (noff + npart + 1)*sum->msize", "colloid_sums.c", 670, __PRETTY_FUNCTION__); 
# 671
} else 
# 672
{ 
...
# 682
(n == (((noff + npart) + 1) * (sum->msize))) ? static_cast< void>(0) : __assert_fail("n == (noff + npart + 1)*sum->msize", "colloid_sums.c", 682, __PRETTY_FUNCTION__); 
# 683
}  
# 685
npart++; 
...
# 703 "colloid_sums.c"
static int colloid_sums_m5(colloid_sum_t *sum, int ic, int jc, int kc, int 
# 704
noff) { 
# 706
int n, npart; 
...
((sum->send)[n++]) = ((pc->s).saf); 
# 724
(n == (((noff + npart) + 1) * (msize_[sum->mtype]))) ? static_cast< void>(0) : __assert_fail("n == (noff + npart + 1)*msize_[sum->mtype]", "colloid_sums.c", 724, __PRETTY_FUNCTION__); 
# 725
} else 
# 726
{ 
...
((pc->s).saf) += ((sum->recv)[n++]); 
# 740
(n == (((noff + npart) + 1) * (msize_[sum->mtype]))) ? static_cast< void>(0) : __assert_fail("n == (noff + npart + 1)*msize_[sum->mtype]", "colloid_sums.c", 740, __PRETTY_FUNCTION__); 
# 741
}  
# 743
npart++; 
...
# 758 "colloid_sums.c"
static int colloid_sums_m6(colloid_sum_t *sum, int ic, int jc, int kc, int 
# 759
noff) { 
# 761
int n, npart; 
...
# 778
(n == (((noff + npart) + 1) * (sum->msize))) ? static_cast< void>(0) : __assert_fail("n == (noff + npart + 1)*sum->msize", "colloid_sums.c", 778, __PRETTY_FUNCTION__); 
# 779
} else 
# 780
{ 
...
# 791
(n == (((noff + npart) + 1) * (sum->msize))) ? static_cast< void>(0) : __assert_fail("n == (noff + npart + 1)*sum->msize", "colloid_sums.c", 791, __PRETTY_FUNCTION__); 
# 792
}  
# 794
npart++; 
...
# 1 "colloid_sums.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__20_colloid_sums_cpp1_ii_8763a098
# 1 "colloid_sums.cudafe1.stub.c"
#include "colloid_sums.cudafe1.stub.c"
# 1 "colloid_sums.cudafe1.stub.c"
