...
# 23 "test_io_options.c"
int test_io_options_mode_valid(); 
# 24
int test_io_options_record_format_valid(); 
# 25
int test_io_options_metadata_version_valid(); 
# 26
int test_io_options_default(); 
# 34
...
mode = IO_MODE_SINGLE; 
# 65
(io_options_mode_valid(mode)) ? static_cast< void>(0) : __assert_fail("io_options_mode_valid(mode)", "test_io_options.c", 65, __PRETTY_FUNCTION__); 
# 67
mode = IO_MODE_MULTIPLE; 
# 68
(io_options_mode_valid(mode)) ? static_cast< void>(0) : __assert_fail("io_options_mode_valid(mode)", "test_io_options.c", 68, __PRETTY_FUNCTION__); 
# 70
mode = IO_MODE_INVALID; 
# 71
(io_options_mode_valid(mode) == 0) ? static_cast< void>(0) : __assert_fail("io_options_mode_valid(mode) == 0", "test_io_options.c", 71, __PRETTY_FUNCTION__); 
# 73
return 0; 
# 74
} 
# 83 "test_io_options.c"
int test_io_options_record_format_valid() { 
# 85
...
# 88
(io_options_record_format_valid(iorformat)) ? static_cast< void>(0) : __assert_fail("io_options_record_format_valid(iorformat)", "test_io_options.c", 88, __PRETTY_FUNCTION__); 
# 90
iorformat = IO_RECORD_BINARY; 
# 91
(io_options_record_format_valid(iorformat)) ? static_cast< void>(0) : __assert_fail("io_options_record_format_valid(iorformat)", "test_io_options.c", 91, __PRETTY_FUNCTION__); 
# 93
iorformat = IO_RECORD_INVALID; 
# 94
(io_options_record_format_valid(iorformat) == 0) ? static_cast< void>(0) : __assert_fail("io_options_record_format_valid(iorformat) == 0", "test_io_options.c", 94, __PRETTY_FUNCTION__); 
# 96
return 0; 
# 97
} 
# 106 "test_io_options.c"
int test_io_options_metadata_version_valid() { 
# 108
io_options_t opts = {}; 
# 111
...
# 114
(io_options_metadata_version_valid(&opts) == 0) ? static_cast< void>(0) : __assert_fail("io_options_metadata_version_valid(&opts) == 0", "test_io_options.c", 114, __PRETTY_FUNCTION__); 
# 117
(opts.mode) = IO_MODE_MULTIPLE; 
# 118
(opts.metadata_version) = IO_METADATA_SINGLE_V1; 
# 120
(io_options_metadata_version_valid(&opts) == 0) ? static_cast< void>(0) : __assert_fail("io_options_metadata_version_valid(&opts) == 0", "test_io_options.c", 120, __PRETTY_FUNCTION__); 
# 123
(opts.mode) = IO_MODE_SINGLE; 
# 124
(opts.metadata_version) = IO_METADATA_SINGLE_V1; 
# 126
(io_options_metadata_version_valid(&opts)) ? static_cast< void>(0) : __assert_fail("io_options_metadata_version_valid(&opts)", "test_io_options.c", 126, __PRETTY_FUNCTION__); 
# 129
(opts.mode) = IO_MODE_MULTIPLE; 
# 130
(opts.metadata_version) = IO_METADATA_MULTI_V1; 
# 132
(io_options_metadata_version_valid(&opts)) ? static_cast< void>(0) : __assert_fail("io_options_metadata_version_valid(&opts)", "test_io_options.c", 132, __PRETTY_FUNCTION__); 
# 134
return 0; 
# 135
} 
# 144 "test_io_options.c"
int test_io_options_default() { 
# 146
io_options_t opts = io_options_default(); 
# 148
(io_options_mode_valid(opts.mode)) ? static_cast< void>(0) : __assert_fail("io_options_mode_valid(opts.mode)", "test_io_options.c", 148, __PRETTY_FUNCTION__); 
# 149
(io_options_record_format_valid(opts.iorformat)) ? static_cast< void>(0) : __assert_fail("io_options_record_format_valid(opts.iorformat)", "test_io_options.c", 149, __PRETTY_FUNCTION__); 
# 150
(io_options_metadata_version_valid(&opts)) ? static_cast< void>(0) : __assert_fail("io_options_metadata_version_valid(&opts)", "test_io_options.c", 150, __PRETTY_FUNCTION__); 
# 151
(io_options_valid(&opts)) ? static_cast< void>(0) : __assert_fail("io_options_valid(&opts)", "test_io_options.c", 151, __PRETTY_FUNCTION__); 
# 153
((opts.report) == 0) ? static_cast< void>(0) : __assert_fail("opts.report == 0", "test_io_options.c", 153, __PRETTY_FUNCTION__); 
# 154
((opts.asynchronous) == 0) ? static_cast< void>(0) : __assert_fail("opts.asynchronous == 0", "test_io_options.c", 154, __PRETTY_FUNCTION__); 
# 156
return 0; 
# 157
} 

# 1 "test_io_options.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__23_test_io_options_cpp1_ii_419a27cd
# 1 "test_io_options.cudafe1.stub.c"
#include "test_io_options.cudafe1.stub.c"
# 1 "test_io_options.cudafe1.stub.c"
