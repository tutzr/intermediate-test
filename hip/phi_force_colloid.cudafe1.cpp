...
# 67 "phi_force_colloid.c"
int pth_force_driver(pth_t * pth, colloids_info_t * cinfo, hydro_t * hydro, map_t * map, wall_t * wall); 
# 70
void pth_force_map_kernel(kernel_ctxt_t * ktx, pth_t * pth, hydro_t * hydro, map_t * map); 
# 72
void pth_force_wall_kernel(kernel_ctxt_t * ktx, pth_t * pth, map_t * map, wall_t * wall, double  fw[3]); 
# 75
void pth_force_fluid_kernel_v(kernel_ctxt_t * ktx, pth_t * pth, hydro_t * hydro); 
# 86 "phi_force_colloid.c"
int pth_force_colloid(pth_t *pth, fe_t *fe, colloids_info_t *cinfo, hydro_t *
# 87
hydro, map_t *map, wall_t *wall) { 
# 89
int ncolloid; 
# 91
(pth) ? static_cast< void>(0) : __assert_fail("pth", "phi_force_colloid.c", 91, __PRETTY_FUNCTION__); 
# 93
colloids_info_ntotal(cinfo, &ncolloid); 
# 95
if ((hydro == (__null)) && (ncolloid == 0)) { return 0; }  
# 97
...
# 117 "phi_force_colloid.c"
static double fs[3]; 
# 119
int pth_force_driver(pth_t *pth, colloids_info_t *cinfo, hydro_t *
# 120
hydro, map_t *map, wall_t *wall) { 
# 121
int ia; 
...
# 132
(pth) ? static_cast< void>(0) : __assert_fail("pth", "phi_force_colloid.c", 132, __PRETTY_FUNCTION__); 
# 133
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "phi_force_colloid.c", 133, __PRETTY_FUNCTION__); 
# 134
(hydro) ? static_cast< void>(0) : __assert_fail("hydro", "phi_force_colloid.c", 134, __PRETTY_FUNCTION__); 
# 135
(map) ? static_cast< void>(0) : __assert_fail("map", "phi_force_colloid.c", 135, __PRETTY_FUNCTION__); 
# 137
...
# 144
kernel_ctxt_create(pth->cs, 1, limits, &ctxt); 
# 145
kernel_ctxt_launch_param(ctxt, &nblk, &ntpb); 
# 147
{ tdpErrorHandler(hipGetSymbolAddress((void **)(&fwd), &fs), "phi_force_colloid.c", 147, 1); } ; 
# 148
tdpMemcpy(fwd, fw, (3) * sizeof(double), hipMemcpyHostToDevice); 
# 150
TIMER_start(TIMER_PHI_FORCE_CALC); 
# 152
do { (__cudaPushCallConfiguration(nblk, ntpb, 0, 0)) ? (void)0 : pth_force_map_kernel(ctxt->target, pth->target, hydro->target, map->target); } while (0); 
# 153
; 
# 155
do { (__cudaPushCallConfiguration(nblk, ntpb, 0, 0)) ? (void)0 : pth_force_wall_kernel(ctxt->target, pth->target, map->target, wallt, fwd); } while (0); 
# 156
; 
# 157
...
# 161
tdpMemcpy(fw, fwd, (3) * sizeof(double), hipMemcpyDeviceToHost); 
# 162
wall_momentum_add(wall, fw); 
# 168
TIMER_start(TIMER_FREE3); 
# 173
pth_memcpy(pth, hipMemcpyDeviceToHost); 
# 176
colloid_t *pc; 
# 177
...
for (ia = 0; ia < 3; ia++) { 
# 202
((pc->force)[ia]) += (((1.0) * ((cv[p])[id])) * ((pth->str)[reverse_addr_rank2_assert(203, "phi_force_colloid.c", pth->nsites, 3, 3, p_link->i, ia, id)])); 
# 204
}  
# 205
}  
...
# 223 "phi_force_colloid.c"
int pth_force_fluid_wall_driver(pth_t *pth, hydro_t *hydro, map_t *
# 224
map, wall_t *wall) { 
# 225
int nlocal[3]; 
...
double fw[3] = {(0.0), (0.0), (0.0)}; 
# 235
(pth) ? static_cast< void>(0) : __assert_fail("pth", "phi_force_colloid.c", 235, __PRETTY_FUNCTION__); 
# 236
(hydro) ? static_cast< void>(0) : __assert_fail("hydro", "phi_force_colloid.c", 236, __PRETTY_FUNCTION__); 
# 237
(map) ? static_cast< void>(0) : __assert_fail("map", "phi_force_colloid.c", 237, __PRETTY_FUNCTION__); 
# 239
cs_nlocal(pth->cs, nlocal); 
# 240
wall_target(wall, &wallt); 
...
kernel_ctxt_launch_param(ctxt, &nblk, &ntpb); 
# 249
{ tdpErrorHandler(hipGetSymbolAddress((void **)(&fwd), &fs), "phi_force_colloid.c", 249, 1); } ; 
# 250
tdpMemcpy(fwd, fw, (3) * sizeof(double), hipMemcpyHostToDevice); 
# 252
do { (__cudaPushCallConfiguration(nblk, ntpb, 0, 0)) ? (void)0 : pth_force_map_kernel(ctxt->target, pth->target, hydro->target, map->target); } while (0); 
...
kernel_ctxt_t *ctxt = (__null); 
# 283
(pth) ? static_cast< void>(0) : __assert_fail("pth", "phi_force_colloid.c", 283, __PRETTY_FUNCTION__); 
# 284
(hydro) ? static_cast< void>(0) : __assert_fail("hydro", "phi_force_colloid.c", 284, __PRETTY_FUNCTION__); 
# 286
cs_nlocal(pth->cs, nlocal); 
# 288
(limits.imin) = 1; (limits.imax) = (nlocal[X]); 
...
TIMER_start(TIMER_PHI_FORCE_CALC); 
# 297
do { (__cudaPushCallConfiguration(nblk, ntpb, 0, 0)) ? (void)0 : pth_force_fluid_kernel_v(ctxt->target, pth->target, hydro->target); } while (0); 
# 298
; 
# 299
tdpDeviceSynchronize(); 
...
void pth_force_fluid_kernel_v(kernel_ctxt_t *ktx, pth_t *pth, hydro_t *
# 321
hydro) ;
#if 0
# 321
...
int kiterations; 
# 325
(ktx) ? static_cast< void>(0) : __assert_fail("ktx", "phi_force_colloid.c", 325, __PRETTY_FUNCTION__); 
# 326
(pth) ? static_cast< void>(0) : __assert_fail("pth", "phi_force_colloid.c", 326, __PRETTY_FUNCTION__); 
# 327
(hydro) ? static_cast< void>(0) : __assert_fail("hydro", "phi_force_colloid.c", 327, __PRETTY_FUNCTION__); 
# 329
...
for (iv = 0; iv < 1; iv++) { 
# 356
(((pth0[ia])[ib])[iv]) = ((pth->str)[reverse_addr_rank2_assert(356, "phi_force_colloid.c", pth->nsites, 3, 3, index + iv, ia, ib)]); 
# 357
}  
# 358
}  
...
# 363
for (iv = 0; iv < 1; iv++) { (pm[iv]) = ((ic[iv]) + (maskv[iv])); }  
# 364
...
for (iv = 0; iv < 1; iv++) { 
# 369
(((pth1[ia])[ib])[iv]) = ((pth->str)[reverse_addr_rank2_assert(369, "phi_force_colloid.c", pth->nsites, 3, 3, index1[iv], ia, ib)]); 
# 370
}  
# 371
}  
...
for (iv = 0; iv < 1; iv++) { 
# 387
(((pth1[ia])[ib])[iv]) = ((pth->str)[reverse_addr_rank2_assert(387, "phi_force_colloid.c", pth->nsites, 3, 3, index1[iv], ia, ib)]); 
# 388
}  
# 389
}  
...
# 398
for (iv = 0; iv < 1; iv++) { (pm[iv]) = ((jc[iv]) + (maskv[iv])); }  
# 399
...
for (iv = 0; iv < 1; iv++) { 
# 404
(((pth1[ia])[ib])[iv]) = ((pth->str)[reverse_addr_rank2_assert(404, "phi_force_colloid.c", pth->nsites, 3, 3, index1[iv], ia, ib)]); 
# 405
}  
# 406
}  
...
for (iv = 0; iv < 1; iv++) { 
# 421
(((pth1[ia])[ib])[iv]) = ((pth->str)[reverse_addr_rank2_assert(421, "phi_force_colloid.c", pth->nsites, 3, 3, index1[iv], ia, ib)]); 
# 422
}  
# 423
}  
...
# 432
for (iv = 0; iv < 1; iv++) { (pm[iv]) = ((kc[iv]) + (maskv[iv])); }  
# 433
...
for (iv = 0; iv < 1; iv++) { 
# 438
(((pth1[ia])[ib])[iv]) = ((pth->str)[reverse_addr_rank2_assert(438, "phi_force_colloid.c", pth->nsites, 3, 3, index1[iv], ia, ib)]); 
# 439
}  
# 440
}  
...
for (iv = 0; iv < 1; iv++) { 
# 455
(((pth1[ia])[ib])[iv]) = ((pth->str)[reverse_addr_rank2_assert(455, "phi_force_colloid.c", pth->nsites, 3, 3, index1[iv], ia, ib)]); 
# 456
}  
# 457
}  
...
for (iv = 0; iv < 1; iv++) { 
# 470
((hydro->f)[reverse_addr_rank1_assert(470, "phi_force_colloid.c", hydro->nsite, 3, index + iv, ia)]) += (((force[ia])[iv]) * (maskv[iv])); 
# 472
}  
# 473
}  
...
void pth_force_map_kernel(kernel_ctxt_t *ktx, pth_t *pth, hydro_t *
# 489
hydro, map_t *map) ;
#if 0
# 489
...
int kiterations; 
# 494
(ktx) ? static_cast< void>(0) : __assert_fail("ktx", "phi_force_colloid.c", 494, __PRETTY_FUNCTION__); 
# 495
(pth) ? static_cast< void>(0) : __assert_fail("pth", "phi_force_colloid.c", 495, __PRETTY_FUNCTION__); 
# 496
(hydro) ? static_cast< void>(0) : __assert_fail("hydro", "phi_force_colloid.c", 496, __PRETTY_FUNCTION__); 
# 497
(map) ? static_cast< void>(0) : __assert_fail("map", "phi_force_colloid.c", 497, __PRETTY_FUNCTION__); 
# 499
...
for (ib = 0; ib < 3; ib++) { 
# 522
((pth0[ia])[ib]) = ((pth->str)[reverse_addr_rank2_assert(522, "phi_force_colloid.c", pth->nsites, 3, 3, index, ia, ib)]); 
# 523
}  
# 524
}  
...
for (ib = 0; ib < 3; ib++) { 
# 540
((pth1[ia])[ib]) = ((pth->str)[reverse_addr_rank2_assert(540, "phi_force_colloid.c", pth->nsites, 3, 3, index1, ia, ib)]); 
# 541
}  
# 542
}  
...
for (ib = 0; ib < 3; ib++) { 
# 560
((pth1[ia])[ib]) = ((pth->str)[reverse_addr_rank2_assert(560, "phi_force_colloid.c", pth->nsites, 3, 3, index1, ia, ib)]); 
# 561
}  
# 562
}  
...
for (ib = 0; ib < 3; ib++) { 
# 580
((pth1[ia])[ib]) = ((pth->str)[reverse_addr_rank2_assert(580, "phi_force_colloid.c", pth->nsites, 3, 3, index1, ia, ib)]); 
# 581
}  
# 582
}  
...
for (ib = 0; ib < 3; ib++) { 
# 600
((pth1[ia])[ib]) = ((pth->str)[reverse_addr_rank2_assert(600, "phi_force_colloid.c", pth->nsites, 3, 3, index1, ia, ib)]); 
# 601
}  
# 602
}  
...
for (ib = 0; ib < 3; ib++) { 
# 620
((pth1[ia])[ib]) = ((pth->str)[reverse_addr_rank2_assert(620, "phi_force_colloid.c", pth->nsites, 3, 3, index1, ia, ib)]); 
# 621
}  
# 622
}  
...
for (ib = 0; ib < 3; ib++) { 
# 640
((pth1[ia])[ib]) = ((pth->str)[reverse_addr_rank2_assert(640, "phi_force_colloid.c", pth->nsites, 3, 3, index1, ia, ib)]); 
# 641
}  
# 642
}  
...
for (ia = 0; ia < 3; ia++) { 
# 651
((hydro->f)[reverse_addr_rank1_assert(651, "phi_force_colloid.c", hydro->nsite, 3, index, ia)]) += (force[ia]); 
# 652
}  
# 653
}  
...
void pth_force_wall_kernel(kernel_ctxt_t *ktx, pth_t *pth, map_t *
# 674
map, wall_t *wall, double 
# 675
fw[3]) ;
#if 0
# 675
...
# 691
(ktx) ? static_cast< void>(0) : __assert_fail("ktx", "phi_force_colloid.c", 691, __PRETTY_FUNCTION__); 
# 692
(pth) ? static_cast< void>(0) : __assert_fail("pth", "phi_force_colloid.c", 692, __PRETTY_FUNCTION__); 
# 693
(map) ? static_cast< void>(0) : __assert_fail("map", "phi_force_colloid.c", 693, __PRETTY_FUNCTION__); 
# 694
(wall) ? static_cast< void>(0) : __assert_fail("wall", "phi_force_colloid.c", 694, __PRETTY_FUNCTION__); 
# 696
kiterations = kernel_iterations(ktx); 
# 698
...
for (ib = 0; ib < 3; ib++) { 
# 717
((pth0[ia])[ib]) = ((pth->str)[reverse_addr_rank2_assert(717, "phi_force_colloid.c", pth->nsites, 3, 3, index, ia, ib)]); 
# 718
}  
# 719
}  
...
# 1 "phi_force_colloid.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__25_phi_force_colloid_cpp1_ii_ca3cfde1
# 1 "phi_force_colloid.cudafe1.stub.c"
#include "phi_force_colloid.cudafe1.stub.c"
# 1 "phi_force_colloid.cudafe1.stub.c"
