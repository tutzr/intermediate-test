...
# 25
int advflux_create(pe_t * pe, cs_t * cs, lees_edw_t * le, int nf, advflux_t ** pobj); 
# 27
int advflux_cs_create(pe_t * pe, cs_t * cs, int nf, advflux_t ** obj); 
# 28
int advflux_le_create(pe_t * pe, cs_t * cs, lees_edw_t * le, int nf, advflux_t ** pobj); 
# 30
int advflux_free(advflux_t * obj); 
# 31
int advflux_memcpy(advflux_t * obj); 
# 33
int advection_x(advflux_t * obj, hydro_t * hydro, field_t * field); 
# 34
int advective_fluxes_d3qx(hydro_t * hydro, int nf, double * f, double ** flx); 
# 36
int advective_fluxes_2nd_d3qx(hydro_t * hydro, int nf, double * f, double ** flx); 
# 39
...
# 31 "psi.h"
enum psi_force_method { PSI_FORCE_NONE, 
# 32
...
# 26
int fe_electro_create(pe_t * pe, psi_t * psi, fe_electro_t ** fe); 
# 27
int fe_electro_free(fe_electro_t * fe); 
# 28
int fe_electro_ext_set(fe_electro_t * fe, double  ext_field[3]); 
# 29
int fe_electro_target(fe_electro_t * fe, fe_t ** target); 
# 31
...
# 40
int fe_es_create(pe_t * pe, cs_t * cs, fe_symm_t * fe_symm, fe_electro_t * fe_elec, psi_t * psi, fe_es_t ** fe); 
# 43
int fe_es_free(fe_es_t * fe); 
# 44
int fe_es_target(fe_es_t * fe, fe_t ** target); 
# 47
...
# 46
int psi_grad_eps_d3qx(psi_t * psi, fe_t * fe, f_vare_t fepsilon, int index, double * grad_eps); 
# 25 "timer.h"
...
# 48
static int advection_le_4th(advflux_t * flux, hydro_t * hydro, int nf, double * f); 
# 50
static int advection_le_5th(advflux_t * flux, hydro_t * hydro, int nf, double * f); 
# 54
void advection_le_1st_kernel(kernel_ctxt_t * ktx, advflux_t * flux, hydro_t * hydro, field_t * field); 
# 57
void advection_2nd_kernel(kernel_ctxt_t * ktx, advflux_t * flux, hydro_t * hydro, field_t * field); 
# 60
void advection_2nd_kernel_v(kernel_ctxt_t * ktx, advflux_t * flux, hydro_t * hydro, field_t * field); 
# 63
void advection_3rd_kernel_v(kernel_ctxt_t * ktx, advflux_t * flux, hydro_t * hydro, field_t * field); 
# 66
void advection_le_3rd_kernel_v(kernel_ctxt_t * ktx, lees_edw_t * le, advflux_t * flux, hydro_t * hydro, field_t * field); 
# 72
static int order_ = 1; 
# 80
...
int advection_order(int *order) { 
# 94
(order) ? static_cast< void>(0) : __assert_fail("order", "advection.c", 94, __PRETTY_FUNCTION__); 
# 96
(*order) = order_; 
# 98
return 0; 
...
# 107
int advflux_cs_create(pe_t *pe, cs_t *cs, int nf, advflux_t **pobj) { 
# 109
(pe) ? static_cast< void>(0) : __assert_fail("pe", "advection.c", 109, __PRETTY_FUNCTION__); 
# 110
(cs) ? static_cast< void>(0) : __assert_fail("cs", "advection.c", 110, __PRETTY_FUNCTION__); 
# 112
return advflux_create(pe, cs, __null, nf, pobj); 
# 113
} 
# 121
int advflux_le_create(pe_t *pe, cs_t *cs, lees_edw_t *le, int nf, advflux_t **
# 122
pobj) { 
# 124
(pe) ? static_cast< void>(0) : __assert_fail("pe", "advection.c", 124, __PRETTY_FUNCTION__); 
# 125
(cs) ? static_cast< void>(0) : __assert_fail("cs", "advection.c", 125, __PRETTY_FUNCTION__); 
# 126
(le) ? static_cast< void>(0) : __assert_fail("le", "advection.c", 126, __PRETTY_FUNCTION__); 
# 127
return advflux_create(pe, cs, le, nf, pobj); 
# 128
} 
# 136
int advflux_create(pe_t *pe, cs_t *cs, lees_edw_t *le, int nf, advflux_t **
# 137
pobj) { 
# 139
int ndevice; 
...
double *tmp; 
# 142
advflux_t *obj = (__null); 
# 144
(pe) ? static_cast< void>(0) : __assert_fail("pe", "advection.c", 144, __PRETTY_FUNCTION__); 
# 145
(cs) ? static_cast< void>(0) : __assert_fail("cs", "advection.c", 145, __PRETTY_FUNCTION__); 
# 146
(pobj) ? static_cast< void>(0) : __assert_fail("pobj", "advection.c", 146, __PRETTY_FUNCTION__); 
# 148
obj = ((advflux_t *)calloc(1, sizeof(advflux_t))); 
# 149
(obj) ? static_cast< void>(0) : __assert_fail("obj", "advection.c", 149, __PRETTY_FUNCTION__); 
# 150
if (obj == (__null)) { pe_fatal(pe, "calloc(advflux) failed\n"); }  
# 152
...
# 166
if ((obj->fe) == (__null)) { pe_fatal(pe, "calloc(advflux->fe) failed\n"); }  
# 167
if ((obj->fw) == (__null)) { pe_fatal(pe, "calloc(advflux->fw) failed\n"); }  
# 168
if ((obj->fy) == (__null)) { pe_fatal(pe, "calloc(advflux->fy) failed\n"); }  
# 169
if ((obj->fz) == (__null)) { pe_fatal(pe, "calloc(advflux->fz) failed\n"); }  
# 174
...
# 188
tdpMemcpy(&((obj->target)->fe), &tmp, sizeof(double *), hipMemcpyHostToDevice); 
# 190
tdpMalloc((void **)(&tmp), nsz); 
# 191
tdpMemcpy(&((obj->target)->fw), &tmp, sizeof(double *), hipMemcpyHostToDevice); 
# 193
tdpMalloc((void **)(&tmp), nsz); 
# 194
tdpMemcpy(&((obj->target)->fy), &tmp, sizeof(double *), hipMemcpyHostToDevice); 
# 196
tdpMalloc((void **)(&tmp), nsz); 
# 197
tdpMemcpy(&((obj->target)->fz), &tmp, sizeof(double *), hipMemcpyHostToDevice); 
# 199
tdpMemcpy(&((obj->target)->nf), &(obj->nf), sizeof(int), hipMemcpyHostToDevice); 
# 200
tdpMemcpy(&((obj->target)->nsite), &(obj->nsite), sizeof(int), hipMemcpyHostToDevice); 
# 203
if (cs) { cs_target(cs, &cstarget); }  
# 204
if (le) { lees_edw_target(le, &letarget); }  
# 205
tdpMemcpy(&((obj->target)->cs), &cstarget, sizeof(cs_t *), hipMemcpyHostToDevice); 
# 207
tdpMemcpy(&((obj->target)->le), &letarget, sizeof(lees_edw_t *), hipMemcpyHostToDevice); 
# 209
}  
# 211
(*pobj) = obj; 
...
double *tmp; 
# 227
(obj) ? static_cast< void>(0) : __assert_fail("obj", "advection.c", 227, __PRETTY_FUNCTION__); 
# 229
tdpGetDeviceCount(&ndevice); 
# 231
if (ndevice > 0) { 
# 232
tdpMemcpy(&tmp, &((obj->target)->fe), sizeof(double *), hipMemcpyDeviceToHost); 
# 233
tdpFree(tmp); 
# 234
tdpMemcpy(&tmp, &((obj->target)->fw), sizeof(double *), hipMemcpyDeviceToHost); 
# 235
tdpFree(tmp); 
# 236
tdpMemcpy(&tmp, &((obj->target)->fy), sizeof(double *), hipMemcpyDeviceToHost); 
# 237
tdpFree(tmp); 
# 238
tdpMemcpy(&tmp, &((obj->target)->fz), sizeof(double *), hipMemcpyDeviceToHost); 
# 239
tdpFree(tmp); 
# 240
tdpFree(obj->target); 
...
# 258
int advection_memcpy(advflux_t *obj) { 
# 260
int ndevice; 
# 262
tdpGetDeviceCount(&ndevice); 
...
if (ndevice == 0) { 
# 266
((obj->target) == obj) ? static_cast< void>(0) : __assert_fail("obj->target == obj", "advection.c", 266, __PRETTY_FUNCTION__); 
# 267
} else 
# 268
{ 
# 269
(0) ? static_cast< void>(0) : __assert_fail("0", "advection.c", 269, __PRETTY_FUNCTION__); 
# 270
}  
# 272
return 0; 
...
int nf; 
# 285
(obj) ? static_cast< void>(0) : __assert_fail("obj", "advection.c", 285, __PRETTY_FUNCTION__); 
# 286
(hydro) ? static_cast< void>(0) : __assert_fail("hydro", "advection.c", 286, __PRETTY_FUNCTION__); 
# 287
(field) ? static_cast< void>(0) : __assert_fail("field", "advection.c", 287, __PRETTY_FUNCTION__); 
# 289
field_nf(field, &nf); 
# 293
...
# 326 "advection.c"
int advection_le_1st(advflux_t *flux, hydro_t *hydro, field_t *
# 327
field) { 
# 328
int nlocal[3]; 
...
# 333
(flux) ? static_cast< void>(0) : __assert_fail("flux", "advection.c", 333, __PRETTY_FUNCTION__); 
# 334
(hydro) ? static_cast< void>(0) : __assert_fail("hydro", "advection.c", 334, __PRETTY_FUNCTION__); 
# 335
(field) ? static_cast< void>(0) : __assert_fail("field", "advection.c", 335, __PRETTY_FUNCTION__); 
# 337
...
# 348
do { (__cudaPushCallConfiguration(nblk, ntpb, 0, 0)) ? (void)0 : advection_le_1st_kernel(ctxt->target, flux->target, hydro->target, field->target); } while (0); 
# 349
; 
# 351
...
# 374 "advection.c"
void advection_le_1st_kernel(kernel_ctxt_t *ktx, advflux_t *
# 375
flux, hydro_t *
# 376
hydro, field_t *
...
int kindex; 
# 380
__attribute__((unused)) int kiter; 
# 382
(ktx) ? static_cast< void>(0) : __assert_fail("ktx", "advection.c", 382, __PRETTY_FUNCTION__); 
# 383
(flux) ? static_cast< void>(0) : __assert_fail("flux", "advection.c", 383, __PRETTY_FUNCTION__); 
# 384
(hydro) ? static_cast< void>(0) : __assert_fail("hydro", "advection.c", 384, __PRETTY_FUNCTION__); 
# 385
(field) ? static_cast< void>(0) : __assert_fail("field", "advection.c", 385, __PRETTY_FUNCTION__); 
# 387
...
for (ia = 0; ia < 3; ia++) { 
# 409
(u0[ia]) = ((hydro->u)[reverse_addr_rank1_assert(409, "advection.c", hydro->nsite, 3, index0, ia)]); 
# 410
}  
# 412
index1 = kernel_coords_index(ktx, icm1, jc, kc); 
# 414
(u1[X]) = ((hydro->u)[reverse_addr_rank1_assert(414, "advection.c", hydro->nsite, 3, index1, X)]); 
# 415
u = ((0.5) * ((u0[X]) + (u1[X]))); 
# 417
index = index0; 
...
# 421
((flux->fw)[reverse_addr_rank1_assert(421, "advection.c", flux->nsite, flux->nf, index0, n)]) = (u * ((field->data)[reverse_addr_rank1_assert(422, "advection.c", field->nsites, field->nf, index, n)])); 
# 423
}  
# 428
index1 = kernel_coords_index(ktx, icp1, jc, kc); 
# 430
(u1[X]) = ((hydro->u)[reverse_addr_rank1_assert(430, "advection.c", hydro->nsite, 3, index1, X)]); 
# 431
u = ((0.5) * ((u0[X]) + (u1[X]))); 
# 433
index = index0; 
...
for (n = 0; n < (field->nf); n++) { 
# 437
((flux->fe)[reverse_addr_rank1_assert(437, "advection.c", flux->nsite, flux->nf, index0, n)]) = (u * ((field->data)[reverse_addr_rank1_assert(438, "advection.c", field->nsites, field->nf, index, n)])); 
# 439
}  
# 443
index1 = kernel_coords_index(ktx, ic, jc + 1, kc); 
# 445
(u1[Y]) = ((hydro->u)[reverse_addr_rank1_assert(445, "advection.c", hydro->nsite, 3, index1, Y)]); 
# 446
u = ((0.5) * ((u0[Y]) + (u1[Y]))); 
# 448
index = index0; 
...
for (n = 0; n < (field->nf); n++) { 
# 452
((flux->fy)[reverse_addr_rank1_assert(452, "advection.c", flux->nsite, flux->nf, index0, n)]) = (u * ((field->data)[reverse_addr_rank1_assert(453, "advection.c", field->nsites, field->nf, index, n)])); 
# 454
}  
# 458
index1 = kernel_coords_index(ktx, ic, jc, kc + 1); 
# 460
(u1[Z]) = ((hydro->u)[reverse_addr_rank1_assert(460, "advection.c", hydro->nsite, 3, index1, Z)]); 
# 461
u = ((0.5) * ((u0[Z]) + (u1[Z]))); 
# 463
index = index0; 
...
for (n = 0; n < (field->nf); n++) { 
# 467
((flux->fz)[reverse_addr_rank1_assert(467, "advection.c", flux->nsite, flux->nf, index0, n)]) = (u * ((field->data)[reverse_addr_rank1_assert(468, "advection.c", field->nsites, field->nf, index, n)])); 
# 469
}  
# 472
}  
...
#endif
# 485 "advection.c"
int advection_le_2nd(advflux_t *flux, hydro_t *hydro, field_t *
# 486
field) { 
# 487
int nlocal[3]; 
...
kernel_ctxt_t *ctxt = (__null); 
# 492
(flux) ? static_cast< void>(0) : __assert_fail("flux", "advection.c", 492, __PRETTY_FUNCTION__); 
# 493
(hydro) ? static_cast< void>(0) : __assert_fail("hydro", "advection.c", 493, __PRETTY_FUNCTION__); 
# 494
(field) ? static_cast< void>(0) : __assert_fail("field", "advection.c", 494, __PRETTY_FUNCTION__); 
# 496
cs_nlocal(flux->cs, nlocal); 
# 500
(limits.imin) = 1; (limits.imax) = (nlocal[X]); 
...
kernel_ctxt_launch_param(ctxt, &nblk, &ntpb); 
# 507
do { (__cudaPushCallConfiguration(nblk, ntpb, 0, 0)) ? (void)0 : advection_2nd_kernel_v(ctxt->target, flux->target, hydro->target, field->target); } while (0); 
# 508
; 
# 510
tdpDeviceSynchronize(); 
...
# 529 "advection.c"
void advection_2nd_kernel(kernel_ctxt_t *ktx, advflux_t *flux, hydro_t *
# 530
hydro, field_t *field) ;
#if 0
# 530
...
__attribute__((unused)) int kiter; 
# 534
(ktx) ? static_cast< void>(0) : __assert_fail("ktx", "advection.c", 534, __PRETTY_FUNCTION__); 
# 535
(flux) ? static_cast< void>(0) : __assert_fail("flux", "advection.c", 535, __PRETTY_FUNCTION__); 
# 536
(hydro) ? static_cast< void>(0) : __assert_fail("hydro", "advection.c", 536, __PRETTY_FUNCTION__); 
# 537
(field) ? static_cast< void>(0) : __assert_fail("field", "advection.c", 537, __PRETTY_FUNCTION__); 
# 539
kiter = kernel_iterations(ktx); 
# 541
kindex = ((1) * (((__device_builtin_variable_blockIdx.x) * (__device_builtin_variable_blockDim.x)) + (__device_builtin_variable_threadIdx.x))); if (kindex < kiter) { 
...
for (ia = 0; ia < 3; ia++) { 
# 559
(u0[ia]) = ((hydro->u)[reverse_addr_rank1_assert(559, "advection.c", hydro->nsite, 3, index0, ia)]); 
# 560
}  
# 564
index1 = kernel_coords_index(ktx, icm1, jc, kc); 
# 565
(u1[X]) = ((hydro->u)[reverse_addr_rank1_assert(565, "advection.c", hydro->nsite, 3, index1, X)]); 
# 566
u = ((0.5) * ((u0[X]) + (u1[X]))); 
# 568
for (n = 0; n < (field->nf); n++) { 
# 569
((flux->fw)[reverse_addr_rank1_assert(569, "advection.c", flux->nsite, flux->nf, index0, n)]) = (((0.5) * u) * (((field->data)[reverse_addr_rank1_assert(570, "advection.c", field->nsites, field->nf, index1, n)]) + ((field->data)[reverse_addr_rank1_assert(571, "advection.c", field->nsites, field->nf, index0, n)]))); 
# 572
}  
# 576
index1 = kernel_coords_index(ktx, icp1, jc, kc); 
# 577
(u1[X]) = ((hydro->u)[reverse_addr_rank1_assert(577, "advection.c", hydro->nsite, 3, index1, X)]); 
# 578
u = ((0.5) * ((u0[X]) + (u1[X]))); 
# 580
for (n = 0; n < (flux->nf); n++) { 
# 581
((flux->fe)[reverse_addr_rank1_assert(581, "advection.c", flux->nsite, flux->nf, index0, n)]) = (((0.5) * u) * (((field->data)[reverse_addr_rank1_assert(582, "advection.c", field->nsites, field->nf, index0, n)]) + ((field->data)[reverse_addr_rank1_assert(583, "advection.c", field->nsites, field->nf, index1, n)]))); 
# 584
}  
# 588
index1 = kernel_coords_index(ktx, ic, jc + 1, kc); 
# 589
(u1[Y]) = ((hydro->u)[reverse_addr_rank1_assert(589, "advection.c", hydro->nsite, 3, index1, Y)]); 
# 590
u = ((0.5) * ((u0[Y]) + (u1[Y]))); 
# 592
for (n = 0; n < (flux->nf); n++) { 
# 593
((flux->fy)[reverse_addr_rank1_assert(593, "advection.c", flux->nsite, flux->nf, index0, n)]) = (((0.5) * u) * (((field->data)[reverse_addr_rank1_assert(594, "advection.c", field->nsites, field->nf, index0, n)]) + ((field->data)[reverse_addr_rank1_assert(595, "advection.c", field->nsites, field->nf, index1, n)]))); 
# 596
}  
# 600
index1 = kernel_coords_index(ktx, ic, jc, kc + 1); 
# 601
(u1[Z]) = ((hydro->u)[reverse_addr_rank1_assert(601, "advection.c", hydro->nsite, 3, index1, Z)]); 
# 602
u = ((0.5) * ((u0[Z]) + (u1[Z]))); 
# 604
for (n = 0; n < (flux->nf); n++) { 
# 605
((flux->fz)[reverse_addr_rank1_assert(605, "advection.c", flux->nsite, flux->nf, index0, n)]) = (((0.5) * u) * (((field->data)[reverse_addr_rank1_assert(606, "advection.c", field->nsites, field->nf, index0, n)]) + ((field->data)[reverse_addr_rank1_assert(607, "advection.c", field->nsites, field->nf, index1, n)]))); 
# 608
}  
# 610
}  
...
#endif
# 623 "advection.c"
void advection_2nd_kernel_v(kernel_ctxt_t *ktx, advflux_t *flux, hydro_t *
# 624
hydro, field_t *field) ;
#if 0
# 624
...
__attribute__((unused)) int kiter; 
# 628
(ktx) ? static_cast< void>(0) : __assert_fail("ktx", "advection.c", 628, __PRETTY_FUNCTION__); 
# 629
(flux) ? static_cast< void>(0) : __assert_fail("flux", "advection.c", 629, __PRETTY_FUNCTION__); 
# 630
(hydro) ? static_cast< void>(0) : __assert_fail("hydro", "advection.c", 630, __PRETTY_FUNCTION__); 
# 631
(field) ? static_cast< void>(0) : __assert_fail("field", "advection.c", 631, __PRETTY_FUNCTION__); 
# 633
...
for (iv = 0; iv < 1; iv++) { 
# 658
((u0[ia])[iv]) = ((hydro->u)[reverse_addr_rank1_assert(658, "advection.c", hydro->nsite, 3, index0[iv], ia)]); 
# 659
}  
# 660
}  
...
for (iv = 0; iv < 1; iv++) { 
# 668
((u1[ia])[iv]) = ((hydro->u)[reverse_addr_rank1_assert(668, "advection.c", hydro->nsite, 3, index1[iv], ia)]); 
# 669
}  
# 670
}  
...
for (iv = 0; iv < 1; iv++) { 
# 674
((flux->fw)[reverse_addr_rank1_assert(674, "advection.c", flux->nsite, flux->nf, index0[iv], n)]) = (((((0.5) * (((u0[X])[iv]) + ((u1[X])[iv]))) * (maskv[iv])) * (0.5)) * (((field->data)[reverse_addr_rank1_assert(676, "advection.c", field->nsites, field->nf, index1[iv], n)]) + ((field->data)[reverse_addr_rank1_assert(677, "advection.c", field->nsites, field->nf, index0[iv], n)]))); 
# 678
}  
# 679
}  
...
for (iv = 0; iv < 1; iv++) { 
# 687
((u1[ia])[iv]) = ((hydro->u)[reverse_addr_rank1_assert(687, "advection.c", hydro->nsite, 3, index1[iv], ia)]); 
# 688
}  
# 689
}  
...
for (iv = 0; iv < 1; iv++) { 
# 693
((flux->fe)[reverse_addr_rank1_assert(693, "advection.c", flux->nsite, flux->nf, index0[iv], n)]) = (((((0.5) * (((u0[X])[iv]) + ((u1[X])[iv]))) * (maskv[iv])) * (0.5)) * (((field->data)[reverse_addr_rank1_assert(695, "advection.c", field->nsites, field->nf, index0[iv], n)]) + ((field->data)[reverse_addr_rank1_assert(696, "advection.c", field->nsites, field->nf, index1[iv], n)]))); 
# 697
}  
# 698
}  
# 702
for (iv = 0; iv < 1; iv++) { (p1[iv]) = ((jc[iv]) + (maskv[iv])); }  
# 703
...
for (iv = 0; iv < 1; iv++) { 
# 707
((u1[ia])[iv]) = ((hydro->u)[reverse_addr_rank1_assert(707, "advection.c", hydro->nsite, 3, index1[iv], ia)]); 
# 708
}  
# 709
}  
...
for (iv = 0; iv < 1; iv++) { 
# 713
((flux->fy)[reverse_addr_rank1_assert(713, "advection.c", flux->nsite, flux->nf, index0[iv], n)]) = (((((0.5) * (((u0[Y])[iv]) + ((u1[Y])[iv]))) * (maskv[iv])) * (0.5)) * (((field->data)[reverse_addr_rank1_assert(715, "advection.c", field->nsites, field->nf, index0[iv], n)]) + ((field->data)[reverse_addr_rank1_assert(716, "advection.c", field->nsites, field->nf, index1[iv], n)]))); 
# 717
}  
# 718
}  
# 722
for (iv = 0; iv < 1; iv++) { (p1[iv]) = ((kc[iv]) + (maskv[iv])); }  
# 723
...
for (iv = 0; iv < 1; iv++) { 
# 727
((u1[ia])[iv]) = ((hydro->u)[reverse_addr_rank1_assert(727, "advection.c", hydro->nsite, 3, index1[iv], ia)]); 
# 728
}  
# 729
}  
...
for (iv = 0; iv < 1; iv++) { 
# 733
((flux->fz)[reverse_addr_rank1_assert(733, "advection.c", flux->nsite, flux->nf, index0[iv], n)]) = (((((0.5) * (((u0[Z])[iv]) + ((u1[Z])[iv]))) * (maskv[iv])) * (0.5)) * (((field->data)[reverse_addr_rank1_assert(735, "advection.c", field->nsites, field->nf, index0[iv], n)]) + ((field->data)[reverse_addr_rank1_assert(736, "advection.c", field->nsites, field->nf, index1[iv], n)]))); 
# 737
}  
# 738
}  
...
#endif
# 753 "advection.c"
int advection_le_3rd(advflux_t *flux, hydro_t *hydro, field_t *
# 754
field) { 
# 755
int nlocal[3]; 
...
lees_edw_t *letarget = (__null); 
# 761
(flux) ? static_cast< void>(0) : __assert_fail("flux", "advection.c", 761, __PRETTY_FUNCTION__); 
# 762
(hydro) ? static_cast< void>(0) : __assert_fail("hydro", "advection.c", 762, __PRETTY_FUNCTION__); 
# 763
(field->data) ? static_cast< void>(0) : __assert_fail("field->data", "advection.c", 763, __PRETTY_FUNCTION__); 
# 765
cs_nlocal(flux->cs, nlocal); 
# 767
(limits.imin) = 1; (limits.imax) = (nlocal[X]); 
...
# 776
do { (__cudaPushCallConfiguration(nblk, ntpb, 0, 0)) ? (void)0 : advection_le_3rd_kernel_v(ctxt->target, letarget, flux->target, hydro->target, field->target); } while (0); 
# 778
; 
# 779
} else 
...
{ 
# 781
do { (__cudaPushCallConfiguration(nblk, ntpb, 0, 0)) ? (void)0 : advection_3rd_kernel_v(ctxt->target, flux->target, hydro->target, field->target); } while (0); 
# 782
; 
# 783
}  
...
# 805 "advection.c"
void advection_le_3rd_kernel_v(kernel_ctxt_t *ktx, lees_edw_t *
# 806
le, advflux_t *
# 807
flux, hydro_t *
...
__attribute__((unused)) int kiter; 
# 813
(ktx) ? static_cast< void>(0) : __assert_fail("ktx", "advection.c", 813, __PRETTY_FUNCTION__); 
# 814
(le) ? static_cast< void>(0) : __assert_fail("le", "advection.c", 814, __PRETTY_FUNCTION__); 
# 815
(flux) ? static_cast< void>(0) : __assert_fail("flux", "advection.c", 815, __PRETTY_FUNCTION__); 
# 816
(hydro) ? static_cast< void>(0) : __assert_fail("hydro", "advection.c", 816, __PRETTY_FUNCTION__); 
# 817
(fld) ? static_cast< void>(0) : __assert_fail("fld", "advection.c", 817, __PRETTY_FUNCTION__); 
# 819
kiter = kernel_vector_iterations(ktx); 
# 821
kindex = ((1) * (((__device_builtin_variable_blockIdx.x) * (__device_builtin_variable_blockDim.x)) + (__device_builtin_variable_threadIdx.x))); if (kindex < kiter) { 
...
# 827
int m2[1], m1[1], p1[1], p2[1]; 
# 828
double u0[3][1], u1[3][1], u[1]; 
# 830
double fd1[1]; 
# 831
double fd2[1]; 
...
double fd3[1]; 
# 834
const double a1 = (-(0.213933000000000012)); 
# 835
const double a2 = (0.9278650000000000508); 
# 836
const double a3 = (0.2860670000000000157); 
# 838
kernel_coords_v(ktx, kindex, ic, jc, kc); 
# 839
kernel_coords_index_v(ktx, ic, jc, kc, index0); 
...
for (iv = 0; iv < 1; iv++) { 
# 844
((u0[ia])[iv]) = ((hydro->u)[reverse_addr_rank1_assert(844, "advection.c", hydro->nsite, 3, index0[iv], ia)]); 
# 845
}  
# 846
}  
# 850
for (iv = 0; iv < 1; iv++) { (m2[iv]) = lees_edw_ic_to_buff(le, ic[iv], (-2) * (maskv[iv])); }  
# 851
for (iv = 0; iv < 1; iv++) { (m1[iv]) = lees_edw_ic_to_buff(le, ic[iv], (-1) * (maskv[iv])); }  
# 852
for (iv = 0; iv < 1; iv++) { (p1[iv]) = lees_edw_ic_to_buff(le, ic[iv], (+1) * (maskv[iv])); }  
# 853
for (iv = 0; iv < 1; iv++) { (p2[iv]) = lees_edw_ic_to_buff(le, ic[iv], (+2) * (maskv[iv])); }  
# 855
...
for (iv = 0; iv < 1; iv++) { 
# 861
((u1[ia])[iv]) = ((hydro->u)[reverse_addr_rank1_assert(861, "advection.c", hydro->nsite, 3, index1[iv], ia)]); 
# 862
}  
# 863
}  
# 865
for (iv = 0; iv < 1; iv++) { (u[iv]) = (((0.5) * (maskv[iv])) * (((u0[X])[iv]) + ((u1[X])[iv]))); }  
# 867
for (n = 0; n < (fld->nf); n++) { 
# 868
for (iv = 0; iv < 1; iv++) { 
...
if ((u[iv]) > (0.0)) { 
# 870
(fd1[iv]) = ((fld->data)[reverse_addr_rank1_assert(870, "advection.c", fld->nsites, fld->nf, index2[iv], n)]); 
# 871
(fd2[iv]) = ((fld->data)[reverse_addr_rank1_assert(871, "advection.c", fld->nsites, fld->nf, index1[iv], n)]); 
# 872
(fd3[iv]) = ((fld->data)[reverse_addr_rank1_assert(872, "advection.c", fld->nsites, fld->nf, index0[iv], n)]); 
# 873
} else 
# 874
{ 
# 875
(fd1[iv]) = ((fld->data)[reverse_addr_rank1_assert(875, "advection.c", fld->nsites, fld->nf, index3[iv], n)]); 
# 876
(fd2[iv]) = ((fld->data)[reverse_addr_rank1_assert(876, "advection.c", fld->nsites, fld->nf, index0[iv], n)]); 
# 877
(fd3[iv]) = ((fld->data)[reverse_addr_rank1_assert(877, "advection.c", fld->nsites, fld->nf, index1[iv], n)]); 
# 878
}  
# 879
}  
...
for (iv = 0; iv < 1; iv++) { 
# 882
((flux->fw)[reverse_addr_rank1_assert(882, "advection.c", flux->nsite, flux->nf, index0[iv], n)]) = ((u[iv]) * (((a1 * (fd1[iv])) + (a2 * (fd2[iv]))) + (a3 * (fd3[iv])))); 
# 884
}  
# 885
}  
...
for (iv = 0; iv < 1; iv++) { 
# 893
((u1[ia])[iv]) = ((hydro->u)[reverse_addr_rank1_assert(893, "advection.c", hydro->nsite, 3, index3[iv], ia)]); 
# 894
}  
# 895
}  
...
if ((u[iv]) < (0.0)) { 
# 902
(fd1[iv]) = ((fld->data)[reverse_addr_rank1_assert(902, "advection.c", fld->nsites, fld->nf, index2[iv], n)]); 
# 903
(fd2[iv]) = ((fld->data)[reverse_addr_rank1_assert(903, "advection.c", fld->nsites, fld->nf, index3[iv], n)]); 
# 904
(fd3[iv]) = ((fld->data)[reverse_addr_rank1_assert(904, "advection.c", fld->nsites, fld->nf, index0[iv], n)]); 
# 905
} else 
# 906
{ 
# 907
(fd1[iv]) = ((fld->data)[reverse_addr_rank1_assert(907, "advection.c", fld->nsites, fld->nf, index1[iv], n)]); 
# 908
(fd2[iv]) = ((fld->data)[reverse_addr_rank1_assert(908, "advection.c", fld->nsites, fld->nf, index0[iv], n)]); 
# 909
(fd3[iv]) = ((fld->data)[reverse_addr_rank1_assert(909, "advection.c", fld->nsites, fld->nf, index3[iv], n)]); 
# 910
}  
# 911
}  
...
for (iv = 0; iv < 1; iv++) { 
# 914
((flux->fe)[reverse_addr_rank1_assert(914, "advection.c", flux->nsite, flux->nf, index0[iv], n)]) = ((u[iv]) * (((a1 * (fd1[iv])) + (a2 * (fd2[iv]))) + (a3 * (fd3[iv])))); 
# 916
}  
# 917
}  
# 922
for (iv = 0; iv < 1; iv++) { (m1[iv]) = ((jc[iv]) - (1 * (maskv[iv]))); }  
# 923
for (iv = 0; iv < 1; iv++) { (p1[iv]) = ((jc[iv]) + (1 * (maskv[iv]))); }  
# 924
for (iv = 0; iv < 1; iv++) { (p2[iv]) = ((jc[iv]) + (2 * (maskv[iv]))); }  
# 926
...
for (iv = 0; iv < 1; iv++) { 
# 932
((u1[ia])[iv]) = ((hydro->u)[reverse_addr_rank1_assert(932, "advection.c", fld->nsites, 3, index1[iv], ia)]); 
# 933
}  
# 934
}  
# 936
for (iv = 0; iv < 1; iv++) { (u[iv]) = (((0.5) * (maskv[iv])) * (((u0[Y])[iv]) + ((u1[Y])[iv]))); }  
# 938
for (n = 0; n < (fld->nf); n++) { 
# 939
for (iv = 0; iv < 1; iv++) { 
...
if ((u[iv]) < (0.0)) { 
# 941
(fd1[iv]) = ((fld->data)[reverse_addr_rank1_assert(941, "advection.c", fld->nsites, fld->nf, index2[iv], n)]); 
# 942
(fd2[iv]) = ((fld->data)[reverse_addr_rank1_assert(942, "advection.c", fld->nsites, fld->nf, index1[iv], n)]); 
# 943
(fd3[iv]) = ((fld->data)[reverse_addr_rank1_assert(943, "advection.c", fld->nsites, fld->nf, index0[iv], n)]); 
# 944
} else 
# 945
{ 
# 946
(fd1[iv]) = ((fld->data)[reverse_addr_rank1_assert(946, "advection.c", fld->nsites, fld->nf, index3[iv], n)]); 
# 947
(fd2[iv]) = ((fld->data)[reverse_addr_rank1_assert(947, "advection.c", fld->nsites, fld->nf, index0[iv], n)]); 
# 948
(fd3[iv]) = ((fld->data)[reverse_addr_rank1_assert(948, "advection.c", fld->nsites, fld->nf, index1[iv], n)]); 
# 949
}  
# 950
}  
...
for (iv = 0; iv < 1; iv++) { 
# 953
((flux->fy)[reverse_addr_rank1_assert(953, "advection.c", flux->nsite, flux->nf, index0[iv], n)]) = ((u[iv]) * (((a1 * (fd1[iv])) + (a2 * (fd2[iv]))) + (a3 * (fd3[iv])))); 
# 955
}  
# 956
}  
# 960
for (iv = 0; iv < 1; iv++) { (m1[iv]) = ((kc[iv]) - (1 * (maskv[iv]))); }  
# 961
for (iv = 0; iv < 1; iv++) { (p1[iv]) = ((kc[iv]) + (1 * (maskv[iv]))); }  
# 962
for (iv = 0; iv < 1; iv++) { (p2[iv]) = ((kc[iv]) + (2 * (maskv[iv]))); }  
# 964
...
for (iv = 0; iv < 1; iv++) { 
# 970
((u1[ia])[iv]) = ((hydro->u)[reverse_addr_rank1_assert(970, "advection.c", hydro->nsite, 3, index1[iv], ia)]); 
# 971
}  
# 972
}  
# 974
for (iv = 0; iv < 1; iv++) { (u[iv]) = (((0.5) * (maskv[iv])) * (((u0[Z])[iv]) + ((u1[Z])[iv]))); }  
# 976
for (n = 0; n < (fld->nf); n++) { 
# 977
for (iv = 0; iv < 1; iv++) { 
...
if ((u[iv]) < (0.0)) { 
# 979
(fd1[iv]) = ((fld->data)[reverse_addr_rank1_assert(979, "advection.c", fld->nsites, fld->nf, index2[iv], n)]); 
# 980
(fd2[iv]) = ((fld->data)[reverse_addr_rank1_assert(980, "advection.c", fld->nsites, fld->nf, index1[iv], n)]); 
# 981
(fd3[iv]) = ((fld->data)[reverse_addr_rank1_assert(981, "advection.c", fld->nsites, fld->nf, index0[iv], n)]); 
# 982
} else 
# 983
{ 
# 984
(fd1[iv]) = ((fld->data)[reverse_addr_rank1_assert(984, "advection.c", fld->nsites, fld->nf, index3[iv], n)]); 
# 985
(fd2[iv]) = ((fld->data)[reverse_addr_rank1_assert(985, "advection.c", fld->nsites, fld->nf, index0[iv], n)]); 
# 986
(fd3[iv]) = ((fld->data)[reverse_addr_rank1_assert(986, "advection.c", fld->nsites, fld->nf, index1[iv], n)]); 
# 987
}  
# 988
}  
...
for (iv = 0; iv < 1; iv++) { 
# 991
((flux->fz)[reverse_addr_rank1_assert(991, "advection.c", flux->nsite, flux->nf, index0[iv], n)]) = ((u[iv]) * (((a1 * (fd1[iv])) + (a2 * (fd2[iv]))) + (a3 * (fd3[iv])))); 
# 993
}  
# 994
}  
...
#endif
# 1009 "advection.c"
void advection_3rd_kernel_v(kernel_ctxt_t *ktx, advflux_t *
# 1010
flux, hydro_t *
# 1011
hydro, field_t *
...
__attribute__((unused)) int kiter; 
# 1017
(ktx) ? static_cast< void>(0) : __assert_fail("ktx", "advection.c", 1017, __PRETTY_FUNCTION__); 
# 1018
(flux) ? static_cast< void>(0) : __assert_fail("flux", "advection.c", 1018, __PRETTY_FUNCTION__); 
# 1019
(hydro) ? static_cast< void>(0) : __assert_fail("hydro", "advection.c", 1019, __PRETTY_FUNCTION__); 
# 1020
(field) ? static_cast< void>(0) : __assert_fail("field", "advection.c", 1020, __PRETTY_FUNCTION__); 
# 1022
kiter = kernel_vector_iterations(ktx); 
# 1024
kindex = ((1) * (((__device_builtin_variable_blockIdx.x) * (__device_builtin_variable_blockDim.x)) + (__device_builtin_variable_threadIdx.x))); if (kindex < kiter) { 
...
for (iv = 0; iv < 1; iv++) { 
# 1050
((u0[ia])[iv]) = ((hydro->u)[reverse_addr_rank1_assert(1050, "advection.c", hydro->nsite, 3, index0[iv], ia)]); 
# 1051
}  
# 1052
}  
# 1056
for (iv = 0; iv < 1; iv++) { (m2[iv]) = ((ic[iv]) - (2 * (maskv[iv]))); }  
# 1057
for (iv = 0; iv < 1; iv++) { (m1[iv]) = ((ic[iv]) - (1 * (maskv[iv]))); }  
# 1058
for (iv = 0; iv < 1; iv++) { (p1[iv]) = ((ic[iv]) + (1 * (maskv[iv]))); }  
# 1059
for (iv = 0; iv < 1; iv++) { (p2[iv]) = ((ic[iv]) + (2 * (maskv[iv]))); }  
# 1061
...
for (iv = 0; iv < 1; iv++) { 
# 1067
((u1[ia])[iv]) = ((hydro->u)[reverse_addr_rank1_assert(1067, "advection.c", hydro->nsite, 3, index1[iv], ia)]); 
# 1068
}  
# 1069
}  
...
if ((u[iv]) > (0.0)) { 
# 1076
(fd1[iv]) = ((field->data)[reverse_addr_rank1_assert(1076, "advection.c", field->nsites, nf, index2[iv], n)]); 
# 1077
(fd2[iv]) = ((field->data)[reverse_addr_rank1_assert(1077, "advection.c", field->nsites, nf, index1[iv], n)]); 
# 1078
(fd3[iv]) = ((field->data)[reverse_addr_rank1_assert(1078, "advection.c", field->nsites, nf, index0[iv], n)]); 
# 1079
} else 
# 1080
{ 
# 1081
(fd1[iv]) = ((field->data)[reverse_addr_rank1_assert(1081, "advection.c", field->nsites, nf, index3[iv], n)]); 
# 1082
(fd2[iv]) = ((field->data)[reverse_addr_rank1_assert(1082, "advection.c", field->nsites, nf, index0[iv], n)]); 
# 1083
(fd3[iv]) = ((field->data)[reverse_addr_rank1_assert(1083, "advection.c", field->nsites, nf, index1[iv], n)]); 
# 1084
}  
# 1085
}  
...
for (iv = 0; iv < 1; iv++) { 
# 1088
((flux->fw)[reverse_addr_rank1_assert(1088, "advection.c", flux->nsite, flux->nf, index0[iv], n)]) = ((u[iv]) * (((a1 * (fd1[iv])) + (a2 * (fd2[iv]))) + (a3 * (fd3[iv])))); 
# 1090
}  
# 1091
}  
...
for (iv = 0; iv < 1; iv++) { 
# 1099
((u1[ia])[iv]) = ((hydro->u)[reverse_addr_rank1_assert(1099, "advection.c", hydro->nsite, 3, index3[iv], ia)]); 
# 1100
}  
# 1101
}  
...
if ((u[iv]) < (0.0)) { 
# 1108
(fd1[iv]) = ((field->data)[reverse_addr_rank1_assert(1108, "advection.c", field->nsites, nf, index2[iv], n)]); 
# 1109
(fd2[iv]) = ((field->data)[reverse_addr_rank1_assert(1109, "advection.c", field->nsites, nf, index3[iv], n)]); 
# 1110
(fd3[iv]) = ((field->data)[reverse_addr_rank1_assert(1110, "advection.c", field->nsites, nf, index0[iv], n)]); 
# 1111
} else 
# 1112
{ 
# 1113
(fd1[iv]) = ((field->data)[reverse_addr_rank1_assert(1113, "advection.c", field->nsites, nf, index1[iv], n)]); 
# 1114
(fd2[iv]) = ((field->data)[reverse_addr_rank1_assert(1114, "advection.c", field->nsites, nf, index0[iv], n)]); 
# 1115
(fd3[iv]) = ((field->data)[reverse_addr_rank1_assert(1115, "advection.c", field->nsites, nf, index3[iv], n)]); 
# 1116
}  
# 1117
}  
...
for (iv = 0; iv < 1; iv++) { 
# 1120
((flux->fe)[reverse_addr_rank1_assert(1120, "advection.c", flux->nsite, flux->nf, index0[iv], n)]) = ((u[iv]) * (((a1 * (fd1[iv])) + (a2 * (fd2[iv]))) + (a3 * (fd3[iv])))); 
# 1122
}  
# 1123
}  
...
for (iv = 0; iv < 1; iv++) { 
# 1138
((u1[ia])[iv]) = ((hydro->u)[reverse_addr_rank1_assert(1138, "advection.c", field->nsites, 3, index1[iv], ia)]); 
# 1139
}  
# 1140
}  
...
if ((u[iv]) < (0.0)) { 
# 1147
(fd1[iv]) = ((field->data)[reverse_addr_rank1_assert(1147, "advection.c", field->nsites, nf, index2[iv], n)]); 
# 1148
(fd2[iv]) = ((field->data)[reverse_addr_rank1_assert(1148, "advection.c", field->nsites, nf, index1[iv], n)]); 
# 1149
(fd3[iv]) = ((field->data)[reverse_addr_rank1_assert(1149, "advection.c", field->nsites, nf, index0[iv], n)]); 
# 1150
} else 
# 1151
{ 
# 1152
(fd1[iv]) = ((field->data)[reverse_addr_rank1_assert(1152, "advection.c", field->nsites, nf, index3[iv], n)]); 
# 1153
(fd2[iv]) = ((field->data)[reverse_addr_rank1_assert(1153, "advection.c", field->nsites, nf, index0[iv], n)]); 
# 1154
(fd3[iv]) = ((field->data)[reverse_addr_rank1_assert(1154, "advection.c", field->nsites, nf, index1[iv], n)]); 
# 1155
}  
# 1156
}  
...
for (iv = 0; iv < 1; iv++) { 
# 1159
((flux->fy)[reverse_addr_rank1_assert(1159, "advection.c", field->nsites, nf, index0[iv], n)]) = ((u[iv]) * (((a1 * (fd1[iv])) + (a2 * (fd2[iv]))) + (a3 * (fd3[iv])))); 
# 1161
}  
# 1162
}  
...
for (iv = 0; iv < 1; iv++) { 
# 1176
((u1[ia])[iv]) = ((hydro->u)[reverse_addr_rank1_assert(1176, "advection.c", hydro->nsite, 3, index1[iv], ia)]); 
# 1177
}  
# 1178
}  
...
if ((u[iv]) < (0.0)) { 
# 1185
(fd1[iv]) = ((field->data)[reverse_addr_rank1_assert(1185, "advection.c", field->nsites, nf, index2[iv], n)]); 
# 1186
(fd2[iv]) = ((field->data)[reverse_addr_rank1_assert(1186, "advection.c", field->nsites, nf, index1[iv], n)]); 
# 1187
(fd3[iv]) = ((field->data)[reverse_addr_rank1_assert(1187, "advection.c", field->nsites, nf, index0[iv], n)]); 
# 1188
} else 
# 1189
{ 
# 1190
(fd1[iv]) = ((field->data)[reverse_addr_rank1_assert(1190, "advection.c", field->nsites, nf, index3[iv], n)]); 
# 1191
(fd2[iv]) = ((field->data)[reverse_addr_rank1_assert(1191, "advection.c", field->nsites, nf, index0[iv], n)]); 
# 1192
(fd3[iv]) = ((field->data)[reverse_addr_rank1_assert(1192, "advection.c", field->nsites, nf, index1[iv], n)]); 
# 1193
}  
# 1194
}  
...
for (iv = 0; iv < 1; iv++) { 
# 1197
((flux->fz)[reverse_addr_rank1_assert(1197, "advection.c", field->nsites, nf, index0[iv], n)]) = ((u[iv]) * (((a1 * (fd1[iv])) + (a2 * (fd2[iv]))) + (a3 * (fd3[iv])))); 
# 1199
}  
# 1200
}  
...
#endif
# 1217 "advection.c"
static int advection_le_4th(advflux_t *flux, hydro_t *hydro, int nf, double *
# 1218
f) { 
# 1219
int nlocal[3]; 
...
# 1230
(flux) ? static_cast< void>(0) : __assert_fail("flux", "advection.c", 1230, __PRETTY_FUNCTION__); 
# 1231
(hydro) ? static_cast< void>(0) : __assert_fail("hydro", "advection.c", 1231, __PRETTY_FUNCTION__); 
# 1232
(f) ? static_cast< void>(0) : __assert_fail("f", "advection.c", 1232, __PRETTY_FUNCTION__); 
# 1234
le = (flux->le); 
# 1236
...
for (n = 0; n < nf; n++) { 
# 1260
((flux->fw)[reverse_addr_rank1_assert(1260, "advection.c", flux->nsite, nf, index0, n)]) = (u * (((((-a1) * (f[reverse_addr_rank1_assert(1261, "advection.c", flux->nsite, nf, index2, n)])) + (a2 * (f[reverse_addr_rank1_assert(1262, "advection.c", flux->nsite, nf, index1, n)]))) + (a2 * (f[reverse_addr_rank1_assert(1263, "advection.c", flux->nsite, nf, index0, n)]))) - (a1 * (f[reverse_addr_rank1_assert(1264, "advection.c", flux->nsite, nf, index3, n)])))); 
# 1265
}  
# 1269
...
for (n = 0; n < nf; n++) { 
# 1277
((flux->fe)[reverse_addr_rank1_assert(1277, "advection.c", flux->nsite, nf, index0, n)]) = (u * (((((-a1) * (f[reverse_addr_rank1_assert(1278, "advection.c", flux->nsite, nf, index2, n)])) + (a2 * (f[reverse_addr_rank1_assert(1279, "advection.c", flux->nsite, nf, index0, n)]))) + (a2 * (f[reverse_addr_rank1_assert(1280, "advection.c", flux->nsite, nf, index1, n)]))) - (a1 * (f[reverse_addr_rank1_assert(1281, "advection.c", flux->nsite, nf, index3, n)])))); 
# 1282
}  
# 1286
...
for (n = 0; n < nf; n++) { 
# 1294
((flux->fy)[reverse_addr_rank1_assert(1294, "advection.c", flux->nsite, nf, index0, n)]) = (u * (((((-a1) * (f[reverse_addr_rank1_assert(1295, "advection.c", flux->nsite, nf, index2, n)])) + (a2 * (f[reverse_addr_rank1_assert(1296, "advection.c", flux->nsite, nf, index0, n)]))) + (a2 * (f[reverse_addr_rank1_assert(1297, "advection.c", flux->nsite, nf, index1, n)]))) - (a1 * (f[reverse_addr_rank1_assert(1298, "advection.c", flux->nsite, nf, index3, n)])))); 
# 1299
}  
# 1303
...
for (n = 0; n < nf; n++) { 
# 1311
((flux->fz)[reverse_addr_rank1_assert(1311, "advection.c", flux->nsite, nf, index0, n)]) = (u * (((((-a1) * (f[reverse_addr_rank1_assert(1312, "advection.c", flux->nsite, nf, index2, n)])) + (a2 * (f[reverse_addr_rank1_assert(1313, "advection.c", flux->nsite, nf, index0, n)]))) + (a2 * (f[reverse_addr_rank1_assert(1314, "advection.c", flux->nsite, nf, index1, n)]))) - (a1 * (f[reverse_addr_rank1_assert(1315, "advection.c", flux->nsite, nf, index3, n)])))); 
# 1316
}  
# 1319
}  
...
# 1340 "advection.c"
static int advection_le_5th(advflux_t *flux, hydro_t *hydro, int nf, double *
# 1341
f) { 
# 1342
int nlocal[3]; 
...
lees_edw_t *le = (__null); 
# 1350
const double a1 = (0.05545300000000000229); 
# 1351
const double a2 = (-(0.3051470000000000016)); 
# 1352
const double a3 = (0.9160540000000000349); 
# 1353
const double a4 = (0.361520000000000008); 
# 1354
const double a5 = (-(0.02787999999999999853)); 
# 1356
(flux) ? static_cast< void>(0) : __assert_fail("flux", "advection.c", 1356, __PRETTY_FUNCTION__); 
# 1357
(hydro) ? static_cast< void>(0) : __assert_fail("hydro", "advection.c", 1357, __PRETTY_FUNCTION__); 
# 1358
(f) ? static_cast< void>(0) : __assert_fail("f", "advection.c", 1358, __PRETTY_FUNCTION__); 
# 1360
le = (flux->le); 
# 1361
lees_edw_nlocal(le, nlocal); 
...
for (n = 0; n < nf; n++) { 
# 1385
((flux->fw)[reverse_addr_rank1_assert(1385, "advection.c", flux->nsite, nf, index0, n)]) = (u * (((((a1 * (f[reverse_addr_rank1_assert(1386, "advection.c", flux->nsite, nf, lees_edw_index(le, icm3, jc, kc), n)])) + (a2 * (f[reverse_addr_rank1_assert(1387, "advection.c", flux->nsite, nf, lees_edw_index(le, icm2, jc, kc), n)]))) + (a3 * (f[reverse_addr_rank1_assert(1388, "advection.c", flux->nsite, nf, index1, n)]))) + (a4 * (f[reverse_addr_rank1_assert(1389, "advection.c", flux->nsite, nf, index0, n)]))) + (a5 * (f[reverse_addr_rank1_assert(1390, "advection.c", flux->nsite, nf, lees_edw_index(le, icp1, jc, kc), n)])))); 
# 1391
}  
# 1392
} else 
...
for (n = 0; n < nf; n++) { 
# 1395
((flux->fw)[reverse_addr_rank1_assert(1395, "advection.c", flux->nsite, nf, index0, n)]) = (u * (((((a1 * (f[reverse_addr_rank1_assert(1396, "advection.c", flux->nsite, nf, lees_edw_index(le, icp2, jc, kc), n)])) + (a2 * (f[reverse_addr_rank1_assert(1397, "advection.c", flux->nsite, nf, lees_edw_index(le, icp1, jc, kc), n)]))) + (a3 * (f[reverse_addr_rank1_assert(1398, "advection.c", flux->nsite, nf, index0, n)]))) + (a4 * (f[reverse_addr_rank1_assert(1399, "advection.c", flux->nsite, nf, index1, n)]))) + (a5 * (f[reverse_addr_rank1_assert(1400, "advection.c", flux->nsite, nf, lees_edw_index(le, icm2, jc, kc), n)])))); 
# 1401
}  
# 1402
}  
...
for (n = 0; n < nf; n++) { 
# 1412
((flux->fe)[reverse_addr_rank1_assert(1412, "advection.c", flux->nsite, nf, index0, n)]) = (u * (((((a1 * (f[reverse_addr_rank1_assert(1413, "advection.c", flux->nsite, nf, lees_edw_index(le, icp3, jc, kc), n)])) + (a2 * (f[reverse_addr_rank1_assert(1414, "advection.c", flux->nsite, nf, lees_edw_index(le, icp2, jc, kc), n)]))) + (a3 * (f[reverse_addr_rank1_assert(1415, "advection.c", flux->nsite, nf, index1, n)]))) + (a4 * (f[reverse_addr_rank1_assert(1416, "advection.c", flux->nsite, nf, index0, n)]))) + (a5 * (f[reverse_addr_rank1_assert(1417, "advection.c", flux->nsite, nf, lees_edw_index(le, icm1, jc, kc), n)])))); 
# 1418
}  
# 1419
} else 
...
for (n = 0; n < nf; n++) { 
# 1422
((flux->fe)[reverse_addr_rank1_assert(1422, "advection.c", flux->nsite, nf, index0, n)]) = (u * (((((a1 * (f[reverse_addr_rank1_assert(1423, "advection.c", flux->nsite, nf, lees_edw_index(le, icm2, jc, kc), n)])) + (a2 * (f[reverse_addr_rank1_assert(1424, "advection.c", flux->nsite, nf, lees_edw_index(le, icm1, jc, kc), n)]))) + (a3 * (f[reverse_addr_rank1_assert(1425, "advection.c", flux->nsite, nf, index0, n)]))) + (a4 * (f[reverse_addr_rank1_assert(1426, "advection.c", flux->nsite, nf, index1, n)]))) + (a5 * (f[reverse_addr_rank1_assert(1427, "advection.c", flux->nsite, nf, lees_edw_index(le, icp2, jc, kc), n)])))); 
# 1428
}  
# 1429
}  
...
for (n = 0; n < nf; n++) { 
# 1439
((flux->fy)[reverse_addr_rank1_assert(1439, "advection.c", flux->nsite, nf, index0, n)]) = (u * (((((a1 * (f[reverse_addr_rank1_assert(1440, "advection.c", flux->nsite, nf, lees_edw_index(le, ic, jc + 3, kc), n)])) + (a2 * (f[reverse_addr_rank1_assert(1441, "advection.c", flux->nsite, nf, lees_edw_index(le, ic, jc + 2, kc), n)]))) + (a3 * (f[reverse_addr_rank1_assert(1442, "advection.c", flux->nsite, nf, index1, n)]))) + (a4 * (f[reverse_addr_rank1_assert(1443, "advection.c", flux->nsite, nf, index0, n)]))) + (a5 * (f[reverse_addr_rank1_assert(1444, "advection.c", flux->nsite, nf, lees_edw_index(le, ic, jc - 1, kc), n)])))); 
# 1445
}  
# 1446
} else 
...
for (n = 0; n < nf; n++) { 
# 1449
((flux->fy)[reverse_addr_rank1_assert(1449, "advection.c", flux->nsite, nf, index0, n)]) = (u * (((((a1 * (f[reverse_addr_rank1_assert(1450, "advection.c", flux->nsite, nf, lees_edw_index(le, ic, jc - 2, kc), n)])) + (a2 * (f[reverse_addr_rank1_assert(1451, "advection.c", flux->nsite, nf, lees_edw_index(le, ic, jc - 1, kc), n)]))) + (a3 * (f[reverse_addr_rank1_assert(1452, "advection.c", flux->nsite, nf, index0, n)]))) + (a4 * (f[reverse_addr_rank1_assert(1453, "advection.c", flux->nsite, nf, index1, n)]))) + (a5 * (f[reverse_addr_rank1_assert(1454, "advection.c", flux->nsite, nf, lees_edw_index(le, ic, jc + 2, kc), n)])))); 
# 1455
}  
# 1456
}  
...
for (n = 0; n < nf; n++) { 
# 1466
((flux->fz)[reverse_addr_rank1_assert(1466, "advection.c", flux->nsite, nf, index0, n)]) = (u * (((((a1 * (f[reverse_addr_rank1_assert(1467, "advection.c", flux->nsite, nf, lees_edw_index(le, ic, jc, kc + 3), n)])) + (a2 * (f[reverse_addr_rank1_assert(1468, "advection.c", flux->nsite, nf, lees_edw_index(le, ic, jc, kc + 2), n)]))) + (a3 * (f[reverse_addr_rank1_assert(1469, "advection.c", flux->nsite, nf, index1, n)]))) + (a4 * (f[reverse_addr_rank1_assert(1470, "advection.c", flux->nsite, nf, index0, n)]))) + (a5 * (f[reverse_addr_rank1_assert(1471, "advection.c", flux->nsite, nf, lees_edw_index(le, ic, jc, kc - 1), n)])))); 
# 1472
}  
# 1473
} else 
...
for (n = 0; n < nf; n++) { 
# 1476
((flux->fz)[reverse_addr_rank1_assert(1476, "advection.c", flux->nsite, nf, index0, n)]) = (u * (((((a1 * (f[reverse_addr_rank1_assert(1477, "advection.c", flux->nsite, nf, lees_edw_index(le, ic, jc, kc - 2), n)])) + (a2 * (f[reverse_addr_rank1_assert(1478, "advection.c", flux->nsite, nf, lees_edw_index(le, ic, jc, kc - 1), n)]))) + (a3 * (f[reverse_addr_rank1_assert(1479, "advection.c", flux->nsite, nf, index0, n)]))) + (a4 * (f[reverse_addr_rank1_assert(1480, "advection.c", flux->nsite, nf, index1, n)]))) + (a5 * (f[reverse_addr_rank1_assert(1481, "advection.c", flux->nsite, nf, lees_edw_index(le, ic, jc, kc + 2), n)])))); 
# 1482
}  
# 1483
}  
...
# 1505 "advection.c"
int advective_fluxes_d3qx(hydro_t *hydro, int nf, double *f, double **
# 1506
flx) { 
# 1508
(hydro) ? static_cast< void>(0) : __assert_fail("hydro", "advection.c", 1508, __PRETTY_FUNCTION__); 
# 1509
(nf > 0) ? static_cast< void>(0) : __assert_fail("nf > 0", "advection.c", 1509, __PRETTY_FUNCTION__); 
# 1510
(f) ? static_cast< void>(0) : __assert_fail("f", "advection.c", 1510, __PRETTY_FUNCTION__); 
# 1511
(flx) ? static_cast< void>(0) : __assert_fail("flx", "advection.c", 1511, __PRETTY_FUNCTION__); 
# 1513
...
# 1529 "advection.c"
int advective_fluxes_2nd_d3qx(hydro_t *hydro, int nf, double *f, double **
# 1530
flx) { 
# 1532
int nlocal[3]; 
...
double u0[3], u1[3], u; 
# 1539
(hydro) ? static_cast< void>(0) : __assert_fail("hydro", "advection.c", 1539, __PRETTY_FUNCTION__); 
# 1540
(hydro->cs) ? static_cast< void>(0) : __assert_fail("hydro->cs", "advection.c", 1540, __PRETTY_FUNCTION__); 
# 1541
(nf > 0) ? static_cast< void>(0) : __assert_fail("nf > 0", "advection.c", 1541, __PRETTY_FUNCTION__); 
# 1542
(f) ? static_cast< void>(0) : __assert_fail("f", "advection.c", 1542, __PRETTY_FUNCTION__); 
# 1543
(flx) ? static_cast< void>(0) : __assert_fail("flx", "advection.c", 1543, __PRETTY_FUNCTION__); 
# 1545
...
for (n = 0; n < nf; n++) { 
# 1564
((flx[reverse_addr_rank1_assert(1564, "advection.c", nsites, nf, index0, n)])[c - 1]) = ((u * (0.5)) * ((f[reverse_addr_rank1_assert(1565, "advection.c", nsites, nf, index1, n)]) + (f[reverse_addr_rank1_assert(1566, "advection.c", nsites, nf, index0, n)]))); 
# 1567
}  
# 1568
}  
...
# 1 "advection.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__17_advection_cpp1_ii_52780400
# 1 "advection.cudafe1.stub.c"
#include "advection.cudafe1.stub.c"
# 1 "advection.cudafe1.stub.c"
