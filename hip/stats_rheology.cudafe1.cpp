...
MPI_Comm comm; 
# 82
(pe) ? static_cast< void>(0) : __assert_fail("pe", "stats_rheology.c", 82, __PRETTY_FUNCTION__); 
# 83
(cs) ? static_cast< void>(0) : __assert_fail("cs", "stats_rheology.c", 83, __PRETTY_FUNCTION__); 
# 85
obj = ((stats_rheo_t *)calloc(1, sizeof(stats_rheo_t))); 
# 86
(obj) ? static_cast< void>(0) : __assert_fail("obj", "stats_rheology.c", 86, __PRETTY_FUNCTION__); 
# 87
if (obj == (__null)) { pe_fatal(pe, "calloc(stats_rheo_t) failed\n"); }  
# 89
(obj->pe) = pe; 
# 90
(obj->cs) = cs; 
...
cs_nlocal(cs, nlocal); 
# 140
nelements = (7 * (nlocal[X])); 
# 141
(obj->sxy) = ((double *)malloc(nelements * sizeof(double))); 
# 142
(obj->sxy) ? static_cast< void>(0) : __assert_fail("obj->sxy", "stats_rheology.c", 142, __PRETTY_FUNCTION__); 
# 143
if ((obj->sxy) == (__null)) { pe_fatal(pe, "malloc(sxy) failed\n"); }  
# 147
nelements = ((22 * (nlocal[X])) * (nlocal[Z])); 
# 148
(obj->stat_xz) = ((double *)malloc(nelements * sizeof(double))); 
# 149
(obj->stat_xz) ? static_cast< void>(0) : __assert_fail("obj->stat_xz", "stats_rheology.c", 149, __PRETTY_FUNCTION__); 
# 150
if ((obj->stat_xz) == (__null)) { pe_fatal(pe, "malloc(stat_xz) failed\n"); }  
# 152
...
# 186 "stats_rheology.c"
int stats_rheology_free_energy_density_profile(stats_rheo_t *stat, fe_t *fe, const char *
# 187
filename) { 
# 189
int ic, jc, kc, index; 
...
MPI_Comm comm; 
# 208
(stat) ? static_cast< void>(0) : __assert_fail("stat", "stats_rheology.c", 208, __PRETTY_FUNCTION__); 
# 210
...
# 218
(fex) ? static_cast< void>(0) : __assert_fail("fex", "stats_rheology.c", 218, __PRETTY_FUNCTION__); 
# 219
if (fex == (__null)) { pe_fatal(stat->pe, "malloc(fex) failed\n"); }  
# 220
fexmean = ((double *)malloc((nlocal[X]) * sizeof(double))); 
# 221
(fexmean) ? static_cast< void>(0) : __assert_fail("fexmean", "stats_rheology.c", 221, __PRETTY_FUNCTION__); 
# 222
if (fexmean == (__null)) { pe_fatal(stat->pe, "malloc(fexmean failed\n"); }  
# 227
...
# 260
if (fp_output == (__null)) { pe_fatal(stat->pe, "fopen(%s) failed\n", filename); }  
# 262
for (ic = 1; ic <= (nlocal[X]); ic++) { 
# 266
...
int nlocal[3]; 
# 303
(stat) ? static_cast< void>(0) : __assert_fail("stat", "stats_rheology.c", 303, __PRETTY_FUNCTION__); 
# 305
cs_nlocal(stat->cs, nlocal); 
# 307
for (ic = 1; ic <= (nlocal[X]); ic++) { 
...
for (n = 0; n < 22; n++) { 
# 313
((stat->stat_xz)[(22 * ((((nlocal[Z]) * (ic - 1)) + kc) - 1)) + n]) = (0.0); 
# 314
}  
# 315
}  
...
# 333 "stats_rheology.c"
int stats_rheology_stress_profile_accumulate(stats_rheo_t *stat, lb_t *lb, fe_t *
# 334
fe, hydro_t *
# 335
hydro) { 
...
double s[3][3]; 
# 344
(stat) ? static_cast< void>(0) : __assert_fail("stat", "stats_rheology.c", 344, __PRETTY_FUNCTION__); 
# 345
(lb) ? static_cast< void>(0) : __assert_fail("lb", "stats_rheology.c", 345, __PRETTY_FUNCTION__); 
# 346
(hydro) ? static_cast< void>(0) : __assert_fail("hydro", "stats_rheology.c", 346, __PRETTY_FUNCTION__); 
# 348
cs_nlocal(stat->cs, nlocal); 
# 350
for (ic = 1; ic <= (nlocal[X]); ic++) { 
...
# 375
((stat->stat_xz)[(22 * ((((nlocal[Z]) * (ic - 1)) + kc) - 1)) + (ndata++)]) += ((s[ia])[ib]); 
# 376
}  
# 377
}  
# 378
(ndata == 6) ? static_cast< void>(0) : __assert_fail("ndata == 6", "stats_rheology.c", 378, __PRETTY_FUNCTION__); 
# 382
((fe->func)->stress)(fe, index, s); 
# 384
((stat->sxy)[(7 * (ic - 1)) + 1]) += ((s[X])[Y]); 
# 386
for (ia = 0; ia < 3; ia++) { 
# 387
for (ib = ia; ib < 3; ib++) { 
...
# 392
((stat->sxy)[(7 * (ic - 1)) + 2]) += ((rrho * (u[X])) * (u[Y])); 
# 393
((stat->sxy)[(7 * (ic - 1)) + 3]) += (rrho * (u[X])); 
# 394
((stat->sxy)[(7 * (ic - 1)) + 4]) += (rrho * (u[Y])); 
# 395
((stat->sxy)[(7 * (ic - 1)) + 5]) += (rrho * (u[Z])); 
# 399
for (ia = 0; ia < 3; ia++) { 
# 400
for (ib = ia; ib < 3; ib++) { 
# 401
((stat->stat_xz)[(22 * ((((nlocal[Z]) * (ic - 1)) + kc) - 1)) + (ndata++)]) += ((rrho * (u[ia])) * (u[ib])); 
# 403
}  
# 404
}  
# 408
((stat->stat_xz)[(22 * ((((nlocal[Z]) * (ic - 1)) + kc) - 1)) + (ndata++)]) += (rrho * (u[X])); 
# 409
((stat->stat_xz)[(22 * ((((nlocal[Z]) * (ic - 1)) + kc) - 1)) + (ndata++)]) += (rrho * (u[Y])); 
# 410
((stat->stat_xz)[(22 * ((((nlocal[Z]) * (ic - 1)) + kc) - 1)) + (ndata++)]) += (rrho * (u[Z])); 
# 413
((stat->stat_xz)[(22 * ((((nlocal[Z]) * (ic - 1)) + kc) - 1)) + (ndata++)]) = (0.0); 
# 415
(ndata == 22) ? static_cast< void>(0) : __assert_fail("ndata == 22", "stats_rheology.c", 415, __PRETTY_FUNCTION__); 
# 417
hydro_u_gradient_tensor(hydro, ic, jc, kc, s); 
# 418
((stat->sxy)[(7 * (ic - 1)) + 6]) += (((s[X])[Y]) + ((s[Y])[X])); 
# 419
}  
# 420
}  
...
FILE *fp_output; 
# 474
(stat) ? static_cast< void>(0) : __assert_fail("stat", "stats_rheology.c", 474, __PRETTY_FUNCTION__); 
# 476
cs_ltot(stat->cs, ltot); 
# 477
cs_nlocal(stat->cs, nlocal); 
...
# 488
(sxymean) ? static_cast< void>(0) : __assert_fail("sxymean", "stats_rheology.c", 488, __PRETTY_FUNCTION__); 
# 489
if (sxymean == (__null)) { pe_fatal(stat->pe, "malloc(sxymean) failed\n"); }  
# 491
MPI_Reduce(stat->sxy, sxymean, 7 * (nlocal[X]), MPI_DOUBLE, MPI_SUM, 0, stat->comm_yz); 
# 494
...
double uy = (0.0); 
# 521
fprintf(fp_output, "%6d %18.10e %18.10e %18.10e %18.10e %18.10e %18.10e %18.10e\n", (noffset[X]) + ic, rmean * (sxymean[7 * (ic - 1)]), rmean * (sxymean[(7 * (ic - 1)) + 1]), rmean * (sxymean[(7 * (ic - 1)) + 2]), rmean * (sxymean[(7 * (ic - 1)) + 3]), (rmean * (sxymean[(7 * (ic - 1)) + 4])) + uy, rmean * (sxymean[(7 * (ic - 1)) + 5]), (rmean * (sxymean[(7 * (ic - 1)) + 6])) * eta); 
# 531
}  
# 535
if (ferror(fp_output)) { 
...
# 607
(stat) ? static_cast< void>(0) : __assert_fail("stat", "stats_rheology.c", 607, __PRETTY_FUNCTION__); 
# 609
cs_ltot(stat->cs, ltot); 
# 610
cs_nlocal(stat->cs, nlocal); 
...
# 622
(stat_2d) ? static_cast< void>(0) : __assert_fail("stat_2d", "stats_rheology.c", 622, __PRETTY_FUNCTION__); 
# 623
if (stat_2d == (__null)) { pe_fatal(stat->pe, "malloc(stat_2d) failed\n"); }  
# 625
nelements = (22 * (ntotal[Z])); 
# 626
stat_1d = ((double *)malloc(nelements * sizeof(double))); 
# 627
(stat_1d) ? static_cast< void>(0) : __assert_fail("stat_1d", "stats_rheology.c", 627, __PRETTY_FUNCTION__); 
# 628
if (stat_1d == (__null)) { pe_fatal(stat->pe, "malloc(stat_1d) failed\n"); }  
# 632
raverage = (0.0); 
# 633
if ((stat->counter_sxy) > 0) { raverage = ((1.0) / ((ltot[Y]) * (stat->counter_sxy))); }  
# 637
MPI_Reduce(stat->stat_xz, stat_2d, (22 * (nlocal[X])) * (nlocal[Z]), MPI_DOUBLE, MPI_SUM, 0, stat->comm_y); 
# 642
if ((mpi_cartcoords[Y]) == 0) { 
# 648
...
for (n = 0; n < 22; n++) { 
# 676
(stat_2d[(22 * ((((nlocal[Z]) * (ic - 1)) + kc) - 1)) + n]) *= raverage; 
# 677
}  
# 680
for (n = 0; n < 6; n++) { 
# 681
(stat_2d[(22 * ((((nlocal[Z]) * (ic - 1)) + kc) - 1)) + n]) *= viscous; 
# 682
}  
# 685
(stat_2d[(22 * ((((nlocal[Z]) * (ic - 1)) + kc) - 1)) + 19]) += uy; 
# 686
}  
# 688
MPI_Gather(stat_2d + ((22 * (nlocal[Z])) * (ic - 1)), 22 * (nlocal[Z]), MPI_DOUBLE, stat_1d, 22 * (nlocal[Z]), MPI_DOUBLE, 0, stat->comm_z); 
# 693
if (is_writing) { 
# 694
...
for (n = 0; n < 22; n++) { 
# 696
fprintf(fp_output, " %15.8e", stat_1d[(22 * (kc - 1)) + n]); 
# 697
}  
# 698
fprintf(fp_output, "\n"); 
...
MPI_Comm comm; 
# 761
(lb) ? static_cast< void>(0) : __assert_fail("lb", "stats_rheology.c", 761, __PRETTY_FUNCTION__); 
# 763
...
# 818
MPI_Reduce(send, recv, 27, MPI_DOUBLE, MPI_SUM, 0, comm); 
# 820
kc = 0; 
# 821
for (ia = 0; ia < 3; ia++) { 
...
# 830
if ((filename == (__null)) || (strcmp(filename, "") == 0)) { 
# 832
...
fp = fopen(filename, "a"); 
# 841
if (fp == (__null)) { pe_fatal(lb->pe, "fopen(%s) failed\n", filename); }  
# 843
...
# 864 "stats_rheology.c"
static void stats_rheology_print_matrix(FILE *fp, double s[3][3]) { 
# 866
(fp) ? static_cast< void>(0) : __assert_fail("fp", "stats_rheology.c", 866, __PRETTY_FUNCTION__); 
# 868
...
# 1 "stats_rheology.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__22_stats_rheology_cpp1_ii_12498389
# 1 "stats_rheology.cudafe1.stub.c"
#include "stats_rheology.cudafe1.stub.c"
# 1 "stats_rheology.cudafe1.stub.c"
