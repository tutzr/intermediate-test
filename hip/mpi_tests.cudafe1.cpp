...
# 13
static int test_mpi_comm_rank(); 
# 14
static int test_mpi_comm_size(); 
# 15
static int test_mpi_allreduce(); 
# 16
static int test_mpi_reduce(); 
# 17
static int test_mpi_allgather(); 
# 19
...
# 26
(ireturn == (MPI_SUCCESS)) ? static_cast< void>(0) : __assert_fail("ireturn == MPI_SUCCESS", "mpi_tests.c", 26, __PRETTY_FUNCTION__); 
# 28
...
# 35
(ireturn == (MPI_SUCCESS)) ? static_cast< void>(0) : __assert_fail("ireturn == MPI_SUCCESS", "mpi_tests.c", 35, __PRETTY_FUNCTION__); 
# 37
...
# 54
(ireturn == (MPI_SUCCESS)) ? static_cast< void>(0) : __assert_fail("ireturn == MPI_SUCCESS", "mpi_tests.c", 54, __PRETTY_FUNCTION__); 
# 55
(rank == 0) ? static_cast< void>(0) : __assert_fail("rank == 0", "mpi_tests.c", 55, __PRETTY_FUNCTION__); 
# 57
return ireturn; 
# 58
} 
...
# 72
(ireturn == (MPI_SUCCESS)) ? static_cast< void>(0) : __assert_fail("ireturn == MPI_SUCCESS", "mpi_tests.c", 72, __PRETTY_FUNCTION__); 
# 73
(size == 1) ? static_cast< void>(0) : __assert_fail("size == 1", "mpi_tests.c", 73, __PRETTY_FUNCTION__); 
# 75
return ireturn; 
# 76
} 
...
# 92
(ireturn == (MPI_SUCCESS)) ? static_cast< void>(0) : __assert_fail("ireturn == MPI_SUCCESS", "mpi_tests.c", 92, __PRETTY_FUNCTION__); 
# 93
(dsend == (1.0)) ? static_cast< void>(0) : __assert_fail("dsend == 1.0", "mpi_tests.c", 93, __PRETTY_FUNCTION__); 
# 94
(drecv == dsend) ? static_cast< void>(0) : __assert_fail("drecv == dsend", "mpi_tests.c", 94, __PRETTY_FUNCTION__); 
# 96
(isend[0]) = (-1); 
# 97
(isend[1]) = 0; 
...
# 101
(ireturn == (MPI_SUCCESS)) ? static_cast< void>(0) : __assert_fail("ireturn == MPI_SUCCESS", "mpi_tests.c", 101, __PRETTY_FUNCTION__); 
# 102
((isend[0]) == (-1)) ? static_cast< void>(0) : __assert_fail("isend[0] == -1", "mpi_tests.c", 102, __PRETTY_FUNCTION__); 
# 103
((isend[1]) == 0) ? static_cast< void>(0) : __assert_fail("isend[1] == 0", "mpi_tests.c", 103, __PRETTY_FUNCTION__); 
# 104
((isend[2]) == (+1)) ? static_cast< void>(0) : __assert_fail("isend[2] == +1", "mpi_tests.c", 104, __PRETTY_FUNCTION__); 
# 105
((irecv[0]) == (-1)) ? static_cast< void>(0) : __assert_fail("irecv[0] == -1", "mpi_tests.c", 105, __PRETTY_FUNCTION__); 
# 106
((irecv[1]) == 0) ? static_cast< void>(0) : __assert_fail("irecv[1] == 0", "mpi_tests.c", 106, __PRETTY_FUNCTION__); 
# 107
((irecv[2]) == (+1)) ? static_cast< void>(0) : __assert_fail("irecv[2] == +1", "mpi_tests.c", 107, __PRETTY_FUNCTION__); 
# 109
return ireturn; 
# 110
} 
...
# 127
(ireturn == (MPI_SUCCESS)) ? static_cast< void>(0) : __assert_fail("ireturn == MPI_SUCCESS", "mpi_tests.c", 127, __PRETTY_FUNCTION__); 
# 128
(dsend == (1.0)) ? static_cast< void>(0) : __assert_fail("dsend == 1.0", "mpi_tests.c", 128, __PRETTY_FUNCTION__); 
# 129
(drecv == dsend) ? static_cast< void>(0) : __assert_fail("drecv == dsend", "mpi_tests.c", 129, __PRETTY_FUNCTION__); 
# 131
(isend[0]) = (-1); 
# 132
(isend[1]) = 0; 
...
# 136
(ireturn == (MPI_SUCCESS)) ? static_cast< void>(0) : __assert_fail("ireturn == MPI_SUCCESS", "mpi_tests.c", 136, __PRETTY_FUNCTION__); 
# 137
((isend[0]) == (-1)) ? static_cast< void>(0) : __assert_fail("isend[0] == -1", "mpi_tests.c", 137, __PRETTY_FUNCTION__); 
# 138
((isend[1]) == 0) ? static_cast< void>(0) : __assert_fail("isend[1] == 0", "mpi_tests.c", 138, __PRETTY_FUNCTION__); 
# 139
((isend[2]) == (+1)) ? static_cast< void>(0) : __assert_fail("isend[2] == +1", "mpi_tests.c", 139, __PRETTY_FUNCTION__); 
# 140
((irecv[0]) == (-1)) ? static_cast< void>(0) : __assert_fail("irecv[0] == -1", "mpi_tests.c", 140, __PRETTY_FUNCTION__); 
# 141
((irecv[1]) == 0) ? static_cast< void>(0) : __assert_fail("irecv[1] == 0", "mpi_tests.c", 141, __PRETTY_FUNCTION__); 
# 142
((irecv[2]) == (+1)) ? static_cast< void>(0) : __assert_fail("irecv[2] == +1", "mpi_tests.c", 142, __PRETTY_FUNCTION__); 
# 144
dvsend = ((double *)malloc((2) * sizeof(double))); 
# 145
dvrecv = ((double *)malloc((2) * sizeof(double))); 
# 147
(dvsend) ? static_cast< void>(0) : __assert_fail("dvsend", "mpi_tests.c", 147, __PRETTY_FUNCTION__); 
# 148
(dvrecv) ? static_cast< void>(0) : __assert_fail("dvrecv", "mpi_tests.c", 148, __PRETTY_FUNCTION__); 
# 150
(dvsend[0]) = (-(1.0)); 
# 151
(dvsend[1]) = (+(1.5)); 
...
# 156
(ireturn == (MPI_SUCCESS)) ? static_cast< void>(0) : __assert_fail("ireturn == MPI_SUCCESS", "mpi_tests.c", 156, __PRETTY_FUNCTION__); 
# 157
((dvsend[0]) == (-(1.0))) ? static_cast< void>(0) : __assert_fail("dvsend[0] == -1.0", "mpi_tests.c", 157, __PRETTY_FUNCTION__); 
# 158
((dvsend[1]) == (+(1.5))) ? static_cast< void>(0) : __assert_fail("dvsend[1] == +1.5", "mpi_tests.c", 158, __PRETTY_FUNCTION__); 
# 159
((dvrecv[0]) == (dvsend[0])) ? static_cast< void>(0) : __assert_fail("dvrecv[0] == dvsend[0]", "mpi_tests.c", 159, __PRETTY_FUNCTION__); 
# 160
((dvrecv[1]) == (dvsend[1])) ? static_cast< void>(0) : __assert_fail("dvrecv[1] == dvsend[1]", "mpi_tests.c", 160, __PRETTY_FUNCTION__); 
# 162
free(dvsend); 
# 163
free(dvrecv); 
...
# 182
(ireturn == (MPI_SUCCESS)) ? static_cast< void>(0) : __assert_fail("ireturn == MPI_SUCCESS", "mpi_tests.c", 182, __PRETTY_FUNCTION__); 
# 184
return ireturn; 
# 185
} 

# 1 "mpi_tests.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__17_mpi_tests_cpp1_ii_main
# 1 "mpi_tests.cudafe1.stub.c"
#include "mpi_tests.cudafe1.stub.c"
# 1 "mpi_tests.cudafe1.stub.c"
