...
# 228
{ tdpErrorHandler(hipGetSymbolAddress((void **)(&tmp), &const_param), "coords.c", 228, 1); } ; 
# 229
tdpMemcpy(&((cs->target)->param), (const void *)(&tmp), sizeof(cs_param_t *), hipMemcpyHostToDevice); 
# 231
cs_commit(cs); 
# 232
}  
...
# 247
{ tdpErrorHandler(hipMemcpyToSymbol(&const_param, cs->param, sizeof(cs_param_t), 0, hipMemcpyHostToDevice), "coords.c", 248, 1); 
# 247 "coords.c"
} 
# 248
; 
