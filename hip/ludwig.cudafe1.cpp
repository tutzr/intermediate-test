...
# 25 "wall_rt.h"
int wall_rt_init(pe_t * pe, cs_t * cs, rt_t * rt, lb_t * lb, map_t * map, wall_t ** wall); 
# 31 "psi.h"
...
# 27
int ewald_create(pe_t * pe, cs_t * cs, double mu, double rc, colloids_info_t * cinfo, ewald_t ** e); 
# 29
...
# 36
int ewald_total_energy(ewald_t * ewald, double * ereal, double * efourier, double * eself); 
# 38
int ewald_fourier_space_energy(ewald_t * ewald, double * ef); 
# 39
int ewald_self_energy(ewald_t * ewald, double * es); 
# 40
int ewald_real_space_energy(ewald_t * ewald, const double  r1[3], const double  r2[3], const double  r12[3], double * er); 
# 30 "interaction.h"
typedef 
# 23
enum interact_enum { 
...
# 48
int interact_potential_add(interact_t * obj, interact_enum_t it, void * potential, compute_ft compute); 
# 50
int interact_statistic_add(interact_t * obj, interact_enum_t it, void * potential, stat_ft stats); 
# 52
...
# 22 "physics_rt.h"
int physics_info(pe_t * pe, physics_t * phys); 
# 23
int physics_init_rt(rt_t * rt, physics_t * phys); 
# 16 "hydro_rt.h"
int hydro_rt(pe_t * pe, rt_t * rt, cs_t * cs, lees_edw_t * le, hydro_t ** phydro); 
# 28 "field.h"
...
# 24
int stats_field_reduce(field_t * obj, map_t * map, double * fmin, double * fmax, double * fsum, double * fvar, double * fvol, int rank, MPI_Comm comm); 
# 27
int stats_field_local(field_t * obj, map_t * map, double * fmin, double * fmax, double * fsum, double * fvar, double * fvol); 
# 29
...
# 30
int pth_create(pe_t * pe, cs_t * cs, int method, pth_t ** pth); 
# 31
int pth_free(pth_t * pth); 
# 32
int pth_memcpy(pth_t * pth, tdpMemcpyKind flag); 
# 33
...
# 26 "phi_force.h"
int phi_force_calculation(cs_t * cs, lees_edw_t * le, wall_t * wall, pth_t * pth, fe_t * fe, map_t * map, field_t * phi, hydro_t * hydro); 
# 26 "phi_force_colloid.h"
int pth_force_fluid_driver(pth_t * pth, hydro_t * hydro); 
# 27
int pth_force_fluid_wall_driver(pth_t * pth, hydro_t * hydro, map_t * map, wall_t * wall); 
# 29
int pth_force_colloid(pth_t * pth, fe_t * fe, colloids_info_t * cinfo, hydro_t * hydro, map_t * map, wall_t * wall); 
# 22 "phi_lb_coupler.h"
int phi_lb_to_field(field_t * phi, lb_t * lb); 
# 23
int phi_lb_from_field(field_t * phi, lb_t * lb); 
# 20 "gradient_2d_5pt_fluid.h"
int grad_2d_5pt_fluid_d2(field_grad_t * fgrad); 
# 21
int grad_2d_5pt_fluid_d4(field_grad_t * fgrad); 
# 20 "gradient_2d_tomita_fluid.h"
int grad_2d_tomita_fluid_d2(field_grad_t * fgrad); 
# 21
int grad_2d_tomita_fluid_d4(field_grad_t * fgrad); 
...
# 50
int fe_lc_droplet_create(pe_t * pe, cs_t * cs, fe_lc_t * lc, fe_symm_t * symm, fe_lc_droplet_t ** p); 
# 53
int fe_lc_droplet_free(fe_lc_droplet_t * fe); 
# 54
int fe_lc_droplet_param(fe_lc_droplet_t * fe, fe_lc_droplet_param_t * param); 
# 56
int fe_lc_droplet_param_set(fe_lc_droplet_t * fe, fe_lc_droplet_param_t param); 
# 58
int fe_lc_droplet_target(fe_lc_droplet_t * fe, fe_t ** target); 
# 59
...
# 66
int fe_lc_droplet_stress(fe_lc_droplet_t * fe, int index, double  s[3][3]); 
# 68
void fe_lc_droplet_stress_v(fe_lc_droplet_t * fe, int index, double  s[3][3][1]); 
# 71
int fe_lc_droplet_mol_field(fe_lc_droplet_t * fe, int index, double  h[3][3]); 
# 74
void fe_lc_droplet_mol_field_v(fe_lc_droplet_t * fe, int index, double  h[3][3][1]); 
# 77
int fe_lc_droplet_mu(fe_lc_droplet_t * fe, int index, double * mu); 
# 81
...
# 85
void fe_lc_droplet_str_symm_v(fe_lc_droplet_t * fe, int index, double  s[3][3][1]); 
# 87
void fe_lc_droplet_str_anti_v(fe_lc_droplet_t * fe, int index, double  s[3][3][1]); 
# 89
int fe_lc_droplet_bodyforce_wall(fe_lc_droplet_t * fe, lees_edw_t * le, hydro_t * hydro, map_t * map, wall_t * wall); 
# 25 "gradient_3d_7pt_solid.h"
typedef struct grad_lc_anch_s grad_lc_anch_t; 
# 27
int grad_lc_anch_create(pe_t * pe, cs_t * cs, map_t * map, field_t * phi, colloids_info_t * cinfo, fe_lc_t * fe, grad_lc_anch_t ** p); 
# 30
int grad_3d_7pt_solid_d2(field_grad_t * fg); 
# 31
int grad_3d_7pt_solid_dab(field_grad_t * fg); 
# 32
int grad_3d_7pt_solid_set(map_t * map, colloids_info_t * cinfo); 
...
# 22 "gradient_3d_27pt_solid.h"
int grad_3d_27pt_solid_map_set(map_t * map); 
# 23
int grad_3d_27pt_solid_d2(field_grad_t * fg); 
# 24
int grad_3d_27pt_solid_dab(field_grad_t * fg); 
# 25
int grad_3d_27pt_solid_fe_set(fe_symm_t * fe); 
# 31 "gradient_rt.h"
int gradient_rt_init(pe_t * pe, rt_t * rt, const char * fieldname, field_grad_t * grad, map_t * map, colloids_info_t * cinfo); 
# 22 "symmetric_rt.h"
int fe_symmetric_init_rt(pe_t * pe, rt_t * rt, fe_symm_t * fe); 
# 23
int fe_symmetric_phi_init_rt(pe_t * pe, rt_t * rt, fe_symm_t * fe, field_t * phi); 
# 27 "brazovskii.h"
...
# 37
int fe_brazovskii_create(pe_t * pe, cs_t * cs, field_t * phi, field_grad_t * dphi, fe_brazovskii_t ** p); 
# 40
int fe_brazovskii_free(fe_brazovskii_t * fe); 
# 41
int fe_brazovskii_param_set(fe_brazovskii_t * fe, fe_brazovskii_param_t param); 
# 43
int fe_brazovskii_target(fe_brazovskii_t * fe, fe_t ** target); 
# 47
int fe_brazovskii_param(fe_brazovskii_t * fe, fe_brazovskii_param_t * param); 
# 49
int fe_brazovskii_amplitude(fe_brazovskii_t * fe, double * a0); 
# 51
int fe_brazovskii_wavelength(fe_brazovskii_t * fe, double * lamb); 
# 53
...
# 59
void fe_brazovskii_str_v(fe_brazovskii_t * fe, int index, double  s[3][3][1]); 
# 22 "brazovskii_rt.h"
int fe_brazovskii_init_rt(pe_t * pe, rt_t * rt, fe_brazovskii_t * fe); 
# 23
int fe_brazovskii_phi_init_rt(pe_t * pe, rt_t * rt, fe_brazovskii_t * fe, field_t * phi); 
# 24 "polar_active.h"
...
# 41
int fe_polar_create(pe_t * pe, cs_t * cs, field_t * p, field_grad_t * dp, fe_polar_t ** fe); 
# 43
int fe_polar_free(fe_polar_t * fe); 
# 44
int fe_polar_param_set(fe_polar_t * fe, fe_polar_param_t values); 
# 45
int fe_polar_param_commit(fe_polar_t * fe); 
# 46
int fe_polar_param(fe_polar_t * fe, fe_polar_param_t * values); 
# 47
int fe_polar_target(fe_polar_t * fe, fe_t ** target); 
# 49
...
# 52
void fe_polar_stress_v(fe_polar_t * fe, int index, double  s[3][3][1]); 
# 22 "polar_active_rt.h"
...
# 26 "blue_phase_rt.h"
int blue_phase_init_rt(pe_t * pe, rt_t * rt, fe_lc_t * fe, beris_edw_t * be); 
# 29
int blue_phase_rt_initial_conditions(pe_t * pe, rt_t * rt, cs_t * cs, fe_lc_t * fe, field_t * q); 
# 21 "lc_droplet_rt.h"
...
# 28
int phi_ch_create(pe_t * pe, cs_t * cs, lees_edw_t * le, phi_ch_info_t * info, phi_ch_t ** pch); 
# 31
int phi_ch_free(phi_ch_t * pch); 
# 33
int phi_cahn_hilliard(phi_ch_t * pch, fe_t * fe, field_t * phi, hydro_t * hydro, map_t * map, noise_t * noise); 
# 22 "leslie_ericksen.h"
int leslie_ericksen_update(cs_t * cs, fe_polar_t * fe, field_t * p, hydro_t * hydro); 
# 24
...
# 23
int colloid_io_create(pe_t * pe, cs_t * cs, int  io_grid[3], colloids_info_t * info, colloid_io_t ** cio); 
# 26
...
# 28 "colloids_rt.h"
int colloids_init_rt(pe_t * pe, rt_t * rt, cs_t * cs, colloids_info_t ** pinfo, colloid_io_t ** cio, interact_t ** interact, wall_t * wall, map_t * map); 
# 31
int colloids_init_ewald_rt(pe_t * pe, rt_t * rt, cs_t * cs, colloids_info_t * cinfo, ewald_t ** pewald); 
# 33
int colloids_init_halo_range_check(pe_t * pe, cs_t * cs, colloids_info_t * cinfo); 
# 21 "colloid_sums.h"
...
# 31
COLLOID_SUM_MAX} colloid_sum_enum_t; 
# 33
...
# 24 "build.h"
int build_remove_replace(fe_t * fe, colloids_info_t * cinfo, lb_t * lb, field_t * phi, field_t * p, field_t * q, psi_t * psi, map_t * map); 
# 27
int build_update_links(cs_t * cs, colloids_info_t * cinfo, wall_t * wall, map_t * map); 
# 29
...
# 47
int visc_arrhenius_create(pe_t * pe, cs_t * cs, field_t * phi, visc_arrhenius_param_t param, visc_arrhenius_t ** visc); 
# 50
int visc_arrhenius_free(visc_arrhenius_t * visc); 
# 51
int visc_arrhenius_info(visc_arrhenius_t * visc); 
# 52
int visc_arrhenius_update(visc_arrhenius_t * visc, hydro_t * hydro); 
# 53
int visc_arrhenius_stats(visc_arrhenius_t * visc, hydro_t * hydro); 
# 23 "psi_rt.h"
...
# 22
int psi_stats_local(psi_t * psi, double * rho_min, double * rho_max, double * rho_tot); 
# 24
int psi_stats_reduce(psi_t * psi, double * rho_min, double * rho_max, double * rho_tot, int rank, MPI_Comm comm); 
# 26 "psi_force.h"
int psi_force_gradmu(psi_t * psi, fe_t * fe, field_t * phi, hydro_t * hydro, map_t * map, colloids_info_t * cinfo); 
# 28
int psi_force_divstress(psi_t * psi, fe_t * fe, hydro_t * hydro, colloids_info_t * cinfo); 
# 30
int psi_force_divstress_d3qx(psi_t * psi, fe_t * fe, hydro_t * hydro, map_t * map, colloids_info_t * cinfo); 
# 32
...
# 23
int psi_colloid_replace_charge(psi_t * psi, colloids_info_t * cinfo, colloid_t * colloid, int index); 
# 25
int psi_colloid_zetapotential(psi_t * obj, colloids_info_t * cinfo, double * psi_zeta); 
# 24 "nernst_planck.h"
int nernst_planck_driver(psi_t * psi, fe_t * fe, hydro_t * hydro, map_t * map); 
# 25
int nernst_planck_driver_d3qx(psi_t * psi, fe_t * fe, hydro_t * hydro, map_t * map, colloids_info_t * cinfo); 
# 27
...
# 39
int fe_surfactant1_create(pe_t * pe, cs_t * cs, field_t * phi, field_grad_t * dphi, fe_surfactant1_t ** fe); 
# 42
int fe_surfactant1_free(fe_surfactant1_t * fe); 
# 43
int fe_surfactant1_param_set(fe_surfactant1_t * fe, fe_surfactant1_param_t vals); 
# 44
int fe_surfactant1_sigma(fe_surfactant1_t * fe, double * sigma); 
# 45
int fe_surfactant1_xi0(fe_surfactant1_t * fe, double * xi0); 
# 46
int fe_surfactant1_langmuir_isotherm(fe_surfactant1_t * fe, double * psi_c); 
# 47
int fe_surfactant1_target(fe_surfactant1_t * fe, fe_t ** target); 
# 49
int fe_surfactant1_param(fe_surfactant1_t * fe, fe_surfactant1_param_t * param); 
# 50
int fe_surfactant1_fed(fe_surfactant1_t * fe, int index, double * fed); 
# 51
int fe_surfactant1_mu(fe_surfactant1_t * fe, int index, double * mu); 
# 52
int fe_surfactant1_str(fe_surfactant1_t * fe, int index, double  s[3][3]); 
# 20 "stats_surfactant.h"
...
# 29
int stats_rheology_stress_profile_accumulate(stats_rheo_t * rheo, lb_t * lb, fe_t * fe, hydro_t * hydro); 
# 32
int stats_rheology_mean_stress(lb_t * lb, fe_t * fe, const char * filename); 
# 35
int stats_rheology_free_energy_density_profile(stats_rheo_t * rheo, fe_t * fe, const char *); 
# 37
...
# 27 "stats_free_energy.h"
int stats_free_energy_density(pe_t * pe, cs_t * cs, wall_t * wall, fe_t * fe, map_t * map, colloids_info_t * cinfo); 
# 19 "stats_distribution.h"
...
# 27
int stats_ahydro_create(pe_t * pe, cs_t * cs, colloids_info_t * cinfo, hydro_t * hydro, map_t * map, stats_ahydro_t ** pobj); 
# 29
...
# 27
int stats_sigma_create(pe_t * pe, cs_t * cs, fe_symm_t * fe, field_t * phi, stats_sigma_t ** pobj); 
# 29
int stats_sigma_free(stats_sigma_t * stat); 
# 30
int stats_sigma_measure(stats_sigma_t * stat, int ntime); 
# 24 "stats_symmetric.h"
int stats_symmetric_length(fe_symm_t * fe, field_grad_t * dphi, map_t * map, int timestep); 
# 26
int stats_symmetric_moment_inertia(field_t * phi, map_t * map, int timestep); 
# 25 "fe_lc_stats.h"
int fe_lc_stats_info(pe_t * pe, cs_t * cs, fe_lc_t * fe, wall_t * wall, map_t * map, colloids_info_t * cinfo, int step); 
# 25 "lb_model_s.h"
...
rt_t *rt = (__null); 
# 195
io_info_t *iohandler = (__null); 
# 197
(ludwig) ? static_cast< void>(0) : __assert_fail("ludwig", "ludwig.c", 197, __PRETTY_FUNCTION__); 
# 199
TIMER_init(ludwig->pe); 
# 200
TIMER_start(TIMER_TOTAL); 
# 203
tdpDeviceSetCacheConfig(cudaFuncCachePreferL1); 
# 208
...
strcpy(value, ""); 
# 245
n = rt_string_parameter(rt, "phi_format", value, 8192); 
# 246
...
# 284
colloids_init_rt(pe, rt, cs, &(ludwig->collinfo), &(ludwig->cio), &(ludwig->interact), ludwig->wall, ludwig->map); 
# 286
...
# 307
pe_info(pe, "Re-starting simulation at step %d with data read from config\nfile(s) %s\n", ntstep, filename); 
# 310
...
if (ludwig->phi) { 
# 351
gradient_rt_init(pe, rt, "phi", ludwig->phi_grad, ludwig->map, ludwig->collinfo); 
# 353
}  
# 354
if (ludwig->p) { 
# 355
gradient_rt_init(pe, rt, "p", ludwig->p_grad, ludwig->map, ludwig->collinfo); 
# 357
}  
# 358
if (ludwig->q) { 
# 359
gradient_rt_init(pe, rt, "q", ludwig->q_grad, ludwig->map, ludwig->collinfo); 
# 361
}  
# 363
...
# 368
n = rt_string_parameter(rt, "calibration", filename, 4096); 
# 369
if ((n == 1) && (strcmp(filename, "on") == 0)) { 
# 370
stats_ahydro_create(pe, cs, ludwig->collinfo, ludwig->hydro, ludwig->map, &(ludwig->stat_ah)); 
# 372
}  
# 376
nstat = 0; 
# 377
n = rt_string_parameter(rt, "calibration_sigma", filename, 4096); 
# 378
if ((n == 1) && (strcmp(filename, "on") == 0)) { nstat = 1; }  
# 380
if (ntstep == 0) { 
# 381
if (nstat) { stats_sigma_create(pe, cs, ludwig->fe_symm, ludwig->phi, &(ludwig->stat_sigma)); }  
# 383
...
io_info_t *iohandler = (__null); 
# 427
ludwig_t *ludwig = (__null); 
# 428
MPI_Comm comm; 
# 431
ludwig = ((ludwig_t *)calloc(1, sizeof(ludwig_t))); 
# 432
(ludwig) ? static_cast< void>(0) : __assert_fail("ludwig", "ludwig.c", 432, __PRETTY_FUNCTION__); 
# 434
...
# 470
lb_memcpy(ludwig->lb, hipMemcpyHostToDevice); 
# 471
if (ludwig->phi) { field_memcpy(ludwig->phi, hipMemcpyHostToDevice); }  
# 472
if (ludwig->p) { field_memcpy(ludwig->p, hipMemcpyHostToDevice); }  
# 473
if (ludwig->q) { field_memcpy(ludwig->q, hipMemcpyHostToDevice); }  
# 478
pe_info(ludwig->pe, "\n"); 
# 479
...
# 585
psi_force_gradmu(ludwig->psi, ludwig->fe, ludwig->phi, ludwig->hydro, ludwig->map, ludwig->collinfo); 
# 588
}  
# 591
if (flag == (PSI_FORCE_DIVERGENCE)) { 
# 592
psi_force_divstress_d3qx(ludwig->psi, ludwig->fe, ludwig->hydro, ludwig->map, ludwig->collinfo); 
# 594
}  
# 595
...
# 600
nernst_planck_driver_d3qx(ludwig->psi, ludwig->fe, ludwig->hydro, ludwig->map, ludwig->collinfo); 
# 602
...
# 646
fe_lc_droplet_bodyforce_wall(fe, ludwig->le, ludwig->hydro, ludwig->map, ludwig->wall); 
# 648
} else 
# 649
{ 
...
# 658
phi_force_calculation(ludwig->cs, ludwig->le, ludwig->wall, ludwig->pth, ludwig->fe, ludwig->map, ludwig->phi, ludwig->hydro); 
# 662
} else 
# 663
{ 
# 664
pth_force_colloid(ludwig->pth, ludwig->fe, ludwig->collinfo, ludwig->hydro, ludwig->map, ludwig->wall); 
# 666
}  
# 667
}  
...
if (ludwig->pch) { 
# 674
phi_cahn_hilliard(ludwig->pch, ludwig->fe, ludwig->phi, ludwig->hydro, ludwig->map, ludwig->noise_phi); 
# 677
}  
# 679
if (ludwig->p) { 
...
# 691
beris_edw_update(ludwig->be, ludwig->fe, ludwig->q, ludwig->q_grad, ludwig->hydro, ludwig->collinfo, ludwig->map, ludwig->noise_rho); 
# 694
}  
# 696
...
# 716
lb_collide(ludwig->lb, ludwig->hydro, ludwig->map, ludwig->noise_rho, ludwig->fe, ludwig->visc); 
# 719
...
# 739
bounce_back_on_links(ludwig->bbl, ludwig->lb, ludwig->wall, ludwig->collinfo); 
# 741
...
if (is_config_step()) { 
# 770
lb_memcpy(ludwig->lb, hipMemcpyDeviceToHost); 
# 771
...
field_io_info(ludwig->q, &iohandler); 
# 806
io_replace_values(ludwig->q, ludwig->map, MAP_COLLOID, (1.000000000000000082e-05)); 
# 807
...
# 830
lb_memcpy(ludwig->lb, hipMemcpyDeviceToDevice); 
# 831
stats_rheology_stress_profile_accumulate(ludwig->stat_rheo, ludwig->lb, ludwig->fe, ludwig->hydro); 
# 833
}  
# 835
...
if (ludwig->phi) { 
# 856
field_grad_memcpy(ludwig->phi_grad, hipMemcpyDeviceToHost); 
# 857
if (im == 2) { 
# 859
phi_lb_to_field(ludwig->phi, ludwig->lb); 
# 860
field_memcpy(ludwig->phi, hipMemcpyDeviceToHost); 
# 861
stats_field_info_bbl(ludwig->phi, ludwig->map, ludwig->bbl); 
# 862
} else 
...
if (ludwig->p) { 
# 870
field_memcpy(ludwig->p, hipMemcpyDeviceToHost); 
# 871
...
if (ludwig->q) { 
# 875
field_memcpy(ludwig->q, hipMemcpyDeviceToHost); 
# 876
field_grad_memcpy(ludwig->q_grad, hipMemcpyDeviceToHost); 
# 877
...
case FE_LC:  
# 892
fe_lc_stats_info(ludwig->pe, ludwig->cs, ludwig->fe_lc, ludwig->wall, ludwig->map, ludwig->collinfo, step); 
# 894
break; 
# 895
default:  
# 896
stats_free_energy_density(ludwig->pe, ludwig->cs, ludwig->wall, ludwig->fe, ludwig->map, ludwig->collinfo); 
# 899
}  
# 900
}  
...
# 905
hydro_memcpy(ludwig->hydro, hipMemcpyDeviceToHost); 
# 906
...
# 1118
(ludwig) ? static_cast< void>(0) : __assert_fail("ludwig", "ludwig.c", 1118, __PRETTY_FUNCTION__); 
# 1119
(ludwig->pe) ? static_cast< void>(0) : __assert_fail("ludwig->pe", "ludwig.c", 1119, __PRETTY_FUNCTION__); 
# 1120
(ludwig->rt) ? static_cast< void>(0) : __assert_fail("ludwig->rt", "ludwig.c", 1120, __PRETTY_FUNCTION__); 
# 1122
pe = (ludwig->pe); 
# 1123
rt = (ludwig->rt); 
...
# 1131
n = rt_string_parameter(rt, "free_energy", description, 8192); 
# 1133
...
# 1145
if ((strcmp(description, "symmetric") == 0) || (strcmp(description, "symmetric_noise") == 0)) 
# 1146
{ 
# 1148
fe_symm_t *fe = (__null); 
...
# 1170
phi_ch_create(pe, cs, le, __null, &(ludwig->pch)); 
# 1172
pe_info(pe, "\n"); 
# 1173
...
# 1210
if (strcmp(description, "symmetric_lb") == 0) { 
# 1212
fe_symm_t *fe = (__null); 
# 1216
...
# 1250
if (strcmp(description, "brazovskii") == 0) { 
# 1254
fe_brazovskii_t *fe = (__null); 
# 1255
nf = 1; 
# 1256
nhalo = 3; 
...
# 1295
if (strcmp(description, "surfactant") == 0) { 
# 1297
pe_info(pe, "Surfactant free energy is disabled\n"); 
# 1298
(0) ? static_cast< void>(0) : __assert_fail("0", "ludwig.c", 1298, __PRETTY_FUNCTION__); 
# 1299
} else { 
# 1300
if (strcmp(description, "lc_blue_phase") == 0) { 
# 1302
fe_lc_t *fe = (__null); 
# 1303
...
pth_create(pe, cs, PTH_METHOD_DIVERGENCE, &(ludwig->pth)); 
# 1343
grad_lc_anch_create(pe, cs, __null, __null, __null, fe, __null); 
# 1345
(ludwig->fe_lc) = fe; 
# 1346
(ludwig->fe) = ((fe_t *)fe); 
...
# 1348
if (strcmp(description, "polar_active") == 0) { 
# 1351
fe_polar_t *fe = (__null); 
# 1353
nf = 3; 
# 1354
nhalo = 2; 
...
# 1384
if (strcmp(description, "lc_droplet") == 0) { 
# 1385
int use_stress_relaxation; 
# 1386
fe_symm_t *symm = (__null); 
# 1387
fe_lc_t *lc = (__null); 
# 1388
fe_lc_droplet_t *fe = (__null); 
# 1391
pe_info(pe, "\n"); 
# 1392
...
pe_info(pe, "Force calculation:      %s\n", (p == 0) ? "phi grad mu method" : ("divergence method")); 
# 1433
(p != 0) ? static_cast< void>(0) : __assert_fail("p != 0", "ludwig.c", 1433, __PRETTY_FUNCTION__); 
# 1434
pth_create(pe, cs, PTH_METHOD_DIVERGENCE, &(ludwig->pth)); 
# 1437
nhalo = 2; 
...
ngrad = 2; 
# 1440
field_create(pe, cs, 5, "q", &(ludwig->q)); 
# 1441
field_init(ludwig->q, nhalo, le); 
# 1442
field_grad_create(pe, ludwig->q, ngrad, &(ludwig->q_grad)); 
...
# 1462
grad_lc_anch_create(pe, cs, __null, ludwig->phi, __null, lc, __null); 
# 1464
(ludwig->fe_symm) = symm; 
# 1465
(ludwig->fe_lc) = lc; 
...
# 1468
if (strcmp(description, "fe_electro") == 0) { 
# 1470
fe_electro_t *fe = (__null); 
# 1472
nk = 2; 
# 1477
p = 1; 
...
# 1509
if (strcmp(description, "fe_electro_symmetric") == 0) { 
# 1511
fe_symm_t *fe_symm = (__null); 
# 1512
fe_electro_t *fe_elec = (__null); 
# 1513
fe_es_t *fes = (__null); 
# 1514
double e1, e2; 
...
int key; 
# 1651
char description[8192 / 2]; 
# 1653
(pe) ? static_cast< void>(0) : __assert_fail("pe", "ludwig.c", 1653, __PRETTY_FUNCTION__); 
# 1654
(rt) ? static_cast< void>(0) : __assert_fail("rt", "ludwig.c", 1654, __PRETTY_FUNCTION__); 
# 1655
(ludwig) ? static_cast< void>(0) : __assert_fail("ludwig", "ludwig.c", 1655, __PRETTY_FUNCTION__); 
# 1657
key = rt_string_parameter(rt, "viscosity_model", description, 8192 / 2); 
# 1659
...
map_t *map = (__null); 
# 1716
(pe) ? static_cast< void>(0) : __assert_fail("pe", "ludwig.c", 1716, __PRETTY_FUNCTION__); 
# 1717
(rt) ? static_cast< void>(0) : __assert_fail("rt", "ludwig.c", 1717, __PRETTY_FUNCTION__); 
# 1719
is_porous_media = rt_string_parameter(rt, "porous_media_file", filename, 4096); 
# 1721
if (is_porous_media) { 
# 1723
rt_string_parameter(rt, "porous_media_type", status, 8192); 
# 1725
...
# 1737
rt_string_parameter(rt, "porous_media_format", format, 8192); 
# 1739
...
int ncolloid = 0; 
# 1783
(ludwig) ? static_cast< void>(0) : __assert_fail("ludwig", "ludwig.c", 1783, __PRETTY_FUNCTION__); 
# 1785
colloids_info_ntotal(ludwig->collinfo, &ncolloid); 
# 1786
...
# 1793
interact_compute(ludwig->interact, ludwig->collinfo, ludwig->map, ludwig->psi, ludwig->ewald); 
# 1796
...
int iconserve; 
# 1816
(ludwig) ? static_cast< void>(0) : __assert_fail("ludwig", "ludwig.c", 1816, __PRETTY_FUNCTION__); 
# 1818
colloids_info_ntotal(ludwig->collinfo, &ncolloid); 
# 1819
if (ncolloid == 0) { return 0; }  
...
# 1860
build_remove_replace(ludwig->fe, ludwig->collinfo, ludwig->lb, ludwig->phi, ludwig->p, ludwig->q, ludwig->psi, ludwig->map); 
# 1862
...
# 1885
colloids_memcpy(ludwig->collinfo, hipMemcpyHostToDevice); 
# 1886
map_memcpy(ludwig->map, hipMemcpyHostToDevice); 
# 1887
lb_memcpy(ludwig->lb, hipMemcpyHostToDevice); 
# 1889
return 0; 
...
int status; 
# 1907
(field) ? static_cast< void>(0) : __assert_fail("field", "ludwig.c", 1907, __PRETTY_FUNCTION__); 
# 1908
(map) ? static_cast< void>(0) : __assert_fail("map", "ludwig.c", 1908, __PRETTY_FUNCTION__); 
# 1910
nf = (field->nf); 
# 1911
...
for (n = 0; n < nf; n++) { 
# 1922
((field->data)[reverse_addr_rank1_assert(1922, "ludwig.c", field->nsites, nf, index, n)]) = value; 
# 1923
}  
# 1924
}  
...
# 1 "ludwig.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__14_ludwig_cpp1_ii_83fa50e4
# 1 "ludwig.cudafe1.stub.c"
#include "ludwig.cudafe1.stub.c"
# 1 "ludwig.cudafe1.stub.c"
