...
# 31 "colloid_io_rt.c"
int colloid_io_run_time(pe_t *pe, rt_t *rt, cs_t *cs, colloids_info_t *
# 32
cinfo, colloid_io_t **
# 33
pcio) { 
...
char tmp[8192]; 
# 38
colloid_io_t *cio = (__null); 
# 40
(pe) ? static_cast< void>(0) : __assert_fail("pe", "colloid_io_rt.c", 40, __PRETTY_FUNCTION__); 
# 41
(rt) ? static_cast< void>(0) : __assert_fail("rt", "colloid_io_rt.c", 41, __PRETTY_FUNCTION__); 
# 42
(cs) ? static_cast< void>(0) : __assert_fail("cs", "colloid_io_rt.c", 42, __PRETTY_FUNCTION__); 
# 43
(cinfo) ? static_cast< void>(0) : __assert_fail("cinfo", "colloid_io_rt.c", 43, __PRETTY_FUNCTION__); 
# 45
...
# 49
(cio) ? static_cast< void>(0) : __assert_fail("cio", "colloid_io_rt.c", 49, __PRETTY_FUNCTION__); 
# 53
...
strcpy(tmp, ""); 
# 57
rt_string_parameter(rt, "colloid_io_format", tmp, 8192); 
# 59
...
# 64
rt_string_parameter(rt, "colloid_io_format_input", tmp, 8192); 
# 66
...
# 70
if ((strncmp("ASCII_SERIAL", tmp, 12) == 0) || (strncmp("ascii_serial", tmp, 12) == 0)) 
# 71
{ 
# 72
colloid_io_format_input_ascii_set(cio); 
...
# 80
if ((strncmp("BINARY_SERIAL", tmp, 13) == 0) || (strncmp("binary_serial", tmp, 13) == 0)) 
# 81
{ 
# 82
colloid_io_format_input_binary_set(cio); 
...
# 86
rt_string_parameter(rt, "colloid_io_format_output", tmp, 8192); 
# 88
if ((strncmp("ASCII", tmp, 5) == 0) || (strncmp("ascii", tmp, 5) == 0)) { 
# 89
colloid_io_format_output_ascii_set(cio); 
...
# 1 "colloid_io_rt.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__21_colloid_io_rt_cpp1_ii_41ea460f
# 1 "colloid_io_rt.cudafe1.stub.c"
#include "colloid_io_rt.cudafe1.stub.c"
# 1 "colloid_io_rt.cudafe1.stub.c"
